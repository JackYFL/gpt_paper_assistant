# Personalized Daily ArXiv Papers 06/30/2026
...
0. [BrainJanus: A Unified Model for Understanding and Generation across Brain, Vision, and Language](#link0)
...
2. [A Physics-Grounded Benchmark for Multi-Agent Dynamics in World Models](#link2)
...
3. [GeoEdit: Geometry-Aware Object Editing via Dual-Branch Denoising](#link3)
**Authors:** Yi He, Jiangming Wang, Xinyu Wang, Mark Fong, Songchun Zhang, Yuxuan Xue, Hai-Tao Zheng, Yue Ma

4. [X-Mind: Efficient Visual Chain-of-Thought via Predictive World Model for End-to-End Driving](#link4)
...
5. [Goku: A Million-Scale Universal Dataset and Benchmark for Instruction-Based Video Editing](#link5)
...
6. [CLOSER-VLN: Closed-Loop Self-Verified Retrieval-Augmented Reasoning for Aerial Vision-Language Navigation](#link6)
**Authors:** Shaoxuan Li, Xiangyu Dong, Xiaoguang Ma, Junfeng Chen, Haoran Zhao, Yaoming Zhou

7. [Illuminating Unified Multimodal Model for Free-form Interleaved Text-Image Generation](#link7)
...
8. [See Only When Needed: Context-Aware Attention Intervention for Mitigating Hallucinations in LVLMs](#link8)
**Authors:** Yuqing Lei, Wenbo Lyu, Yingjun Du, Xiantong Zhen, Cees G. M. Snoek, Ling Shao

9. [Dynamo: Dynamic Skill-Tool Evolution for Vision-Language Agents](#link9)
...
10. [SHOVIR: A Benchmark for Evaluating Vision Shortcut Learning in Radiology Report Generation](#link10)
**Authors:** Filippo Ruffini, Marco Salm\'e, Rosa Sicilia, Valerio Guarrasi, Paolo Soda

11. [AEGIR: Modeling Area Emitters for Indoor Inverse Rendering using Gaussian Splatting](#link11)
**Authors:** Mohamed Shawky Sabae, Philipp Langsteiner, Jan-Niklas Dihlmann, Hendrik Lensch

12. [TrafficAlign: Aligning Large Language Models for Traffic Scenario Generation](#link12)
**Authors:** Zhi Tu, Liangkun Niu, Tianyi Zhang

13. [COMPASS: Grounding Composition-Intent Guidance in Unified Multimodal Models](#link13)
**Authors:** Ziqi Zhou, Weize Quan, Mining Tan, Zhihan Chen, Dandan Zheng, Jingdong Chen, Jun Zhou, Weiming Dong, Dong-Ming Yan

14. [Towards in-the-wild Egocentric 3D Hand-Object Pose Estimation](#link14)
**Authors:** Siddhant Bansal, Zhifan Zhu, Shashank Tripathi, Jiahe Zhao, Michael J. Black, Dima Damen

15. [SkelEM: Training-Signal Decoupling of Skeleton and Diffusion for Self-supervised Axial Super-Resolution in Volume Microscopy](#link15)
**Authors:** Bohao Chen, Yanchao Zhang, Yanan Lv, Chenxun Deng, Hua Han, Xi Chen

16. [AerialMetric: Benchmarking and Adapting UAV Monocular Metric Depth Estimation in the Real World](#link16)
**Authors:** Zhongqiang Song, Guanying Chen, Yuqi Zhang, Yin Zou, Chuanyu Fu, Zhiyuan Yuan, Chuan Huang, Shuguang Cui, Xiaochun Cao

17. [ScaleErasure: Inference-Time Minimal Intervention for Precise Concept Erasure in Next-Scale Autoregressive Image Generation](#link17)
**Authors:** Cong Wang, Haiyu Wu, Zhiwei Jiang, Zifeng Cheng, Fei Shen, Yafeng Yin, Qing Gu

18. [GeoISF: Instance Semantic Forest Inspired Large-Scale Cross-View Geo-Localization via Ground LiDAR-to-Satellite Image](#link18)
**Authors:** Di Hu, Xia Yuan, Chunxia Zhao

19. [FFAvatar: Feed-Forward 4D Head Avatar Reconstruction from Sparse Portrait Images](#link19)
**Authors:** Jianjiang Yao, Ke Xian, Renxiang Dai, Robert Caiming Qiu

20. [Reliability-Prioritized Fine-Grained Generation in Multimodal Large](#link20)
...
21. [MirrorPPR: Exemplar-Based Portrait Photo Retouching](#link21)
**Authors:** Zhihong Liu, Zheng Li, Jiachun Jin, Siqi Kou, Yitao Jian, Fengpei Yu, Zhijie Deng

22. [Cognitive World Models for Process-Level Social Influence Evaluation](#link22)
**Authors:** Minghui Ma, Bin Guo, Han Wang, Mengqi Chen, Jingqi Liu, Yan Liu, Zhiwen Yu

23. [ManimAgent: Self-Evolving Multimodal Agents for Visual Education](#link23)
...
24. [UniVAD v2: Unified Visual Anomaly Detection via Support-Conditioned Boundary Construction](#link24)
**Authors:** Zhaopeng Gu, Bingke Zhu, Zhaowen Li, Guibo Zhu, Yingying Chen, Ming Tang, Peng Su, Jinqiao Wang

25. [KM-Speaker: Keypoint-Based Style Control for High-Quality Speech-Driven 3D Facial Animation and Dialogue Localization](#link25)
**Authors:** Arthur Josi, Emeline Got, Abdallah Dib, Luiz Gustavo Hafemann, Rafael M. O. Cruz

26. [Evidence-Based Text-Conditioned 3D CT Synthesis for Ovarian Cancer](#link26)
...
---
## 0. [BrainJanus: A Unified Model for Understanding and Generation across Brain, Vision, and Language](https://arxiv.org/abs/2606.30319) <a id="link0"></a>
**ArXiv ID:** 2606.30319
**Authors:** Haitao Wu, Qirui Zhang, Zhouheng Yao, Shangquan Sun, Qihao Zheng, Mianxin Liu, Chi Zhang, Wanli Ouyang, Chunfeng Song, Changqing Zhang, Jiamin Wu
...
**Comment:** Matches criterion 4 very closely: it is a unified brain-vision-language model with any-to-any generation, strongly related to vision foundation models and multimodal representation learning.
**Relevance:** 8
**Novelty:** 8
...
**Comment:** Matches criterion 3 very closely: it proposes a new embodied/world-model method with a unified next-state-prediction framework and evaluates embodied action generation.
**Relevance:** 8
**Novelty:** 8

---

## 2. [A Physics-Grounded Benchmark for Multi-Agent Dynamics in World Models](https://arxiv.org/abs/2606.28757) <a id="link2"></a>
**ArXiv ID:** 2606.28757
**Authors:** Nuo Chen, Lulin Liu, Zihao Li, Ziyao Zeng, Zihao Zhu, Wenyan Cong, Junyuan Hong, Yunhao Yang, Zhengzhong Tu, Yan Wang, Boris Ivanovic, Marco Pavone, Zhangyang Wang, Yang Zhou, Zhiwen Fan
...
**Comment:** Matches criterion 3 very closely: it introduces a new benchmark/evaluation framework for world models focused on physics-grounded multi-agent dynamics in simulation.
**Relevance:** 8
**Novelty:** 7

---

## 3. [GeoEdit: Geometry-Aware Object Editing via Dual-Branch Denoising](https://arxiv.org/abs/2606.30003) <a id="link3"></a>
**ArXiv ID:** 2606.30003
**Authors:** Yi He, Jiangming Wang, Xinyu Wang, Mark Fong, Songchun Zhang, Yuxuan Xue, Hai-Tao Zheng, Yue Ma
...
**Comment:** Matches criterion 1 very closely, and also criterion 4 to a lesser extent: it is geometry-aware spatial editing with a new pose-aware benchmark.
**Relevance:** 8
**Novelty:** 6

---

## 4. [X-Mind: Efficient Visual Chain-of-Thought via Predictive World Model for End-to-End Driving](https://arxiv.org/abs/2606.28758) <a id="link4"></a>
**ArXiv ID:** 2606.28758
**Authors:** Bohao Zhao, Chengrui Wei, Guangfeng Jiang, Ruixin Liu, Xuejie Lv, Liu Liang, Sutao Deng, Xiuyang Fan, Pengkun Zheng, Jinyun Zhou, Rui Guo, Hanpeng Liu, Yutong Zheng, Yi Guo, Xinlong Zheng, Qingyu Luo, Zhuangzhuang Ding, Yu Zhang, Hang Zhang, Xianming Liu
...
**Comment:** Matches criterion 1 closely: it introduces predictive world-model-based visual chain-of-thought for end-to-end driving, a spatial/intelligence method for embodied agents.
**Relevance:** 7
**Novelty:** 7

---

## 5. [Goku: A Million-Scale Universal Dataset and Benchmark for Instruction-Based Video Editing](https://arxiv.org/abs/2606.30599) <a id="link5"></a>
**ArXiv ID:** 2606.30599
**Authors:** Sen Liang, Cong Wang, Zhentao Yu, Fengbin Guan, Zhengguang Zhou, Teng Hu, Youliang Zhang, Yuan Zhou, Xin Li, Qinglin Lu, Zhibo Chen
...
**Comment:** Matches criterion 2 very closely, and also fits criterion 4 via its multimodal video-editing benchmark and MLLM-based editor.
**Relevance:** 8
**Novelty:** 6

---

## 6. [CLOSER-VLN: Closed-Loop Self-Verified Retrieval-Augmented Reasoning for Aerial Vision-Language Navigation](https://arxiv.org/abs/2606.28397) <a id="link6"></a>
**ArXiv ID:** 2606.28397
**Authors:** Shaoxuan Li, Xiangyu Dong, Xiaoguang Ma, Junfeng Chen, Haoran Zhao, Yaoming Zhou
...
**Comment:** Matches criterion 3 very closely: it is an embodied AI / VLN method with a new closed-loop reasoning and verification framework for aerial navigation.
**Relevance:** 7
**Novelty:** 6

---

## 7. [Illuminating Unified Multimodal Model for Free-form Interleaved Text-Image Generation](https://arxiv.org/abs/2606.30054) <a id="link7"></a>
**ArXiv ID:** 2606.30054
**Authors:** Chonghuinan Wang, Zhikai Chen, Chunwei Wang, Yecong Wan, Junwei Yang, Zhixin Wang, Wei Zhang, Jiaqi Xu, Renjing Pei, Xiaohe Wu, Fan Li, Wangmeng Zuo
...
**Comment:** Matches criterion 2 closely: it proposes a unified multimodal model for free-form interleaved text-image generation.
**Relevance:** 7
**Novelty:** 6

---

## 8. [See Only When Needed: Context-Aware Attention Intervention for Mitigating Hallucinations in LVLMs](https://arxiv.org/abs/2606.29847) <a id="link8"></a>
**ArXiv ID:** 2606.29847
**Authors:** Yuqing Lei, Wenbo Lyu, Yingjun Du, Xiantong Zhen, Cees G. M. Snoek, Ling Shao
...
**Comment:** Matches criterion 2 closely: it is a new LVLM inference-time method aimed at reducing hallucinations in large vision-language models.
**Relevance:** 7
**Novelty:** 5

---

## 9. [Dynamo: Dynamic Skill-Tool Evolution for Vision-Language Agents](https://arxiv.org/abs/2606.30185) <a id="link9"></a>
**ArXiv ID:** 2606.30185
**Authors:** Yutao Sun, Yanting Miao, Hao-Xuan Ma, Mengyu Zhou, Mingshuai Chen, Tiancheng Zhao, Dexin Wang, Lei Lv, Li Xu, Xiaoxi Jiang, Guanjun Jiang
...
**Comment:** Matches criterion 2: a new vision-language agent framework that dynamically builds skills and tools for visual reasoning.
**Relevance:** 6
**Novelty:** 6

---

## 10. [SHOVIR: A Benchmark for Evaluating Vision Shortcut Learning in Radiology Report Generation](https://arxiv.org/abs/2606.30201) <a id="link10"></a>
**ArXiv ID:** 2606.30201
**Authors:** Filippo Ruffini, Marco Salm\'e, Rosa Sicilia, Valerio Guarrasi, Paolo Soda
...
**Comment:** Matches criterion 3: it is a new benchmark for spatial grounding / shortcut learning in vision-language radiology report generation.
**Relevance:** 6
**Novelty:** 6

---

## 11. [AEGIR: Modeling Area Emitters for Indoor Inverse Rendering using Gaussian Splatting](https://arxiv.org/abs/2606.28635) <a id="link11"></a>
**ArXiv ID:** 2606.28635
**Authors:** Mohamed Shawky Sabae, Philipp Langsteiner, Jan-Niklas Dihlmann, Hendrik Lensch
...
**Comment:** Matches criterion 4 very closely: vision/graphics foundation-model-style application via Gaussian Splatting for inverse rendering and relighting.
**Relevance:** 6
**Novelty:** 6

---

## 12. [TrafficAlign: Aligning Large Language Models for Traffic Scenario Generation](https://arxiv.org/abs/2606.29097) <a id="link12"></a>
**ArXiv ID:** 2606.29097
**Authors:** Zhi Tu, Liangkun Niu, Tianyi Zhang
...
**Comment:** Matches criterion 3: embodied/autonomous-driving scenario generation with a benchmark-alignment angle focused on simulator-relevant traffic scenes.
**Relevance:** 6
**Novelty:** 5

---

## 13. [COMPASS: Grounding Composition-Intent Guidance in Unified Multimodal Models](https://arxiv.org/abs/2606.28696) <a id="link13"></a>
**ArXiv ID:** 2606.28696
**Authors:** Ziqi Zhou, Weize Quan, Mining Tan, Zhihan Chen, Dandan Zheng, Jingdong Chen, Jun Zhou, Weiming Dong, Dong-Ming Yan
...
**Comment:** Matches criterion 2: it introduces a unified multimodal model for composition perception and composition-guided generation.
**Relevance:** 5
**Novelty:** 6

---

## 14. [Towards in-the-wild Egocentric 3D Hand-Object Pose Estimation](https://arxiv.org/abs/2606.30598) <a id="link14"></a>
**ArXiv ID:** 2606.30598
**Authors:** Siddhant Bansal, Zhifan Zhu, Shashank Tripathi, Jiahe Zhao, Michael J. Black, Dima Damen
...
**Comment:** Matches criterion 3 very closely: embodied AI / egocentric 3D hand-object pose with a new in-the-wild dataset and method.
**Relevance:** 6
**Novelty:** 5

---

## 15. [SkelEM: Training-Signal Decoupling of Skeleton and Diffusion for Self-supervised Axial Super-Resolution in Volume Microscopy](https://arxiv.org/abs/2606.30012) <a id="link15"></a>
**ArXiv ID:** 2606.30012
**Authors:** Bohao Chen, Yanchao Zhang, Yanan Lv, Chenxun Deng, Hua Han, Xi Chen
...
**Comment:** Matches criterion 4 very closely: microscopy vision foundation-style self-supervised restoration with a new benchmark and a diffusion-based method.
**Relevance:** 5
**Novelty:** 6

---

## 16. [AerialMetric: Benchmarking and Adapting UAV Monocular Metric Depth Estimation in the Real World](https://arxiv.org/abs/2606.29716) <a id="link16"></a>
**ArXiv ID:** 2606.29716
**Authors:** Zhongqiang Song, Guanying Chen, Yuqi Zhang, Yin Zou, Chuanyu Fu, Zhiyuan Yuan, Chuan Huang, Shuguang Cui, Xiaochun Cao
...
**Comment:** Matches criterion 3 very closely: it introduces a new embodied/robotics-style benchmark for UAV monocular metric depth estimation in the real world.
**Relevance:** 6
**Novelty:** 5

---

## 17. [ScaleErasure: Inference-Time Minimal Intervention for Precise Concept Erasure in Next-Scale Autoregressive Image Generation](https://arxiv.org/abs/2606.29282) <a id="link17"></a>
**ArXiv ID:** 2606.29282
**Authors:** Cong Wang, Haiyu Wu, Zhiwei Jiang, Zifeng Cheng, Fei Shen, Yafeng Yin, Qing Gu
...
**Comment:** Matches criterion 4 loosely: it studies inference-time concept erasure in next-scale autoregressive image generation, which is a vision generative modeling method.
**Relevance:** 4
**Novelty:** 6

---

## 18. [GeoISF: Instance Semantic Forest Inspired Large-Scale Cross-View Geo-Localization via Ground LiDAR-to-Satellite Image](https://arxiv.org/abs/2606.28371) <a id="link18"></a>
**ArXiv ID:** 2606.28371
**Authors:** Di Hu, Xia Yuan, Chunxia Zhao
...
**Comment:** Matches criterion 3: cross-view geo-localization with LiDAR-to-satellite matching, relevant to spatial understanding in embodied/geospatial settings.
**Relevance:** 5
**Novelty:** 5

---

## 19. [FFAvatar: Feed-Forward 4D Head Avatar Reconstruction from Sparse Portrait Images](https://arxiv.org/abs/2606.30347) <a id="link19"></a>
**ArXiv ID:** 2606.30347
**Authors:** Jianjiang Yao, Ke Xian, Renxiang Dai, Robert Caiming Qiu
...
**Comment:** Matches criterion 4: vision foundation / 3D generative modeling applied to fast 4D head avatar reconstruction.
**Relevance:** 5
**Novelty:** 5

---

## 20. [Reliability-Prioritized Fine-Grained Generation in Multimodal Large](https://arxiv.org/abs/2606.29573) <a id="link20"></a>
**ArXiv ID:** 2606.29573
**Authors:** Xiaomeng Fan, Wu Wei, Yuwei Wu, Zhi Gao, Shiyu Luo, Mingyang Gao, Haoyu Zhao, Zhenxin Diao, Yuxuan Ba, Lijia Feng, Yunde Jia, Mehrtash Harandi
...
**Comment:** Matches criterion 2 very closely: it studies fine-grained generation in MLLMs and proposes a benchmark plus preference optimization.
**Relevance:** 5
**Novelty:** 5

---

## 21. [MirrorPPR: Exemplar-Based Portrait Photo Retouching](https://arxiv.org/abs/2606.29308) <a id="link21"></a>
**ArXiv ID:** 2606.29308
**Authors:** Zhihong Liu, Zheng Li, Jiachun Jin, Siqi Kou, Yitao Jian, Fengpei Yu, Zhijie Deng
...
**Comment:** Matches criterion 4 moderately: a generative vision editing method with a new large-scale dataset for exemplar-based portrait retouching.
**Relevance:** 4
**Novelty:** 6

---

## 22. [Cognitive World Models for Process-Level Social Influence Evaluation](https://arxiv.org/abs/2606.29495) <a id="link22"></a>
**ArXiv ID:** 2606.29495
**Authors:** Minghui Ma, Bin Guo, Han Wang, Mengqi Chen, Jingqi Liu, Yan Liu, Zhiwen Yu
...
**Comment:** Matches criterion 3 in a looser sense: it builds a user simulator/evaluation platform for multi-turn social influence dialogue, but it is not embodied AI.
**Relevance:** 3
**Novelty:** 6

---

## 23. [ManimAgent: Self-Evolving Multimodal Agents for Visual Education](https://arxiv.org/abs/2606.30296) <a id="link23"></a>
**ArXiv ID:** 2606.30296
**Authors:** Wenjia Jiang, Zongyuan Cai, Yuanhang Shao, Chenru Wang, Boyan Han, Zhixue Song, Keyu Chen, Shengwei An, Xu Yang, Zhou Yang
...
**Comment:** Matches criterion 2 moderately: a self-evolving multimodal agent using a VLM for visual education tasks.
**Relevance:** 4
**Novelty:** 5

---

## 24. [UniVAD v2: Unified Visual Anomaly Detection via Support-Conditioned Boundary Construction](https://arxiv.org/abs/2606.29714) <a id="link24"></a>
**ArXiv ID:** 2606.29714
**Authors:** Zhaopeng Gu, Bingke Zhu, Zhaowen Li, Guibo Zhu, Yingying Chen, Ming Tang, Peng Su, Jinqiao Wang
...
**Comment:** Matches criterion 4 moderately: strong vision application with a new benchmark and method for unified anomaly detection.
**Relevance:** 4
**Novelty:** 5

---

## 25. [KM-Speaker: Keypoint-Based Style Control for High-Quality Speech-Driven 3D Facial Animation and Dialogue Localization](https://arxiv.org/abs/2606.28568) <a id="link25"></a>
**ArXiv ID:** 2606.28568
**Authors:** Arthur Josi, Emeline Got, Abdallah Dib, Luiz Gustavo Hafemann, Rafael M. O. Cruz
...
**Comment:** Matches criterion 4 loosely: it is a vision-related generative application for controllable 3D facial animation, but not a foundation model paper.
**Relevance:** 3
**Novelty:** 5

---

## 26. [Evidence-Based Text-Conditioned 3D CT Synthesis for Ovarian Cancer](https://arxiv.org/abs/2606.28980) <a id="link26"></a>
**ArXiv ID:** 2606.28980
**Authors:** Francesca Pia Panaccione, Eugenio Lomurno, Francesca Fati, Carlotta Pecchiari, Marina Rosanu, Luigi De Vitis, Lucia Ribero, Gabriella Schivardi, Giovanni Damiano Aletti, Nicoletta Colombo, Maria Francesca Spadea, Francesco Multinu, Matteo Matteucci, Elena De Momi
...
**Comment:** Matches criterion 4: vision-language guided generative modeling for medical imaging synthesis.
**Relevance:** 4
**Novelty:** 4
