# Personalized Daily ArXiv Papers 06/03/2026
...
0. [Cosmos 3: Omnimodal World Models for Physical AI](#link0)
...
1. [Benchmarking Visual State Tracking in Multimodal Video Understanding](#link1)
...
2. [NewtPhys: Do Foundation Models Understand Newtonian Physics?](#link2)
**Authors:** Sebastian Cavada, Soumava Paul, Tuan-Hung Vu, Andrei Bursuc, Raoul de Charette

3. [Plan2Map: A Multimodal Benchmark for Document-Grounded Geospatial Boundary Reconstruction from Planning Records](#link3)
**Authors:** Fabian Degen, Oishi Deb, Jindong Gu, Junchi Yu, Samuele Marro, Philip Torr, Jialin Yu

4. [DyaPlex: Full-Duplex Speech-Motion Model for Dyadic Interaction](#link4)
...
5. [CP-Agent: Context-Aware Multimodal Reasoning for Cellular Morphological Profiling under Chemical Perturbations](#link5)
**Authors:** Yuxin Zhang, Yiyao Li, Ping Shu Ho, Simon See, Zhenqin Wu, Kevin Tsia

6. [Seg2Track++: Probabilistic Track Validation and Data Association for Multi-Object Tracking and Segmentation](#link6)
**Authors:** Diogo Mendon\c{c}a, Tiago Barros, Cristiano Premebida, Urbano J. Nunes

7. [PaddleOCR-VL-1.6: Expanding the Frontier of Document Parsing with Under-Optimized Region Refinement and Progressive Post-Training](#link7)
...
8. [Qwen-Image-Flash: Beyond Objective Design](#link8)
...
9. [ThoughtFold: Folding Reasoning Chains via Introspective Preference Learning](#link9)
**Authors:** Ziyan Liu, Xueda Shen, Yuzhe Gu, Songyang Gao, Kuikun Liu, Guangran Cheng, Chengqi Lyu, Dahua Lin, Wenwei Zhang, Kai Chen

10. [Inverting the Generation Process of Denoising Diffusion Implicit Models: Empirical Evaluation and a Novel Method](#link10)
**Authors:** Yan Zeng, Masanori Suganuma, Takayuki Okatani

11. [Bridging Auxiliary Constraints to Resolve Instruction Following in Large Reasoning Models](#link11)
...
12. [From Answers to States: Verifiable Process-Level Evaluation of Chemical Reasoning in Large Language Models](#link12)
**Authors:** Hongyu Guo, Hao Li, He Cao, Gongbo Zhang, Li Yuan

13. [FCUS-rPPG: A Fast-Converging Unsupervised Framework for Remote Photoplethysmography via Gradient Oscillation Suppression](#link13)
**Authors:** Jiajie Li, Yu Liu, Rencheng Song, Xun Chen, Juan Cheng

14. [Efficient Transformer-Based Localized Patch Sampling for Choroid Plexus Segmentation in Multiple Sclerosis](#link14)
**Authors:** Po-Jui Lu, Alessandro Cagol, Mario Ocampo-Pineda, Federico Spagnolo, Marina Mastantuono, Andreea-Alexandra Aldea, Jannis M\"uller, \"Ozg\"ur Yaldizli, Matthias Weigel, Lester Melie-Garcia, Roberta Magliozzi, Maria Pia Sormani, Ludwig Kappos, Jens Kuhle, Cristina Granziera

---
## 0. [Cosmos 3: Omnimodal World Models for Physical AI](https://arxiv.org/abs/2606.02800) <a id="link0"></a>
**ArXiv ID:** 2606.02800
**Authors:** Aditi, Niket Agarwal, Arslan Ali, Jon Allen, Martin Antolini, Adeline Aubame, Alisson Azzolini, Junjie Bai, Maciej Bala, Yogesh Balaji, Josh Bapst, Aarti Basant, Mukesh Beladiya, Mohammad Qazim Bhat, Zaid Pervaiz Bhat, Dan Blick, Vanni Brighella, Han Cai, Tiffany Cai, Eric Cameracci, Jiaxin Cao, Yulong Cao, Mark Carlson, Carlos Casanova, Ting-Yun Chang, Yan Chang, Yu-Wei Chao, Prithvijit Chattopadhyay, Roshan Chaudhari, Chieh-Yun Chen, Junyu Chen, Ke Chen, Qizhi Chen, Wenkai Chen, Xiaotong Chen, Yu Chen, An-Chieh Cheng, Click Cheng, Xiu Chia, Jeana Choi, Chaeyeon Chung, Wenyan Cong, Yin Cui, Magdalena Dadela, Nalin Dadhich, Wenliang Dai, Joyjit Daw, Alperen Degirmenci, Rodrigo Vieira Del Monte, Robert Denomme, Sameer Dharur, Marco Di Lucca, Ke Ding, Wenhao Ding, Yifan Ding, Yuzhu Dong, Nicole Drumheller, Yilun Du, Aigul Dzhumamuratova, Aleksandr Efitorov, Hamid Eghbalzadeh, Naomi Eigbe, Imad El Hanafi, Hassan Eslami, Benedikt Falk, Jiaojiao Fan, Jim Fan, Amol Fasale, Sergiy Fefilatyev, Liang Feng, Francesco Ferroni, Sanja Fidler, Xiao Fu, Vikram Fugro, Prashant Gaikwad, TJ Galda, Katelyn Gao, Yihuai Gao, Wenhang Ge, Sreyan Ghosh, Arushi Goel, Vivek Goel, Akash Gokul, Rama Govindaraju, Jinwei Gu, Miguel Guerrero, Elfie Guo, Aryaman Gupta, Siddharth Gururani, Hugo Hadfield, Song Han, Ankur Handa, Zekun Hao, Mohammad Harrim, Ali Hassani, Nathan Hayes-Roth, Yufan He, Chris Helvig, Cyrus Hogg, Madison Huang, Michael Huang, Sophia Huang, Yufan Huang, Jacob Huffman, DeLesley Hutchins, Suneel Indupuru, Boris Ivanovic, Arihant Jain, Joel Jang, Ryan Ji, Yanan Jian, Dongfu Jiang, Jingyi Jin, Atharva Joshi, Nikhilesh Joshi, Pranjali Joshi, Jaehun Jung, Weiwei Kang, Scott Kassekert, Jan Kautz, Ashna Khetan, Julia Kiczka, Slawek Kierat, Gwanghyun Kim, Kuno Kim, Sunny Kim, Kezhi Kong, Xin Kong, Zhifeng Kong, Tomasz Kornuta, Egor Krivov, Hui Kuang, Saurav Kumar, Chia-Wen Kuo, George Kurian, Wojciech Kutak, JF Lafleche, Himangshu Lahkar, Omar Laymoun, Jayjun Lee, Sanggil Lee, Gabriele Leone, Boyi Li, Freya Li, Jiajun Li, Jinfeng Li, Ling Li, Pengcheng Li, Shangru Li, Tingle Li, Xiaolong Li, Xuan Li, Zhaoshuo Li, Zhiqi Li, Hao Liang, Maosheng Liao, Chen-Hsuan Lin, Tsung-Yi Lin, Ming-Yu Liu, Sifei Liu, Zihan Liu, Hai Loc Lu, Xiangyu Lu, Alice Luo, Ruipu Luo, Wenjie Luo, Jiangran Lyu, Martin Ding Ma, Nic Ma, Qianli Ma, Dawid Majchrowski, Louis Marcoux, Miguel Martin, Qing Miao, Ashkan Mirzaei, Shreyas Misra, Kaichun Mo, Durra Mohsin, Hyejin Moon, Pawel Morkisz, Saeid Motiian, Kirill Motkov, Seungjun Nah, Yashraj Narang, Deepak Narayanan, Thabang Ngazimbi, Julian Ouyang, David Page, Yatian Pang, Sehwi Park, Mahesh Patekar, Mostofa Patwary, Marco Pavone, Trung Pham, Wei Ping, Soha Pouya, Shrimai Prabhumoye, Varun Praveen, Delin Qu, Hesam Rabeti, Morteza Ramezanali, Marilyn Reeb, Xuanchi Ren, Kristen Rumley, Wojciech Rymer, Jun Saito, Yeongho Seol, John Shao, Piyush Shekdar, Tianwei Shen, Humphrey Shi, Min Shi, Stella Shi, Kevin Shih, Mohammad Shoeybi, Mateusz Sieniawski, Shuran Song, Alexander Sotelo, Amir Sotoodeh, Sunil Srinivasa, Vignesh Srinivasakumar, Bartosz Stefaniak, Rahul Heinrich Steiger, Shangkun Sun, Jiaxiang Tang, Shitao Tang, Yangyang Tang, Yue Tang, Tolou Tavakkoli, Kayley Ting, Krzysztof Tomala, Wei-Cheng Tseng, Jibin Varghese, Sergei Vasilev, Thomas Volk, Raju Wagwani, Roger Waleffe, Andrew Z. Wang, Boxiang Wang, Haoxiang Wang, Qiao Wang, Shihao Wang, Shijie Wang, Ting-Chun Wang, Yan Wang, Yu Wang, David Wehr, Fangyin Wei, Xinshuo Weng, Jay Zhangjie Wu, Kedi Wu, Hongchi Xia, Summer Xiao, Tianjun Xiao, Kevin Xie, Daguang Xu, Jiashu Xu, Mengyao Xu, Ruqing Xu, Xingqian Xu, Yao Xu, Dinghao Yang, Dong Yang, Hans Yang, Xiaodong Yang, Xuning Yang, Yichu Yang, Yurong You, Zhiding Yu, Hao Yuan, Simon Yuen, Xiaohui Zeng, Pengcuo Zeren, Cindy Zha, Haotian Zhang, Jenny Zhang, Jing Zhang, Liangkai Zhang, Paris Zhang, Shun Zhang, Xuanmeng Zhang, Zhizheng Zhang, Ann Zhao, Yilin Zhao, Yuliya Zhautouskaya, Charles Zhou, Fengzhe Zhou, Shilin Zhu, Yuke Zhu, Dima Zhylko, Artur Zolkowski
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs), criterion 3 (embodied AI, new benchmark/methods), and criterion 4 (vision foundation models and applications): Cosmos 3 is an omnimodal world model for Physical AI, unifying language, image, video, audio, and action in a single architecture, evaluated on a diverse suite of tasks and benchmarks. Highly relevant for embodied agents, multi-modal learning, and vision foundation models.
**Relevance:** 10
**Novelty:** 9

---

## 1. [Benchmarking Visual State Tracking in Multimodal Video Understanding](https://arxiv.org/abs/2606.03920) <a id="link1"></a>
**ArXiv ID:** 2606.03920
**Authors:** Sihyun Yu, Nanye Ma, Pinzhi Huang, Hyunseok Lee, Shusheng Yang, June Suk Choi, Ellis Brown, Oscar Michel, Boyang Zheng, Jinwoo Shin, Saining Xie
...
**Comment:** Matches criteria 1 (spatial understanding in embodied agents), 2 (MLLMs), and 3 (new benchmark for embodied AI, focusing on visual state tracking in videos, a novel and underexplored angle). The paper introduces a new benchmark (VSTAT) for visual state tracking in MLLMs, analyzes failure modes, and compares with human performance.
**Relevance:** 10
**Novelty:** 8

---

## 2. [NewtPhys: Do Foundation Models Understand Newtonian Physics?](https://arxiv.org/abs/2606.03986) <a id="link2"></a>
**ArXiv ID:** 2606.03986
**Authors:** Sebastian Cavada, Soumava Paul, Tuan-Hung Vu, Andrei Bursuc, Raoul de Charette
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and criterion 3 (new benchmark for embodied/physics-aware AI): Introduces NewtPhys, a 4D physically annotated dataset for evaluating foundation models' understanding of Newtonian physics, with systematic benchmarking of VLMs and VFMs. Strong new benchmark and empirical insights.
**Relevance:** 10
**Novelty:** 8

---

## 3. [Plan2Map: A Multimodal Benchmark for Document-Grounded Geospatial Boundary Reconstruction from Planning Records](https://arxiv.org/abs/2606.02747) <a id="link3"></a>
**ArXiv ID:** 2606.02747
**Authors:** Fabian Degen, Oishi Deb, Jindong Gu, Junchi Yu, Samuele Marro, Philip Torr, Jialin Yu
...
**Comment:** Matches criteria 1 (spatial understanding in embodied agents) and 3 (new multimodal benchmark for geospatial boundary reconstruction, with a novel document-grounded, geospatial-tool-in-the-loop method). The benchmark and method address spatial reasoning from multimodal planning documents, a novel and underexplored angle.
**Relevance:** 9
**Novelty:** 8

---

## 4. [DyaPlex: Full-Duplex Speech-Motion Model for Dyadic Interaction](https://arxiv.org/abs/2606.03874) <a id="link4"></a>
**ArXiv ID:** 2606.03874
**Authors:** Koki Nagano, Hongyu Liu, Seonwook Park, Tianye Li, Amrita Mazumdar, Christian Jacobsen, Shengze Wang, Michael Stengel, Rajarshi Roy, Ka Chun Cheung, Simon See, Shalini De Mello
...
**Comment:** Matches criterion 2 (multi-modal large language models) and criterion 3 (embodied AI, new methods): DyaPlex is a full-duplex speech-motion model for dyadic interaction, with a novel dual-tower transformer architecture for synchronized multi-modal interaction. Strong multi-modal and embodied AI angle.
**Relevance:** 9
**Novelty:** 8

---

## 5. [CP-Agent: Context-Aware Multimodal Reasoning for Cellular Morphological Profiling under Chemical Perturbations](https://arxiv.org/abs/2606.03435) <a id="link5"></a>
**ArXiv ID:** 2606.03435
**Authors:** Yuxin Zhang, Yiyao Li, Ping Shu Ho, Simon See, Zhenqin Wu, Kevin Tsia
...
**Comment:** Matches criterion 2 (new MLLMs): Introduces CP-Agent, a context-aware multimodal large language model (MLLM) for reasoning about cellular morphology under chemical perturbations, with a novel context-aware alignment module (CP-CLIP) and agentic reasoning. Also relevant for multi-modal learning and interpretable rationales.
**Relevance:** 8
**Novelty:** 7

---

## 6. [Seg2Track++: Probabilistic Track Validation and Data Association for Multi-Object Tracking and Segmentation](https://arxiv.org/abs/2606.03875) <a id="link6"></a>
**ArXiv ID:** 2606.03875
**Authors:** Diogo Mendon\c{c}a, Tiago Barros, Cristiano Premebida, Urbano J. Nunes
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Seg2Track++ integrates foundation models (SAM2) for multi-object tracking and segmentation, introducing probabilistic track validation and novel data association methods. Focuses on robust application of vision foundation models.
**Relevance:** 7
**Novelty:** 6

---

## 7. [PaddleOCR-VL-1.6: Expanding the Frontier of Document Parsing with Under-Optimized Region Refinement and Progressive Post-Training](https://arxiv.org/abs/2606.03264) <a id="link7"></a>
**ArXiv ID:** 2606.03264
**Authors:** Zelun Zhang, Hongen Liu, Suyin Liang, Yubo Zhang, Yiqing Xiang, Jiaxuan Liu, Ting Sun, Manhui Lin, Yue Zhang, Changda Zhou, Tingquan Gao, Cheng Cui, Yi Liu, Dianhai Yu, Yanjun Ma
...
**Comment:** Matches criterion 4 (vision foundation models and applications): PaddleOCR-VL-1.6 is an upgraded document parsing model with region-aware data optimization and progressive post-training, achieving SOTA on OmniDocBench. Focuses on vision-language document parsing.
**Relevance:** 7
**Novelty:** 6

---

## 8. [Qwen-Image-Flash: Beyond Objective Design](https://arxiv.org/abs/2606.03746) <a id="link8"></a>
**ArXiv ID:** 2606.03746
**Authors:** Tianhe Wu, Kun Yan, Zikai Zhou, Lihan Jiang, Jiahao Li, Jie Zhang, Kaiyuan Gao, Ningyuan Tang, Shengming Yin, Xiaoyue Chen, Xiao Xu, Yilei Chen, Yuxiang Chen, Yan Shu, Yixian Xu, Yanran Zhang, Zihao Liu, Zhendong Wang, Zekai Zhang, Deqing Li, Liang Peng, Yi Wang, Jingren Zhou, Chenfei Wu
...
**Comment:** Related to criterion 4 (vision foundation models and applications): Focuses on few-step distillation for visual generative models (Qwen-Image-2.0), with empirical insights into training recipes for text-to-image and image editing. Not a new VLLM, but provides methodological insights for vision foundation models.
**Relevance:** 6
**Novelty:** 6

---

## 9. [ThoughtFold: Folding Reasoning Chains via Introspective Preference Learning](https://arxiv.org/abs/2606.03503) <a id="link9"></a>
**ArXiv ID:** 2606.03503
**Authors:** Ziyan Liu, Xueda Shen, Yuzhe Gu, Songyang Gao, Kuikun Liu, Guangran Cheng, Chengqi Lyu, Dahua Lin, Wenwei Zhang, Kai Chen
...
**Comment:** Somewhat related to criterion 2 (methodological improvements in reasoning models): Proposes ThoughtFold, a framework for more efficient reasoning in large reasoning models by introspective preference learning to reduce redundant reasoning steps. Not directly about VLLMs or spatial intelligence, but relevant for reasoning efficiency.
**Relevance:** 5
**Novelty:** 6

---

## 10. [Inverting the Generation Process of Denoising Diffusion Implicit Models: Empirical Evaluation and a Novel Method](https://arxiv.org/abs/2606.03111) <a id="link10"></a>
**ArXiv ID:** 2606.03111
**Authors:** Yan Zeng, Masanori Suganuma, Takayuki Okatani
...
**Comment:** Relevant to generative modeling in computer vision (diffusion models), but does not directly address spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models. Focuses on inversion and analysis of DDIMs, which may be of general interest.
**Relevance:** 3
**Novelty:** 7

---

## 11. [Bridging Auxiliary Constraints to Resolve Instruction Following in Large Reasoning Models](https://arxiv.org/abs/2606.03624) <a id="link11"></a>
**ArXiv ID:** 2606.03624
**Authors:** Zhengyi Zhao, Shubo Zhang, Huimin Wang, Zezhong Wang, Yutian Zhao, Yefeng Zheng, Binyang Li, Yulan He, Kam-Fai Wong, Xian Wu
...
**Comment:** Somewhat related to criterion 2 (methodological improvements in reasoning models): Proposes a new framework for improving instruction following in large reasoning models via constraint relationship graphs and auxiliary constraints. Not directly about VLLMs or spatial intelligence.
**Relevance:** 5
**Novelty:** 5

---

## 12. [From Answers to States: Verifiable Process-Level Evaluation of Chemical Reasoning in Large Language Models](https://arxiv.org/abs/2606.03660) <a id="link12"></a>
**ArXiv ID:** 2606.03660
**Authors:** Hongyu Guo, Hao Li, He Cao, Gongbo Zhang, Li Yuan
...
**Comment:** Related to process-level evaluation of LLMs in chemistry, but not directly about spatial understanding, VLLMs/MLLMs, embodied AI, or vision foundation models. Interesting for reasoning evaluation, but not a direct match.
**Relevance:** 3
**Novelty:** 6

---

## 13. [FCUS-rPPG: A Fast-Converging Unsupervised Framework for Remote Photoplethysmography via Gradient Oscillation Suppression](https://arxiv.org/abs/2606.03050) <a id="link13"></a>
**ArXiv ID:** 2606.03050
**Authors:** Jiajie Li, Yu Liu, Rencheng Song, Xun Chen, Juan Cheng
...
**Comment:** Does not directly match any specific criterion. Focuses on unsupervised rPPG (remote photoplethysmography) with optimization improvements, which is more about physiological signal extraction than spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 14. [Efficient Transformer-Based Localized Patch Sampling for Choroid Plexus Segmentation in Multiple Sclerosis](https://arxiv.org/abs/2606.03566) <a id="link14"></a>
**ArXiv ID:** 2606.03566
**Authors:** Po-Jui Lu, Alessandro Cagol, Mario Ocampo-Pineda, Federico Spagnolo, Marina Mastantuono, Andreea-Alexandra Aldea, Jannis M\"uller, \"Ozg\"ur Yaldizli, Matthias Weigel, Lester Melie-Garcia, Roberta Magliozzi, Maria Pia Sormani, Ludwig Kappos, Jens Kuhle, Cristina Granziera
...
**Comment:** This paper proposes a transformer-based method (SwinUNETR) for efficient and accurate segmentation of the choroid plexus in MRI, with a focus on spatial localization and computational efficiency. While it involves spatial understanding and transformer models, it is primarily a medical imaging application and does not introduce new embodied agent methods or benchmarks. Closest to criterion 1 (spatial understanding), but not in the context of embodied agents.
**Relevance:** 4
**Novelty:** 4
