# Personalized Daily ArXiv Papers 07/02/2026
...
0. [OmniView-Space: Reinforcing Spatial Reasoning via Multi-Perspective Spatial Mapping](#link0)
...
1. [ABot-M0.5: Unified Mobility-and-Manipulation World Action Model](#link1)
...
2. [LeVLJEPA: End-to-End Vision-Language Pretraining Without Negatives](#link2)
**Authors:** Lukas Kuhn, Giuseppe Serra, Randall Balestriero, Florian Buettner

3. [GeoSearcher: Anchor-Guided Progressive Reasoning for Remote Sensing Visual Grounding with Process Supervision](#link3)
**Authors:** Dianyu Wang, Yidan Zhang, Peirong Zhang, Xuyang Li, Xiaoxuan Liu, Lei Wang

4. [PHREEQC-MCQ-200: A Diagnostic Benchmark for Tool-Augmented Scientific Simulator Agents](#link4)
**Authors:** Ke Zhang, Sahchit Chundur, Mohammad Javad Qomi, Maziar Raissi

5. [GenAU: Language-Grounded Industrial Anomaly Understanding with Vision-Language Models](#link5)
**Authors:** Hongkuan Zhou, Tristan Rehm, Nadeem Nazer, Lavdim Halilaj, Jingcheng Wu, Steffen Staab

6. [Radial Interaction Tomography: Recognizing Non-Transitive Evolutionary Games from One Range-Expansion Image](#link6)
**Authors:** Faruk Alpay, Baris Basaran

7. [Synergistic Perception-Reasoning Governance: Grounding Medical MLLMs with Verifiable Anatomical Evidence](#link7)
**Authors:** Rui Hao, Qiankun Li, Junyuan Mao, Linghao Meng, Dirui Xie, Dayu Tan, Zhigang Zeng

8. [LIST3R: Long-sequence Instance-aware 3D Reconstruction](#link8)
**Authors:** Jing Gao, Wei Wang, Feiran Wang, Yan Yan

9. [Robust 3D Alignment of Generative Reconstructions via Partial Monocular Observations](#link9)
...
10. [MoVA: Learning Asymmetric Dual Projections for Modular Long Video-Text Alignment](#link10)
**Authors:** Peiyuan Zhu, Shaoan Xie, Zijian Li, Yifan Shen, Namrata Deka, Harsh Shrivastava, Guangyi Chen, Kun Zhang

11. [AnF-DiffPET: Anatomy- and Frequency-Guided Diffusion for PET/CT Denoising](#link11)
**Authors:** Xuepeng Liu, Ruili Li, Zetong Liu, Renyiming Li, Yan Li, Yin Dai, Chao Li, Yueyang Teng

12. [ConRTF: Edge-Constrained Boundary Distribution Refinement for Realtime TransFormer Table Structure Recognition](#link12)
...
---
## 0. [OmniView-Space: Reinforcing Spatial Reasoning via Multi-Perspective Spatial Mapping](https://arxiv.org/abs/2607.00881) <a id="link0"></a>
**ArXiv ID:** 2607.00881
**Authors:** Xudong Li, Mengdan Zhang, Peixian Chen, Jiaxi Tan, Zihao Huang, Jingyuan Zheng, Yan Zhang, Xiawu Zheng, Xing Sun, Rongrong Ji
...
**Comment:** Strong match to criteria 1 and 2: it targets spatial intelligence for MLLMs and proposes a new spatial reasoning framework with multi-perspective mapping and egocentric tool-guided reasoning.
**Relevance:** 9
**Novelty:** 7

---

## 1. [ABot-M0.5: Unified Mobility-and-Manipulation World Action Model](https://arxiv.org/abs/2607.00678) <a id="link1"></a>
**ArXiv ID:** 2607.00678
**Authors:** Ronghan Chen, Yandan Yang, Zuojin Tang, Dongjie Huo, Tong Lin, Haoning Wu, Haoyun Liu, Yuzhi Chen, Lulu Zheng, Botai Yuan, Tianlun Li, Mingxin Wang, Dekang Qi, Bin Hu, Wei Mei, Yuze Xuan, Haolong Yang, Yanqing Zhu, Mu Xu, Zhiheng Ma, Xinyuan Chang
...
**Comment:** Matches criterion 3 very closely: it is an embodied AI method for mobile manipulation/world action modeling with explicit alignment for long-horizon robot control.
**Relevance:** 8
**Novelty:** 7

---

## 2. [LeVLJEPA: End-to-End Vision-Language Pretraining Without Negatives](https://arxiv.org/abs/2607.00784) <a id="link2"></a>
**ArXiv ID:** 2607.00784
**Authors:** Lukas Kuhn, Giuseppe Serra, Randall Balestriero, Florian Buettner
...
**Comment:** Matches criterion 4 closely: it proposes a new vision-language pretraining method without negatives, with direct implications for vision foundation models and dense semantic features.
**Relevance:** 6
**Novelty:** 7

---

## 3. [GeoSearcher: Anchor-Guided Progressive Reasoning for Remote Sensing Visual Grounding with Process Supervision](https://arxiv.org/abs/2607.01050) <a id="link3"></a>
**ArXiv ID:** 2607.01050
**Authors:** Dianyu Wang, Yidan Zhang, Peirong Zhang, Xuyang Li, Xiaoxuan Liu, Lei Wang
...
**Comment:** Matches criterion 2 and criterion 3 closely: an MLLM-based method for remote sensing visual grounding with progressive reasoning and process supervision, emphasizing a novel spatial localization formulation.
**Relevance:** 7
**Novelty:** 6

---

## 4. [PHREEQC-MCQ-200: A Diagnostic Benchmark for Tool-Augmented Scientific Simulator Agents](https://arxiv.org/abs/2607.00436) <a id="link4"></a>
**ArXiv ID:** 2607.00436
**Authors:** Ke Zhang, Sahchit Chundur, Mohammad Javad Qomi, Maziar Raissi
...
**Comment:** Matches criterion 3: it is a new benchmark for tool-augmented scientific simulator agents, with a diagnostic angle that emphasizes simulator access, failure modes, and protocol sensitivity.
**Relevance:** 6
**Novelty:** 7

---

## 5. [GenAU: Language-Grounded Industrial Anomaly Understanding with Vision-Language Models](https://arxiv.org/abs/2607.01049) <a id="link5"></a>
**ArXiv ID:** 2607.01049
**Authors:** Hongkuan Zhou, Tristan Rehm, Nadeem Nazer, Lavdim Halilaj, Jingcheng Wu, Steffen Staab
...
**Comment:** Matches criterion 1 and 2 quite closely: it is a new VLM-based method for spatial localization/segmentation in industrial anomaly understanding, with language-grounded pixel-level queries.
**Relevance:** 7
**Novelty:** 6

---

## 6. [Radial Interaction Tomography: Recognizing Non-Transitive Evolutionary Games from One Range-Expansion Image](https://arxiv.org/abs/2607.00378) <a id="link6"></a>
**ArXiv ID:** 2607.00378
**Authors:** Faruk Alpay, Baris Basaran
...
**Comment:** Matches criterion 1 in a novel way: this is a computer-vision inverse problem for spatial/mechanistic inference from a single image, with strong emphasis on observability and statistical testing.
**Relevance:** 5
**Novelty:** 7

---

## 7. [Synergistic Perception-Reasoning Governance: Grounding Medical MLLMs with Verifiable Anatomical Evidence](https://arxiv.org/abs/2607.00060) <a id="link7"></a>
**ArXiv ID:** 2607.00060
**Authors:** Rui Hao, Qiankun Li, Junyuan Mao, Linghao Meng, Dirui Xie, Dayu Tan, Zhigang Zeng
...
**Comment:** Matches criterion 2 very closely: it is a medical MLLM method that directly targets hallucination mitigation in visual-language reasoning with training-free evidence injection.
**Relevance:** 6
**Novelty:** 5

---

## 8. [LIST3R: Long-sequence Instance-aware 3D Reconstruction](https://arxiv.org/abs/2607.00375) <a id="link8"></a>
**ArXiv ID:** 2607.00375
**Authors:** Jing Gao, Wei Wang, Feiran Wang, Yan Yan
...
**Comment:** Matches criterion 1 loosely: it is a spatial-memory-inspired 3D reconstruction method with instance-aware long-horizon scene organization, but it is not embodied AI or a VLLM paper.
**Relevance:** 4
**Novelty:** 6

---

## 9. [Robust 3D Alignment of Generative Reconstructions via Partial Monocular Observations](https://arxiv.org/abs/2607.00498) <a id="link9"></a>
**ArXiv ID:** 2607.00498
**Authors:** Yuchen Zhang, Luanyuan Dai, Yiwei Wang, Xiwei Xu, Jianing Zhang, Johnny. r. zhang, Xianhui Meng, Yanbiao Ma, Jiayi Ma, Xiaoshuai Hao
...
**Comment:** Matches criterion 4 somewhat: it uses generative 3D priors and robust alignment for partial monocular observations, which is relevant to vision foundation model applications, though not a foundation model itself.
**Relevance:** 4
**Novelty:** 6

---

## 10. [MoVA: Learning Asymmetric Dual Projections for Modular Long Video-Text Alignment](https://arxiv.org/abs/2607.00858) <a id="link10"></a>
**ArXiv ID:** 2607.00858
**Authors:** Peiyuan Zhu, Shaoan Xie, Zijian Li, Yifan Shen, Namrata Deka, Harsh Shrivastava, Guangyi Chen, Kun Zhang
...
**Comment:** Matches criterion 4 weakly: it is a vision-text representation learning paper and could be useful for vision foundation model alignment, but it is not a foundation model itself.
**Relevance:** 4
**Novelty:** 6

---

## 11. [AnF-DiffPET: Anatomy- and Frequency-Guided Diffusion for PET/CT Denoising](https://arxiv.org/abs/2607.00509) <a id="link11"></a>
**ArXiv ID:** 2607.00509
**Authors:** Xuepeng Liu, Ruili Li, Zetong Liu, Renyiming Li, Yan Li, Yin Dai, Chao Li, Yueyang Teng
...
**Comment:** Matches criterion 4 moderately: a vision-foundation-style anatomical guidance framework applied to PET/CT denoising with diffusion models, though it is a domain-specific medical imaging method.
**Relevance:** 4
**Novelty:** 5

---

## 12. [ConRTF: Edge-Constrained Boundary Distribution Refinement for Realtime TransFormer Table Structure Recognition](https://arxiv.org/abs/2607.00734) <a id="link12"></a>
**ArXiv ID:** 2607.00734
**Authors:** Eliott Thomas, Tri-Cong Pham, Mickael Coustaty, Aurelie Joseph, Gaspar Deloin, Vincent Poulain d'Andecy, Jean-Marc Ogier, Antoine Doucet
...
**Comment:** Matches criterion 3 weakly: it is a new method for table structure recognition in document images, but not an embodied-AI benchmark or spatial-intelligence paper.
**Relevance:** 3
**Novelty:** 3
