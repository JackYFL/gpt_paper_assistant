...
0. [Stream3D-VLM: Online 3D Spatial Understanding with Incremental Geometry Priors](#link0)
**Authors:** Hanxun Yu, Xuan Qu, Lei Ke, Boqiang Zhang, Yuxin Wang, Jianke Zhu, Dong Yu

1. [Skill-3D: Evolving Scene-Aware Skills for Agentic 3D Spatial Reasoning](#link1)
**Authors:** Haoyuan Li, Zhengdong Hu, Jun Wang, Hehe Fan, Yi Yang

2. [AnchorWorld: Embodied Egocentric World Simulation with View-based Evolution Customization](#link2)
...
3. [EgoPressDiff: Multimodal Video Diffusion for Egocentric UV-Domain Hand-Pressure Estimation](#link3)
**Authors:** Yuan Zeng, Zilue Gao, Yujia Shi, Zongqing Lu, Wenming Yang, QingMin Liao

4. [Watch, Remember, Reason: Human-View Video Understanding with MLLMs](#link4)
...
5. [CL-CLIP: CLIP-Based Continual Learning Framework with Cost-Volume Category Decoupling for Object Detection](#link5)
**Authors:** Zihan Liu, Yuguang Yang, Shengjie Su, Jianing Pang, Linlin Yang, Chunyu Xie, Nikolai Yu. Zolotykh, Baochang Zhang

6. [AEGIS: A Backup Reflex for Physical AI](#link6)
**Authors:** Josef Chen

7. [Geometric-Aware Hypergraph Reasoning for Novel Class Discovery in Point Cloud Segmentation](#link7)
**Authors:** Zihao Zhang, Aming Wu, Yang Li, Yahong Han, Jialie Shen

8. [Unified Safe In-context Image Generation in Multimodal Diffusion Transformers via Restricting Unsafe Information Flows](#link8)
**Authors:** Xiang Yang, Feifei Li, Mi Zhang, Geng Hong, Xiaoyu You, Mi Wen, Min Yang

9. [Direct 3D-Aware Object Insertion via Decomposed Visual Proxies](#link9)
**Authors:** Jingbo Gong, Yikai Wang, Yushi Lan, Yuhao Wan, Ziheng Ouyang, Rui Zhao, Ming-Ming Cheng, Qibin Hou, Chen Change Loy

10. [MMBU: A Massive Multi-modal Biomedical Understanding Benchmark to Probe the Perception Capabilities of Vision-Language Models](#link10)
...
11. [Beyond Skeletons: Learning Animation Directly from Driving Videos with Same2X Training Strategy](#link11)
**Authors:** Yuan Zeng, Yujia Shi, Yuhao Yang, Dongxia Liu, Zongqing Lu, Wenming Yang, Qingmin Liao

12. [Lighting-Aware Representation Learning under Controllable Lighting Variation](#link12)
**Authors:** Lizhen Zhu, Charantej Reddy Pochimireddy, James Z Wang, Brad Wyble

13. [RealDocBench: A Benchmark for Field-Level QA and Layout Understanding on Real-World Regulated Documents](#link13)
**Authors:** Ameya Joshi, Joon Kim, Gus Eggert, Joseph Bajor, Cindy Hao, Jing Reyhan, Kushal Byatnal, Eli Badgio

14. [AdaGRPO: A Capability-Aware Adaptive Enhancement for Flow-based GRPO](#link14)
...
15. [Evidence-Based Intelligent Diagnostic and Therapeutic Visualization System with Large Language Models: Multi-Turn Interaction and Multimodal Treatment Plan Generation](#link15)
**Authors:** Yunhan Wang, Yuda Wang, Zhiying Tu, Mingqiang Song, Li Song, Kun Li, Dianhui Chu, Bolin Zhang

16. [Declarative Skills for AI Agents in Knowledge-Grounded Tool-Use Workflows](#link16)
**Authors:** M. Danish Lim, I. Danial Bin Sharudin, Wen Han Chen, Cedric Lim, Laura Wynter

17. [Think Fast: Estimating No-CoT Task-Completion Time Horizons of Frontier AI Models](#link17)
...
---
## 0. [Stream3D-VLM: Online 3D Spatial Understanding with Incremental Geometry Priors](https://arxiv.org/abs/2606.06891) <a id="link0"></a>
**ArXiv ID:** 2606.06891
**Authors:** Hanxun Yu, Xuan Qu, Lei Ke, Boqiang Zhang, Yuxin Wang, Jianke Zhu, Dong Yu
...
**Comment:** Strongly matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 2 (new VLLM/MLLM for 3D spatial understanding). Also matches criterion 3 (new benchmark for online 3D spatial understanding with streaming data). The paper introduces an online 3D vision-language model with novel modules for geometry priors and efficient token compression, and establishes a new benchmark.
**Relevance:** 10
**Novelty:** 8

---

## 1. [Skill-3D: Evolving Scene-Aware Skills for Agentic 3D Spatial Reasoning](https://arxiv.org/abs/2606.07436) <a id="link1"></a>
**ArXiv ID:** 2606.07436
**Authors:** Haoyuan Li, Zhengdong Hu, Jun Wang, Hehe Fan, Yi Yang
...
**Comment:** Matches criterion 1 (spatial understanding on embodied agents) and criterion 3 (embodied AI, new methods): Proposes Skill-3D, a framework for evolving scene-aware skills for agentic 3D spatial reasoning, with memory and skill library co-evolution. Strong focus on spatial intelligence and novel agentic learning in 3D environments.
**Relevance:** 10
**Novelty:** 8

---

## 2. [AnchorWorld: Embodied Egocentric World Simulation with View-based Evolution Customization](https://arxiv.org/abs/2606.07326) <a id="link2"></a>
**ArXiv ID:** 2606.07326
**Authors:** Yu Li, Menghan Xia, Gongye Liu, Xintao Wang, Conglang Zhang, Lei Ke, Yuxuan Lin, Ruihang Chu, Pengfei Wan, Kun Gai, Yujiu Yang
...
**Comment:** Matches criterion 3 (embodied AI, new benchmarks/simulators): Presents AnchorWorld, a framework for embodied egocentric world simulation with view-based evolution customization, using 3D human motion and anchor views for robust spatial grounding and world customization. Strong focus on simulation and spatial intelligence.
**Relevance:** 9
**Novelty:** 8

---

## 3. [EgoPressDiff: Multimodal Video Diffusion for Egocentric UV-Domain Hand-Pressure Estimation](https://arxiv.org/abs/2606.06872) <a id="link3"></a>
**ArXiv ID:** 2606.06872
**Authors:** Yuan Zeng, Zilue Gao, Yujia Shi, Zongqing Lu, Wenming Yang, QingMin Liao
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 4 (vision foundation models and applications). Introduces a multimodal video diffusion model for egocentric hand-pressure estimation, with a novel feature fusion layer and strong empirical results.
**Relevance:** 8
**Novelty:** 8

---

## 4. [Watch, Remember, Reason: Human-View Video Understanding with MLLMs](https://arxiv.org/abs/2606.07433) <a id="link4"></a>
**ArXiv ID:** 2606.07433
**Authors:** Jiahao Meng, Yue Tan, Qi Xu, Kuan Gao, Weisong Liu, Yanwei Li, Jason Li, Lingdong Kong, Haochen Wang, Qianyu Zhou, Jiangning Zhang, Guangliang Cheng, Yunhai Tong, Lu Qi, Minghsuan Yang
...
**Comment:** Strongly matches criterion 2 (new MLLMs for video understanding) and criterion 4 (vision foundation models and applications). The paper provides a comprehensive review and new formulation for video MLLMs, focusing on spatio-temporal perception, memory, and reasoning.
**Relevance:** 9
**Novelty:** 7

---

## 5. [CL-CLIP: CLIP-Based Continual Learning Framework with Cost-Volume Category Decoupling for Object Detection](https://arxiv.org/abs/2606.06978) <a id="link5"></a>
**ArXiv ID:** 2606.06978
**Authors:** Zihan Liu, Yuguang Yang, Shengjie Su, Jianing Pang, Linlin Yang, Chunyu Xie, Nikolai Yu. Zolotykh, Baochang Zhang
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 2 (CLIP-based continual learning for object detection, leveraging vision-language models). The use of cost-volume category decoupling and CLIP-based spatial priors is a novel approach for continual object detection.
**Relevance:** 8
**Novelty:** 7

---

## 6. [AEGIS: A Backup Reflex for Physical AI](https://arxiv.org/abs/2606.06660) <a id="link6"></a>
**ArXiv ID:** 2606.06660
**Authors:** Josef Chen
...
**Comment:** Matches criterion 3 (embodied AI, new methods): Introduces AEGIS, a backup reflex system for physical AI agents to recover from failure in long-horizon robot manipulation, using activation probes and selective policy switching. Presents a novel method for embodied AI robustness.
**Relevance:** 8
**Novelty:** 7

---

## 7. [Geometric-Aware Hypergraph Reasoning for Novel Class Discovery in Point Cloud Segmentation](https://arxiv.org/abs/2606.07280) <a id="link7"></a>
**ArXiv ID:** 2606.07280
**Authors:** Zihao Zhang, Aming Wu, Yang Li, Yahong Han, Jialie Shen
...
**Comment:** Matches criterion 1 (spatial understanding on embodied agents): Proposes a hypergraph-based framework for novel class discovery in point cloud segmentation, with geometric-aware prototypes for better spatial structure exploitation. Strong focus on spatial intelligence and geometric reasoning.
**Relevance:** 8
**Novelty:** 7

---

## 8. [Unified Safe In-context Image Generation in Multimodal Diffusion Transformers via Restricting Unsafe Information Flows](https://arxiv.org/abs/2606.06875) <a id="link8"></a>
**ArXiv ID:** 2606.06875
**Authors:** Xiang Yang, Feifei Li, Mi Zhang, Geng Hong, Xiaoyu You, Mi Wen, Min Yang
...
**Comment:** Matches criterion 2 (VLLMs/MLLMs): Proposes a new safety regulator for multimodal diffusion transformers (DiTs) in image generation, focusing on attention dynamics and information flow in MM-Attn. Also relevant to criterion 4 (vision foundation models and applications) as it addresses safety in state-of-the-art image generation models.
**Relevance:** 8
**Novelty:** 7

---

## 9. [Direct 3D-Aware Object Insertion via Decomposed Visual Proxies](https://arxiv.org/abs/2606.06601) <a id="link9"></a>
**ArXiv ID:** 2606.06601
**Authors:** Jingbo Gong, Yikai Wang, Yushi Lan, Yuhao Wan, Ziheng Ouyang, Rui Zhao, Ming-Ming Cheng, Qibin Hou, Chen Change Loy
...
**Comment:** Matches criterion 4 (vision foundation models and applications) by introducing a new method for 3D-aware object insertion using decomposed visual proxies. The approach is relevant for generative modeling and spatial control in vision.
**Relevance:** 6
**Novelty:** 7

---

## 10. [MMBU: A Massive Multi-modal Biomedical Understanding Benchmark to Probe the Perception Capabilities of Vision-Language Models](https://arxiv.org/abs/2606.06696) <a id="link10"></a>
**ArXiv ID:** 2606.06696
**Authors:** Ryan D'Cunha, Alejandro Lozano, Xiaoxiao Sun, Daniel Vela Jarquin, Min Woo Sun, Josiah Aklilu, James Burgess, Yuhui Zhang, Ryan Nayebi, Paola Avila, Robayo, Jin Ye, Ming Hu, Zhongying Deng, Junjun He, Xin Chen, Yue Yao, Robert Tibshirani, Jeffrey J. Nirschl, Serena Yeung-Levy
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and partially criterion 2 (evaluates VLMs on a new large-scale biomedical benchmark). The focus is on benchmarking VLMs in biomedical imaging, which is a novel application area.
**Relevance:** 6
**Novelty:** 7

---

## 11. [Beyond Skeletons: Learning Animation Directly from Driving Videos with Same2X Training Strategy](https://arxiv.org/abs/2606.06903) <a id="link11"></a>
**ArXiv ID:** 2606.06903
**Authors:** Yuan Zeng, Yujia Shi, Yuhao Yang, Dongxia Liu, Zongqing Lu, Wenming Yang, Qingmin Liao
...
**Comment:** Related to criterion 4 (vision foundation models and applications): Proposes DirectAnimator, a framework for human image animation directly from driving videos, bypassing pose extraction and using a novel training strategy. Focuses on generative modeling in vision.
**Relevance:** 6
**Novelty:** 7

---

## 12. [Lighting-Aware Representation Learning under Controllable Lighting Variation](https://arxiv.org/abs/2606.06899) <a id="link12"></a>
**ArXiv ID:** 2606.06899
**Authors:** Lizhen Zhu, Charantej Reddy Pochimireddy, James Z Wang, Brad Wyble
...
**Comment:** Matches criterion 4 (vision foundation models and applications) by proposing a lighting-aware representation learning framework that could improve robustness of vision models. The approach is a methodological improvement in visual representation learning, but not specifically for embodied agents or VLLMs.
**Relevance:** 5
**Novelty:** 6

---

## 13. [RealDocBench: A Benchmark for Field-Level QA and Layout Understanding on Real-World Regulated Documents](https://arxiv.org/abs/2606.07401) <a id="link13"></a>
**ArXiv ID:** 2606.07401
**Authors:** Ameya Joshi, Joon Kim, Gus Eggert, Joseph Bajor, Cindy Hao, Jing Reyhan, Kushal Byatnal, Eli Badgio
...
**Comment:** Matches criterion 4 (vision foundation models and applications) as it evaluates VLMs and parsing APIs on a new real-world document benchmark. The focus is on document parsing, which is tangential to spatial intelligence but relevant for vision-language evaluation.
**Relevance:** 5
**Novelty:** 6

---

## 14. [AdaGRPO: A Capability-Aware Adaptive Enhancement for Flow-based GRPO](https://arxiv.org/abs/2606.06828) <a id="link14"></a>
**ArXiv ID:** 2606.06828
**Authors:** Jiazi Bu, Pengyang Ling, Yujie Zhou, Yibin Wang, Yuhang Zang, Tianyi Wei, Xiaohang Zhan, Jiaqi Wang, Tong Wu, Xingang Pan, Dahua Lin
...
**Comment:** Somewhat related to criterion 2 (VLLMs/MLLMs): Proposes a new RL algorithm for aligning text-to-image flow models with human preferences, focusing on adaptive prompt selection and advantage estimation. While not a new VLLM, it is a methodological improvement for generative models in vision-language tasks.
**Relevance:** 5
**Novelty:** 6

---

## 15. [Evidence-Based Intelligent Diagnostic and Therapeutic Visualization System with Large Language Models: Multi-Turn Interaction and Multimodal Treatment Plan Generation](https://arxiv.org/abs/2606.06869) <a id="link15"></a>
**ArXiv ID:** 2606.06869
**Authors:** Yunhan Wang, Yuda Wang, Zhiying Tu, Mingqiang Song, Li Song, Kun Li, Dianhui Chu, Bolin Zhang
...
**Comment:** Somewhat related to criterion 2 (VLLMs/MLLMs): Uses large language models and multimodal interaction for diagnostic and therapeutic visualization, but the main focus is on medical applications rather than core vision-language modeling or spatial intelligence.
**Relevance:** 4
**Novelty:** 5

---

## 16. [Declarative Skills for AI Agents in Knowledge-Grounded Tool-Use Workflows](https://arxiv.org/abs/2606.06923) <a id="link16"></a>
**ArXiv ID:** 2606.06923
**Authors:** M. Danish Lim, I. Danial Bin Sharudin, Wen Han Chen, Cedric Lim, Laura Wynter
...
**Comment:** Somewhat related to criterion 2 (VLLMs/MLLMs): Discusses orchestration mechanisms for tool-using AI agents in knowledge-grounded workflows, comparing declarative and imperative agent paradigms. Focuses on language models and retrieval, but not specifically vision or multi-modal models.
**Relevance:** 4
**Novelty:** 5

---

## 17. [Think Fast: Estimating No-CoT Task-Completion Time Horizons of Frontier AI Models](https://arxiv.org/abs/2606.07157) <a id="link17"></a>
**ArXiv ID:** 2606.07157
**Authors:** Dewi Gould, Francis Rhys Ward, Anders Cairns Woodruff, Rauno Arike, Josh Hills, Alex Serrano, Ida Caspary, Jason Ross Brown, Jo J. Jiao, Patrick Leask, Twm Stone, Ram Potham, Ionut Gabriel Stan, Harry Mayne, Simeon Hellsten, Shubhorup Biswas, Ariana Azarbal, William L. Anderson, Elle Najt, Ryan Greenblatt, Julian Stastny
...
**Comment:** Not directly related to any criterion: Focuses on measuring reasoning abilities and time horizons of frontier AI models without chain-of-thought, across various domains. No specific focus on spatial, vision, or embodied AI.
**Relevance:** 3
**Novelty:** 5
