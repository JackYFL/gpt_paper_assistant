...
0. [Scaling Mixture-of-Experts Video Pretraining for Embodied Intelligence](#link0)
...
**Comment:** Strong match to criterion 4 and partly criterion 3: it proposes a large-scale video foundation model tailored for embodied intelligence, with MoE pretraining and robot-oriented data.
**Relevance:** 9
**Novelty:** 8

---

## 1. [SpaR3D-MoE: Adaptive 3D Spatial Reasoning from Sparse Views Meets Geometry-Inductive Mixture-of-Experts](https://arxiv.org/abs/2607.06620) <a id="link1"></a>
**ArXiv ID:** 2607.06620
**Authors:** Haida Feng, Hao Wei, Haolin Wang, Shiwei Li, Chade Li, Yihong Wu
...
**Comment:** Strong match to criterion 1 and criterion 2: it targets 3D spatial reasoning for MLLMs from sparse views, with geometry-aware routing and adaptive spatial reasoning.
**Relevance:** 9
**Novelty:** 7

---

## 2. [PUF: Plug-and-Play Uncertainty-Aware Fusion for Online 3D Scene Graph Generation](https://arxiv.org/abs/2607.07170) <a id="link2"></a>
**ArXiv ID:** 2607.07170
**Authors:** Yi Yang, Myrna Castillo, Bodo Rosenhahn, Michael Ying Yang
...
**Comment:** Strong match to criterion 3: it addresses online 3D scene graph generation, an embodied/3D scene understanding setting, with a novel uncertainty-aware fusion approach.
**Relevance:** 8
**Novelty:** 6

---

## 3. [BUS: Brain-Inspired Unsupervised Self-Reflection for Advanced Multimodal Reasoning](https://arxiv.org/abs/2607.07361) <a id="link3"></a>
**ArXiv ID:** 2607.07361
**Authors:** Jiacheng Yang, Tongying Xiao, Yunkai Dang, Cong Wang, Yuekun Yang, Qi Fan, Wenbin Li, Feng Miao, Yang Gao
...
**Comment:** Strong match to criterion 2: it proposes a new method to improve VLM multimodal reasoning via label-free self-reflection and backward prediction.
**Relevance:** 8
**Novelty:** 6

---

## 4. [DiffCVE: Diffusion-based Compressed Video Enhancement](https://arxiv.org/abs/2607.07195) <a id="link4"></a>
**ArXiv ID:** 2607.07195
**Authors:** Wenqiang Xiao, Wenzhuo Ma, Junxi Zhang, Zhenzhong Chen
...
**Comment:** Strong match to criterion 4: it is a diffusion-based video restoration/enhancement method, i.e. a vision foundation-model-style generative application.
**Relevance:** 6
**Novelty:** 6

---

## 5. [A Theory of Contrastive Learning with Natural Images](https://arxiv.org/abs/2607.07470) <a id="link5"></a>
**ArXiv ID:** 2607.07470
**Authors:** Antonio Torralba, Yair Weiss
...
**Comment:** No direct match to the criteria, but it is highly relevant to your friend's taste in clever statistical/representation-learning results: a theory paper explaining contrastive learning with natural images.
**Relevance:** 3
**Novelty:** 7

---

## 6. [CoMind: Understanding Collaborative Human Activity from Multiple Minds and Views](https://arxiv.org/abs/2607.06691) <a id="link6"></a>
**ArXiv ID:** 2607.06691
**Authors:** Alexey Gavryushin, Dingxi Zhang, Zhao Huang, Alexandros Delitzas, Jiaqi Chen, Ben Ellis, Cedric Z\"ollner, Manthan Patel, Manuel Kaufmann, Marc Pollefeys, Xi Wang
...
**Comment:** Matches criterion 3 only loosely: it builds a new multimodal collaboration benchmark with egocentric/exocentric video, gaze, audio, and 3D scans for joint attention and handover prediction. It is more about human collaboration than embodied agents.
**Relevance:** 4
**Novelty:** 6

---

## 7. [Prototype-Anchored Generalized Manifold Regression for Unknown-Domain Object Detection](https://arxiv.org/abs/2607.07192) <a id="link7"></a>
**ArXiv ID:** 2607.07192
**Authors:** Zihao Zhang, Aming Wu, Yang Li, Yahong Han
...
**Comment:** No direct match to the listed criteria, but it is a method paper with a novel VLM-guided + diffusion-based generalization scheme for object detection, which may appeal to someone interested in clever vision ML methods.
**Relevance:** 3
**Novelty:** 6

---

## 8. [ColorFM: An Optimization-to-Learning Framework for Color Transfer via Flow Matching](https://arxiv.org/abs/2607.07119) <a id="link8"></a>
**ArXiv ID:** 2607.07119
**Authors:** Yuhang He, Kai Zhang, Xiaoming Li, Du Chen, Jian Yang
...
**Comment:** No direct match to the listed criteria, but it is a generative-modeling-flavored vision method using flow matching for color transfer, which may be interesting for multimodal/generative modeling interests.
**Relevance:** 3
**Novelty:** 5

---

## 9. [SoccerNet 2026 Challenges Results](https://arxiv.org/abs/2607.07320) <a id="link9"></a>
**ArXiv ID:** 2607.07320
**Authors:** Anthony Cioppa, Silvio Giancola, H{\aa}kan Ard\"o, Mohamad Dalal, Jan Held, J\'er\'emie Ochin, Jiayuan Rao, Karen Sanchez, Renaud Vandeghen, Artur Xarles, Olivier Barnich, Albert Clap\'es, Mathieu Delvaux, Sergio Escalera, Bernard Ghanem, C\'edric Hons, Antoine Houet, Sotiris Manitsaris, Tom Michel, Pierre Miralles, Thomas B. Moeslund, Mikael Nilsson, Bogdan Stanciulescu, Marc Van Droogenbroeck, Yanfeng Wang, Weidi Xie, Faisal Altawijri, Mohamed Atef, Semen Budennyy, Vasiliy Chelpanov, Puhua Chen, Yixin Chen, Lechao Cheng, Jianling Chu, Ju-Seong Do, Oleg Durygin, Omar Fetouh, Mirco Fuchs, Youssef Ghallab, Falguni Ghosh, Wonjun Heo, Yufeng Hu, Weixuan Huang, Phuong-Linh Huynh-Ha, Matvey Isupov, Yangguang Ji, Siyuan Jiang, Zhenxiang Jiang, Wonyong Jo, Ho-Young Jung, SeongHeon Kang, MinJae Kim, Youngseon Kim, Jakub Komosa, Artem Konshin, Trung-Hoang Le, Jongmin Lee, Lingling Li, Litao Li, Vadim Linkov, Fang Liu, Haoxuan Ma, Shun Makino, Ismail Mathkour, Konstantin Mitin, Mikhail Moiseev, Takumi Nagaya, Yuki Nakamura, Thanh-Khoi Nguyen, Hoang-Phuc Nguyen, Trong-Thuan Nguyen, Christian Orduz, Kwanyong Park, Fabian Perez, Parthsarthi Rawat, SuHyun Rim, Hoover Rueda-Chac\'on, Atom Scott, Minori Sugimura, Yuyang Sun, Shengeng Tang, Minh-Triet Tran, Ikuma Uchida, Juan Vanegas, Thanh-Nhan Vo, Jiangtao Wang, Yaxiong Wang, Xiaogang Wang, Ruifeng Wang, Rio Watanabe, Jiali Wen, Yongliang Wu, Di Yang, Xu Yang, Zhuo Yang, Xinyu Ye, Yibo Yu, Zihan Zhai, Yu Zhang, Zhenyu Zhao, Zhun Zhong, Yixi Zhou, Xingyu Zhu, Wenbo Zhu, Julian Ziegler
...
**Comment:** Matches criterion 3 very closely: this is a benchmark/challenge paper for embodied-like visual understanding tasks, including novel view synthesis, spatial localization, and video VQA, with unified evaluation protocols and baselines.
**Relevance:** 5
**Novelty:** 3

---

## 10. [`Attention-Guided Cross-Temporal Clustering for Self-Supervised Video Object Segmentation](https://arxiv.org/abs/2607.07230) <a id="link10"></a>
**ArXiv ID:** 2607.07230
**Authors:** Waqas Arshid, Mohammad Awrangjeb, Alan Wee-Chung Liew, Yongsheng Gao
...
**Comment:** No strong match to criteria 1-4; this is a self-supervised video object segmentation method, which is adjacent to vision but not clearly a spatial intelligence/embodied AI or VLLM/MLLM paper.
**Relevance:** 3
**Novelty:** 4
