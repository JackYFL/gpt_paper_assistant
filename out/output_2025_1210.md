...
0. [FRIEDA: Benchmarking Multi-Step Cartographic Reasoning in Vision-Language Models](#link0)
...
1. [No Labels, No Problem: Training Visual Reasoners with Multimodal Verifiers](#link1)
**Authors:** Damiano Marsili, Georgia Gkioxari

2. [Towards Effective and Efficient Long Video Understanding of Multimodal Large Language Models via One-shot Clip Retrieval](#link2)
**Authors:** Tao Chen, Shaobo Ju, Qiong Wu, Chenxin Fang, Kun Zhang, Jun Peng, Hui Li, Yiyi Zhou, Rongrong Ji

3. [TrackingWorld: World-centric Monocular 3D Tracking of Almost All Pixels](#link3)
**Authors:** Jiahao Lu, Weitao Xiong, Jiacheng Deng, Peng Li, Tianyu Huang, Zhiyang Dou, Cheng Lin, Sai-Kit Yeung, Yuan Liu

4. [MM-CoT:A Benchmark for Probing Visual Chain-of-Thought Reasoning in Multimodal Models](#link4)
...
5. [Same Content, Different Answers: Cross-Modal Inconsistency in MLLMs](#link5)
**Authors:** Angela van Sprang, Laurens Samson, Ana Lucic, Erman Acar, Sennay Ghebreab, Yuki M. Asano

6. [Prismatic World Model: Learning Compositional Dynamics for Planning in Hybrid Systems](#link6)
**Authors:** Mingwei Li, Xiaoyuan Zhang, Chengwei Yang, Zilong Zheng, Yaodong Yang

7. [HybridToken-VLM: Hybrid Token Compression for Vision-Language Models](#link7)
**Authors:** Jusheng Zhang, Xiaoyang Guo, Kaitong Cai, Qinhan Lv, Yijia Fan, Wenhao Chai, Jian Wang, Keze Wang

8. [EgoX: Egocentric Video Generation from a Single Exocentric Video](#link8)
**Authors:** Taewoong Kang, Kinam Kim, Dohyeon Kim, Minho Park, Junha Hyung, Jaegul Choo

9. [SATGround: A Spatially-Aware Approach for Visual Grounding in Remote Sensing](#link9)
**Authors:** Aysim Toker, Andreea-Maria Oncescu, Roy Miles, Ismail Elezi, Jiankang Deng

10. [On-the-fly Large-scale 3D Reconstruction from Multi-Camera Rigs](#link10)
**Authors:** Yijia Guo, Tong Hu, Zhiwei Li, Liwen Hu, Keming Qian, Xitong Lin, Shengbo Chen, Tiejun Huang, Lei Ma

11. [Efficiently Reconstructing Dynamic Scenes One D4RT at a Time](#link11)
...
12. [Generation is Required for Data-Efficient Perception](#link12)
**Authors:** Jack Brady, Bernhard Sch\"olkopf, Thomas Kipf, Simon Buchholz, Wieland Brendel

13. [Towards a Science of Scaling Agent Systems](#link13)
...
14. [MVP: Multiple View Prediction Improves GUI Grounding](#link14)
**Authors:** Yunzhu Zhang, Zeyu Pan, Zhengwen Zeng, Shuheng Shen, Changhua Meng, Linchao Zhu

15. [EcomBench: Towards Holistic Evaluation of Foundation Agents in E-commerce](#link15)
**Authors:** Rui Min (May), Zile Qiao (May), Ze Xu (May), Jiawen Zhai (May), Wenyu Gao (May), Xuanzhong Chen (May), Haozhen Sun (May), Zhen Zhang (May), Xinyu Wang (May), Hong Zhou (May), Wenbiao Yin (May), Xuan Zhou (May), Yong Jiang (May), Haicheng Liu (May), Liang Ding (May), Ling Zou (May), Yi R. (May), Fung, Yalong Li, Pengjun Xie

16. [Disrupting Hierarchical Reasoning: Adversarial Protection for Geographic Privacy in Multimodal Reasoning Models](#link16)
**Authors:** Jiaming Zhang, Che Wang, Yang Cao, Longtao Huang, Wei Yang Bryan Lim

17. [Beyond Real Weights: Hypercomplex Representations for Stable Quantization](#link17)
...
18. [Towards Foundation Models with Native Multi-Agent Intelligence](#link18)
**Authors:** Shuyue Hu, Haoyang Yan, Yiqun Zhang, Yang Chen, Dongzhan Zhou, Lei Bai

19. [Chain-of-Image Generation: Toward Monitorable and Controllable Image Generation](#link19)
**Authors:** Young Kyung Kim, Oded Schlesinger, Yuzhou Zhao, J. Matias Di Martino, Guillermo Sapiro

20. [OpenSubject: Leveraging Video-Derived Identity and Diversity Priors for Subject-driven Image Generation and Manipulation](#link20)
...
21. [Thinking with Images via Self-Calling Agent](#link21)
**Authors:** Wenxi Yang, Yuzhong Zhao, Fang Wan, Qixiang Ye

22. [Photo3D: Advancing Photorealistic 3D Generation through Structure-Aligned Detail Enhancement](#link22)
**Authors:** Xinyue Liang, Zhinyuan Ma, Lingchen Sun, Yanjun Guo, Lei Zhang

23. [FastBEV++: Fast by Algorithm, Deployable by Design](#link23)
**Authors:** Yuanpeng Chen, Hui Song, Wei Tao, ShanHui Mo, Shuang Zhang, Xiao Hua, TianKun Zhao

24. [VisKnow: Constructing Visual Knowledge Base for Object Understanding](#link24)
**Authors:** Ziwei Yao, Qiyang Wan, Ruiping Wang, Xilin Chen

25. [Visionary: The World Model Carrier Built on WebGPU-Powered Gaussian Splatting Platform](#link25)
...
26. [Fast-ARDiff: An Entropy-informed Acceleration Framework for Continuous Space Autoregressive Generation](#link26)
**Authors:** Zhen Zou, Xiaoxiao Ma, Jie Huang, Zichao Yu, Feng Zhao

27. [Repulsor: Accelerating Generative Modeling with a Contrastive Memory Bank](#link27)
...
28. [GeoDM: Geometry-aware Distribution Matching for Dataset Distillation](#link28)
**Authors:** Xuhui Li, Zhengquan Luo, Zihui Cui, Zhiqiang Xu

29. [Dual-Branch Center-Surrounding Contrast: Rethinking Contrastive Learning for 3D Point Clouds](#link29)
**Authors:** Shaofeng Zhang, Xuanqi Chen, Xiangdong Zhang, Sitong Wu, Junchi Yan

30. [Distilling Future Temporal Knowledge with Masked Feature Reconstruction for 3D Object Detection](#link30)
**Authors:** Haowen Zheng, Hu Zhu, Lu Deng, Weihao Gu, Yang Yang, Yanyan Liang

31. [SegEarth-OV3: Exploring SAM 3 for Open-Vocabulary Semantic Segmentation in Remote Sensing Images](#link31)
**Authors:** Kaiyu Li, Shengqi Zhang, Yupeng Deng, Zhi Wang, Deyu Meng, Xiangyong Cao

32. [Modular Neural Image Signal Processing](#link32)
**Authors:** Mahmoud Afifi, Zhongling Wang, Ran Zhang, Michael S. Brown

33. [DINO-BOLDNet: A DINOv3-Guided Multi-Slice Attention Network for T1-to-BOLD Generation](#link33)
**Authors:** Jianwei Wang, Qing Wang, Menglan Ruan, Rongjun Ge, Chunfeng Yang, Yang Chen, Chunming Xie

34. [SFP: Real-World Scene Recovery Using Spatial and Frequency Priors](#link34)
**Authors:** Yun Liu, Tao Li, Cosmin Ancuti, Wenqi Ren, Weisi Lin

35. [Interpreting Structured Perturbations in Image Protection Methods for Diffusion Models](#link35)
**Authors:** Michael R. Martin, Garrick Chan, Kwan-Liu Ma

36. [ContextDrag: Precise Drag-Based Image Editing via Context-Preserving Token Injection and Position-Consistent Attention](#link36)
**Authors:** Huiguo He, Pengyu Yan, Ziqi Yi, Weizhi Zhong, Zheng Liu, Yejun Tang, Huan Yang, Kun Gai, Guanbin Li, Lianwen Jin

37. [PaintFlow: A Unified Framework for Interactive Oil Paintings Editing and Generation](#link37)
**Authors:** Zhangli Hu, Ye Chen, Jiajun Yao, Bingbing Ni

38. [Uncertainty-Aware Subset Selection for Robust Visual Explainability under Distribution Shifts](#link38)
**Authors:** Madhav Gupta, Vishak Prasad C, Ganesh Ramakrishnan

39. [Skewness-Guided Pruning of Multimodal Swin Transformers for Federated Skin Lesion Classification on Edge Devices](#link39)
**Authors:** Kuniko Paxton, Koorosh Aslansefat, Dhavalkumar Thakker, Yiannis Papadopoulos

40. [Query-aware Hub Prototype Learning for Few-Shot 3D Point Cloud Semantic Segmentation](#link40)
**Authors:** YiLin Zhou, Lili Wei, Zheming Xu, Ziyi Chen, Congyan Lang

41. [HybridSplat: Fast Reflection-baked Gaussian Tracing using Hybrid Splatting](#link41)
**Authors:** Chang Liu, Hongliang Yuan, Lianghao Zhang, Sichao Wang, Jianwei Guo, Shi-Sheng Huang

42. [Accuracy Does Not Guarantee Human-Likeness in Monocular Depth Estimators](#link42)
**Authors:** Yuki Kubota, Taiki Fukiage

43. [Simultaneous Enhancement and Noise Suppression under Complex Illumination Conditions](#link43)
**Authors:** Jing Tao, You Li, Banglei Guan, Yang Shang, Qifeng Yu

44. [New VVC profiles targeting Feature Coding for Machines](#link44)
**Authors:** Md Eimran Hossain Eimon, Ashan Perera, Juan Merlos, Velibor Adzic, Hari Kalva

45. [Can AI autonomously build, operate, and use the entire data stack?](#link45)
**Authors:** Arvind Agarwal, Lisa Amini, Sameep Mehta, Horst Samulowitz, Kavitha Srinivas

46. [Preserving Source Video Realism: High-Fidelity Face Swapping for Cinematic Quality](#link46)
**Authors:** Zekai Luo, Zongze Du, Zhouhang Zhu, Hao Zhong, Muzhi Zhu, Wen Wang, Yuling Xi, Chenchen Jing, Hao Chen, Chunhua Shen

47. [What really matters for person re-identification? A Mixture-of-Experts Framework for Semantic Attribute Importance](#link47)
**Authors:** Athena Psalta, Vasileios Tsironis, Konstantinos Karantzalos

48. [A Practical Guide for Designing, Developing, and Deploying Production-Grade Agentic AI Workflows](#link48)
...
49. [Animal Re-Identification on Microcontrollers](#link49)
**Authors:** Yubo Chen, Di Zhao, Yun Sing Koh, Talia Xu

50. [SSplain: Sparse and Smooth Explainer for Retinopathy of Prematurity Classification](#link50)
**Authors:** Elifnur Sunger, Tales Imbiriba, Peter Campbell, Deniz Erdogmus, Stratis Ioannidis, Jennifer Dy

---
## 0. [FRIEDA: Benchmarking Multi-Step Cartographic Reasoning in Vision-Language Models](https://arxiv.org/abs/2512.08016) <a id="link0"></a>
**ArXiv ID:** 2512.08016
**Authors:** Jiyoon Pyo, Yuankun Jiao, Dongwon Jung, Zekun Li, Leeje Jang, Sofia Kirsanova, Jina Kim, Yijun Lin, Qin Liu, Junyi Xie, Hadi Askari, Nan Xu, Muhao Chen, Yao-Yi Chiang
...
## 1. [No Labels, No Problem: Training Visual Reasoners with Multimodal Verifiers](https://arxiv.org/abs/2512.08889) <a id="link1"></a>
**ArXiv ID:** 2512.08889
**Authors:** Damiano Marsili, Georgia Gkioxari
...
## 2. [Towards Effective and Efficient Long Video Understanding of Multimodal Large Language Models via One-shot Clip Retrieval](https://arxiv.org/abs/2512.08410) <a id="link2"></a>
**ArXiv ID:** 2512.08410
**Authors:** Tao Chen, Shaobo Ju, Qiong Wu, Chenxin Fang, Kun Zhang, Jun Peng, Hui Li, Yiyi Zhou, Rongrong Ji
...
## 3. [TrackingWorld: World-centric Monocular 3D Tracking of Almost All Pixels](https://arxiv.org/abs/2512.08358) <a id="link3"></a>
**ArXiv ID:** 2512.08358
**Authors:** Jiahao Lu, Weitao Xiong, Jiacheng Deng, Peng Li, Tianyu Huang, Zhiyang Dou, Cheng Lin, Sai-Kit Yeung, Yuan Liu
...
## 4. [MM-CoT:A Benchmark for Probing Visual Chain-of-Thought Reasoning in Multimodal Models](https://arxiv.org/abs/2512.08228) <a id="link4"></a>
**ArXiv ID:** 2512.08228
**Authors:** Jusheng Zhang, Kaitong Cai, Xiaoyang Guo, Sidi Liu, Qinhan Lv, Ruiqi Chen, Jing Yang, Yijia Fan, Xiaofei Sun, Jian Wang, Ziliang Chen, Liang Lin, Keze Wang
...
## 5. [Same Content, Different Answers: Cross-Modal Inconsistency in MLLMs](https://arxiv.org/abs/2512.08923) <a id="link5"></a>
**ArXiv ID:** 2512.08923
**Authors:** Angela van Sprang, Laurens Samson, Ana Lucic, Erman Acar, Sennay Ghebreab, Yuki M. Asano
...
## 6. [Prismatic World Model: Learning Compositional Dynamics for Planning in Hybrid Systems](https://arxiv.org/abs/2512.08411) <a id="link6"></a>
**ArXiv ID:** 2512.08411
**Authors:** Mingwei Li, Xiaoyuan Zhang, Chengwei Yang, Zilong Zheng, Yaodong Yang
...
## 7. [HybridToken-VLM: Hybrid Token Compression for Vision-Language Models](https://arxiv.org/abs/2512.08240) <a id="link7"></a>
**ArXiv ID:** 2512.08240
**Authors:** Jusheng Zhang, Xiaoyang Guo, Kaitong Cai, Qinhan Lv, Yijia Fan, Wenhao Chai, Jian Wang, Keze Wang
...
## 8. [EgoX: Egocentric Video Generation from a Single Exocentric Video](https://arxiv.org/abs/2512.08269) <a id="link8"></a>
**ArXiv ID:** 2512.08269
**Authors:** Taewoong Kang, Kinam Kim, Dohyeon Kim, Minho Park, Junha Hyung, Jaegul Choo
...
## 9. [SATGround: A Spatially-Aware Approach for Visual Grounding in Remote Sensing](https://arxiv.org/abs/2512.08881) <a id="link9"></a>
**ArXiv ID:** 2512.08881
**Authors:** Aysim Toker, Andreea-Maria Oncescu, Roy Miles, Ismail Elezi, Jiankang Deng
...
## 10. [On-the-fly Large-scale 3D Reconstruction from Multi-Camera Rigs](https://arxiv.org/abs/2512.08498) <a id="link10"></a>
**ArXiv ID:** 2512.08498
**Authors:** Yijia Guo, Tong Hu, Zhiwei Li, Liwen Hu, Keming Qian, Xitong Lin, Shengbo Chen, Tiejun Huang, Lei Ma
...
## 11. [Efficiently Reconstructing Dynamic Scenes One D4RT at a Time](https://arxiv.org/abs/2512.08924) <a id="link11"></a>
**ArXiv ID:** 2512.08924
**Authors:** Chuhan Zhang, Guillaume Le Moing, Skanda Koppula, Ignacio Rocco, Liliane Momeni, Junyu Xie, Shuyang Sun, Rahul Sukthankar, Jo\"elle K Barral, Raia Hadsell, Zoubin Ghahramani, Andrew Zisserman, Junlin Zhang, Mehdi SM Sajjadi
...
## 12. [Generation is Required for Data-Efficient Perception](https://arxiv.org/abs/2512.08854) <a id="link12"></a>
**ArXiv ID:** 2512.08854
**Authors:** Jack Brady, Bernhard Sch\"olkopf, Thomas Kipf, Simon Buchholz, Wieland Brendel
...
## 13. [Towards a Science of Scaling Agent Systems](https://arxiv.org/abs/2512.08296) <a id="link13"></a>
**ArXiv ID:** 2512.08296
**Authors:** Yubin Kim, Ken Gu, Chanwoo Park, Chunjong Park, Samuel Schmidgall, A. Ali Heydari, Yao Yan, Zhihan Zhang, Yuchen Zhuang, Mark Malhotra, Paul Pu Liang, Hae Won Park, Yuzhe Yang, Xuhai Xu, Yilun Du, Shwetak Patel, Tim Althoff, Daniel McDuff, Xin Liu
...
## 14. [MVP: Multiple View Prediction Improves GUI Grounding](https://arxiv.org/abs/2512.08529) <a id="link14"></a>
**ArXiv ID:** 2512.08529
**Authors:** Yunzhu Zhang, Zeyu Pan, Zhengwen Zeng, Shuheng Shen, Changhua Meng, Linchao Zhu
...
## 15. [EcomBench: Towards Holistic Evaluation of Foundation Agents in E-commerce](https://arxiv.org/abs/2512.08868) <a id="link15"></a>
**ArXiv ID:** 2512.08868
**Authors:** Rui Min (May), Zile Qiao (May), Ze Xu (May), Jiawen Zhai (May), Wenyu Gao (May), Xuanzhong Chen (May), Haozhen Sun (May), Zhen Zhang (May), Xinyu Wang (May), Hong Zhou (May), Wenbiao Yin (May), Xuan Zhou (May), Yong Jiang (May), Haicheng Liu (May), Liang Ding (May), Ling Zou (May), Yi R. (May), Fung, Yalong Li, Pengjun Xie
...
## 16. [Disrupting Hierarchical Reasoning: Adversarial Protection for Geographic Privacy in Multimodal Reasoning Models](https://arxiv.org/abs/2512.08503) <a id="link16"></a>
**ArXiv ID:** 2512.08503
**Authors:** Jiaming Zhang, Che Wang, Yang Cao, Longtao Huang, Wei Yang Bryan Lim
...
## 17. [Beyond Real Weights: Hypercomplex Representations for Stable Quantization](https://arxiv.org/abs/2512.08524) <a id="link17"></a>
**ArXiv ID:** 2512.08524
**Authors:** Jawad Ibn Ahad, Maisha Rahman, Amrijit Biswas, Muhammad Rafsan Kabir, Robin Krambroeckers, Sifat Momen, Nabeel Mohammed, Shafin Rahman
...
## 18. [Towards Foundation Models with Native Multi-Agent Intelligence](https://arxiv.org/abs/2512.08743) <a id="link18"></a>
**ArXiv ID:** 2512.08743
**Authors:** Shuyue Hu, Haoyang Yan, Yiqun Zhang, Yang Chen, Dongzhan Zhou, Lei Bai
...
## 19. [Chain-of-Image Generation: Toward Monitorable and Controllable Image Generation](https://arxiv.org/abs/2512.08645) <a id="link19"></a>
**ArXiv ID:** 2512.08645
**Authors:** Young Kyung Kim, Oded Schlesinger, Yuzhou Zhao, J. Matias Di Martino, Guillermo Sapiro
...
## 20. [OpenSubject: Leveraging Video-Derived Identity and Diversity Priors for Subject-driven Image Generation and Manipulation](https://arxiv.org/abs/2512.08294) <a id="link20"></a>
**ArXiv ID:** 2512.08294
**Authors:** Yexin Liu, Manyuan Zhang, Yueze Wang, Hongyu Li, Dian Zheng, Weiming Zhang, Changsheng Lu, Xunliang Cai, Yan Feng, Peng Pei, Harry Yang
...
## 21. [Thinking with Images via Self-Calling Agent](https://arxiv.org/abs/2512.08511) <a id="link21"></a>
**ArXiv ID:** 2512.08511
**Authors:** Wenxi Yang, Yuzhong Zhao, Fang Wan, Qixiang Ye
...
## 22. [Photo3D: Advancing Photorealistic 3D Generation through Structure-Aligned Detail Enhancement](https://arxiv.org/abs/2512.08535) <a id="link22"></a>
**ArXiv ID:** 2512.08535
**Authors:** Xinyue Liang, Zhinyuan Ma, Lingchen Sun, Yanjun Guo, Lei Zhang
...
## 23. [FastBEV++: Fast by Algorithm, Deployable by Design](https://arxiv.org/abs/2512.08237) <a id="link23"></a>
**ArXiv ID:** 2512.08237
**Authors:** Yuanpeng Chen, Hui Song, Wei Tao, ShanHui Mo, Shuang Zhang, Xiao Hua, TianKun Zhao
...
## 24. [VisKnow: Constructing Visual Knowledge Base for Object Understanding](https://arxiv.org/abs/2512.08221) <a id="link24"></a>
**ArXiv ID:** 2512.08221
**Authors:** Ziwei Yao, Qiyang Wan, Ruiping Wang, Xilin Chen
...
## 25. [Visionary: The World Model Carrier Built on WebGPU-Powered Gaussian Splatting Platform](https://arxiv.org/abs/2512.08478) <a id="link25"></a>
**ArXiv ID:** 2512.08478
**Authors:** Yuning Gong, Yifei Liu, Yifan Zhan, Muyao Niu, Xueying Li, Yuanjun Liao, Jiaming Chen, Yuanyuan Gao, Jiaqi Chen, Minming Chen, Li Zhou, Yuning Zhang, Wei Wang, Xiaoqing Hou, Huaxi Huang, Shixiang Tang, Le Ma, Dingwen Zhang, Xue Yang, Junchi Yan, Yanchi Zhang, Yinqiang Zheng, Xiao Sun, Zhihang Zhong
...
## 26. [Fast-ARDiff: An Entropy-informed Acceleration Framework for Continuous Space Autoregressive Generation](https://arxiv.org/abs/2512.08537) <a id="link26"></a>
**ArXiv ID:** 2512.08537
**Authors:** Zhen Zou, Xiaoxiao Ma, Jie Huang, Zichao Yu, Feng Zhao
...
## 27. [Repulsor: Accelerating Generative Modeling with a Contrastive Memory Bank](https://arxiv.org/abs/2512.08648) <a id="link27"></a>
**ArXiv ID:** 2512.08648
**Authors:** Shaofeng Zhang, Xuanqi Chen, Ning Liao, Haoxiang Zhao, Xiaoxing Wang, Haoru Tan, Sitong Wu, Xiaosong Jia, Qi Fan, Junchi Yan
...
## 28. [GeoDM: Geometry-aware Distribution Matching for Dataset Distillation](https://arxiv.org/abs/2512.08317) <a id="link28"></a>
**ArXiv ID:** 2512.08317
**Authors:** Xuhui Li, Zhengquan Luo, Zihui Cui, Zhiqiang Xu
...
## 29. [Dual-Branch Center-Surrounding Contrast: Rethinking Contrastive Learning for 3D Point Clouds](https://arxiv.org/abs/2512.08673) <a id="link29"></a>
**ArXiv ID:** 2512.08673
**Authors:** Shaofeng Zhang, Xuanqi Chen, Xiangdong Zhang, Sitong Wu, Junchi Yan
...
## 30. [Distilling Future Temporal Knowledge with Masked Feature Reconstruction for 3D Object Detection](https://arxiv.org/abs/2512.08247) <a id="link30"></a>
**ArXiv ID:** 2512.08247
**Authors:** Haowen Zheng, Hu Zhu, Lu Deng, Weihao Gu, Yang Yang, Yanyan Liang
...
## 31. [SegEarth-OV3: Exploring SAM 3 for Open-Vocabulary Semantic Segmentation in Remote Sensing Images](https://arxiv.org/abs/2512.08730) <a id="link31"></a>
**ArXiv ID:** 2512.08730
**Authors:** Kaiyu Li, Shengqi Zhang, Yupeng Deng, Zhi Wang, Deyu Meng, Xiangyong Cao
...
## 32. [Modular Neural Image Signal Processing](https://arxiv.org/abs/2512.08564) <a id="link32"></a>
**ArXiv ID:** 2512.08564
**Authors:** Mahmoud Afifi, Zhongling Wang, Ran Zhang, Michael S. Brown
...
## 33. [DINO-BOLDNet: A DINOv3-Guided Multi-Slice Attention Network for T1-to-BOLD Generation](https://arxiv.org/abs/2512.08337) <a id="link33"></a>
**ArXiv ID:** 2512.08337
**Authors:** Jianwei Wang, Qing Wang, Menglan Ruan, Rongjun Ge, Chunfeng Yang, Yang Chen, Chunming Xie
...
## 34. [SFP: Real-World Scene Recovery Using Spatial and Frequency Priors](https://arxiv.org/abs/2512.08254) <a id="link34"></a>
**ArXiv ID:** 2512.08254
**Authors:** Yun Liu, Tao Li, Cosmin Ancuti, Wenqi Ren, Weisi Lin
...
## 35. [Interpreting Structured Perturbations in Image Protection Methods for Diffusion Models](https://arxiv.org/abs/2512.08329) <a id="link35"></a>
**ArXiv ID:** 2512.08329
**Authors:** Michael R. Martin, Garrick Chan, Kwan-Liu Ma
...
## 36. [ContextDrag: Precise Drag-Based Image Editing via Context-Preserving Token Injection and Position-Consistent Attention](https://arxiv.org/abs/2512.08477) <a id="link36"></a>
**ArXiv ID:** 2512.08477
**Authors:** Huiguo He, Pengyu Yan, Ziqi Yi, Weizhi Zhong, Zheng Liu, Yejun Tang, Huan Yang, Kun Gai, Guanbin Li, Lianwen Jin
...
## 37. [PaintFlow: A Unified Framework for Interactive Oil Paintings Editing and Generation](https://arxiv.org/abs/2512.08534) <a id="link37"></a>
**ArXiv ID:** 2512.08534
**Authors:** Zhangli Hu, Ye Chen, Jiajun Yao, Bingbing Ni
...
## 38. [Uncertainty-Aware Subset Selection for Robust Visual Explainability under Distribution Shifts](https://arxiv.org/abs/2512.08445) <a id="link38"></a>
**ArXiv ID:** 2512.08445
**Authors:** Madhav Gupta, Vishak Prasad C, Ganesh Ramakrishnan
...
## 39. [Skewness-Guided Pruning of Multimodal Swin Transformers for Federated Skin Lesion Classification on Edge Devices](https://arxiv.org/abs/2512.08751) <a id="link39"></a>
**ArXiv ID:** 2512.08751
**Authors:** Kuniko Paxton, Koorosh Aslansefat, Dhavalkumar Thakker, Yiannis Papadopoulos
...
## 40. [Query-aware Hub Prototype Learning for Few-Shot 3D Point Cloud Semantic Segmentation](https://arxiv.org/abs/2512.08253) <a id="link40"></a>
**ArXiv ID:** 2512.08253
**Authors:** YiLin Zhou, Lili Wei, Zheming Xu, Ziyi Chen, Congyan Lang
...
## 41. [HybridSplat: Fast Reflection-baked Gaussian Tracing using Hybrid Splatting](https://arxiv.org/abs/2512.08334) <a id="link41"></a>
**ArXiv ID:** 2512.08334
**Authors:** Chang Liu, Hongliang Yuan, Lianghao Zhang, Sichao Wang, Jianwei Guo, Shi-Sheng Huang
...
## 42. [Accuracy Does Not Guarantee Human-Likeness in Monocular Depth Estimators](https://arxiv.org/abs/2512.08163) <a id="link42"></a>
**ArXiv ID:** 2512.08163
**Authors:** Yuki Kubota, Taiki Fukiage
...
## 43. [Simultaneous Enhancement and Noise Suppression under Complex Illumination Conditions](https://arxiv.org/abs/2512.08378) <a id="link43"></a>
**ArXiv ID:** 2512.08378
**Authors:** Jing Tao, You Li, Banglei Guan, Yang Shang, Qifeng Yu
...
## 44. [New VVC profiles targeting Feature Coding for Machines](https://arxiv.org/abs/2512.08227) <a id="link44"></a>
**ArXiv ID:** 2512.08227
**Authors:** Md Eimran Hossain Eimon, Ashan Perera, Juan Merlos, Velibor Adzic, Hari Kalva
...
## 45. [Can AI autonomously build, operate, and use the entire data stack?](https://arxiv.org/abs/2512.07926) <a id="link45"></a>
**ArXiv ID:** 2512.07926
**Authors:** Arvind Agarwal, Lisa Amini, Sameep Mehta, Horst Samulowitz, Kavitha Srinivas
...
## 46. [Preserving Source Video Realism: High-Fidelity Face Swapping for Cinematic Quality](https://arxiv.org/abs/2512.07951) <a id="link46"></a>
**ArXiv ID:** 2512.07951
**Authors:** Zekai Luo, Zongze Du, Zhouhang Zhu, Hao Zhong, Muzhi Zhu, Wen Wang, Yuling Xi, Chenchen Jing, Hao Chen, Chunhua Shen
...
## 47. [What really matters for person re-identification? A Mixture-of-Experts Framework for Semantic Attribute Importance](https://arxiv.org/abs/2512.08697) <a id="link47"></a>
**ArXiv ID:** 2512.08697
**Authors:** Athena Psalta, Vasileios Tsironis, Konstantinos Karantzalos
...
## 48. [A Practical Guide for Designing, Developing, and Deploying Production-Grade Agentic AI Workflows](https://arxiv.org/abs/2512.08769) <a id="link48"></a>
**ArXiv ID:** 2512.08769
**Authors:** Eranga Bandara, Ross Gore, Peter Foytik, Sachin Shetty, Ravi Mukkamala, Abdul Rahman, Xueping Liang, Safdar H. Bouk, Amin Hass, Sachini Rajapakse, Ng Wee Keong, Kasun De Zoysa, Aruna Withanage, Nilaan Loganathan
...
## 49. [Animal Re-Identification on Microcontrollers](https://arxiv.org/abs/2512.08198) <a id="link49"></a>
**ArXiv ID:** 2512.08198
**Authors:** Yubo Chen, Di Zhao, Yun Sing Koh, Talia Xu
...
## 50. [SSplain: Sparse and Smooth Explainer for Retinopathy of Prematurity Classification](https://arxiv.org/abs/2512.08038) <a id="link50"></a>
**ArXiv ID:** 2512.08038
**Authors:** Elifnur Sunger, Tales Imbiriba, Peter Campbell, Deniz Erdogmus, Stratis Ioannidis, Jennifer Dy
