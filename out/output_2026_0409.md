...
0. [INSPATIO-WORLD: A Real-Time 4D World Simulator via Spatiotemporal Autoregressive Modeling](#link0)
...
1. [EVGeoQA: Benchmarking LLMs on Dynamic, Multi-Objective Geo-Spatial Exploration](#link1)
**Authors:** Jianfei Wu, Zhichun Wang, Zhensheng Wang, Zhiyu He

2. [Enhancing MLLM Spatial Understanding via Active 3D Scene Exploration for Multi-Perspective Reasoning](#link2)
**Authors:** Jiahua Chen, Qihong Tang, Weinong Wang, Qi Fan

3. [Making MLLMs Blind: Adversarial Smuggling Attacks in MLLM Content Moderation](#link3)
...
4. [CraterBench-R: Instance-Level Crater Retrieval for Planetary Scale](#link4)
**Authors:** Jichao Fang, Lei Zhang, Michael Phillips, Wei Luo

5. [Grounded Forcing: Bridging Time-Independent Semantics and Proximal Dynamics in Autoregressive Video Synthesis](#link5)
**Authors:** Jintao Chen, Chengyu Bai, Junjun hu, Xinda Xue, Mu Xu

6. [How Well Do Vision-Language Models Understand Sequential Driving Scenes? A Sensitivity Study](#link6)
**Authors:** Roberto Brusnicki, Mattia Piccinini, Johannes Betz

7. [Vision-Language Model-Guided Deep Unrolling Enables Personalized, Fast MRI](#link7)
**Authors:** Fangmao Ju, Yuzhu He, Zhiwen Xue, Chunfeng Lian, Jianhua Ma

8. [Visual prompting reimagined: The power of the Activation Prompts](#link8)
**Authors:** Yihua Zhang, Hongkang Li, Yuguang Yao, Aochuan Chen, Shuai Zhang, Pin-Yu Chen, Meng Wang, Sijia Liu

9. [Video-guided Machine Translation with Global Video Context](#link9)
**Authors:** Jian Chen, JinZe Lv, Zi Long, XiangHua Fu

10. [Synthetic Dataset Generation for Partially Observed Indoor Objects](#link10)
**Authors:** Jelle Vermandere, Maarten Bassier, Maarten Vergauwen

11. [Generate, Analyze, and Refine: Training-Free Sound Source Localization via MLLM Meta-Reasoning](#link11)
**Authors:** Subin Park, Jung Uk Kim

12. [Evidence-Based Actor-Verifier Reasoning for Echocardiographic Agents](#link12)
...
13. [Steering the Verifiability of Multimodal AI Hallucinations](#link13)
**Authors:** Jianhong Pang, Ruoxi Cheng, Ziyi Ye, Xingjun Ma, Zuxuan Wu, Xuanjing Huang, Yu-Gang Jiang

14. [EventFace: Event-Based Face Recognition via Structure-Driven Spatiotemporal Modeling](#link14)
**Authors:** Qingguo Meng, Xingbo Dong, Zhe Jin, Massimo Tistarelli

15. [Specializing Large Models for Oracle Bone Script Interpretation via Component-Grounded Multimodal Knowledge Augmentation](#link15)
**Authors:** Jianing Zhang, Runan Li, Honglin Pang, Ding Xia, Zhou Zhu, Qian Zhang, Chuntao Li, Xi Yang

16. [Not all tokens contribute equally to diffusion learning](#link16)
**Authors:** Guoqing Zhang, Lu Shi, Wanru Xu, Linna Zhang, Sen Wang, Fangfang Wang, Yigang Cen

17. [RefineAnything: Multimodal Region-Specific Refinement for Perfect Local Details](#link17)
**Authors:** Dewei Zhou, You Li, Zongxin Yang, Yi Yang

18. [PhysHead: Simulation-Ready Gaussian Head Avatars](#link18)
**Authors:** Berna Kabadayi, Vanessa Sklyarova, Wojciech Zielonka, Justus Thies, Gerard Pons-Moll

19. [FlowExtract: Procedural Knowledge Extraction from Maintenance Flowcharts](#link19)
**Authors:** Guillermo Gil de Avalle, Laura Maruster, Eric Sloot, Christos Emmanouilidis

20. [WeatherRemover: All-in-one Adverse Weather Removal with Multi-scale Feature Map Compression](#link20)
**Authors:** Weikai Qu, Sijun Liang, Cheng Pan, Zikuan Yang, Guanchi Zhou, Xianjun Fu, Bo Liu, Changmiao Wang, Ahmed Elazab

21. [USCNet: Transformer-Based Multimodal Fusion with Segmentation Guidance for Urolithiasis Classification](#link21)
...
22. [PRISM: Rethinking Scattered Atmosphere Reconstruction as a Unified Understanding and Generation Model for Real-world Dehazing](#link22)
**Authors:** Chengyu Fang, Chunming He, Yuelin Zhang, Chubin Chen, Chenyang Zhu, Longxiang Tang, Xiu Li

23. [POS-ISP: Pipeline Optimization at the Sequence Level for Task-aware ISP](#link23)
**Authors:** Jiyun Won, Heemin Yang, Woohyeok Kim, Jungseul Ok, Sunghyun Cho

24. [Bridging MRI and PET physiology: Untangling complementarity through orthogonal representations](#link24)
**Authors:** Sonja Adomeit, Kartikay Tehlan, Lukas F\"orner, Katharina Weisser, Helen Scholtiseek, David Kaufmann, Julie Steinestel, Constantin Lapa, Thomas Kr\"oncke, Thomas Wendler

25. [Controllable Generative Video Compression](#link25)
**Authors:** Ding Ding, Daowen Li, Ying Chen, Yixin Gao, Ruixiao Dong, Kai Li, Li Li

26. [Beyond Loss Values: Robust Dynamic Pruning via Loss Trajectory Alignment](#link26)
**Authors:** Huaiyuan Qin, Muli Yang, Gabriel James Goenawan, Kai Wang, Zheng Wang, Peng Hu, Xi Peng, Hongyuan Zhu

27. [Compression as an Adversarial Amplifier Through Decision Space Reduction](#link27)
**Authors:** Lewis Evans, Harkrishan Jandu, Zihan Ye, Yang Lu, Shreyank N Gowda

28. [Novel Anomaly Detection Scenarios and Evaluation Metrics to Address the Ambiguity in the Definition of Normal Samples](#link28)
**Authors:** Reiji Saito, Satoshi Kamiya, Kazuhiro Hotta

29. [Variational Feature Compression for Model-Specific Representations](#link29)
**Authors:** Zinan Guo, Zihan Wang, Chuan Yan, Liuhuo Wan, Ethan Ma, Guangdong Bai

30. [NTIRE 2026 Challenge on Bitstream-Corrupted Video Restoration: Methods and Results](#link30)
...
31. [RePL: Pseudo-label Refinement for Semi-supervised LiDAR Semantic Segmentation](#link31)
**Authors:** Donghyeon Kwon, Taegyu Park, Suha Kwak

32. [Explaining Neural Networks in Preference Learning: a Post-hoc Inductive Logic Programming Approach](#link32)
**Authors:** Daniele Fossem\`o, Filippo Mignosi, Giuseppe Placidi, Luca Raggioli, Matteo Spezialetti, Fabio Aurelio D'Asaro

33. [TurboAgent: An LLM-Driven Autonomous Multi-Agent Framework for Turbomachinery Aerodynamic Design](#link33)
**Authors:** Juan Du, Yueteng Wu, Pan Zhao, Yuze Liu, Min Zhang, Xiaobin Xu, Xinglong Zhang

---
## 0. [INSPATIO-WORLD: A Real-Time 4D World Simulator via Spatiotemporal Autoregressive Modeling](https://arxiv.org/abs/2604.07209) <a id="link0"></a>
**ArXiv ID:** 2604.07209
**Authors:** InSpatio Team, Donghui Shen, Guofeng Zhang, Haomin Liu, Haoyu Ji, Hujun Bao, Hongjia Zhai, Jialin Liu, Jing Guo, Nan Wang, Siji Pan, Weihong Pan, Weijian Xie, Xianbin Liu, Xiaojun Xiang, Xiaoyu Zhang, Xinyu Chen, Yifu Wang, Yipeng Chen, Zhenzhou Fan, Zhewen Le, Zhichao Ye, Ziqiang Zhao
...
**Comment:** This paper directly matches criterion 3: it introduces a new real-time 4D world simulator (INSPATIO-WORLD) with a novel spatiotemporal autoregressive model, a new benchmark (WorldScore-Dynamic), and new methods for spatial consistency and interactive navigation. It also touches on criterion 1 (spatial intelligence for embodied agents) and criterion 4 (vision foundation models and applications).
**Relevance:** 10
**Novelty:** 8

---

## 1. [EVGeoQA: Benchmarking LLMs on Dynamic, Multi-Objective Geo-Spatial Exploration](https://arxiv.org/abs/2604.07070) <a id="link1"></a>
**ArXiv ID:** 2604.07070
**Authors:** Jianfei Wu, Zhichun Wang, Zhensheng Wang, Zhiyu He
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 3 (new benchmark for geo-spatial intelligence in dynamic, multi-objective environments). The paper introduces a novel benchmark (EVGeoQA) and evaluation framework (GeoRover) for LLMs in dynamic geo-spatial exploration, focusing on spatial reasoning and embodied agent planning.
**Relevance:** 10
**Novelty:** 8

---

## 2. [Enhancing MLLM Spatial Understanding via Active 3D Scene Exploration for Multi-Perspective Reasoning](https://arxiv.org/abs/2604.06725) <a id="link2"></a>
**ArXiv ID:** 2604.06725
**Authors:** Jiahua Chen, Qihong Tang, Weinong Wang, Qi Fan
...
**Comment:** Matches criteria 1 (new methodological improvements to spatial understanding on embodied agents) and 2 (new MLLMs). Proposes a training-free framework for enhancing MLLM spatial understanding via active 3D scene exploration and multi-perspective reasoning, outperforming specialized spatial models and general-purpose MLLMs on major benchmarks.
**Relevance:** 10
**Novelty:** 8

---

## 3. [Making MLLMs Blind: Adversarial Smuggling Attacks in MLLM Content Moderation](https://arxiv.org/abs/2604.06950) <a id="link3"></a>
**ArXiv ID:** 2604.06950
**Authors:** Zhiheng Li, Zongyang Ma, Yuntong Pan, Ziqi Zhang, Xiaolei Lv, Bo Li, Jun Gao, Jianing Zhang, Chunfeng Yuan, Bing Li, Weiming Hu
...
**Comment:** This paper introduces a new benchmark (SmuggleBench) and analyzes adversarial attacks on MLLMs, directly matching criterion 2 (new MLLMs) and criterion 3 (new benchmarks for embodied AI/VLLMs/MLLMs). It provides surprising empirical results on vulnerabilities in state-of-the-art models.
**Relevance:** 9
**Novelty:** 8

---

## 4. [CraterBench-R: Instance-Level Crater Retrieval for Planetary Scale](https://arxiv.org/abs/2604.06245) <a id="link4"></a>
**ArXiv ID:** 2604.06245
**Authors:** Jichao Fang, Lei Zhang, Michael Phillips, Wei Luo
...
**Comment:** Matches criterion 3 (embodied AI/new benchmarks) and criterion 4 (vision foundation models and applications). Introduces a new planetary-scale benchmark for instance-level crater retrieval and proposes a scalable token aggregation method for ViTs, which is a clever statistical trick.
**Relevance:** 9
**Novelty:** 8

---

## 5. [Grounded Forcing: Bridging Time-Independent Semantics and Proximal Dynamics in Autoregressive Video Synthesis](https://arxiv.org/abs/2604.06939) <a id="link5"></a>
**ArXiv ID:** 2604.06939
**Authors:** Jintao Chen, Chengyu Bai, Junjun hu, Xinda Xue, Mu Xu
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding in generative video models) and criterion 4 (vision foundation models and applications). The paper introduces a novel framework for long-range video synthesis with mechanisms for semantic coherence and visual stability, which is highly relevant to spatial intelligence and generative modeling.
**Relevance:** 9
**Novelty:** 8

---

## 6. [How Well Do Vision-Language Models Understand Sequential Driving Scenes? A Sensitivity Study](https://arxiv.org/abs/2604.06750) <a id="link6"></a>
**ArXiv ID:** 2604.06750
**Authors:** Roberto Brusnicki, Mattia Piccinini, Johannes Betz
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Introduces VENUSS, a framework for systematic sensitivity analysis of VLMs on sequential driving scenes, revealing capability gaps and providing a new evaluation benchmark.
**Relevance:** 8
**Novelty:** 8

---

## 7. [Vision-Language Model-Guided Deep Unrolling Enables Personalized, Fast MRI](https://arxiv.org/abs/2604.06849) <a id="link7"></a>
**ArXiv ID:** 2604.06849
**Authors:** Fangmao Ju, Yuzhu He, Zhiwen Xue, Chunfeng Lian, Jianhua Ma
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and 4 (vision foundation models and applications). Uses a vision-language model to guide deep unrolling for personalized, fast MRI, integrating high-level clinical reasoning with physics-aware networks.
**Relevance:** 8
**Novelty:** 8

---

## 8. [Visual prompting reimagined: The power of the Activation Prompts](https://arxiv.org/abs/2604.06440) <a id="link8"></a>
**ArXiv ID:** 2604.06440
**Authors:** Yihua Zhang, Hongkang Li, Yuguang Yao, Aochuan Chen, Shuai Zhang, Pin-Yu Chen, Meng Wang, Sijia Liu
...
**Comment:** This paper proposes a new method for visual prompting (activation prompts) that improves adaptation of vision foundation models, matching criterion 4 (vision foundation models and applications). It also introduces a novel analytical tool for understanding prompting in vision models.
**Relevance:** 8
**Novelty:** 7

---

## 9. [Video-guided Machine Translation with Global Video Context](https://arxiv.org/abs/2604.06789) <a id="link9"></a>
**ArXiv ID:** 2604.06789
**Authors:** Jian Chen, JinZe Lv, Zi Long, XiangHua Fu
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Proposes a new globally video-guided multimodal translation framework with novel attention mechanisms for long-video scenarios.
**Relevance:** 8
**Novelty:** 7

---

## 10. [Synthetic Dataset Generation for Partially Observed Indoor Objects](https://arxiv.org/abs/2604.07010) <a id="link10"></a>
**ArXiv ID:** 2604.07010
**Authors:** Jelle Vermandere, Maarten Bassier, Maarten Vergauwen
...
**Comment:** Matches criterion 3 (embodied AI papers on building new benchmarks/simulators). Introduces a new synthetic dataset and virtual scanning framework for 3D scene reconstruction, with a novel procedural indoor scene generation pipeline.
**Relevance:** 8
**Novelty:** 7

---

## 11. [Generate, Analyze, and Refine: Training-Free Sound Source Localization via MLLM Meta-Reasoning](https://arxiv.org/abs/2604.06824) <a id="link11"></a>
**ArXiv ID:** 2604.06824
**Authors:** Subin Park, Jung Uk Kim
...
**Comment:** Matches criterion 2 (new MLLMs) and is relevant to criterion 4 (vision foundation models and applications). Proposes a training-free sound source localization framework leveraging MLLM meta-reasoning, with a novel pipeline for multi-modal reasoning and empirical results.
**Relevance:** 8
**Novelty:** 7

---

## 12. [Evidence-Based Actor-Verifier Reasoning for Echocardiographic Agents](https://arxiv.org/abs/2604.06347) <a id="link12"></a>
**ArXiv ID:** 2604.06347
**Authors:** Peng Huang, Yiming Wang, Yineng Chen, Liangqiao Gui, Hui Guo, Bo Peng, Shu Hu, Xi Wu, Tsao Connie, Hongtu Zhu, Balakrishnan Prabhakaran, Xin Wang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and is relevant to criterion 4 (vision foundation models and applications). Proposes an evidence-driven Actor-Verifier framework for trustworthy reasoning in echocardiography VLM-based agents, introducing structured intermediate representations for clinical decision support.
**Relevance:** 8
**Novelty:** 7

---

## 13. [Steering the Verifiability of Multimodal AI Hallucinations](https://arxiv.org/abs/2604.06714) <a id="link13"></a>
**ArXiv ID:** 2604.06714
**Authors:** Jianhong Pang, Ruoxi Cheng, Ziyi Ye, Xingjun Ma, Zuxuan Wu, Xuanjing Huang, Yu-Gang Jiang
...
**Comment:** Matches criterion 2 (new MLLMs). Proposes a method for steering the verifiability of hallucinations in multimodal LLMs, with a new dataset and activation-space intervention for fine-grained control.
**Relevance:** 8
**Novelty:** 7

---

## 14. [EventFace: Event-Based Face Recognition via Structure-Driven Spatiotemporal Modeling](https://arxiv.org/abs/2604.06782) <a id="link14"></a>
**ArXiv ID:** 2604.06782
**Authors:** Qingguo Meng, Xingbo Dong, Zhe Jin, Massimo Tistarelli
...
**Comment:** This paper proposes a new event-based face recognition method with structure-driven spatiotemporal modeling, and introduces a new event-based face dataset. It is relevant to criterion 1 (spatial understanding on embodied agents) and criterion 3 (new benchmarks/methods for embodied AI), as it advances spatial-temporal modeling in a novel sensing modality.
**Relevance:** 7
**Novelty:** 7

---

## 15. [Specializing Large Models for Oracle Bone Script Interpretation via Component-Grounded Multimodal Knowledge Augmentation](https://arxiv.org/abs/2604.06711) <a id="link15"></a>
**ArXiv ID:** 2604.06711
**Authors:** Jianing Zhang, Runan Li, Honglin Pang, Ding Xia, Zhou Zhu, Qian Zhang, Chuntao Li, Xi Yang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Proposes a VLM-based agent for ancient script interpretation, integrating vision-language reasoning and introducing a new annotated dataset.
**Relevance:** 7
**Novelty:** 7

---

## 16. [Not all tokens contribute equally to diffusion learning](https://arxiv.org/abs/2604.07026) <a id="link16"></a>
**ArXiv ID:** 2604.07026
**Authors:** Guoqing Zhang, Lu Shi, Wanru Xu, Linna Zhang, Sen Wang, Fangfang Wang, Yigang Cen
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and is relevant to generative modeling in multi-modal learning. The paper proposes a new framework (DARE) for improving semantic guidance in diffusion models, with clever statistical tricks for token importance and spatial alignment.
**Relevance:** 7
**Novelty:** 7

---

## 17. [RefineAnything: Multimodal Region-Specific Refinement for Perfect Local Details](https://arxiv.org/abs/2604.06870) <a id="link17"></a>
**ArXiv ID:** 2604.06870
**Authors:** Dewei Zhou, You Li, Zongxin Yang, Yi Yang
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a multimodal diffusion-based refinement model for region-specific image editing, with a new benchmark and clever empirical tricks for high-precision local refinement.
**Relevance:** 7
**Novelty:** 7

---

## 18. [PhysHead: Simulation-Ready Gaussian Head Avatars](https://arxiv.org/abs/2604.06467) <a id="link18"></a>
**ArXiv ID:** 2604.06467
**Authors:** Berna Kabadayi, Vanessa Sklyarova, Wojciech Zielonka, Justus Thies, Gerard Pons-Moll
...
**Comment:** This paper introduces a new simulation-ready head avatar model with realistic hair dynamics, using a hybrid 3D Gaussian-based representation and VLM-based models for occluded region appearance. It is relevant to criterion 1 (spatial understanding on embodied agents) and criterion 4 (vision foundation models and applications), as it leverages VLMs for appearance generation and advances spatially-aware avatar modeling.
**Relevance:** 6
**Novelty:** 7

---

## 19. [FlowExtract: Procedural Knowledge Extraction from Maintenance Flowcharts](https://arxiv.org/abs/2604.06770) <a id="link19"></a>
**ArXiv ID:** 2604.06770
**Authors:** Guillermo Gil de Avalle, Laura Maruster, Eric Sloot, Christos Emmanouilidis
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and is tangentially related to criterion 2 (uses vision-language models as baselines). The paper proposes a novel pipeline for extracting procedural knowledge from flowcharts, outperforming VLMs on this task.
**Relevance:** 6
**Novelty:** 7

---

## 20. [WeatherRemover: All-in-one Adverse Weather Removal with Multi-scale Feature Map Compression](https://arxiv.org/abs/2604.06623) <a id="link20"></a>
**ArXiv ID:** 2604.06623
**Authors:** Weikai Qu, Sijun Liang, Cheng Pan, Zikuan Yang, Guanchi Zhou, Xianjun Fu, Bo Liu, Changmiao Wang, Ahmed Elazab
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a UNet-like model with a multi-scale pyramid vision transformer for all-in-one adverse weather removal, focusing on efficiency and restoration quality.
**Relevance:** 6
**Novelty:** 6

---

## 21. [USCNet: Transformer-Based Multimodal Fusion with Segmentation Guidance for Urolithiasis Classification](https://arxiv.org/abs/2604.07141) <a id="link21"></a>
**ArXiv ID:** 2604.07141
**Authors:** Changmiao Wang, Songqi Zhang, Yongquan Zhang, Yifei Wang, Liya Liu, Nannan Li, Xingzhi Li, Jiexin Pan, Yi Jiang, Xiang Wan, Hai Wang, Ahmed Elazab
...
**Comment:** Matches criterion 2 (new MLLMs). Proposes a transformer-based multimodal fusion network for medical image and EHR data, with segmentation-guided attention for improved classification.
**Relevance:** 6
**Novelty:** 6

---

## 22. [PRISM: Rethinking Scattered Atmosphere Reconstruction as a Unified Understanding and Generation Model for Real-world Dehazing](https://arxiv.org/abs/2604.07048) <a id="link22"></a>
**ArXiv ID:** 2604.07048
**Authors:** Chengyu Fang, Chunming He, Yuelin Zhang, Chubin Chen, Chenyang Zhu, Longxiang Tang, Xiu Li
...
**Comment:** Related to vision foundation models and their applications (criterion 4), as it proposes a physically structured model for real-world image dehazing with a novel adaptation scheme. However, it is more of an application than a foundational method.
**Relevance:** 5
**Novelty:** 6

---

## 23. [POS-ISP: Pipeline Optimization at the Sequence Level for Task-aware ISP](https://arxiv.org/abs/2604.06938) <a id="link23"></a>
**ArXiv ID:** 2604.06938
**Authors:** Jiyun Won, Heemin Yang, Woohyeok Kim, Jungseul Ok, Sunghyun Cho
...
**Comment:** Somewhat related to criterion 4 (vision foundation models and applications), as it proposes a new RL-based optimization for image signal processing pipelines, but does not directly address spatial intelligence or VLLMs/MLLMs.
**Relevance:** 4
**Novelty:** 6

---

## 24. [Bridging MRI and PET physiology: Untangling complementarity through orthogonal representations](https://arxiv.org/abs/2604.07154) <a id="link24"></a>
**ArXiv ID:** 2604.07154
**Authors:** Sonja Adomeit, Kartikay Tehlan, Lukas F\"orner, Katharina Weisser, Helen Scholtiseek, David Kaufmann, Julie Steinestel, Constantin Lapa, Thomas Kr\"oncke, Thomas Wendler
...
**Comment:** Related to multi-modal learning and representation disentanglement, but does not directly match any specific criterion (not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models).
**Relevance:** 3
**Novelty:** 6

---

## 25. [Controllable Generative Video Compression](https://arxiv.org/abs/2604.06655) <a id="link25"></a>
**ArXiv ID:** 2604.06655
**Authors:** Ding Ding, Daowen Li, Ying Chen, Yixin Gao, Ruixiao Dong, Kai Li, Li Li
...
**Comment:** Relevant to generative modeling and video compression, but does not directly match any specific criterion (not spatial, VLLM/MLLM, embodied AI, or vision foundation models).
**Relevance:** 3
**Novelty:** 6

---

## 26. [Beyond Loss Values: Robust Dynamic Pruning via Loss Trajectory Alignment](https://arxiv.org/abs/2604.07306) <a id="link26"></a>
**ArXiv ID:** 2604.07306
**Authors:** Huaiyuan Qin, Muli Yang, Gabriel James Goenawan, Kai Wang, Zheng Wang, Peng Hu, Xi Peng, Hongyuan Zhu
...
**Comment:** Relevant to machine learning and clever statistical tricks (loss trajectory alignment for pruning), but does not directly match any specific criterion (not spatial, VLLM/MLLM, embodied AI, or vision foundation models).
**Relevance:** 3
**Novelty:** 6

---

## 27. [Compression as an Adversarial Amplifier Through Decision Space Reduction](https://arxiv.org/abs/2604.06954) <a id="link27"></a>
**ArXiv ID:** 2604.06954
**Authors:** Lewis Evans, Harkrishan Jandu, Zihan Ye, Yang Lu, Shreyank N Gowda
...
**Comment:** Relevant to computer vision and machine learning, but does not directly match any specific criterion. Focuses on adversarial robustness and image compression, not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 28. [Novel Anomaly Detection Scenarios and Evaluation Metrics to Address the Ambiguity in the Definition of Normal Samples](https://arxiv.org/abs/2604.07097) <a id="link28"></a>
**ArXiv ID:** 2604.07097
**Authors:** Reiji Saito, Satoshi Kamiya, Kazuhiro Hotta
...
**Comment:** Does not match any specific criteria. Focuses on anomaly detection and evaluation metrics, not directly related to spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 29. [Variational Feature Compression for Model-Specific Representations](https://arxiv.org/abs/2604.06644) <a id="link29"></a>
**ArXiv ID:** 2604.06644
**Authors:** Zinan Guo, Zihan Wang, Chuan Yan, Liuhuo Wan, Ethan Ma, Guangdong Bai
...
**Comment:** Does not match any specific criteria. Focuses on privacy-preserving feature extraction for model-specific representations, not directly related to spatial understanding, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 30. [NTIRE 2026 Challenge on Bitstream-Corrupted Video Restoration: Methods and Results](https://arxiv.org/abs/2604.06945) <a id="link30"></a>
**ArXiv ID:** 2604.06945
**Authors:** Wenbin Zou, Tianyi Li, Kejun Wu, Huiping Zhuang, Zongwei Wu, Zhuyun Zhou, Radu Timofte, Kim-Hui Yap, Lap-Pui Chau, Yi Wang, Shiqi Zhou, Xiaodi Shi, Yuxiang Chen, Yilian Zhong, Shibo Yin, Yushun Fang, Xilei Zhu, Yahui Wang, Chen Lu, Zhitao Wang, Lifa Ha, Hengyu Man, Xiaopeng Fan, Priyansh Singh, Sidharth, Krrish Dev, Soham Kakkar, Vinit Jakhetiya, Ovais Iqbal Shah, Wei Zhou, Linfeng Li, Qi Xu, Zhenyang Liu, Kepeng Xu, Tong Qiao, Jiachen Tu, Guoyi Xu, Yaoxin Jiang, Jiajia Liu, Yaokun Shi
...
**Comment:** This is a challenge report on bitstream-corrupted video restoration. While it introduces a new benchmark, it is not directly related to embodied AI, spatial intelligence, or VLLMs/MLLMs, but is generally relevant to computer vision.
**Relevance:** 3
**Novelty:** 5

---

## 31. [RePL: Pseudo-label Refinement for Semi-supervised LiDAR Semantic Segmentation](https://arxiv.org/abs/2604.06825) <a id="link31"></a>
**ArXiv ID:** 2604.06825
**Authors:** Donghyeon Kwon, Taegyu Park, Suha Kwak
...
**Comment:** Relevant to computer vision and semi-supervised learning, but does not match any specific criterion (not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models).
**Relevance:** 3
**Novelty:** 5

---

## 32. [Explaining Neural Networks in Preference Learning: a Post-hoc Inductive Logic Programming Approach](https://arxiv.org/abs/2604.06838) <a id="link32"></a>
**ArXiv ID:** 2604.06838
**Authors:** Daniele Fossem\`o, Filippo Mignosi, Giuseppe Placidi, Luca Raggioli, Matteo Spezialetti, Fabio Aurelio D'Asaro
...
**Comment:** Relevant to explainability in neural networks and preference learning, but does not directly match any specific criterion (not spatial, VLLM/MLLM, embodied AI, or vision foundation models).
**Relevance:** 3
**Novelty:** 5

---

## 33. [TurboAgent: An LLM-Driven Autonomous Multi-Agent Framework for Turbomachinery Aerodynamic Design](https://arxiv.org/abs/2604.06747) <a id="link33"></a>
**ArXiv ID:** 2604.06747
**Authors:** Juan Du, Yueteng Wu, Pan Zhao, Yuze Liu, Min Zhang, Xiaobin Xu, Xinglong Zhang
...
**Comment:** Does not match any specific criteria. Applies LLMs to multi-agent design for turbomachinery, but not focused on spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5
