# Personalized Daily ArXiv Papers 04/01/2026
...
0. [OccSim: Multi-kilometer Simulation with Long-horizon Occupancy World Models](#link0)
**Authors:** Tianran Liu, Shengwen Zhao, Mozhgan Pourkeshavarz, Weican Li, Nicholas Rhinehart

1. [SceneTeract: Agentic Functional Affordances and VLM Grounding in 3D Scenes](#link1)
**Authors:** L\'eopold Maillard, Francis Engelmann, Tom Durand, Boxiao Pan, Yang You, Or Litany, Leonidas Guibas, Maks Ovsjanikov

2. [PRISM: A Multi-View Multi-Capability Retail Video Dataset for Embodied Vision-Language Models](#link2)
...
3. [SurgTEMP: Temporal-Aware Surgical Video Question Answering with Text-guided Visual Memory for Laparoscopic Cholecystectomy](#link3)
**Authors:** Shi Li (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Vinkle Srivastav (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Nicolas Chanel (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Saurav Sharma (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Nabani Banik (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Lorenzo Arboit (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Kun Yuan (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Pietro Mascagni (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France, Fondazione Policlinico Universitario Agostino Gemelli IRCCS, Rome, Italy), Nicolas Padoy (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France)

4. [M2H-MX: Multi-Task Dense Visual Perception for Real-Time Monocular Spatial Understanding](#link4)
**Authors:** U. V. B. L. Udugama, George Vosselman, Francesco Nex

5. [SeGPruner: Semantic-Geometric Visual Token Pruner for 3D Question Answering](#link5)
**Authors:** Wenli Li, Kai Zhao, Haoran Jiang, Enquan Yang, Yi Su, Dan Zeng

6. [PSPA-Bench: A Personalized Benchmark for Smartphone GUI Agent](#link6)
**Authors:** Hongyi Nie, Xunyuan Liu, Yudong Bai, Yaqing Wang, Yang Liu, Quanming Yao, Zhen Wang

7. [TSHA: A Benchmark for Visual Language Models in Trustworthy Safety Hazard Assessment Scenarios](#link7)
**Authors:** Qiucheng Yu, Ruijie Xu, Mingang Chen, Xuequan Lu, Jianfeng Dong, Chaochao Lu, Xin Tan

8. [Better than Average: Spatially-Aware Aggregation of Segmentation Uncertainty Improves Downstream Performance](#link8)
...
9. [CutClaw: Agentic Hours-Long Video Editing via Music Synchronization](#link9)
**Authors:** Shifang Zhao, Yihan Hu, Ying Shan, Yunchao Wei, Xiaodong Cun

10. [BigEarthNet.txt: A Large-Scale Multi-Sensor Image-Text Dataset and Benchmark for Earth Observation](#link10)
...
11. [C-TRAIL: A Commonsense World Framework for Trajectory Planning in Autonomous Driving](#link11)
**Authors:** Zhihong Cui, Haoran Tang, Tianyi Li, Yushuai Li, Peiyuan Guan, Amir Taherkordi, Tor Skeie

12. [Owl-AuraID 1.0: An Intelligent System for Autonomous Scientific Instrumentation and Scientific Data Analysis](#link12)
...
13. [OmniRoam: World Wandering via Long-Horizon Panoramic Video Generation](#link13)
...
14. [LightHarmony3D: Harmonizing Illumination and Shadows for Object Insertion in 3D Gaussian Splatting](#link14)
**Authors:** Tianyu Huang, Zhenyang Ren, Zhenchen Wan, Jiyang Zheng, Wenjie Wang, Runnan Chen, Mingming Gong, Tongliang Liu

15. [GRVS: a Generalizable and Recurrent Approach to Monocular Dynamic View Synthesis](#link15)
...
16. [SciVisAgentBench: A Benchmark for Evaluating Scientific Data Analysis and Visualization Agents](#link16)
...
17. [Xuanwu: Evolving General Multimodal Models into an Industrial-Grade Foundation for Content Ecosystems](#link17)
**Authors:** Zhiqian Zhang, Xu Zhao, Xiaoqing Xu, Guangdong Liang, Weijia Wang, Xiaolei Lv, Bo Li, Jun Gao

18. [Seeing the Evidence, Missing the Answer: Tool-Guided Vision-Language Models on Visual Illusions](#link18)
**Authors:** Xuesong Wang, Harry Wang

19. [Video-Oasis: Rethinking Evaluation of Video Understanding](#link19)
**Authors:** Geuntaek Lim, Minho Shim, Sungjune Park, Jaeyun Lee, Inwoong Lee, Taeoh Kim, Dongyoon Wee, Yukyung Choi

20. [Gloria: Consistent Character Video Generation via Content Anchors](#link20)
**Authors:** Yuhang Yang, Fan Zhang, Huaijin Pi, Shuai Guo, Guowei Xu, Wei Zhai, Yang Cao, Zheng-Jun Zha

21. [SLVMEval: Synthetic Meta Evaluation Benchmark for Text-to-Long Video Generation](#link21)
**Authors:** Ryosuke Matsuda, Keito Kudo, Haruto Yoshida, Nobuyuki Shimizu, Jun Suzuki

22. [Square Superpixel Generation and Representation Learning via Granular Ball Computing](#link22)
**Authors:** Shuyin Xia, Meng Yang, Dawei Dai, Fan Chen, Shilin Zhao, Junwei Han, Xinbo Gao, Guoyin Wang, Wen Lu

23. [ASI-Evolve: AI Accelerates AI](#link23)
**Authors:** Weixian Xu, Tiantian Mi, Yixiu Liu, Yang Nan, Zhimeng Zhou, Lyumanshan Ye, Lin Zhang, Yu Qiao, Pengfei Liu

24. [UltraG-Ray: Physics-Based Gaussian Ray Casting for Novel Ultrasound View Synthesis](#link24)
**Authors:** Felix Duelmer, Jakob Klaushofer, Magdalena Wysocki, Nassir Navab, Mohammad Farid Azampour

25. [Compressive sensing inspired self-supervised single-pixel imaging](#link25)
**Authors:** Jijun Lu, Yifan Chen, Libang Chen, Yiqiang Zhou, Ye Zheng, Mingliang Chen, Zhe Sun, Xuelong Li

26. [Beyond Ground-Truth: Leveraging Image Quality Priors for Real-World Image Restoration](#link26)
**Authors:** Fengyang Xiao, Peng Hu, Lei Xu, XingE Guo, Guanyi Qin, Yuqi Shen, Chengyu Fang, Rihan Zhang, Chunming He, Sina Farsiu

27. [Conditional Polarization Guidance for Camouflaged Object Detection](#link27)
**Authors:** QIfan Zhang, Hao Wang, Xiangrong Qin, Ruijie Li

28. [Monocular Building Height Estimation from PhiSat-2 Imagery: Dataset and Method](#link28)
**Authors:** Yanjiao Song, Bowen Cai, Timo Balz, Zhenfeng Shao, Neema Simon Sumari, James Magidi, Walter Musakwa

29. [HSFM: Hard-Set-Guided Feature-Space Meta-Learning for Robust Classification under Spurious Correlations](#link29)
**Authors:** Aryan Yazdan Parast, Khawar Islam, Soyoun Won, Basim Azam, Naveed Akhtar

30. [Spontaneous Functional Differentiation in Large Language Models: A Brain-Like Intelligence Economy](#link30)
**Authors:** Junjie Zhang, Zhen Shen, Gang Xiong, Xisong Dong

31. [End-to-End Image Compression with Segmentation Guided Dual Coding for Wind Turbines](#link31)
**Authors:** Ra\"ul P\'erez-Gonzalo, Andreas Espersen, S{\o}ren Forchhammer, Antonio Agudo

32. [All-in-One Augmented Reality Guided Head and Neck Tumor Resection](#link32)
**Authors:** Yue Yang, Matthieu Chabanas, Carrie Reale, Annie Benson, Jason Slagle, Matthew Weinger, Michael Topf, Jie Ying Wu

33. [SimMOF: AI agent for Automated MOF Simulations](#link33)
**Authors:** Jaewoong Lee, Taeun Bae, Jihan Kim

34. [Multi-Layered Memory Architectures for LLM Agents: An Experimental Evaluation of Long-Term Context Retention](#link34)
**Authors:** Sunil Tiwari, Payal Fofadiya

35. [3D Architect: An Automated Approach to Three-Dimensional Modeling](#link35)
**Authors:** Sunil Tiwari, Payal Fofadiya, Vicky Vishwakarma

---
## 0. [OccSim: Multi-kilometer Simulation with Long-horizon Occupancy World Models](https://arxiv.org/abs/2603.28887) <a id="link0"></a>
**ArXiv ID:** 2603.28887
**Authors:** Tianran Liu, Shengwen Zhao, Mozhgan Pourkeshavarz, Weican Li, Nicholas Rhinehart
...
**Comment:** OccSim presents a new simulator for autonomous driving that generates multi-kilometer 3D occupancy maps from a single frame and ego-actions, breaking the dependency on logs/HD maps. This is a strong match for criterion 3 (embodied AI, new benchmark/simulator, novel method for simulation).
**Relevance:** 10
**Novelty:** 8

---

## 1. [SceneTeract: Agentic Functional Affordances and VLM Grounding in 3D Scenes](https://arxiv.org/abs/2603.29798) <a id="link1"></a>
**ArXiv ID:** 2603.29798
**Authors:** L\'eopold Maillard, Francis Engelmann, Tom Durand, Boxiao Pan, Yang You, Or Litany, Leonidas Guibas, Maks Ovsjanikov
...
**Comment:** Matches criteria 1 (spatial understanding in embodied agents), 3 (new methods and benchmarks for embodied AI), and 2 (VLMs). SceneTeract introduces a framework for verifying 3D scene functionality under agent constraints, evaluates VLMs' affordance reasoning, and provides a new verification suite for embodied 3D scene understanding. The coupling of semantic reasoning with geometric checks and use as a reward engine is a novel contribution.
**Relevance:** 10
**Novelty:** 8

---

## 2. [PRISM: A Multi-View Multi-Capability Retail Video Dataset for Embodied Vision-Language Models](https://arxiv.org/abs/2603.29281) <a id="link2"></a>
**ArXiv ID:** 2603.29281
**Authors:** Amirreza Rouhi, Parikshit Sakurikar, Satya Sai Reddy, Narsimha Menga, Anirudh Govil, Sri Harsha Chittajallu, Rajat Aggarwal, Anoop Namboodiri, Sashi Reddi
...
**Comment:** Matches criteria 1 (spatial understanding in embodied agents), 3 (new benchmark/dataset for embodied AI), and 2 (focus on embodied VLMs). PRISM is a large, multi-view, multi-capability dataset for embodied vision-language models, specifically targeting spatial, temporal, and physical knowledge in real-world retail environments. The ontology-structured approach and empirical results on embodied action understanding are highly relevant.
**Relevance:** 10
**Novelty:** 8

---

## 3. [SurgTEMP: Temporal-Aware Surgical Video Question Answering with Text-guided Visual Memory for Laparoscopic Cholecystectomy](https://arxiv.org/abs/2603.29962) <a id="link3"></a>
**ArXiv ID:** 2603.29962
**Authors:** Shi Li (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Vinkle Srivastav (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Nicolas Chanel (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Saurav Sharma (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Nabani Banik (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Lorenzo Arboit (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Kun Yuan (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France), Pietro Mascagni (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France, Fondazione Policlinico Universitario Agostino Gemelli IRCCS, Rome, Italy), Nicolas Padoy (University of Strasbourg, CNRS, INSERM, ICube, Strasbourg, France)
...
**Comment:** Matches criterion 2: Proposes SurgTEMP, a multimodal LLM framework for surgical video QA, with a new dataset and hierarchical memory. Strong focus on MLLMs and temporal/spatial reasoning.
**Relevance:** 9
**Novelty:** 8

---

## 4. [M2H-MX: Multi-Task Dense Visual Perception for Real-Time Monocular Spatial Understanding](https://arxiv.org/abs/2603.29236) <a id="link4"></a>
**ArXiv ID:** 2603.29236
**Authors:** U. V. B. L. Udugama, George Vosselman, Francesco Nex
...
**Comment:** M2H-MX is a real-time multi-task perception model for monocular spatial understanding, integrating depth and semantic prediction for robotic mapping. This is a strong match for criterion 1 (methodological improvements to spatial understanding on embodied agents).
**Relevance:** 9
**Novelty:** 7

---

## 5. [SeGPruner: Semantic-Geometric Visual Token Pruner for 3D Question Answering](https://arxiv.org/abs/2603.29437) <a id="link5"></a>
**ArXiv ID:** 2603.29437
**Authors:** Wenli Li, Kai Zhao, Haoran Jiang, Enquan Yang, Yi Su, Dan Zeng
...
**Comment:** Matches criteria 2 (VLMs/MLLMs) and 1 (spatial intelligence in embodied agents). SeGPruner proposes a semantic-geometric token pruning method for 3D question answering, improving efficiency and maintaining spatial coverage. The combination of semantic and geometric cues for token pruning in 3D QA is a novel angle.
**Relevance:** 9
**Novelty:** 7

---

## 6. [PSPA-Bench: A Personalized Benchmark for Smartphone GUI Agent](https://arxiv.org/abs/2603.29318) <a id="link6"></a>
**ArXiv ID:** 2603.29318
**Authors:** Hongyi Nie, Xunyuan Liu, Yudong Bai, Yaqing Wang, Yang Liu, Quanming Yao, Zhen Wang
...
**Comment:** Matches criterion 3: Introduces a new benchmark (PSPA-Bench) for personalized smartphone GUI agents, with fine-grained evaluation and analysis of current methods. Focuses on a novel angle (personalization) previously ignored.
**Relevance:** 8
**Novelty:** 8

---

## 7. [TSHA: A Benchmark for Visual Language Models in Trustworthy Safety Hazard Assessment Scenarios](https://arxiv.org/abs/2603.29759) <a id="link7"></a>
**ArXiv ID:** 2603.29759
**Authors:** Qiucheng Yu, Ruijie Xu, Mingang Chen, Xuequan Lu, Jianfeng Dong, Chaochao Lu, Xin Tan
...
**Comment:** Matches criterion 3 and 4: Introduces a new, large-scale, real-world benchmark for VLMs in safety hazard assessment, addressing limitations of previous simulation-based benchmarks. Also evaluates and improves VLMs' generalizability.
**Relevance:** 8
**Novelty:** 8

---

## 8. [Better than Average: Spatially-Aware Aggregation of Segmentation Uncertainty Improves Downstream Performance](https://arxiv.org/abs/2603.29941) <a id="link8"></a>
**ArXiv ID:** 2603.29941
**Authors:** Vanessa Emanuela Guarino, Claudia Winklmayr, Jannik Franzen, Josef Lorenz Rumberger, Manuel Pfeuffer, Sonja Greven, Klaus Maier-Hein, Carsten T. L\"uth, Christoph Karg, Dagmar Kainmueller
...
**Comment:** Matches criterion 1: Proposes novel spatially-aware aggregation strategies for segmentation uncertainty, with a meta-aggregator leveraging spatial structure for improved downstream performance. Strong focus on spatial intelligence and methodological improvement.
**Relevance:** 9
**Novelty:** 7

---

## 9. [CutClaw: Agentic Hours-Long Video Editing via Music Synchronization](https://arxiv.org/abs/2603.29664) <a id="link9"></a>
**ArXiv ID:** 2603.29664
**Authors:** Shifang Zhao, Yihan Hu, Ying Shan, Yunchao Wei, Xiaodong Cun
...
**Comment:** Matches criterion 2 (new MLLMs) and partially criterion 4 (application of multimodal models). Proposes an autonomous multi-agent framework using multiple MLLMs for long video editing via music synchronization, with hierarchical multimodal decomposition and agent collaboration.
**Relevance:** 8
**Novelty:** 7

---

## 10. [BigEarthNet.txt: A Large-Scale Multi-Sensor Image-Text Dataset and Benchmark for Earth Observation](https://arxiv.org/abs/2603.29630) <a id="link10"></a>
**ArXiv ID:** 2603.29630
**Authors:** Johann-Ludwig Herzog, Mathis J\"urgen Adler, Leonard Hackel, Yan Shu, Angelos Zavras, Ioannis Papoutsis, Paolo Rota, Beg\"um Demir
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Introduces a large-scale multi-sensor image-text dataset for Earth observation, enabling benchmarking and fine-tuning of VLMs on remote sensing data. Also provides empirical insights into VLM limitations and improvements.
**Relevance:** 8
**Novelty:** 7

---

## 11. [C-TRAIL: A Commonsense World Framework for Trajectory Planning in Autonomous Driving](https://arxiv.org/abs/2603.29908) <a id="link11"></a>
**ArXiv ID:** 2603.29908
**Authors:** Zhihong Cui, Haoran Tang, Tianyi Li, Yushuai Li, Peiyuan Guan, Amir Taherkordi, Tor Skeie
...
**Comment:** C-TRAIL is a framework for trajectory planning in autonomous driving, combining LLM-derived commonsense with a trust mechanism. It is relevant to embodied AI (criterion 3), especially for integrating LLMs into planning with a novel trust mechanism.
**Relevance:** 8
**Novelty:** 7

---

## 12. [Owl-AuraID 1.0: An Intelligent System for Autonomous Scientific Instrumentation and Scientific Data Analysis](https://arxiv.org/abs/2603.29828) <a id="link12"></a>
**ArXiv ID:** 2603.29828
**Authors:** Han Deng, Anqi Zou, Hanling Zhang, Ben Fei, Chengyu Zhang, Haobo Wang, Xinru Guo, Zhenyu Li, Xuzhu Wang, Peng Yang, Fujian Zhang, Weiyu Guo, Xiaohong Shao, Zhaoyang Liu, Shixiang Tang, Zhihui Wang, Wanli Ouyang
...
**Comment:** This paper introduces Owl-AuraID, an embodied agent system for autonomous scientific instrumentation and data analysis. It matches criterion 3 (embodied AI, new benchmark/system, novel angle: GUI-native paradigm for instrument control).
**Relevance:** 8
**Novelty:** 7

---

## 13. [OmniRoam: World Wandering via Long-Horizon Panoramic Video Generation](https://arxiv.org/abs/2603.30045) <a id="link13"></a>
**ArXiv ID:** 2603.30045
**Authors:** Yuheng Liu, Xin Lin, Xinke Li, Baihan Yang, Chen Wang, Kalyan Sunkavalli, Yannick Hold-Geoffroy, Hao Tan, Kai Zhang, Xiaohui Xie, Zifan Shi, Yiwei Hu
...
**Comment:** Matches criteria 4 (vision foundation models and applications) and is relevant to generative modeling in multi-modal learning. OmniRoam introduces a panoramic video generation framework for long-horizon scene wandering, with new datasets and applications to 3D reconstruction. The panoramic, controllable, and long-term consistency aspects are novel.
**Relevance:** 8
**Novelty:** 7

---

## 14. [LightHarmony3D: Harmonizing Illumination and Shadows for Object Insertion in 3D Gaussian Splatting](https://arxiv.org/abs/2603.29209) <a id="link14"></a>
**ArXiv ID:** 2603.29209
**Authors:** Tianyu Huang, Zhenyang Ren, Zhenchen Wan, Jiyang Zheng, Wenjie Wang, Runnan Chen, Mingming Gong, Tongliang Liu
...
**Comment:** Matches criterion 4: Presents a generative module for illumination-consistent mesh insertion in 3D Gaussian Splatting, and introduces a new benchmark for lighting consistency. Strong application of vision foundation models.
**Relevance:** 8
**Novelty:** 7

---

## 15. [GRVS: a Generalizable and Recurrent Approach to Monocular Dynamic View Synthesis](https://arxiv.org/abs/2603.29734) <a id="link15"></a>
**ArXiv ID:** 2603.29734
**Authors:** Thomas Tanay, Mohammed Brahimi, Michal Nazarczuk, Qingwen Zhang, Sibi Catley-Chandar, Arthur Moreau, Zhensong Zhang, Eduardo P\'erez-Pellitero
...
**Comment:** Matches criterion 4: Proposes a new generalizable model for monocular dynamic view synthesis, outperforming existing methods and introducing a new dataset. Strong vision foundation model angle.
**Relevance:** 8
**Novelty:** 7

---

## 16. [SciVisAgentBench: A Benchmark for Evaluating Scientific Data Analysis and Visualization Agents](https://arxiv.org/abs/2603.29139) <a id="link16"></a>
**ArXiv ID:** 2603.29139
**Authors:** Kuangshi Ai, Haichao Miao, Kaiyuan Tang, Nathaniel Gorski, Jianxin Sun, Guoxi Liu, Helgi I. Ingolfsson, David Lenz, Hanqi Guo, Hongfeng Yu, Teja Leburu, Michael Molash, Bei Wang, Tom Peterka, Chaoli Wang, Shusen Liu
...
**Comment:** Matches criterion 3 (embodied AI papers on new benchmarks/simulators). Introduces a new benchmark for evaluating scientific data analysis and visualization agents, with a multimodal evaluation pipeline and expert validation. Focuses on agentic systems and systematic comparison.
**Relevance:** 7
**Novelty:** 7

---

## 17. [Xuanwu: Evolving General Multimodal Models into an Industrial-Grade Foundation for Content Ecosystems](https://arxiv.org/abs/2603.29211) <a id="link17"></a>
**ArXiv ID:** 2603.29211
**Authors:** Zhiqian Zhang, Xu Zhao, Xiaoqing Xu, Guangdong Liang, Weijia Wang, Xiaolei Lv, Bo Li, Jun Gao
...
**Comment:** Matches criteria 2 (new MLLMs/VLLMs) and 4 (vision foundation models and applications). Xuanwu VL-2B is a new industrial-grade multimodal foundation model with a focus on fine-grained visual perception and business alignment, showing strong empirical results in content moderation and adversarial settings.
**Relevance:** 8
**Novelty:** 6

---

## 18. [Seeing the Evidence, Missing the Answer: Tool-Guided Vision-Language Models on Visual Illusions](https://arxiv.org/abs/2603.29428) <a id="link18"></a>
**ArXiv ID:** 2603.29428
**Authors:** Xuesong Wang, Harry Wang
...
**Comment:** Matches criteria 2 (VLMs) and 4 (vision foundation models and applications). The paper investigates VLMs' systematic bias on visual illusions and proposes a tool-guided inference framework, revealing surprising empirical results about VLM reasoning. The empirical findings and tool-based approach are insightful.
**Relevance:** 7
**Novelty:** 7

---

## 19. [Video-Oasis: Rethinking Evaluation of Video Understanding](https://arxiv.org/abs/2603.29616) <a id="link19"></a>
**ArXiv ID:** 2603.29616
**Authors:** Geuntaek Lim, Minho Shim, Sungjune Park, Jaeyun Lee, Inwoong Lee, Taeoh Kim, Dongyoon Wee, Yukyung Choi
...
**Comment:** Matches criterion 3: Proposes a diagnostic suite (Video-Oasis) to systematically evaluate and analyze video understanding benchmarks, revealing overlooked issues and providing guidelines for future benchmarks.
**Relevance:** 7
**Novelty:** 7

---

## 20. [Gloria: Consistent Character Video Generation via Content Anchors](https://arxiv.org/abs/2603.29931) <a id="link20"></a>
**ArXiv ID:** 2603.29931
**Authors:** Yuhang Yang, Fan Zhang, Huaijin Pi, Shuai Guo, Guowei Xu, Wei Zhai, Yang Cao, Zheng-Jun Zha
...
**Comment:** Relevant to generative modeling and computer vision, but does not directly match any specific criterion (not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models). Focuses on character video generation with content anchors.
**Relevance:** 4
**Novelty:** 7

---

## 21. [SLVMEval: Synthetic Meta Evaluation Benchmark for Text-to-Long Video Generation](https://arxiv.org/abs/2603.29186) <a id="link21"></a>
**ArXiv ID:** 2603.29186
**Authors:** Ryosuke Matsuda, Keito Kudo, Haruto Yoshida, Nobuyuki Shimizu, Jun Suzuki
...
**Comment:** Partially matches criterion 3 (benchmark for evaluation), but is focused on evaluation of text-to-long-video generation systems rather than embodied AI or simulators. Relevant for empirical insights into evaluation weaknesses.
**Relevance:** 5
**Novelty:** 6

---

## 22. [Square Superpixel Generation and Representation Learning via Granular Ball Computing](https://arxiv.org/abs/2603.29460) <a id="link22"></a>
**ArXiv ID:** 2603.29460
**Authors:** Shuyin Xia, Meng Yang, Dawei Dai, Fan Chen, Shilin Zhao, Junwei Han, Xinbo Gao, Guoyin Wang, Wen Lu
...
**Comment:** This paper proposes a new method for generating square superpixels for vision tasks, facilitating integration with GNNs/ViTs. It is related to vision foundation models (criterion 4), but is more about representation learning than foundation models per se.
**Relevance:** 5
**Novelty:** 6

---

## 23. [ASI-Evolve: AI Accelerates AI](https://arxiv.org/abs/2603.29640) <a id="link23"></a>
**ArXiv ID:** 2603.29640
**Authors:** Weixian Xu, Tiantian Mi, Yixiu Liu, Yang Nan, Zhimeng Zhou, Lyumanshan Ye, Lin Zhang, Yu Qiao, Pengfei Liu
...
**Comment:** Not directly related to any specific criterion. Focuses on AI-for-AI research and agentic frameworks for accelerating AI development, with some relevance to general machine learning interests.
**Relevance:** 3
**Novelty:** 8

---

## 24. [UltraG-Ray: Physics-Based Gaussian Ray Casting for Novel Ultrasound View Synthesis](https://arxiv.org/abs/2603.29022) <a id="link24"></a>
**ArXiv ID:** 2603.29022
**Authors:** Felix Duelmer, Jakob Klaushofer, Magdalena Wysocki, Nassir Navab, Mohammad Farid Azampour
...
**Comment:** Somewhat relevant to spatial understanding (criterion 1) via novel view synthesis, but focused on ultrasound imaging. The physics-based Gaussian ray casting is a methodological improvement, but the application domain is narrow.
**Relevance:** 4
**Novelty:** 6

---

## 25. [Compressive sensing inspired self-supervised single-pixel imaging](https://arxiv.org/abs/2603.29732) <a id="link25"></a>
**ArXiv ID:** 2603.29732
**Authors:** Jijun Lu, Yifan Chen, Libang Chen, Yiqiang Zhou, Ye Zheng, Mingliang Chen, Zhe Sun, Xuelong Li
...
**Comment:** Relevant to computer vision and compressive sensing, but does not match any specific criterion (no spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models).
**Relevance:** 3
**Novelty:** 6

---

## 26. [Beyond Ground-Truth: Leveraging Image Quality Priors for Real-World Image Restoration](https://arxiv.org/abs/2603.29773) <a id="link26"></a>
**ArXiv ID:** 2603.29773
**Authors:** Fengyang Xiao, Peng Hu, Lei Xu, XingE Guo, Guanyi Qin, Yuqi Shen, Chengyu Fang, Rihan Zhang, Chunming He, Sina Farsiu
...
**Comment:** Relevant to general computer vision and machine learning, but does not directly match any specific criterion. Focuses on image restoration using image quality priors, not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 27. [Conditional Polarization Guidance for Camouflaged Object Detection](https://arxiv.org/abs/2603.30008) <a id="link27"></a>
**ArXiv ID:** 2603.30008
**Authors:** QIfan Zhang, Hao Wang, Xiangrong Qin, Ruijie Li
...
**Comment:** This paper proposes a new method for camouflaged object detection using polarization cues. While it is a novel vision method, it does not match the specific criteria (no spatial intelligence, VLLM/MLLM, embodied AI, or vision foundation model focus).
**Relevance:** 3
**Novelty:** 6

---

## 28. [Monocular Building Height Estimation from PhiSat-2 Imagery: Dataset and Method](https://arxiv.org/abs/2603.29245) <a id="link28"></a>
**ArXiv ID:** 2603.29245
**Authors:** Yanjiao Song, Bowen Cai, Timo Balz, Zhenfeng Shao, Neema Simon Sumari, James Magidi, Walter Musakwa
...
**Comment:** This paper introduces a new dataset and method for monocular building height estimation from satellite imagery. While it involves spatial understanding, it is not focused on embodied agents or spatial intelligence in embodied settings. Some relevance to spatial understanding (criterion 1), but not a direct match.
**Relevance:** 4
**Novelty:** 5

---

## 29. [HSFM: Hard-Set-Guided Feature-Space Meta-Learning for Robust Classification under Spurious Correlations](https://arxiv.org/abs/2603.29313) <a id="link29"></a>
**ArXiv ID:** 2603.29313
**Authors:** Aryan Yazdan Parast, Khawar Islam, Soyoun Won, Basim Azam, Naveed Akhtar
...
**Comment:** This paper proposes a new meta-learning method for robust classification under spurious correlations, with CLIP-based visualizations. While it uses vision-language models for analysis, it does not introduce a new VLLM/MLLM or focus on embodied agents or spatial intelligence. Closest to criterion 4 (vision foundation models and applications), but not a direct match.
**Relevance:** 4
**Novelty:** 5

---

## 30. [Spontaneous Functional Differentiation in Large Language Models: A Brain-Like Intelligence Economy](https://arxiv.org/abs/2603.29735) <a id="link30"></a>
**ArXiv ID:** 2603.29735
**Authors:** Junjie Zhang, Zhen Shen, Gang Xiong, Xisong Dong
...
**Comment:** Some relevance to vision-language models (criterion 2), but focuses on internal functional differentiation in LLMs, not VLLMs or MLLMs. Interesting empirical findings, but not a direct match.
**Relevance:** 3
**Novelty:** 6

---

## 31. [End-to-End Image Compression with Segmentation Guided Dual Coding for Wind Turbines](https://arxiv.org/abs/2603.29927) <a id="link31"></a>
**ArXiv ID:** 2603.29927
**Authors:** Ra\"ul P\'erez-Gonzalo, Andreas Espersen, S{\o}ren Forchhammer, Antonio Agudo
...
**Comment:** Some relevance to vision foundation models (criterion 4) via deep learning-based segmentation and compression, but primarily an application to wind turbine inspection. Not a new foundation model or benchmark.
**Relevance:** 4
**Novelty:** 5

---

## 32. [All-in-One Augmented Reality Guided Head and Neck Tumor Resection](https://arxiv.org/abs/2603.29495) <a id="link32"></a>
**ArXiv ID:** 2603.29495
**Authors:** Yue Yang, Matthieu Chabanas, Carrie Reale, Annie Benson, Jason Slagle, Matthew Weinger, Michael Topf, Jie Ying Wu
...
**Comment:** Relevant to vision applications (augmented reality in surgery), but does not match any specific criterion (not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models).
**Relevance:** 3
**Novelty:** 5

---

## 33. [SimMOF: AI agent for Automated MOF Simulations](https://arxiv.org/abs/2603.29152) <a id="link33"></a>
**ArXiv ID:** 2603.29152
**Authors:** Jaewoong Lee, Taeun Bae, Jihan Kim
...
**Comment:** SimMOF is a multi-agent LLM-based framework for automating MOF simulations. It is an application of LLMs to scientific workflows, but does not introduce new VLLMs/MLLMs, spatial intelligence, or embodied AI benchmarks. Not a direct match.
**Relevance:** 3
**Novelty:** 5

---

## 34. [Multi-Layered Memory Architectures for LLM Agents: An Experimental Evaluation of Long-Term Context Retention](https://arxiv.org/abs/2603.29194) <a id="link34"></a>
**ArXiv ID:** 2603.29194
**Authors:** Sunil Tiwari, Payal Fofadiya
...
**Comment:** Somewhat relevant to general interest in LLMs and memory architectures, but not directly matching any specific criterion.
**Relevance:** 3
**Novelty:** 5

---

## 35. [3D Architect: An Automated Approach to Three-Dimensional Modeling](https://arxiv.org/abs/2603.29191) <a id="link35"></a>
**ArXiv ID:** 2603.29191
**Authors:** Sunil Tiwari, Payal Fofadiya, Vicky Vishwakarma
...
**Comment:** Some relevance to spatial understanding (criterion 1), but focuses on 3D reconstruction from orthographic views using classical computer vision techniques, not embodied agents or learning-based methods.
**Relevance:** 4
**Novelty:** 4
