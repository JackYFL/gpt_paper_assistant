...
0. [SGR3 Model: Scene Graph Retrieval-Reasoning Model in 3D](#link0)
...
1. [SkillNet: Create, Evaluate, and Connect AI Skills](#link1)
...
2. [AdaIAT: Adaptively Increasing Attention to Generated Text to Alleviate Hallucinations in LVLM](#link2)
**Authors:** Li'an Zhong, Ziqiang He, Jibin Zheng, Jin Li, Z. Jane Wang, Xiangui Kang

3. [ORMOT: A Dataset and Framework for Omnidirectional Referring Multi-Object Tracking](#link3)
**Authors:** Sijia Chen, Zihan Zhou, Yanqiu Yu, En Yu, Wenbing Tao

4. [UniM: A Unified Any-to-Any Interleaved Multimodal Benchmark](#link4)
...
5. [KARL: Knowledge Agents via Reinforcement Learning](#link5)
...
6. [EvoTool: Self-Evolving Tool-Use Policy Optimization in LLM Agents via Blame-Aware Mutation and Diversity-Aware Selection](#link6)
**Authors:** Shuo Yang, Soyeon Caren Han, Xueqi Ma, Yan Li, Mohammad Reza Ghasemi Madani, Eduard Hovy

7. [Evaluating GPT-5 as a Multimodal Clinical Reasoner: A Landscape Commentary](#link7)
**Authors:** Alexandru Florea, Shansong Wang, Mingzhe Hu, Qiang Li, Zach Eidex, Luke del Balzo, Mojtaba Safari, Xiaofeng Yang

8. [Act, Think or Abstain: Complexity-Aware Adaptive Inference for Vision-Language-Action Models](#link8)
**Authors:** Riccardo Andrea Izzo, Gianluca Bardaro, Matteo Matteucci

9. [WebFactory: Automated Compression of Foundational Language Intelligence into Grounded Web Agents](#link9)
**Authors:** Sicheng Fan, Qingyun Shi, Shengze Xu, Shengbo Cai, Tieyong Zeng, Li Ling, Yanyi Shang, Dehan Kong

10. [Toward Real-world Infrared Image Super-Resolution: A Unified Autoregressive Framework and Benchmark Dataset](#link10)
**Authors:** Yang Zou, Jun Ma, Zhidong Jiao, Xingyuan Li, Zhiying Jiang, Jinyuan Liu

11. [A Simple Baseline for Unifying Understanding, Generation, and Editing via Vanilla Next-token Prediction](#link11)
**Authors:** Jie Zhu, Hanghang Ma, Jia Wang, Yayong Guan, Yanbing Zeng, Lishuai Gao, Junqiang Wu, Jie Hu, Leye Wang

12. [K-Gen: A Multimodal Language-Conditioned Approach for Interpretable Keypoint-Guided Trajectory Generation](#link12)
**Authors:** Mingxuan Mu, Guo Yang, Lei Chen, Ping Wu, Jianxun Cui

13. [Guiding Diffusion-based Reconstruction with Contrastive Signals for Balanced Visual Representation](#link13)
**Authors:** Boyu Han, Qianqian Xu, Shilong Bao, Zhiyong Yang, Ruochen Cui, Xilin Zhao, Qingming Huang

14. [Tell2Adapt: A Unified Framework for Source Free Unsupervised Domain Adaptation via Vision Foundation Model](#link14)
**Authors:** Yulong Shi, Shijie Li, Ziyi Li, Lin Qi

15. [MoRe: Motion-aware Feed-forward 4D Reconstruction Transformer](#link15)
**Authors:** Juntong Fang, Zequn Chen, Weiqi Zhang, Donglin Di, Xuancheng Zhang, Chengmin Yang, Yu-Shen Liu

16. [MASQuant: Modality-Aware Smoothing Quantization for Multimodal Large Language Models](#link16)
**Authors:** Lulu Hu, Wenhu Xiao, Xin Chen, Xinhua Xu, Bowen Xu, Kun Li, Yongliang Tao

17. [Towards Highly Transferable Vision-Language Attack via Semantic-Augmented Dynamic Contrastive Interaction](#link17)
**Authors:** Yuanbo Li, Tianyang Xu, Cong Hu, Tao Zhou, Xiao-Jun Wu, Josef Kittler

18. [Towards 3D Scene Understanding of Gas Plumes in LWIR Hyperspectral Images Using Neural Radiance Fields](#link18)
**Authors:** Scout Jarman, Zigfried Hampel-Arias, Adra Carr, Kevin R. Moon

19. [Multi-Paradigm Collaborative Adversarial Attack Against Multi-Modal Large Language Models](#link19)
**Authors:** Yuanbo Li, Tianyang Xu, Cong Hu, Tao Zhou, Xiao-Jun Wu, Josef Kittler

20. [Locality-Attending Vision Transformer](#link20)
**Authors:** Sina Hajimiri, Farzad Beizaee, Fereshteh Shakeri, Christian Desrosiers, Ismail Ben Ayed, Jose Dolz

21. [MobileFetalCLIP: Selective Repulsive Knowledge Distillation for Mobile Fetal Ultrasound Analysis](#link21)
**Authors:** Numan Saeed, Fadillah Adamsyah Maani, Mohammad Yaqub

22. [Structure Observation Driven Image-Text Contrastive Learning for Computed Tomography Report Generation](#link22)
**Authors:** Hong Liu, Dong Wei, Qiong Peng, Yawen Huang, Xian Wu, Yefeng Zheng, Liansheng Wang

23. [MI-DETR: A Strong Baseline for Moving Infrared Small Target Detection with Bio-Inspired Motion Integration](#link23)
...
24. [STRUCTUREDAGENT: Planning with AND/OR Trees for Long-Horizon Web Tasks](#link24)
**Authors:** ELita Lobo, Xu Chen, Jingjing Meng, Nan Xi, Yang Jiao, Chirag Agarwal, Yair Zick, Yan Gao

25. [Fusion4CA: Boosting 3D Object Detection via Comprehensive Image Exploitation](#link25)
**Authors:** Kang Luo, Xin Chen, Yangyi Xiao, Hesheng Wang

26. [SPyCer: Semi-Supervised Physics-Guided Contextual Attention for Near-Surface Air Temperature Estimation from Satellite Imagery](#link26)
**Authors:** Sofiane Bouaziz, Adel Hafiane, Raphael Canals, Rachid Nedjai

27. [NaiLIA: Multimodal Nail Design Retrieval Based on Dense Intent Descriptions and Palette Queries](#link27)
**Authors:** Kanon Amemiya, Daichi Yashima, Kei Katsumata, Takumi Komatsu, Ryosuke Korekata, Seitaro Otsuki, Komei Sugiura

28. [Layer by layer, module by module: Choose both for optimal OOD probing of ViT](#link28)
**Authors:** Ambroise Odonnat, Vasilii Feofanov, Laetitia Chapel, Romain Tavenard, Ievgen Redko

29. [Diffusion-Based sRGB Real Noise Generation via Prompt-Driven Noise Representation Learning](#link29)
**Authors:** Jaekyun Ko, Dongjin Kim, Soomin Lee, Guanghui Wang, Tae Hyun Kim

30. [Distributed Partial Information Puzzles: Examining Common Ground Construction Under Epistemic Asymmetry](#link30)
**Authors:** Yifan Zhu, Mariah Bradford, Kenneth Lai, Timothy Obiso, Videep Venkatesha, James Pustejovsky, Nikhil Krishnaswamy

31. [MOOSEnger -- a Domain-Specific AI Agent for the MOOSE Ecosystem](#link31)
**Authors:** Mengnan Li, Jason Miller, Zachary Prince, Alexander Lindsay, Cody Permann

32. [Evaluating and Correcting Human Annotation Bias in Dynamic Micro-Expression Recognition](#link32)
**Authors:** Feng Liu, Bingyu Nan, Xuezhong Qian, Xiaolan Fu

33. [MultiGO++: Monocular 3D Clothed Human Reconstruction via Geometry-Texture Collaboration](#link33)
**Authors:** Nanjie Yao, Gangjian Zhang, Wenhao Shen, Jian Shu, Yu Feng, Hao Wang

34. [Privacy-Aware Camera 2.0 Technical Report](#link34)
**Authors:** Huan Song, Shuyu Tian, Ting Long, Jiang Liu, Cheng Yuan, Zhenyu Jia, Jiawei Shao, Xuelong Li

35. [Timer-S1: A Billion-Scale Time Series Foundation Model with Serial Scaling](#link35)
...
36. [sFRC for assessing hallucinations in medical image restoration](#link36)
**Authors:** Prabhat Kc, Rongping Zeng, Nirmal Soni, Aldo Badano

37. [Bidirectional Curriculum Generation: A Multi-Agent Framework for Data-Efficient Mathematical Reasoning](#link37)
**Authors:** Boren Hu, Xiao Liu, Boci Peng, Xinping Zhao, Xiaoran Shang, Yun Zhu, Lijun Wu

38. [BioLLMAgent: A Hybrid Framework with Enhanced Structural Interpretability for Simulating Human Decision-Making in Computational Psychiatry](#link38)
**Authors:** Zuo Fei, Kezhi Wang, Xiaomin Chen, Yizhou Huang

39. [CONE: Embeddings for Complex Numerical Data Preserving Unit and Variable Semantics](#link39)
**Authors:** Gyanendra Shrestha, Anna Pyayt, Michael Gubanov

40. [Recognition of Daily Activities through Multi-Modal Deep Learning: A Video, Pose, and Object-Aware Approach for Ambient Assisted Living](#link40)
**Authors:** Kooshan Hashemifard, Pau Climent-P\'erez, Francisco Florez-Revuelta

41. [GloSplat: Joint Pose-Appearance Optimization for Faster and More Accurate 3D Reconstruction](#link41)
**Authors:** Tianyu Xiong, Rui Li, Linjie Li, Jiaqi Yang

42. [Rethinking Representativeness and Diversity in Dynamic Data Selection](#link42)
**Authors:** Yuzhe Zhou, Zhenglin Hua, Haiyun Guo, Yuheng Jia

43. [Dissociating Direct Access from Inference in AI Introspection](#link43)
**Authors:** Harvey Lederman, Kyle Mahowald

44. [Discovering mathematical concepts through a multi-agent system](#link44)
**Authors:** Daattavya Aggarwal, Oisin Kim, Carl Henrik Ek, Challenger Mishra

45. [On Multi-Step Theorem Prediction via Non-Parametric Structural Priors](#link45)
**Authors:** Junbo Zhao, Ting Zhang, Can Li, Wei He, Jingdong Wang, Hua Huang

46. [Adaptive Memory Admission Control for LLM Agents](#link46)
**Authors:** Guilin Zhang, Wei Jiang, Xiejiashan Wang, Aisha Behr, Kai Zhao, Jeffrey Friedman, Xu Chu, Amine Anoun

47. [Judge Reliability Harness: Stress Testing the Reliability of LLM Judges](#link47)
**Authors:** Sunishchal Dev, Andrew Sloan, Joshua Kavner, Nicholas Kong, Morgan Sandler

48. [DeformTrace: A Deformable State Space Model with Relay Tokens for Temporal Forgery Localization](#link48)
**Authors:** Xiaodong Zhu, Suting Wang, Yuanming Zheng, Junqi Yang, Yangxu Liao, Yuhong Yang, Weiping Tu, Zhongyuan Wang

49. [GEM-TFL: Bridging Weak and Full Supervision for Forgery Localization through EM-Guided Decomposition and Temporal Refinement](#link49)
**Authors:** Xiaodong Zhu, Yuanming Zheng, Suting Wang, Junqi Yang, Yuhong Yang, Weiping Tu, Zhongyuan Wang

---
## 0. [SGR3 Model: Scene Graph Retrieval-Reasoning Model in 3D](https://arxiv.org/abs/2603.04614) <a id="link0"></a>
**ArXiv ID:** 2603.04614
**Authors:** Zirui Wang, Ruiping Liu, Yufan Chen, Junwei Zheng, Weijia Fan, Kunyu Peng, Di Wen, Jiale Wei, Jiaming Zhang, Rainer Stiefelhagen
...
**Comment:** This paper presents SGR3, a training-free 3D scene graph retrieval-reasoning model using MLLMs and retrieval-augmented generation for semantic scene graph generation. It matches criterion 1 (spatial understanding in embodied agents), criterion 2 (MLLMs), and criterion 3 (novel method for spatial reasoning in embodied AI).
**Relevance:** 10
**Novelty:** 8

---

## 1. [SkillNet: Create, Evaluate, and Connect AI Skills](https://arxiv.org/abs/2603.04448) <a id="link1"></a>
**ArXiv ID:** 2603.04448
**Authors:** Yuan Liang, Ruobin Zhong, Haoming Xu, Chen Jiang, Yi Zhong, Runnan Fang, Jia-Chen Gu, Shumin Deng, Yunzhi Yao, Mengru Wang, Shuofei Qiao, Xin Xu, Tongtong Wu, Kun Wang, Yang Liu, Zhen Bi, Jungang Lou, Yuchen Eleanor Jiang, Hangcheng Zhu, Gang Yu, Haiwen Hong, Longtao Huang, Hui Xue, Chenxi Wang, Yijun Wang, Zifei Shan, Xi Chen, Zhaopeng Tu, Feiyu Xiong, Xin Xie, Peng Zhang, Zhengke Gui, Lei Liang, Jun Zhou, Chiyu Wu, Jin Shang, Yu Gong, Junyu Lin, Changliang Xu, Hongjie Deng, Wen Zhang, Keyan Ding, Qiang Zhang, Fei Huang, Ningyu Zhang, Jeff Z. Pan, Guilin Qi, Haofen Wang, Huajun Chen
...
**Comment:** Matches criterion 1 (methodological improvements to spatial intelligence on embodied agents) and criterion 3 (embodied AI, new benchmark/methods, simulator-related). SkillNet introduces a large-scale infrastructure for skill creation, evaluation, and transfer in embodied agents, with empirical results on ALFWorld, WebShop, and ScienceWorld.
**Relevance:** 10
**Novelty:** 8

---

## 2. [AdaIAT: Adaptively Increasing Attention to Generated Text to Alleviate Hallucinations in LVLM](https://arxiv.org/abs/2603.04908) <a id="link2"></a>
**ArXiv ID:** 2603.04908
**Authors:** Li'an Zhong, Ziqiang He, Jibin Zheng, Jin Li, Z. Jane Wang, Xiangui Kang
...
**Comment:** This paper proposes AdaIAT, a new method to reduce hallucinations in Large Vision-Language Models (LVLMs) by adaptively increasing attention to generated text. This directly matches criterion 2 (shows new VLLMs or MLLMs) and is highly relevant to vision-language modeling.
**Relevance:** 10
**Novelty:** 7

---

## 3. [ORMOT: A Dataset and Framework for Omnidirectional Referring Multi-Object Tracking](https://arxiv.org/abs/2603.05384) <a id="link3"></a>
**ArXiv ID:** 2603.05384
**Authors:** Sijia Chen, Zihan Zhou, Yanqiu Yu, En Yu, Wenbing Tao
...
**Comment:** Matches criterion 3 (embodied AI, new benchmark/simulator) and criterion 2 (shows new LVLM-driven framework). Introduces a new omnidirectional referring multi-object tracking dataset and a LVLM-based method for vision-language tracking.
**Relevance:** 9
**Novelty:** 8

---

## 4. [UniM: A Unified Any-to-Any Interleaved Multimodal Benchmark](https://arxiv.org/abs/2603.05075) <a id="link4"></a>
**ArXiv ID:** 2603.05075
**Authors:** Yanlin Li, Minghui Guo, Kaiwen Zhang, Shize Zhang, Yiran Zhao, Haodong Li, Congyue Zhou, Weijie Zheng, Yushen Yan, Shengqiong Wu, Wei Ji, Lei Cui, Furu Wei, Hao Fei, Mong-Li Lee, Wynne Hsu
...
**Comment:** Matches criterion 3: Embodied AI papers on building new benchmarks (simulator related) or new methods. Introduces a new benchmark for any-to-any interleaved multimodal learning, covering 7 modalities and complex reasoning/generation tasks.
**Relevance:** 9
**Novelty:** 8

---

## 5. [KARL: Knowledge Agents via Reinforcement Learning](https://arxiv.org/abs/2603.05218) <a id="link5"></a>
**ArXiv ID:** 2603.05218
**Authors:** Jonathan D. Chang, Andrew Drozdov, Shubham Toshniwal, Owen Oertell, Alexander Trott, Jacob Portes, Abhay Gupta, Pallavi Koppol, Ashutosh Baheti, Sean Kulinski, Ivan Zhou, Irene Dea, Krista Opsahl-Ong, Simon Favreau-Lessard, Sean Owen, Jose Javier Gonzalez Ortiz, Arnav Singhvi, Xabi Andrade, Cindy Wang, Kartik Sreenivasan, Sam Havens, Jialu Liu, Peyton DeNiro, Wen Sun, Michael Bendersky, Jonathan Frankle
...
**Comment:** This paper presents KARL, a system for training knowledge agents via reinforcement learning, and introduces KARLBench, a new benchmark suite for agentic search tasks. It matches criterion 3 (embodied AI papers on building new benchmarks or methods, especially with novel angles), as it introduces a new benchmark and a novel RL-based training paradigm for agentic reasoning.
**Relevance:** 8
**Novelty:** 8

---

## 6. [EvoTool: Self-Evolving Tool-Use Policy Optimization in LLM Agents via Blame-Aware Mutation and Diversity-Aware Selection](https://arxiv.org/abs/2603.04900) <a id="link6"></a>
**ArXiv ID:** 2603.04900
**Authors:** Shuo Yang, Soyeon Caren Han, Xueqi Ma, Yan Li, Mohammad Reza Ghasemi Madani, Eduard Hovy
...
**Comment:** Matches criterion 3 (embodied AI/new methods): Proposes EvoTool, a novel self-evolving tool-use policy optimization framework for LLM agents, introducing blame-aware mutation and diversity-aware selection. Focuses on modular policy optimization and credit assignment, which are novel angles in agent tool-use.
**Relevance:** 8
**Novelty:** 8

---

## 7. [Evaluating GPT-5 as a Multimodal Clinical Reasoner: A Landscape Commentary](https://arxiv.org/abs/2603.04763) <a id="link7"></a>
**ArXiv ID:** 2603.04763
**Authors:** Alexandru Florea, Shansong Wang, Mingzhe Hu, Qiang Li, Zach Eidex, Luke del Balzo, Mojtaba Safari, Xiaofeng Yang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs): Evaluates GPT-5 family as a multimodal clinical reasoner, including visual question answering and comparison to GPT-4o. Also provides surprising empirical results on multimodal synthesis and domain-specific performance.
**Relevance:** 9
**Novelty:** 7

---

## 8. [Act, Think or Abstain: Complexity-Aware Adaptive Inference for Vision-Language-Action Models](https://arxiv.org/abs/2603.05147) <a id="link8"></a>
**ArXiv ID:** 2603.05147
**Authors:** Riccardo Andrea Izzo, Gianluca Bardaro, Matteo Matteucci
...
**Comment:** Matches criterion 1 (methodological improvements to spatial understanding on embodied agents) and criterion 3 (novel adaptive inference for VLA models). Proposes a complexity-aware adaptive inference framework for vision-language-action models, with empirical insights.
**Relevance:** 9
**Novelty:** 7

---

## 9. [WebFactory: Automated Compression of Foundational Language Intelligence into Grounded Web Agents](https://arxiv.org/abs/2603.05044) <a id="link9"></a>
**ArXiv ID:** 2603.05044
**Authors:** Sicheng Fan, Qingyun Shi, Shengze Xu, Shengbo Cai, Tieyong Zeng, Li Ling, Yanyi Shang, Dehan Kong
...
**Comment:** Matches criterion 3 (embodied AI, new methods for grounded web agents) and criterion 2 (compression of LLM knowledge into grounded agents). Presents a new RL pipeline for GUI agents and discusses 'embodiment potential' of LLMs.
**Relevance:** 8
**Novelty:** 8

---

## 10. [Toward Real-world Infrared Image Super-Resolution: A Unified Autoregressive Framework and Benchmark Dataset](https://arxiv.org/abs/2603.04745) <a id="link10"></a>
**ArXiv ID:** 2603.04745
**Authors:** Yang Zou, Jun Ma, Zhidong Jiao, Xingyuan Li, Zhiying Jiang, Jinyuan Liu
...
**Comment:** This paper introduces a new autoregressive framework and a real-world benchmark dataset for infrared image super-resolution, addressing criterion 3 (embodied AI/new benchmarks/methods with novel angles). The dataset and method both address previously ignored real-world degradations.
**Relevance:** 8
**Novelty:** 8

---

## 11. [A Simple Baseline for Unifying Understanding, Generation, and Editing via Vanilla Next-token Prediction](https://arxiv.org/abs/2603.04980) <a id="link11"></a>
**ArXiv ID:** 2603.04980
**Authors:** Jie Zhu, Hanghang Ma, Jia Wang, Yayong Guan, Yanbing Zeng, Lishuai Gao, Junqiang Wu, Jie Hu, Leye Wang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Introduces Wallaroo, a unified autoregressive model for multi-modal understanding, image generation, and editing.
**Relevance:** 9
**Novelty:** 7

---

## 12. [K-Gen: A Multimodal Language-Conditioned Approach for Interpretable Keypoint-Guided Trajectory Generation](https://arxiv.org/abs/2603.04868) <a id="link12"></a>
**ArXiv ID:** 2603.04868
**Authors:** Mingxuan Mu, Guo Yang, Lei Chen, Ping Wu, Jianxun Cui
...
**Comment:** Matches criterion 2 (new MLLMs) and criterion 3 (embodied AI, new methods for trajectory generation in simulation). Proposes a multimodal LLM-based framework for interpretable keypoint-guided trajectory generation in autonomous driving simulation.
**Relevance:** 9
**Novelty:** 7

---

## 13. [Guiding Diffusion-based Reconstruction with Contrastive Signals for Balanced Visual Representation](https://arxiv.org/abs/2603.04803) <a id="link13"></a>
**ArXiv ID:** 2603.04803
**Authors:** Boyu Han, Qianqian Xu, Shilong Bao, Zhiyong Yang, Ruochen Cui, Xilin Zhao, Qingming Huang
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Proposes a new method (Diffusion Contrastive Reconstruction) to improve CLIP's visual encoder by integrating contrastive signals into diffusion-based reconstruction, with empirical and theoretical analysis.
**Relevance:** 8
**Novelty:** 7

---

## 14. [Tell2Adapt: A Unified Framework for Source Free Unsupervised Domain Adaptation via Vision Foundation Model](https://arxiv.org/abs/2603.05012) <a id="link14"></a>
**ArXiv ID:** 2603.05012
**Authors:** Yulong Shi, Shijie Li, Ziyi Li, Lin Qi
...
**Comment:** Matches criterion 1 (methodological improvements to spatial understanding via Vision Foundation Models in domain adaptation) and criterion 4 (vision foundation models and applications). Uses VFM for domain adaptation in medical image segmentation, with novel prompt regularization and plausibility refinement.
**Relevance:** 8
**Novelty:** 7

---

## 15. [MoRe: Motion-aware Feed-forward 4D Reconstruction Transformer](https://arxiv.org/abs/2603.05078) <a id="link15"></a>
**ArXiv ID:** 2603.05078
**Authors:** Juntong Fang, Zequn Chen, Weiqi Zhang, Donglin Di, Xuancheng Zhang, Chengmin Yang, Yu-Shen Liu
...
**Comment:** Matches criterion 1: New methodological improvements to spatial understanding/spatial intelligence on embodied agents. Proposes a feedforward 4D reconstruction network for dynamic scenes, disentangling motion and static structure for efficient, temporally coherent geometry reconstruction.
**Relevance:** 8
**Novelty:** 7

---

## 16. [MASQuant: Modality-Aware Smoothing Quantization for Multimodal Large Language Models](https://arxiv.org/abs/2603.04800) <a id="link16"></a>
**ArXiv ID:** 2603.04800
**Authors:** Lulu Hu, Wenhu Xiao, Xin Chen, Xinhua Xu, Bowen Xu, Kun Li, Yongliang Tao
...
**Comment:** Matches criterion 2: Shows new MLLMs (multi-modal large language models). Proposes a new quantization method for MLLMs, with empirical results.
**Relevance:** 8
**Novelty:** 7

---

## 17. [Towards Highly Transferable Vision-Language Attack via Semantic-Augmented Dynamic Contrastive Interaction](https://arxiv.org/abs/2603.04839) <a id="link17"></a>
**ArXiv ID:** 2603.04839
**Authors:** Yuanbo Li, Tianyang Xu, Cong Hu, Tao Zhou, Xiao-Jun Wu, Josef Kittler
...
**Comment:** This paper proposes a new adversarial attack method for vision-language pre-training models, focusing on semantic-augmented dynamic contrastive interaction. It directly addresses criterion 2 (VLLMs/MLLMs) and provides empirical insights into adversarial robustness.
**Relevance:** 8
**Novelty:** 7

---

## 18. [Towards 3D Scene Understanding of Gas Plumes in LWIR Hyperspectral Images Using Neural Radiance Fields](https://arxiv.org/abs/2603.05473) <a id="link18"></a>
**ArXiv ID:** 2603.05473
**Authors:** Scout Jarman, Zigfried Hampel-Arias, Adra Carr, Kevin R. Moon
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Applies NeRFs (a vision foundation model) to 3D scene understanding from hyperspectral images, with a novel adaptive loss and application to gas plume detection.
**Relevance:** 8
**Novelty:** 7

---

## 19. [Multi-Paradigm Collaborative Adversarial Attack Against Multi-Modal Large Language Models](https://arxiv.org/abs/2603.04846) <a id="link19"></a>
**ArXiv ID:** 2603.04846
**Authors:** Yuanbo Li, Tianyang Xu, Cong Hu, Tao Zhou, Xiao-Jun Wu, Josef Kittler
...
**Comment:** Matches criterion 2 (new MLLMs) as it proposes a novel adversarial attack framework specifically for multi-modal large language models, with empirical results on multiple MLLMs.
**Relevance:** 8
**Novelty:** 7

---

## 20. [Locality-Attending Vision Transformer](https://arxiv.org/abs/2603.04892) <a id="link20"></a>
**ArXiv ID:** 2603.04892
**Authors:** Sina Hajimiri, Farzad Beizaee, Fereshteh Shakeri, Christian Desrosiers, Ismail Ben Ayed, Jose Dolz
...
**Comment:** This paper proposes a locality-attending add-on for vision transformers to improve segmentation performance, which is a methodological improvement in spatial understanding for vision models. This matches criterion 1 (methodological improvements to spatial understanding) and is also relevant to criterion 4 (vision foundation models and applications).
**Relevance:** 8
**Novelty:** 6

---

## 21. [MobileFetalCLIP: Selective Repulsive Knowledge Distillation for Mobile Fetal Ultrasound Analysis](https://arxiv.org/abs/2603.05421) <a id="link21"></a>
**ArXiv ID:** 2603.05421
**Authors:** Numan Saeed, Fadillah Adamsyah Maani, Mohammad Yaqub
...
**Comment:** This paper introduces a new knowledge distillation method for compressing vision foundation models (FetalCLIP) for mobile ultrasound analysis. It is relevant to criterion 4 (vision foundation models and applications), especially in the context of model compression and deployment.
**Relevance:** 7
**Novelty:** 7

---

## 22. [Structure Observation Driven Image-Text Contrastive Learning for Computed Tomography Report Generation](https://arxiv.org/abs/2603.04878) <a id="link22"></a>
**ArXiv ID:** 2603.04878
**Authors:** Hong Liu, Dong Wei, Qiong Peng, Yawen Huang, Xian Wu, Yefeng Zheng, Liansheng Wang
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Proposes a novel two-stage structure- and report-learning framework for CT report generation using structure-wise image-text contrastive learning, with new methods for structure-level semantic correspondence and negative sampling.
**Relevance:** 7
**Novelty:** 7

---

## 23. [MI-DETR: A Strong Baseline for Moving Infrared Small Target Detection with Bio-Inspired Motion Integration](https://arxiv.org/abs/2603.05071) <a id="link23"></a>
**ArXiv ID:** 2603.05071
**Authors:** Nian Liu, Jin Gao, Shubo Lin, Yutong Kou, Sikui Zhang, Fudong Ge, Zhiqiang Pu, Liang Li, Gang Wang, Yizheng Wang, Weiming Hu
...
**Comment:** Matches criterion 4: Vision foundation models related and its applications. Proposes a bio-inspired dual-pathway detector for motion-aware small target detection in infrared imagery.
**Relevance:** 7
**Novelty:** 7

---

## 24. [STRUCTUREDAGENT: Planning with AND/OR Trees for Long-Horizon Web Tasks](https://arxiv.org/abs/2603.05294) <a id="link24"></a>
**ArXiv ID:** 2603.05294
**Authors:** ELita Lobo, Xu Chen, Jingjing Meng, Nan Xi, Yang Jiao, Chirag Agarwal, Yair Zick, Yan Gao
...
**Comment:** Matches criterion 3: Embodied AI papers on new methods. Proposes a hierarchical planning framework for LLM-based web agents, with structured memory and interpretable plans for long-horizon tasks.
**Relevance:** 7
**Novelty:** 7

---

## 25. [Fusion4CA: Boosting 3D Object Detection via Comprehensive Image Exploitation](https://arxiv.org/abs/2603.05305) <a id="link25"></a>
**ArXiv ID:** 2603.05305
**Authors:** Kang Luo, Xin Chen, Yangyi Xiao, Hesheng Wang
...
**Comment:** Matches criterion 4: Vision foundation models related and its applications. Also relevant to criterion 1 (spatial intelligence) as it improves 3D object detection by better exploiting visual input in BEV fusion.
**Relevance:** 8
**Novelty:** 6

---

## 26. [SPyCer: Semi-Supervised Physics-Guided Contextual Attention for Near-Surface Air Temperature Estimation from Satellite Imagery](https://arxiv.org/abs/2603.05219) <a id="link26"></a>
**ArXiv ID:** 2603.05219
**Authors:** Sofiane Bouaziz, Adel Hafiane, Raphael Canals, Rachid Nedjai
...
**Comment:** This paper introduces a semi-supervised, physics-guided network for spatial estimation of near-surface air temperature from satellite imagery. It leverages spatial context and physical modeling, matching criterion 1 (spatial understanding/methodological improvements).
**Relevance:** 7
**Novelty:** 7

---

## 27. [NaiLIA: Multimodal Nail Design Retrieval Based on Dense Intent Descriptions and Palette Queries](https://arxiv.org/abs/2603.05446) <a id="link27"></a>
**ArXiv ID:** 2603.05446
**Authors:** Kanon Amemiya, Daichi Yashima, Kei Katsumata, Takumi Komatsu, Ryosuke Korekata, Seitaro Otsuki, Komei Sugiura
...
**Comment:** Applies vision-language foundation models to multimodal retrieval; matches criterion 4 (vision foundation models and applications). Focuses on dense intent and palette queries for image retrieval.
**Relevance:** 7
**Novelty:** 6

---

## 28. [Layer by layer, module by module: Choose both for optimal OOD probing of ViT](https://arxiv.org/abs/2603.05280) <a id="link28"></a>
**ArXiv ID:** 2603.05280
**Authors:** Ambroise Odonnat, Vasilii Feofanov, Laetitia Chapel, Romain Tavenard, Ievgen Redko
...
**Comment:** Matches criterion 4: Vision foundation models related and its applications. Provides a fine-grained analysis of probing strategies for ViTs under distribution shift.
**Relevance:** 7
**Novelty:** 6

---

## 29. [Diffusion-Based sRGB Real Noise Generation via Prompt-Driven Noise Representation Learning](https://arxiv.org/abs/2603.04870) <a id="link29"></a>
**ArXiv ID:** 2603.04870
**Authors:** Jaekyun Ko, Dongjin Kim, Soomin Lee, Guanghui Wang, Tae Hyun Kim
...
**Comment:** This paper presents a prompt-driven diffusion model for generating realistic sRGB noise, which is relevant to vision foundation models and generative modeling (criterion 4). The prompt-driven approach is a novel angle for noise synthesis.
**Relevance:** 6
**Novelty:** 7

---

## 30. [Distributed Partial Information Puzzles: Examining Common Ground Construction Under Epistemic Asymmetry](https://arxiv.org/abs/2603.05450) <a id="link30"></a>
**ArXiv ID:** 2603.05450
**Authors:** Yifan Zhu, Mariah Bradford, Kenneth Lai, Timothy Obiso, Videep Venkatesha, James Pustejovsky, Nikhil Krishnaswamy
...
**Comment:** Some relevance to criterion 3 (embodied AI/benchmarks): Introduces a new multimodal dataset and collaborative construction task (DPIP) for common ground construction under epistemic asymmetry, and evaluates LLMs and logic-based models. Focuses on multi-agent, multimodal reasoning, which is tangentially related to embodied AI benchmarks.
**Relevance:** 5
**Novelty:** 7

---

## 31. [MOOSEnger -- a Domain-Specific AI Agent for the MOOSE Ecosystem](https://arxiv.org/abs/2603.04756) <a id="link31"></a>
**ArXiv ID:** 2603.04756
**Authors:** Mengnan Li, Jason Miller, Zachary Prince, Alexander Lindsay, Cody Permann
...
**Comment:** Domain-specific AI agent for simulation environment; matches criterion 3 (embodied AI, new benchmark/method for simulator-related agent). Presents a new agent architecture and evaluation for MOOSE simulation.
**Relevance:** 6
**Novelty:** 6

---

## 32. [Evaluating and Correcting Human Annotation Bias in Dynamic Micro-Expression Recognition](https://arxiv.org/abs/2603.04766) <a id="link32"></a>
**ArXiv ID:** 2603.04766
**Authors:** Feng Liu, Bingyu Nan, Xuezhong Qian, Xiaolan Fu
...
**Comment:** This paper proposes a new method for improving spatio-temporal modeling in micro-expression recognition, which is a form of spatial understanding. It introduces a novel keyframe reselection strategy and addresses annotation bias, which is a methodological improvement. This matches criterion 1 (new methodological improvements to spatial understanding on embodied agents), though the application is in micro-expression recognition rather than embodied agents per se.
**Relevance:** 5
**Novelty:** 6

---

## 33. [MultiGO++: Monocular 3D Clothed Human Reconstruction via Geometry-Texture Collaboration](https://arxiv.org/abs/2603.04993) <a id="link33"></a>
**ArXiv ID:** 2603.04993
**Authors:** Nanjie Yao, Gangjian Zhang, Wenhao Shen, Jian Shu, Yu Feng, Hao Wang
...
**Comment:** This paper proposes MultiGO++, a monocular 3D clothed human reconstruction framework with geometry-texture collaboration. While it is relevant to computer vision and generative modeling, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, or vision foundation models.
**Relevance:** 4
**Novelty:** 7

---

## 34. [Privacy-Aware Camera 2.0 Technical Report](https://arxiv.org/abs/2603.04775) <a id="link34"></a>
**ArXiv ID:** 2603.04775
**Authors:** Huan Song, Shuyu Tian, Ting Long, Jiang Liu, Cheng Yuan, Zhenyu Jia, Jiawei Shao, Xuelong Li
...
**Comment:** Some relevance to criterion 4 (vision foundation models and applications): Proposes a privacy-preserving perception framework for visual surveillance, using feature abstraction and semantic reconstruction. While not directly about foundation models, it is a novel application of vision and privacy.
**Relevance:** 4
**Novelty:** 6

---

## 35. [Timer-S1: A Billion-Scale Time Series Foundation Model with Serial Scaling](https://arxiv.org/abs/2603.04791) <a id="link35"></a>
**ArXiv ID:** 2603.04791
**Authors:** Yong Liu, Xingjian Su, Shiyu Wang, Haoran Zhang, Haixuan Liu, Yuxuan Wang, Zhou Ye, Yang Xiang, Jianmin Wang, Mingsheng Long
...
**Comment:** Does not match any specific criterion. Focuses on time series foundation models, not spatial or multimodal vision/embodied AI.
**Relevance:** 3
**Novelty:** 7

---

## 36. [sFRC for assessing hallucinations in medical image restoration](https://arxiv.org/abs/2603.04673) <a id="link36"></a>
**ArXiv ID:** 2603.04673
**Authors:** Prabhat Kc, Rongping Zeng, Nirmal Soni, Aldo Badano
...
**Comment:** This paper introduces a new metric (sFRC) for detecting hallucinations in medical image restoration. While it is a methodological improvement in vision, it does not focus on spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 4
**Novelty:** 6

---

## 37. [Bidirectional Curriculum Generation: A Multi-Agent Framework for Data-Efficient Mathematical Reasoning](https://arxiv.org/abs/2603.05120) <a id="link37"></a>
**ArXiv ID:** 2603.05120
**Authors:** Boren Hu, Xiao Liu, Boci Peng, Xinping Zhao, Xiaoran Shang, Yun Zhu, Lijun Wu
...
**Comment:** This paper introduces a bidirectional curriculum generation framework for data-efficient mathematical reasoning in LLMs. While it is a novel approach to curriculum learning, it does not directly match any of the four criteria, as it is not focused on spatial understanding, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 38. [BioLLMAgent: A Hybrid Framework with Enhanced Structural Interpretability for Simulating Human Decision-Making in Computational Psychiatry](https://arxiv.org/abs/2603.05016) <a id="link38"></a>
**ArXiv ID:** 2603.05016
**Authors:** Zuo Fei, Kezhi Wang, Xiaomin Chen, Yizhou Huang
...
**Comment:** Does not match any specific criterion. Focuses on computational psychiatry and hybrid LLM/RL agents for simulating human decision-making, not spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 39. [CONE: Embeddings for Complex Numerical Data Preserving Unit and Variable Semantics](https://arxiv.org/abs/2603.04741) <a id="link39"></a>
**ArXiv ID:** 2603.04741
**Authors:** Gyanendra Shrestha, Anna Pyayt, Michael Gubanov
...
**Comment:** Does not match any specific criterion. Focuses on numerical data embeddings and hybrid transformer models for numerical reasoning, not spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 40. [Recognition of Daily Activities through Multi-Modal Deep Learning: A Video, Pose, and Object-Aware Approach for Ambient Assisted Living](https://arxiv.org/abs/2603.04509) <a id="link40"></a>
**ArXiv ID:** 2603.04509
**Authors:** Kooshan Hashemifard, Pau Climent-P\'erez, Francisco Florez-Revuelta
...
**Comment:** Multi-modal deep learning for activity recognition; relevant to spatial understanding and multi-modal learning, but does not introduce new methods for embodied agents or VLLMs/MLLMs.
**Relevance:** 4
**Novelty:** 5

---

## 41. [GloSplat: Joint Pose-Appearance Optimization for Faster and More Accurate 3D Reconstruction](https://arxiv.org/abs/2603.04847) <a id="link41"></a>
**ArXiv ID:** 2603.04847
**Authors:** Tianyu Xiong, Rui Li, Linjie Li, Jiaqi Yang
...
**Comment:** Relevant to computer vision and 3D reconstruction, but does not directly match any of the four criteria (no embodied agent, VLLM/MLLM, or vision foundation model focus).
**Relevance:** 3
**Novelty:** 6

---

## 42. [Rethinking Representativeness and Diversity in Dynamic Data Selection](https://arxiv.org/abs/2603.04981) <a id="link42"></a>
**ArXiv ID:** 2603.04981
**Authors:** Yuzhe Zhou, Zhenglin Hua, Haiyun Guo, Yuheng Jia
...
**Comment:** Does not match any specific criterion. Focuses on data selection strategies, not spatial, vision, or multimodal models.
**Relevance:** 3
**Novelty:** 6

---

## 43. [Dissociating Direct Access from Inference in AI Introspection](https://arxiv.org/abs/2603.05414) <a id="link43"></a>
**ArXiv ID:** 2603.05414
**Authors:** Harvey Lederman, Kyle Mahowald
...
**Comment:** This paper investigates introspection mechanisms in AI models, focusing on how models detect injected representations. While it is interesting for cognitive modeling, it does not directly address spatial understanding, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 44. [Discovering mathematical concepts through a multi-agent system](https://arxiv.org/abs/2603.04528) <a id="link44"></a>
**ArXiv ID:** 2603.04528
**Authors:** Daattavya Aggarwal, Oisin Kim, Carl Henrik Ek, Challenger Mishra
...
**Comment:** Relevant to multi-agent systems and computational discovery, but does not directly match any specific criterion. Focuses on mathematical concept discovery.
**Relevance:** 3
**Novelty:** 6

---

## 45. [On Multi-Step Theorem Prediction via Non-Parametric Structural Priors](https://arxiv.org/abs/2603.04852) <a id="link45"></a>
**ArXiv ID:** 2603.04852
**Authors:** Junbo Zhao, Ting Zhang, Can Li, Wei He, Jingdong Wang, Hua Huang
...
**Comment:** Relevant to machine learning and reasoning, but does not directly match any specific criterion. Focuses on theorem prediction and symbolic reasoning with LLMs.
**Relevance:** 3
**Novelty:** 6

---

## 46. [Adaptive Memory Admission Control for LLM Agents](https://arxiv.org/abs/2603.04549) <a id="link46"></a>
**ArXiv ID:** 2603.04549
**Authors:** Guilin Zhang, Wei Jiang, Xiejiashan Wang, Aisha Behr, Kai Zhao, Jeffrey Friedman, Xu Chu, Amine Anoun
...
**Comment:** Does not match any specific criterion. Focuses on memory management for LLM agents, not spatial, vision, or multimodal aspects.
**Relevance:** 3
**Novelty:** 5

---

## 47. [Judge Reliability Harness: Stress Testing the Reliability of LLM Judges](https://arxiv.org/abs/2603.05399) <a id="link47"></a>
**ArXiv ID:** 2603.05399
**Authors:** Sunishchal Dev, Andrew Sloan, Joshua Kavner, Nicholas Kong, Morgan Sandler
...
**Comment:** Relevant to evaluation of LLMs, but does not directly match any specific criterion. Focuses on reliability testing for LLM judges.
**Relevance:** 3
**Novelty:** 5

---

## 48. [DeformTrace: A Deformable State Space Model with Relay Tokens for Temporal Forgery Localization](https://arxiv.org/abs/2603.04882) <a id="link48"></a>
**ArXiv ID:** 2603.04882
**Authors:** Xiaodong Zhu, Suting Wang, Yuanming Zheng, Junqi Yang, Yangxu Liao, Yuhong Yang, Weiping Tu, Zhongyuan Wang
...
**Comment:** Relevant to computer vision and machine learning, but does not directly match any specific criterion. Focuses on temporal forgery localization using state space models.
**Relevance:** 3
**Novelty:** 5

---

## 49. [GEM-TFL: Bridging Weak and Full Supervision for Forgery Localization through EM-Guided Decomposition and Temporal Refinement](https://arxiv.org/abs/2603.05095) <a id="link49"></a>
**ArXiv ID:** 2603.05095
**Authors:** Xiaodong Zhu, Yuanming Zheng, Suting Wang, Junqi Yang, Yuhong Yang, Weiping Tu, Zhongyuan Wang
...
**Comment:** Relevant to computer vision and machine learning, but does not directly match any specific criterion. Focuses on temporal forgery localization with weak supervision.
**Relevance:** 3
**Novelty:** 5
