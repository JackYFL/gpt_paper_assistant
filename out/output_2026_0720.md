...
0. [GeoChrono: Benchmarking and Rethinking Long-Term Temporal Understanding in Remote Sensing](#link0)
**Authors:** Yujie Li, Jiancheng Pan, Zhiwei Wei, Jiuniu Wang, Mugen Peng, Wenjia Xu

1. [Reasoning-Guided Part-Level Visual Grounding via Reinforcement Learning](#link1)
...
2. [SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction](#link2)
**Authors:** Xue Yu, Bo Yuan, Pengshuai Yang, Kailin Zhao, Hong Hu, Junlan Feng

3. [EgoExoMoCap: Distributed Ego-Exo Human Motion Capture](#link3)
...
4. [E3DGS: Unified Geometric-Photometric Equivariance for 3D Gaussian Splatting via Color-as-Geometry Embedding](#link4)
**Authors:** Chankyo Kim, Maani Ghaffari

5. [Trajectory-aware Cross-view Geo-localization with Sequential Observations](#link5)
**Authors:** Tianyi Gao, Jiayu Lin, Danielle Beaulieu, Nathan Jacobs

6. [Toward Semantic Communication for Real-time Mobile 3D Reconstruction](#link6)
**Authors:** Fangzhou Zhao, Yao Sun, Xuesong Liu, Runze Cheng, Shang Kai, Yi Sun

7. [Model Merging for Medical LVLMs: A Benchmark and a Winner-Take-All Approach](#link7)
...
8. [When Can Test-Time Adaptation Help Zero-Shot CT Vision-Language Models?](#link8)
**Authors:** Ailar Mahdizadeh, Puria Azadi Moghadam, Xiangteng He, Leonid Sigal

9. [Event3R: Asynchronous-to-Global 3D Reconstruction from Event Camera via Spatial-Temporal Feature Aggregation](#link9)
**Authors:** Jian Huang, Haotian Shen, Xinhao Lou, Chengrui Dong, Wenpu Li, Peidong Liu

10. [Are All Tokens Necessary for Visual Place Recognition? An Empirical Study of Token Reduction for Efficient Inference](#link10)
**Authors:** Tong Jin, Yunpeng Liu, Shuyu Hu, Qinghua Zhang, Ruize Han, Song Wang, Feng Lu

11. [CSS-BA: Gate-Guided Column Space Search for Bundle Adjustment](#link11)
**Authors:** Ayano Kaneda, Takafumi Taketomi, Shugo Yamaguchi, Shigeo Morishima

12. [StructGen: Disambiguating Multi-Reference Image Generation via Structured Context Modeling](#link12)
**Authors:** Jianing Peng, Mengyu Wang, Henghui Ding, Zixiang Li, Ting Liu, Xiaochao Qu, Luoqi Liu, Yao Zhao, Yunchao Wei

13. [Beyond a Joke: Multi-Angle Reasoning for Detecting and Explaining Harmful Humor in Memes](#link13)
**Authors:** Shanhong Liu, Pai Chet Ng, De Wen Soh, Malika Meghjani, Konstantinos N. Plataniotis

14. [CLIFE: Camera-LiDAR Fusion Framework for Edge-Deployable Roadside VRU Perception](#link14)
**Authors:** Tam Bang, Hoang H. Nguyen, Lei Cheng, Lihao Guo, Siyang Cao, Hussam Abubakr, Tianya Zhang, Austin Harris, Mina Sartipi

---
## 0. [GeoChrono: Benchmarking and Rethinking Long-Term Temporal Understanding in Remote Sensing](https://arxiv.org/abs/2607.15768) <a id="link0"></a>
**ArXiv ID:** 2607.15768
**Authors:** Yujie Li, Jiancheng Pan, Zhiwei Wei, Jiuniu Wang, Mugen Peng, Wenjia Xu
...
**Comment:** Matches criterion 4 closely: this is a remote-sensing MLLM benchmark plus a new model for long-term temporal and spatio-temporal understanding.
**Relevance:** 8
**Novelty:** 7

---

## 1. [Reasoning-Guided Part-Level Visual Grounding via Reinforcement Learning](https://arxiv.org/abs/2607.15374) <a id="link1"></a>
**ArXiv ID:** 2607.15374
**Authors:** Kazi Sajeed Mehrab, Hani Alomari, Najibul Haque Sarker, Chia-Wei Tang, Zaber Ibn Abdul Hakim, Anuj Karpatne, Chris Thomas
...
**Comment:** Criterion 2 matches closely: this is a new MLLM-based reasoning-guided grounding method with hierarchical coarse-to-fine localization and RL training.
**Relevance:** 7
**Novelty:** 7

---

## 2. [SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction](https://arxiv.org/abs/2607.15550) <a id="link2"></a>
**ArXiv ID:** 2607.15550
**Authors:** Xue Yu, Bo Yuan, Pengshuai Yang, Kailin Zhao, Hong Hu, Junlan Feng
...
**Comment:** Criterion 1 matches closely: this proposes a new safety framework for mobile GUI agents using a learned world model for pre-execution risk assessment, which is an embodied-agent method with spatial/state prediction.
**Relevance:** 7
**Novelty:** 7

---

## 3. [EgoExoMoCap: Distributed Ego-Exo Human Motion Capture](https://arxiv.org/abs/2607.15868) <a id="link3"></a>
**ArXiv ID:** 2607.15868
**Authors:** Jiaxi Jiang, Bharat Lal Bhatnagar, Nan Yang, Lingni Ma, Sebastian Starke, Robin Kips, Nadine Bertsch, Christian Holz, Federica Bogo
...
**Comment:** Criterion 3 matches closely: this is an embodied-AI-relevant motion capture method with a novel distributed ego-exo setup and a new in-the-wild capture paradigm.
**Relevance:** 6
**Novelty:** 7

---

## 4. [E3DGS: Unified Geometric-Photometric Equivariance for 3D Gaussian Splatting via Color-as-Geometry Embedding](https://arxiv.org/abs/2607.15536) <a id="link4"></a>
**ArXiv ID:** 2607.15536
**Authors:** Chankyo Kim, Maani Ghaffari
...
**Comment:** Matches criterion 4 closely: a vision foundation model-style geometric formulation for 3D Gaussian Splatting with equivariance and action-conditioned world modeling applications.
**Relevance:** 6
**Novelty:** 7

---

## 5. [Trajectory-aware Cross-view Geo-localization with Sequential Observations](https://arxiv.org/abs/2607.15491) <a id="link5"></a>
**ArXiv ID:** 2607.15491
**Authors:** Tianyi Gao, Jiayu Lin, Danielle Beaulieu, Nathan Jacobs
...
**Comment:** Matches criterion 1 and 3 closely: it introduces trajectory-aware cross-view geo-localization and a new dataset/framework for sequential observations with spatially-aware representations.
**Relevance:** 7
**Novelty:** 6

---

## 6. [Toward Semantic Communication for Real-time Mobile 3D Reconstruction](https://arxiv.org/abs/2607.16128) <a id="link6"></a>
**ArXiv ID:** 2607.16128
**Authors:** Fangzhou Zhao, Yao Sun, Xuesong Liu, Runze Cheng, Shang Kai, Yi Sun
...
**Comment:** Criterion 3 matches closely: it is a new method for real-time mobile 3D reconstruction with semantic communication and confidence-guided geometry estimation, a novel embodied/robotics-relevant angle that prior work often ignores.
**Relevance:** 6
**Novelty:** 6

---

## 7. [Model Merging for Medical LVLMs: A Benchmark and a Winner-Take-All Approach](https://arxiv.org/abs/2607.15661) <a id="link7"></a>
**ArXiv ID:** 2607.15661
**Authors:** Lichao Mou, Shilan Zhang, Chunlei Li, Bingcong Yan, Jingliang Hu, Yilei Shi, Shengwu Xiong, Xiao Xiang Zhu, Lei Li, Yaxiong Chen
...
**Comment:** Matches criterion 2 and 4 closely: it is a benchmark and method for merging medical LVLMs, directly about vision-language models.
**Relevance:** 7
**Novelty:** 5

---

## 8. [When Can Test-Time Adaptation Help Zero-Shot CT Vision-Language Models?](https://arxiv.org/abs/2607.15556) <a id="link8"></a>
**ArXiv ID:** 2607.15556
**Authors:** Ailar Mahdizadeh, Puria Azadi Moghadam, Xiangteng He, Leonid Sigal
...
**Comment:** Matches criterion 2 and somewhat criterion 4: it studies test-time adaptation for zero-shot 3D CT vision-language models and proposes a cardinality-aware method.
**Relevance:** 6
**Novelty:** 6

---

## 9. [Event3R: Asynchronous-to-Global 3D Reconstruction from Event Camera via Spatial-Temporal Feature Aggregation](https://arxiv.org/abs/2607.15727) <a id="link9"></a>
**ArXiv ID:** 2607.15727
**Authors:** Jian Huang, Haotian Shen, Xinhao Lou, Chengrui Dong, Wenpu Li, Peidong Liu
...
**Comment:** Matches criterion 3 very closely: it is an embodied-perception/3D reconstruction method with a new event-camera reconstruction framework and a self-supervised pretraining strategy for a previously underexplored sensor setting.
**Relevance:** 6
**Novelty:** 5

---

## 10. [Are All Tokens Necessary for Visual Place Recognition? An Empirical Study of Token Reduction for Efficient Inference](https://arxiv.org/abs/2607.15563) <a id="link10"></a>
**ArXiv ID:** 2607.15563
**Authors:** Tong Jin, Yunpeng Liu, Shuyu Hu, Qinghua Zhang, Ruize Han, Song Wang, Feng Lu
...
**Comment:** Matches criterion 4 closely: a benchmark study on token reduction for visual place recognition using vision transformer foundation models, with practical efficiency insights.
**Relevance:** 6
**Novelty:** 5

---

## 11. [CSS-BA: Gate-Guided Column Space Search for Bundle Adjustment](https://arxiv.org/abs/2607.15652) <a id="link11"></a>
**ArXiv ID:** 2607.15652
**Authors:** Ayano Kaneda, Takafumi Taketomi, Shugo Yamaguchi, Shigeo Morishima
...
**Comment:** Criterion 3 matches loosely: it is a new solver-side bundle-adjustment method for weak-geometry reconstruction, but it is not a benchmark or embodied-AI-specific paper.
**Relevance:** 4
**Novelty:** 5

---

## 12. [StructGen: Disambiguating Multi-Reference Image Generation via Structured Context Modeling](https://arxiv.org/abs/2607.15619) <a id="link12"></a>
**ArXiv ID:** 2607.15619
**Authors:** Jianing Peng, Mengyu Wang, Henghui Ding, Zixiang Li, Ting Liu, Xiaochao Qu, Luoqi Liu, Yao Zhao, Yunchao Wei
...
**Comment:** No close match to the requested criteria; this is multi-reference image generation with structured conditioning, which fits generative multimodal learning but not the specific criteria listed.
**Relevance:** 3
**Novelty:** 6

---

## 13. [Beyond a Joke: Multi-Angle Reasoning for Detecting and Explaining Harmful Humor in Memes](https://arxiv.org/abs/2607.15442) <a id="link13"></a>
**ArXiv ID:** 2607.15442
**Authors:** Shanhong Liu, Pai Chet Ng, De Wen Soh, Malika Meghjani, Konstantinos N. Plataniotis
...
**Comment:** No close match to the requested criteria; this is a VLM-based meme understanding/explanation paper, but it is not about embodied AI, benchmark building for embodied agents, or vision foundation model applications in the sense of the criteria.
**Relevance:** 3
**Novelty:** 5

---

## 14. [CLIFE: Camera-LiDAR Fusion Framework for Edge-Deployable Roadside VRU Perception](https://arxiv.org/abs/2607.16154) <a id="link14"></a>
**ArXiv ID:** 2607.16154
**Authors:** Tam Bang, Hoang H. Nguyen, Lei Cheng, Lihao Guo, Siyang Cao, Hussam Abubakr, Tianya Zhang, Austin Harris, Mina Sartipi
...
**Comment:** Matches criterion 3 loosely: an embodied/perception-adjacent multi-sensor fusion system for roadside VRU perception, but it is more deployment-focused than a novel embodied AI benchmark or method.
**Relevance:** 4
**Novelty:** 4
