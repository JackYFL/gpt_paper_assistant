...
2. [When to Think and When to Look: Uncertainty-Guided Lookback](#link2)
...
3. [SceneEdited: A City-Scale Benchmark for 3D HD Map Updating via Image-Guided Change Detection](#link3)
**Authors:** Chun-Jung Lin, Tat-Jun Chin, Sourav Garg, Feras Dayoub

4. [GeoVista: Web-Augmented Agentic Visual Reasoning for Geolocalization](#link4)
**Authors:** Yikun Wang, Zuyan Liu, Ziyi Wang, Pengfei Liu, Han Hu, Yongming Rao

5. [Think Visually, Reason Textually: Vision-Language Synergy in ARC](#link5)
**Authors:** Beichen Zhang, Yuhang Zang, Xiaoyi Dong, Yuhang Cao, Haodong Duan, Dahua Lin, Jiaqi Wang

6. [Adapt-As-You-Walk Through the Clouds: Training-Free Online Test-Time Adaptation of 3D Vision-Language Foundation Models](#link6)
**Authors:** Mehran Tamjidi, Hamidreza Dastmalchi, Mohammadreza Alimoradijazi, Ali Cheraghian, Aijun An, Morteza Saberi

7. [Graph Query Networks for Object Detection with Automotive Radar](#link7)
**Authors:** Loveneet Saini, Hasan Tercan, Tobias Meisen

8. [D4C: Data-free Quantization for Contrastive Language-Image Pre-training Models](#link8)
**Authors:** Wenlun Zhang, Yunshan Zhong, Zihao Ding, Xinyu Li, Kentaro Yoshioka

9. [MoDES: Accelerating Mixture-of-Experts Multimodal Large Language Models via Dynamic Expert Skipping](#link9)
**Authors:** Yushi Huang, Zining Wang, Zhihang Yuan, Yifu Ding, Ruihao Gong, Jinyang Guo, Xianglong Liu, Jun Zhang

10. [Computer-Use Agents as Judges for Generative User Interface](#link10)
**Authors:** Kevin Qinghong Lin, Siyuan Hu, Linjie Li, Zhengyuan Yang, Lijuan Wang, Philip Torr, Mike Zheng Shou

11. [X-WIN: Building Chest Radiograph World Model via Predictive Sensing](#link11)
**Authors:** Zefan Yang, Ge Wang, James Hendler, Mannudeep K. Kalra, Pingkun Yan

12. [Unsupervised Discovery of Long-Term Spatiotemporal Periodic Workflows in Human Activities](#link12)
**Authors:** Fan Yang, Quanting Xie, Atsunori Moteki, Shoichi Masui, Shan Jiang, Yonatan Bisk, Graham Neubig

13. [CompTrack: Information Bottleneck-Guided Low-Rank Dynamic Token Compression for Point Cloud Tracking](#link13)
**Authors:** Sifan Zhou, Yichao Cao, Jiahao Nie, Yuqian Fu, Ziyu Zhao, Xiaobo Lu, Shuo Wang

14. [The SA-FARI Dataset: Segment Anything in Footage of Animals for Recognition and Identification](#link14)
...
15. [HV-Attack: Hierarchical Visual Attack for Multimodal Retrieval Augmented Generation](#link15)
**Authors:** Linyin Luo, Yujuan Ding, Yunshan Ma, Wenqi Fan, Hanjiang Lai

16. [Multimodal Continual Instruction Tuning with Dynamic Gradient Guidance](#link16)
**Authors:** Songze Li, Mingyu Gao, Tonghua Su, Xu-Yao Zhang, Zhongjie Wang

17. [GEO-Bench-2: From Performance to Capability, Rethinking Evaluation in Geospatial AI](#link17)
...
18. [SIGMMA: Hierarchical Graph-Based Multi-Scale Multi-modal Contrastive Alignment of Histopathology Image and Spatial Transcriptome](#link18)
...
19. [KANGURA: Kolmogorov-Arnold Network-Based Geometry-Aware Learning with Unified Representation Attention for 3D Modeling of Complex Structures](#link19)
**Authors:** Mohammad Reza Shafie, Morteza Hajiabadi, Hamed Khosravi, Mobina Noori, Imtiaz Ahmed

20. [SkillGen: Learning Domain Skills for In-Context Sequential Decision Making](#link20)
**Authors:** Ruomeng Ding, Wei Cheng, Minglai Shao, Chen Zhao

21. [SplitFlux: Learning to Decouple Content and Style from a Single Image](#link21)
**Authors:** Yitong Yang, Yinglin Wang, Changshuo Wang, Yongjun Zhang, Ziyang Chen, Shuting He

22. [Hierarchical Semantic Tree Anchoring for CLIP-Based Class-Incremental Learning](#link22)
**Authors:** Tao Hu, Lan Li, Zhen-Hao Xie, Da-Wei Zhou

23. [Taming Generative Synthetic Data for X-ray Prohibited Item Detection](#link23)
**Authors:** Jialong Sun, Hongguang Zhu, Weizhe Liu, Yunda Sun, Renshuai Tao, Yunchao Wei

24. [CPSL: Representing Volumetric Video via Content-Promoted Scene Layers](#link24)
**Authors:** Kaiyuan Hu, Yili Jin, Junhua Liu, Xize Duan, Hong Kang, Xue Liu

25. [Multi-Text Guided Few-Shot Semantic Segmentation](#link25)
**Authors:** Qiang Jiao, Bin Yan, Yi Yang, Mengrui Shi, Qiang Zhang

26. [Learning from Mistakes: Loss-Aware Memory Enhanced Continual Learning for LiDAR Place Recognition](#link26)
**Authors:** Xufei Wang, Junqiao Zhao, Siyue Tao, Qiwen Gu, Wonbong Kim, Tiantian Feng

27. [SkinGPT-R1: Adapter-Only Dual Distillation for Efficient Dermatology Reasoning](#link27)
**Authors:** Yuhao Shen, Jiahe Qian, Zhangtianyi Chen, Yuanhao He, Juexiao Zhou

28. [Jailbreaking Large Vision Language Models in Intelligent Transportation Systems](#link28)
**Authors:** Badhan Chandra Das, Md Tasnim Jawad, Md Jueal Mia, M. Hadi Amini, Yanzhao Wu

29. [Driving in Spikes: An Entropy-Guided Object Detector for Spike Cameras](#link29)
**Authors:** Ziyan Liu, Qi Su, Lulu Tang, Zhaofei Yu, Tiejun Huang

30. [DCL-SE: Dynamic Curriculum Learning for Spatiotemporal Encoding of Brain Imaging](#link30)
**Authors:** Meihua Zhou, Xinyu Tong, Jiarui Zhao, Min Cheng, Li Yang, Lei Tian, Nan Wan

31. [APD-Agents: A Large Language Model-Driven Multi-Agents Collaborative Framework for Automated Page Design](#link31)
**Authors:** Xinpeng Chen, Xiaofeng Han, Kaihao Zhang, Guochao Ren, Yujie Wang, Wenhao Cao, Yang Zhou, Jianfeng Lu, Zhenbo Song

32. [First Frame Is the Place to Go for Video Content Customization](#link32)
...
33. [FlashMesh: Faster and Better Autoregressive Mesh Synthesis via Structured Speculation](#link33)
**Authors:** Tingrui Shen, Yiheng Zhang, Chen Tang, Chuan Ping, Zixing Zhao, Le Wan, Yuwang Wang, Ronggang Wang, Shengfeng He

34. [Towards Unbiased Cross-Modal Representation Learning for Food Image-to-Recipe Retrieval](#link34)
**Authors:** Qing Wang, Chong-Wah Ngo, Ee-Peng Lim

35. [TiCAL:Typicality-Based Consistency-Aware Learning for Multimodal Emotion Recognition](#link35)
**Authors:** Wen Yin, Siyu Zhan, Cencen Liu, Xin Hu, Guiduo Duan, Xiurui Xie, Yuan-Fang Li, Tao He

36. [Complex-Valued 2D Gaussian Representation for Computer-Generated Holography](#link36)
**Authors:** Yicheng Zhan, Xiangjun Gao, Long Quan, Kaan Ak\c{s}it

37. [INQUIRE-Search: A Framework for Interactive Discovery in Large-Scale Biodiversity Databases](#link37)
...
38. [MMCM: Multimodality-aware Metric using Clustering-based Modes for Probabilistic Human Motion Prediction](#link38)
**Authors:** Kyotaro Tokoro, Hiromu Taketsugu, Norimichi Ukita

39. [Computer Vision Modeling of the Development of Geometric and Numerical Concepts in Humans](#link39)
**Authors:** Zekun Wang, Sashank Varma

40. [Fast Post-Hoc Confidence Fusion for 3-Class Open-Set Aerial Object Detection](#link40)
**Authors:** Spyridon Loukovitis, Vasileios Karampinis, Athanasios Voulodimos

41. [Generating Natural-Language Surgical Feedback: From Structured Representation to Domain-Grounded Evaluation](#link41)
**Authors:** Firdavs Nasriddinov, Rafal Kocielnik, Anima Anandkumar, Andrew J. Hung

42. [Collaborative QA using Interacting LLMs. Impact of Network Structure, Node Capability and Distributed Data](#link42)
**Authors:** Adit Jain, Vikram Krishnamurthy, Yiming Zhang

43. [ALEX:A Light Editing-knowledge Extractor](#link43)
...
44. [RS-CA-HSICT: A Residual and Spatial Channel Augmented CNN Transformer Framework for Monkeypox Detection](#link44)
...
**Comment:** Matches criterion 1: proposes a novel dual-process thinking system for spatial understanding in embodied agents (Vision-and-Language Navigation), integrating LLMs and expert models for improved spatial reasoning. Also relevant to criterion 2 as it uses multimodal LLMs.
**Relevance:** 10
**Novelty:** 8
...
**Comment:** Matches criterion 3 (embodied AI, new benchmarks, spatial reasoning) and criterion 1 (spatial understanding in agents). Introduces VR-Bench, a new benchmark for evaluating video models' spatial reasoning via maze-solving, and provides empirical insights into video-based reasoning.
**Relevance:** 10
**Novelty:** 8

---

## 2. [When to Think and When to Look: Uncertainty-Guided Lookback](https://arxiv.org/abs/2511.15613) <a id="link2"></a>
**ArXiv ID:** 2511.15613
**Authors:** Jing Bi (Yolo), Filippos Bellos (Yolo), Junjia Guo (Yolo), Yayuan Li (Yolo), Chao Huang (Yolo), Yunlong (Yolo), Tang (Mark), Luchuan Song (Mark), Susan Liang (Mark), Zhongfei (Mark), Zhang, Jason J. Corso, Chenliang Xu
...
**Comment:** Matches criterion 2 (VLLMs): Provides a systematic analysis of 'thinking' in large vision-language models and introduces a new uncertainty-guided decoding strategy with strong empirical results.
**Relevance:** 10
**Novelty:** 8

---

## 3. [SceneEdited: A City-Scale Benchmark for 3D HD Map Updating via Image-Guided Change Detection](https://arxiv.org/abs/2511.15153) <a id="link3"></a>
**ArXiv ID:** 2511.15153
**Authors:** Chun-Jung Lin, Tat-Jun Chin, Sourav Garg, Feras Dayoub
...
**Comment:** Matches criterion 3: introduces a new city-scale benchmark and toolkit for 3D HD map updating, focusing on realistic urban modifications and providing a standardized evaluation for 3D map maintenance, which is highly relevant to embodied AI and simulator-related benchmarks.
**Relevance:** 9
**Novelty:** 8

---

## 4. [GeoVista: Web-Augmented Agentic Visual Reasoning for Geolocalization](https://arxiv.org/abs/2511.15705) <a id="link4"></a>
**ArXiv ID:** 2511.15705
**Authors:** Yikun Wang, Zuyan Liu, Ziyi Wang, Pengfei Liu, Han Hu, Yongming Rao
...
**Comment:** Matches criterion 3 (embodied AI/new benchmarks/methods) and criterion 2 (VLLMs/MLLMs). Proposes GeoVista, an agentic visual reasoning model for geolocalization, with a new benchmark (GeoBench) and integration of web-augmented tools in the reasoning loop.
**Relevance:** 9
**Novelty:** 8

---

## 5. [Think Visually, Reason Textually: Vision-Language Synergy in ARC](https://arxiv.org/abs/2511.15703) <a id="link5"></a>
**ArXiv ID:** 2511.15703
**Authors:** Beichen Zhang, Yuhang Zang, Xiaoyi Dong, Yuhang Cao, Haodong Duan, Dahua Lin, Jiaqi Wang
...
**Comment:** Matches criterion 2 (VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Proposes a novel synergy between vision and language for abstract reasoning tasks (ARC-AGI), with new strategies for integrating visual and textual reasoning.
**Relevance:** 9
**Novelty:** 8

---

## 6. [Adapt-As-You-Walk Through the Clouds: Training-Free Online Test-Time Adaptation of 3D Vision-Language Foundation Models](https://arxiv.org/abs/2511.15311) <a id="link6"></a>
**ArXiv ID:** 2511.15311
**Authors:** Mehran Tamjidi, Hamidreza Dastmalchi, Mohammadreza Alimoradijazi, Ali Cheraghian, Aijun An, Morteza Saberi
...
**Comment:** Matches criterion 4: Vision foundation models and applications. Proposes Uni-Adapter, a training-free online test-time adaptation method for 3D Vision-Language Foundation Models (VLFMs), improving robustness and performance in 3D point cloud tasks.
**Relevance:** 9
**Novelty:** 8

---

## 7. [Graph Query Networks for Object Detection with Automotive Radar](https://arxiv.org/abs/2511.15271) <a id="link7"></a>
**ArXiv ID:** 2511.15271
**Authors:** Loveneet Saini, Hasan Tercan, Tobias Meisen
...
**Comment:** Matches criterion 1 (spatial understanding on embodied agents): Introduces a new graph-based method for object detection with automotive radar, focusing on spatial reasoning and relational/contextual features.
**Relevance:** 8
**Novelty:** 8

---

## 8. [D4C: Data-free Quantization for Contrastive Language-Image Pre-training Models](https://arxiv.org/abs/2511.15411) <a id="link8"></a>
**ArXiv ID:** 2511.15411
**Authors:** Wenlun Zhang, Yunshan Zhong, Zihao Ding, Xinyu Li, Kentaro Yoshioka
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Proposes a new data-free quantization method for CLIP, a vision-language foundation model, with significant empirical improvements.
**Relevance:** 9
**Novelty:** 7

---

## 9. [MoDES: Accelerating Mixture-of-Experts Multimodal Large Language Models via Dynamic Expert Skipping](https://arxiv.org/abs/2511.15690) <a id="link9"></a>
**ArXiv ID:** 2511.15690
**Authors:** Yushi Huang, Zining Wang, Zhihang Yuan, Yifu Ding, Ruihao Gong, Jinyang Guo, Xianglong Liu, Jun Zhang
...
**Comment:** Matches criterion 2 (new MLLMs) as it proposes MoDES, a new framework for accelerating Mixture-of-Experts Multimodal Large Language Models, with novel expert skipping and gating mechanisms for efficient inference.
**Relevance:** 9
**Novelty:** 7

---

## 10. [Computer-Use Agents as Judges for Generative User Interface](https://arxiv.org/abs/2511.15567) <a id="link10"></a>
**ArXiv ID:** 2511.15567
**Authors:** Kevin Qinghong Lin, Siyuan Hu, Linjie Li, Zhengyuan Yang, Lijuan Wang, Philip Torr, Mike Zheng Shou
...
**Comment:** Matches criterion 3: Embodied AI, new benchmarks and methods for agent-based GUI design and evaluation (AUI-Gym). Proposes a framework where computer-use agents act as judges for generative user interfaces, shifting interface design toward agent-native efficiency.
**Relevance:** 8
**Novelty:** 8

---

## 11. [X-WIN: Building Chest Radiograph World Model via Predictive Sensing](https://arxiv.org/abs/2511.14918) <a id="link11"></a>
**ArXiv ID:** 2511.14918
**Authors:** Zefan Yang, Ge Wang, James Hendler, Mannudeep K. Kalra, Pingkun Yan
...
**Comment:** Matches criterion 4: Vision foundation models and applications. Proposes X-WIN, a CXR world model that distills 3D anatomical knowledge for 2D chest X-ray analysis, outperforming existing foundation models and enabling 3D reconstruction from 2D projections.
**Relevance:** 8
**Novelty:** 8

---

## 12. [Unsupervised Discovery of Long-Term Spatiotemporal Periodic Workflows in Human Activities](https://arxiv.org/abs/2511.14945) <a id="link12"></a>
**ArXiv ID:** 2511.14945
**Authors:** Fan Yang, Quanting Xie, Atsunori Moteki, Shoichi Masui, Shan Jiang, Yonatan Bisk, Graham Neubig
...
**Comment:** Matches criterion 3: introduces a new benchmark for unsupervised discovery of long-term spatiotemporal periodic workflows in human activities, with a focus on multimodal sequences and evaluation tasks relevant to embodied AI.
**Relevance:** 8
**Novelty:** 7

---

## 13. [CompTrack: Information Bottleneck-Guided Low-Rank Dynamic Token Compression for Point Cloud Tracking](https://arxiv.org/abs/2511.15580) <a id="link13"></a>
**ArXiv ID:** 2511.15580
**Authors:** Sifan Zhou, Yichao Cao, Jiahao Nie, Yuqian Fu, Ziyu Zhao, Xiaobo Lu, Shuo Wang
...
**Comment:** Matches criterion 1: introduces a new method for spatial understanding in point cloud tracking using information bottleneck and low-rank token compression, which is a methodological improvement for spatial intelligence in embodied agents.
**Relevance:** 8
**Novelty:** 7

---

## 14. [The SA-FARI Dataset: Segment Anything in Footage of Animals for Recognition and Identification](https://arxiv.org/abs/2511.15622) <a id="link14"></a>
**ArXiv ID:** 2511.15622
**Authors:** Dante Francisco Wasmuht, Otto Brookes, Maximillian Schall, Pablo Palencia, Chris Beirne, Tilo Burghardt, Majid Mirmehdi, Hjalmar K\"uhl, Mimi Arandjelovic, Sam Pottie, Peter Bermant, Brandon Asheim, Yi Jin Toh, Adam Elzinga, Jason Holmberg, Andrew Whitworth, Eleanor Flatt, Laura Gustafson, Chaitanya Ryali, Yuan-Ting Hu, Baishan Guo, Andrew Westbury, Kate Saenko, Didac Suris
...
**Comment:** Matches criterion 4: presents a large-scale, high-diversity vision foundation model dataset for multi-animal tracking, and benchmarks vision-language models (including SAM 3) for detection and tracking. Also relevant to criterion 2 as it evaluates VLLMs.
**Relevance:** 8
**Novelty:** 7

---

## 15. [HV-Attack: Hierarchical Visual Attack for Multimodal Retrieval Augmented Generation](https://arxiv.org/abs/2511.15435) <a id="link15"></a>
**ArXiv ID:** 2511.15435
**Authors:** Linyin Luo, Yujuan Ding, Yunshan Ma, Wenqi Fan, Hanjiang Lai
...
**Comment:** Matches criterion 2 (VLLMs/MLLMs): Proposes a novel adversarial attack on multimodal retrieval-augmented generation systems using visual perturbations, with experiments on CLIP-based retrievers and LMMs.
**Relevance:** 8
**Novelty:** 7

---

## 16. [Multimodal Continual Instruction Tuning with Dynamic Gradient Guidance](https://arxiv.org/abs/2511.15164) <a id="link16"></a>
**ArXiv ID:** 2511.15164
**Authors:** Songze Li, Mingyu Gao, Tonghua Su, Xu-Yao Zhang, Zhongjie Wang
...
**Comment:** Matches criterion 2 (new MLLM methods): Proposes a novel method for continual instruction tuning in multimodal large language models, addressing catastrophic forgetting with a new gradient guidance approach.
**Relevance:** 8
**Novelty:** 7

---

## 17. [GEO-Bench-2: From Performance to Capability, Rethinking Evaluation in Geospatial AI](https://arxiv.org/abs/2511.15658) <a id="link17"></a>
**ArXiv ID:** 2511.15658
**Authors:** Naomi Simumba, Nils Lehmann, Paolo Fraccaro, Hamed Alemohammad, Geeth De Mel, Salman Khan, Manil Maskey, Nicolas Longepe, Xiao Xiang Zhu, Hannah Kerner, Juan Bernabe-Moreno, Alexander Lacoste
...
**Comment:** Matches criterion 3 (embodied AI papers on new benchmarks/simulators) and criterion 4 (vision foundation models and applications). Introduces GEO-Bench-2, a comprehensive benchmark for geospatial foundation models, with new evaluation protocols and capability groups.
**Relevance:** 8
**Novelty:** 7

---

## 18. [SIGMMA: Hierarchical Graph-Based Multi-Scale Multi-modal Contrastive Alignment of Histopathology Image and Spatial Transcriptome](https://arxiv.org/abs/2511.15464) <a id="link18"></a>
**ArXiv ID:** 2511.15464
**Authors:** Dabin Jeong, Amirhossein Vahidi, Ciro Ram\'irez-Su\'astegui, Marie Moullet, Kevin Ly, Mohammad Vali Sanian, Sebastian Birk, Yinshui Chang, Adam Boxall, Daniyal Jafree, Lloyd Steele, Vijaya Baskar MS, Muzlifah Haniffa, Mohammad Lotfollahi
...
**Comment:** Matches criterion 2 (multi-modal large language models) and criterion 4 (vision foundation models and applications). Proposes a hierarchical, graph-based multi-scale multi-modal contrastive alignment framework for histopathology images and spatial transcriptomics, with strong empirical results.
**Relevance:** 8
**Novelty:** 7

---

## 19. [KANGURA: Kolmogorov-Arnold Network-Based Geometry-Aware Learning with Unified Representation Attention for 3D Modeling of Complex Structures](https://arxiv.org/abs/2511.13798) <a id="link19"></a>
**ArXiv ID:** 2511.13798
**Authors:** Mohammad Reza Shafie, Morteza Hajiabadi, Hamed Khosravi, Mobina Noori, Imtiaz Ahmed
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding) as it introduces a geometry-aware learning framework (KANGURA) for 3D modeling with unified representation attention, focusing on spatial understanding and geometric relationships.
**Relevance:** 8
**Novelty:** 7

---

## 20. [SkillGen: Learning Domain Skills for In-Context Sequential Decision Making](https://arxiv.org/abs/2511.14670) <a id="link20"></a>
**ArXiv ID:** 2511.14670
**Authors:** Ruomeng Ding, Wei Cheng, Minglai Shao, Chen Zhao
...
**Comment:** Matches criterion 3: Embodied AI, new methods for in-context sequential decision making in environments like ALFWorld, BabyAI, and ScienceWorld. Proposes a novel skill-based ICL framework (SkillGen) for LLMs in sequential reasoning, with empirical improvements.
**Relevance:** 8
**Novelty:** 7

---

## 21. [SplitFlux: Learning to Decouple Content and Style from a Single Image](https://arxiv.org/abs/2511.15258) <a id="link21"></a>
**ArXiv ID:** 2511.15258
**Authors:** Yitong Yang, Yinglin Wang, Changshuo Wang, Yongjun Zhang, Ziyang Chen, Shuting He
...
**Comment:** Related to criterion 4 (vision foundation models and applications): Proposes a new method for disentangling content and style in image generation, building on foundation models like SDXL and Flux.
**Relevance:** 7
**Novelty:** 7

---

## 22. [Hierarchical Semantic Tree Anchoring for CLIP-Based Class-Incremental Learning](https://arxiv.org/abs/2511.15633) <a id="link22"></a>
**ArXiv ID:** 2511.15633
**Authors:** Tao Hu, Lan Li, Zhen-Hao Xie, Da-Wei Zhou
...
**Comment:** Matches criterion 4 (vision foundation models and applications) as it proposes a new method for CLIP-based class-incremental learning, explicitly leveraging hierarchical semantic structure.
**Relevance:** 7
**Novelty:** 7

---

## 23. [Taming Generative Synthetic Data for X-ray Prohibited Item Detection](https://arxiv.org/abs/2511.15299) <a id="link23"></a>
**ArXiv ID:** 2511.15299
**Authors:** Jialong Sun, Hongguang Zhu, Weizhe Liu, Yunda Sun, Renshuai Tao, Yunchao Wei
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a one-stage generative synthetic data pipeline for X-ray prohibited item detection using text-to-image diffusion models, with novel annotation and occlusion modeling strategies.
**Relevance:** 7
**Novelty:** 7

---

## 24. [CPSL: Representing Volumetric Video via Content-Promoted Scene Layers](https://arxiv.org/abs/2511.14927) <a id="link24"></a>
**ArXiv ID:** 2511.14927
**Authors:** Kaiyuan Hu, Yili Jin, Junhua Liu, Xize Duan, Hong Kang, Xue Liu
...
**Comment:** Matches criterion 4: Vision foundation models and applications. Proposes a new compact 2.5D video representation (CPSL) for immersive media, improving scalability and efficiency in volumetric video, which is relevant to vision foundation models and their practical deployment.
**Relevance:** 7
**Novelty:** 7

---

## 25. [Multi-Text Guided Few-Shot Semantic Segmentation](https://arxiv.org/abs/2511.15515) <a id="link25"></a>
**ArXiv ID:** 2511.15515
**Authors:** Qiang Jiao, Bin Yan, Yi Yang, Mengrui Shi, Qiang Zhang
...
**Comment:** Matches criterion 4 (vision foundation models and applications) as it builds on CLIP for few-shot semantic segmentation, introducing new modules for multi-text guidance and cross-modal optimization.
**Relevance:** 7
**Novelty:** 6

---

## 26. [Learning from Mistakes: Loss-Aware Memory Enhanced Continual Learning for LiDAR Place Recognition](https://arxiv.org/abs/2511.15597) <a id="link26"></a>
**ArXiv ID:** 2511.15597
**Authors:** Xufei Wang, Junqiao Zhao, Siyue Tao, Qiwen Gu, Wonbong Kim, Tiantian Feng
...
**Comment:** Matches criterion 1 (spatial understanding on embodied agents) and criterion 3 (new methods in embodied AI). Proposes a continual learning framework for LiDAR place recognition, with loss-aware sampling and rehearsal enhancement for spatial memory.
**Relevance:** 7
**Novelty:** 6

---

## 27. [SkinGPT-R1: Adapter-Only Dual Distillation for Efficient Dermatology Reasoning](https://arxiv.org/abs/2511.15242) <a id="link27"></a>
**ArXiv ID:** 2511.15242
**Authors:** Yuhao Shen, Jiahe Qian, Zhangtianyi Chen, Yuanhao He, Juexiao Zhou
...
**Comment:** Matches criterion 2 (VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Presents SkinGPT-R1, a dermatology-focused vision-language model with novel dual distillation and chain-of-thought reasoning for medical applications.
**Relevance:** 7
**Novelty:** 6

---

## 28. [Jailbreaking Large Vision Language Models in Intelligent Transportation Systems](https://arxiv.org/abs/2511.13892) <a id="link28"></a>
**ArXiv ID:** 2511.13892
**Authors:** Badhan Chandra Das, Md Tasnim Jawad, Md Jueal Mia, M. Hadi Amini, Yanzhao Wu
...
**Comment:** Matches criterion 2 (new VLLMs) as it analyzes vulnerabilities and defenses in large vision-language models (LVLMs) in the context of intelligent transportation systems, including empirical evaluation of state-of-the-art LVLMs.
**Relevance:** 7
**Novelty:** 6

---

## 29. [Driving in Spikes: An Entropy-Guided Object Detector for Spike Cameras](https://arxiv.org/abs/2511.15459) <a id="link29"></a>
**ArXiv ID:** 2511.15459
**Authors:** Ziyan Liu, Qi Su, Lulu Tang, Zhaofei Yu, Tiejun Huang
...
**Comment:** Related to object detection and new benchmarks (DSEC Spike) for spike cameras, which is a novel sensor modality. Some relevance to criterion 3 (new benchmarks for embodied AI), but focus is on spike camera data rather than embodied agents or simulators.
**Relevance:** 5
**Novelty:** 7

---

## 30. [DCL-SE: Dynamic Curriculum Learning for Spatiotemporal Encoding of Brain Imaging](https://arxiv.org/abs/2511.15151) <a id="link30"></a>
**ArXiv ID:** 2511.15151
**Authors:** Meihua Zhou, Xinyu Tong, Jiarui Zhao, Min Cheng, Li Yang, Lei Tian, Nan Wan
...
**Comment:** Somewhat related to spatial intelligence (criterion 1) via spatiotemporal encoding, but focused on brain imaging rather than embodied agents or general spatial understanding. Not a direct match.
**Relevance:** 4
**Novelty:** 6

---

## 31. [APD-Agents: A Large Language Model-Driven Multi-Agents Collaborative Framework for Automated Page Design](https://arxiv.org/abs/2511.14101) <a id="link31"></a>
**ArXiv ID:** 2511.14101
**Authors:** Xinpeng Chen, Xiaofeng Han, Kaihao Zhang, Guochao Ren, Yujie Wang, Wenhao Cao, Yang Zhou, Jianfeng Lu, Zhenbo Song
...
**Comment:** Somewhat related to criterion 2 (multi-agent LLM-driven framework), but not focused on VLLMs or MLLMs; more about LLMs for UI design.
**Relevance:** 4
**Novelty:** 6

---

## 32. [First Frame Is the Place to Go for Video Content Customization](https://arxiv.org/abs/2511.15700) <a id="link32"></a>
**ArXiv ID:** 2511.15700
**Authors:** Jingxi Chen, Zongxia Li, Zhichao Liu, Guangyao Shi, Xiyang Wu, Fuxiao Liu, Cornelia Fermuller, Brandon Y. Feng, Yiannis Aloimonos
...
**Comment:** Related to video generation and customization, but does not directly match any of the four criteria. Offers an empirical insight into video models' use of the first frame.
**Relevance:** 4
**Novelty:** 6

---

## 33. [FlashMesh: Faster and Better Autoregressive Mesh Synthesis via Structured Speculation](https://arxiv.org/abs/2511.15618) <a id="link33"></a>
**ArXiv ID:** 2511.15618
**Authors:** Tingrui Shen, Yiheng Zhang, Chen Tang, Chuan Ping, Zixing Zhao, Le Wan, Yuwang Wang, Ronggang Wang, Shengfeng He
...
**Comment:** Related to generative modeling in 3D vision (mesh synthesis), but does not introduce a new vision foundation model or embodied AI method. Proposes a faster autoregressive mesh generation framework (FlashMesh) using structured speculation.
**Relevance:** 4
**Novelty:** 6

---

## 34. [Towards Unbiased Cross-Modal Representation Learning for Food Image-to-Recipe Retrieval](https://arxiv.org/abs/2511.15201) <a id="link34"></a>
**ArXiv ID:** 2511.15201
**Authors:** Qing Wang, Chong-Wah Ngo, Ee-Peng Lim
...
**Comment:** Related to multi-modal learning and cross-modal retrieval, but does not introduce a new VLLM/MLLM or vision foundation model. Uses causal theory for debiasing, which is a clever statistical trick, but not a direct match to the criteria.
**Relevance:** 4
**Novelty:** 6

---

## 35. [TiCAL:Typicality-Based Consistency-Aware Learning for Multimodal Emotion Recognition](https://arxiv.org/abs/2511.15085) <a id="link35"></a>
**ArXiv ID:** 2511.15085
**Authors:** Wen Yin, Siyu Zhan, Cencen Liu, Xin Hu, Guiduo Duan, Xiurui Xie, Yuan-Fang Li, Tao He
...
**Comment:** Somewhat related to criterion 2 (multimodal learning), but focuses on emotion recognition and not on VLLMs or MLLMs per se.
**Relevance:** 4
**Novelty:** 5

---

## 36. [Complex-Valued 2D Gaussian Representation for Computer-Generated Holography](https://arxiv.org/abs/2511.15022) <a id="link36"></a>
**ArXiv ID:** 2511.15022
**Authors:** Yicheng Zhan, Xiangjun Gao, Long Quan, Kaan Ak\c{s}it
...
**Comment:** Related to computer vision and generative modeling, but does not match any specific criterion. Focuses on holography representation and optimization.
**Relevance:** 3
**Novelty:** 6

---

## 37. [INQUIRE-Search: A Framework for Interactive Discovery in Large-Scale Biodiversity Databases](https://arxiv.org/abs/2511.15656) <a id="link37"></a>
**ArXiv ID:** 2511.15656
**Authors:** Edward Vendrow, Julia Chae, Rupa Kurinchi-Vendhan, Isaac Eckert, Jazlynn Hall, Marta Jarzyna, Reymond Miyajima, Ruth Oliver, Laura Pollock, Lauren Schrack, Scott Yanco, Oisin Mac Aodha, Sara Beery
...
**Comment:** Somewhat related to criterion 4 (vision foundation models and applications), as it describes an AI-enabled search tool for biodiversity images, but does not introduce a new foundation model or core vision method.
**Relevance:** 4
**Novelty:** 5

---

## 38. [MMCM: Multimodality-aware Metric using Clustering-based Modes for Probabilistic Human Motion Prediction](https://arxiv.org/abs/2511.15179) <a id="link38"></a>
**ArXiv ID:** 2511.15179
**Authors:** Kyotaro Tokoro, Hiromu Taketsugu, Norimichi Ukita
...
**Comment:** Related to human motion prediction and evaluation metrics, but does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, or vision foundation models. Proposes a new metric (MMCM) for probabilistic motion prediction.
**Relevance:** 3
**Novelty:** 6

---

## 39. [Computer Vision Modeling of the Development of Geometric and Numerical Concepts in Humans](https://arxiv.org/abs/2511.15029) <a id="link39"></a>
**ArXiv ID:** 2511.15029
**Authors:** Zekun Wang, Sashank Varma
...
**Comment:** Somewhat related to spatial intelligence (criterion 1), as it studies how computer vision models develop geometric and numerical concepts, but it is more cognitive science than new methods for embodied agents or spatial understanding.
**Relevance:** 4
**Novelty:** 5

---

## 40. [Fast Post-Hoc Confidence Fusion for 3-Class Open-Set Aerial Object Detection](https://arxiv.org/abs/2511.15343) <a id="link40"></a>
**ArXiv ID:** 2511.15343
**Authors:** Spyridon Loukovitis, Vasileios Karampinis, Athanasios Voulodimos
...
**Comment:** Does not match any specific criterion. Focuses on open-set detection for UAVs, which is not directly about spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 41. [Generating Natural-Language Surgical Feedback: From Structured Representation to Domain-Grounded Evaluation](https://arxiv.org/abs/2511.15159) <a id="link41"></a>
**ArXiv ID:** 2511.15159
**Authors:** Firdavs Nasriddinov, Rafal Kocielnik, Anima Anandkumar, Andrew J. Hung
...
**Comment:** Related to multi-modal learning and video-to-text, but does not match any specific criterion. Focuses on surgical feedback generation.
**Relevance:** 3
**Novelty:** 5

---

## 42. [Collaborative QA using Interacting LLMs. Impact of Network Structure, Node Capability and Distributed Data](https://arxiv.org/abs/2511.14098) <a id="link42"></a>
**ArXiv ID:** 2511.14098
**Authors:** Adit Jain, Vikram Krishnamurthy, Yiming Zhang
...
**Comment:** Related to LLMs and collaborative QA, but not directly to any of the four criteria. Focuses on networked LLMs and hallucination dynamics.
**Relevance:** 3
**Novelty:** 5

---

## 43. [ALEX:A Light Editing-knowledge Extractor](https://arxiv.org/abs/2511.14018) <a id="link43"></a>
**ArXiv ID:** 2511.14018
**Authors:** Minghu Wang (College of Computer and Cyber Security, Hebei Normal University, Hebei, China), Shuliang Zhao (College of Computer and Cyber Security, Hebei Normal University, Hebei, China), Yuanyuan Zhao (Hebei Provincial Engineering Research Center for Supply Chain Big Data Analytics and Data Security, Hebei, China), Hongxia Xu (College of Computer and Cyber Security, Hebei Normal University, Hebei, China)
...
**Comment:** Does not match any specific criterion. Focuses on knowledge editing in LLMs, not spatial, vision, or embodied AI.
**Relevance:** 3
**Novelty:** 5

---

## 44. [RS-CA-HSICT: A Residual and Spatial Channel Augmented CNN Transformer Framework for Monkeypox Detection](https://arxiv.org/abs/2511.15476) <a id="link44"></a>
**ArXiv ID:** 2511.15476
**Authors:** Rashid Iqbal, Saddam Hussain Khan
...
**Comment:** Does not match any specific criterion. Focuses on a hybrid CNN-Transformer for monkeypox detection, which is an application paper.
**Relevance:** 3
**Novelty:** 4
