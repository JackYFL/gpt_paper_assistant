...
0. [StreamPI: Streaming Multimodal Temporal Modeling for Vision-Language-Action Models](#link0)
**Authors:** Zhe Liu, Jinghua Hou, Yuxiang Lu, Zhenya Yang, Xianzhe Fan, Junwei Luo, Junyi Li, Ruihua Han, Zhi Hou, Hengshuang Zhao

1. [VBVR-Pro: A Scalable and Verifiable Suite for Native Visual Reasoning](#link1)
...
2. [4DGS-WAM: Bridging Past and Future with an Object-Centric World Action Model based on 4D Gaussian Splatting](#link2)
**Authors:** Yueen Ma, Zenglin Xu, Irwin King

3. [MyoMechanix: Biomechanically-Grounded Compositional Skilled Activity Understanding and Coaching](#link3)
**Authors:** Hao Yin, Paritosh Parmar, Lijun Gu, Lin Xu, Tianxiao Guo, Xiujin Liu, Tianyou Zheng, Yang Zhang, Weiwei Fu

4. [Auditable CT Phenotyping Through Report-derived Radiological Observations](#link4)
...
5. [V-Rubrics: Visual Faithfulness via Rubric-Based Reinforcement Learning](#link5)
**Authors:** Shulin Tian, Minglun Li, Yuhao Dong, Hao Ding, Jiarui Yao, Haiwen Diao, Jingkang Yang, Hongyuan Zhu, Ziwei Liu

6. [SeVeR: Selective Visual Exposure and Retrieval for 3D Medical Image Question Answering](#link6)
...
7. [InteractGesture: Progressive Chunk Guidance for Continuous Streaming Co-Speech Gesture Control](#link7)
...
8. [Where to Look Matters: On-Policy Self-Distillation for Long-Video Understanding](#link8)
**Authors:** Kaishen Wang, Dongdi Zhao, Yijun Liang, Dingqiang Ye, Ruibo Chen, Heng Huang, Di Fu

9. [OmniJudge or OmniBias? Diagnosing Multimodal Judges through Balanced, Decoupled Lenses](#link9)
...
10. [See More, Detect Less? Taming Information Leakage in Multi-View Anomaly Detection](#link10)
**Authors:** Shang-Fu Chen, Kuan-Chuan Peng, Jhih-Ciang Wu, Wen-Huang Cheng, Kai-Lung Hua

11. [Video-IFBench: Evaluating Instruction Following of Multimodal LLMs in Video Understanding Scenarios](#link11)
...
12. [Recursive Experiential-Working Memory Evolution for Long-Horizon Agent Harnesses](#link12)
**Authors:** Zhaochen Yu, Yingcheng Wu, Zhenfei Yin, Kaiyuan Chen, Zhe Zhao, Mengdi Wang, Shuicheng Yan, Ling Yang

13. [VGA-BenchV2: An Expanded Unified Benchmark and Multi-Model Framework for Evaluating Video Aesthetics and Generation Quality](#link13)
...
14. [FlashNormal: Detailed Surface Normal Estimation from Flash and No-Flash Images](#link14)
**Authors:** Ruiyang Chen, Feiran Li, Heng Guo, Zhanyu Ma

---
## 0. [StreamPI: Streaming Multimodal Temporal Modeling for Vision-Language-Action Models](https://arxiv.org/abs/2608.26067) <a id="link0"></a>
**ArXiv ID:** 2608.26067
**Authors:** Zhe Liu, Jinghua Hou, Yuxiang Lu, Zhenya Yang, Xianzhe Fan, Junwei Luo, Junyi Li, Ruihua Han, Zhi Hou, Hengshuang Zhao
...
**Comment:** Matches criteria 1 and 3: it introduces a new streaming multimodal temporal modeling method for vision-language-action robot control, with real-robot and simulator evaluation.
**Relevance:** 7
**Novelty:** 7

---

## 1. [VBVR-Pro: A Scalable and Verifiable Suite for Native Visual Reasoning](https://arxiv.org/abs/2608.26105) <a id="link1"></a>
**ArXiv ID:** 2608.26105
**Authors:** Junxiang Xu, Ruisi Wang, Fanyi Pu, Maijunxian Wang, Ran Ji, Tongxi Zhou, Chenyang Gu, Jing Zuo, Hongcan Xiao, Yimeng Geng, Wanqi Yin, Wei Chen, Oscar Qian, Zhengan Yan, Ziqi Huang, Haiwen Diao, Liang Pan, Bo Li, Xiangyu Fan, Dezhi Luo, Fengyuan Yu, Zehong Zhao, Qingying Gao, Tinghui Zhu, Yilan Zhang, Jingqi Tong, Pinyuan Feng, Zhengze Jiang, Letian Wang, Ziyu Guo, Renrui Zhang, Jieneng Chen, Sonia Joseph, Constantin Venhoff, Saman Motamed, Mengyue Yang, Chandra Sripada, Alan Yuille, Philip Torr, Lvmin Zhang, Vikash Kumar, Daniel Khashabi, Nikolaus Kriegeskorte, Rapha\"el Milli\`ere, Vincent C. M\"uller, Anyi Rao, Quan Wang, Ziwei Liu, Dahua Lin, Lei Yang, Hokin Deng, Zhongang Cai
...
**Comment:** Matches criterion 2 closely: it presents a new MLLM/VLM-style native visual reasoning framework with verifiable rewards and controlled generative substrates.
**Relevance:** 5
**Novelty:** 8

---

## 2. [4DGS-WAM: Bridging Past and Future with an Object-Centric World Action Model based on 4D Gaussian Splatting](https://arxiv.org/abs/2608.25956) <a id="link2"></a>
**ArXiv ID:** 2608.25956
**Authors:** Yueen Ma, Zenglin Xu, Irwin King
...
**Comment:** Matches criteria 1 and 3: it proposes an object-centric world action model with explicit 4D Gaussian splatting for future-state prediction in embodied/dynamic scenes.
**Relevance:** 6
**Novelty:** 7

---

## 3. [MyoMechanix: Biomechanically-Grounded Compositional Skilled Activity Understanding and Coaching](https://arxiv.org/abs/2608.26094) <a id="link3"></a>
**ArXiv ID:** 2608.26094
**Authors:** Hao Yin, Paritosh Parmar, Lijun Gu, Lin Xu, Tianxiao Guo, Xiujin Liu, Tianyou Zheng, Yang Zhang, Weiwei Fu
...
**Comment:** Matches criterion 3 closely: it introduces a new embodied/physical-AI benchmark ecosystem for compositional skilled activity understanding, with multimodal sensing and coaching methods.
**Relevance:** 5
**Novelty:** 7

---

## 4. [Auditable CT Phenotyping Through Report-derived Radiological Observations](https://arxiv.org/abs/2608.25948) <a id="link4"></a>
**ArXiv ID:** 2608.25948
**Authors:** Riga Wu, Walter Witschey, Yicheng Li, Felix Barajas Ordonez, Keno K. Bressem, Lisa C. Adams, Gary E. Weissman, Li Shen, Christos Davatzikos, Eduardo Barbosa, Daniel Truhn, Tianyu Han
...
**Comment:** Matches criterion 4 closely: it concerns medical vision foundation models and audits CT phenotyping via report-derived radiological observations.
**Relevance:** 5
**Novelty:** 6

---

## 5. [V-Rubrics: Visual Faithfulness via Rubric-Based Reinforcement Learning](https://arxiv.org/abs/2608.25580) <a id="link5"></a>
**ArXiv ID:** 2608.25580
**Authors:** Shulin Tian, Minglun Li, Yuhao Dong, Hao Ding, Jiarui Yao, Haiwen Diao, Jingkang Yang, Hongyuan Zhu, Ziwei Liu
...
**Comment:** Matches criterion 2 closely: it proposes a new post-training method for VLMs/MLLMs using rubric-based reinforcement learning for visual faithfulness.
**Relevance:** 5
**Novelty:** 6

---

## 6. [SeVeR: Selective Visual Exposure and Retrieval for 3D Medical Image Question Answering](https://arxiv.org/abs/2608.25630) <a id="link6"></a>
**ArXiv ID:** 2608.25630
**Authors:** Yaojun Hu, Danyang Tu, Yang Liu, Jiajin Zhang, Wei Fang, Zhiqiang Liu, Chunlai Dong, Yingda Xia, Haochao Ying, Jian Wu, Ling Zhang
...
**Comment:** Matches criterion 3 closely: it builds a new 3D medical VQA benchmark and a method for selective visual exposure and retrieval over volumetric inputs.
**Relevance:** 5
**Novelty:** 6

---

## 7. [InteractGesture: Progressive Chunk Guidance for Continuous Streaming Co-Speech Gesture Control](https://arxiv.org/abs/2608.25734) <a id="link7"></a>
**ArXiv ID:** 2608.25734
**Authors:** Ekkasit Pinyoanuntapong, Ajinkya Deogade, Paul Streli, Wenjing Zhang, Joanna Materzynska, Pu Wang, Vittorio Ferrari, Jie Shen
...
**Comment:** Matches criterion 1 very closely: it introduces spatial controllability for co-speech gesture generation with progressive chunk guidance over diffusion sampling.
**Relevance:** 5
**Novelty:** 6

---

## 8. [Where to Look Matters: On-Policy Self-Distillation for Long-Video Understanding](https://arxiv.org/abs/2608.25356) <a id="link8"></a>
**ArXiv ID:** 2608.25356
**Authors:** Kaishen Wang, Dongdi Zhao, Yijun Liang, Dingqiang Ye, Ruibo Chen, Heng Huang, Di Fu
...
**Comment:** Matches criterion 2: it proposes a new vision-language model training method for long-video understanding, with an on-policy self-distillation framework.
**Relevance:** 5
**Novelty:** 6

---

## 9. [OmniJudge or OmniBias? Diagnosing Multimodal Judges through Balanced, Decoupled Lenses](https://arxiv.org/abs/2608.24160) <a id="link9"></a>
**ArXiv ID:** 2608.24160
**Authors:** Guangzheng Hu, Ziyue Jiang, Weixu Qiao, Lixin Zhang, Jianye Kang, Yuru Wu, Rong Bao, Niantong Li, Wei Wang, Ziyi Cheng, Xinfa Zhu, HangRui Hu, Ting He, Bing Zhao, Lin Qu, Hu Wei, Jin Xu
...
**Comment:** Matches criterion 2 moderately: it is a benchmark for multimodal judges, including systems used to evaluate image/video/audio generation, but it is more diagnosis/evaluation than a new VLLM/MLLM method.
**Relevance:** 4
**Novelty:** 6

---

## 10. [See More, Detect Less? Taming Information Leakage in Multi-View Anomaly Detection](https://arxiv.org/abs/2608.25168) <a id="link10"></a>
**ArXiv ID:** 2608.25168
**Authors:** Shang-Fu Chen, Kuan-Chuan Peng, Jhih-Ciang Wu, Wen-Huang Cheng, Kai-Lung Hua
...
**Comment:** Matches criterion 4: it uses vision foundation model features for a new application in multi-view anomaly detection, with a clearly stated leakage issue and fusion design.
**Relevance:** 5
**Novelty:** 5

---

## 11. [Video-IFBench: Evaluating Instruction Following of Multimodal LLMs in Video Understanding Scenarios](https://arxiv.org/abs/2608.25529) <a id="link11"></a>
**ArXiv ID:** 2608.25529
**Authors:** Hongbo Liu, Peixian Chen, Sihan Liu, Peiyuan Zhang, Kai Zou, Dian Zheng, Xiaoxing Hu, Yuhao Dong, Mengdan Zhang, Yunhang Shen, Haoyu Cao, Wei Liu, Weibo Gu, Xing Sun, Shengjie Zhao
...
**Comment:** Matches criterion 2 moderately: it benchmarks instruction following in video understanding for MLLMs, but does not introduce a new model or embodied AI method.
**Relevance:** 4
**Novelty:** 5

---

## 12. [Recursive Experiential-Working Memory Evolution for Long-Horizon Agent Harnesses](https://arxiv.org/abs/2608.24876) <a id="link12"></a>
**ArXiv ID:** 2608.24876
**Authors:** Zhaochen Yu, Yingcheng Wu, Zhenfei Yin, Kaiyuan Chen, Zhe Zhao, Mengdi Wang, Shuicheng Yan, Ling Yang
...
**Comment:** No very close match to the listed criteria; it is a long-horizon agent memory method, but not clearly an embodied AI or vision-centric benchmark/method paper.
**Relevance:** 3
**Novelty:** 6

---

## 13. [VGA-BenchV2: An Expanded Unified Benchmark and Multi-Model Framework for Evaluating Video Aesthetics and Generation Quality](https://arxiv.org/abs/2608.25452) <a id="link13"></a>
**ArXiv ID:** 2608.25452
**Authors:** Longteng Jiang, DanDan Zheng, Qianqian Qiao, Heng Huang, Huaye Wang, Yihang Bo, Bao Peng, Jingdong Chen, Jun Zhou, Xin Jin
...
**Comment:** Matches criterion 4 only loosely: it builds a benchmark and evaluator stack around video generation quality, which is adjacent to vision foundation model applications.
**Relevance:** 4
**Novelty:** 5

---

## 14. [FlashNormal: Detailed Surface Normal Estimation from Flash and No-Flash Images](https://arxiv.org/abs/2608.25360) <a id="link14"></a>
**ArXiv ID:** 2608.25360
**Authors:** Ruiyang Chen, Feiran Li, Heng Guo, Zhanyu Ma
...
**Comment:** No very close match to the listed criteria; it is a strong vision application paper on surface normal estimation, but not specifically one of the targeted embodied/VLM/benchmark angles.
**Relevance:** 3
**Novelty:** 5
