# Personalized Daily ArXiv Papers 09/18/2026
...
0. [Can 4D Foundation Models Remember?](#link0)
**Authors:** Guangzhao He, Hadar Averbuch-Elor, Wei-Chiu Ma

1. [SIMLIFE: Pattern Understanding for Long-Horizon Human-Agent Partnership](#link1)
**Authors:** Run Peng, Zinnia Nie, Jing Ding, Yinpei Dai, Yichi Zhang, Zengqing Wu, Yao Fu, Ziqiao Ma, Jiayuan Mao, Joyce Chai

2. [Continual Enterprise World Model Discovery in Dynamic Systems](#link2)
**Authors:** Shambhavi Mishra, David Vazquez, Perouz Taslakian, Marco Pedersoli, Jose Dolz, Issam H. Laradji

3. [PerSeM: Persistent Semantic Memory for Long-Horizon Open-Vocabulary UAV Mapping](#link3)
**Authors:** Saurbh Singh Jamwal, Ganesh Ramakrishnan

4. [PART: Learning 3D Part Assembly and Retrieval with Transformers](#link4)
**Authors:** Ruchao Bao, Wenzheng Wu, Chucheng Xiang, Zhongyuan Liu, Yuan Liu, Jinxin Dong, Ligang Liu, Ziqi Wang

5. [Socialized UAV Cross-Task Learning: Towards Cross-Granularity Collaboration through Hierarchical Interaction](#link5)
**Authors:** Xinjie Yao, Ruipu Zhao, Yunqi Zhu, Zhihe Fan, Zhoupeng Guo, Weihao Li, Zhen Wang, Qilong Wang, Pengfei Zhu

6. [FAMOS: Feed-Forward 3D Articulation Modeling from Sparse Observations](#link6)
**Authors:** Kevin Qu, Tao Sun, Massimiliano Viola, Liyuan Zhu, Zhizhuo Zhou, Sayan Deb Sarkar, Konrad Schindler, Iro Armeni

7. [Paint-Anything: Unified Any-Color Control for Image Generation and Editing](#link7)
**Authors:** Ji Xie, Dewei Zhou, Xinyu Huang, Zhennan Chen, Xun Wang

8. [FreqDINO++: A Frequency-Guided Multi-Task Routing Vision Foundation Model for Universal Ultrasound Analysis](#link8)
**Authors:** Qing Xu, Yixuan Zhang, Yue Li, Xiangjian He, Qian Zhang, Mainul Haque, Rong Qu, Wenting Duan, Jieyun Bai, Zhen Chen

9. [IMFD: End-to-end Multi-Face Forgery Detection through Instruction-based Large Vision-Language Models](#link9)
**Authors:** Dasom Choi, Sangjun Moon, Hyeongchan Im, Jaeeon Park, Jingun Kwon, Hidetaka Kamigaito, Taro Watanabe, Manabu Okumura

10. [Refinement Is Inherently Editable: Training-Free Prompt-to-Prompt Image Editing with Generative Refinement Network](#link10)
**Authors:** Yulong Chen, Ziqian Zhang, Haoyu Zhang, Ao He, Senmao Li, Kai Wang

11. [Bridging Modalities on the Cortex: Surface-based MRI to PET Translation with a Diffusion Bridge](#link11)
**Authors:** Yitong Li, Alexandra Samoylova, Fabian Bongratz, Timo Grimmer, Dennis M. Hedderich, Igor Yakushev, Christian Wachinger

12. [What Do Current Systematic Generalization Tasks Miss? A Reasoning-Centered Analysis](#link12)
**Authors:** Chengwen Qi, Deheng Ye, Yatao Bian

13. [An Event Preserving Velocity Invariant Representation for Event Cameras](#link13)
**Authors:** Mikihiro Ikura, Luna Gava, Jiahang Wu, Chiara Bartolozzi, Arren Glover

---
## 0. [Can 4D Foundation Models Remember?](https://arxiv.org/abs/2609.20819) <a id="link0"></a>
**ArXiv ID:** 2609.20819
**Authors:** Guangzhao He, Hadar Averbuch-Elor, Wei-Chiu Ma
...
**Comment:** Matches criterion 4 very closely: it evaluates 4D foundation models with a new benchmark focused on visual memory, persistence, and object-centric evaluation.
**Relevance:** 5
**Novelty:** 7

---

## 1. [SIMLIFE: Pattern Understanding for Long-Horizon Human-Agent Partnership](https://arxiv.org/abs/2609.19610) <a id="link1"></a>
**ArXiv ID:** 2609.19610
**Authors:** Run Peng, Zinnia Nie, Jing Ding, Yinpei Dai, Yichi Zhang, Zengqing Wu, Yao Fu, Ziqiao Ma, Jiayuan Mao, Joyce Chai
...
**Comment:** Matches criterion 3 very closely: it builds a new embodied simulation benchmark/platform for long-horizon human-agent partnership and studies long-context reasoning in household life.
**Relevance:** 5
**Novelty:** 7

---

## 2. [Continual Enterprise World Model Discovery in Dynamic Systems](https://arxiv.org/abs/2609.19551) <a id="link2"></a>
**ArXiv ID:** 2609.19551
**Authors:** Shambhavi Mishra, David Vazquez, Perouz Taslakian, Marco Pedersoli, Jose Dolz, Issam H. Laradji
...
**Comment:** Matches criterion 3 closely: it builds a new simulator-like benchmark in a live ServiceNow enterprise environment for continual world model discovery and revision.
**Relevance:** 5
**Novelty:** 6

---

## 3. [PerSeM: Persistent Semantic Memory for Long-Horizon Open-Vocabulary UAV Mapping](https://arxiv.org/abs/2609.19542) <a id="link3"></a>
**ArXiv ID:** 2609.19542
**Authors:** Saurbh Singh Jamwal, Ganesh Ramakrishnan
...
**Comment:** Matches criterion 1 and 4 closely: it is a spatial-memory method for long-horizon open-vocabulary UAV mapping, combining 3D persistence with open-vocabulary perception.
**Relevance:** 6
**Novelty:** 5

---

## 4. [PART: Learning 3D Part Assembly and Retrieval with Transformers](https://arxiv.org/abs/2609.19872) <a id="link4"></a>
**ArXiv ID:** 2609.19872
**Authors:** Ruchao Bao, Wenzheng Wu, Chucheng Xiang, Zhongyuan Liu, Yuan Liu, Jinxin Dong, Ligang Liu, Ziqi Wang
...
**Comment:** Matches criterion 3 closely: it is an embodied/3D spatial method for retrieval-based part assembly with 6-DoF pose estimation and a new large-scale dataset.
**Relevance:** 5
**Novelty:** 6

---

## 5. [Socialized UAV Cross-Task Learning: Towards Cross-Granularity Collaboration through Hierarchical Interaction](https://arxiv.org/abs/2609.19867) <a id="link5"></a>
**ArXiv ID:** 2609.19867
**Authors:** Xinjie Yao, Ruipu Zhao, Yunqi Zhu, Zhihe Fan, Zhoupeng Guo, Weihao Li, Zhen Wang, Qilong Wang, Pengfei Zhu
...
**Comment:** Matches criterion 3: it introduces a new UAV benchmark and a method for cross-task collaboration, which is an embodied-AI-adjacent benchmark/method paper with a novel angle on cross-granularity interaction.
**Relevance:** 5
**Novelty:** 6

---

## 6. [FAMOS: Feed-Forward 3D Articulation Modeling from Sparse Observations](https://arxiv.org/abs/2609.20817) <a id="link6"></a>
**ArXiv ID:** 2609.20817
**Authors:** Kevin Qu, Tao Sun, Massimiliano Viola, Liyuan Zhu, Zhizhuo Zhou, Sayan Deb Sarkar, Konrad Schindler, Iro Armeni
...
**Comment:** Matches criterion 1: it proposes a new feed-forward method for 3D articulation modeling from sparse observations, which is closely related to spatial understanding and articulated object reasoning.
**Relevance:** 5
**Novelty:** 6

---

## 7. [Paint-Anything: Unified Any-Color Control for Image Generation and Editing](https://arxiv.org/abs/2609.20816) <a id="link7"></a>
**ArXiv ID:** 2609.20816
**Authors:** Ji Xie, Dewei Zhou, Xinyu Huang, Zhennan Chen, Xun Wang
...
**Comment:** Matches criterion 4 closely: it is a generative image editing and generation method with a new color-control interface and benchmark.
**Relevance:** 5
**Novelty:** 5

---

## 8. [FreqDINO++: A Frequency-Guided Multi-Task Routing Vision Foundation Model for Universal Ultrasound Analysis](https://arxiv.org/abs/2609.20340) <a id="link8"></a>
**ArXiv ID:** 2609.20340
**Authors:** Qing Xu, Yixuan Zhang, Yue Li, Xiangjian He, Qian Zhang, Mainul Haque, Rong Qu, Wenting Duan, Jieyun Bai, Zhen Chen
...
**Comment:** Matches criterion 4 closely: it is a vision foundation model for universal ultrasound analysis with multi-task routing and frequency-guided adaptation.
**Relevance:** 5
**Novelty:** 5

---

## 9. [IMFD: End-to-end Multi-Face Forgery Detection through Instruction-based Large Vision-Language Models](https://arxiv.org/abs/2609.19693) <a id="link9"></a>
**ArXiv ID:** 2609.19693
**Authors:** Dasom Choi, Sangjun Moon, Hyeongchan Im, Jaeeon Park, Jingun Kwon, Hidetaka Kamigaito, Taro Watanabe, Manabu Okumura
...
**Comment:** Matches criterion 2 very closely: it proposes an instruction-based LVLM for end-to-end multi-face forgery detection and uses image-level instructions plus bounding boxes as visual cues.
**Relevance:** 6
**Novelty:** 4

---

## 10. [Refinement Is Inherently Editable: Training-Free Prompt-to-Prompt Image Editing with Generative Refinement Network](https://arxiv.org/abs/2609.20633) <a id="link10"></a>
**ArXiv ID:** 2609.20633
**Authors:** Yulong Chen, Ziqian Zhang, Haoyu Zhang, Ao He, Senmao Li, Kai Wang
...
**Comment:** Matches criterion 4 closely: it is a training-free generative image editing method for prompt-to-prompt refinement with strong preservation behavior.
**Relevance:** 4
**Novelty:** 5

---

## 11. [Bridging Modalities on the Cortex: Surface-based MRI to PET Translation with a Diffusion Bridge](https://arxiv.org/abs/2609.20147) <a id="link11"></a>
**ArXiv ID:** 2609.20147
**Authors:** Yitong Li, Alexandra Samoylova, Fabian Bongratz, Timo Grimmer, Dennis M. Hedderich, Igor Yakushev, Christian Wachinger
...
**Comment:** Matches criterion 4 only loosely: it is a medical vision foundation-model-style generative translation method, but not a general vision foundation model application in the sense of broad vision-language or embodied AI work.
**Relevance:** 3
**Novelty:** 6

---

## 12. [What Do Current Systematic Generalization Tasks Miss? A Reasoning-Centered Analysis](https://arxiv.org/abs/2609.19212) <a id="link12"></a>
**ArXiv ID:** 2609.19212
**Authors:** Chengwen Qi, Deheng Ye, Yatao Bian
...
**Comment:** Does not directly match the listed criteria, but is adjacent to criterion 1 in the sense that it studies systematic generalization and reasoning under controlled tasks.
**Relevance:** 3
**Novelty:** 5

---

## 13. [An Event Preserving Velocity Invariant Representation for Event Cameras](https://arxiv.org/abs/2609.19973) <a id="link13"></a>
**ArXiv ID:** 2609.19973
**Authors:** Mikihiro Ikura, Luna Gava, Jiahang Wu, Chiara Bartolozzi, Arren Glover
...
**Comment:** No close match to criteria 1-4; it is an event-camera representation paper, which is vision-related but not specifically about spatial intelligence, embodied agents, VLLMs/MLLMs, or foundation models.
**Relevance:** 3
**Novelty:** 5
