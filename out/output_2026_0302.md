...
2. [EvalMVX: A Unified Benchmarking for Neural 3D Reconstruction under Diverse Multiview Setups](#link2)
**Authors:** Zaiyan Yang, Jieji Ren, Xiangyi Wang, zonglin li, Xu Cao, Heng Guo, Zhanyu Ma, Boxin Shi

3. [Egocentric Visibility-Aware Human Pose Estimation](#link3)
**Authors:** Peng Dai, Yu Zhang, Yiqiang Feng, Zhen Fan, Yang Zhang

4. [Ref-Adv: Exploring MLLM Visual Reasoning in Referring Expression Tasks](#link4)
**Authors:** Qihua Dong, Kuo Yang, Lin Ju, Handong Zhao, Yitian Zhang, Yizhou Wang, Huimin Zeng, Jianglin Lu, Yun Fu

5. [Thinking with Images as Continuous Actions: Numerical Visual Chain-of-Thought](#link5)
**Authors:** Kesen Zhao, Beier Zhu, Junbao Zhou, Xingyu Zhu, Zhongqi Yue, Hanwang Zhang

6. [Towards Source-Aware Object Swapping with Initial Noise Perturbation](#link6)
**Authors:** Jiahui Zhan, Xianbing Sun, Xiangnan Zhu, Yikun Ji, Ruitong Liu, Liqing Zhang, Jianfu Zhang

7. [Suppressing Prior-Comparison Hallucinations in Radiology Report Generation via Semantically Decoupled Latent Steering](#link7)
**Authors:** Ao Li, Rui Liu, Mingjie Li, Sheng Liu, Lei Wang, Xiaodan Liang, Lina Yao, Xiaojun Chang, Lei Xing

8. [GDA-YOLO11: Amodal Instance Segmentation for Occlusion-Robust Robotic Fruit Harvesting](#link8)
**Authors:** Caner Beldek, Emre Sariyildiz, Son Lam Phung, Gursel Alici

9. [Reasoning-Driven Multimodal LLM for Domain Generalization](#link9)
**Authors:** Zhipeng Xu, Zilong Wang, Xinyang Jiang, Dongsheng Li, De Cheng, Nannan Wang

10. [CC-VQA: Conflict- and Correlation-Aware Method for Mitigating Knowledge Conflict in Knowledge-Based Visual Question Answering](#link10)
**Authors:** Yuyang Hong, Jiaqi Gu, Yujin Lou, Lubin Fan, Qi Yang, Ying Wang, Kun Ding, Yue Wu, Shiming Xiang, Jieping Ye

11. [Look Carefully: Adaptive Visual Reinforcements in Multimodal Large Language Models for Hallucination Mitigation](#link11)
**Authors:** Xingyu Zhu, Kesen Zhao, Liang Yi, Shuo Wang, Zhicai Wang, Beier Zhu, Hanwang Zhang

12. [DiffusionHarmonizer: Bridging Neural Reconstruction and Photorealistic Simulation with Online Diffusion Enhancer](#link12)
...
13. [FocusTrack: One-Stage Focus-and-Suppress Framework for 3D Point Cloud Object Tracking](#link13)
**Authors:** Sifan Zhou, Jiahao Nie, Ziyu Zhao, Yichao Cao, Xiaobo Lu

14. [ProtoDCS: Towards Robust and Efficient Open-Set Test-Time Adaptation for Vision-Language Models](#link14)
**Authors:** Wei Luo, Yangfan Ou, Jin Deng, Zeshuai Deng, Xiquan Yan, Zhiquan Wen, Mingkui Tan

15. [Multimodal Optimal Transport for Unsupervised Temporal Segmentation in Surgical Robotics](#link15)
**Authors:** Omar Mohamed, Edoardo Fazzari, Ayah Al-Naji, Hamdan Alhadhrami, Khalfan Hableel, Saif Alkindi, Cesare Stefanini

16. [EMO-R3: Reflective Reinforcement Learning for Emotional Reasoning in Multimodal Large Language Models](#link16)
**Authors:** Yiyang Fang, Wenke Huang, Pei Fu, Yihao Yang, Kehua Su, Zhenbo Luo, Jian Luan, Mang Ye

17. [AgenticOCR: Parsing Only What You Need for Efficient Retrieval-Augmented Generation](#link17)
**Authors:** Zhengren Wang, Dongsheng Ma, Huaping Zhong, Jiayu Li, Wentao Zhang, Bin Wang, Conghui He

18. [Hierarchical Action Learning for Weakly-Supervised Action Segmentation](#link18)
**Authors:** Junxian Huang, Ruichu Cai, Hao Zhu, Juntao Fang, Boyan Xu, Weilin Chen, Zijian Li, Shenghua Gao

19. [DLEBench: Evaluating Small-scale Object Editing Ability for Instruction-based Image Editing Model](#link19)
**Authors:** Shibo Hong, Boxian Ai, Jun Kuang, Wei Wang, FengJiao Chen, Zhongyuan Peng, Chenhao Huang, Yixin Cao

20. [Uncertainty Quantification for Multimodal Large Language Models with Incoherence-adjusted Semantic Volume](#link20)
**Authors:** Gregory Kang Ruey Lau, Hieu Dao, Nicole Kan Hui Lin, Bryan Kian Hsiang Low

21. [SR3R: Rethinking Super-Resolution 3D Reconstruction With Feed-Forward Gaussian Splatting](#link21)
...
22. [SwitchCraft: Training-Free Multi-Event Video Generation with Attention Controls](#link22)
**Authors:** Qianxun Xu, Chenxi Song, Yujun Cai, Chi Zhang

23. [GuardAlign: Test-time Safety Alignment in Multimodal Large Language Models](#link23)
**Authors:** Xingyu Zhu, Beier Zhu, Junfeng Fang, Shuo Wang, Yin Zhang, Xiang Wang, Xiangnan He

24. [Interpretable Debiasing of Vision-Language Models for Social Fairness](#link24)
**Authors:** Na Min An, Yoonna Jang, Yusuke Hirota, Ryo Hachiuma, Isabelle Augenstein, Hyunjung Shim

25. [Altitude-Aware Visual Place Recognition in Top-Down View](#link25)
**Authors:** Xingyu Shao, Mengfan He, Chunyu Li, Liangzheng Sun, Ziyang Meng

26. [Open-Vocabulary Semantic Segmentation in Remote Sensing via Hierarchical Attention Masking and Model Composition](#link26)
**Authors:** Mohammadreza Heidarianbaei, Mareike Dorozynski, Hubert Kanyamahanga, Max Mehltretter, Franz Rottensteiner

27. [Toward Guarantees for Clinical Reasoning in Vision Language Models via Formal Verification](#link27)
**Authors:** Vikash Singh, Debargha Ganguly, Haotian Yu, Chengwei Zhou, Prerna Singh, Brandon Lee, Vipin Chaudhary, Gourav Datta

28. [DACESR: Degradation-Aware Conditional Embedding for Real-World Image Super-Resolution](#link28)
**Authors:** Xiaoyan Lei, Wenlong Zhang, Biao Luo, Hui Liang, Weifeng Cao, Qiuting Lin

29. [MuViT: Multi-Resolution Vision Transformers for Learning Across Scales in Microscopy](#link29)
**Authors:** Albert Dominguez Mantes, Gioele La Manno, Martin Weigert

30. [The Auton Agentic AI Framework](#link30)
**Authors:** Sheng Cao, Zhao Chang, Chang Li, Hannan Li, Liyao Fu, Ji Tang

31. [Mode Seeking meets Mean Seeking for Fast Long Video Generation](#link31)
...
32. [Diffusion Probe: Generated Image Result Prediction Using CNN Probes](#link32)
...
33. [SegMate: Asymmetric Attention-Based Lightweight Architecture for Efficient Multi-Organ Segmentation](#link33)
**Authors:** Andrei-Alexandru Bunea, Dan-Matei Popovici, Radu Tudor Ionescu

34. [From Flat Logs to Causal Graphs: Hierarchical Failure Attribution for LLM-based Multi-Agent Systems](#link34)
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 4 (vision foundation models and applications). Uses a 3D geometric foundation model for bimanual manipulation, fusing geometry-aware latents and predicting future 3D scene evolution, showing strong spatial intelligence advances for embodied agents.
**Relevance:** 10
**Novelty:** 8
...
**Comment:** Matches criterion 2 and 3: Introduces U-Mind, a unified real-time multimodal interaction system for embodied agents, supporting language, speech, motion, and video synthesis. Novel in its unified alignment and reasoning framework for embodied AI.
**Relevance:** 10
**Novelty:** 8

---

## 2. [EvalMVX: A Unified Benchmarking for Neural 3D Reconstruction under Diverse Multiview Setups](https://arxiv.org/abs/2602.24065) <a id="link2"></a>
**ArXiv ID:** 2602.24065
**Authors:** Zaiyan Yang, Jieji Ren, Xiangyi Wang, zonglin li, Xu Cao, Heng Guo, Zhanyu Ma, Boxin Shi
...
**Comment:** Matches criterion 3: Proposes EvalMVX, a unified real-world benchmark for neural 3D reconstruction under diverse multiview setups, including new modalities (polarization, photometric stereo) not previously benchmarked together. Provides new insights and open problems for embodied AI and simulator-related research.
**Relevance:** 9
**Novelty:** 8

---

## 3. [Egocentric Visibility-Aware Human Pose Estimation](https://arxiv.org/abs/2602.23618) <a id="link3"></a>
**ArXiv ID:** 2602.23618
**Authors:** Peng Dai, Yu Zhang, Yiqiang Feng, Zhen Fan, Yang Zhang
...
**Comment:** Matches criterion 1 and 3: Presents a new large-scale egocentric visibility-aware human pose estimation dataset (Eva-3M) and a new method (EvaPose) that explicitly incorporates visibility information, addressing a previously overlooked problem in egocentric HPE. Also augments an existing dataset for benchmarking.
**Relevance:** 9
**Novelty:** 8

---

## 4. [Ref-Adv: Exploring MLLM Visual Reasoning in Referring Expression Tasks](https://arxiv.org/abs/2602.23898) <a id="link4"></a>
**ArXiv ID:** 2602.23898
**Authors:** Qihua Dong, Kuo Yang, Lin Ju, Handong Zhao, Yitian Zhang, Yizhou Wang, Huimin Zeng, Jianglin Lu, Yun Fu
...
**Comment:** Matches criterion 3 (new benchmark for vision-language models) and criterion 2 (MLLMs). Introduces Ref-Adv, a new REC benchmark that suppresses shortcuts and requires genuine visual reasoning, with comprehensive ablations and failure analysis of MLLMs.
**Relevance:** 9
**Novelty:** 8

---

## 5. [Thinking with Images as Continuous Actions: Numerical Visual Chain-of-Thought](https://arxiv.org/abs/2602.23959) <a id="link5"></a>
**ArXiv ID:** 2602.23959
**Authors:** Kesen Zhao, Beier Zhu, Junbao Zhou, Xingyu Zhu, Zhongqi Yue, Hanwang Zhang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 1 (methodological improvements to spatial understanding on embodied agents). Proposes a framework for MLLMs to reason over images using continuous numerical coordinates, improving localization and reasoning precision.
**Relevance:** 9
**Novelty:** 8

---

## 6. [Towards Source-Aware Object Swapping with Initial Noise Perturbation](https://arxiv.org/abs/2602.23697) <a id="link6"></a>
**ArXiv ID:** 2602.23697
**Authors:** Jiahui Zhan, Xianbing Sun, Xiangnan Zhu, Yikun Ji, Ruitong Liu, Liqing Zhang, Jianfu Zhang
...
**Comment:** Matches criterion 4: Introduces a new self-supervised, source-aware object swapping framework (SourceSwap) and a new benchmark (SourceBench) for object swapping/editing, with novel generative modeling techniques for multi-modal learning. Relevant for generative modeling and vision foundation model applications.
**Relevance:** 8
**Novelty:** 8

---

## 7. [Suppressing Prior-Comparison Hallucinations in Radiology Report Generation via Semantically Decoupled Latent Steering](https://arxiv.org/abs/2602.23676) <a id="link7"></a>
**ArXiv ID:** 2602.23676
**Authors:** Ao Li, Rui Liu, Mingjie Li, Sheng Liu, Lei Wang, Xiaodan Liang, Lina Yao, Xiaojun Chang, Lei Xing
...
**Comment:** Matches criterion 2: Proposes a novel inference-time control framework (SDLS) for vision-language models (VLMs) in radiology report generation, using clever statistical tricks (QR-based orthogonalization) to suppress hallucinations. Also demonstrates surprising empirical results in VLMs.
**Relevance:** 8
**Novelty:** 7

---

## 8. [GDA-YOLO11: Amodal Instance Segmentation for Occlusion-Robust Robotic Fruit Harvesting](https://arxiv.org/abs/2602.23953) <a id="link8"></a>
**ArXiv ID:** 2602.23953
**Authors:** Caner Beldek, Emre Sariyildiz, Son Lam Phung, Gursel Alici
...
**Comment:** Matches criterion 1 (spatial understanding on embodied agents) and criterion 4 (vision foundation models and applications). Proposes a new amodal instance segmentation model for occlusion-robust robotic fruit harvesting, with practical demonstration and improved perception-to-action integration.
**Relevance:** 8
**Novelty:** 7

---

## 9. [Reasoning-Driven Multimodal LLM for Domain Generalization](https://arxiv.org/abs/2602.23777) <a id="link9"></a>
**ArXiv ID:** 2602.23777
**Authors:** Zhipeng Xu, Zilong Wang, Xinyang Jiang, Dongsheng Li, De Cheng, Nannan Wang
...
**Comment:** Matches criterion 2 (MLLMs) and partially criterion 4 (vision foundation models and applications). Proposes a reasoning-driven multimodal LLM for domain generalization, with a new dataset and framework for robust out-of-domain generalization.
**Relevance:** 8
**Novelty:** 7

---

## 10. [CC-VQA: Conflict- and Correlation-Aware Method for Mitigating Knowledge Conflict in Knowledge-Based Visual Question Answering](https://arxiv.org/abs/2602.23952) <a id="link10"></a>
**ArXiv ID:** 2602.23952
**Authors:** Yuyang Hong, Jiaqi Gu, Yujin Lou, Lubin Fan, Qi Yang, Ying Wang, Kun Ding, Yue Wu, Shiming Xiang, Jieping Ye
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and partially criterion 4 (vision foundation models and applications). Proposes a new method for mitigating knowledge conflict in knowledge-based VQA, with vision-centric conflict reasoning and correlation-guided encoding/decoding, evaluated on multiple VQA benchmarks.
**Relevance:** 8
**Novelty:** 7

---

## 11. [Look Carefully: Adaptive Visual Reinforcements in Multimodal Large Language Models for Hallucination Mitigation](https://arxiv.org/abs/2602.24041) <a id="link11"></a>
**ArXiv ID:** 2602.24041
**Authors:** Xingyu Zhu, Kesen Zhao, Liang Yi, Shuo Wang, Zhicai Wang, Beier Zhu, Hanwang Zhang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Proposes a training-free hallucination mitigation framework for MLLMs using adaptive visual reinforcement and prototype-based token reduction.
**Relevance:** 8
**Novelty:** 7

---

## 12. [DiffusionHarmonizer: Bridging Neural Reconstruction and Photorealistic Simulation with Online Diffusion Enhancer](https://arxiv.org/abs/2602.24096) <a id="link12"></a>
**ArXiv ID:** 2602.24096
**Authors:** Yuxuan Zhang, Katar\'ina T\'othov\'a, Zian Wang, Kangxue Yin, Haithem Turki, Riccardo de Lutio, Yen-Yu Chang, Or Litany, Sanja Fidler, Zan Gojcic
...
**Comment:** Matches criterion 3 (embodied AI, simulator-related methods) and criterion 4 (vision foundation models and applications). Introduces an online diffusion-based enhancer for neural reconstructions in simulation, improving realism and temporal consistency for embodied AI simulators.
**Relevance:** 8
**Novelty:** 7

---

## 13. [FocusTrack: One-Stage Focus-and-Suppress Framework for 3D Point Cloud Object Tracking](https://arxiv.org/abs/2602.24133) <a id="link13"></a>
**ArXiv ID:** 2602.24133
**Authors:** Sifan Zhou, Jiahao Nie, Ziyu Zhao, Yichao Cao, Xiaobo Lu
...
**Comment:** Matches criterion 1 (methodological improvements to spatial understanding on embodied agents) and criterion 3 (embodied AI, new methods). Proposes a novel one-stage 3D point cloud tracking framework with motion-semantics co-modeling and achieves SOTA on major benchmarks.
**Relevance:** 8
**Novelty:** 7

---

## 14. [ProtoDCS: Towards Robust and Efficient Open-Set Test-Time Adaptation for Vision-Language Models](https://arxiv.org/abs/2602.23653) <a id="link14"></a>
**ArXiv ID:** 2602.23653
**Authors:** Wei Luo, Yangfan Ou, Jin Deng, Zeshuai Deng, Xiquan Yan, Zhiquan Wen, Mingkui Tan
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Proposes a new robust test-time adaptation framework for VLMs in open-set scenarios, with a novel GMM-based separation and prototype-level adaptation.
**Relevance:** 8
**Novelty:** 7

---

## 15. [Multimodal Optimal Transport for Unsupervised Temporal Segmentation in Surgical Robotics](https://arxiv.org/abs/2602.24138) <a id="link15"></a>
**ArXiv ID:** 2602.24138
**Authors:** Omar Mohamed, Edoardo Fazzari, Ayah Al-Naji, Hamdan Alhadhrami, Khalfan Hableel, Saif Alkindi, Cesare Stefanini
...
**Comment:** Matches criterion 1 and 3: Proposes TASOT, an unsupervised multimodal optimal transport method for temporal segmentation in surgical robotics, with a novel approach to aligning visual and textual cues without pretraining.
**Relevance:** 8
**Novelty:** 7

---

## 16. [EMO-R3: Reflective Reinforcement Learning for Emotional Reasoning in Multimodal Large Language Models](https://arxiv.org/abs/2602.23802) <a id="link16"></a>
**ArXiv ID:** 2602.23802
**Authors:** Yiyang Fang, Wenke Huang, Pei Fu, Yihao Yang, Kehua Su, Zhenbo Luo, Jian Luan, Mang Ye
...
**Comment:** Matches criterion 2: Presents EMO-R3, a new reinforcement learning framework for improving emotional reasoning in MLLMs, with structured emotional thinking and reflective reward design.
**Relevance:** 8
**Novelty:** 7

---

## 17. [AgenticOCR: Parsing Only What You Need for Efficient Retrieval-Augmented Generation](https://arxiv.org/abs/2602.24134) <a id="link17"></a>
**ArXiv ID:** 2602.24134
**Authors:** Zhengren Wang, Dongsheng Ma, Huaping Zhong, Jiayu Li, Wentao Zhang, Bin Wang, Conghui He
...
**Comment:** Matches criterion 2: Introduces AgenticOCR, a new paradigm for efficient retrieval-augmented generation in multimodal (visual document) settings, with a focus on selective OCR and visual token management. Also relevant to criterion 4 as it enhances visual document understanding.
**Relevance:** 8
**Novelty:** 7

---

## 18. [Hierarchical Action Learning for Weakly-Supervised Action Segmentation](https://arxiv.org/abs/2602.24275) <a id="link18"></a>
**ArXiv ID:** 2602.24275
**Authors:** Junxian Huang, Ruichu Cai, Hao Zhu, Juntao Fang, Boyan Xu, Weilin Chen, Zijian Li, Shenghua Gao
...
**Comment:** Matches criterion 1: Proposes a new hierarchical action learning model for video understanding, introducing a hierarchical pyramid transformer and causal data generation process for better spatial-temporal reasoning in action segmentation.
**Relevance:** 8
**Novelty:** 7

---

## 19. [DLEBench: Evaluating Small-scale Object Editing Ability for Instruction-based Image Editing Model](https://arxiv.org/abs/2602.23622) <a id="link19"></a>
**ArXiv ID:** 2602.23622
**Authors:** Shibo Hong, Boxian Ai, Jun Kuang, Wei Wang, FengJiao Chen, Zhongyuan Peng, Chenhao Huang, Yixin Cao
...
**Comment:** Matches criterion 3 (new benchmark for embodied AI or vision-language models). Introduces a new benchmark (DLEBench) for evaluating instruction-based image editing models on small-scale object editing, with a dual-mode evaluation protocol and empirical analysis.
**Relevance:** 7
**Novelty:** 7

---

## 20. [Uncertainty Quantification for Multimodal Large Language Models with Incoherence-adjusted Semantic Volume](https://arxiv.org/abs/2602.24195) <a id="link20"></a>
**ArXiv ID:** 2602.24195
**Authors:** Gregory Kang Ruey Lau, Hieu Dao, Nicole Kan Hui Lin, Bryan Kian Hsiang Low
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs). Proposes a training-free uncertainty quantification framework for MLLMs, generalizing across modalities and outputs, with theoretical analysis and strong empirical results.
**Relevance:** 7
**Novelty:** 7

---

## 21. [SR3R: Rethinking Super-Resolution 3D Reconstruction With Feed-Forward Gaussian Splatting](https://arxiv.org/abs/2602.24020) <a id="link21"></a>
**ArXiv ID:** 2602.24020
**Authors:** Xiang Feng, Xiangbo Wang, Tieshi Zhong, Chengkai Wang, Yiting Zhao, Tianxiang Xu, Zhenzhong Kuang, Feiwei Qin, Xuefei Yin, Yanming Zhu
...
**Comment:** Matches criterion 4: SR3R proposes a feed-forward framework for super-resolution 3D reconstruction using Gaussian Splatting, relevant to vision foundation models and their applications in 3D scene understanding.
**Relevance:** 7
**Novelty:** 7

---

## 22. [SwitchCraft: Training-Free Multi-Event Video Generation with Attention Controls](https://arxiv.org/abs/2602.23956) <a id="link22"></a>
**ArXiv ID:** 2602.23956
**Authors:** Qianxun Xu, Chenxi Song, Yujun Cai, Chi Zhang
...
**Comment:** Matches criterion 4: SwitchCraft introduces a training-free framework for multi-event video generation with attention controls, relevant to generative modeling in multi-modal learning and vision foundation model applications.
**Relevance:** 7
**Novelty:** 7

---

## 23. [GuardAlign: Test-time Safety Alignment in Multimodal Large Language Models](https://arxiv.org/abs/2602.24027) <a id="link23"></a>
**ArXiv ID:** 2602.24027
**Authors:** Xingyu Zhu, Beier Zhu, Junfeng Fang, Shuo Wang, Yin Zhang, Xiang Wang, Xiangnan He
...
**Comment:** Matches criterion 2: Proposes GuardAlign, a test-time safety alignment framework for multimodal large language models (MLLMs), with novel optimal transport-based detection and cross-modal attentive calibration.
**Relevance:** 8
**Novelty:** 6

---

## 24. [Interpretable Debiasing of Vision-Language Models for Social Fairness](https://arxiv.org/abs/2602.24014) <a id="link24"></a>
**ArXiv ID:** 2602.24014
**Authors:** Na Min An, Yoonna Jang, Yusuke Hirota, Ryo Hachiuma, Isabelle Augenstein, Hyunjung Shim
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes an interpretable, model-agnostic debiasing framework for VLMs using sparse autoencoders to localize and deactivate social attribute neurons.
**Relevance:** 6
**Novelty:** 7

---

## 25. [Altitude-Aware Visual Place Recognition in Top-Down View](https://arxiv.org/abs/2602.23872) <a id="link25"></a>
**ArXiv ID:** 2602.23872
**Authors:** Xingyu Shao, Mengfan He, Chunyu Li, Liangzheng Sun, Ziyang Meng
...
**Comment:** Matches criterion 1 (methodological improvements to spatial understanding on embodied agents). Proposes a vision-only, altitude-adaptive visual place recognition method for aerial platforms, robust to altitude changes.
**Relevance:** 7
**Novelty:** 6

---

## 26. [Open-Vocabulary Semantic Segmentation in Remote Sensing via Hierarchical Attention Masking and Model Composition](https://arxiv.org/abs/2602.23869) <a id="link26"></a>
**ArXiv ID:** 2602.23869
**Authors:** Mohammadreza Heidarianbaei, Mareike Dorozynski, Hubert Kanyamahanga, Max Mehltretter, Franz Rottensteiner
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Presents a new training-free open-vocabulary semantic segmentation method for remote sensing using CLIP and SAM, with a novel hierarchical masking and model composition.
**Relevance:** 7
**Novelty:** 6

---

## 27. [Toward Guarantees for Clinical Reasoning in Vision Language Models via Formal Verification](https://arxiv.org/abs/2602.24111) <a id="link27"></a>
**ArXiv ID:** 2602.24111
**Authors:** Vikash Singh, Debargha Ganguly, Haotian Yu, Chengwei Zhou, Prerna Singh, Brandon Lee, Vipin Chaudhary, Gourav Datta
...
**Comment:** Matches criterion 2: Proposes a neurosymbolic verification framework for clinical reasoning in vision-language models, with formal verification for logical consistency in generated radiology reports.
**Relevance:** 7
**Novelty:** 6

---

## 28. [DACESR: Degradation-Aware Conditional Embedding for Real-World Image Super-Resolution](https://arxiv.org/abs/2602.23890) <a id="link28"></a>
**ArXiv ID:** 2602.23890
**Authors:** Xiaoyan Lei, Wenlong Zhang, Biao Luo, Hui Liang, Weifeng Cao, Qiuting Lin
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a degradation-aware conditional embedding for real-world image super-resolution, leveraging contrastive learning and a Mamba-based network.
**Relevance:** 6
**Novelty:** 6

---

## 29. [MuViT: Multi-Resolution Vision Transformers for Learning Across Scales in Microscopy](https://arxiv.org/abs/2602.24222) <a id="link29"></a>
**ArXiv ID:** 2602.24222
**Authors:** Albert Dominguez Mantes, Gioele La Manno, Martin Weigert
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Introduces a multi-resolution vision transformer for microscopy, fusing multi-scale information with explicit world-coordinate modeling.
**Relevance:** 6
**Novelty:** 6

---

## 30. [The Auton Agentic AI Framework](https://arxiv.org/abs/2602.23720) <a id="link30"></a>
**ArXiv ID:** 2602.23720
**Authors:** Sheng Cao, Zhao Chang, Chang Li, Hannan Li, Liyao Fu, Ji Tang
...
**Comment:** Some relevance to embodied AI (criterion 3) as it discusses agentic AI frameworks and formalizes agent execution as an augmented POMDP, but focus is more on agent architecture and governance than spatial intelligence or vision.
**Relevance:** 5
**Novelty:** 6

---

## 31. [Mode Seeking meets Mean Seeking for Fast Long Video Generation](https://arxiv.org/abs/2602.24289) <a id="link31"></a>
**ArXiv ID:** 2602.24289
**Authors:** Shengqu Cai, Weili Nie, Chao Liu, Julius Berner, Lvmin Zhang, Nanye Ma, Hansheng Chen, Maneesh Agrawala, Leonidas Guibas, Gordon Wetzstein, Arash Vahdat
...
**Comment:** Relevant to generative modeling in multi-modal learning (friend's general interest), but does not directly match any specific criterion. Focuses on long video generation with a new training paradigm combining mode-seeking and mean-seeking objectives.
**Relevance:** 4
**Novelty:** 7

---

## 32. [Diffusion Probe: Generated Image Result Prediction Using CNN Probes](https://arxiv.org/abs/2602.23783) <a id="link32"></a>
**ArXiv ID:** 2602.23783
**Authors:** Benlei Cui, Bukun Huang, Zhizeng Ye, Xuemei Dong, Tuo Chen, Hui Xue, Dingkang Yang, Longtao Huang, Jingqun Tang, Haiwen Hong
...
**Comment:** Some relevance to generative modeling in multi-modal learning (friend's general interest), but does not directly match any specific criterion. Proposes a method for early quality prediction in diffusion models using CNN probes.
**Relevance:** 4
**Novelty:** 6

---

## 33. [SegMate: Asymmetric Attention-Based Lightweight Architecture for Efficient Multi-Organ Segmentation](https://arxiv.org/abs/2602.23903) <a id="link33"></a>
**ArXiv ID:** 2602.23903
**Authors:** Andrei-Alexandru Bunea, Dan-Matei Popovici, Radu Tudor Ionescu
...
**Comment:** Somewhat relevant to criterion 4: Proposes a new lightweight architecture for medical image segmentation, but does not focus on vision foundation models or their applications directly. More of an efficient architecture paper.
**Relevance:** 4
**Novelty:** 5

---

## 34. [From Flat Logs to Causal Graphs: Hierarchical Failure Attribution for LLM-based Multi-Agent Systems](https://arxiv.org/abs/2602.23701) <a id="link34"></a>
**ArXiv ID:** 2602.23701
**Authors:** Yawen Wang, Wenjie Wu, Junjie Wang, Qing Wang
...
**Comment:** Does not directly match any criteria. Focuses on causal failure attribution in LLM-based multi-agent systems, which is tangential to embodied AI but not about spatial intelligence, VLLMs/MLLMs, benchmarks, or vision foundation models.
**Relevance:** 3
**Novelty:** 6
