...
0. [DeepEyesV2: Toward Agentic Multimodal Model](#link0)
**Authors:** Jack Hong, Chenxiao Zhao, ChengLin Zhu, Weiheng Lu, Guohai Xu, Xing Yu

1. [LiveStar: Live Streaming Assistant for Real-World Online Video Understanding](#link1)
...
2. [FreeControl: Efficient, Training-Free Structural Control via One-Step Attention Extraction](#link2)
**Authors:** Jiang Lin, Xinyu Chen, Song Wu, Zhiqiu Zhang, Jizhi Zhang, Ye Wang, Qiang Tang, Qian Wang, Jian Yang, Zili Yi

3. [TimeSearch-R: Adaptive Temporal Search for Long-Form Video Understanding via Self-Verification Reinforcement Learning](#link3)
**Authors:** Junwen Pan, Qizhe Zhang, Rui Zhang, Ming Lu, Xin Wan, Yuan Zhang, Chang Liu, Qi She

4. [Pressure2Motion: Hierarchical Motion Synthesis from Ground Pressure with Text Guidance](#link4)
**Authors:** Zhengxuan Li, Qinhui Yang, Yiyu Zhuang, Chuan Guo, Xinxin Zuo, Xiaoxiao Long, Yao Yao, Xun Cao, Qiu Shen, Hao Zhu

5. [Dense Motion Captioning](#link5)
**Authors:** Shiyao Xu, Benedetta Liberatori, G\"ul Varol, Paolo Rota

6. [A benchmark multimodal oro-dental dataset for large vision-language models](#link6)
...
7. [Canonical Space Representation for 4D Panoptic Segmentation of Articulated Objects](#link7)
**Authors:** Manuel Gomes, Bogdan Raducanu, Miguel Oliveira

8. [Real-Time Reasoning Agents in Evolving Environments](#link8)
**Authors:** Yule Wen, Yixin Ye, Yanzhe Zhang, Diyi Yang, Hao Zhu

9. [Towards Mitigating Hallucinations in Large Vision-Language Models by Refining Textual Embeddings](#link9)
...
10. [4D3R: Motion-Aware Neural Reconstruction and Rendering of Dynamic Scenes from Monocular Videos](#link10)
**Authors:** Mengqi Guo, Bo Xu, Yanyan Li, Gim Hee Lee

11. [Self-Supervised Implicit Attention Priors for Point Cloud Reconstruction](#link11)
**Authors:** Kyle Fogarty, Chenyue Cai, Jing Yang, Zhilin Guo, Cengiz \"Oztireli

12. [3D Gaussian Point Encoders](#link12)
**Authors:** Jim James, Ben Wilson, Simon Lucey, James Hays

13. [No Pose Estimation? No Problem: Pose-Agnostic and Instance-Aware Test-Time Adaptation for Monocular Depth Estimation](#link13)
**Authors:** Mingyu Sung, Hyeonmin Choe, Il-Min Kim, Sangseok Yun, Jae Mo Kang

14. [How Many Tokens Do 3D Point Cloud Transformer Architectures Really Need?](#link14)
...
15. [Learning Fourier shapes to probe the geometric world of deep neural networks](#link15)
**Authors:** Jian Wang, Yixing Yong, Haixia Bi, Lijun He, Fan Li

16. [Semantic-Guided Natural Language and Visual Fusion for Cross-Modal Interaction Based on Tiny Object Detection](#link16)
**Authors:** Xian-Hong Huang, Hui-Kai Su, Chi-Chia Sun, Jun-Wei Hsieh

17. [Medical Referring Image Segmentation via Next-Token Mask Prediction](#link17)
**Authors:** Xinyu Chen, Yiran Wang, Gaoyang Pang, Jiafu Hao, Chentao Yue, Luping Zhou, Yonghui Li

18. [Real-World Adverse Weather Image Restoration via Dual-Level Reinforcement Learning with High-Quality Cold Start](#link18)
**Authors:** Fuyang Liu, Jiaqi Xu, Xiaowei Hu

19. [SnowyLane: Robust Lane Detection on Snow-covered Rural Roads Using Infrastructural Elements](#link19)
**Authors:** J\"org Gamerdinger, Benedict Wetzel, Patrick Schulz, Sven Teufel, Oliver Bringmann

20. [Pattern-Aware Diffusion Synthesis of fMRI/dMRI with Tissue and Microstructural Refinement](#link20)
...
21. [Splatography: Sparse multi-view dynamic Gaussian Splatting for filmmaking challenges](#link21)
**Authors:** Adrian Azzarelli, Nantheera Anantrasirichai, David R Bull

22. [From Linear Probing to Joint-Weighted Token Hierarchy: A Foundation Model Bridging Global and Cellular Representations in Biomarker Detection](#link22)
**Authors:** Jingsong Liu, Han Li, Nassir Navab, Peter J. Sch\"uffler

23. [$\mathbf{S^2LM}$: Towards Semantic Steganography via Large Language Models](#link23)
**Authors:** Huanqi Wu, Huangbiao Xu, Runfeng Xie, Jiaxin Cai, Kaixin Zhang, Xiao Ke

24. [MUSE: Multi-Scale Dense Self-Distillation for Nucleus Detection and Classification](#link24)
...
25. [GSE: Evaluating Sticker Visual Semantic Similarity via a General Sticker Encoder](#link25)
**Authors:** Heng Er Metilda Chee, Jiayin Wang, Zhiqiang Guo, Weizhi Ma, Min Zhang

26. [The Potential of Copernicus Satellites for Disaster Response: Retrieving Building Damage from Sentinel-1 and Sentinel-2](#link26)
...
27. [Global 3D Reconstruction of Clouds & Tropical Cyclones](#link27)
...
28. [A Dual-stage Prompt-driven Privacy-preserving Paradigm for Person Re-Identification](#link28)
**Authors:** Ruolin Li, Min Liu, Yuan Bian, Zhaoyang Li, Yuzhen Li, Xueping Wang, Yaonan Wang

29. [CLM: Removing the GPU Memory Barrier for 3D Gaussian Splatting](#link29)
**Authors:** Hexu Zhao, Xiwen Min, Xiaoteng Liu, Moonjun Gong, Yiming Li, Ang Li, Saining Xie, Jinyang Li, Aurojit Panda

30. [EventFlow: Real-Time Neuromorphic Event-Driven Classification of Two-Phase Boiling Flow Regimes](#link30)
...
31. [Dynamic Residual Encoding with Slide-Level Contrastive Learning for End-to-End Whole Slide Image Representation](#link31)
**Authors:** Jing Jin, Xu Liu, Te Gao, Zhihong Shi, Yixiong Liang, Ruiqing Zheng, Hulin Kuang, Min Zeng, Shichao Kan

32. [Deep learning models are vulnerable, but adversarial examples are even more vulnerable](#link32)
**Authors:** Jun Li, Yanwei Xu, Keran Li, Xiaoli Zhang

33. [Geometry Denoising with Preferred Normal Vectors](#link33)
**Authors:** Manuel Wei{\ss}, Lukas Baumg\"artner, Roland Herzog, Stephan Schmidt

34. [Learning to Restore Multi-Degraded Images via Ingredient Decoupling and Task-Aware Path Adaptation](#link34)
**Authors:** Hu Gao, Xiaoning Lei, Ying Zhang, Xichen Xu, Guannan Jiang, Lizhuang Ma

35. [Data Efficiency and Transfer Robustness in Biomedical Image Segmentation: A Study of Redundancy and Forgetting with Cellpose](#link35)
**Authors:** Shuo Zhao, Jianxu Chen

36. [AI Assisted AR Assembly: Object Recognition and Computer Vision for Augmented Reality Assisted Assembly](#link36)
**Authors:** Alexander Htet Kyaw, Haotian Ma, Sasa Zivkovic, Jenny Sabin

37. [DMA: Online RAG Alignment with Human Feedback](#link37)
...
38. [Cross-domain EEG-based Emotion Recognition with Contrastive Learning](#link38)
**Authors:** Rui Yan, Yibo Li, Han Ding, Fei Wang

39. [Sharing the Learned Knowledge-base to Estimate Convolutional Filter Parameters for Continual Image Restoration](#link39)
**Authors:** Aupendu Kar, Krishnendu Ghosh, Prabir Kumar Biswas

40. [Reasoning Is All You Need for Urban Planning AI](#link40)
**Authors:** Sijie Yang, Jiatong Li, Filip Biljecki

---
## 0. [DeepEyesV2: Toward Agentic Multimodal Model](https://arxiv.org/abs/2511.05271) <a id="link0"></a>
**ArXiv ID:** 2511.05271
**Authors:** Jack Hong, Chenxiao Zhao, ChengLin Zhu, Weiheng Lu, Guohai Xu, Xing Yu
...
## 1. [LiveStar: Live Streaming Assistant for Real-World Online Video Understanding](https://arxiv.org/abs/2511.05299) <a id="link1"></a>
**ArXiv ID:** 2511.05299
**Authors:** Zhenyu Yang, Kairui Zhang, Yuhang Hu, Bing Wang, Shengsheng Qian, Bin Wen, Fan Yang, Tingting Gao, Weiming Dong, Changsheng Xu
...
## 2. [FreeControl: Efficient, Training-Free Structural Control via One-Step Attention Extraction](https://arxiv.org/abs/2511.05219) <a id="link2"></a>
**ArXiv ID:** 2511.05219
**Authors:** Jiang Lin, Xinyu Chen, Song Wu, Zhiqiu Zhang, Jizhi Zhang, Ye Wang, Qiang Tang, Qian Wang, Jian Yang, Zili Yi
...
## 3. [TimeSearch-R: Adaptive Temporal Search for Long-Form Video Understanding via Self-Verification Reinforcement Learning](https://arxiv.org/abs/2511.05489) <a id="link3"></a>
**ArXiv ID:** 2511.05489
**Authors:** Junwen Pan, Qizhe Zhang, Rui Zhang, Ming Lu, Xin Wan, Yuan Zhang, Chang Liu, Qi She
...
## 4. [Pressure2Motion: Hierarchical Motion Synthesis from Ground Pressure with Text Guidance](https://arxiv.org/abs/2511.05038) <a id="link4"></a>
**ArXiv ID:** 2511.05038
**Authors:** Zhengxuan Li, Qinhui Yang, Yiyu Zhuang, Chuan Guo, Xinxin Zuo, Xiaoxiao Long, Yao Yao, Xun Cao, Qiu Shen, Hao Zhu
...
## 5. [Dense Motion Captioning](https://arxiv.org/abs/2511.05369) <a id="link5"></a>
**ArXiv ID:** 2511.05369
**Authors:** Shiyao Xu, Benedetta Liberatori, G\"ul Varol, Paolo Rota
...
## 6. [A benchmark multimodal oro-dental dataset for large vision-language models](https://arxiv.org/abs/2511.04948) <a id="link6"></a>
**ArXiv ID:** 2511.04948
**Authors:** Haoxin Lv, Ijazul Haq, Jin Du, Jiaxin Ma, Binnian Zhu, Xiaobing Dang, Chaoan Liang, Ruxu Du, Yingjie Zhang, Muhammad Saqib
...
## 7. [Canonical Space Representation for 4D Panoptic Segmentation of Articulated Objects](https://arxiv.org/abs/2511.05356) <a id="link7"></a>
**ArXiv ID:** 2511.05356
**Authors:** Manuel Gomes, Bogdan Raducanu, Miguel Oliveira
...
## 8. [Real-Time Reasoning Agents in Evolving Environments](https://arxiv.org/abs/2511.04898) <a id="link8"></a>
**ArXiv ID:** 2511.04898
**Authors:** Yule Wen, Yixin Ye, Yanzhe Zhang, Diyi Yang, Hao Zhu
...
## 9. [Towards Mitigating Hallucinations in Large Vision-Language Models by Refining Textual Embeddings](https://arxiv.org/abs/2511.05017) <a id="link9"></a>
**ArXiv ID:** 2511.05017
**Authors:** Aakriti Agrawal, Gouthaman KV, Rohith Aralikatti, Gauri Jagatap, Jiaxin Yuan, Vijay Kamarshi, Andrea Fanelli, Furong Huang
...
## 10. [4D3R: Motion-Aware Neural Reconstruction and Rendering of Dynamic Scenes from Monocular Videos](https://arxiv.org/abs/2511.05229) <a id="link10"></a>
**ArXiv ID:** 2511.05229
**Authors:** Mengqi Guo, Bo Xu, Yanyan Li, Gim Hee Lee
...
## 11. [Self-Supervised Implicit Attention Priors for Point Cloud Reconstruction](https://arxiv.org/abs/2511.04864) <a id="link11"></a>
**ArXiv ID:** 2511.04864
**Authors:** Kyle Fogarty, Chenyue Cai, Jing Yang, Zhilin Guo, Cengiz \"Oztireli
...
## 12. [3D Gaussian Point Encoders](https://arxiv.org/abs/2511.04797) <a id="link12"></a>
**ArXiv ID:** 2511.04797
**Authors:** Jim James, Ben Wilson, Simon Lucey, James Hays
...
## 13. [No Pose Estimation? No Problem: Pose-Agnostic and Instance-Aware Test-Time Adaptation for Monocular Depth Estimation](https://arxiv.org/abs/2511.05055) <a id="link13"></a>
**ArXiv ID:** 2511.05055
**Authors:** Mingyu Sung, Hyeonmin Choe, Il-Min Kim, Sangseok Yun, Jae Mo Kang
...
## 14. [How Many Tokens Do 3D Point Cloud Transformer Architectures Really Need?](https://arxiv.org/abs/2511.05449) <a id="link14"></a>
**ArXiv ID:** 2511.05449
**Authors:** Tuan Anh Tran, Duy M. H. Nguyen, Hoai-Chau Tran, Michael Barz, Khoa D. Doan, Roger Wattenhofer, Ngo Anh Vien, Mathias Niepert, Daniel Sonntag, Paul Swoboda
...
## 15. [Learning Fourier shapes to probe the geometric world of deep neural networks](https://arxiv.org/abs/2511.04970) <a id="link15"></a>
**ArXiv ID:** 2511.04970
**Authors:** Jian Wang, Yixing Yong, Haixia Bi, Lijun He, Fan Li
...
## 16. [Semantic-Guided Natural Language and Visual Fusion for Cross-Modal Interaction Based on Tiny Object Detection](https://arxiv.org/abs/2511.05474) <a id="link16"></a>
**ArXiv ID:** 2511.05474
**Authors:** Xian-Hong Huang, Hui-Kai Su, Chi-Chia Sun, Jun-Wei Hsieh
...
## 17. [Medical Referring Image Segmentation via Next-Token Mask Prediction](https://arxiv.org/abs/2511.05044) <a id="link17"></a>
**ArXiv ID:** 2511.05044
**Authors:** Xinyu Chen, Yiran Wang, Gaoyang Pang, Jiafu Hao, Chentao Yue, Luping Zhou, Yonghui Li
...
## 18. [Real-World Adverse Weather Image Restoration via Dual-Level Reinforcement Learning with High-Quality Cold Start](https://arxiv.org/abs/2511.05095) <a id="link18"></a>
**ArXiv ID:** 2511.05095
**Authors:** Fuyang Liu, Jiaqi Xu, Xiaowei Hu
...
## 19. [SnowyLane: Robust Lane Detection on Snow-covered Rural Roads Using Infrastructural Elements](https://arxiv.org/abs/2511.05108) <a id="link19"></a>
**ArXiv ID:** 2511.05108
**Authors:** J\"org Gamerdinger, Benedict Wetzel, Patrick Schulz, Sven Teufel, Oliver Bringmann
...
## 20. [Pattern-Aware Diffusion Synthesis of fMRI/dMRI with Tissue and Microstructural Refinement](https://arxiv.org/abs/2511.04963) <a id="link20"></a>
**ArXiv ID:** 2511.04963
**Authors:** Xiongri Shen, Jiaqi Wang, Yi Zhong, Zhenxi Song, Leilei Zhao, Yichen Wei, Lingyan Liang, Shuqiang Wang, Baiying Lei, Demao Deng, Zhiguo Zhang
...
## 21. [Splatography: Sparse multi-view dynamic Gaussian Splatting for filmmaking challenges](https://arxiv.org/abs/2511.05152) <a id="link21"></a>
**ArXiv ID:** 2511.05152
**Authors:** Adrian Azzarelli, Nantheera Anantrasirichai, David R Bull
...
## 22. [From Linear Probing to Joint-Weighted Token Hierarchy: A Foundation Model Bridging Global and Cellular Representations in Biomarker Detection](https://arxiv.org/abs/2511.05150) <a id="link22"></a>
**ArXiv ID:** 2511.05150
**Authors:** Jingsong Liu, Han Li, Nassir Navab, Peter J. Sch\"uffler
...
## 23. [$\mathbf{S^2LM}$: Towards Semantic Steganography via Large Language Models](https://arxiv.org/abs/2511.05319) <a id="link23"></a>
**ArXiv ID:** 2511.05319
**Authors:** Huanqi Wu, Huangbiao Xu, Runfeng Xie, Jiaxin Cai, Kaixin Zhang, Xiao Ke
...
## 24. [MUSE: Multi-Scale Dense Self-Distillation for Nucleus Detection and Classification](https://arxiv.org/abs/2511.05170) <a id="link24"></a>
**ArXiv ID:** 2511.05170
**Authors:** Zijiang Yang, Hanqing Chao, Bokai Zhao, Yelin Yang, Yunshuo Zhang, Dongmei Fu, Junping Zhang, Le Lu, Ke Yan, Dakai Jin, Minfeng Xu, Yun Bian, Hui Jiang
...
## 25. [GSE: Evaluating Sticker Visual Semantic Similarity via a General Sticker Encoder](https://arxiv.org/abs/2511.04977) <a id="link25"></a>
**ArXiv ID:** 2511.04977
**Authors:** Heng Er Metilda Chee, Jiayin Wang, Zhiqiang Guo, Weizhi Ma, Min Zhang
...
## 26. [The Potential of Copernicus Satellites for Disaster Response: Retrieving Building Damage from Sentinel-1 and Sentinel-2](https://arxiv.org/abs/2511.05461) <a id="link26"></a>
**ArXiv ID:** 2511.05461
**Authors:** Olivier Dietrich, Merlin Alfredsson, Emilia Arens, Nando Metzger, Torben Peters, Linus Scheibenreif, Jan Dirk Wegner, Konrad Schindler
...
## 27. [Global 3D Reconstruction of Clouds & Tropical Cyclones](https://arxiv.org/abs/2511.04773) <a id="link27"></a>
**ArXiv ID:** 2511.04773
**Authors:** Shirin Ermis, Cesar Aybar, Lilli Freischem, Stella Girtsou, Kyriaki-Margarita Bintsi, Emiliano Diaz Salas-Porras, Michael Eisinger, William Jones, Anna Jungbluth, Benoit Tremblay
...
## 28. [A Dual-stage Prompt-driven Privacy-preserving Paradigm for Person Re-Identification](https://arxiv.org/abs/2511.05092) <a id="link28"></a>
**ArXiv ID:** 2511.05092
**Authors:** Ruolin Li, Min Liu, Yuan Bian, Zhaoyang Li, Yuzhen Li, Xueping Wang, Yaonan Wang
...
## 29. [CLM: Removing the GPU Memory Barrier for 3D Gaussian Splatting](https://arxiv.org/abs/2511.04951) <a id="link29"></a>
**ArXiv ID:** 2511.04951
**Authors:** Hexu Zhao, Xiwen Min, Xiaoteng Liu, Moonjun Gong, Yiming Li, Ang Li, Saining Xie, Jinyang Li, Aurojit Panda
...
## 30. [EventFlow: Real-Time Neuromorphic Event-Driven Classification of Two-Phase Boiling Flow Regimes](https://arxiv.org/abs/2511.05467) <a id="link30"></a>
**ArXiv ID:** 2511.05467
**Authors:** Sanghyeon Chang, Srikar Arani, Nishant Sai Nuthalapati, Youngjoon Suh, Nicholas Choi, Siavash Khodakarami, Md Rakibul Hasan Roni, Nenad Miljkovic, Aparna Chandramowlishwaran, Yoonjin Won
...
## 31. [Dynamic Residual Encoding with Slide-Level Contrastive Learning for End-to-End Whole Slide Image Representation](https://arxiv.org/abs/2511.05034) <a id="link31"></a>
**ArXiv ID:** 2511.05034
**Authors:** Jing Jin, Xu Liu, Te Gao, Zhihong Shi, Yixiong Liang, Ruiqing Zheng, Hulin Kuang, Min Zeng, Shichao Kan
...
## 32. [Deep learning models are vulnerable, but adversarial examples are even more vulnerable](https://arxiv.org/abs/2511.05073) <a id="link32"></a>
**ArXiv ID:** 2511.05073
**Authors:** Jun Li, Yanwei Xu, Keran Li, Xiaoli Zhang
...
## 33. [Geometry Denoising with Preferred Normal Vectors](https://arxiv.org/abs/2511.04848) <a id="link33"></a>
**ArXiv ID:** 2511.04848
**Authors:** Manuel Wei{\ss}, Lukas Baumg\"artner, Roland Herzog, Stephan Schmidt
...
## 34. [Learning to Restore Multi-Degraded Images via Ingredient Decoupling and Task-Aware Path Adaptation](https://arxiv.org/abs/2511.04920) <a id="link34"></a>
**ArXiv ID:** 2511.04920
**Authors:** Hu Gao, Xiaoning Lei, Ying Zhang, Xichen Xu, Guannan Jiang, Lizhuang Ma
...
## 35. [Data Efficiency and Transfer Robustness in Biomedical Image Segmentation: A Study of Redundancy and Forgetting with Cellpose](https://arxiv.org/abs/2511.04803) <a id="link35"></a>
**ArXiv ID:** 2511.04803
**Authors:** Shuo Zhao, Jianxu Chen
...
## 36. [AI Assisted AR Assembly: Object Recognition and Computer Vision for Augmented Reality Assisted Assembly](https://arxiv.org/abs/2511.05394) <a id="link36"></a>
**ArXiv ID:** 2511.05394
**Authors:** Alexander Htet Kyaw, Haotian Ma, Sasa Zivkovic, Jenny Sabin
...
## 37. [DMA: Online RAG Alignment with Human Feedback](https://arxiv.org/abs/2511.04880) <a id="link37"></a>
**ArXiv ID:** 2511.04880
**Authors:** Yu Bai, Yukai Miao, Dawei Wang, Li Chen, Fei Long, Rundi Zhai, Dan Li, Yanyu Ren, Tianfeng Liu, Hongtao Xie, Ce Yang, Xuhui Cai
...
## 38. [Cross-domain EEG-based Emotion Recognition with Contrastive Learning](https://arxiv.org/abs/2511.05293) <a id="link38"></a>
**ArXiv ID:** 2511.05293
**Authors:** Rui Yan, Yibo Li, Han Ding, Fei Wang
...
## 39. [Sharing the Learned Knowledge-base to Estimate Convolutional Filter Parameters for Continual Image Restoration](https://arxiv.org/abs/2511.05421) <a id="link39"></a>
**ArXiv ID:** 2511.05421
**Authors:** Aupendu Kar, Krishnendu Ghosh, Prabir Kumar Biswas
...
## 40. [Reasoning Is All You Need for Urban Planning AI](https://arxiv.org/abs/2511.05375) <a id="link40"></a>
**ArXiv ID:** 2511.05375
**Authors:** Sijie Yang, Jiatong Li, Filip Biljecki
