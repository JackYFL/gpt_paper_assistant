# Personalized Daily ArXiv Papers 04/21/2026
...
0. [SpatialImaginer: Towards Adaptive Visual Imagination for Spatial Reasoning](#link0)
**Authors:** Yian Li, Yang Jiao, Bin Zhu, Tianwen Qian, Shaoxiang Chen, Jingjing Chen, Yu-Gang Jiang

1. [Q-DeepSight: Incentivizing Thinking with Images for Image Quality Assessment and Refinement](#link1)
**Authors:** Xudong Li, Jiaxi Tan, Ziyin Zhou, Yan Zhong, Zihao Huang, Jingyuan Zheng, Yan Zhang, Xiawu Zheng, Rongrong Ji

2. [TSM-Pose: Topology-Aware Learning with Semantic Mamba for Category-Level Object Pose Estimation](#link2)
**Authors:** Jinshuo Liu, Bingtao Ma, Junlin Su, Guanyuan Pan, Beining Wu, Cheng Yang, Jiaxuan Lu, Chenggang Yan, Shuai Wang

3. [Source-Free Domain Adaptation with Vision-Language Prior](#link3)
**Authors:** Song Tang, Yunxiang Bai, Wenxin Su, Mao Ye, Jianwei Zhang, Xiatian Zhu

4. [Prompting Foundation Models for Zero-Shot Ship Instance Segmentation in SAR Imagery](#link4)
**Authors:** Islam Mansour, Francescopaolo Sica, Michael Schmitt

5. [Training LLM Agents for Spontaneous, Reward-Free Self-Evolution via World Knowledge Exploration](#link5)
**Authors:** Qifan Zhang, Dongyang Ma, Tianqing Fang, Jia Li, Jing Tang, Nuo Chen, Haitao Mi, Yan Wang

6. [LIVE: Leveraging Image Manipulation Priors for Instruction-based Video Editing](#link6)
**Authors:** Weicheng Wang, Zhicheng Zhang, Zhongqi Zhang, Juncheng Zhou, Yongjie Zhu, Wenyu Qin, Meng Wang, Pengfei Wan, Jufeng Yang

7. [TowerDataset: A Heterogeneous Benchmark for Transmission Corridor Segmentation with a Global-Local Fusion Framework](#link7)
**Authors:** Xu Cui, Xinyan Liu, Chen Yang, Zhaobo Qi, Beichen Zang, Weigang Zhang, Antoni B. Chan

8. [LiteResearcher: A Scalable Agentic RL Training Framework for Deep Research Agent](#link8)
**Authors:** Wanli Li, Bince Qu, Bo Pan, Jianyu Zhang, Zheng Liu, Pan Zhang, Wei Chen, Bo Zhang

9. [DVAR: Adversarial Multi-Agent Debate for Video Authenticity Detection](#link9)
**Authors:** Hongyuan Qi, Feifei Shao, Ming Li, Hehe Fan, Jun Xiao

10. [Understanding Human Actions through the Lens of Executable Models](#link10)
**Authors:** Rimvydas Rubavicius, Manisha Dubey, N. Siddharth, Subramanian Ramamoorthy

11. [Test-Time Perturbation Learning with Delayed Feedback for Vision-Language-Action Models](#link11)
**Authors:** Zehua Zang, Xi Wang, Fuchun Sun, Xiao Xu, Lixiang Lium, Jiahuan Zhou, Jiangmeng Li

12. [Advancing Vision Transformer with Enhanced Spatial Priors](#link12)
**Authors:** Qihang Fan, Huaibo Huang, Mingrui Chen, Hongmin Liu, Ran He

13. [When Vision-Language Models Judge Without Seeing: Exposing Informativeness Bias](#link13)
**Authors:** Xiaohan Zou, Roshan Sridhar, Mohammadtaher Safarzadeh, Dan Roth

14. [Motif-Video 2B: Technical Report](#link14)
...
15. [ReCap: Lightweight Referential Grounding for Coherent Story Visualization](#link15)
**Authors:** Aditya Arora, Akshita Gupta, Pau Rodriguez, Marcus Rohrbach

16. [Positioning radiata pine branches requiring pruning by drone stereo vision](#link16)
**Authors:** Yida Lin, Bing Xue, Mengjie Zhang, Sam Schofield, Richard Green

17. [Frequency-guided Multi-level Reasoning for Scene Graph Generation in Video](#link17)
**Authors:** Chenxing Li, Yiping Duan, Xiaoming Tao

18. [HQA-VLAttack: Towards High Quality Adversarial Attack on Vision-Language Pre-Trained Models](#link18)
**Authors:** Han Liu, Jiaqi Li, Zhi Xu, Xiaotong Zhang, Xiaoming Xu, Fenglong Ma, Yuanman Li, Hong Yu

19. [ViPS: Video-informed Pose Spaces for Auto-Rigged Meshes](#link19)
...
20. [Adverse-to-the-eXtreme Panoptic Segmentation: URVIS 2026 Study and Benchmark](#link20)
**Authors:** Yiting Wang, Nolwenn Peyratout, Tim Brodermann, Jiahui Wang, Yusi Cao, Michele Cazzola, Elie Tarassov, Takuya Kobayashi, Abderrahim Kasmi, Guillaume Allibert, C\'edric Demonceaux, Valentina Donzella, Kurt Debattista, Radu Timofte, Zongwei Wu, Christos Sakaridis

21. [DreamShot: Personalized Storyboard Synthesis with Video Diffusion Prior](#link21)
**Authors:** Junjia Huang, Binbin Yang, Pengxiang Yan, Jiyang Liu, Bin Xia, Zhao Wang, Yitong Wang, Liang Lin, Guanbin Li

22. [Soft Label Pruning and Quantization for Large-Scale Dataset Distillation](#link22)
**Authors:** Xiao Lingao, Yang He

23. [A Benchmark Study of Segmentation Models and Adaptation Strategies for Landslide Detection from Satellite Imagery](#link23)
**Authors:** Md Kowsher, Weiwei Zhan, Chen Chen

24. [TeMuDance: Contrastive Alignment-Based Textual Control for Music-Driven Dance Generation](#link24)
**Authors:** Xinran Liu, Diptesh Kanojia, Wenwu Wang, Zhenhua Feng

25. [NTIRE 2026 Rip Current Detection and Segmentation (RipDetSeg) Challenge Report](#link25)
...
26. [Channel Attention-Guided Cross-Modal Knowledge Distillation for Referring Image Segmentation](#link26)
**Authors:** Chen Yang

27. [Training-inference input alignment outweighs framework choice in longitudinal retinal image prediction](#link27)
**Authors:** Liyin Chen, Nazlee Zebardast, Mengyu Wang, Tobias Elze, Jason I. Comander

28. [EvoMaster: A Foundational Agent Framework for Building Evolving Autonomous Scientific Agents at Scale](#link28)
...
29. [Fractal Characterization of Low-Correlation Signals in AI-Generated Image Detection](#link29)
**Authors:** Wenwei Xie, Jie Yin, Lu Ma, Xuansong Zhang, Wenjing Zhang

30. [Low Light Image Enhancement Challenge at NTIRE 2026](#link30)
...
31. [The First Challenge on Mobile Real-World Image Super-Resolution at NTIRE 2026: Benchmark Results and Method Overview](#link31)
...
32. [Unveiling Deepfakes: A Frequency-Aware Triple Branch Network for Deepfake Detection](#link32)
**Authors:** Qihao Shen, Jiaxing Xuan, Zhenguang Liu, Sifan Wu, Yutong Xie, Zhaoyan Ming, Yingying Jiao, kui Ren

33. [OGER: A Robust Offline-Guided Exploration Reward for Hybrid Reinforcement Learning](#link33)
**Authors:** Xinyu Ma, Mingzhou Xu, Xuebo Liu, Chang Jin, Qiang Wang, Derek F. Wong, Min Zhang

34. [From Clinical Intent to Clinical Model: An Autonomous Coding-Agent Framework for Clinician-driven AI Development](#link34)
**Authors:** Zihao Zhao, Frederik Hauke, Juliana De Castilhos, Jakob Nikolas Kather, Sven Nebelung, Daniel Truhn

---
## 0. [SpatialImaginer: Towards Adaptive Visual Imagination for Spatial Reasoning](https://arxiv.org/abs/2604.17385) <a id="link0"></a>
**ArXiv ID:** 2604.17385
**Authors:** Yian Li, Yang Jiao, Bin Zhu, Tianwen Qian, Shaoxiang Chen, Jingjing Chen, Yu-Gang Jiang
...
**Comment:** This paper proposes SpatialImaginer, a new framework for adaptive visual imagination in spatial reasoning, integrating textual reasoning with visual imagination. It directly matches criterion 1 (methodological improvements to spatial understanding/spatial intelligence on embodied agents) and criterion 2 (MLLMs), and is highly relevant for spatial intelligence in multi-modal models.
**Relevance:** 10
**Novelty:** 8

---

## 1. [Q-DeepSight: Incentivizing Thinking with Images for Image Quality Assessment and Refinement](https://arxiv.org/abs/2604.16858) <a id="link1"></a>
**ArXiv ID:** 2604.16858
**Authors:** Xudong Li, Jiaxi Tan, Ziyin Zhou, Yan Zhong, Zihao Huang, Jingyuan Zheng, Yan Zhang, Xiawu Zheng, Rongrong Ji
...
**Comment:** Matches criterion 2 (MLLMs) and criterion 4 (vision foundation models and applications). Proposes a multimodal chain-of-thought framework for image quality assessment and refinement, with new RL-based training techniques and practical applications in generative image enhancement.
**Relevance:** 9
**Novelty:** 8

---

## 2. [TSM-Pose: Topology-Aware Learning with Semantic Mamba for Category-Level Object Pose Estimation](https://arxiv.org/abs/2604.16954) <a id="link2"></a>
**ArXiv ID:** 2604.16954
**Authors:** Jinshuo Liu, Bingtao Ma, Junlin Su, Guanyuan Pan, Beining Wu, Cheng Yang, Jiaxuan Lu, Chenggang Yan, Shuai Wang
...
**Comment:** This paper proposes TSM-Pose, a new method for category-level object pose estimation, directly addressing criterion 1 (methodological improvements to spatial understanding on embodied agents). The use of topology-aware learning and semantic Mamba is a novel approach.
**Relevance:** 10
**Novelty:** 7

---

## 3. [Source-Free Domain Adaptation with Vision-Language Prior](https://arxiv.org/abs/2604.17748) <a id="link3"></a>
**ArXiv ID:** 2604.17748
**Authors:** Song Tang, Yunxiang Bai, Wenxin Su, Mao Ye, Jianwei Zhang, Xiatian Zhu
...
**Comment:** Matches criterion 2: proposes a new method leveraging vision-language large models (CLIP) for source-free domain adaptation, with a novel mutual information-based adaptation and knowledge distillation approach.
**Relevance:** 9
**Novelty:** 7

---

## 4. [Prompting Foundation Models for Zero-Shot Ship Instance Segmentation in SAR Imagery](https://arxiv.org/abs/2604.17920) <a id="link4"></a>
**ArXiv ID:** 2604.17920
**Authors:** Islam Mansour, Francescopaolo Sica, Michael Schmitt
...
**Comment:** This paper explores prompting vision foundation models (SAM2) for zero-shot ship instance segmentation in SAR imagery, directly addressing criterion 4 (vision foundation models and applications). The use of foundation models for annotation-free segmentation is a novel application.
**Relevance:** 9
**Novelty:** 7

---

## 5. [Training LLM Agents for Spontaneous, Reward-Free Self-Evolution via World Knowledge Exploration](https://arxiv.org/abs/2604.18131) <a id="link5"></a>
**ArXiv ID:** 2604.18131
**Authors:** Qifan Zhang, Dongyang Ma, Tianqing Fang, Jia Li, Jing Tang, Nuo Chen, Haitao Mi, Yan Wang
...
**Comment:** This paper introduces a new method for training LLM agents to self-evolve via world knowledge exploration, which is relevant to criterion 1 (methodological improvements to spatial understanding/spatial intelligence on embodied agents) and criterion 3 (novel methods for embodied agents). The focus on reward-free, spontaneous adaptation is a novel angle.
**Relevance:** 8
**Novelty:** 8

---

## 6. [LIVE: Leveraging Image Manipulation Priors for Instruction-based Video Editing](https://arxiv.org/abs/2604.17021) <a id="link6"></a>
**ArXiv ID:** 2604.17021
**Authors:** Weicheng Wang, Zhicheng Zhang, Zhongqi Zhang, Juncheng Zhou, Yongjie Zhu, Wenyu Qin, Meng Wang, Pengfei Wan, Jufeng Yang
...
**Comment:** Matches criterion 4: presents a new framework (LIVE) for instruction-based video editing using vision foundation models and large-scale image editing priors, with a novel frame-wise token noise strategy.
**Relevance:** 8
**Novelty:** 7

---

## 7. [TowerDataset: A Heterogeneous Benchmark for Transmission Corridor Segmentation with a Global-Local Fusion Framework](https://arxiv.org/abs/2604.16848) <a id="link7"></a>
**ArXiv ID:** 2604.16848
**Authors:** Xu Cui, Xinyan Liu, Chen Yang, Zhaobo Qi, Beichen Zang, Weigang Zhang, Antoni B. Chan
...
**Comment:** Matches criterion 3: introduces a new benchmark (TowerDataset) for spatial understanding in transmission-corridor segmentation, with a novel global-local fusion framework for embodied AI-like tasks. Also relevant to criterion 1 due to spatial intelligence aspects.
**Relevance:** 8
**Novelty:** 7

---

## 8. [LiteResearcher: A Scalable Agentic RL Training Framework for Deep Research Agent](https://arxiv.org/abs/2604.17931) <a id="link8"></a>
**ArXiv ID:** 2604.17931
**Authors:** Wanli Li, Bince Qu, Bo Pan, Jianyu Zhang, Zheng Liu, Pan Zhang, Wei Chen, Bo Zhang
...
**Comment:** Matches criterion 3 (embodied AI, new RL training framework for agentic research agents, with a novel simulator/virtual world for scalable RL).
**Relevance:** 8
**Novelty:** 7

---

## 9. [DVAR: Adversarial Multi-Agent Debate for Video Authenticity Detection](https://arxiv.org/abs/2604.16987) <a id="link9"></a>
**ArXiv ID:** 2604.16987
**Authors:** Hongyuan Qi, Feifei Shao, Ming Li, Hehe Fan, Jun Xiao
...
**Comment:** Matches criterion 2 (multi-agent debate using generative and natural mechanism agents for video authenticity, leveraging reasoning in a vision-language context). Also relevant to criterion 4 (application of reasoning to vision foundation models).
**Relevance:** 8
**Novelty:** 7

---

## 10. [Understanding Human Actions through the Lens of Executable Models](https://arxiv.org/abs/2604.18064) <a id="link10"></a>
**ArXiv ID:** 2604.18064
**Authors:** Rimvydas Rubavicius, Manisha Dubey, N. Siddharth, Subramanian Ramamoorthy
...
**Comment:** This paper introduces a neuro-symbolic executable model for understanding human actions, using a domain-specific language for motion programs. This is relevant to criterion 1 (spatial understanding and intelligence in embodied agents) and criterion 3 (novel methods for embodied AI).
**Relevance:** 8
**Novelty:** 7

---

## 11. [Test-Time Perturbation Learning with Delayed Feedback for Vision-Language-Action Models](https://arxiv.org/abs/2604.18107) <a id="link11"></a>
**ArXiv ID:** 2604.18107
**Authors:** Zehua Zang, Xi Wang, Fuchun Sun, Xiao Xu, Lixiang Lium, Jiahuan Zhou, Jiangmeng Li
...
**Comment:** This paper introduces a new test-time adaptation framework for Vision-Language-Action models, relevant to criterion 3 (new methods for embodied AI, especially in multimodal decision-making agents). The delayed feedback and perturbation learning are novel techniques.
**Relevance:** 8
**Novelty:** 7

---

## 12. [Advancing Vision Transformer with Enhanced Spatial Priors](https://arxiv.org/abs/2604.18549) <a id="link12"></a>
**ArXiv ID:** 2604.18549
**Authors:** Qihang Fan, Huaibo Huang, Mingrui Chen, Hongmin Liu, Ran He
...
**Comment:** This paper proposes EVT, a Vision Transformer variant with explicit spatial priors, improving spatial relationship modeling. It is relevant to criterion 4 (vision foundation models and applications) and criterion 1 (spatial understanding in vision models).
**Relevance:** 8
**Novelty:** 7

---

## 13. [When Vision-Language Models Judge Without Seeing: Exposing Informativeness Bias](https://arxiv.org/abs/2604.17768) <a id="link13"></a>
**ArXiv ID:** 2604.17768
**Authors:** Xiaohan Zou, Roshan Sridhar, Mohammadtaher Safarzadeh, Dan Roth
...
**Comment:** This paper analyzes and addresses informativeness bias in VLM-as-a-Judge systems, proposing a new judging paradigm (BIRCH). It is directly relevant to criterion 2 (VLLMs/MLLMs) and provides surprising empirical insights into VLM behavior.
**Relevance:** 8
**Novelty:** 7

---

## 14. [Motif-Video 2B: Technical Report](https://arxiv.org/abs/2604.16503) <a id="link14"></a>
**ArXiv ID:** 2604.16503
**Authors:** Junghwan Lim, Wai Ting Cheung, Minsu Ha, Beomgyu Kim, Taewhan Kim, Haesol Lee, Dongpin Oh, Jeesoo Lee, Taehyun Kim, Minjae Kim, Sungmin Lee, Hyeyeon Cho, Dahye Choi, Jaeheui Her, Jaeyeon Huh, Hanbin Jung, Changjin Kang, Dongseok Kim, Jangwoong Kim, Youngrok Kim, Hyukjin Kweon, Hongjoo Lee, Jeongdoo Lee, Junhyeok Lee, Eunhwan Park, Yeongjae Park, Bokki Ryu, Dongjoo Weon
...
**Comment:** Motif-Video 2B introduces architectural innovations for efficient text-to-video generation, focusing on prompt alignment, temporal consistency, and detail recovery. This is relevant to criterion 4 (vision foundation models and applications) and generative modeling in multi-modal learning.
**Relevance:** 7
**Novelty:** 8

---

## 15. [ReCap: Lightweight Referential Grounding for Coherent Story Visualization](https://arxiv.org/abs/2604.18575) <a id="link15"></a>
**ArXiv ID:** 2604.18575
**Authors:** Aditya Arora, Akshita Gupta, Pau Rodriguez, Marcus Rohrbach
...
**Comment:** Matches criterion 4: proposes a lightweight referential grounding method for story visualization, improving visual consistency in multi-frame generative models. Also relevant to multi-modal generative modeling.
**Relevance:** 7
**Novelty:** 7

---

## 16. [Positioning radiata pine branches requiring pruning by drone stereo vision](https://arxiv.org/abs/2604.16480) <a id="link16"></a>
**ArXiv ID:** 2604.16480
**Authors:** Yida Lin, Bing Xue, Mengjie Zhang, Sam Schofield, Richard Green
...
**Comment:** Matches criterion 1 (spatial understanding on embodied agents; drone stereo vision for branch localization and pruning). Presents a new pipeline for spatial perception in an embodied agent (drone) context.
**Relevance:** 8
**Novelty:** 6

---

## 17. [Frequency-guided Multi-level Reasoning for Scene Graph Generation in Video](https://arxiv.org/abs/2604.17298) <a id="link17"></a>
**ArXiv ID:** 2604.17298
**Authors:** Chenxing Li, Yiping Duan, Xiaoming Tao
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a new model for video scene graph generation with novel statistical tricks for handling long-tail distributions and uncertainty estimation.
**Relevance:** 7
**Novelty:** 7

---

## 18. [HQA-VLAttack: Towards High Quality Adversarial Attack on Vision-Language Pre-Trained Models](https://arxiv.org/abs/2604.16499) <a id="link18"></a>
**ArXiv ID:** 2604.16499
**Authors:** Han Liu, Jiaqi Li, Zhi Xu, Xiaotong Zhang, Xiaoming Xu, Fenglong Ma, Yuanman Li, Hong Yu
...
**Comment:** Matches criterion 2 (new methods for attacking vision-language pre-trained models, which are a type of VLLM/MLLM). The paper proposes a new adversarial attack framework for vision-language models, with both image and text perturbations, and introduces novel techniques for both modalities.
**Relevance:** 7
**Novelty:** 6

---

## 19. [ViPS: Video-informed Pose Spaces for Auto-Rigged Meshes](https://arxiv.org/abs/2604.17623) <a id="link19"></a>
**ArXiv ID:** 2604.17623
**Authors:** Honglin Chen, Karran Pandey, Rundi Wu, Matheus Gadelha, Yannick Hold-Geoffroy, Ayush Tewari, Niloy J. Mitra, Changxi Zheng, Paul Guerrero
...
**Comment:** ViPS introduces a framework for learning plausible pose spaces for auto-rigged meshes using video diffusion priors, bridging 2D generative priors and 3D kinematic control. This is relevant to criterion 4 (vision foundation models and applications) and generative modeling in multi-modal learning.
**Relevance:** 6
**Novelty:** 7

---

## 20. [Adverse-to-the-eXtreme Panoptic Segmentation: URVIS 2026 Study and Benchmark](https://arxiv.org/abs/2604.16984) <a id="link20"></a>
**ArXiv ID:** 2604.16984
**Authors:** Yiting Wang, Nolwenn Peyratout, Tim Brodermann, Jiahui Wang, Yusi Cao, Michele Cazzola, Elie Tarassov, Takuya Kobayashi, Abderrahim Kasmi, Guillaume Allibert, C\'edric Demonceaux, Valentina Donzella, Kurt Debattista, Radu Timofte, Zongwei Wu, Christos Sakaridis
...
**Comment:** This paper presents a new benchmark and challenge for panoptic segmentation in adverse weather using multi-sensor data, which matches criterion 3 (new benchmarks for embodied AI, simulator-related, novel angles).
**Relevance:** 7
**Novelty:** 6

---

## 21. [DreamShot: Personalized Storyboard Synthesis with Video Diffusion Prior](https://arxiv.org/abs/2604.17195) <a id="link21"></a>
**ArXiv ID:** 2604.17195
**Authors:** Junjia Huang, Binbin Yang, Pengxiang Yan, Jiyang Liu, Bin Xia, Zhao Wang, Yitong Wang, Liang Lin, Guanbin Li
...
**Comment:** This paper introduces a new video generative model for storyboard synthesis, leveraging video diffusion priors for spatial-temporal consistency and controllable multi-shot generation. It is relevant to criterion 4 (vision foundation models and applications) and generative modeling in multi-modal learning.
**Relevance:** 6
**Novelty:** 7

---

## 22. [Soft Label Pruning and Quantization for Large-Scale Dataset Distillation](https://arxiv.org/abs/2604.18135) <a id="link22"></a>
**ArXiv ID:** 2604.18135
**Authors:** Xiao Lingao, Yang He
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes new methods for dataset distillation, which is relevant for training vision foundation models more efficiently.
**Relevance:** 6
**Novelty:** 6

---

## 23. [A Benchmark Study of Segmentation Models and Adaptation Strategies for Landslide Detection from Satellite Imagery](https://arxiv.org/abs/2604.16663) <a id="link23"></a>
**ArXiv ID:** 2604.16663
**Authors:** Md Kowsher, Weiwei Zhan, Chen Chen
...
**Comment:** Matches criterion 4 (vision foundation models and their applications). Systematic benchmarking of segmentation models, including large pre-trained foundation models, for landslide detection from satellite imagery.
**Relevance:** 7
**Novelty:** 5

---

## 24. [TeMuDance: Contrastive Alignment-Based Textual Control for Music-Driven Dance Generation](https://arxiv.org/abs/2604.17005) <a id="link24"></a>
**ArXiv ID:** 2604.17005
**Authors:** Xinran Liu, Diptesh Kanojia, Wenwu Wang, Zhenhua Feng
...
**Comment:** This paper proposes a new framework for text-based control in music-driven dance generation using cross-modal alignment, which is a novel multi-modal generative modeling approach. It is relevant to criterion 2 (new MLLMs) and generative modeling in multi-modal learning.
**Relevance:** 5
**Novelty:** 7

---

## 25. [NTIRE 2026 Rip Current Detection and Segmentation (RipDetSeg) Challenge Report](https://arxiv.org/abs/2604.17070) <a id="link25"></a>
**ArXiv ID:** 2604.17070
**Authors:** Andrei Dumitriu, Aakash Ralhan, Florin Miron, Florin Tatui, Radu Tudor Ionescu, Radu Timofte, Abdullah Naeem, Anav Katwal, Ayon Dey, Md Tamjidul Hoque, Asuka Shin, Hiroto Shirono, Kosuke Shigematsu, Gaurav Mahesh, Anjana Nanditha, Jiji CV, Akbarali Vakhitov, Sang-Chul Lee, Xinger Li, Chun'an Yu, Junhao Chen, Yang Yang, Gundluri Yuvateja Reddy, Harshitha Palaram, Gejalakshmi N, Jeevitha S, Jiachen Tu, Guoyi Xu, Yaoxin Jiang, Jiajia Liu, Yaokun Shi, Amitabh Tripathi, Modugumudi Mahesh, Santosh Kumar Vipparthi, Subrahmanyam Murala
...
**Comment:** This paper introduces a new benchmark and challenge for rip current detection and segmentation, which is relevant to criterion 3 (new benchmarks in vision). It also discusses the use of vision foundation models (criterion 4).
**Relevance:** 6
**Novelty:** 5

---

## 26. [Channel Attention-Guided Cross-Modal Knowledge Distillation for Referring Image Segmentation](https://arxiv.org/abs/2604.16806) <a id="link26"></a>
**ArXiv ID:** 2604.16806
**Authors:** Chen Yang
...
**Comment:** This paper proposes a channel attention-guided cross-modal knowledge distillation method for referring image segmentation, which is relevant to criterion 2 (multi-modal large language models) and criterion 4 (vision foundation models and applications), as it deals with cross-modal learning and efficient deployment.
**Relevance:** 6
**Novelty:** 5

---

## 27. [Training-inference input alignment outweighs framework choice in longitudinal retinal image prediction](https://arxiv.org/abs/2604.16955) <a id="link27"></a>
**ArXiv ID:** 2604.16955
**Authors:** Liyin Chen, Nazlee Zebardast, Mengyu Wang, Tobias Elze, Jason I. Comander
...
**Comment:** Does not directly match any specific criterion, but is relevant to generative modeling in medical imaging. Shows an insightful empirical result about the importance of training-inference alignment over model complexity.
**Relevance:** 4
**Novelty:** 6

---

## 28. [EvoMaster: A Foundational Agent Framework for Building Evolving Autonomous Scientific Agents at Scale](https://arxiv.org/abs/2604.17406) <a id="link28"></a>
**ArXiv ID:** 2604.17406
**Authors:** Xinyu Zhu, Yuzhu Cai, Zexi Liu, Cheng Wang, Fengyang Li, Wenkai Jin, Wanxu Liu, Zehao Bing, Bingyang Zheng, Jingyi Chai, Shuo Tang, Rui Ye, Yuwen Du, Xianghe Pang, Yaxin Du, Tingjia Miao, Yuzhi Zhang, Ruoxue Liao, Zhaohan Ding, Linfeng Zhang, Yanfeng Wang, Weinan E, Siheng Chen
...
**Comment:** Does not directly match any criterion. Focuses on agent frameworks for scientific discovery, not specifically spatial intelligence, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models.
**Relevance:** 3
**Novelty:** 7

---

## 29. [Fractal Characterization of Low-Correlation Signals in AI-Generated Image Detection](https://arxiv.org/abs/2604.17268) <a id="link29"></a>
**ArXiv ID:** 2604.17268
**Authors:** Wenwei Xie, Jie Yin, Lu Ma, Xuansong Zhang, Wenjing Zhang
...
**Comment:** Does not directly match any specific criterion, but is relevant to computer vision and generative modeling (deepfake detection using fractal signal analysis).
**Relevance:** 3
**Novelty:** 6

---

## 30. [Low Light Image Enhancement Challenge at NTIRE 2026](https://arxiv.org/abs/2604.17669) <a id="link30"></a>
**ArXiv ID:** 2604.17669
**Authors:** George Ciubotariu, Sharif S M A, Abdur Rehman, Fayaz Ali Dharejo, Rizwan Ali Naqvi, Marcos V. Conde, Radu Timofte, Zhi Jin, Hongjun Wu, Wenjian Zhang, Chang Ye, Xunpeng Yi, Qinglong Yan, Yibing Zhang, Nikhil Akalwadi, Varda I Pattanshetty, Varsha I Pattanshetty, Padmashree Desai, Uma Mudenagudi, Ramesh Ashok Tabib, Hao Yang, Ruikun Zhang, Liyuan Pan, Furkan K{\i}nl{\i}, Donghun Ryou, Inju Ha, Junoh Kang, Bohyung Han, Wei Zhou, Yuval Haitman, Ariel Lapid, Reuven Peretz, Idit Diamant, Leilei Cao, Shuo Zhang, Praful Hambarde, Prateek Shaily, Jayant Kumar, Hardik Sharma, Aashish Negi, Sachin Chaudhary, Akshay Dudhane, Amit Shukla, MoHao Wu, Lin Wang, Jiachen Tu, Guoyi Xu, Yaoxin Jiang, Jiajia Liu, Yaokun Shi, Raul Balmez, Alexandru Brateanu, Ciprian Orhei, Cosmin Ancuti, Codruta O. Ancuti, Bilel Benjdira, Anas M. Ali, Wadii Boulila, Kaifan Qiao, Bofei Chen, Jingyi Xu, Duo Zhang, Xin Deng, Mai Xu, Shengxi Li, Lai Jiang, Harini A, Ananya N, Lakshanya K, Ying Xu, Xinyi Zhu, Shijun Shi, Jiangning Zhang, Yong Liu, Kai Hu, Jing Xu, Xianfang Zeng, Jinao Song, Guangsheng Tang, Cheng Li, Yuqiang Yang, Ziyi Wang, Yan Chen, Long Bao, Heng Sun, Mohab Kishawy, Jun Chen, Wan-Chi Siu, Yihao Cheng, Hon Man Hammond Lee, Chun-Chuen Hui
...
**Comment:** This is a challenge paper on low-light image enhancement, introducing a new dataset and benchmarking methods. It is relevant to criterion 3 (new benchmarks), but not specifically focused on embodied AI or spatial intelligence.
**Relevance:** 5
**Novelty:** 4

---

## 31. [The First Challenge on Mobile Real-World Image Super-Resolution at NTIRE 2026: Benchmark Results and Method Overview](https://arxiv.org/abs/2604.17306) <a id="link31"></a>
**ArXiv ID:** 2604.17306
**Authors:** Jiatong Li, Zheng Chen, Kai Liu, Jingkai Wang, Zihan Zhou, Xiaoyang Liu, Libo Zhu, Jue Gong, Radu Timofte, Yulun Zhang, Congyu Wang, Zihao Wang, Ke Wu, Xinzhe Zhu, Fengkai Zhang, Zhongbao Yang, Long Sun, Jiangxin Dong, Jinshan Pan, Jiachen Tu, Yaokun Shi, Guoyi Xu, Yaoxin Jiang, Jiajia Liu, Renyuan Situ, Yixin Yang, Zhaorun Zhou, Junyang Chen, Yuqi Li, Chuanguang Yang, Weilun Feng, Chuanyue Yan, Yuedong Tan, Yingli Tian, Zhenzhong Chen, Tongqi Guo, Ruhan Liu, Sangzi Shi, Huazhang Deng, Jie Yang, Wenzhuo Ma, Yuantong Zhang, Daiqin Yang, Tianrun Chen, Deyi Ji, Yuxiao Jiang, Qi Zhu, Lanyun Zhu, Yuwen Pan, Runze Tian, Mingyu Shi, Zhanfeng Feng, Yuanfei Bao, Jiaming Guo, Renjing Pei, Xin Di, Long Peng, Linfeng Jiang, Xueyang Fu, Yang Cao, Zhengjun Zha, Choulhyouc Lee, Shyang-En Weng, Yi-Cheng Liao, Jorge Tyrakowski, Yu-Syuan Xu, Wei-Chen Chiu, Ching-Chun Huang, Yoonjin Im, Jihye Park, Hyungju Chun, Hyunhee Park, MinKyu Park, Xiaoxuan Yu, Jianxing Zhang, Yuxuan Jiang, Chengxi Zeng, Tianhao Peng, Fan Zhang, David Bull, Watchara Ruangsang, Supavadee Aramvith, JiaHao Deng, Wei Zhou, Hongyu Huang, Shaohui Lin, Zihan Wang, Yilin Chen, Yunchen Li, Junbo Qiao, Wei Li, Jiao Xie, Gaoqi He, Wenxi Li
...
**Comment:** This paper presents a new benchmark and challenge for mobile real-world image super-resolution, which is relevant to criterion 3 (new benchmarks in vision, simulator-related). However, it is not focused on embodied AI or spatial intelligence, and does not introduce new methods for spatial understanding.
**Relevance:** 5
**Novelty:** 4

---

## 32. [Unveiling Deepfakes: A Frequency-Aware Triple Branch Network for Deepfake Detection](https://arxiv.org/abs/2604.17477) <a id="link32"></a>
**ArXiv ID:** 2604.17477
**Authors:** Qihao Shen, Jiaxing Xuan, Zhenguang Liu, Sifan Wu, Yutong Xie, Zhaoyan Ming, Yingying Jiao, kui Ren
...
**Comment:** This paper proposes a frequency-aware triple branch network for deepfake detection, focusing on spatial and frequency feature decoupling. While it is a vision paper with clever statistical tricks, it does not directly match any of the four criteria.
**Relevance:** 3
**Novelty:** 6

---

## 33. [OGER: A Robust Offline-Guided Exploration Reward for Hybrid Reinforcement Learning](https://arxiv.org/abs/2604.18530) <a id="link33"></a>
**ArXiv ID:** 2604.18530
**Authors:** Xinyu Ma, Mingzhou Xu, Xuebo Liu, Chang Jin, Qiang Wang, Derek F. Wong, Min Zhang
...
**Comment:** Does not directly match any criterion. The paper is about reinforcement learning with verifiable rewards for LLM reasoning, not spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 34. [From Clinical Intent to Clinical Model: An Autonomous Coding-Agent Framework for Clinician-driven AI Development](https://arxiv.org/abs/2604.17110) <a id="link34"></a>
**ArXiv ID:** 2604.17110
**Authors:** Zihao Zhao, Frederik Hauke, Juliana De Castilhos, Jakob Nikolas Kather, Sven Nebelung, Daniel Truhn
...
**Comment:** This paper presents an autonomous coding-agent framework for clinician-driven AI development. While it is an interesting application of LLM agents, it does not directly address any of the four criteria, as it is focused on clinical AI workflow automation.
**Relevance:** 3
**Novelty:** 5
