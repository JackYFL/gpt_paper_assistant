# Personalized Daily ArXiv Papers 08/06/2026
...
0. [Talk2Sensors: 3D Visual Grounding in Autonomous Driving via Sensor-Adaptive Physical Cue Matching](#link0)
...
1. [CARGO-VL: Counterfactual Arbitration with Risk-Constrained Group Optimization for Vision-Language Models](#link1)
**Authors:** De Jiang, Zhengyang Zhang, Kehong Yuan, Shaohua Ma

2. [ToolArtist: Tool-Using Unified Multimodal Models for Agentic Image Generation](#link2)
**Authors:** Jiahao Zhao, Xiaomin Yu, Zhongxiang Sun, Fengwei Teng, Chengwei Qin, Xiaobin Hu, Jun Xu, Shuicheng Yan

3. [SIGNPOST-Bench: Benchmarking Text-Vision Conflict Resolution in Multimodal Large Language Models](#link3)
**Authors:** Sirun Li, Minghao Liu, Ling Dai, Yong Li, Haoxin Lyu, Junting Zhou, Fan Zhang

4. [LoRetta: A Foundation Model and Extensive Dataset for Global-Scale Remote Sensing Dense Image Matching](#link4)
**Authors:** Siwei Yu, Han Guo, Zhenwei Shi, Zhengxia Zou

5. [WorldCycle: Self-Verifiable Reinforcement Learning for Long-Horizon Video World Models](#link5)
...
6. [MetaVideoAgent: Automated Video-Agent Evolution for Long-Form Video Understanding](#link6)
...
7. [The First EgoCross Challenge at EgoVis 2026: Cross-Domain Egocentric Video Question Answering](#link7)
...
8. [ContextMaster: Interactive Multi-Shot Video Creation via Fixed-Budget Sparse Context Routing](#link8)
...
9. [RegisterBridgeMM: A Register-Centric Framework for RGB-Infrared Object Detection](#link9)
**Authors:** Zian Wang, Hangchuan Liang, Yuehua Chen, Changchun Li, Chaoyi Guo, Mingzhe Liu, Fangming Gu

10. [COSMO: Consensus-Driven Shift Modulation for Source-Free Domain Adaptation](#link10)
**Authors:** Bo Li, Junjie Peng, Xiaohua Xie, Jianhuang Lai

11. [FocusMem: Factorizing Content, Readout, and Trust in Latent GUI Memory](#link11)
**Authors:** Zhuoran Zhang, Bowen Li, Jingcheng Ju, Yang Shi, Qixun Wang, Haotian Wang, Wei Chen, Tengjiao Wang

12. [DIVE: Dynamic Iterative Visual Evidence Construction for Efficient Vision-Language Models](#link12)
**Authors:** Chen Zhong, Xiao An, Zijie Wang, Jiepan Li, Guangyi Yang, Wei He

13. [CoCo-IR: Contextual Composed Image Retrieval](#link13)
...
14. [FinPerMA: A Theory-Informed, Event-Grounded Personalized-Memory Benchmark for LLM Agents](#link14)
**Authors:** Ben Wang, Kang Zhou, Lifan Guo, Feng Chen, Chi Zhang

15. [NSF-HRPT: Neural Semantic Field meets Hierarchical Risk Perception Tree for Safety-Critical Scenario Assessment](#link15)
**Authors:** Yu Zhao, Jiangyu Pan, Tao Hu, Ming Yin, Fan Yang, Jiangfan Liu, Xiubo Liang

16. [MatrAIx: Simulating the World with 8.3 Billion Persona Agents](#link16)
...
17. [Interoceptive Attention as Dynamic Homeostatic Prioritization in a Foraging Agent](#link17)
...
18. [Coupled Continuous-Discrete Generation for Scene Text Image Super-Resolution](#link18)
**Authors:** Axi Niu, Knag Zhang, Qingsen Yan, Hao Jin, Jinqiu Sun, Yanning Zhang

19. [Adversarially Robust Abductive Fusion of Pre-trained Transformer-based Perception Models](#link19)
**Authors:** Mario Leiva, Yue Ma, Qinru Qiu, Gerardo Simari, Paulo Shakarian

20. [Objects as Audio-Visual Modal Sound Fields](#link20)
**Authors:** Zisen Shao, Zihao Wei, Derong Jin, Ruohan Gao

21. [PADFormer: Pose-agnostic Anomaly Detection from Sparse View Images](#link21)
**Authors:** Ruiqi Wang, Yiming Qian, Fenggen Yu, Yuxuan Lu, Dakuo Wang, Hao Zhang, Jing Huang

---
## 0. [Talk2Sensors: 3D Visual Grounding in Autonomous Driving via Sensor-Adaptive Physical Cue Matching](https://arxiv.org/abs/2608.04568) <a id="link0"></a>
**ArXiv ID:** 2608.04568
**Authors:** Runwei Guan, Di Tian, Ningwei Ouyang, Ruixiao Zhang, Shaofeng Liang, Haocheng Zhao, Lianqing Zheng, Xiaokai Bai, Guotao Wang, Daizong Liu, Henghui Ding, Hui Xiong
...
**Comment:** Matches criterion 1 very closely: it proposes a new method for 3D visual grounding in autonomous driving with sensor-adaptive fusion of camera, LiDAR, and 4D radar cues, which is a direct spatial understanding / embodied perception contribution. It also fits criterion 3 as a new benchmark plus method.
**Relevance:** 9
**Novelty:** 7

---

## 1. [CARGO-VL: Counterfactual Arbitration with Risk-Constrained Group Optimization for Vision-Language Models](https://arxiv.org/abs/2608.04509) <a id="link1"></a>
**ArXiv ID:** 2608.04509
**Authors:** De Jiang, Zhengyang Zhang, Kehong Yuan, Shaohua Ma
...
**Comment:** Matches criterion 2 very closely: a new vision-language model training objective for reliable multimodal evidence arbitration with counterfactual consistency and abstention.
**Relevance:** 9
**Novelty:** 7

---

## 2. [ToolArtist: Tool-Using Unified Multimodal Models for Agentic Image Generation](https://arxiv.org/abs/2608.04436) <a id="link2"></a>
**ArXiv ID:** 2608.04436
**Authors:** Jiahao Zhao, Xiaomin Yu, Zhongxiang Sun, Fengwei Teng, Chengwei Qin, Xiaobin Hu, Jun Xu, Shuicheng Yan
...
**Comment:** Matches criterion 2 closely: a new unified multimodal model for agentic image generation with tool use and post-training RL.
**Relevance:** 8
**Novelty:** 7

---

## 3. [SIGNPOST-Bench: Benchmarking Text-Vision Conflict Resolution in Multimodal Large Language Models](https://arxiv.org/abs/2608.04244) <a id="link3"></a>
**ArXiv ID:** 2608.04244
**Authors:** Sirun Li, Minghao Liu, Ling Dai, Yong Li, Haoxin Lyu, Junting Zhou, Fan Zhang
...
**Comment:** Matches criterion 2 strongly: it builds a benchmark for text-vision conflict resolution in MLLMs and directly studies their arbitration behavior.
**Relevance:** 7
**Novelty:** 7

---

## 4. [LoRetta: A Foundation Model and Extensive Dataset for Global-Scale Remote Sensing Dense Image Matching](https://arxiv.org/abs/2608.04106) <a id="link4"></a>
**ArXiv ID:** 2608.04106
**Authors:** Siwei Yu, Han Guo, Zhenwei Shi, Zhengxia Zou
...
**Comment:** Matches criterion 4: it is a vision foundation model for large-scale remote sensing dense matching, plus a new benchmark and evaluation protocol.
**Relevance:** 6
**Novelty:** 7

---

## 5. [WorldCycle: Self-Verifiable Reinforcement Learning for Long-Horizon Video World Models](https://arxiv.org/abs/2608.04964) <a id="link5"></a>
**ArXiv ID:** 2608.04964
**Authors:** Bohai Gu, Yueyang Yuan, Taiyi Wu, Dazhao Du, Jian Liu, Xiaoyi Pang, Jie Zhang, Xiaocheng Lu, Haobin Zhong, Xiaotong Zhao, Alan Zhao, Song Guo
...
**Comment:** Matches criterion 3 moderately well: a new long-horizon video world-model RL method with a diagnostic benchmark for state-returning behavior.
**Relevance:** 5
**Novelty:** 7

---

## 6. [MetaVideoAgent: Automated Video-Agent Evolution for Long-Form Video Understanding](https://arxiv.org/abs/2608.04587) <a id="link6"></a>
**ArXiv ID:** 2608.04587
**Authors:** Benlei Cui, Ruize Wang, Junjie Li, Jinhao Chen, Longtao Huang, Yinghao Chen, Yuwen Zhai, Jingqun Tang, Ruijian Jia, Weiwei Wu, Pengfei Sun, Haiwen Hong
...
**Comment:** Matches criterion 3 moderately well: it proposes a new method and benchmark-style setup for long-form video understanding via automated video-agent evolution. It is adjacent to multimodal agentic systems, though not a direct embodied AI or vision foundation model paper.
**Relevance:** 5
**Novelty:** 6

---

## 7. [The First EgoCross Challenge at EgoVis 2026: Cross-Domain Egocentric Video Question Answering](https://arxiv.org/abs/2608.04589) <a id="link7"></a>
**ArXiv ID:** 2608.04589
**Authors:** Yuqian Fu, Tianwen Qian, Yanjun Li, Yu Li, Kunyu Peng, Xu Zheng, Yongqin Xian, Alessio Tonioni, Yanwei Fu, Xiaoling Wang, Danda Paudel, Federico Tombari, Luc Van Gool, Leyi Wu, Yifan Zhao, Jinjie Zhang, Yinchuan Li, Yingcong Chen, Zixu Li, Zhiwei Chen, Zhiheng Fu, Wenbo Wang, Yupeng Hu, Weili Guan, Liqiang Nie, Takuya Murakawa, Toru Tamaki, Yi Wen, Zhenglin Du, Zhengyang Li, Lingling Li, Licheng Jiao, Wenping Ma
...
**Comment:** Matches criterion 3 closely: it introduces a new embodied/video benchmark for cross-domain egocentric video QA, with target domains that go beyond standard daily-life settings and include challenging simulator-like or specialized environments.
**Relevance:** 6
**Novelty:** 5

---

## 8. [ContextMaster: Interactive Multi-Shot Video Creation via Fixed-Budget Sparse Context Routing](https://arxiv.org/abs/2608.04956) <a id="link8"></a>
**ArXiv ID:** 2608.04956
**Authors:** Xu Guo, Zhengxuan Wei, Xinghui Li, Hanzhuo Huang, Xinyu Liu, Xiangyang Luo, Min Wei, Yiran Zhu, Qiulin Wang, Yulong Xu, Xintao Wang, Pengfei Wan, Qi Fan, Xiangwang Hou
...
**Comment:** Matches criterion 3 somewhat: a new unified video creation model with interactive multi-shot context routing, though it is more video generation than embodied AI.
**Relevance:** 4
**Novelty:** 7

---

## 9. [RegisterBridgeMM: A Register-Centric Framework for RGB-Infrared Object Detection](https://arxiv.org/abs/2608.04833) <a id="link9"></a>
**ArXiv ID:** 2608.04833
**Authors:** Zian Wang, Hangchuan Liang, Yuehua Chen, Changchun Li, Chaoyi Guo, Mingzhe Liu, Fangming Gu
...
**Comment:** Matches criterion 4 moderately well: it leverages pretrained register tokens from vision foundation models for RGB-infrared detection.
**Relevance:** 5
**Novelty:** 6

---

## 10. [COSMO: Consensus-Driven Shift Modulation for Source-Free Domain Adaptation](https://arxiv.org/abs/2608.04604) <a id="link10"></a>
**ArXiv ID:** 2608.04604
**Authors:** Bo Li, Junjie Peng, Xiaohua Xie, Jianhuang Lai
...
**Comment:** Matches criterion 4 moderately well: a vision-language-model-guided domain adaptation method using pretrained VLMs as auxiliary semantic knowledge.
**Relevance:** 5
**Novelty:** 6

---

## 11. [FocusMem: Factorizing Content, Readout, and Trust in Latent GUI Memory](https://arxiv.org/abs/2608.04530) <a id="link11"></a>
**ArXiv ID:** 2608.04530
**Authors:** Zhuoran Zhang, Bowen Li, Jingcheng Ju, Yang Shi, Qixun Wang, Haotian Wang, Wei Chen, Tengjiao Wang
...
**Comment:** Matches criterion 3: it targets GUI agents/embodied interaction by introducing a new latent memory method focused on task progress, retrieval trust, and action-stage readout.
**Relevance:** 5
**Novelty:** 6

---

## 12. [DIVE: Dynamic Iterative Visual Evidence Construction for Efficient Vision-Language Models](https://arxiv.org/abs/2608.04496) <a id="link12"></a>
**ArXiv ID:** 2608.04496
**Authors:** Chen Zhong, Xiao An, Zijie Wang, Jiepan Li, Guangyi Yang, Wei He
...
**Comment:** Matches criterion 2: it is a method for efficient vision-language models, specifically training-free visual-token pruning via iterative evidence construction.
**Relevance:** 5
**Novelty:** 6

---

## 13. [CoCo-IR: Contextual Composed Image Retrieval](https://arxiv.org/abs/2608.05149) <a id="link13"></a>
**ArXiv ID:** 2608.05149
**Authors:** Shengcao Cao, Tanmaya Shekhar Dabral, Zhongli Ding, Madhuri Shanbhogue, Kaifeng Chen, Zhe Li, Mojtaba Seyedhosseini, Yu-Xiong Wang, Liang-Yan Gui
...
**Comment:** Matches criterion 3: it introduces a new embodied/retrieval-style benchmark for multi-turn contextual visual search, with a new method built around multi-turn interaction history.
**Relevance:** 5
**Novelty:** 6

---

## 14. [FinPerMA: A Theory-Informed, Event-Grounded Personalized-Memory Benchmark for LLM Agents](https://arxiv.org/abs/2608.04095) <a id="link14"></a>
**ArXiv ID:** 2608.04095
**Authors:** Ben Wang, Kang Zhou, Lifan Guo, Feng Chen, Chi Zhang
...
**Comment:** Matches criterion 3: a new benchmark for LLM agents focused on personalized memory over longitudinal, event-grounded trajectories.
**Relevance:** 4
**Novelty:** 6

---

## 15. [NSF-HRPT: Neural Semantic Field meets Hierarchical Risk Perception Tree for Safety-Critical Scenario Assessment](https://arxiv.org/abs/2608.04776) <a id="link15"></a>
**ArXiv ID:** 2608.04776
**Authors:** Yu Zhao, Jiangyu Pan, Tao Hu, Ming Yin, Fan Yang, Jiangfan Liu, Xiubo Liang
...
**Comment:** Matches criterion 3 loosely: it is an embodied/autonomy-adjacent method using simulation data and spatial reasoning for risk assessment, but it is not a new embodied benchmark.
**Relevance:** 4
**Novelty:** 6

---

## 16. [MatrAIx: Simulating the World with 8.3 Billion Persona Agents](https://arxiv.org/abs/2608.04205) <a id="link16"></a>
**ArXiv ID:** 2608.04205
**Authors:** Xiaomin Li, Yuexing Hao, Jianheng Hou, Jintao Huang, Qianfeng Wen, Shirley Huang, Yifan Liu, Xiaoyi Liu, Yilan Fan, Yijun Wang, Koutian Wu, Ruoqi Gao, Muhammad Ahmed Mohsin, Jing Tang, Brihi Joshi, Heming Liu, Zheyuan Deng, Zonglin Di, Sankalp Jajee, Jiuyao Lu, Zhiwei Zhang, Saksham Kapoor, Ishan Gupta, Yunhan Zhao, Chanwoo Park, Yucheng Lu, Bing Hu, Weihang Xiao, Aravind Mohan, Hanwen Xing, Runyu Zhang, Mihir Kulshreshtha, Yuanda Xu, Qianyu Zhu, Dianzhuo Wang, Yuxin Xiao, Bowen Jiang, Yongye Su, Wenhao Chai, Zuxin Liu, Lawrence Yunliang Chen, Xuandong Zhao, Ethan Ye, Shivam Patel, Jason Xie, Alex Martin Richmond, Weixiang Ding, Emre Okcular, Diya Mathew, Ziheng Wang, Rana M. Shahroz Khan, Zhejian Peng, Fang Wu, Fan Nie, Xinyang Han, Yubin Kim, Jiawei Zhang, Zhenting Qi, Huangyuan Su, Xu Pan, Abinitha Gourabathina, Hyewon Jeong, Hemanth Neelgund Ramesh, Kumail Alhamoud, Kimia Hamidieh, Zidi Xiong, Samuel Schmidgall, Pengrui Han, Yepeng Huang, Yongheng Wang, Bowen Yang, Alex Gu, Yuchu Wang, Akshay Paruchuri, Brenna Li, Hejie Cui, Jiayuan Ding, Chaosheng Dong, Jiahao Wang, Yixuan He, Chi Wang, Pamela Bhattacharya, Tianyi Peng, Paul Pu Liang, Mitchell Gordon, Yilun Du, Marinka Zitnik, James Zou, Prasanna Tambe, Philip Torr, Emily Fox, Asu Ozdaglar, Dawn Song
...
**Comment:** No direct match to criteria 1-4, though it is adjacent to embodied/simulated-agent evaluation. This is primarily a population-scale simulated-user infrastructure for product evaluation rather than embodied AI, spatial understanding, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 17. [Interoceptive Attention as Dynamic Homeostatic Prioritization in a Foraging Agent](https://arxiv.org/abs/2608.04232) <a id="link17"></a>
**ArXiv ID:** 2608.04232
**Authors:** St John Grimbly, Nicolas Kuske, Evert A. Boonstra, Bruce A. Bassett, Charel van Hoof, Rowan Hodson, Benjamin Rosman, Ryan Smith, Mark Solms, Jonathan P. Shock
...
**Comment:** No close match to the listed criteria; it is an embodied/control-style agent paper, but not clearly about embodied AI benchmarks, VLLMs/MLLMs, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 18. [Coupled Continuous-Discrete Generation for Scene Text Image Super-Resolution](https://arxiv.org/abs/2608.04525) <a id="link18"></a>
**ArXiv ID:** 2608.04525
**Authors:** Axi Niu, Knag Zhang, Qingsen Yan, Hao Jin, Jinqiu Sun, Yanning Zhang
...
**Comment:** No close match to criteria 1-4, though it is a multimodal generative model for scene text super-resolution with coupled continuous-discrete generation.
**Relevance:** 3
**Novelty:** 6

---

## 19. [Adversarially Robust Abductive Fusion of Pre-trained Transformer-based Perception Models](https://arxiv.org/abs/2608.04190) <a id="link19"></a>
**ArXiv ID:** 2608.04190
**Authors:** Mario Leiva, Yue Ma, Qinru Qiu, Gerardo Simari, Paulo Shakarian
...
**Comment:** No close match to criteria 1-4; it is a clever robustness/fusion method for pre-trained perception models, but not a vision foundation model application or embodied benchmark.
**Relevance:** 3
**Novelty:** 6

---

## 20. [Objects as Audio-Visual Modal Sound Fields](https://arxiv.org/abs/2608.05145) <a id="link20"></a>
**ArXiv ID:** 2608.05145
**Authors:** Zisen Shao, Zihao Wei, Derong Jin, Ruohan Gao
...
**Comment:** No close match to criteria 1-4, though it is a strong vision-related representation learning paper with a novel audio-visual 3D field formulation.
**Relevance:** 3
**Novelty:** 6

---

## 21. [PADFormer: Pose-agnostic Anomaly Detection from Sparse View Images](https://arxiv.org/abs/2608.04210) <a id="link21"></a>
**ArXiv ID:** 2608.04210
**Authors:** Ruiqi Wang, Yiming Qian, Fenggen Yu, Yuxuan Lu, Dakuo Wang, Hao Zhang, Jing Huang
...
**Comment:** No close match to the criteria; it is a vision-transformer anomaly detection method, relevant to vision but not specifically one of the requested categories.
**Relevance:** 3
**Novelty:** 5
