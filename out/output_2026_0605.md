# Personalized Daily ArXiv Papers 06/05/2026
...
0. [HyperVis: Continuous Latent Visual Relational Graphs on the Lorentz Hyperboloid for Compositional Reasoning](#link0)
**Authors:** Moshiur Farazi, Sameera Ramasinghe, Mahbub Ahmed Turza, Shafin Rahman

1. [ViCuR: Visual Cues as Recoverable Privilege for Multimodal On-Policy Distillation](#link1)
**Authors:** Kanghui Tian, Siyuan Liu, Ziang Yan, Sheng Xia, Shuai Dong, Yi Wang

2. [Almieyar-Oryx-BloomBench: A Bilingual Multimodal Benchmark for Cognitively Informed Evaluation of Vision-Language Models](#link2)
...
3. [DRIFT: A Residual Flow Adapter for Decoding Continuous Outputs in Vision-Language Models](#link3)
**Authors:** Zhuoming Liu, Jinhong Lin, Kwan Man Cheng, Lin Zhang, Shayok Bagchi, Yin Li

4. [LongSpace: Exploring Long-Horizon Spatial Memory from Perception to Recall in Video](#link4)
**Authors:** Shiqiang Lang, Jing Liu, Haoyang He, Peiwen Sun, Yuanteng Chen, Tao Liu, Lan Yang, Longteng Guo, Honggang Zhang

5. [HomeWorld: A Unified Floorplan-to-Furnished Framework for Generating Controllable, Densely Interactive Whole-Home Scenes](#link5)
**Authors:** Wenbo Li, Xiaoliang Ju, Zipeng Qin, Rongyao Fang, Hongsheng Li

6. [Imagine Before You Predict: Interleaved Latent Visual Reasoning for Video Event Prediction](#link6)
**Authors:** Tianxiang Jiang, Linquan Wu, Sheng Xia, Songze Li, Ziang Yan, Haoyu Yang, Yu Qiao, Yi Wang

7. [DisasterBench: A Multimodal Benchmark for UAV-Based Disaster Response in Complex Environments](#link7)
**Authors:** Tan Zhang, Quanyou Li, Lu Zhang, Jun Liu, Xiaofeng Zhu, Ping Hu

8. [AutoLab: Can Frontier Models Solve Long-Horizon Auto Research and Engineering Tasks?](#link8)
...
9. [GRAMformer: Any-Order Modality Interactions via Volumetric Multimodal Cross-Attention](#link9)
**Authors:** Giordano Cicchetti, Eleonora Grassucci, Danilo Comminiello

10. [R-APS: Compositional Reasoning and In-Context Meta-Learning for Constrained Design via Reflective Adversarial Pareto Search](#link10)
**Authors:** Jo\~ao Pedro Gandarela, Thiago Rios, Stefan Menzel, Andr\'e Freitas

11. [Scaling Self-Evolving Agents via Parametric Memory](#link11)
...
12. [Recovering Physically Plausible Human-Object Interactions from Monocular Videos](#link12)
**Authors:** Dingbang Huang, Etienne Vouga, Qixing Huang, Georgios Pavlakos

13. [GMBFormer: An NDVI-Guided Global Memory Bank Transformer for Urban Green-Space Extraction from Ultra-High-Resolution Imagery](#link13)
**Authors:** Hao Lei, Xi Cheng, Chenlu Shu, Zhiheng Chen, Zhengjie Duan, Haoyu Wang, Zhanfeng Shen

14. [MapAgent: An Industrial-Grade Agentic Framework for City-scale Lane-level Map Generation](#link14)
**Authors:** Deguo Xia, Zihan Li, Haochen Zhao, Dong Xie, Yuyao Kong, Xiyan Liu, Jizhou Huang, Mengmeng Yang, Diange Yang

15. [CamFlow+: Hybrid Motion Bases for 2D Camera Motion Estimation with Stabilization Applications](#link15)
**Authors:** Haipeng Li, Zhen Liu, Zhanglei Yang, Hai Jiang, Tianhao Zhou, Zhengzhe Liu, Ping Tan, Bing Zeng, Shuaicheng Liu

16. [Plan First, Judge Later, Run Better: A DMAIC-Inspired Agentic System for Industrial Anomaly Detection](#link16)
**Authors:** Yongzi Yu, Ao Li, Le Wang, Ziyue Li, Fugee Tsung, Yuxuan Liang, Man Li

17. [Physics-Guided Deep Unfolding for Blind Cross-Sensor Spectral Super-Resolution via Learning the Spectral Transformation Function](#link17)
**Authors:** Zhaolin Li, Jinsong Chen, Shanxin Guo, Tuo Zhang, Xinglong Zhang, Pan Chen

18. [The Meta-Agent Challenge: Are Current Agents Capable of Autonomous Agent Development?](#link18)
...
25. [Strabo: Declarative Specification and Implementation of Agentic Interaction Protocols](#link25)
**Authors:** Samuel H. Christie V, Amit K. Chopra, Munindar P. Singh

---
## 0. [HyperVis: Continuous Latent Visual Relational Graphs on the Lorentz Hyperboloid for Compositional Reasoning](https://arxiv.org/abs/2606.06100) <a id="link0"></a>
**ArXiv ID:** 2606.06100
**Authors:** Moshiur Farazi, Sameera Ramasinghe, Mahbub Ahmed Turza, Shafin Rahman
...
**Comment:** Matches criterion 2 and 4: Proposes HyperVis, a novel approach for compositional reasoning in VLMs using continuous latent visual relational graphs in hyperbolic space, with empirical insights into curvature and compositionality.
**Relevance:** 10
**Novelty:** 9

---

## 1. [ViCuR: Visual Cues as Recoverable Privilege for Multimodal On-Policy Distillation](https://arxiv.org/abs/2606.05718) <a id="link1"></a>
**ArXiv ID:** 2606.05718
**Authors:** Kanghui Tian, Siyuan Liu, Ziang Yan, Sheng Xia, Shuai Dong, Yi Wang
...
**Comment:** This paper proposes ViCuR, a visually grounded privileged-teacher distillation framework for multimodal on-policy distillation, improving reasoning in VLLMs/MLLMs. This matches criterion 2 (new VLLMs/MLLMs methods) and criterion 4 (vision foundation models and applications), with a novel approach to teacher privilege.
**Relevance:** 10
**Novelty:** 8

---

## 2. [Almieyar-Oryx-BloomBench: A Bilingual Multimodal Benchmark for Cognitively Informed Evaluation of Vision-Language Models](https://arxiv.org/abs/2606.05531) <a id="link2"></a>
**ArXiv ID:** 2606.05531
**Authors:** Mohammad Mahdi Abootorabi, Omid Ghahroodi, Anas Madkoor, Marzia Nouri, Doratossadat Dastgheib, Mohamed Hefeeda, Ehsaneddin Asgari
...
**Comment:** This paper introduces BloomBench, a new bilingual multimodal benchmark for cognitively informed evaluation of vision-language models. This directly matches criterion 3 (embodied AI papers on building new benchmarks, especially with novel angles) and criterion 2 (shows new VLLMs/MLLMs, as it evaluates them). The cognitive and cross-lingual focus is a novel angle.
**Relevance:** 10
**Novelty:** 8

---

## 3. [DRIFT: A Residual Flow Adapter for Decoding Continuous Outputs in Vision-Language Models](https://arxiv.org/abs/2606.05758) <a id="link3"></a>
**ArXiv ID:** 2606.05758
**Authors:** Zhuoming Liu, Jinhong Lin, Kwan Man Cheng, Lin Zhang, Shayok Bagchi, Yin Li
...
**Comment:** Matches criterion 2: Proposes DRIFT, a residual flow adapter for decoding continuous outputs in vision-language models, enabling VLMs/MLLMs to handle continuous tasks like robotic control and visual grounding.
**Relevance:** 10
**Novelty:** 8

---

## 4. [LongSpace: Exploring Long-Horizon Spatial Memory from Perception to Recall in Video](https://arxiv.org/abs/2606.05677) <a id="link4"></a>
**ArXiv ID:** 2606.05677
**Authors:** Shiqiang Lang, Jing Liu, Haoyang He, Peiwen Sun, Yuanteng Chen, Tao Liu, Lan Yang, Longteng Guo, Honggang Zhang
...
**Comment:** Matches criterion 1 (spatial understanding and memory in embodied agents) and criterion 3 (new benchmark for long-horizon spatial memory in video). Proposes a new benchmark and method for long-horizon spatial memory in MLLMs.
**Relevance:** 10
**Novelty:** 8

---

## 5. [HomeWorld: A Unified Floorplan-to-Furnished Framework for Generating Controllable, Densely Interactive Whole-Home Scenes](https://arxiv.org/abs/2606.06390) <a id="link5"></a>
**ArXiv ID:** 2606.06390
**Authors:** Wenbo Li, Xiaoliang Ju, Zipeng Qin, Rongyao Fang, Hongsheng Li
...
**Comment:** Matches criterion 3 (embodied AI, new benchmark and simulator pipeline for whole-home scene generation) and criterion 4 (vision foundation models for 3D scene generation). Presents a unified, controllable pipeline for generating interactive home scenes for embodied AI, with a large dataset and new methods.
**Relevance:** 10
**Novelty:** 8

---

## 6. [Imagine Before You Predict: Interleaved Latent Visual Reasoning for Video Event Prediction](https://arxiv.org/abs/2606.05769) <a id="link6"></a>
**ArXiv ID:** 2606.05769
**Authors:** Tianxiang Jiang, Linquan Wu, Sheng Xia, Songze Li, Ziang Yan, Haoyu Yang, Yu Qiao, Yi Wang
...
**Comment:** Matches criterion 2 (new MLLMs for video event prediction) and criterion 4 (novel visual-latent reasoning in MLLMs). Introduces a new framework for interleaved latent visual reasoning in video MLLMs, with strong empirical results.
**Relevance:** 10
**Novelty:** 8

---

## 7. [DisasterBench: A Multimodal Benchmark for UAV-Based Disaster Response in Complex Environments](https://arxiv.org/abs/2606.06217) <a id="link7"></a>
**ArXiv ID:** 2606.06217
**Authors:** Tan Zhang, Quanyou Li, Lu Zhang, Jun Liu, Xiaofeng Zhu, Ping Hu
...
**Comment:** Matches criterion 3 and 2: Introduces DisasterBench, a new multimodal benchmark for UAV-based disaster response, and DisasterVL, a lightweight MLLM for multi-stage reasoning, both addressing overlooked aspects in embodied AI and VLLMs/MLLMs.
**Relevance:** 9
**Novelty:** 8

---

## 8. [AutoLab: Can Frontier Models Solve Long-Horizon Auto Research and Engineering Tasks?](https://arxiv.org/abs/2606.05080) <a id="link8"></a>
**ArXiv ID:** 2606.05080
**Authors:** Zhangchen Xu, Junda Chen, Yue Huang, Dongfu Jiang, Jiefeng Chen, Hang Hua, Zijian Wu, Zheyuan Liu, Zexue He, Lichi Li, Shizhe Diao, Jiaxin Pei, Jinsung Yoon, Hao Zhang, Mengdi Wang, Radha Poovendran, Misha Sra, Alex Pentland, Zichen Chen
...
**Comment:** Matches criterion 3: Introduces AutoLab, a new benchmark for long-horizon agentic tasks, focusing on persistent iteration and time awareness in autonomous agents, which is a novel benchmarking angle in embodied AI.
**Relevance:** 9
**Novelty:** 8

---

## 9. [GRAMformer: Any-Order Modality Interactions via Volumetric Multimodal Cross-Attention](https://arxiv.org/abs/2606.06249) <a id="link9"></a>
**ArXiv ID:** 2606.06249
**Authors:** Giordano Cicchetti, Eleonora Grassucci, Danilo Comminiello
...
**Comment:** Matches criterion 2 (new multimodal transformer architecture) and criterion 4 (foundation model architecture for multimodal learning). Introduces a novel cross-attention mechanism for any-order modality interactions.
**Relevance:** 9
**Novelty:** 8

---

## 10. [R-APS: Compositional Reasoning and In-Context Meta-Learning for Constrained Design via Reflective Adversarial Pareto Search](https://arxiv.org/abs/2606.04823) <a id="link10"></a>
**ArXiv ID:** 2606.04823
**Authors:** Jo\~ao Pedro Gandarela, Thiago Rios, Stefan Menzel, Andr\'e Freitas
...
**Comment:** This paper proposes R-APS, a new method for compositional reasoning and meta-learning in agentic settings, evaluated on robotics and mechanism synthesis. It addresses reasoning failures in agentic LLMs and proposes a structured protocol for robust design, which matches criterion 3 (new methods for embodied AI with novel angles).
**Relevance:** 8
**Novelty:** 8

---

## 11. [Scaling Self-Evolving Agents via Parametric Memory](https://arxiv.org/abs/2606.04536) <a id="link11"></a>
**ArXiv ID:** 2606.04536
**Authors:** Tao Ren, Weiyao Luo, Hui Yang, Rongzhi Zhu, Xiang Huang, Yuchuan Wu, Bingxue Chou, Jieping Ye, Jiafeng Liang, Yongbin Li, Yijie Peng
...
**Comment:** This paper introduces TMEM, a parametric memory framework for self-evolving agents, allowing online adaptation of LLMs within an episode. This is a methodological improvement for embodied agents (criterion 1) and relates to agent memory and learning from experience, which is a novel angle in agent design.
**Relevance:** 8
**Novelty:** 7

---

## 12. [Recovering Physically Plausible Human-Object Interactions from Monocular Videos](https://arxiv.org/abs/2606.05359) <a id="link12"></a>
**ArXiv ID:** 2606.05359
**Authors:** Dingbang Huang, Etienne Vouga, Qixing Huang, Georgios Pavlakos
...
**Comment:** Matches criterion 1 and 3: Presents a new method (RePHO) for reconstructing physically plausible human-object interactions from monocular videos using RL and adaptive sampling, improving spatial understanding and physical realism in embodied AI.
**Relevance:** 8
**Novelty:** 7

---

## 13. [GMBFormer: An NDVI-Guided Global Memory Bank Transformer for Urban Green-Space Extraction from Ultra-High-Resolution Imagery](https://arxiv.org/abs/2606.06363) <a id="link13"></a>
**ArXiv ID:** 2606.06363
**Authors:** Hao Lei, Xi Cheng, Chenlu Shu, Zhiheng Chen, Zhengjie Duan, Haoyu Wang, Zhanfeng Shen
...
**Comment:** Matches criterion 1: Presents a new method for spatial understanding in urban green-space extraction using a global memory bank transformer with physics-informed gating, which is a methodological improvement in spatial intelligence.
**Relevance:** 8
**Novelty:** 7

---

## 14. [MapAgent: An Industrial-Grade Agentic Framework for City-scale Lane-level Map Generation](https://arxiv.org/abs/2606.04513) <a id="link14"></a>
**ArXiv ID:** 2606.04513
**Authors:** Deguo Xia, Zihan Li, Haochen Zhao, Dong Xie, Yuyao Kong, Xiyan Liu, Jizhou Huang, Mengmeng Yang, Diange Yang
...
**Comment:** Matches criterion 3 (embodied AI, new agentic framework for city-scale lane-level map generation). Presents a practical, scalable agentic system for large-scale map generation with vision-language components.
**Relevance:** 8
**Novelty:** 7

---

## 15. [CamFlow+: Hybrid Motion Bases for 2D Camera Motion Estimation with Stabilization Applications](https://arxiv.org/abs/2606.05915) <a id="link15"></a>
**ArXiv ID:** 2606.05915
**Authors:** Haipeng Li, Zhen Liu, Zhanglei Yang, Hai Jiang, Tianhao Zhou, Zhengzhe Liu, Ping Tan, Bing Zeng, Shuaicheng Liu
...
**Comment:** Matches criterion 1 (new methodological improvement for spatial understanding: hybrid-basis camera motion estimation). Proposes a new framework for 2D camera motion estimation, relevant for spatial intelligence.
**Relevance:** 8
**Novelty:** 7

---

## 16. [Plan First, Judge Later, Run Better: A DMAIC-Inspired Agentic System for Industrial Anomaly Detection](https://arxiv.org/abs/2606.04599) <a id="link16"></a>
**ArXiv ID:** 2606.04599
**Authors:** Yongzi Yu, Ao Li, Le Wang, Ziyue Li, Fugee Tsung, Yuxuan Liang, Man Li
...
**Comment:** Matches criterion 3: Proposes a new agentic system for industrial anomaly detection with a novel DMAIC-inspired multi-agent approach, focusing on strategy formulation and multi-modal reasoning, which is a novel angle in embodied AI.
**Relevance:** 7
**Novelty:** 6

---

## 17. [Physics-Guided Deep Unfolding for Blind Cross-Sensor Spectral Super-Resolution via Learning the Spectral Transformation Function](https://arxiv.org/abs/2606.05759) <a id="link17"></a>
**ArXiv ID:** 2606.05759
**Authors:** Zhaolin Li, Jinsong Chen, Shanxin Guo, Tuo Zhang, Xinglong Zhang, Pan Chen
...
**Comment:** This paper proposes a new physics-guided deep unfolding network for blind cross-sensor spectral super-resolution, which is a methodological improvement in spatial understanding for remote sensing. This matches criterion 1 (new methodological improvements to spatial understanding on embodied agents), though the focus is on remote sensing rather than embodied agents per se.
**Relevance:** 5
**Novelty:** 6

---

## 18. [The Meta-Agent Challenge: Are Current Agents Capable of Autonomous Agent Development?](https://arxiv.org/abs/2606.04455) <a id="link18"></a>
**ArXiv ID:** 2606.04455
**Authors:** Xinyu Lu, Tianshu Wang, Pengbo Wang, zujie wen, Zhiqiang Zhang, Jun Zhou, Boxi Cao, Yaojie Lu, Hongyu Lin, Xianpei Han, Le Sun
...
**Comment:** Does not match any specific criteria. Focuses on meta-agent development and agent self-improvement, not spatial, vision, or embodied AI.
**Relevance:** 3
**Novelty:** 7

---

## 19. [Learning Admissible Heuristics via Cost Partitioning](https://arxiv.org/abs/2606.04597) <a id="link19"></a>
**ArXiv ID:** 2606.04597
**Authors:** Hugo Barral, Quentin Cappart, Marie-Jos\'e Huguet, Sylvie Thi\'ebaux
...
**Comment:** This paper introduces a framework for learning admissible heuristics via cost partitioning for optimal planning. While it is a methodological improvement in planning, it does not directly address spatial intelligence, embodied agents, VLLMs/MLLMs, or vision foundation models. It is more relevant to planning and search.
**Relevance:** 3
**Novelty:** 6

---

## 20. [Beyond Absolute Scores: Relative Edit-induced Difference for Generalizable Image Aesthetic Assessment](https://arxiv.org/abs/2606.05778) <a id="link20"></a>
**ArXiv ID:** 2606.05778
**Authors:** Qifei Jia, Xintong Yao, Minghao Li, Yajie Chai, Qiming Lu, Baoyue Shen, Yasen Zhang, Runyu Shi, Ying Huang, Yue Zhang
...
**Comment:** Does not match any specific criterion. Focuses on image aesthetic assessment and relative difference learning, not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 21. [Trivium: Temporal Regret as a First-Class Objective for Causal-Memory Controllers](https://arxiv.org/abs/2606.04421) <a id="link21"></a>
**ArXiv ID:** 2606.04421
**Authors:** Edward Y. Chang
...
**Comment:** Does not match any specific criteria. Focuses on regret in agentic systems, not spatial, vision, or embodied AI.
**Relevance:** 3
**Novelty:** 6

---

## 22. [Beyond Prompt-Based Planning: MCP-Native Graph Planning-based Biomedical Agent System](https://arxiv.org/abs/2606.04494) <a id="link22"></a>
**ArXiv ID:** 2606.04494
**Authors:** Zhangtianyi Chen, Florensia Widjaja, Wufei Dai, Xiangjun Zhang, Yuhao Shen, Juexiao Zhou
...
**Comment:** Does not match any specific criteria. Focuses on biomedical agent planning, not spatial, vision, or embodied AI.
**Relevance:** 3
**Novelty:** 6

---

## 23. [Symb-xMIL: Symbolic Explanations for Multiple Instance Learning in Digital Pathology](https://arxiv.org/abs/2606.06224) <a id="link23"></a>
**ArXiv ID:** 2606.06224
**Authors:** Yanqing Luo (Berlin Institute for the Foundations of Learning and Data, Berlin, Germany, Machine Learning Group, Technische Universit\"at Berlin, Berlin, Germany), Julius Hense (Berlin Institute for the Foundations of Learning and Data, Berlin, Germany, Machine Learning Group, Technische Universit\"at Berlin, Berlin, Germany), Niklas Preni{\ss}l (Institute of Pathology, Charit\'e Universit\"atsmedizin, Berlin, Germany, Berlin Institute of Health at Charit\'e -- Universit\"atsmedizin Berlin, BIH Biomedical Innovation Academy, BIH Charit\'e Digital Clinician Scientist Program, Berlin, Germany), Andreas Mock (Institute of Pathology, Ludwig Maximilian University of Munich, Munich, Germany, Division of Translational Medical Oncology, DKFZ, Heidelberg, Germany, NCT Heidelberg, Heidelberg, Germany, German Cancer Consortium), Klaus-Robert M\"uller (Berlin Institute for the Foundations of Learning and Data, Berlin, Germany, Machine Learning Group, Technische Universit\"at Berlin, Berlin, Germany, Department of Artificial Intelligence, Korea University, Seoul, Korea, Max-Planck Institute for Informatics, Saarbr\"ucken, Germany), Thomas Schnake (Department of Chemistry, Chemical Physics Theory Group, University of Toronto, Canada, Vector Institute for Artificial Intelligence, Toronto, Canada, Acceleration Consortium, University of Toronto, Canada), Mina Jamshidi Idaji (Berlin Institute for the Foundations of Learning and Data, Berlin, Germany, Machine Learning Group, Technische Universit\"at Berlin, Berlin, Germany)
...
**Comment:** Does not match any specific criterion. Focuses on symbolic explanations for MIL in digital pathology, which is outside the main criteria.
**Relevance:** 3
**Novelty:** 5

---

## 24. [Knowledge Index of Noah's Ark](https://arxiv.org/abs/2606.05104) <a id="link24"></a>
**ArXiv ID:** 2606.05104
**Authors:** Sheng Jin, Minghao Liu, Yunze Xiao, Zeqi Zhou, Heli Qi, Yifan Yao, Meishu Song, Kaijing Ma, Xuan Zhang, Sicong Jiang, Yizhe Li, Ningshan Ma, Jie Wei, Ziniu Li, Minglai Yang, Bangya Liu, Yiming Liang, Xiao Fang, Qingcheng Zeng, Jiarui Liu, Rui Yang, Shen Yan, Wenhao Huang, Jiaheng Liu, Zihan Wang, Weihao Xuan, Ge Zhang
...
**Comment:** Does not match any specific criteria. Focuses on knowledge benchmarks for LLMs, not spatial, vision, or embodied AI.
**Relevance:** 3
**Novelty:** 5

---

## 25. [Strabo: Declarative Specification and Implementation of Agentic Interaction Protocols](https://arxiv.org/abs/2606.05043) <a id="link25"></a>
**ArXiv ID:** 2606.05043
**Authors:** Samuel H. Christie V, Amit K. Chopra, Munindar P. Singh
...
**Comment:** Does not match any specific criterion. Focuses on declarative agentic interaction protocols and interoperability, not spatial intelligence, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models.
**Relevance:** 3
**Novelty:** 4
