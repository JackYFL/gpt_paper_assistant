# Personalized Daily ArXiv Papers 05/28/2026
...
0. [Deconstructing Spatial Complexity: Hierarchical Decomposition for LLM Spatial Reasoning](#link0)
**Authors:** Yi Wang, Haojie Lu, Zhaofan Zhang, Li Chen, Sihong Xie

1. [What-If World: A Causal Benchmark for General World Models in Embodied Scenarios](#link1)
...
2. [Mags-RL: Wearing Multimodal LLMs a Magnifying Glass via Agentic Reinforcement Learning For Complex Scene Reasoning](#link2)
...
3. [Qwen-Image-Bench: From Generation to Creation in Text-to-Image Evaluation](#link3)
...
4. [VeriTrip: A Verifiable Benchmark for Travel Planning Agents over Unstructured Web Corpora](#link4)
**Authors:** Yuting Xu, Jiayi Tian, Jian Liang, Xin Xiong, Hang Zhang, Mu Xu, Xiao-Yu Zhang

5. [{\Omega}-QVLA: Robust Quantization for Vision-Language-Action Models via Composite Rotation and Per-step Scaling](#link5)
**Authors:** Xinyu Wang, Mingze Li, Sicheng Lyu, Dongxiu Liu, Kaicheng Yang, Ziyu Zhao, Yufei Cui, Xiao-Wen Chang, Peng Lu

6. [REVEAL: Reference-Grounded Reasoning for Multimodal Manipulation Detection](#link6)
**Authors:** Jun Zhou, Bingwen Hu, Yaxiong Wang, Zhedong Zheng, Yongzhen Wang, Yuchen Zhang, Ping Liu

7. [EntroAD: Structural Entropy-Guided Prompt Adaptation for Zero-Shot Anomaly Detection](#link7)
**Authors:** Xinyu Zhao, Qingyun Sun, Jiayi Luo, Jianxin Li

8. [CogPortrait: Fine-Grained Eye-Region Control in Portrait Animation via Hierarchical Agent Planning](#link8)
**Authors:** He Feng, Yongjia Ma, Donglin Di, Lei Fan, Tonghua Su

9. [OphIn-500K: Curating Web-Scale Visual Instructions for Scaling Ophthalmic Multimodal Large Language Models](#link9)
...
10. [Personal Visual Memory from Explicit and Implicit Evidence](#link10)
**Authors:** Viet Nguyen, Thao Nguyen, Vishal M. Patel, Yuheng Li

11. [When Think-with-Image Meets Safety: What Determines Multimodal Jailbreak Robustness?](#link11)
**Authors:** Yuan Tian, Bing Hu, Fang Wu, Xiaomin Li, Binghang Lu, Neil Zhenqiang Gong

12. [MORI-Seg: Learning Morphological Geometry for Instance Segmentation without Instance Annotations](#link12)
...
13. [Reflective Dialogue between Teacher and Solver Agents for Video Question Answering](#link13)
**Authors:** Takuya Murakawa, Toru Tamaki

14. [Residualized Temporal Sparse Autoencoders for Interpreting Diffusion Models](#link14)
**Authors:** Calvin Yeung, Prathyush Poduval, Ali Zakeri, Zhuowen Zou, Mohsen Imani

15. [From Affect to Complex Behavior: Advancing Multimodal Human-Centered AI at the 10th ABAW Workshop & Competition](#link15)
...
16. [SmartDirector: Keyframe-Conditioned Cinematic Video Generation with Narrative Pacing Control](#link16)
**Authors:** Zhida Zhang, Jie Ma, Zhan Peng, Haoxue Wu, Yang Han, Jun Liang, Jie Cao, Jing Li

17. [HarmoVid: Relightful Video Portrait Harmonization](#link17)
**Authors:** Jun Myeong Choi, Jae Shin Yoon, Luchao Qi, Roni Sengupta, Joon-Young Lee

18. [GONDOR to the Rescue: Satisficing Planning with Low Memory](#link18)
**Authors:** Yonatan Vernik, Alexander Tuisov, Alexander Shleyfman

19. [Decoupled Training with Local Reinforcement Fine-Tuning in Federated Learning](#link19)
**Authors:** Yuting Ma, Lechao Cheng, Xiaohua Xu

20. [EAPO: Entropy-Driven Adaptive Positive-Negative Sample Weighting for Policy Optimization in Open-Ended QA](#link20)
...
21. [Hierarchical Prompt-Domain Control and Learning for Resource-Constrained Agentic Language Models](#link21)
**Authors:** Joan Vendrell Gallart, Russell Bent, Michael Grosskopf

22. [Laguna M.1/XS.2 Technical Report](#link22)
...
23. [C-MIG: Multi-view Information Gain-based Retrieval-Augmented Generation for Clinical Diagnosis Reasoning](#link23)
...
24. [On the Origin of Synthetic Information by Means of Steganographic Inheritance](#link24)
**Authors:** Ching-Chun Chang, Isao Echizen

25. [A Policy-Driven Runtime Layer for Agentic LLM Serving](#link25)
**Authors:** Rui Zhang, Chaeeun Kim, Liting Hu

26. [Measuring Progress Toward AGI: A Cognitive Framework](#link26)
...
27. [Data-Efficient On-Policy Distillation for Automatic Speech Recognition](#link27)
**Authors:** Yu Lin, Yiming Wang, Runyuan Cai, Xiaodong Zeng

28. [PetroBench: A Benchmark for Large Language Models in Petroleum Engineering](#link28)
**Authors:** Xiang Wang, Tingting Zhang, Sen Wang, Ying Wu, Heng Meng, Peng Zhou, Peng Li

---
## 0. [Deconstructing Spatial Complexity: Hierarchical Decomposition for LLM Spatial Reasoning](https://arxiv.org/abs/2605.28144) <a id="link0"></a>
**ArXiv ID:** 2605.28144
**Authors:** Yi Wang, Haojie Lu, Zhaofan Zhang, Li Chen, Sihong Xie
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding/spatial intelligence on embodied agents). The paper proposes a hierarchical decomposition method for LLM spatial reasoning, with a novel MCTS-guided optimization and fine-grained advantage function, specifically targeting spatial reasoning and planning tasks relevant to embodied intelligence.
**Relevance:** 10
**Novelty:** 8

---

## 1. [What-If World: A Causal Benchmark for General World Models in Embodied Scenarios](https://arxiv.org/abs/2605.27589) <a id="link1"></a>
**ArXiv ID:** 2605.27589
**Authors:** Kunlin Cai, Rui Song, Jinghuai Zhang, Kaiyuan Zhang, Pranav Bodapati, Alicia Yu, Fnu Suya, Mohammad Rostami, Jiaqi Ma, Yuan Tian
...
**Comment:** Matches criterion 3 (embodied AI/new benchmarks): Introduces What-If World, a causal benchmark for world models in embodied scenarios, focusing on causal interventions and physical reasoning in video generation models for driving and manipulation. Provides a new evaluation rubric and empirical insights.
**Relevance:** 10
**Novelty:** 8

---

## 2. [Mags-RL: Wearing Multimodal LLMs a Magnifying Glass via Agentic Reinforcement Learning For Complex Scene Reasoning](https://arxiv.org/abs/2605.27960) <a id="link2"></a>
**ArXiv ID:** 2605.27960
**Authors:** Xuanzhao Dong, Wenhui Zhu, Peijie Qiu, Xiwen Chen, Xiaobing Yu, Xin Li, Zhipeng Wang, Shao Tang, Gen Li, Yujian Xiong, Hao Wang, Yanxi Chen, Prayag Tiwari, Yalin Wang
...
**Comment:** Matches criterion 2 (new MLLMs) and criterion 3 (embodied AI/new methods): Proposes Mags-RL, an agentic RL framework that equips MLLMs with a super-resolution 'magnifying glass' for complex scene reasoning, improving visual grounding and reasoning in complex scenarios. Also introduces a novel curriculum learning strategy for data-efficient RL.
**Relevance:** 10
**Novelty:** 8

---

## 3. [Qwen-Image-Bench: From Generation to Creation in Text-to-Image Evaluation](https://arxiv.org/abs/2605.28091) <a id="link3"></a>
**ArXiv ID:** 2605.28091
**Authors:** Niantong Li, Guangzheng Hu, Weixu Qiao, Ying Ba, Qichen Hong, Shijun Shen, Jinlin Wang, Fan Zhou, Jianye Kang, Xin Shang, Ziyi He, Wei Wang, Dalin Li, Jiahao Li, Jie Zhang, Kaiyuan Gao, Kun Yan, Lihan Jiang, Ningyuan Tang, Shengming Yin, Tianhe Wu, Xiao Xu, Xiaoyue Chen, Yuxiang Chen, Yan Shu, Yanran Zhang, Yilei Chen, Yixian Xu, Zekai Zhang, Zhendong Wang, Zihao Liu, Zikai Zhou, Hongzhu Shi, Yi Wang, Bing Zhao, Hu Wei, Lin Qu, Chenfei Wu
...
**Comment:** Matches criterion 4: Vision foundation models and their applications. Introduces Qwen-Image-Bench, a new benchmark for text-to-image models, with a focus on real-world fidelity and creative generation, and a unified judge model for fine-grained evaluation.
**Relevance:** 9
**Novelty:** 8

---

## 4. [VeriTrip: A Verifiable Benchmark for Travel Planning Agents over Unstructured Web Corpora](https://arxiv.org/abs/2605.28683) <a id="link4"></a>
**ArXiv ID:** 2605.28683
**Authors:** Yuting Xu, Jiayi Tian, Jian Liang, Xin Xiong, Hang Zhang, Mu Xu, Xiao-Yu Zhang
...
**Comment:** Matches criterion 3: Embodied AI papers on building new benchmarks (simulator related) or new methods, with a novel angle. Introduces VeriTrip, a new benchmark for travel planning agents that emphasizes evidence-grounded reasoning over unstructured multimodal web corpora, addressing previously ignored cognitive hurdles.
**Relevance:** 9
**Novelty:** 8

---

## 5. [{\Omega}-QVLA: Robust Quantization for Vision-Language-Action Models via Composite Rotation and Per-step Scaling](https://arxiv.org/abs/2605.28803) <a id="link5"></a>
**ArXiv ID:** 2605.28803
**Authors:** Xinyu Wang, Mingze Li, Sicheng Lyu, Dongxiu Liu, Kaicheng Yang, Ziyu Zhao, Yufei Cui, Xiao-Wen Chang, Peng Lu
...
**Comment:** Matches criterion 2 (VLLMs/MLLMs) and criterion 4 (vision foundation models and applications): Proposes Omega-QVLA, a quantization framework for Vision-Language-Action models, enabling efficient deployment of large VLA models with minimal performance loss. Includes clever quantization/statistical tricks.
**Relevance:** 9
**Novelty:** 8

---

## 6. [REVEAL: Reference-Grounded Reasoning for Multimodal Manipulation Detection](https://arxiv.org/abs/2605.28459) <a id="link6"></a>
**ArXiv ID:** 2605.28459
**Authors:** Jun Zhou, Bingwen Hu, Yaxiong Wang, Zhedong Zheng, Yongzhen Wang, Yuchen Zhang, Ping Liu
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a reference-grounded reasoning framework for multimodal manipulation detection, with a large-scale reference library and a MoE architecture for detection and grounding. The training-free domain adaptation is a novel angle.
**Relevance:** 8
**Novelty:** 8

---

## 7. [EntroAD: Structural Entropy-Guided Prompt Adaptation for Zero-Shot Anomaly Detection](https://arxiv.org/abs/2605.28630) <a id="link7"></a>
**ArXiv ID:** 2605.28630
**Authors:** Xinyu Zhao, Qingyun Sun, Jiayi Luo, Jianxin Li
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a structural entropy-guided prompt adaptation for zero-shot anomaly detection using CLIP, with a dynamic routing mechanism and dual-branch prompt adaptation. The approach is novel for ZSAD.
**Relevance:** 8
**Novelty:** 7

---

## 8. [CogPortrait: Fine-Grained Eye-Region Control in Portrait Animation via Hierarchical Agent Planning](https://arxiv.org/abs/2605.28056) <a id="link8"></a>
**ArXiv ID:** 2605.28056
**Authors:** He Feng, Yongjia Ma, Donglin Di, Lei Fan, Tonghua Su
...
**Comment:** Matches criterion 2 (shows new MLLMs) and criterion 4 (vision foundation models and applications). Introduces a chain-of-thought MLLM agent system for fine-grained portrait animation, with a new benchmark for eye-region control. The use of MLLMs for hierarchical planning in animation is novel.
**Relevance:** 8
**Novelty:** 7

---

## 9. [OphIn-500K: Curating Web-Scale Visual Instructions for Scaling Ophthalmic Multimodal Large Language Models](https://arxiv.org/abs/2605.27916) <a id="link9"></a>
**ArXiv ID:** 2605.27916
**Authors:** Xuanzhao Dong, Wenhui Zhu, Xiwen Chen, Hao Wang, Xin Li, Yujian Xiong, Jiajun Cheng, Jingjing Wang, Xiaobing Yu, Haiyu Wu, Shao Tang, Zhipeng Wang, Langechuan Liu, Shan Lin, Oana Dumitrascu, Yalin Wang
...
**Comment:** Matches criterion 2: Shows new MLLMs. Introduces OphIn-500K, a large-scale multimodal ophthalmology instruction-tuning dataset, and OphIn-VL, an ophthalmology-specific MLLM with advanced visual understanding and conversational capabilities.
**Relevance:** 8
**Novelty:** 7

---

## 10. [Personal Visual Memory from Explicit and Implicit Evidence](https://arxiv.org/abs/2605.28806) <a id="link10"></a>
**ArXiv ID:** 2605.28806
**Authors:** Viet Nguyen, Thao Nguyen, Vishal M. Patel, Yuheng Li
...
**Comment:** Matches criterion 2: Shows new MLLMs. Proposes a benchmark and a hybrid visual-text architecture (VisualMem) for personal visual memory in AI agents, targeting both explicit and implicit visual evidence, and demonstrates substantial improvements over prior systems.
**Relevance:** 8
**Novelty:** 7

---

## 11. [When Think-with-Image Meets Safety: What Determines Multimodal Jailbreak Robustness?](https://arxiv.org/abs/2605.27932) <a id="link11"></a>
**ArXiv ID:** 2605.27932
**Authors:** Yuan Tian, Bing Hu, Fang Wu, Xiaomin Li, Binghang Lu, Neil Zhenqiang Gong
...
**Comment:** Matches criterion 2: Shows new VLLMs or MLLMs. The paper investigates safety and jailbreak robustness in vision-language models using think-with-image reasoning, and introduces a novel analysis framework for multimodal jailbreak robustness.
**Relevance:** 8
**Novelty:** 7

---

## 12. [MORI-Seg: Learning Morphological Geometry for Instance Segmentation without Instance Annotations](https://arxiv.org/abs/2605.28261) <a id="link12"></a>
**ArXiv ID:** 2605.28261
**Authors:** Leiyue Zhao, Tianyu Shi, Daniel Reisenbuchler, Xinzi He, Junchao Zhu, Tianyuan Yao, Yuechen Yang, Yanfan Zhu, Junlin Guo, Gelei Xu, Haichun Yang, Yuankai Huo, Mert R. Sabuncu, Yihe Yang, Ruining Deng
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Proposes MORI-Seg, a deep learning framework for instance segmentation without instance-level annotations, learning morphological geometry from semantic masks. This is a novel approach in computer vision.
**Relevance:** 8
**Novelty:** 7

---

## 13. [Reflective Dialogue between Teacher and Solver Agents for Video Question Answering](https://arxiv.org/abs/2605.27885) <a id="link13"></a>
**ArXiv ID:** 2605.27885
**Authors:** Takuya Murakawa, Toru Tamaki
...
**Comment:** Matches criterion 2 (VLLMs/MLLMs) and is relevant to vision-language models for video question answering. Proposes a reflective dialogue adaptation method for VLMs at inference time, which is a clever empirical approach.
**Relevance:** 7
**Novelty:** 7

---

## 14. [Residualized Temporal Sparse Autoencoders for Interpreting Diffusion Models](https://arxiv.org/abs/2605.27813) <a id="link14"></a>
**ArXiv ID:** 2605.27813
**Authors:** Calvin Yeung, Prathyush Poduval, Ali Zakeri, Zhuowen Zou, Mohsen Imani
...
**Comment:** Related to criterion 4: Vision foundation models and their applications. This paper introduces a new method for interpreting diffusion models (a type of vision foundation model) using residualized temporal sparse autoencoders, providing new insights into their internal representations.
**Relevance:** 6
**Novelty:** 7

---

## 15. [From Affect to Complex Behavior: Advancing Multimodal Human-Centered AI at the 10th ABAW Workshop & Competition](https://arxiv.org/abs/2605.27451) <a id="link15"></a>
**ArXiv ID:** 2605.27451
**Authors:** Dimitrios Kollias, Panagiotis Tzirakis, Alan Cowen, Stefanos Zafeiriou, Irene Kotsia, Eric Granger, Marco Pedersoli, Simon Bacon, Jens Madsen, Soufiane Belharbi, Muhammad Haseeb Aslam, Chunchang Shao, Guanyu Hu
...
**Comment:** Matches criterion 3: Embodied AI papers on building new benchmarks (simulator related) or new methods, with a focus on novel angles. The ABAW workshop introduces new challenges and benchmarks for multimodal, human-centered AI, including complex behavior analysis and multimodal learning.
**Relevance:** 7
**Novelty:** 6

---

## 16. [SmartDirector: Keyframe-Conditioned Cinematic Video Generation with Narrative Pacing Control](https://arxiv.org/abs/2605.27891) <a id="link16"></a>
**ArXiv ID:** 2605.27891
**Authors:** Zhida Zhang, Jie Ma, Zhan Peng, Haoxue Wu, Yang Han, Jun Liang, Jie Cao, Jing Li
...
**Comment:** Related to generative modeling in multi-modal learning (criterion 4), but focuses on cinematic video generation with narrative pacing control. While it is a strong vision foundation model application, it does not introduce a new VLLM/MLLM or spatial intelligence method.
**Relevance:** 5
**Novelty:** 7

---

## 17. [HarmoVid: Relightful Video Portrait Harmonization](https://arxiv.org/abs/2605.28811) <a id="link17"></a>
**ArXiv ID:** 2605.28811
**Authors:** Jun Myeong Choi, Jae Shin Yoon, Luchao Qi, Roni Sengupta, Joon-Young Lee
...
**Comment:** Applies diffusion models to video harmonization, which is an application of vision foundation models (criterion 4). The main novelty is in the lighting deflickering and harmonization for videos, but not directly about spatial intelligence or VLLMs/MLLMs.
**Relevance:** 5
**Novelty:** 6

---

## 18. [GONDOR to the Rescue: Satisficing Planning with Low Memory](https://arxiv.org/abs/2605.28454) <a id="link18"></a>
**ArXiv ID:** 2605.28454
**Authors:** Yonatan Vernik, Alexander Tuisov, Alexander Shleyfman
...
**Comment:** Somewhat related to criterion 1: New methodological improvements to spatial understanding on embodied agents, as it introduces a memory-efficient planning algorithm (GONDOR) for navigation and pathfinding, which are spatial tasks. However, it is more focused on search algorithms than embodied agents per se.
**Relevance:** 5
**Novelty:** 6

---

## 19. [Decoupled Training with Local Reinforcement Fine-Tuning in Federated Learning](https://arxiv.org/abs/2605.27900) <a id="link19"></a>
**ArXiv ID:** 2605.27900
**Authors:** Yuting Ma, Lechao Cheng, Xiaohua Xu
...
**Comment:** Somewhat related to criterion 2: Shows new VLLMs or MLLMs, as it discusses federated learning with pre-trained vision-language models (VLMs) and introduces a new federated VLM framework (FedDTL). However, the focus is more on federated learning methodology than on the VLMs themselves.
**Relevance:** 5
**Novelty:** 6

---

## 20. [EAPO: Entropy-Driven Adaptive Positive-Negative Sample Weighting for Policy Optimization in Open-Ended QA](https://arxiv.org/abs/2605.27846) <a id="link20"></a>
**ArXiv ID:** 2605.27846
**Authors:** Yunsheng Zeng, Gen Li, Yuwei Miao, Xiandong Li, Yujin Wang, Siyu Chen, Luning Wang, Yunhao Qiao, Junfeng Wang, Jianwei Lv, Bo Yuan
...
**Comment:** This paper proposes a new entropy-driven adaptive policy optimization for open-ended QA in large reasoning models. It is not focused on spatial intelligence, VLLMs/MLLMs, or vision/embodied AI, but does introduce a clever statistical trick for RL in language models.
**Relevance:** 4
**Novelty:** 6

---

## 21. [Hierarchical Prompt-Domain Control and Learning for Resource-Constrained Agentic Language Models](https://arxiv.org/abs/2605.27703) <a id="link21"></a>
**ArXiv ID:** 2605.27703
**Authors:** Joan Vendrell Gallart, Russell Bent, Michael Grosskopf
...
**Comment:** This paper proposes a hierarchical control-and-learning framework for agentic LLMs under resource constraints. While it is about agentic LLMs, it does not focus on spatial intelligence, VLLMs/MLLMs, or vision/embodied AI. It is more about prompt management and reliability in agentic LLMs.
**Relevance:** 4
**Novelty:** 6

---

## 22. [Laguna M.1/XS.2 Technical Report](https://arxiv.org/abs/2605.27605) <a id="link22"></a>
**ArXiv ID:** 2605.27605
**Authors:** Julien Abadji, Marah Abdin, Connor Adams, Eric Alcaide, Mustafa Altun, Michele Artoni, Junze Bao, Uday Barar, Vassilis Bekiaris, Arkadii Bessonov, Benjamin B\"utikofer, Jonathan Chang, Yen-Chun Chen, Dmitry Chernenkov, Yang Chi, Filippos Christianos, Fenia Christopoulou, Razvan-Andrei Ciocoiu, Tzachi Cohen, Yohann Coppel, Dmitrii Emelianenko, Brandon Fergerson, Brian Fitzgerald, Matthias Gall\'e, Alex Golonzovskyi, George Grigorev, Yiyang Hao, Christian Hensel, Jan Huenermann, Ye Ji, Sarthak Joshi, Eiso Kant, Kabir Khandpur, Seonghyeon Kim, Vladimir Kirichenko, Umut Kocasarac, Ilya Kochik, Ivan Komarov, Chaerin Kong, Anurag Koul, Fran\c{c}ois-Joseph Lacroix, Sergei Laktionov, Waren Long, Quentin Malartic, Vadim Markovtsev, Afonso Marques, Robert McHardy, Carlos Mochol\'i, Dmitry Monakhov, Adam Morris, Martin Muller, Christian M\"urtz, Robin Nabel, Thien Nguyen, Rok Novosel, Szymon Ozog, Aalhad Patankar, Aleksei Petrov, Alexandre Pich\'e, Arthur Pignet, Teodor Poncu, Phil Potter, Alexander Rakowski, Pierre-Yves Ritschard, Jay Roberts, Joe Rowell, Piotr Sarna, Pierre-Andr\'e Savalle, Uladzislau Sazanovich, Nikita Shapovalov, Arsenii Shevchenko, Mikhail Shilkov, Andrei Sokol, Mohamed Soliman, Jack Stephenson, Victor Storchan, Dragos-Constantin Tantaru, Artem Tyurin, Adrian W\"alchli, Pengming Wang, Jianxiao Yang, Renat Zayashnikov, Alexander Zelenka Martin, Nikolay Zinov, Caroline Bercier, Jos\'e Caldeira, Margarida Garcia, Tom George, Kabeer Gharzai, Glenn Hitchcock, Carson Klingenberg, Ivo Pinto, Varun Randery, Noah Smith, Arina Sugako, Jason Warner
...
**Comment:** Describes new Mixture-of-Experts foundation models for coding, not directly related to spatial intelligence, VLLMs/MLLMs for vision, embodied AI, or vision foundation models in the visual domain.
**Relevance:** 3
**Novelty:** 6

---

## 23. [C-MIG: Multi-view Information Gain-based Retrieval-Augmented Generation for Clinical Diagnosis Reasoning](https://arxiv.org/abs/2605.27860) <a id="link23"></a>
**ArXiv ID:** 2605.27860
**Authors:** Yuwei Miao, Gen Li, Yunsheng Zeng, Xiandong Li, Yujin Wang, Siyu Chen, Luning Wang, Yunhao Qiao, Junfeng Wang, Jianwei Lv, Bo Yuan
...
**Comment:** Primarily focused on retrieval-augmented generation for clinical diagnosis, not directly related to spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models. Only tangentially relevant to multi-modal learning.
**Relevance:** 3
**Novelty:** 6

---

## 24. [On the Origin of Synthetic Information by Means of Steganographic Inheritance](https://arxiv.org/abs/2605.27551) <a id="link24"></a>
**ArXiv ID:** 2605.27551
**Authors:** Ching-Chun Chang, Isao Echizen
...
**Comment:** This paper proposes a steganographic mechanism for tracing synthetic information lineage. While interesting, it is not focused on spatial intelligence, VLLMs/MLLMs, or vision/embodied AI.
**Relevance:** 3
**Novelty:** 6

---

## 25. [A Policy-Driven Runtime Layer for Agentic LLM Serving](https://arxiv.org/abs/2605.27744) <a id="link25"></a>
**ArXiv ID:** 2605.27744
**Authors:** Rui Zhang, Chaeeun Kim, Liting Hu
...
**Comment:** This paper introduces a new runtime layer for agentic LLM serving, focusing on system architecture and serving efficiency. It is not directly about spatial intelligence, VLLMs/MLLMs, or vision/embodied AI, but is relevant to agentic LLM systems.
**Relevance:** 4
**Novelty:** 5

---

## 26. [Measuring Progress Toward AGI: A Cognitive Framework](https://arxiv.org/abs/2605.28405) <a id="link26"></a>
**ArXiv ID:** 2605.28405
**Authors:** Ryan Burnell, Yumeya Yamamori, Orhan Firat, Kate Olszewska, Steph Hughes-Fitt, Oran Kelly, Isaac R. Galatzer-Levy, Meredith Ringel Morris, Allan Dafoe, Alison M. Snyder, Noah D. Goodman, Matthew Botvinick, Shane Legg
...
**Comment:** Not directly related to any specific criterion. The paper proposes a cognitive framework for measuring AGI progress, which is more general and not focused on spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 27. [Data-Efficient On-Policy Distillation for Automatic Speech Recognition](https://arxiv.org/abs/2605.28139) <a id="link27"></a>
**ArXiv ID:** 2605.28139
**Authors:** Yu Lin, Yiming Wang, Runyuan Cai, Xiaodong Zeng
...
**Comment:** This paper is about data-efficient on-policy distillation for ASR models. It is not focused on spatial intelligence, VLLMs/MLLMs, or vision/embodied AI, but is relevant to multi-modal learning (audio-text).
**Relevance:** 3
**Novelty:** 5

---

## 28. [PetroBench: A Benchmark for Large Language Models in Petroleum Engineering](https://arxiv.org/abs/2605.28032) <a id="link28"></a>
**ArXiv ID:** 2605.28032
**Authors:** Xiang Wang, Tingting Zhang, Sen Wang, Ying Wu, Heng Meng, Peng Zhou, Peng Li
...
**Comment:** This paper introduces a new benchmark for LLMs in petroleum engineering, but it is domain-specific and not focused on spatial intelligence, embodied agents, VLLMs/MLLMs, or vision foundation models. It is only tangentially related to your friend's interests.
**Relevance:** 3
**Novelty:** 4
