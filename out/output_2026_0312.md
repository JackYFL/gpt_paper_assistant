...
0. [Overcoming Visual Clutter in Vision Language Action Models via Concept-Gated Visual Distillation](#link0)
**Authors:** Sangmim Song, Sarath Kodagoda, Marc Carmichael, Karthick Thiyagarajan

1. [GroundCount: Grounding Vision-Language Models with Object Detection for Mitigating Counting Hallucinations](#link1)
**Authors:** Boyuan Chen, Minghao Shao, Siddharth Garg, Ramesh Karri, Muhammad Shafique

2. [GeoSense: Internalizing Geometric Necessity Perception for Multimodal Reasoning](#link2)
**Authors:** Ruiheng Liu, Haihong Hao, Mingfei Han, Xin Gu, Kecheng Zhang, Changlin Li, Xiaojun Chang

3. [WalkGPT: Grounded Vision-Language Conversation with Depth-Aware Segmentation for Pedestrian Navigation](#link3)
**Authors:** Rafi Ibn Sultan, Hui Zhu, Xiangyu Zhou, Chengyin Li, Prashant Khanduri, Marco Brocanelli, Dongxiao Zhu

4. [CodePercept: Code-Grounded Visual STEM Perception for MLLMs](#link4)
...
5. [HanMoVLM: Large Vision-Language Models for Professional Artistic Painting Evaluation](#link5)
**Authors:** Hongji Yang, Yucheng Zhou, Wencheng Han, Songlian Li, Xiaotong Zhao, Jianbing Shen

6. [Motion Forcing: A Decoupled Framework for Robust Video Generation in Motion Dynamics](#link6)
**Authors:** Tianshuo Xu, Zhifei Chen, Leyi Wu, Hao Lu, Ying-cong Chen

7. [BALD-SAM: Disagreement-based Active Prompting in Interactive Segmentation](#link7)
**Authors:** Prithwijit Chowdhury, Mohit Prabhushankar, Ghassan AlRegib

8. [Too Vivid to Be Real? Benchmarking and Calibrating Generative Color Fidelity](#link8)
**Authors:** Zhengyao Fang, Zexi Jia, Yijia Zhong, Pengcheng Luo, Jinchao Zhang, Guangming Lu, Jun Yu, Wenjie Pei

9. [Lifelong Imitation Learning with Multimodal Latent Replay and Incremental Adjustment](#link9)
**Authors:** Fanqi Yu, Matteo Tiezzi, Tommaso Apicella, Cigdem Beyan, Vittorio Murino

10. [On the Reliability of Cue Conflict and Beyond](#link10)
**Authors:** Pum Jun Kim, Seung-Ah Lee, Seongho Park, Dongyoon Han, Jaejun Yoo

11. [Towards Cognitive Defect Analysis in Active Infrared Thermography with Vision-Text Cues](#link11)
...
12. [Beyond Sequential Distance: Inter-Modal Distance Invariant Position Encoding](#link12)
**Authors:** Lin Chen, Bolin Ni, Qi Yang, Zili Wang, Kun Ding, Ying Wang, Houwen Peng, Shiming Xiang

13. [From Imitation to Intuition: Intrinsic Reasoning for Open-Instance Video Classification](#link13)
**Authors:** Ke Zhang, Xiangchen Zhao, Yunjie Tian, Jiayu Zheng, Vishal M. Patel, Di Fu

14. [Less is More: Decoder-Free Masked Modeling for Efficient Skeleton Representation Learning](#link14)
**Authors:** Jeonghyeok Do, Yun Chen, Geunhyuk Youk, Munchurl Kim

15. [Visually-Guided Controllable Medical Image Generation via Fine-Grained Semantic Disentanglement](#link15)
**Authors:** Xin Huang, Junjie Liang, Qingshan Hou, Peng Cao, Jinzhu Yang, Xiaoli Liu, Osmar R. Zaiane

16. [Need for Speed: Zero-Shot Depth Completion with Single-Step Diffusion](#link16)
**Authors:** Jakub Gregorek, Paraskevas Pegios, Nando Metzger, Konrad Schindler, Theodora Kontogianni, Lazaros Nalpantidis

17. [Bilevel Layer-Positioning LoRA for Real Image Dehazing](#link17)
**Authors:** Yan Zhang, Long Ma, Yuxin Feng, Zhe Huang, Fan Zhou, Zhuo Su

18. [IMTBench: A Multi-Scenario Cross-Modal Collaborative Evaluation Benchmark for In-Image Machine Translation](#link18)
**Authors:** Jiahao Lyu, Pei Fu, Zhenhang Li, Weichao Zeng, Shaojie Zhan, Jiahui Yang, Can Ma, Yu Zhou, Zhenbo Luo, Jian Luan

19. [R4-CGQA: Retrieval-based Vision Language Models for Computer Graphics Image Quality Assessment](#link19)
**Authors:** Zhuangzi Li, Jian Jin, Shilv Cai, Weisi Lin

20. [How To Embed Matters: Evaluation of EO Embedding Design Choices](#link20)
**Authors:** Luis Gilch, Isabelle Wittmann, Maximilian Nitsche, Johannes Jakubik, Arne Ewald, Thomas Brunschwiler

21. [Resource-constrained Amazons chess decision framework integrating large language models and graph attention](#link21)
**Authors:** Tianhao Qian, Zhuoxuan Li, Jinde Cao, Xinli Shi, Hanjie Liu, Leszek Rutkowski

22. [Why Does It Look There? Structured Explanations for Image Classification](#link22)
**Authors:** Jiarui Li, Zixiang Yin, Samuel J Landry, Zhengming Ding, Ramgopal R. Mettu

23. [Event-based Photometric Stereo via Rotating Illumination and Per-Pixel Learning](#link23)
**Authors:** Hyunwoo Kim, Won-Hoe Kim, Sanghoon Lee, Jianfei Cai, Giljoo Nam, Jae-Sang Hyun

24. [Just-in-Time: Training-Free Spatial Acceleration for Diffusion Transformers](#link24)
**Authors:** Wenhao Sun, Ji Li, Zhaoqiang Liu

25. [Backdoor Directions in Vision Transformers](#link25)
**Authors:** Sengim Karayalcin, Marina Krcek, Pin-Yu Chen, Stjepan Picek

26. [TractoRC: A Unified Probabilistic Learning Framework for Joint Tractography Registration and Clustering](#link26)
**Authors:** Yijie Li, Xi Zhu, Junyi Wang, Ye Wu, Lauren J. O'Donnell, Fan Zhang

27. [A dataset of medication images with instance segmentation masks for preventing adverse drug events](#link27)
**Authors:** W. I. Chu, S. Hirani, G. Tarroni, L. Li

28. [HEAL: Hindsight Entropy-Assisted Learning for Reasoning Distillation](#link28)
...
29. [UHD Image Deblurring via Autoregressive Flow with Ill-conditioned Constraints](#link29)
**Authors:** Yucheng Xin, Dawei Zhao, Xiang Chen, Chen Wu, Pu Wang, Dianjie Lu, Guijuan Zhang, Xiuyi Jia, Zhuoran Zheng

30. [Sparse Task Vector Mixup with Hypernetworks for Efficient Knowledge Transfer in Whole-Slide Image Prognosis](#link30)
**Authors:** Pei Liu, Xiangxiang Zeng, Tengfei Ma, Yucheng Xing, Xuanbai Ren, Yiping Liu

31. [Multi-Person Pose Estimation Evaluation Using Optimal Transportation and Improved Pose Matching](#link31)
**Authors:** Takato Moriki, Hiromu Taketsugu, Norimichi Ukita

32. [StructDamage:A Large Scale Unified Crack and Surface Defect Dataset for Robust Structural Damage Detection](#link32)
**Authors:** Misbah Ijaz, Saif Ur Rehman Khan, Abd Ur Rehman, Sebastian Vollmer, Andreas Dengel, Muhammad Nabeel Asim

33. [Evaluating Few-Shot Pill Recognition Under Visual Domain Shift](#link33)
**Authors:** W. I. Chu, G. Tarroni, L. Li

34. [Contrastive learning-based video quality assessment-jointed video vision transformer for video recognition](#link34)
**Authors:** Jian Sun, Mohammad H. Mahoor

---
## 0. [Overcoming Visual Clutter in Vision Language Action Models via Concept-Gated Visual Distillation](https://arxiv.org/abs/2603.10340) <a id="link0"></a>
**ArXiv ID:** 2603.10340
**Authors:** Sangmim Song, Sarath Kodagoda, Marc Carmichael, Karthick Thiyagarajan
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 3 (novel method for robust manipulation in cluttered environments, focusing on spatial disambiguation and visual distillation). The method is model-agnostic and inference-time, which is a clever statistical trick for embodied AI.
**Relevance:** 10
**Novelty:** 8

---

## 1. [GroundCount: Grounding Vision-Language Models with Object Detection for Mitigating Counting Hallucinations](https://arxiv.org/abs/2603.10978) <a id="link1"></a>
**ArXiv ID:** 2603.10978
**Authors:** Boyuan Chen, Minghao Shao, Siddharth Garg, Ramesh Karri, Muhammad Shafique
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 1 (spatial understanding in VLMs). Proposes a framework to mitigate counting hallucinations in VLMs by grounding with object detection, with detailed ablation on spatial-semantic integration.
**Relevance:** 10
**Novelty:** 8

---

## 2. [GeoSense: Internalizing Geometric Necessity Perception for Multimodal Reasoning](https://arxiv.org/abs/2603.10370) <a id="link2"></a>
**ArXiv ID:** 2603.10370
**Authors:** Ruiheng Liu, Haihong Hao, Mingfei Han, Xin Gu, Kecheng Zhang, Changlin Li, Xiaojun Chang
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding in MLLMs) and criterion 2 (shows new MLLM with spatial reasoning improvements). The paper introduces a framework for spatial awareness in MLLMs, with a novel geometry input channel and spatial-aware fine-tuning.
**Relevance:** 10
**Novelty:** 8

---

## 3. [WalkGPT: Grounded Vision-Language Conversation with Depth-Aware Segmentation for Pedestrian Navigation](https://arxiv.org/abs/2603.10703) <a id="link3"></a>
**ArXiv ID:** 2603.10703
**Authors:** Rafi Ibn Sultan, Hui Zhu, Xiangyu Zhou, Chengyin Li, Prashant Khanduri, Marco Brocanelli, Dongxiao Zhu
...
**Comment:** Matches criterion 1 (spatial understanding on embodied agents), 2 (LVLMs), and 3 (new benchmark for embodied AI). Proposes WalkGPT, a pixel-grounded LVLM for pedestrian navigation with depth-aware segmentation, and introduces a new benchmark (PAVE).
**Relevance:** 10
**Novelty:** 8

---

## 4. [CodePercept: Code-Grounded Visual STEM Perception for MLLMs](https://arxiv.org/abs/2603.10757) <a id="link4"></a>
**ArXiv ID:** 2603.10757
**Authors:** Tongkun Guan, Zhibo Yang, Jianqiang Wan, Mingkun Yang, Zhengtao Guo, Zijian Hu, Ruilin Luo, Ruize Chen, Songtao Jiang, Peng Wang, Wei Shen, Junyang Lin, Xiaokang Yang
...
**Comment:** Strongly matches criterion 2 (new MLLMs) and 4 (vision foundation models and applications). Introduces a code-grounded perception paradigm for MLLMs in STEM, a new large dataset, and a novel benchmark for visual perception in STEM domains.
**Relevance:** 10
**Novelty:** 8

---

## 5. [HanMoVLM: Large Vision-Language Models for Professional Artistic Painting Evaluation](https://arxiv.org/abs/2603.10814) <a id="link5"></a>
**ArXiv ID:** 2603.10814
**Authors:** Hongji Yang, Yucheng Zhou, Wencheng Han, Songlian Li, Xiaotong Zhao, Jianbing Shen
...
**Comment:** Matches criterion 2 and 4: Introduces HanMoVLM, a new large vision-language model (VLM) for professional artistic painting evaluation, and demonstrates its application as a verifier for generative models, with a new dataset and expert-level reasoning.
**Relevance:** 9
**Novelty:** 8

---

## 6. [Motion Forcing: A Decoupled Framework for Robust Video Generation in Motion Dynamics](https://arxiv.org/abs/2603.10408) <a id="link6"></a>
**ArXiv ID:** 2603.10408
**Authors:** Tianshuo Xu, Zhifei Chen, Leyi Wu, Hao Lu, Ying-cong Chen
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding for video generation) and criterion 4 (vision foundation models and applications). Introduces a decoupled framework for robust video generation with explicit physical reasoning, using a hierarchical point-shape-appearance paradigm and masked point recovery for learning physical laws.
**Relevance:** 9
**Novelty:** 8

---

## 7. [BALD-SAM: Disagreement-based Active Prompting in Interactive Segmentation](https://arxiv.org/abs/2603.10828) <a id="link7"></a>
**ArXiv ID:** 2603.10828
**Authors:** Prithwijit Chowdhury, Mohit Prabhushankar, Ghassan AlRegib
...
**Comment:** Matches criterion 4: Presents a novel application and methodological improvement for vision foundation models (SAM) by introducing active prompting using Bayesian Active Learning by Disagreement (BALD) for interactive segmentation, with strong empirical results.
**Relevance:** 8
**Novelty:** 8

---

## 8. [Too Vivid to Be Real? Benchmarking and Calibrating Generative Color Fidelity](https://arxiv.org/abs/2603.10990) <a id="link8"></a>
**ArXiv ID:** 2603.10990
**Authors:** Zhengyao Fang, Zexi Jia, Yijia Zhong, Pengcheng Luo, Jinchao Zhang, Guangming Lu, Jun Yu, Wenjie Pei
...
**Comment:** Matches criterion 4 (vision foundation models and their applications), specifically benchmarking and improving generative color fidelity in T2I models. Introduces a new dataset, metric, and refinement method.
**Relevance:** 8
**Novelty:** 8

---

## 9. [Lifelong Imitation Learning with Multimodal Latent Replay and Incremental Adjustment](https://arxiv.org/abs/2603.10929) <a id="link9"></a>
**ArXiv ID:** 2603.10929
**Authors:** Fanqi Yu, Matteo Tiezzi, Tommaso Apicella, Cigdem Beyan, Vittorio Murino
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial intelligence on embodied agents) and criterion 3 (new method for lifelong imitation learning in embodied AI, with a novel multimodal latent replay and incremental adjustment). Strong results on LIBERO benchmarks.
**Relevance:** 9
**Novelty:** 7

---

## 10. [On the Reliability of Cue Conflict and Beyond](https://arxiv.org/abs/2603.10834) <a id="link10"></a>
**ArXiv ID:** 2603.10834
**Authors:** Pum Jun Kim, Seung-Ah Lee, Seongho Park, Dongyoon Han, Jaejun Yoo
...
**Comment:** Matches criterion 3 and 4: Proposes REFINED-BIAS, a new benchmark and evaluation framework for diagnosing shape-texture bias in vision models, addressing limitations of previous benchmarks and enabling fairer cross-model comparisons.
**Relevance:** 8
**Novelty:** 7

---

## 11. [Towards Cognitive Defect Analysis in Active Infrared Thermography with Vision-Text Cues](https://arxiv.org/abs/2603.10549) <a id="link11"></a>
**ArXiv ID:** 2603.10549
**Authors:** Mohammed Salah, Eman Ouda, Giuseppe Dell'Avvocato, Fabrizio Sarasini, Ester D'Accardi, Jorge Dias, Davor Svetinovic, Stefano Sfarra, Yusra Abdulrahman
...
**Comment:** Matches criterion 2 (shows new VLLMs/MLLMs) and criterion 4 (application of vision foundation models to a new domain: thermographic defect analysis). Uses pretrained multimodal VLMs for zero-shot defect detection, with a novel adapter for domain alignment.
**Relevance:** 8
**Novelty:** 7

---

## 12. [Beyond Sequential Distance: Inter-Modal Distance Invariant Position Encoding](https://arxiv.org/abs/2603.10863) <a id="link12"></a>
**ArXiv ID:** 2603.10863
**Authors:** Lin Chen, Bolin Ni, Qi Yang, Zili Wang, Kun Ding, Ying Wang, Houwen Peng, Shiming Xiang
...
**Comment:** Matches criterion 2 (MLLMs) and 4 (vision foundation models and applications). Proposes a new position encoding (DIPE) to address visual fading in long-context MLLMs, with code released.
**Relevance:** 8
**Novelty:** 7

---

## 13. [From Imitation to Intuition: Intrinsic Reasoning for Open-Instance Video Classification](https://arxiv.org/abs/2603.10300) <a id="link13"></a>
**ArXiv ID:** 2603.10300
**Authors:** Ke Zhang, Xiangchen Zhao, Yunjie Tian, Jiayu Zheng, Vishal M. Patel, Di Fu
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and 4 (vision foundation models and applications). Proposes a new intrinsic reasoning framework leveraging VLMs for open-instance video classification, with a novel calibration stage and reinforcement learning refinement.
**Relevance:** 8
**Novelty:** 7

---

## 14. [Less is More: Decoder-Free Masked Modeling for Efficient Skeleton Representation Learning](https://arxiv.org/abs/2603.10648) <a id="link14"></a>
**ArXiv ID:** 2603.10648
**Authors:** Jeonghyeok Do, Yun Chen, Geunhyuk Youk, Munchurl Kim
...
**Comment:** Matches criterion 1: Proposes a new methodological improvement for spatial understanding in skeleton-based action representation learning, introducing a decoder-free masked modeling approach and semantic tube masking for better spatial-temporal representation.
**Relevance:** 7
**Novelty:** 7

---

## 15. [Visually-Guided Controllable Medical Image Generation via Fine-Grained Semantic Disentanglement](https://arxiv.org/abs/2603.10519) <a id="link15"></a>
**ArXiv ID:** 2603.10519
**Authors:** Xin Huang, Junjie Liang, Qingshan Hou, Peng Cao, Jinzhu Yang, Xiaoli Liu, Osmar R. Zaiane
...
**Comment:** Matches criterion 4 (vision foundation models and their applications), specifically for controllable medical image generation using diffusion transformers and cross-modal disentanglement.
**Relevance:** 7
**Novelty:** 7

---

## 16. [Need for Speed: Zero-Shot Depth Completion with Single-Step Diffusion](https://arxiv.org/abs/2603.10584) <a id="link16"></a>
**ArXiv ID:** 2603.10584
**Authors:** Jakub Gregorek, Paraskevas Pegios, Nando Metzger, Konrad Schindler, Theodora Kontogianni, Lazaros Nalpantidis
...
**Comment:** Related to vision foundation models (diffusion models) and their application to depth completion (criterion 4). Also uses a clever statistical trick (single-step diffusion for efficiency).
**Relevance:** 7
**Novelty:** 7

---

## 17. [Bilevel Layer-Positioning LoRA for Real Image Dehazing](https://arxiv.org/abs/2603.10872) <a id="link17"></a>
**ArXiv ID:** 2603.10872
**Authors:** Yan Zhang, Long Ma, Yuxin Feng, Zhe Huang, Fan Zhou, Zhuo Su
...
**Comment:** Applies CLIP-based cross-modal loss and LoRA adaptation for image dehazing. Uses vision foundation models (criterion 4) in a novel way for unsupervised dehazing adaptation.
**Relevance:** 7
**Novelty:** 7

---

## 18. [IMTBench: A Multi-Scenario Cross-Modal Collaborative Evaluation Benchmark for In-Image Machine Translation](https://arxiv.org/abs/2603.10495) <a id="link18"></a>
**ArXiv ID:** 2603.10495
**Authors:** Jiahao Lyu, Pei Fu, Zhenhang Li, Weichao Zeng, Shaojie Zhan, Jiahui Yang, Can Ma, Yu Zhou, Zhenbo Luo, Jian Luan
...
**Comment:** Matches criterion 3 (new benchmark for multi-modal/vision-language models). Introduces IMTBench, a new benchmark for in-image machine translation with multi-aspect evaluation and cross-modal alignment.
**Relevance:** 7
**Novelty:** 7

---

## 19. [R4-CGQA: Retrieval-based Vision Language Models for Computer Graphics Image Quality Assessment](https://arxiv.org/abs/2603.10578) <a id="link19"></a>
**ArXiv ID:** 2603.10578
**Authors:** Zhuangzi Li, Jian Jin, Shilv Cai, Weisi Lin
...
**Comment:** Matches criterion 2 (VLLMs) and 4 (vision foundation models and applications). Proposes a retrieval-augmented VLM for computer graphics image quality assessment and introduces a new dataset and evaluation protocol.
**Relevance:** 7
**Novelty:** 6

---

## 20. [How To Embed Matters: Evaluation of EO Embedding Design Choices](https://arxiv.org/abs/2603.10658) <a id="link20"></a>
**ArXiv ID:** 2603.10658
**Authors:** Luis Gilch, Isabelle Wittmann, Maximilian Nitsche, Johannes Jakubik, Arne Ewald, Thomas Brunschwiler
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Systematic analysis of embedding design in geospatial foundation models, with insights into representation aggregation and robustness.
**Relevance:** 6
**Novelty:** 6

---

## 21. [Resource-constrained Amazons chess decision framework integrating large language models and graph attention](https://arxiv.org/abs/2603.10512) <a id="link21"></a>
**ArXiv ID:** 2603.10512
**Authors:** Tianhao Qian, Zhuoxuan Li, Jinde Cao, Xinli Shi, Hanjie Liu, Leszek Rutkowski
...
**Comment:** Applies LLMs and graph attention to game AI, but not specifically spatial understanding in embodied agents or vision foundation models. Some relevance to multi-modal learning, but not a direct match.
**Relevance:** 4
**Novelty:** 6

---

## 22. [Why Does It Look There? Structured Explanations for Image Classification](https://arxiv.org/abs/2603.10234) <a id="link22"></a>
**ArXiv ID:** 2603.10234
**Authors:** Jiarui Li, Zixiang Yin, Samuel J Landry, Zhengming Ding, Ramgopal R. Mettu
...
**Comment:** Somewhat related to criterion 4 (vision foundation models and their interpretability), but mainly focuses on explainability for image classification models, not specifically VLMs or MLLMs. Interesting for model interpretability, but not a direct match.
**Relevance:** 4
**Novelty:** 6

---

## 23. [Event-based Photometric Stereo via Rotating Illumination and Per-Pixel Learning](https://arxiv.org/abs/2603.10748) <a id="link23"></a>
**ArXiv ID:** 2603.10748
**Authors:** Hyunwoo Kim, Won-Hoe Kim, Sanghoon Lee, Jianfei Cai, Giljoo Nam, Jae-Sang Hyun
...
**Comment:** Presents an event-based photometric stereo system with per-pixel learning. While innovative for 3D vision, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, or benchmarks.
**Relevance:** 4
**Novelty:** 6

---

## 24. [Just-in-Time: Training-Free Spatial Acceleration for Diffusion Transformers](https://arxiv.org/abs/2603.10744) <a id="link24"></a>
**ArXiv ID:** 2603.10744
**Authors:** Wenhao Sun, Ji Li, Zhaoqiang Liu
...
**Comment:** Relevant to generative modeling in vision (diffusion transformers), but does not directly match any specific criterion. Proposes a novel spatial acceleration method for diffusion transformers.
**Relevance:** 3
**Novelty:** 7

---

## 25. [Backdoor Directions in Vision Transformers](https://arxiv.org/abs/2603.10806) <a id="link25"></a>
**ArXiv ID:** 2603.10806
**Authors:** Sengim Karayalcin, Marina Krcek, Pin-Yu Chen, Stjepan Picek
...
**Comment:** Does not match any specific criteria. Focuses on backdoor attacks and interpretability in Vision Transformers, which is security-oriented rather than spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation model applications.
**Relevance:** 3
**Novelty:** 6

---

## 26. [TractoRC: A Unified Probabilistic Learning Framework for Joint Tractography Registration and Clustering](https://arxiv.org/abs/2603.10418) <a id="link26"></a>
**ArXiv ID:** 2603.10418
**Authors:** Yijie Li, Xi Zhu, Junyi Wang, Ye Wu, Lauren J. O'Donnell, Fan Zhang
...
**Comment:** Focuses on tractography registration and clustering in diffusion MRI, which is spatial but not embodied AI or vision-language. No direct match to criteria.
**Relevance:** 3
**Novelty:** 6

---

## 27. [A dataset of medication images with instance segmentation masks for preventing adverse drug events](https://arxiv.org/abs/2603.10825) <a id="link27"></a>
**ArXiv ID:** 2603.10825
**Authors:** W. I. Chu, S. Hirani, G. Tarroni, L. Li
...
**Comment:** Introduces a new dataset for medication image segmentation. While useful for benchmarking, it is not focused on embodied AI, spatial intelligence, or VLLMs/MLLMs.
**Relevance:** 4
**Novelty:** 5

---

## 28. [HEAL: Hindsight Entropy-Assisted Learning for Reasoning Distillation](https://arxiv.org/abs/2603.10359) <a id="link28"></a>
**ArXiv ID:** 2603.10359
**Authors:** Wenjing Zhang, Jiangze Yan, Jieyun Huang, Yi Shen, Shuming Shi, Ping Chen, Ning Wang, Zhaoxiang Liu, Kai Wang, Shiguo Lian
...
**Comment:** Relevant to reasoning distillation in language models, but does not directly match any specific criterion. Focuses on RL-free distillation for reasoning models.
**Relevance:** 3
**Novelty:** 6

---

## 29. [UHD Image Deblurring via Autoregressive Flow with Ill-conditioned Constraints](https://arxiv.org/abs/2603.10517) <a id="link29"></a>
**ArXiv ID:** 2603.10517
**Authors:** Yucheng Xin, Dawei Zhao, Xiang Chen, Chen Wu, Pu Wang, Dianjie Lu, Guijuan Zhang, Xiuyi Jia, Zhuoran Zheng
...
**Comment:** Relevant to computer vision and generative modeling, but does not directly match any specific criterion. Focuses on UHD image deblurring with autoregressive flow and novel regularization.
**Relevance:** 3
**Novelty:** 6

---

## 30. [Sparse Task Vector Mixup with Hypernetworks for Efficient Knowledge Transfer in Whole-Slide Image Prognosis](https://arxiv.org/abs/2603.10526) <a id="link30"></a>
**ArXiv ID:** 2603.10526
**Authors:** Pei Liu, Xiangxiang Zeng, Tengfei Ma, Yucheng Xing, Xuanbai Ren, Yiping Liu
...
**Comment:** Focuses on knowledge transfer in whole-slide image prognosis using hypernetworks and mixup. Not directly related to spatial intelligence, VLLMs/MLLMs, or embodied AI.
**Relevance:** 3
**Novelty:** 5

---

## 31. [Multi-Person Pose Estimation Evaluation Using Optimal Transportation and Improved Pose Matching](https://arxiv.org/abs/2603.10398) <a id="link31"></a>
**ArXiv ID:** 2603.10398
**Authors:** Takato Moriki, Hiromu Taketsugu, Norimichi Ukita
...
**Comment:** Relevant to computer vision evaluation metrics, but does not match any specific criterion. Focuses on pose estimation evaluation, not spatial intelligence in embodied agents or VLLMs/MLLMs.
**Relevance:** 3
**Novelty:** 5

---

## 32. [StructDamage:A Large Scale Unified Crack and Surface Defect Dataset for Robust Structural Damage Detection](https://arxiv.org/abs/2603.10484) <a id="link32"></a>
**ArXiv ID:** 2603.10484
**Authors:** Misbah Ijaz, Saif Ur Rehman Khan, Abd Ur Rehman, Sebastian Vollmer, Andreas Dengel, Muhammad Nabeel Asim
...
**Comment:** Does not match any specific criteria. Presents a new dataset for crack and surface defect detection, which is an application of computer vision but not a new method or benchmark for embodied AI, spatial intelligence, or VLLMs/MLLMs.
**Relevance:** 3
**Novelty:** 4

---

## 33. [Evaluating Few-Shot Pill Recognition Under Visual Domain Shift](https://arxiv.org/abs/2603.10833) <a id="link33"></a>
**ArXiv ID:** 2603.10833
**Authors:** W. I. Chu, G. Tarroni, L. Li
...
**Comment:** Evaluates few-shot pill recognition under domain shift. Focuses on robustness and generalization, but not on spatial intelligence, VLLMs/MLLMs, or embodied AI benchmarks.
**Relevance:** 3
**Novelty:** 4

---

## 34. [Contrastive learning-based video quality assessment-jointed video vision transformer for video recognition](https://arxiv.org/abs/2603.10965) <a id="link34"></a>
**ArXiv ID:** 2603.10965
**Authors:** Jian Sun, Mohammad H. Mahoor
...
**Comment:** Applies contrastive learning and video transformers for video classification, but does not address spatial intelligence, VLLMs/MLLMs, or embodied AI benchmarks. General CV/ML interest.
**Relevance:** 3
**Novelty:** 4
