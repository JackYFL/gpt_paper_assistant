# Personalized Daily ArXiv Papers 05/16/2026
...
0. [Learning to Build the Environment: Self-Evolving Reasoning RL via Verifiable Environment Synthesis](#link0)
**Authors:** Yucheng Shi, Zhenwen Liang, Kishan Panaganti, Dian Yu, Wenhao Yu, Haitao Mi

1. [ASH: Agents that Self-Hone via Embodied Learning](#link1)
**Authors:** Benjamin Schneider, Xavier Schneider, Victor Zhong, Sun Sun

2. [From Table to Cell: Attention for Better Reasoning with TABALIGN](#link2)
...
3. [Agentifying Patient Dynamics within LLMs through Interacting with Clinical World Model](#link3)
...
4. [AI Outperforms Humans in Personalized Image Aesthetics Assessment via LLM-Based Interviews and Semantic Feature Extraction](#link4)
**Authors:** Yoshia Abe, Tatsuya Daikoku, Yasuo Kuniyoshi

5. [ClawForge: Generating Executable Interactive Benchmarks for Command-Line Agents](#link5)
...
6. [Coding Agent Is Good As World Simulator](#link6)
**Authors:** Hongyu Wang, Jingquan Wang, Bocheng Zou, Radu Serban, Dan Negrut

7. [Orchard: An Open-Source Agentic Modeling Framework](#link7)
...
8. [$\pi$-Bench: Evaluating Proactive Personal Assistant Agents in Long-Horizon Workflows](#link8)
...
9. [Are Agents Ready to Teach? A Multi-Stage Benchmark for Real-World Teaching Workflows](#link9)
**Authors:** Zixin Chen, Peng Liu, Rui Sheng, Haobo Li, Jianhong Tu, Xiaodong Deng, Kashun Shum, Dayiheng Liu, Huamin Qu

10. [LEMON: Learning Executable Multi-Agent Orchestration via Counterfactual Reinforcement Learning](#link10)
**Authors:** Xudong Chen, Yixin Liu, Hua Wei, Kaize Ding

11. [GraphBit: A Graph-based Agentic Framework for Non-Linear Agent Orchestration](#link11)
**Authors:** Yeahia Sarker, Md Rahmat Ullah, Musa Molla, Shafiq Joty

12. [Good to Go: The LOOP Skill Engine That Hits 99% Success and Slashes Token Usage by 99% via One-Shot Recording and Deterministic Replay](#link12)
**Authors:** Xiaohua Wang, Kai Yu, XuXiao Liang, Liang Wang, Chao Han

13. [Stateful Reasoning via Insight Replay](#link13)
**Authors:** Bin Lei, Caiwen Ding, Jiachen Yang, Ang Li, Xin Eric Wang

14. [Herculean: An Agentic Benchmark for Financial Intelligence](#link14)
...
15. [MediaClaw: Multimodal Intelligent-Agent Platform Technical Report](#link15)
...
16. [CrystalReasoner: Reasoning and RL for Property-Conditioned Crystal Structure Generation](#link16)
**Authors:** Yuyang Wu, Stefano Falletta, Delia McGrath, Sherry Yang

17. [Grounded Continuation: A Linear-Time Runtime Verifier for LLM Conversations](#link17)
**Authors:** Qisong He, Yi Dong, Xiaowei Huang

18. [Case-Based Calibration of Adaptive Reasoning and Execution for LLM Tool Use](#link18)
**Authors:** Renning Pang, Tian Lan, Leyuan Liu, Piao Tong, Sheng Cao, Xiaosong Zhang

19. [Probabilistic Verification of Recurrent Neural Networks for Single and Multi-Agent Reinforcement Learning](#link19)
**Authors:** Luca Marzari, Enrico Marchesini

20. [Beyond Individual Intelligence: Surveying Collaboration, Failure Attribution, and Self-Evolution in LLM-based Multi-Agent Systems](#link20)
...
21. [Model-Adaptive Tool Necessity Reveals the Knowing-Doing Gap in LLM Tool Use](#link21)
**Authors:** Yize Cheng, Chenrui Fan, Mahdi JafariRaviz, Keivan Rezaei, Soheil Feiz

22. [Hypergraph Enterprise Agentic Reasoner over Heterogeneous Business Systems](#link22)
...
23. [Precise Verification of Transformers through ReLU-Catalyzed Abstraction Refinement](#link23)
**Authors:** Hengjie Liu, Zhenya Zhang, Jianjun Zhao

---
## 0. [Learning to Build the Environment: Self-Evolving Reasoning RL via Verifiable Environment Synthesis](https://arxiv.org/abs/2605.14392) <a id="link0"></a>
**ArXiv ID:** 2605.14392
**Authors:** Yucheng Shi, Zhenwen Liang, Kishan Panaganti, Dian Yu, Wenhao Yu, Haitao Mi
...
**Comment:** Matches criterion 3: Proposes EvoEnv, a novel self-evolving reasoning RL framework where the agent constructs its own training environments, focusing on stable self-improvement and environment synthesis. Presents a new angle on embodied AI and benchmarking.
**Relevance:** 10
**Novelty:** 8

---

## 1. [ASH: Agents that Self-Hone via Embodied Learning](https://arxiv.org/abs/2605.14211) <a id="link1"></a>
**ArXiv ID:** 2605.14211
**Authors:** Benjamin Schneider, Xavier Schneider, Victor Zhong, Sun Sun
...
**Comment:** Matches criterion 1 and 3: Introduces a new method (ASH) for embodied agents to learn from unlabeled, noisy internet video without reward shaping or expert annotation, and demonstrates a scalable self-improvement loop for long-horizon embodied learning. Also presents strong empirical results in game environments.
**Relevance:** 10
**Novelty:** 8

---

## 2. [From Table to Cell: Attention for Better Reasoning with TABALIGN](https://arxiv.org/abs/2605.14465) <a id="link2"></a>
**ArXiv ID:** 2605.14465
**Authors:** Tung Sum Thomas Kwok, Zeyong Zhang, Xinyu Wang, Chunhe Wang, Xiaofeng Lin, Hanwei Wu, Lei Ding, Guang Cheng, Zhijiang Guo
...
**Comment:** Matches criterion 2 and 4: Proposes TABALIGN, a new table reasoning framework using diffusion language models (DLMs) for better cell-level attention and reasoning, with significant empirical improvements. Focuses on multi-modal reasoning and foundation model applications.
**Relevance:** 9
**Novelty:** 8

---

## 3. [Agentifying Patient Dynamics within LLMs through Interacting with Clinical World Model](https://arxiv.org/abs/2605.14723) <a id="link3"></a>
**ArXiv ID:** 2605.14723
**Authors:** Minghao Wu, Yuting Yan, Zhenyang Cai, Ke Ji, Chuangsen Fang, Ziying Sheng, Xidong Wang, Rongsheng Wang, Hejia Zhang, Shuang Li, Benyou Wang, Hongyuan Zha
...
**Comment:** Matches criterion 3 (embodied AI with a new agentic method using a Clinical World Model for patient dynamics, with a novel propose-simulate-refine workflow).
**Relevance:** 8
**Novelty:** 8

---

## 4. [AI Outperforms Humans in Personalized Image Aesthetics Assessment via LLM-Based Interviews and Semantic Feature Extraction](https://arxiv.org/abs/2605.14761) <a id="link4"></a>
**ArXiv ID:** 2605.14761
**Authors:** Yoshia Abe, Tatsuya Daikoku, Yasuo Kuniyoshi
...
**Comment:** Matches criterion 2 and 4: Presents a system integrating deep learning and LLMs for personalized image aesthetics assessment, leveraging both low-level and high-level semantic features. Strong empirical results showing AI outperforming humans in this task.
**Relevance:** 8
**Novelty:** 7

---

## 5. [ClawForge: Generating Executable Interactive Benchmarks for Command-Line Agents](https://arxiv.org/abs/2605.14133) <a id="link5"></a>
**ArXiv ID:** 2605.14133
**Authors:** Yuxiang Lai, Peng Xia, Haonian Ji, Kaiwen Xiong, Kaide Zeng, Jiaqi Liu, Fang Wu, Jike Zhong, Zeyu Zheng, Cihang Xie, Huaxiu Yao
...
**Comment:** Matches criterion 3: introduces ClawForge, a generator-backed benchmark for command-line agents under state conflict, focusing on realistic workflow evaluation and persistent state, a novel angle.
**Relevance:** 8
**Novelty:** 7

---

## 6. [Coding Agent Is Good As World Simulator](https://arxiv.org/abs/2605.14398) <a id="link6"></a>
**ArXiv ID:** 2605.14398
**Authors:** Hongyu Wang, Jingquan Wang, Bocheng Zou, Radu Serban, Dan Negrut
...
**Comment:** Matches criterion 3: proposes a new agentic framework for building physics-based world models using code generation and multi-agent coordination, outperforming video-based models in physical accuracy. Relevant for embodied AI and simulators.
**Relevance:** 8
**Novelty:** 7

---

## 7. [Orchard: An Open-Source Agentic Modeling Framework](https://arxiv.org/abs/2605.15040) <a id="link7"></a>
**ArXiv ID:** 2605.15040
**Authors:** Baolin Peng, Wenlin Yao, Qianhui Wu, Hao Cheng, Xiao Yu, Rui Yang, Tao Ge, Alessandrio Sordoni, Xingdi Yuan, Yelong Shen, Pengcheng He, Tong Zhang, Zhou Yu, Jianfeng Gao
...
**Comment:** Matches criterion 3: introduces Orchard, an open-source agentic modeling framework with new environment primitives and agentic recipes, including a vision-language agent (Orchard-GUI). Also relevant to criterion 4 for vision-language applications.
**Relevance:** 8
**Novelty:** 7

---

## 8. [$\pi$-Bench: Evaluating Proactive Personal Assistant Agents in Long-Horizon Workflows](https://arxiv.org/abs/2605.14678) <a id="link8"></a>
**ArXiv ID:** 2605.14678
**Authors:** Haoran Zhang, Luxin Xu, Zhilin Wang, Runquan Gui, Shunkai Zhang, Haodi Lei, Zihao He, Bingsu He, Chicheng Qin, Tong Zhu, Xiaoye Qu, Yang Yang, Yu Cheng, Yafu Li
...
**Comment:** Matches criterion 3: introduces π-Bench, a new benchmark for proactive personal assistant agents in long-horizon workflows, focusing on hidden user intents and proactivity, which is a novel angle.
**Relevance:** 8
**Novelty:** 7

---

## 9. [Are Agents Ready to Teach? A Multi-Stage Benchmark for Real-World Teaching Workflows](https://arxiv.org/abs/2605.14322) <a id="link9"></a>
**ArXiv ID:** 2605.14322
**Authors:** Zixin Chen, Peng Liu, Rui Sheng, Haobo Li, Jianhong Tu, Xiaodong Deng, Kashun Shum, Dayiheng Liu, Huamin Qu
...
**Comment:** Matches criterion 3: introduces EduAgentBench, a new benchmark for evaluating tutor agents in realistic teaching workflows, focusing on holistic teaching capabilities that previous benchmarks ignored.
**Relevance:** 8
**Novelty:** 7

---

## 10. [LEMON: Learning Executable Multi-Agent Orchestration via Counterfactual Reinforcement Learning](https://arxiv.org/abs/2605.14483) <a id="link10"></a>
**ArXiv ID:** 2605.14483
**Authors:** Xudong Chen, Yixin Liu, Hua Wei, Kaize Ding
...
**Comment:** Matches criterion 3 (new method for multi-agent orchestration using counterfactual RL, a novel approach to agent collaboration and credit assignment).
**Relevance:** 8
**Novelty:** 7

---

## 11. [GraphBit: A Graph-based Agentic Framework for Non-Linear Agent Orchestration](https://arxiv.org/abs/2605.13848) <a id="link11"></a>
**ArXiv ID:** 2605.13848
**Authors:** Yeahia Sarker, Md Rahmat Ullah, Musa Molla, Shafiq Joty
...
**Comment:** Matches criterion 3: introduces GraphBit, a graph-based agentic framework for non-linear agent orchestration, addressing reproducibility and workflow control in agentic LLMs. Novel in orchestration and memory architecture.
**Relevance:** 7
**Novelty:** 7

---

## 12. [Good to Go: The LOOP Skill Engine That Hits 99% Success and Slashes Token Usage by 99% via One-Shot Recording and Deterministic Replay](https://arxiv.org/abs/2605.14237) <a id="link12"></a>
**ArXiv ID:** 2605.14237
**Authors:** Xiaohua Wang, Kai Yu, XuXiao Liang, Liang Wang, Chao Han
...
**Comment:** Matches criterion 3 (new method for agent execution in repetitive tasks, focusing on deterministic replay and token efficiency, which is a novel angle for agent reliability and efficiency).
**Relevance:** 7
**Novelty:** 7

---

## 13. [Stateful Reasoning via Insight Replay](https://arxiv.org/abs/2605.14457) <a id="link13"></a>
**ArXiv ID:** 2605.14457
**Authors:** Bin Lei, Caiwen Ding, Jiachen Yang, Ang Li, Xin Eric Wang
...
**Comment:** Matches criterion 1 (methodological improvement to reasoning in agents, specifically maintaining access to critical insights during long reasoning chains). Also relevant to criterion 3 (novel method for reasoning in LLMs).
**Relevance:** 7
**Novelty:** 7

---

## 14. [Herculean: An Agentic Benchmark for Financial Intelligence](https://arxiv.org/abs/2605.14355) <a id="link14"></a>
**ArXiv ID:** 2605.14355
**Authors:** Xueqing Peng, Zhuohan Xie, Yupeng Cao, Haohang Li, Lingfei Qian, Yan Wang, Vincent Jim Zhang, Huan He, Xuguang Ai, Linhai Ma, Ruoyu Xiang, Yueru He, Yi Han, Shuyao Wang, Yuqing Guo, Mingyang Jiang, Yilun Zhao, Youzhong Dong, Xiaoyu Wang, Yankai Chen, Ye Yuan, Qiyuan Zhang, Fuyuan Lyu, Haolun Wu, Yonghan Yang, Zichen Zhao, Yuyang Dai, Fan Zhang, Rania Elbadry, Ayesha Gull, Muhammad Usman Safder, Nuo Chen, Fengbin Zhu, Tianshi Cai, Zimu Wang, Polydoros Giannouris, Yuechen Jiang, Zhiwei Liu, Mohsinul Kabir, Yuyan Wang, Yixiang Zheng, Yangyang Yu, Weijin Liu, Wenbo Cao, Anke Xu, Peng Lu, Jerry Huang, Fengran Mo, Mingquan Lin, Prayag Tiwari, Yijia Zhao, Victor Gutierrez Basulto, Xiao-Yang Liu, Kaleb E Smith, Jiahuan Pei, Arman Cohan, Jimin Huang, Yuehua Tang, Alejandro Lopez-Lira, Xi Chen, Xue Liu, Junichi Tsujii, Jian-Yun Nie, Sophia Ananiadou
...
**Comment:** Matches criterion 3: introduces Herculean, a new benchmark for agentic financial intelligence, evaluating agents on complex workflows beyond static tasks.
**Relevance:** 7
**Novelty:** 6

---

## 15. [MediaClaw: Multimodal Intelligent-Agent Platform Technical Report](https://arxiv.org/abs/2605.14771) <a id="link15"></a>
**ArXiv ID:** 2605.14771
**Authors:** Shaoan Zhao, Huanlin Gao, Qiang Hui, Ting Lu, Xueqiang Guo, Yantao Li, Xinpei Su, Fuyuan Shi, Chao Tan, Fang Zhao, Kai Wang, Shiguo Lian
...
**Comment:** Matches criterion 2 (multimodal agent platform, relevant to MLLMs) and criterion 4 (platform for multimodal capabilities, relevant to vision foundation models and their applications).
**Relevance:** 7
**Novelty:** 6

---

## 16. [CrystalReasoner: Reasoning and RL for Property-Conditioned Crystal Structure Generation](https://arxiv.org/abs/2605.14344) <a id="link16"></a>
**ArXiv ID:** 2605.14344
**Authors:** Yuyang Wu, Stefano Falletta, Delia McGrath, Sherry Yang
...
**Comment:** Somewhat matches criterion 4: proposes CrystalReasoner, an LLM-based generative model for property-conditioned crystal structure generation, using RL and reasoning. Interesting for generative modeling and multi-modal learning, but not directly a vision foundation model.
**Relevance:** 5
**Novelty:** 7

---

## 17. [Grounded Continuation: A Linear-Time Runtime Verifier for LLM Conversations](https://arxiv.org/abs/2605.14175) <a id="link17"></a>
**ArXiv ID:** 2605.14175
**Authors:** Qisong He, Yi Dong, Xiaowei Huang
...
**Comment:** Somewhat matches criterion 2: proposes a runtime verifier for LLM conversations using explicit dependency graphs and formal logic, improving conversation soundness. Not a new VLLM/MLLM, but a novel method for LLM reliability.
**Relevance:** 5
**Novelty:** 6

---

## 18. [Case-Based Calibration of Adaptive Reasoning and Execution for LLM Tool Use](https://arxiv.org/abs/2605.15041) <a id="link18"></a>
**ArXiv ID:** 2605.15041
**Authors:** Renning Pang, Tian Lan, Leyuan Liu, Piao Tong, Sheng Cao, Xiaosong Zhang
...
**Comment:** Somewhat matches criterion 2: proposes CAST, a case-based calibration framework for LLM tool use, improving adaptive reasoning and execution. While not a new VLLM/MLLM, it is a novel method for tool-using LLMs.
**Relevance:** 5
**Novelty:** 6

---

## 19. [Probabilistic Verification of Recurrent Neural Networks for Single and Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.14758) <a id="link19"></a>
**ArXiv ID:** 2605.14758
**Authors:** Luca Marzari, Enrico Marchesini
...
**Comment:** Somewhat related to criterion 3: Proposes a probabilistic verification framework for RNN-based policies in RL, including multi-agent settings. Focus is on verification/statistical guarantees, not new embodied agent methods or benchmarks.
**Relevance:** 4
**Novelty:** 6

---

## 20. [Beyond Individual Intelligence: Surveying Collaboration, Failure Attribution, and Self-Evolution in LLM-based Multi-Agent Systems](https://arxiv.org/abs/2605.14892) <a id="link20"></a>
**ArXiv ID:** 2605.14892
**Authors:** Shihao Qi, Jie Ma, Rui Xing, Wei Guo, Xiao Huang, Zhitao Gao, Jianhao Deng, Jun Liu, Lingling Zhang, Bifan Wei, Boqian Yang, Pinghui Wang, Jianwen Sun, Jing Tao, Yaqiang Wu, Hui Liu, Yu Yao, Tongliang Liu
...
**Comment:** Survey paper on multi-agent LLM systems, relevant to criterion 3 (embodied AI, multi-agent systems), but as a survey, less novel.
**Relevance:** 6
**Novelty:** 4

---

## 21. [Model-Adaptive Tool Necessity Reveals the Knowing-Doing Gap in LLM Tool Use](https://arxiv.org/abs/2605.14038) <a id="link21"></a>
**ArXiv ID:** 2605.14038
**Authors:** Yize Cheng, Chenrui Fan, Mahdi JafariRaviz, Keivan Rezaei, Soheil Feiz
...
**Comment:** Somewhat related to criterion 2: Investigates tool-use behavior in LLMs, focusing on the knowing-doing gap. While not directly about VLLMs/MLLMs, it provides empirical insights into LLM agent behavior, which may be of tangential interest.
**Relevance:** 3
**Novelty:** 6

---

## 22. [Hypergraph Enterprise Agentic Reasoner over Heterogeneous Business Systems](https://arxiv.org/abs/2605.14259) <a id="link22"></a>
**ArXiv ID:** 2605.14259
**Authors:** Ling Wang, Songnan Liu, Jianan Wang, Cheng Cheng, Xin Liu, Yihan Zhu, Enyu Li, Yu Xiao, Jiangyong Xie, Duogong Yan, Jiangyi Chen
...
**Comment:** Related to agentic reasoning in enterprise systems, but not directly about spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 4
**Novelty:** 5

---

## 23. [Precise Verification of Transformers through ReLU-Catalyzed Abstraction Refinement](https://arxiv.org/abs/2605.14294) <a id="link23"></a>
**ArXiv ID:** 2605.14294
**Authors:** Hengjie Liu, Zhenya Zhang, Jianjun Zhao
...
**Comment:** Related to formal verification of transformers, not directly matching any criterion, but of tangential interest for model robustness.
**Relevance:** 3
**Novelty:** 5
