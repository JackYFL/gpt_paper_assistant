...
0. [NeoWorld-Pro: Programming Interactive Scenes from Monocular Images for Embodied Simulation](#link0)
**Authors:** Yumeng He, Yichen Song, Xiaotian Yang, Weijia Zhang, Zanwei Zhou, Junru Gong, Xiaokang Yang, Yunbo Wang

1. [AffineTok: Semantic Affine Consistency for Diffusion-Friendly Visual Tokenizer](#link1)
...
2. [Are Android GUI Agents Robust Against Runtime Anomalies? AnTrap: Evaluating Agents in Dynamic Adversarial Environments](#link2)
**Authors:** Guo Gan, Yilun Zhao, Cong Chen, Jinbiao Wei, Tingyu Song, Zheyuan Yang, Lin Fu, Hong Zhou

3. [When Seeing Is Not Enough: Benchmarking Interactive Visual Grounding in LVLMs](#link3)
**Authors:** Zhengxiang Wang, Owen Rambow

4. [Variance-Guided Spatial Attention Fusion for Robust End-to-End Driving under Asymmetric Sensor Degradation](#link4)
**Authors:** Weizhi Tao, Zengwang Jin, Xiao Wang, Hailong Huang

5. [LeFlow: Generative Latent Flow Planning for World Models](#link5)
**Authors:** Hsiang-Wei Huang, Jianxu Shangguan, Junbin Lu, Jenq-Neng Hwang

6. [Reflection with Action-Induced Visual Differences for Desktop GUI Agents](#link6)
**Authors:** Yijie Ma, Chaoyue Niu, Fan Wu, Guihai Chen

7. [TurboT2VA: Fast Large-Scale Text-to-Video-Audio Generation via Score-Regularized Consistency Distillation](#link7)
...
8. [Task-Adaptive Rubrics for GUI Reward Modeling](#link8)
**Authors:** Tao Xiong, Xavier Hu, Wenkai Wang, Qinzhuo Wu, Changqiao Wu, Pengzhi Gao, Wei Liu, Jian Luan, Shengyu Zhang

9. [IDeaL: Data-Free Multi-Teacher Distillation via Improved Dead Leaves](#link9)
**Authors:** Feyza Yavuz, Mert B\"ulent Sar{\i}y{\i}ld{\i}z, Diane Larlus

10. [Syn2RealTrack: Bridging the Gap Between Synthetic and Real-World Datasets for Online Multi-View Multi-Target Tracking](#link10)
...
11. [Pivot-and-Station Multi-Agent Path Finding: Solvability, Complexity, and Algorithms](#link11)
**Authors:** Andrea Di Nezza, Mihir Patel, Fabio Fagnani, Sara Bernardini

12. [Rethinking Pre-Training and Augmentation for Zero-Shot Cross-City Object Detection](#link12)
...
---
## 0. [NeoWorld-Pro: Programming Interactive Scenes from Monocular Images for Embodied Simulation](https://arxiv.org/abs/2608.24212) <a id="link0"></a>
**ArXiv ID:** 2608.24212
**Authors:** Yumeng He, Yichen Song, Xiaotian Yang, Weijia Zhang, Zanwei Zhou, Junru Gong, Xiaokang Yang, Yunbo Wang
...
**Comment:** Matches criterion 3 closely: it builds embodied-simulation assets from monocular images using MLLMs and a physics-in-the-loop reconstruction/programming pipeline.
**Relevance:** 5
**Novelty:** 7

---

## 1. [AffineTok: Semantic Affine Consistency for Diffusion-Friendly Visual Tokenizer](https://arxiv.org/abs/2608.23864) <a id="link1"></a>
**ArXiv ID:** 2608.23864
**Authors:** Junqiu Yu, Pandeng Li, Yikai Wang, Jiaxing Zhao, Yujie Wei, Kaixun Jiang, Quanhao Li, Hongtao Yu, Zhihang Liu, Zhaohe Liao, Junjie Zhou, Yun Zheng, Yu Liu, Yanwei Fu
...
**Comment:** Matches criterion 4 closely: it is a vision foundation model component for diffusion-friendly visual tokenization, with a new tokenizer training objective and strong generation results.
**Relevance:** 5
**Novelty:** 7

---

## 2. [Are Android GUI Agents Robust Against Runtime Anomalies? AnTrap: Evaluating Agents in Dynamic Adversarial Environments](https://arxiv.org/abs/2608.24099) <a id="link2"></a>
**ArXiv ID:** 2608.24099
**Authors:** Guo Gan, Yilun Zhao, Cong Chen, Jinbiao Wei, Tingyu Song, Zheyuan Yang, Lin Fu, Hong Zhou
...
**Comment:** Matches criterion 3 closely: it builds a benchmark for Android GUI agents under dynamic adversarial runtime anomalies, a novel embodied/interactive evaluation angle.
**Relevance:** 5
**Novelty:** 6

---

## 3. [When Seeing Is Not Enough: Benchmarking Interactive Visual Grounding in LVLMs](https://arxiv.org/abs/2608.23978) <a id="link3"></a>
**ArXiv ID:** 2608.23978
**Authors:** Zhengxiang Wang, Owen Rambow
...
**Comment:** Matches criterion 2 closely: it benchmarks interactive visual grounding in LVLMs, focusing on dialogue-based acquisition of missing visual target information.
**Relevance:** 5
**Novelty:** 6

---

## 4. [Variance-Guided Spatial Attention Fusion for Robust End-to-End Driving under Asymmetric Sensor Degradation](https://arxiv.org/abs/2608.24366) <a id="link4"></a>
**ArXiv ID:** 2608.24366
**Authors:** Weizhi Tao, Zengwang Jin, Xiao Wang, Hailong Huang
...
**Comment:** Matches criterion 1 closely: it proposes a spatially aware fusion method for robust embodied driving under sensor degradation, with dense reliability maps and calibrated spatial attention.
**Relevance:** 5
**Novelty:** 6

---

## 5. [LeFlow: Generative Latent Flow Planning for World Models](https://arxiv.org/abs/2608.24855) <a id="link5"></a>
**ArXiv ID:** 2608.24855
**Authors:** Hsiang-Wei Huang, Jianxu Shangguan, Junbin Lu, Jenq-Neng Hwang
...
**Comment:** Close match to criterion 3: it proposes a new planning method for world models in goal-conditioned pixel-control/embodied settings.
**Relevance:** 5
**Novelty:** 6

---

## 6. [Reflection with Action-Induced Visual Differences for Desktop GUI Agents](https://arxiv.org/abs/2608.24015) <a id="link6"></a>
**ArXiv ID:** 2608.24015
**Authors:** Yijie Ma, Chaoyue Niu, Fan Wu, Guihai Chen
...
**Comment:** Matches criterion 3 closely: it introduces a new method for desktop GUI agents that reasons over action-induced visual differences, which is an embodied-agent style interaction setting.
**Relevance:** 5
**Novelty:** 5

---

## 7. [TurboT2VA: Fast Large-Scale Text-to-Video-Audio Generation via Score-Regularized Consistency Distillation](https://arxiv.org/abs/2608.24674) <a id="link7"></a>
**ArXiv ID:** 2608.24674
**Authors:** Xiaoda Yang, Yuxiang Liu, Kaiwen Zheng, Yuan Liu, Yibo Lai, Shengpeng Ji, Kai Jiang, Jianfei Chen, Xiaobin Hu, Shuicheng Yan, Jintao Zhang, Jun Zhu, Zhou Zhao
...
**Comment:** Partial match to criterion 4: it is a large-scale multimodal generative model for text-to-video-audio, which is related to vision foundation models and multimodal generation applications.
**Relevance:** 4
**Novelty:** 6

---

## 8. [Task-Adaptive Rubrics for GUI Reward Modeling](https://arxiv.org/abs/2608.24174) <a id="link8"></a>
**ArXiv ID:** 2608.24174
**Authors:** Tao Xiong, Xavier Hu, Wenkai Wang, Qinzhuo Wu, Changqiao Wu, Pengzhi Gao, Wei Liu, Jian Luan, Shengyu Zhang
...
**Comment:** Close match to criterion 3: it targets GUI agents with a new reward-modeling framework for task-adaptive judging criteria, which is an embodied-agent method.
**Relevance:** 5
**Novelty:** 5

---

## 9. [IDeaL: Data-Free Multi-Teacher Distillation via Improved Dead Leaves](https://arxiv.org/abs/2608.24759) <a id="link9"></a>
**ArXiv ID:** 2608.24759
**Authors:** Feyza Yavuz, Mert B\"ulent Sar{\i}y{\i}ld{\i}z, Diane Larlus
...
**Comment:** No direct match to the listed criteria; this is a data-free multi-teacher distillation method, interesting for clever statistical tricks but not specifically spatial, embodied, VLLM/MLLM, or vision-foundation-model focused.
**Relevance:** 3
**Novelty:** 6

---

## 10. [Syn2RealTrack: Bridging the Gap Between Synthetic and Real-World Datasets for Online Multi-View Multi-Target Tracking](https://arxiv.org/abs/2608.24130) <a id="link10"></a>
**ArXiv ID:** 2608.24130
**Authors:** Duong Nguyen-Ngoc Tran, Ngoc Doan-Minh Huynh, Cu Quoc Le, Hoang-Khang Nguyen, Long Hoang Pham, Huy-Hung Nguyen, Quoc Pham-Nam Ho, Trinh Le Ba Khanh, Chi Dai Tran, Duong Khac Vu, Son Hong Phan, Hyung-Min Jeon, Jae Wook Jeon
...
**Comment:** Close to criterion 3 in spirit: it is an embodied multi-view tracking system for warehouse scenes, with a new synthetic-to-real adaptation pipeline and simulator-to-real angle.
**Relevance:** 4
**Novelty:** 5

---

## 11. [Pivot-and-Station Multi-Agent Path Finding: Solvability, Complexity, and Algorithms](https://arxiv.org/abs/2608.24585) <a id="link11"></a>
**ArXiv ID:** 2608.24585
**Authors:** Andrea Di Nezza, Mihir Patel, Fabio Fagnani, Sara Bernardini
...
**Comment:** No close match to criteria 1-4; this is a theoretical/algorithmic MAPF paper, which is adjacent to robotics but not clearly about embodied spatial intelligence methods or a new embodied benchmark.
**Relevance:** 3
**Novelty:** 6

---

## 12. [Rethinking Pre-Training and Augmentation for Zero-Shot Cross-City Object Detection](https://arxiv.org/abs/2608.24154) <a id="link12"></a>
**ArXiv ID:** 2608.24154
**Authors:** Long Hoang Pham, Quoc Pham-Nam Ho, Huy-Hung Nguyen, Duong Nguyen-Ngoc Tran, Ngoc Doan-Minh Huynh, Cu Quoc Le, Hoang-Khang Nguyen, Hyung-Min Jeon, Chi Dai Tran, Son Hong Phan, Duong Khac Vu, Trinh Le Ba Khanh, Jae Wook Jeon
...
**Comment:** No direct match to the criteria; this is a cross-city object detection/domain generalization paper, relevant to computer vision but not specifically the requested categories.
**Relevance:** 3
**Novelty:** 5
