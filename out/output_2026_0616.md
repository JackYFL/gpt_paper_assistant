...
0. [Qwen-RobotWorld Technical Report: Unifying Embodied World Modeling through Language-Conditioned Video Generation](#link0)
...
1. [SurroundNEXO: Ego-Centric Metric Bridging for Spatially Consistent Geometry in Autonomous Driving](#link1)
...
2. [What Should a Streaming Video Model Remember?](#link2)
**Authors:** Haonan Ge, Yiwei Wang, Hang Wu, Yujun Cai

3. [JoyAI-VL-Interaction: Real-Time Vision-Language Interaction Intelligence](#link3)
...
4. [RealityBridge: Bridging Editable 3D Gaussian Splatting Driving Simulations and Real-World Videos](#link4)
**Authors:** Zhenhua Wu, Yun Pang, Mingkun Chang, Yuwei Ning, Liangzhi Wang, Yi Xiao, Guanbin Li

5. [OneFocus: Enabling Real-World X-ray Security Screening with a Unified Vision-Language Model](#link5)
**Authors:** Jiali Wen, Hongxia Gao, Litao Li, Yixin Chen, Kaijie Zhang, Qianyun Liu, Xiaoqin Wen

6. [PAL-Bench: Evidence-Grounded Profile Reconstruction from Longitudinal Personal Albums](#link6)
**Authors:** Qiwei Yan, Zhiqiang Yuan, Zexi Jia, Nanxing Hu, Kailin Lyu, Jie Zhou, Jinchao Zhang

7. [Visual-Seeker: Towards Visual-Native Multimodal Agentic Search via Active Visual Reasoning](#link7)
...
8. [MotionVLA: Vision-Language-Action Model for Humanoid Motion](#link8)
**Authors:** Nonghai Zhang, Siyu Zhai, Yanjun Li, Zeyu Zhang, Zhihan Yin, Yandong Guo, Boxin Shi, Hao Tang

9. [Learning Sparse Latent Predictive Foundation Model for Multimodal Neuroimaging](#link9)
...
10. [OpenClaw-Skill: Collective Skill Tree Search for Agentic Large Language Models](#link10)
**Authors:** Tianyi Lin, Chuanyu Sun, Jingyi Zhang, Changxu Wei, Huanjin Yao, Shunyu Liu, Xikun Zhang, Liu Liu, Jiaxing Huang

11. [Stepwise Token Selection for Efficient Multimodal Large Language Models](#link11)
**Authors:** Landi He, Shawn Young, Lijian Xu

12. [A Multi-Center Benchmark for Abdominal Disease Diagnosis and Report Generation from Non-Contrast CT](#link12)
...
13. [An Extensive Benchmark for Single-round and Multi-round Instruction-based Image Editing](#link13)
**Authors:** Yiwei Ma, Ke Ye, Weihuang Lin, Jiayi Ji, Xiaoshuai Sun, Tat-Seng Chua, Rongrong Ji

14. [SUP-MCRL: Subject-aware Unified Pseudo-feature Coded Multimodal Contrastive Representation Learning for EEG Visual Decoding](#link14)
**Authors:** Shengyu Gong, Weiming Zeng, Yueyang Li, Zijian Kang, Hongjie Yan, Wai Ting Siok, Nizhuan Wang

15. [Shift-and-Sum Quantization for Visual Autoregressive Models](#link15)
**Authors:** Jaehyeon Moon, Bumsub Ham

16. [Structure-aware Knowledge-guided Heterogeneous Mamba for Zygomaticomaxillary Suture Assessment](#link16)
...
---
## 0. [Qwen-RobotWorld Technical Report: Unifying Embodied World Modeling through Language-Conditioned Video Generation](https://arxiv.org/abs/2606.17030) <a id="link0"></a>
**ArXiv ID:** 2606.17030
**Authors:** Jie Zhang, Xiaoyue Chen, Anzhe Chen, Chenxu Lv, Deqing Li, Gengze Zhou, Hang Yin, Haoqi Yuan, Haoyang Li, Jiahao Li, Jiazhao Zhang, Jingren Zhou, Kaiyuan Gao, Kun Yan, Lihan Jiang, Ningyuan Tang, Pei Lin, Qihang Peng, Shengming Yin, Tianhe Wu, Tianyi Yan, Xiao Xu, Yan Shu, Yanran Zhang, Ye Wang, Yi Wang, Yilei Chen, Yixian Xu, Yiyang Huang, Yuxiang Chen, Zekai Zhang, Zhendong Wang, Zhixing Lei, Zhixuan Liang, Zihao Liu, Zikai Zhou, Xiong-Hui Chen, Chenfei Wu
...
**Comment:** Matches criterion 2 and criterion 3 very closely: it presents a new embodied world model / MLLM-style system for language-conditioned video generation and embodied intelligence, with benchmarked simulation-oriented uses.
**Relevance:** 10
**Novelty:** 8

---

## 1. [SurroundNEXO: Ego-Centric Metric Bridging for Spatially Consistent Geometry in Autonomous Driving](https://arxiv.org/abs/2606.16960) <a id="link1"></a>
**ArXiv ID:** 2606.16960
**Authors:** Shuai Yuan, Runxi Tang, Yuzhou Ji, Fudong Ge, Hanshi Wang, Yifei Wang, Xianming Zeng, Jianyun Xu, Xingliang Liu, Yanfeng Wang, Zhipeng Zhang
...
**Comment:** Matches criterion 1 and 3: it introduces a spatially consistent metric depth method for autonomous driving with weak cross-view overlap, directly targeting spatial understanding in embodied driving systems.
**Relevance:** 6
**Novelty:** 6

---

## 2. [What Should a Streaming Video Model Remember?](https://arxiv.org/abs/2606.16353) <a id="link2"></a>
**ArXiv ID:** 2606.16353
**Authors:** Haonan Ge, Yiwei Wang, Hang Wu, Yujun Cai
...
**Comment:** Matches criterion 2 and 3: it proposes a streaming-video VLM with selective memory allocation for online video understanding, a novel angle on long-horizon embodied/video intelligence.
**Relevance:** 6
**Novelty:** 6

---

## 3. [JoyAI-VL-Interaction: Real-Time Vision-Language Interaction Intelligence](https://arxiv.org/abs/2606.14777) <a id="link3"></a>
**ArXiv ID:** 2606.14777
**Authors:** Dingyu Yao, Junhao Zhou, Chenxu Yang, Chuanyu Qin, Haowen Hou, Zheming Liang, Congcong Wang, Yuhang Cao, Shenglong Ye, Shuai Xie, Shuhuan Gu, Haoyang Huang, Qingyi Si, Nan Duan, Jiaqi Wang
...
**Comment:** Matches criterion 2 and 3: it introduces a new open vision-language interaction model with real-time, continuous interaction behavior.
**Relevance:** 6
**Novelty:** 6

---

## 4. [RealityBridge: Bridging Editable 3D Gaussian Splatting Driving Simulations and Real-World Videos](https://arxiv.org/abs/2606.16278) <a id="link4"></a>
**ArXiv ID:** 2606.16278
**Authors:** Zhenhua Wu, Yun Pang, Mingkun Chang, Yuwei Ning, Liangzhi Wang, Yi Xiao, Guanbin Li
...
**Comment:** Matches criterion 3: it focuses on an embodied/autonomous driving simulator-like setting by bridging editable 3D Gaussian Splatting driving simulations to real-world videos.
**Relevance:** 6
**Novelty:** 6

---

## 5. [OneFocus: Enabling Real-World X-ray Security Screening with a Unified Vision-Language Model](https://arxiv.org/abs/2606.15663) <a id="link5"></a>
**ArXiv ID:** 2606.15663
**Authors:** Jiali Wen, Hongxia Gao, Litao Li, Yixin Chen, Kaijie Zhang, Qianyun Liu, Xiaoqin Wen
...
**Comment:** Matches criterion 2 and 4: it builds a unified vision-language model for X-ray security screening and introduces a new benchmark/dataset for a specialized visual understanding domain.
**Relevance:** 6
**Novelty:** 6

---

## 6. [PAL-Bench: Evidence-Grounded Profile Reconstruction from Longitudinal Personal Albums](https://arxiv.org/abs/2606.16175) <a id="link6"></a>
**ArXiv ID:** 2606.16175
**Authors:** Qiwei Yan, Zhiqiang Yuan, Zexi Jia, Nanxing Hu, Kailin Lyu, Jie Zhou, Jinchao Zhang
...
**Comment:** Matches criterion 3 very closely: it introduces a new embodied/multimodal benchmark with a novel simulator-style synthetic evidence compiler and provenance-aware evaluation.
**Relevance:** 5
**Novelty:** 7

---

## 7. [Visual-Seeker: Towards Visual-Native Multimodal Agentic Search via Active Visual Reasoning](https://arxiv.org/abs/2606.15231) <a id="link7"></a>
**ArXiv ID:** 2606.15231
**Authors:** Zhengbo Zhang, Changtao Miao, Jinbo Su, Zhaowen Zhou, Chunxia Zhang, Xukai Wang, Ruiqi Liu, Kaiyuan Zheng, Jiansheng Cai, Bo Zhang, Zhe Li, Shiming Xiang, Ying Yan
...
**Comment:** Matches criterion 2: it proposes a new multimodal large language model agent for visual-native multimodal search with active visual reasoning.
**Relevance:** 6
**Novelty:** 6

---

## 8. [MotionVLA: Vision-Language-Action Model for Humanoid Motion](https://arxiv.org/abs/2606.15142) <a id="link8"></a>
**ArXiv ID:** 2606.15142
**Authors:** Nonghai Zhang, Siyu Zhai, Yanjun Li, Zeyu Zhang, Zhihan Yin, Yandong Guo, Boxin Shi, Hao Tang
...
**Comment:** Matches criterion 3: it presents a new vision-language-action model for humanoid motion generation, which is an embodied AI method with a novel frequency-aware formulation.
**Relevance:** 6
**Novelty:** 6

---

## 9. [Learning Sparse Latent Predictive Foundation Model for Multimodal Neuroimaging](https://arxiv.org/abs/2606.14957) <a id="link9"></a>
**ArXiv ID:** 2606.14957
**Authors:** Haoxu Huang, Long Chen, Jingyun Chen, Jinu Hyun, James Ryan Loftus, Kara Melmed, Daniel Orringer, Jennifer Frontera, Seena Dehkharghani, Arjun Masurkar, Narges Razavian
...
**Comment:** Matches criterion 4 very closely: this is a multimodal foundation model for neuroimaging representation learning with broad downstream applications.
**Relevance:** 5
**Novelty:** 6

---

## 10. [OpenClaw-Skill: Collective Skill Tree Search for Agentic Large Language Models](https://arxiv.org/abs/2606.16774) <a id="link10"></a>
**ArXiv ID:** 2606.16774
**Authors:** Tianyi Lin, Chuanyu Sun, Jingyi Zhang, Changxu Wei, Huanjin Yao, Shunyu Liu, Xikun Zhang, Liu Liu, Jiaxing Huang
...
**Comment:** Matches criterion 3: it proposes a new method for agentic LLM skill construction and long-horizon tool-use/planning, with a tree-search framework for reusable skills.
**Relevance:** 5
**Novelty:** 6

---

## 11. [Stepwise Token Selection for Efficient Multimodal Large Language Models](https://arxiv.org/abs/2606.16067) <a id="link11"></a>
**ArXiv ID:** 2606.16067
**Authors:** Landi He, Shawn Young, Lijian Xu
...
**Comment:** Matches criterion 2: it proposes a new method for visual token selection inside an MLLM, aimed at improving multimodal model efficiency.
**Relevance:** 5
**Novelty:** 5

---

## 12. [A Multi-Center Benchmark for Abdominal Disease Diagnosis and Report Generation from Non-Contrast CT](https://arxiv.org/abs/2606.16991) <a id="link12"></a>
**ArXiv ID:** 2606.16991
**Authors:** Mariam Elbakry, Aliaa Sayed Sheha, Salma Hassan Tantawy, Aya Yassin, Concetto Spampinato, Karim Lekadir, Xiaomeng Li, Marawan Elbatel
...
**Comment:** Matches criterion 3: it introduces a new multi-center benchmark for abdominal disease diagnosis and report generation from non-contrast CT.
**Relevance:** 5
**Novelty:** 4

---

## 13. [An Extensive Benchmark for Single-round and Multi-round Instruction-based Image Editing](https://arxiv.org/abs/2606.15570) <a id="link13"></a>
**ArXiv ID:** 2606.15570
**Authors:** Yiwei Ma, Ke Ye, Weihuang Lin, Jiayi Ji, Xiaoshuai Sun, Tat-Seng Chua, Rongrong Ji
...
**Comment:** Matches criterion 3: it builds a new benchmark for instruction-based image editing, focusing on single-round and multi-round evaluation.
**Relevance:** 5
**Novelty:** 4

---

## 14. [SUP-MCRL: Subject-aware Unified Pseudo-feature Coded Multimodal Contrastive Representation Learning for EEG Visual Decoding](https://arxiv.org/abs/2606.16615) <a id="link14"></a>
**ArXiv ID:** 2606.16615
**Authors:** Shengyu Gong, Weiming Zeng, Yueyang Li, Zijian Kang, Hongjie Yan, Wai Ting Siok, Nizhuan Wang
...
**Comment:** No close match to the four criteria; it is a brain decoding / EEG representation learning paper, adjacent to multimodal learning but not a direct fit.
**Relevance:** 3
**Novelty:** 5

---

## 15. [Shift-and-Sum Quantization for Visual Autoregressive Models](https://arxiv.org/abs/2606.16131) <a id="link15"></a>
**ArXiv ID:** 2606.16131
**Authors:** Jaehyeon Moon, Bumsub Ham
...
**Comment:** No close match to criteria 1-4; this is a quantization method for visual autoregressive models, which is adjacent to vision generation but not one of the requested criteria.
**Relevance:** 3
**Novelty:** 5

---

## 16. [Structure-aware Knowledge-guided Heterogeneous Mamba for Zygomaticomaxillary Suture Assessment](https://arxiv.org/abs/2606.16749) <a id="link16"></a>
**ArXiv ID:** 2606.16749
**Authors:** Xiaoqi Guo, Birui Chen, Xinquan Yang, Chaoyun Zhang, Xuefen Liu, Mianjie Zheng, Kun Tang, Xuguang Li, Wen Ma, Yanhua Xu, Linlin Shen
...
**Comment:** Partial match to criterion 4: it applies a foundation-model-style multimodal framework with language guidance, but the task is a narrow medical assessment application rather than a general vision foundation model contribution.
**Relevance:** 3
**Novelty:** 4
