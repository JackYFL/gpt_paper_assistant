# Personalized Daily ArXiv Papers 07/30/2026
...
0. [CoTinyVLA: Chain-of-Thought Distillation for a Sub-Billion-Parameter Vision-Language-Action Model](#link0)
**Authors:** Minhyeok Lee, Chiyoung Kim, Chanhoe Gu, Seongrok Kim, Sanghyuk Roy Choi, Donghwan Hwang, Donghun Ryu, Seokhyun Kim

1. [TurboVLA: Real-Time Vision-Language-Action Model at 32 Hz on an RTX 4090 with <1 GB VRAM](#link1)
**Authors:** Hengyi Xie, Chenfei Yao, Xianjin Wu, Xuanyang Xi, Yiping Tang, Di Xu, Yingying Zhu, Dingkang Liang, Xiang Bai, Han Ding

2. [Prior Directions: Why GUI Grounding Gets Locked in the Past](#link2)
**Authors:** Weile Gong, Zijian Lu, Mingcai Chen, Yiping Zuo, Xin He, Weibei Fan

3. [Visual Credit Audit for Multimodal Spatial Reasoning](#link3)
**Authors:** Feixiang Liu, Qiang Qiu, Lanbo Sun, Nan Wei, Huawei Shen, Xueqi Cheng

4. [OrchBench: Evaluating Multi-Agent Orchestration Plans in Isolation via Deterministic Simulation](#link4)
**Authors:** Zhenzhen Ren, Jiyan He, Xinpeng Zhang, Zhenxing Qian, Ke Han, Shuxin Zheng, GuoBiao Li, Xiaoqing Zhang

5. [Progressive Multimodal Alignment for Continual Instruction Tuning](#link5)
**Authors:** Duzhen Zhang, Yahan Yu, Qiaoyi Su, Jiahua Dong, Tielin Zhang

6. [StatePlay: State-Aware Game World Models for Mechanics-Consistent Generation](#link6)
**Authors:** Zijun Lin, Zeqing Wang, Cheston Tan, Bihan Wen, Yeying Jin

7. [ProcAgent: An Agentic Framework for Procedural Task Guidance on Edge with Human-in-the-Loop](#link7)
**Authors:** Azizul Zahid, Subrata Biswas, Bashima Islam, Sai Swaminathan

8. [Dual Inversion for Text-to-Image Diffusion Models: From Both Prompt and Noise Perspectives](#link8)
**Authors:** Xiaolong Liu, Junjian Li, Yuan Xiao, Jiaqi Deng, Dayong Ye, Tianqing Zhu, Huan Huo

9. [Ripple: Real-Time Streaming Audio-Video Generation With Cross-Modal Recurrent Memory](#link9)
**Authors:** Yanbo Ding, Zhizhi Guo, Quanyue Song, Yishan He, Zhixiang He, Yongxiang Li, Yali Wang

10. [FreqForcing: Autoregressive Long Video Generation via Spectral Self-Anchoring](#link10)
**Authors:** Jiatong Li, Leo Liang, Linghe Kong, Yulun Zhang

11. [CHARM: A Multimodal Graph Foundation Model with Hierarchical Context Modeling for Zero-Shot Transfer](#link11)
**Authors:** Ankang Yang, Jitao Zhao, Di Jin, Yuxiao Huang, Dongxiao He

12. [Knowledge-guided Disentanglement with Atomic Actions for Action Recognition](#link12)
**Authors:** Tianci Wu, Siqi Cao, Guangming Zhu, Jiang Lu, Siyuan Wang, Longfei Zhang, Jincai Huang, Jun Sheng, Liang Zhang

---
## 0. [CoTinyVLA: Chain-of-Thought Distillation for a Sub-Billion-Parameter Vision-Language-Action Model](https://arxiv.org/abs/2607.25487) <a id="link0"></a>
**ArXiv ID:** 2607.25487
**Authors:** Minhyeok Lee, Chiyoung Kim, Chanhoe Gu, Seongrok Kim, Sanghyuk Roy Choi, Donghwan Hwang, Donghun Ryu, Seokhyun Kim
...
**Comment:** Matches criterion 3 very closely: it is an embodied AI/VLA paper proposing a small model with chain-of-thought distillation and robustness-oriented supervision.
**Relevance:** 9
**Novelty:** 7

---

## 1. [TurboVLA: Real-Time Vision-Language-Action Model at 32 Hz on an RTX 4090 with <1 GB VRAM](https://arxiv.org/abs/2607.27205) <a id="link1"></a>
**ArXiv ID:** 2607.27205
**Authors:** Hengyi Xie, Chenfei Yao, Xianjin Wu, Xuanyang Xi, Yiping Tang, Di Xu, Yingying Zhu, Dingkang Liang, Xiang Bai, Han Ding
...
**Comment:** Matches criterion 3 very closely: it proposes a new real-time vision-language-action model for embodied robot manipulation with a new low-latency design.
**Relevance:** 9
**Novelty:** 7

---

## 2. [Prior Directions: Why GUI Grounding Gets Locked in the Past](https://arxiv.org/abs/2607.26913) <a id="link2"></a>
**ArXiv ID:** 2607.26913
**Authors:** Weile Gong, Zijian Lu, Mingcai Chen, Yiping Zuo, Xin He, Weibei Fan
...
**Comment:** Matches criterion 1 very closely: it studies a failure mode in GUI grounding for vision-language models and proposes an interpretability-style intervention to restore visual grounding.
**Relevance:** 8
**Novelty:** 7

---

## 3. [Visual Credit Audit for Multimodal Spatial Reasoning](https://arxiv.org/abs/2607.27069) <a id="link3"></a>
**ArXiv ID:** 2607.27069
**Authors:** Feixiang Liu, Qiang Qiu, Lanbo Sun, Nan Wei, Huawei Shen, Xueqi Cheng
...
**Comment:** Matches criterion 1: a methodological improvement for multimodal spatial reasoning, with a careful visual-credit audit of when images actually help.
**Relevance:** 7
**Novelty:** 7

---

## 4. [OrchBench: Evaluating Multi-Agent Orchestration Plans in Isolation via Deterministic Simulation](https://arxiv.org/abs/2607.25656) <a id="link4"></a>
**ArXiv ID:** 2607.25656
**Authors:** Zhenzhen Ren, Jiyan He, Xinpeng Zhang, Zhenxing Qian, Ke Han, Shuxin Zheng, GuoBiao Li, Xiaoqing Zhang
...
**Comment:** Matches criterion 3 closely: it introduces a new simulation-based benchmark for evaluating multi-agent orchestration plans in isolation.
**Relevance:** 7
**Novelty:** 7

---

## 5. [Progressive Multimodal Alignment for Continual Instruction Tuning](https://arxiv.org/abs/2607.26947) <a id="link5"></a>
**ArXiv ID:** 2607.26947
**Authors:** Duzhen Zhang, Yahan Yu, Qiaoyi Su, Jiahua Dong, Tielin Zhang
...
**Comment:** Matches criterion 2: a new MLLM training method that tackles continual multimodal instruction tuning and projector-level forgetting.
**Relevance:** 7
**Novelty:** 6

---

## 6. [StatePlay: State-Aware Game World Models for Mechanics-Consistent Generation](https://arxiv.org/abs/2607.26754) <a id="link6"></a>
**ArXiv ID:** 2607.26754
**Authors:** Zijun Lin, Zeqing Wang, Cheston Tan, Bihan Wen, Yeying Jin
...
**Comment:** Matches criterion 3: a new embodied/simulator-related world model that explicitly models game state for mechanics-consistent generation.
**Relevance:** 6
**Novelty:** 6

---

## 7. [ProcAgent: An Agentic Framework for Procedural Task Guidance on Edge with Human-in-the-Loop](https://arxiv.org/abs/2607.24770) <a id="link7"></a>
**ArXiv ID:** 2607.24770
**Authors:** Azizul Zahid, Subrata Biswas, Bashima Islam, Sai Swaminathan
...
**Comment:** Matches criterion 3: a new embodied-AI method for procedural task guidance with human-in-the-loop on edge hardware.
**Relevance:** 6
**Novelty:** 5

---

## 8. [Dual Inversion for Text-to-Image Diffusion Models: From Both Prompt and Noise Perspectives](https://arxiv.org/abs/2607.26735) <a id="link8"></a>
**ArXiv ID:** 2607.26735
**Authors:** Xiaolong Liu, Junjian Li, Yuan Xiao, Jiaqi Deng, Dayong Ye, Tianqing Zhu, Huan Huo
...
**Comment:** Matches criterion 4 loosely: it combines a vision-language model with diffusion inversion for text-to-image editing, but it is not a foundation-model paper in the usual sense.
**Relevance:** 4
**Novelty:** 6

---

## 9. [Ripple: Real-Time Streaming Audio-Video Generation With Cross-Modal Recurrent Memory](https://arxiv.org/abs/2607.26818) <a id="link9"></a>
**ArXiv ID:** 2607.26818
**Authors:** Yanbo Ding, Zhizhi Guo, Quanyue Song, Yishan He, Zhixiang He, Yongxiang Li, Yali Wang
...
**Comment:** Matches criterion 4 loosely: a multimodal generative model for real-time audio-video generation, but the connection to vision foundation models is indirect.
**Relevance:** 4
**Novelty:** 6

---

## 10. [FreqForcing: Autoregressive Long Video Generation via Spectral Self-Anchoring](https://arxiv.org/abs/2607.27110) <a id="link10"></a>
**ArXiv ID:** 2607.27110
**Authors:** Jiatong Li, Leo Liang, Linghe Kong, Yulun Zhang
...
**Comment:** Matches criterion 4 loosely: it is a generative video model paper with a new training-free stabilization method, but it is not specifically about vision foundation models or embodied AI.
**Relevance:** 4
**Novelty:** 6

---

## 11. [CHARM: A Multimodal Graph Foundation Model with Hierarchical Context Modeling for Zero-Shot Transfer](https://arxiv.org/abs/2607.26023) <a id="link11"></a>
**ArXiv ID:** 2607.26023
**Authors:** Ankang Yang, Jitao Zhao, Di Jin, Yuxiao Huang, Dongxiao He
...
**Comment:** Matches criterion 4: a multimodal graph foundation model with zero-shot transfer across modalities.
**Relevance:** 4
**Novelty:** 5

---

## 12. [Knowledge-guided Disentanglement with Atomic Actions for Action Recognition](https://arxiv.org/abs/2607.26097) <a id="link12"></a>
**ArXiv ID:** 2607.26097
**Authors:** Tianci Wu, Siqi Cao, Guangming Zhu, Jiang Lu, Siyuan Wang, Longfei Zhang, Jincai Huang, Jun Sheng, Liang Zhang
...
**Comment:** Only a weak fit to criterion 1/4: it uses LLM-derived atomic actions for action recognition, but it is not really embodied AI or a vision foundation model method.
**Relevance:** 3
**Novelty:** 5
