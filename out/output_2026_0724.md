# Personalized Daily ArXiv Papers 07/24/2026
...
0. [Engine-Native Editable 3D World Reconstruction with Objects and Lighting](#link0)
...
1. [Do Pathology Vision-Language Models Truly See Pathology?](#link1)
...
2. [Future Rendering $\neq$ Future Surface: A Benchmark and Dataset for Dynamic Surface Reconstruction Beyond the Observed Window](#link2)
**Authors:** Yukun Shi, Minglun Gong

3. [HyperImageNet: A Large-Scale High-Spatial Resolution Hyperspectral Imagery Classification Benchmark](#link3)
**Authors:** Chuguang Zeng, Jingtao Li, Yinhe Liu, Yanfei Zhong

4. [Self-Supervised Learning of Structured Dynamics from Videos](#link4)
**Authors:** Lukas Knobel, Andrew Zisserman, Yuki M. Asano

5. [MagicMakeup: A Region-Controllable Diffusion Transformer for High-Fidelity Makeup-Transfer](#link5)
**Authors:** Ziyi Wang, Siming Zheng, Yang Yang, Shusong Xu, Hao Zhang, Bo Li, Changqing Zou, Peng-Tao Jiang

6. [RealVDeblur: One-Step Diffusion for Generalizable Real-World Video Deblurring](#link6)
...
7. [The Second LoViF 2026 Challenge on Real-World All-in-One Image Restoration: Methods and Results](#link7)
...
8. [Distribution-Alignment Bridge for Uncertainty-Aware Text-to-Video Retrieval](#link8)
**Authors:** Kyeongmo Chae, Jihoon Lee, Sangtae Ahn

9. [Sidewalk Moments: Are Richer Representations Always More Human-Aligned? Evidence from City-Walk Videos](#link9)
**Authors:** Liu Liu, Freya Huying Tan, F\'abio Duarte

---
## 0. [Engine-Native Editable 3D World Reconstruction with Objects and Lighting](https://arxiv.org/abs/2607.20889) <a id="link0"></a>
**ArXiv ID:** 2607.20889
**Authors:** Junhao Chen, Xinghao Chen, Henghaofan Zhang, Zihao Qiao, Saining Zhang, Yongzhi Li, Ruqi Huang, Sisi Li, Yimin Sheng, Jianyi Zhu, Hao Zhao
...
**Comment:** Matches criterion 3 very closely: an embodied/3D scene benchmark and method for engine-native editable reconstruction with object instances and parametric lights; also touches criterion 2 via VLM-based parsing.
**Relevance:** 9
**Novelty:** 8

---

## 1. [Do Pathology Vision-Language Models Truly See Pathology?](https://arxiv.org/abs/2607.21065) <a id="link1"></a>
**ArXiv ID:** 2607.21065
**Authors:** Chengyang Zhang, Wenchuan Zhang, Bo Li, Xinyu Liu, Jiaming Yang, Mengran Li, Chenxun Deng, Jie Chen, Yang Zhang, Wei Ju, Yuhao Yi, Hong Bu, Jiancheng Lv
...
**Comment:** Matches criterion 2 very closely: it studies pathology vision-language models and introduces PathBind to benchmark visual-semantic binding and grounding.
**Relevance:** 8
**Novelty:** 6

---

## 2. [Future Rendering $\neq$ Future Surface: A Benchmark and Dataset for Dynamic Surface Reconstruction Beyond the Observed Window](https://arxiv.org/abs/2607.21471) <a id="link2"></a>
**ArXiv ID:** 2607.21471
**Authors:** Yukun Shi, Minglun Gong
...
**Comment:** Matches criterion 3 very closely: it introduces a new benchmark and dataset for dynamic surface reconstruction beyond the observed window, a novel embodied/3D geometry evaluation angle.
**Relevance:** 6
**Novelty:** 7

---

## 3. [HyperImageNet: A Large-Scale High-Spatial Resolution Hyperspectral Imagery Classification Benchmark](https://arxiv.org/abs/2607.21050) <a id="link3"></a>
**ArXiv ID:** 2607.21050
**Authors:** Chuguang Zeng, Jingtao Li, Yinhe Liu, Yanfei Zhong
...
**Comment:** Matches criterion 4 closely: a new large-scale hyperspectral imagery benchmark with an associated foundation model and open-environment evaluation.
**Relevance:** 7
**Novelty:** 6

---

## 4. [Self-Supervised Learning of Structured Dynamics from Videos](https://arxiv.org/abs/2607.21576) <a id="link4"></a>
**ArXiv ID:** 2607.21576
**Authors:** Lukas Knobel, Andrew Zisserman, Yuki M. Asano
...
**Comment:** Matches criterion 1 moderately well: it proposes a new representation for structured dynamics from videos, which is useful for spatial/motion understanding in visual learning.
**Relevance:** 5
**Novelty:** 6

---

## 5. [MagicMakeup: A Region-Controllable Diffusion Transformer for High-Fidelity Makeup-Transfer](https://arxiv.org/abs/2607.20924) <a id="link5"></a>
**ArXiv ID:** 2607.20924
**Authors:** Ziyi Wang, Siming Zheng, Yang Yang, Shusong Xu, Hao Zhang, Bo Li, Changqing Zou, Peng-Tao Jiang
...
**Comment:** Matches criterion 2 moderately: a diffusion transformer for region-controllable makeup transfer, which is a multimodal image-editing model with explicit spatial control.
**Relevance:** 5
**Novelty:** 6

---

## 6. [RealVDeblur: One-Step Diffusion for Generalizable Real-World Video Deblurring](https://arxiv.org/abs/2607.20628) <a id="link6"></a>
**ArXiv ID:** 2607.20628
**Authors:** Renbiao Jin, Mingxin Yang, Yutian Chen, Junhao Zhuang, Xin Cai, Mulin Yu, Linning Xu, Wenxian Yu, Danping Zou, Shi Guo, Tianfan Xue
...
**Comment:** Matches criterion 4 moderately: a generative restoration method with a physically grounded data pipeline and strong downstream impact on 3D reconstruction, though it is not a vision foundation model itself.
**Relevance:** 4
**Novelty:** 6

---

## 7. [The Second LoViF 2026 Challenge on Real-World All-in-One Image Restoration: Methods and Results](https://arxiv.org/abs/2607.21118) <a id="link7"></a>
**ArXiv ID:** 2607.21118
**Authors:** Xiang Chen, Hao Li, Jiangxin Dong, Jinshan Pan, Xin Li, Hongbo Ding, Junpeng Jiang, Xingyu Qiu, Yilian Zhong, Yuxiang Chen, Shibo Yin, Zixuan Huang, Yushun Fang, Xilei Zhu, Yahui Wang, Chen Lu, Xiaodong Zhou, Qingyue Cao, Changwei Gong, Jingyun Liu, Xingchen Yi, Hansen Shi, Ruiyi Liu, Jirui Xie, Tao Liu, Wenzhuo Ma, Hongzhen Li, Yongyong Chen, Zheng Zhou, Jingyong Su, Jie Liu, Haijin Zeng, Cheng Li, Peishuai Zha, Ziyi Wang, Jian Tang, Yan Chen, Long Bao, Heng Sun, Jiyuan Zhang, Shuai Liu, Wei Ding, Chengjun Guo, Yibin Huang, Xiaotao Wang, Dongqing Zou, Lei Lei, Xiaofeng Wang, Xiao Liu, Yulin Wu, Yuhan Zhao, Shurui Peng, Chao Ren, Yu-Kai Wang, Kosuke Shigematsu, Asuka Shin, Rong-Lin Jian, Cheng-Jun Kang, Jin-Hui Jiang, Jialin Zhou, Kuo Yuan, Songyu Zhang, E B Benson, Ashfaq Hussain, Pruthvikanth AC, Qirui Chen, Jinyuan Chen, Jun Zhang, Xu Zhang, Xuhui Cao, Jiaqi Ma, Laibin Chang, Yuchun Miao, Yichu Xu, Yuanzhi Yao, Shi Chen, Yuning Cui, Huan Zhang, Lefei Zhang, Saeed Ahmad, Ik Hyun Lee, Jun Young Park, Ji Hwan Yoon, Shangquan Sun, Behrooz Nobahar-Moghanlou, Majid Edalatjou, Karim Shahi-Niyar, Ruibo Zhang, Dexiang Hong, Xinyan Liu, Shengeng Tang, Weidong Chen
...
**Comment:** Matches criterion 4 moderately well: a vision foundation-model-adjacent image restoration benchmark/challenge focused on real-world all-in-one restoration.
**Relevance:** 5
**Novelty:** 3

---

## 8. [Distribution-Alignment Bridge for Uncertainty-Aware Text-to-Video Retrieval](https://arxiv.org/abs/2607.20984) <a id="link8"></a>
**ArXiv ID:** 2607.20984
**Authors:** Kyeongmo Chae, Jihoon Lee, Sangtae Ahn
...
**Comment:** No close match to criteria 1-4; it is a text-to-video retrieval method with uncertainty modeling, relevant to multimodal learning but not one of the specified paper types.
**Relevance:** 3
**Novelty:** 5

---

## 9. [Sidewalk Moments: Are Richer Representations Always More Human-Aligned? Evidence from City-Walk Videos](https://arxiv.org/abs/2607.20903) <a id="link9"></a>
**ArXiv ID:** 2607.20903
**Authors:** Liu Liu, Freya Huying Tan, F\'abio Duarte
...
**Comment:** No close match to criteria 1-4; it studies human-aligned visual representations for city-walk engagement, which is interesting but not a direct match to the requested vision-language or embodied-AI criteria.
**Relevance:** 3
**Novelty:** 5
