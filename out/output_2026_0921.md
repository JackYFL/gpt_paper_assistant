# Personalized Daily ArXiv Papers 09/21/2026
...
0. [A Scene Language Model for Open-Vocabulary Scene Mapping](#link0)
...
1. [MintAct: A Unified Visual Agent for Digital Environments](#link1)
**Authors:** Mingfei Gao, Rui Tian, Haiming Gang, Bohan Zhai, Le Zhang, Yuanzheng Gong, Di Feng, Ege \"Ozsoy, Kaixin Ma, Vishwesh Kirthivasan, O\u{g}uzhan Fatih Kar, Roman Bachmann, Anders Boesen Lindbo Larsen, Afshin Dehghan

2. [ZYT-World: A Real-Time Controllable World Model for Closed-Loop Autonomous-Driving Simulation](#link2)
...
3. [VideoReloc: Long-Term Indoor Video Relocalization against a Kilobyte-Scale Semantic Scene Graph](#link3)
**Authors:** Qianru Li, Xuyang Chen, Xuqin Wang, Zhenghao Zhang, Hongyi Luo, Tao Wu, Daniel Cremers, Lu Liu, Yanfeng Zhang

4. [Cube-Splat: High-Fidelity 360{\deg} Gaussian Splatting SLAM via Cubemap Factorization and Adjoint-Consistent Optimization](#link4)
**Authors:** Xiangfei Guo, Hao Shi, Yufan Zhang, Zhonghua Yi, Yongqi Mao, Xiaoting Yin, Kaiwei Wang

5. [ME-Dex 1.0: Bringing Heterogeneous Tactile Sensing into World Action Modeling](#link5)
**Authors:** Xuancheng Zhang, Xuetao Liu, Qianying Tang, Jizhe Wang, Zhijing Cheng, Bochen Lin, Haoran Wen, Ming Li, Kun Zhan, Yu Liu

6. [Driving on Registers, Reasoning on Risk: Risk-Aware Occupancy for Register-Based End-to-End Autonomous Driving](#link6)
**Authors:** Jiaxing Chen, Hengduo Zou, YuKai Qin, Yiren Zhao, Lidong Yu, Bolin Gao

7. [Risk-Aware Occupancy for Safety-Oriented End-to-End Autonomous Driving](#link7)
**Authors:** Jiaxing Chen, Hengduo Zou, Yiren Zhao, Bolin Gao

8. [OmniVBench: A Benchmark and Large-Scale Dataset for Omni Reference-to-Video Generation](#link8)
...
9. [VeriFuse: Bounded Vision-Language Arbitration and Reason-Guided Refinement for Cooperative 3D Perception](#link9)
**Authors:** Hongyi Lin, Yiyao Liu, Qi Kang, Heye Huang, Yang Liu, Haris Koutsopoulos, Jinhua Zhao

10. [PRIME: Perception Feedback with Situational Memory Embeddings in VLA Models](#link10)
**Authors:** Erik Deinzer, Naya Baslan, Luca Paparusso, Narunas Vaskevicius, Peter Knott, Luigi Palmieri

11. [SignGPT: Toward LLM-Mediated Sign Language Interaction through Gloss-Free Translation and Generation](#link11)
...
12. [PrismAlign: Prior-Steered Multi-View VLM Alignment for Hallucination-Robust Table OCR](#link12)
**Authors:** Guangyi Liu, Qianjun Huang, Boyu Hou

13. [GestureFAR: Streaming Co-Speech Gesture Generation with Flow Autoregression](#link13)
**Authors:** Pinxin Liu, Haiyang Liu, Jiahao Luo, Junhua Huang, Chunhao Zou, Luchuan Song

---
## 0. [A Scene Language Model for Open-Vocabulary Scene Mapping](https://arxiv.org/abs/2609.21400) <a id="link0"></a>
**ArXiv ID:** 2609.21400
**Authors:** Adam Lilja, Fabio H\"ubel, Siming He, Junsheng Fu, Claire Tomlin, Lars Hammarstrand, Jitendra Malik, Jonas Frey, Marco Pavone
...
**Comment:** Matches criterion 1 and 2 very closely: it proposes a new Scene-Language Model for open-vocabulary 3D scene mapping, giving a novel method for spatial understanding in embodied settings and a new VLM-style system.
**Relevance:** 9
**Novelty:** 8

---

## 1. [MintAct: A Unified Visual Agent for Digital Environments](https://arxiv.org/abs/2609.22083) <a id="link1"></a>
**ArXiv ID:** 2609.22083
**Authors:** Mingfei Gao, Rui Tian, Haiming Gang, Bohan Zhai, Le Zhang, Yuanzheng Gong, Di Feng, Ege \"Ozsoy, Kaixin Ma, Vishwesh Kirthivasan, O\u{g}uzhan Fatih Kar, Roman Bachmann, Anders Boesen Lindbo Larsen, Afshin Dehghan
...
**Comment:** Matches criterion 2 and criterion 3 very strongly: a unified visual agent / VLM for UI grounding, multi-step navigation, and visual tool use across digital environments.
**Relevance:** 9
**Novelty:** 7

---

## 2. [ZYT-World: A Real-Time Controllable World Model for Closed-Loop Autonomous-Driving Simulation](https://arxiv.org/abs/2609.21712) <a id="link2"></a>
**ArXiv ID:** 2609.21712
**Authors:** Boni Hu, Xiong Wei, Haoming Huang, Yong Huang, Chenbo Wang, Yi Yang, Jiancheng Wang, Ruicheng Zhu, Zhimin Yang, Guanglai Liu, Qiaowan Jin, Dongzhuo Wang, Haiwei Kuang, Jiajun Fan, Yue Wu, Jiaxin Wei, Hao Sun, Feihong Yan, Wei Bi, Kaixuan Wang, Zichao Guo, Xiaozhi Chen
...
**Comment:** Strong match for criterion 3: a new real-time controllable world model for closed-loop autonomous-driving simulation, with simulator-style long-horizon rollout and memory handling.
**Relevance:** 8
**Novelty:** 8

---

## 3. [VideoReloc: Long-Term Indoor Video Relocalization against a Kilobyte-Scale Semantic Scene Graph](https://arxiv.org/abs/2609.21804) <a id="link3"></a>
**ArXiv ID:** 2609.21804
**Authors:** Qianru Li, Xuyang Chen, Xuqin Wang, Zhenghao Zhang, Hongyi Luo, Tao Wu, Daniel Cremers, Lu Liu, Yanfeng Zhang
...
**Comment:** Matches criterion 1 and 3 very closely: it targets long-term indoor relocalization with a compact semantic scene graph, introducing a new embodied spatial method and a simulator/benchmark-style evaluation setting.
**Relevance:** 8
**Novelty:** 7

---

## 4. [Cube-Splat: High-Fidelity 360{\deg} Gaussian Splatting SLAM via Cubemap Factorization and Adjoint-Consistent Optimization](https://arxiv.org/abs/2609.21347) <a id="link4"></a>
**ArXiv ID:** 2609.21347
**Authors:** Xiangfei Guo, Hao Shi, Yufan Zhang, Zhonghua Yi, Yongqi Mao, Xiaoting Yin, Kaiwei Wang
...
**Comment:** Matches criterion 3: a new panoramic GS-SLAM framework plus a synthetic benchmark dataset for 360° SLAM evaluation.
**Relevance:** 7
**Novelty:** 7

---

## 5. [ME-Dex 1.0: Bringing Heterogeneous Tactile Sensing into World Action Modeling](https://arxiv.org/abs/2609.21449) <a id="link5"></a>
**ArXiv ID:** 2609.21449
**Authors:** Xuancheng Zhang, Xuetao Liu, Qianying Tang, Jizhe Wang, Zhijing Cheng, Bochen Lin, Haoran Wen, Ming Li, Kun Zhan, Yu Liu
...
**Comment:** Matches criterion 3 very well: an embodied manipulation method that brings tactile sensing into world-action modeling, with a new heterogeneous tactile data engine and simulator-based evaluation.
**Relevance:** 7
**Novelty:** 7

---

## 6. [Driving on Registers, Reasoning on Risk: Risk-Aware Occupancy for Register-Based End-to-End Autonomous Driving](https://arxiv.org/abs/2609.21486) <a id="link6"></a>
**ArXiv ID:** 2609.21486
**Authors:** Jiaxing Chen, Hengduo Zou, YuKai Qin, Yiren Zhao, Lidong Yu, Bolin Gao
...
**Comment:** Matches criterion 3: a new register-based driving method with risk-aware occupancy and a new risk-annotated benchmark for trajectory selection.
**Relevance:** 7
**Novelty:** 6

---

## 7. [Risk-Aware Occupancy for Safety-Oriented End-to-End Autonomous Driving](https://arxiv.org/abs/2609.21470) <a id="link7"></a>
**ArXiv ID:** 2609.21470
**Authors:** Jiaxing Chen, Hengduo Zou, Yiren Zhao, Bolin Gao
...
**Comment:** Matches criterion 3: a new safety-oriented end-to-end driving method based on risk-aware occupancy, plus a new risk benchmark for autonomous driving.
**Relevance:** 7
**Novelty:** 6

---

## 8. [OmniVBench: A Benchmark and Large-Scale Dataset for Omni Reference-to-Video Generation](https://arxiv.org/abs/2609.22069) <a id="link8"></a>
**ArXiv ID:** 2609.22069
**Authors:** Wenxue Li, Peiyan Guan, Haoyang Jiang, Junxian Cai, Hualuo Liu, Chunjie Zhang, Chong Guan, Songlian Li, Taiyi Wu, Yongjian Yu, Xiaotong Zhao, Alan Zhao, Eric Liu, Xi Chen, Yu Liu, Lei Zhu
...
**Comment:** Matches criterion 4 partially and is also a strong benchmark paper: it builds a new large-scale benchmark/dataset for reference-to-video generation, which may interest someone following multimodal generative modeling and evaluation.
**Relevance:** 5
**Novelty:** 7

---

## 9. [VeriFuse: Bounded Vision-Language Arbitration and Reason-Guided Refinement for Cooperative 3D Perception](https://arxiv.org/abs/2609.21323) <a id="link9"></a>
**ArXiv ID:** 2609.21323
**Authors:** Hongyi Lin, Yiyao Liu, Qi Kang, Heye Huang, Yang Liu, Haris Koutsopoulos, Jinhua Zhao
...
**Comment:** Matches criterion 4 and criterion 2: it uses a frozen VLM for bounded arbitration in cooperative 3D perception, a clear vision-foundation-model application.
**Relevance:** 6
**Novelty:** 6

---

## 10. [PRIME: Perception Feedback with Situational Memory Embeddings in VLA Models](https://arxiv.org/abs/2609.22040) <a id="link10"></a>
**ArXiv ID:** 2609.22040
**Authors:** Erik Deinzer, Naya Baslan, Luca Paparusso, Narunas Vaskevicius, Peter Knott, Luigi Palmieri
...
**Comment:** Matches criterion 3: a new VLA driving method that adds perception feedback via situational memory, improving closed-loop autonomous driving behavior.
**Relevance:** 6
**Novelty:** 6

---

## 11. [SignGPT: Toward LLM-Mediated Sign Language Interaction through Gloss-Free Translation and Generation](https://arxiv.org/abs/2609.21709) <a id="link11"></a>
**ArXiv ID:** 2609.21709
**Authors:** Ronghui Li, Jun Dong, Zhongyuan Hu, Zunnan Xu, Jun Zhou, Liyuan Chen, Shuoling Liu, Jiangpeng Yan, Jie Guo, Xiu Li, Linchao Bao
...
**Comment:** Matches criterion 3: unified sign-language translation and generation with a new pose-based framework, which is an embodied interaction setting with a novel bidirectional formulation.
**Relevance:** 5
**Novelty:** 6

---

## 12. [PrismAlign: Prior-Steered Multi-View VLM Alignment for Hallucination-Robust Table OCR](https://arxiv.org/abs/2609.21351) <a id="link12"></a>
**ArXiv ID:** 2609.21351
**Authors:** Guangyi Liu, Qianjun Huang, Boyu Hou
...
**Comment:** Matches criterion 2 partially: it uses multiple VLMs in a new alignment framework for OCR, but the paper is mainly about document/table extraction rather than a new general VLLM or embodied method.
**Relevance:** 4
**Novelty:** 5

---

## 13. [GestureFAR: Streaming Co-Speech Gesture Generation with Flow Autoregression](https://arxiv.org/abs/2609.21576) <a id="link13"></a>
**ArXiv ID:** 2609.21576
**Authors:** Pinxin Liu, Haiyang Liu, Jiahao Luo, Junhua Huang, Chunhao Zou, Luchuan Song
...
**Comment:** Matches criterion 3 only very loosely: it is an embodied conversational agent method, but the focus is co-speech gesture generation rather than a new embodied AI benchmark or spatial intelligence method.
**Relevance:** 3
**Novelty:** 6
