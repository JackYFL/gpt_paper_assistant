...
0. [VQ-Transplant: Efficient VQ-Module Integration for Pre-trained Visual Tokenizers](#link0)
**Authors:** Xianghong Fang, Yuan Yuan, Dehan Kong, Tim G. J. Rudner

1. [RS-RIE-Bench: Benchmarking Reasoning-Guided Remote Sensing Image Editing](#link1)
**Authors:** Zihan Qin, Boao Xu, Zhao Dong, Yingping Sun, Ziheng Jiao, Junying Wang, Hongwei Wang

2. [LAVIFT: Latent-Action-Guided Vision Fine-Tuning for Surgical Interaction Recognition](#link2)
**Authors:** Jiajun Cheng, Subarna Tripathi, Sainan Liu, Xiaofan Yu, Shan Lin

3. [Look Less, Think Faster: Joint Token-Compute Adaptation for Multimodal LLMs](#link3)
**Authors:** Pengcheng Wang, Zhiquan Wang, Jayoung Lee, Zhuoyan Xu, Ran Xu, Saurabh Bagchi, Yin Li, Somali Chaterji

4. [Not All Patches are Equal: Sampling Matters for Visible-Infrared Pre-Training](#link4)
**Authors:** Qiwei Ma, Bin Deng, Junjie Zhu, Qiangjuan Huang, Puhong Duan, Ke Yang, Xudong Kang, Shutao Li

5. [Diverse-Intent Multi-Turn Fashion Image Retrieval](#link5)
**Authors:** Mingqiang Tang, Haokun Wen, Meng Liu, Yupeng Hu, Weili Guan, Xuemeng Song

6. [MV-Bench: Benchmarking Multimodal Large Language Models for Coordinated Multi-View Interface Construction](#link6)
**Authors:** Yue Zhao, Hongxu Liu, Feiyu Wang, Xiaoyu Yang, Tong Ge, Zhen Yang, Chao Wang, Qiong Zeng

7. [STEREOFLOW: Progressive Stereo Matching with StereoDiT and Transition Flow Matching](#link7)
**Authors:** Hao Wang, Haoran Geng, Xiaotong Yang, Jing Tang, Songlin Wei, Linlong Lang, Yeying Jin, Zheng Zhu, Zhaoxin Fan, Biao Leng

8. [Multimodal Large Language Models for Remote Sensing Image Understanding: Domain-Specific or General-Purpose?](#link8)
**Authors:** Qiwei Ma, Chunping Qiu, Xinjun Cheng, Xiaoyu Zhang, Puhong Duan, Ke Yang, Xudong Kang, Shutao Li

9. [HeadCast: Casting Attention Heads for Efficient Autoregressive Video Generation](#link9)
**Authors:** Jinliang Shen, Lianghao Su, Zheming Li, Kang He, ZiLiang Lai, Yanbing Jiang, Chengru Song

10. [WearWow: Native 2K Multi-Garment Virtual Try-On via Adaptive Token Packing and Preference Alignment](#link10)
**Authors:** Xujie Zhang, Runyan Du, Song Chang, Jiang Li, Dongliang Shao, Liping Wu, Wei Luo, Xiaochao Qu, Luoqi Liu, Xiaodan Liang

11. [Efficient Tracking and Understanding Object Transformations](#link11)
**Authors:** Yihong Sun, Bharath Hariharan

12. [OffNadirLoc: Benchmark and Framework for Challenging UAV-to-Satellite Geo-Localization under Large Off-Nadir Views](#link12)
**Authors:** Qian Qiao, Wenye Liu, Ting Liu, Jiuhe Shu, Peng Wang

13. [Importance-Aware OBS Pruning for Diffusion Models](#link13)
**Authors:** Ba-Thinh Lam, Srijan Das, Hieu Le

14. [Toward Reliable RGB-D Semantic Segmentation: Handling Missing Modalities via Condition Dropout](#link14)
**Authors:** Xuchen Zhu, Yajuan Wei, Shuang Hao, Jiwei Jiang, Guanxiang Mao, Fang Ren

---
## 0. [VQ-Transplant: Efficient VQ-Module Integration for Pre-trained Visual Tokenizers](https://arxiv.org/abs/2607.19575) <a id="link0"></a>
**ArXiv ID:** 2607.19575
**Authors:** Xianghong Fang, Yuan Yuan, Dehan Kong, Tim G. J. Rudner
...
**Comment:** Matches criterion 4 closely: it is about visual tokenizer/VQ infrastructure for pre-trained vision foundation models and efficient adaptation of discrete visual tokenization.
**Relevance:** 5
**Novelty:** 6

---

## 1. [RS-RIE-Bench: Benchmarking Reasoning-Guided Remote Sensing Image Editing](https://arxiv.org/abs/2607.20197) <a id="link1"></a>
**ArXiv ID:** 2607.20197
**Authors:** Zihan Qin, Boao Xu, Zhao Dong, Yingping Sun, Ziheng Jiao, Junying Wang, Hongwei Wang
...
**Comment:** Matches criterion 3 very closely: a new benchmark for reasoning-guided remote sensing image editing, with explicit spatial reasoning evaluation.
**Relevance:** 5
**Novelty:** 6

---

## 2. [LAVIFT: Latent-Action-Guided Vision Fine-Tuning for Surgical Interaction Recognition](https://arxiv.org/abs/2607.19889) <a id="link2"></a>
**ArXiv ID:** 2607.19889
**Authors:** Jiajun Cheng, Subarna Tripathi, Sainan Liu, Xiaofan Yu, Shan Lin
...
**Comment:** Strong match to criterion 4: it adapts pretrained vision-language / vision foundation models to a surgical interaction recognition task with a grounding-oriented fine-tuning method.
**Relevance:** 5
**Novelty:** 6

---

## 3. [Look Less, Think Faster: Joint Token-Compute Adaptation for Multimodal LLMs](https://arxiv.org/abs/2607.20357) <a id="link3"></a>
**ArXiv ID:** 2607.20357
**Authors:** Pengcheng Wang, Zhiquan Wang, Jayoung Lee, Zhuoyan Xu, Ran Xu, Saurabh Bagchi, Yin Li, Somali Chaterji
...
**Comment:** Strong match to criterion 2: it proposes a new MLLM inference framework with joint vision-token and LLM compute adaptation.
**Relevance:** 5
**Novelty:** 6

---

## 4. [Not All Patches are Equal: Sampling Matters for Visible-Infrared Pre-Training](https://arxiv.org/abs/2607.20238) <a id="link4"></a>
**ArXiv ID:** 2607.20238
**Authors:** Qiwei Ma, Bin Deng, Junjie Zhu, Qiangjuan Huang, Puhong Duan, Ke Yang, Xudong Kang, Shutao Li
...
**Comment:** Matches criterion 4 very closely: a VIS-IR pre-training method for multi-sensor representation learning, with a nontrivial sampling/curriculum trick for foundation-style pretraining.
**Relevance:** 5
**Novelty:** 5

---

## 5. [Diverse-Intent Multi-Turn Fashion Image Retrieval](https://arxiv.org/abs/2607.20291) <a id="link5"></a>
**ArXiv ID:** 2607.20291
**Authors:** Mingqiang Tang, Haokun Wen, Meng Liu, Yupeng Hu, Weili Guan, Xuemeng Song
...
**Comment:** Strong match to criterion 2: it proposes an MLLM-based framework and a new benchmark for diverse-intent multi-turn fashion image retrieval.
**Relevance:** 5
**Novelty:** 5

---

## 6. [MV-Bench: Benchmarking Multimodal Large Language Models for Coordinated Multi-View Interface Construction](https://arxiv.org/abs/2607.19910) <a id="link6"></a>
**ArXiv ID:** 2607.19910
**Authors:** Yue Zhao, Hongxu Liu, Feiyu Wang, Xiaoyu Yang, Tong Ge, Zhen Yang, Chao Wang, Qiong Zeng
...
**Comment:** Strong match to criterion 2: it introduces a benchmark for evaluating MLLMs on coordinated multi-view interface construction.
**Relevance:** 5
**Novelty:** 5

---

## 7. [STEREOFLOW: Progressive Stereo Matching with StereoDiT and Transition Flow Matching](https://arxiv.org/abs/2607.19986) <a id="link7"></a>
**ArXiv ID:** 2607.19986
**Authors:** Hao Wang, Haoran Geng, Xiaotong Yang, Jing Tang, Songlin Wei, Linlong Lang, Yeying Jin, Zheng Zhu, Zhaoxin Fan, Biao Leng
...
**Comment:** Weakly related to criterion 4 via generative modeling in vision, but it is stereo matching rather than a vision foundation model or embodied AI method.
**Relevance:** 3
**Novelty:** 6

---

## 8. [Multimodal Large Language Models for Remote Sensing Image Understanding: Domain-Specific or General-Purpose?](https://arxiv.org/abs/2607.20284) <a id="link8"></a>
**ArXiv ID:** 2607.20284
**Authors:** Qiwei Ma, Chunping Qiu, Xinjun Cheng, Xiaoyu Zhang, Puhong Duan, Ke Yang, Xudong Kang, Shutao Li
...
**Comment:** Matches criterion 2 very closely: a systematic survey/diagnostic of MLLMs for remote sensing image understanding, including general-purpose versus domain-specific model comparison.
**Relevance:** 5
**Novelty:** 4

---

## 9. [HeadCast: Casting Attention Heads for Efficient Autoregressive Video Generation](https://arxiv.org/abs/2607.20125) <a id="link9"></a>
**ArXiv ID:** 2607.20125
**Authors:** Jinliang Shen, Lianghao Su, Zheming Li, Kang He, ZiLiang Lai, Yanbing Jiang, Chengru Song
...
**Comment:** No close match to criteria 1-4; this is efficient autoregressive video generation, relevant to generative modeling but not specifically to the listed spatial/embodied/MLLM/benchmark themes.
**Relevance:** 3
**Novelty:** 6

---

## 10. [WearWow: Native 2K Multi-Garment Virtual Try-On via Adaptive Token Packing and Preference Alignment](https://arxiv.org/abs/2607.19923) <a id="link10"></a>
**ArXiv ID:** 2607.19923
**Authors:** Xujie Zhang, Runyan Du, Song Chang, Jiang Li, Dongliang Shao, Liping Wu, Wei Luo, Xiaochao Qu, Luoqi Liu, Xiaodan Liang
...
**Comment:** No close match to criteria 1-4; this is a multimodal generative modeling paper for virtual try-on, which may still interest your friend but is not specifically about the listed criteria.
**Relevance:** 3
**Novelty:** 6

---

## 11. [Efficient Tracking and Understanding Object Transformations](https://arxiv.org/abs/2607.19743) <a id="link11"></a>
**ArXiv ID:** 2607.19743
**Authors:** Yihong Sun, Bharath Hariharan
...
**Comment:** No close match to criteria 1-4, though it does use a vision foundation model component (SAM2) for video object transformation tracking as an application.
**Relevance:** 3
**Novelty:** 6

---

## 12. [OffNadirLoc: Benchmark and Framework for Challenging UAV-to-Satellite Geo-Localization under Large Off-Nadir Views](https://arxiv.org/abs/2607.19951) <a id="link12"></a>
**ArXiv ID:** 2607.19951
**Authors:** Qian Qiao, Wenye Liu, Ting Liu, Jiuhe Shu, Peng Wang
...
**Comment:** Partial match to criterion 3: it introduces a new benchmark for UAV-to-satellite geo-localization under challenging viewpoints, but it is not an embodied AI simulator benchmark.
**Relevance:** 4
**Novelty:** 5

---

## 13. [Importance-Aware OBS Pruning for Diffusion Models](https://arxiv.org/abs/2607.20048) <a id="link13"></a>
**ArXiv ID:** 2607.20048
**Authors:** Ba-Thinh Lam, Srijan Das, Hieu Le
...
**Comment:** No close match to criteria 1-4; this is a training-free compression/pruning method for diffusion models, adjacent to criterion 4 but not a foundation-model application paper.
**Relevance:** 3
**Novelty:** 5

---

## 14. [Toward Reliable RGB-D Semantic Segmentation: Handling Missing Modalities via Condition Dropout](https://arxiv.org/abs/2607.20326) <a id="link14"></a>
**ArXiv ID:** 2607.20326
**Authors:** Xuchen Zhu, Yajuan Wei, Shuang Hao, Jiwei Jiang, Guanxiang Mao, Fang Ren
...
**Comment:** No close match to criteria 1-4; this is RGB-D semantic segmentation robustness under missing modalities, which is adjacent but not centered on the requested themes.
**Relevance:** 3
**Novelty:** 4
