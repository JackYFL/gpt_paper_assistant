# Personalized Daily ArXiv Papers 07/03/2026
...
0. [Show Me Examples: Inferring Visual Concepts from Image Sets](#link0)
**Authors:** Nick Stracke, Kolja Bauer, Stefan Andreas Baumann, Miguel Angel Bautista, Josh Susskind, Bj\"orn Ommer

1. [UnderOneFacade: Worldwide Facade Semantic Segmentation Benchmark Dataset](#link1)
...
2. [DetailAnywhere: Fashion Detail Generation via Cross-Modal Feature Alignment Distillation](#link2)
...
3. [WorldDirector: Building Controllable World Simulators with Persistent Dynamic Memory](#link3)
...
4. [Discrete Diffusion Language Models for Interactive Radiology Report Drafting](#link4)
**Authors:** Max Van Puyvelde, Halil Ibrahim Gulluk, Wim Van Criekinge, Olivier Gevaert

5. [LLM-Empowered Multimodal Fusion Framework for Autonomous Driving: Semantic Enhancement and Channel-Adaptive Design](#link5)
**Authors:** Wen Wang, Yaping Sun, Yejun He, Hao Chen, Zhiyong Chen, Xiaodong Xu, Nan Ma, Shuguang Cui

6. [Text-Driven 3D Indoor Scene Synthesis in Non-Manhattan Environments](#link6)
...
7. [Online Segment 3D Gaussians via Launching Virtual Drones](#link7)
**Authors:** Liwei Liao, Rongjie Wang, Ronggang Wang

8. [KathaTrace: Diagnosing Semantic Trajectory Collapse in Generated Visual Narratives](#link8)
**Authors:** Jamuna S. Murthy, Amin Karimi Monsefi, Rajiv Ramnath

9. [Diversity-aware View Partitioning for Scalable VGGT](#link9)
**Authors:** Jinsoo Park, Donggyu Choi, Ahyun Seo, Minsu cho, Jeany Son

10. [CPG-PAD: Concept-Informed Prompts Guided Presentation Attack Detection](#link10)
**Authors:** Haoyuan Zhang, Xiangyu Zhu, Li Gao, Ajian Liu, Siran Peng, Zhen Lei

11. [NEvo: Neural-Guided Evolutionary Video Synthesis for Dynamic Visual Selectivity](#link11)
**Authors:** Yingtian Tang, Sogand Salehi, Ming Zhou, Amir Zamir, Leyla Isik, Martin Schrimpf

12. [Assessing VLM Reliability for Medical Image Quality Evaluation Under Corruption and Bias](#link12)
**Authors:** Sofiane Ouaari, Kevin Vorwalder, Nico Pfeifer

13. [Towards Real-World Ultrasound Understanding: Large Vision-Language Models from Multi-Image Examinations with Long-Form Reports](#link13)
**Authors:** Bingcong Yan, Chunlei Li, Jingliang Hu, Yilei Shi, Xiao Xiang Zhu, Lichao Mou

14. [Dual-Selective Network for Domain-Incremental Change Detection](#link14)
**Authors:** Yuzhi He, Junxi Huang, Haorui Wu, Jiahui Qu

15. [Multi-Resolution Flow Matching: Training-Free Diffusion Acceleration via Staged Sampling](#link15)
**Authors:** Xingyu Zheng, Xianglong Liu, Yifu Ding, Weilun Feng, Junqing Lin, Jinyang Guo, Haotong Qin

16. [Patient-Specific Articulated Digital Twins from a Single Full-Body CT Scan](#link16)
**Authors:** Han Zhang, Boyang Zhao, Mathias Unberath

17. [Beyond Heatmaps: Unsupervised Concept-Graph Reasoning for Interpretable Visual Explanation](#link17)
**Authors:** Md Mohasin Hossain (German Research Center for Artificial Intelligence, Saarland University, Saarbr\"ucken, Germany), Anar Amirli (BEGO GmbH & Co. KG, Bremen, Germany), Robert Leist (German Research Center for Artificial Intelligence), Md Abdul Kadir (German Research Center for Artificial Intelligence, Oldenburg University, Oldenburg, Germany), Daniel Sonntag (German Research Center for Artificial Intelligence, Oldenburg University, Oldenburg, Germany)

18. [Spatial-Temporal Expert Learning for Video-based Person Re-identification](#link18)
**Authors:** Xiaofei Hui, Pengfei Wang, Evan Ling, Dezhao Huang, Keng Teck Ma, Minhoe Hur, Jun Liu

---
## 0. [Show Me Examples: Inferring Visual Concepts from Image Sets](https://arxiv.org/abs/2607.02402) <a id="link0"></a>
**ArXiv ID:** 2607.02402
**Authors:** Nick Stracke, Kolja Bauer, Stefan Andreas Baumann, Miguel Angel Bautista, Josh Susskind, Bj\"orn Ommer
...
**Comment:** Matches criterion 2 very closely: it proposes a VLM/MLLM-style method for inferring visual concepts from image sets and applying them to generation.
**Relevance:** 7
**Novelty:** 6

---

## 1. [UnderOneFacade: Worldwide Facade Semantic Segmentation Benchmark Dataset](https://arxiv.org/abs/2607.02018) <a id="link1"></a>
**ArXiv ID:** 2607.02018
**Authors:** Yi Wang, Fan Wang, Prabin Gyawali, Ziyang Xu, Anna Klimkowska, Yixiong Jing, Wanru Yang, Filip Biljecki, Christoph Holst, Benjamin Busam, Brian Sheil, Olaf Wysocki
...
**Comment:** Matches criterion 3 strongly: it introduces a new large-scale benchmark for cross-country 3D facade segmentation and transfer evaluation.
**Relevance:** 6
**Novelty:** 6

---

## 2. [DetailAnywhere: Fashion Detail Generation via Cross-Modal Feature Alignment Distillation](https://arxiv.org/abs/2607.02220) <a id="link2"></a>
**ArXiv ID:** 2607.02220
**Authors:** Zijun Li, Yimin Zhou, Jia Sun, Honglie Wang, Pengcheng Wei, Junlong Wu, Yongrui Heng, Jiyuan Wang, Huan Ouyang, Boheng Zhang, Huaiqing Wang, Dewen Fan, Qianqian Gan, Fan Yang, Tingting Gao
...
**Comment:** Matches criterion 3: it builds a new benchmark (FDBench) and a new method for fashion detail generation with focus conditioning.
**Relevance:** 6
**Novelty:** 6

---

## 3. [WorldDirector: Building Controllable World Simulators with Persistent Dynamic Memory](https://arxiv.org/abs/2607.02517) <a id="link3"></a>
**ArXiv ID:** 2607.02517
**Authors:** Hanlin Wang, Hao Ouyang, Qiuyu Wang, Wen Wang, Qingyan Bai, Ka Leong Cheng, Yue Yu, Yixuan Li, Yihao Meng, Zichen Liu, Yanhong Zeng, Yujun Shen, Qifeng Chen
...
**Comment:** Matches criterion 3 very closely: it is a new controllable world simulator/world model with persistent dynamic memory and viewpoint exploration, which is directly relevant to embodied simulation and world modeling.
**Relevance:** 5
**Novelty:** 7

---

## 4. [Discrete Diffusion Language Models for Interactive Radiology Report Drafting](https://arxiv.org/abs/2607.01436) <a id="link4"></a>
**ArXiv ID:** 2607.01436
**Authors:** Max Van Puyvelde, Halil Ibrahim Gulluk, Wim Van Criekinge, Olivier Gevaert
...
**Comment:** Matches criterion 2 and also the friend's interest in VLLMs: it studies a diffusion-based multimodal model for medical visual question answering and interactive report drafting, with any-order infill as a new capability.
**Relevance:** 6
**Novelty:** 6

---

## 5. [LLM-Empowered Multimodal Fusion Framework for Autonomous Driving: Semantic Enhancement and Channel-Adaptive Design](https://arxiv.org/abs/2607.01772) <a id="link5"></a>
**ArXiv ID:** 2607.01772
**Authors:** Wen Wang, Yaping Sun, Yejun He, Hao Chen, Zhiyong Chen, Xiaodong Xu, Nan Ma, Shuguang Cui
...
**Comment:** Matches criterion 1 and 2: it introduces an LLM-centered multimodal fusion framework for autonomous driving with channel-adaptive semantic reasoning.
**Relevance:** 6
**Novelty:** 5

---

## 6. [Text-Driven 3D Indoor Scene Synthesis in Non-Manhattan Environments](https://arxiv.org/abs/2607.02407) <a id="link6"></a>
**ArXiv ID:** 2607.02407
**Authors:** Xianhui Meng, Zirui Song, Yuchen Zhang, Li Zhang, Yongxuan Lv, Xiuying Chen, Kun Wang, Yan Luo, Kai Chen, Hangjun Ye, Long Chen, Jun Liu, Xiaoshuai Hao
...
**Comment:** Matches criterion 3: it is a text-driven 3D indoor scene synthesis method and also introduces a new benchmark for non-Manhattan environments, a novel spatial/layout angle that prior work often ignores.
**Relevance:** 5
**Novelty:** 6

---

## 7. [Online Segment 3D Gaussians via Launching Virtual Drones](https://arxiv.org/abs/2607.01628) <a id="link7"></a>
**ArXiv ID:** 2607.01628
**Authors:** Liwei Liao, Rongjie Wang, Ronggang Wang
...
**Comment:** Matches criterion 3 very closely: it is an embodied/3D scene method for online interactive segmentation of 3D Gaussians, with a new setup-free simulator-like workflow via virtual drones and NBV planning.
**Relevance:** 5
**Novelty:** 6

---

## 8. [KathaTrace: Diagnosing Semantic Trajectory Collapse in Generated Visual Narratives](https://arxiv.org/abs/2607.01312) <a id="link8"></a>
**ArXiv ID:** 2607.01312
**Authors:** Jamuna S. Murthy, Amin Karimi Monsefi, Rajiv Ramnath
...
**Comment:** Matches criterion 3: it introduces a new benchmark/protocol for a previously underexplored failure mode in generated visual narratives, plus a post-generation repair probe.
**Relevance:** 4
**Novelty:** 6

---

## 9. [Diversity-aware View Partitioning for Scalable VGGT](https://arxiv.org/abs/2607.01885) <a id="link9"></a>
**ArXiv ID:** 2607.01885
**Authors:** Jinsoo Park, Donggyu Choi, Ahyun Seo, Minsu cho, Jeany Son
...
**Comment:** Matches criterion 1: it proposes a training-free view partitioning method to improve scalable multi-view geometric reasoning in VGGT.
**Relevance:** 5
**Novelty:** 5

---

## 10. [CPG-PAD: Concept-Informed Prompts Guided Presentation Attack Detection](https://arxiv.org/abs/2607.01303) <a id="link10"></a>
**ArXiv ID:** 2607.01303
**Authors:** Haoyuan Zhang, Xiangyu Zhu, Li Gao, Ajian Liu, Siran Peng, Zhen Lei
...
**Comment:** Matches criterion 2: it uses VLM/prompt learning ideas for presentation attack detection, with explicit concept-guided prompting.
**Relevance:** 5
**Novelty:** 5

---

## 11. [NEvo: Neural-Guided Evolutionary Video Synthesis for Dynamic Visual Selectivity](https://arxiv.org/abs/2607.02317) <a id="link11"></a>
**ArXiv ID:** 2607.02317
**Authors:** Yingtian Tang, Sogand Salehi, Ming Zhou, Amir Zamir, Leyla Isik, Martin Schrimpf
...
**Comment:** No direct match to the listed criteria, though it is interesting generative modeling for dynamic visual stimuli and vision neuroscience.
**Relevance:** 3
**Novelty:** 6

---

## 12. [Assessing VLM Reliability for Medical Image Quality Evaluation Under Corruption and Bias](https://arxiv.org/abs/2607.01973) <a id="link12"></a>
**ArXiv ID:** 2607.01973
**Authors:** Sofiane Ouaari, Kevin Vorwalder, Nico Pfeifer
...
**Comment:** Matches criterion 2 in the broad sense: it systematically evaluates VLM reliability under corruption and bias, with surprising empirical findings.
**Relevance:** 4
**Novelty:** 5

---

## 13. [Towards Real-World Ultrasound Understanding: Large Vision-Language Models from Multi-Image Examinations with Long-Form Reports](https://arxiv.org/abs/2607.01908) <a id="link13"></a>
**ArXiv ID:** 2607.01908
**Authors:** Bingcong Yan, Chunlei Li, Jingliang Hu, Yilei Shi, Xiao Xiang Zhu, Lichao Mou
...
**Comment:** Matches criterion 2: it introduces a large vision-language model setup for real-world ultrasound with multi-image examinations and long-form reports, emphasizing scaling and a simple yet effective training recipe.
**Relevance:** 5
**Novelty:** 4

---

## 14. [Dual-Selective Network for Domain-Incremental Change Detection](https://arxiv.org/abs/2607.02299) <a id="link14"></a>
**ArXiv ID:** 2607.02299
**Authors:** Yuzhi He, Junxi Huang, Haorui Wu, Jiahui Qu
...
**Comment:** Matches criterion 1 only partially: it is a spatial change-detection method with selective state-space modeling, but not embodied spatial intelligence.
**Relevance:** 3
**Novelty:** 5

---

## 15. [Multi-Resolution Flow Matching: Training-Free Diffusion Acceleration via Staged Sampling](https://arxiv.org/abs/2607.01642) <a id="link15"></a>
**ArXiv ID:** 2607.01642
**Authors:** Xingyu Zheng, Xianglong Liu, Yifu Ding, Weilun Feng, Junqing Lin, Jinyang Guo, Haotong Qin
...
**Comment:** Matches criterion 4 only indirectly: it concerns generative modeling and diffusion acceleration, but not vision foundation models in the sense of representation or downstream applications.
**Relevance:** 3
**Novelty:** 5

---

## 16. [Patient-Specific Articulated Digital Twins from a Single Full-Body CT Scan](https://arxiv.org/abs/2607.02156) <a id="link16"></a>
**ArXiv ID:** 2607.02156
**Authors:** Han Zhang, Boyang Zhao, Mathias Unberath
...
**Comment:** Matches criterion 3 only loosely: it builds a patient-specific articulated digital twin from CT for pose-dependent rendering, which is simulator-related but not a novel embodied AI benchmark or agent method.
**Relevance:** 3
**Novelty:** 5

---

## 17. [Beyond Heatmaps: Unsupervised Concept-Graph Reasoning for Interpretable Visual Explanation](https://arxiv.org/abs/2607.01416) <a id="link17"></a>
**ArXiv ID:** 2607.01416
**Authors:** Md Mohasin Hossain (German Research Center for Artificial Intelligence, Saarland University, Saarbr\"ucken, Germany), Anar Amirli (BEGO GmbH & Co. KG, Bremen, Germany), Robert Leist (German Research Center for Artificial Intelligence), Md Abdul Kadir (German Research Center for Artificial Intelligence, Oldenburg University, Oldenburg, Germany), Daniel Sonntag (German Research Center for Artificial Intelligence, Oldenburg University, Oldenburg, Germany)
...
**Comment:** Matches criterion 1 only loosely: it adds spatially grounded concept-graph reasoning with region-level concept recurrence, which is a methodological improvement for visual explanation, but not embodied spatial intelligence.
**Relevance:** 3
**Novelty:** 5

---

## 18. [Spatial-Temporal Expert Learning for Video-based Person Re-identification](https://arxiv.org/abs/2607.01353) <a id="link18"></a>
**ArXiv ID:** 2607.01353
**Authors:** Xiaofei Hui, Pengfei Wang, Evan Ling, Dezhao Huang, Keng Teck Ma, Minhoe Hur, Jun Liu
...
**Comment:** Matches criterion 1 only loosely: it adds spatial-temporal expert selection for fine-grained video re-identification, but it is not about embodied spatial understanding.
**Relevance:** 3
**Novelty:** 4
