...
0. [Hy-Embodied-VLM-1.0: Efficient Physical-World Agents](#link0)
...
1. [UniVR: Thinking in Visual Space for Unified Visual Reasoning](#link1)
**Authors:** Zhongwei Ren, Yunchao Wei, Yao Zhao, Weibo Gong, Xiao Liu, Anran Wang, Xiangtai Li, Xiaojie Jin

2. [Let RGB Be the Language of Vision](#link2)
...
3. [AVSCap: Orchestrating Audio-Visual Synergy for Omni-modal Video Captioning](#link3)
...
4. [MetaView: Monocular Novel View Synthesis with Scale-Aware Implicit Geometry Priors](#link4)
**Authors:** Yufei Cai, Xuesong Niu, Hao Lu, Kun Gai, Kai Wu, Guosheng Lin

5. [DynTrace: Tracking Dynamic Object Evidence for 4D Spatio-Temporal Reasoning in MLLMs](#link5)
...
6. [ARDepth: Auto-regressive Monocular Depth Estimation with Progressive Visual Conditioning](#link6)
**Authors:** Zijie Wang, Wei Zhang, Weiming Zhang, Xiao Tan, Weikai Chen, Xiaoxu Li, Guanbin Li

7. [Hallo4D: Multi-Modal Hallucination Mitigation for Consistent Spatio-Temporal Generation](#link7)
**Authors:** Hongbo Wang, Huaibo Huang, Jie Cao, Jin Liu, Haoyang Tong, Ran He

8. [SymbOmni: Evolving Agentic Omni Models via Symbolic Concept Learning](#link8)
**Authors:** Jinxiu Liu, Jianru Li, Tanqing Kuang, Xuanming Liu, Kangfu Mei, Yandong Wen, Weiyang Liu

9. [ViCo3D: Empowering LiDAR-based Collaborative 3D Object Detection with Vision Foundation Models](#link9)
**Authors:** Haojie Ren, Songrui Luo, Lingfeng Wang, Yan Xia, Yao Li, Jing Li, Lu Zhang, Jiajun Deng, Yanyong Zhang

10. [LARAD: Layout-Aware Road Anomaly Detection via Spatial-Logic Reasoning](#link10)
**Authors:** Shiyi Mu, Xujie Chen, Shugong Xu

11. [DM-KG: A Novel Method for Boosting Spatial Cognition of Vision-Language Models in Street View Imagery](#link11)
**Authors:** Xinyue Xu, Zheng Zhang, Kunyang Ma, Ge Zhu, Lianshuai Cao, Lei Wang, Zixuan Li, Yi Cheng

12. [RealSkin: Spatio-Spectral Partial Neural Adjoint Maps for Image-to-3D Attribute Transfer](#link12)
**Authors:** Jing Li, Yawei Luo, Xiangze Meng, Ying Li, Tieru Wu, Rui Ma

13. [Gaussian Mixture Modeling for Event-Aware Visual Allocation in Long Video Understanding](#link13)
**Authors:** Yifan Lu, Ziqi Zhang, Chunfeng Yuan, Jun Gao, Bing Li, Weiming Hu

14. [Point Tracking in Surgery--The 2025 Surgical Tattoos in Infrared Challenge (STIRC2025)](#link14)
...
---
## 0. [Hy-Embodied-VLM-1.0: Efficient Physical-World Agents](https://arxiv.org/abs/2607.12894) <a id="link0"></a>
**ArXiv ID:** 2607.12894
**Authors:** Ziyi Wang, Xumin Yu, Yongming Rao, Yonggen Ling, Yunheng Li, Oran Wang, Mingqi Gao, Yuchen Zhou, Yves Liang, Zuyan Liu, Yani Zhang, Rui Huang, Xiaoran Xu, Bowen Yuan, Yifu Yuan, Xu Tan, He Zhang, Yufei Huang, Shenghao Zhang, Hongsheng Wu, Han Hu, Zhengyou Zhang
...
**Comment:** Matches criterion 3 very closely: it is an embodied AI foundation model for physical-world agents, with a new capability taxonomy, data pipeline, and extensive embodied benchmarks.
**Relevance:** 10
**Novelty:** 7

---

## 1. [UniVR: Thinking in Visual Space for Unified Visual Reasoning](https://arxiv.org/abs/2607.12800) <a id="link1"></a>
**ArXiv ID:** 2607.12800
**Authors:** Zhongwei Ren, Yunchao Wei, Yao Zhao, Weibo Gong, Xiao Liu, Anran Wang, Xiangtai Li, Xiaojie Jin
...
**Comment:** Matches criterion 1 and 3 very closely: it learns reasoning, physical dynamics, and long-horizon planning from pure visual demonstrations, and it also introduces a new embodied-style benchmark (VR-X) for heterogeneous visual reasoning.
**Relevance:** 9
**Novelty:** 8

---

## 2. [Let RGB Be the Language of Vision](https://arxiv.org/abs/2607.12450) <a id="link2"></a>
**ArXiv ID:** 2607.12450
**Authors:** Timing Yang, Jinrui Yang, Xinlong Li, Yuhan Wang, Haoran Li, Yanqing Liu, Guoyizhe Wei, Jixuan Ying, Chen Wei, Rama Chellappa, Yuyin Zhou, Cihang Xie, Alan Yuille, Feng Wang
...
**Comment:** Matches criterion 4 very closely: it proposes a unified visual foundation-model formulation (RGB In/RGB Out) that repurposes diverse vision tasks into a shared image-editing interface.
**Relevance:** 8
**Novelty:** 7

---

## 3. [AVSCap: Orchestrating Audio-Visual Synergy for Omni-modal Video Captioning](https://arxiv.org/abs/2607.12820) <a id="link3"></a>
**ArXiv ID:** 2607.12820
**Authors:** Yanghai Wang, Jiahao Wang, Jiafu Tang, Yuanxing Zhang, Zhe Cao, Hanyan Bian, Zijie Zhang, Weiliang Luo, Zhiyu Pan, Zixuan Dong, Jiaheng Liu, Zhaoxiang Zhang
...
**Comment:** Matches criterion 2 and 4 moderately well: it is an omni-modal video captioning model with explicit audio-visual binding and a new benchmark, which is relevant to multimodal foundation models.
**Relevance:** 6
**Novelty:** 7

---

## 4. [MetaView: Monocular Novel View Synthesis with Scale-Aware Implicit Geometry Priors](https://arxiv.org/abs/2607.12000) <a id="link4"></a>
**ArXiv ID:** 2607.12000
**Authors:** Yufei Cai, Xuesong Niu, Hao Lu, Kun Gai, Kai Wu, Guosheng Lin
...
**Comment:** Matches criterion 1 moderately well: it improves spatial understanding for novel view synthesis with explicit geometry priors and metric scale control, but it is not an embodied agent paper or VLLM/MLLM.
**Relevance:** 6
**Novelty:** 7

---

## 5. [DynTrace: Tracking Dynamic Object Evidence for 4D Spatio-Temporal Reasoning in MLLMs](https://arxiv.org/abs/2607.12503) <a id="link5"></a>
**ArXiv ID:** 2607.12503
**Authors:** Rongxin Gao, Yuzhi Huang, Dongxuan Liu, Chu Li, Zhenye Wang, Jie Wu, Shuzhao Xie, Jingyan Jiang, Xinghao Ding, Xiaotong Tu, Yue Huang
...
**Comment:** Matches criterion 1 very closely: it targets 4D spatio-temporal reasoning in MLLMs and proposes a training-free method for tracking dynamic object evidence.
**Relevance:** 6
**Novelty:** 6

---

## 6. [ARDepth: Auto-regressive Monocular Depth Estimation with Progressive Visual Conditioning](https://arxiv.org/abs/2607.12433) <a id="link6"></a>
**ArXiv ID:** 2607.12433
**Authors:** Zijie Wang, Wei Zhang, Weiming Zhang, Xiao Tan, Weikai Chen, Xiaoxu Li, Guanbin Li
...
**Comment:** Matches criterion 1: it proposes a new geometric modeling method for spatial understanding via structured auto-regressive monocular depth estimation.
**Relevance:** 5
**Novelty:** 6

---

## 7. [Hallo4D: Multi-Modal Hallucination Mitigation for Consistent Spatio-Temporal Generation](https://arxiv.org/abs/2607.12752) <a id="link7"></a>
**ArXiv ID:** 2607.12752
**Authors:** Hongbo Wang, Huaibo Huang, Jie Cao, Jin Liu, Haoyang Tong, Ran He
...
**Comment:** Matches criterion 3 closely: an embodied/3D-4D generation method that uses LMMs to detect and correct spatio-temporal inconsistencies, with a novel generation-detection-correction pipeline.
**Relevance:** 5
**Novelty:** 6

---

## 8. [SymbOmni: Evolving Agentic Omni Models via Symbolic Concept Learning](https://arxiv.org/abs/2607.12042) <a id="link8"></a>
**ArXiv ID:** 2607.12042
**Authors:** Jinxiu Liu, Jianru Li, Tanqing Kuang, Xuanming Liu, Kangfu Mei, Yandong Wen, Weiyang Liu
...
**Comment:** Matches criterion 4 partially through vision-generation and multimodal creation, but it is not a clear fit for 1-3; the main novelty is an agentic omni-model with symbolic concept learning rather than a vision foundation model application per se.
**Relevance:** 4
**Novelty:** 7

---

## 9. [ViCo3D: Empowering LiDAR-based Collaborative 3D Object Detection with Vision Foundation Models](https://arxiv.org/abs/2607.12959) <a id="link9"></a>
**ArXiv ID:** 2607.12959
**Authors:** Haojie Ren, Songrui Luo, Lingfeng Wang, Yan Xia, Yao Li, Jing Li, Lu Zhang, Jiajun Deng, Yanyong Zhang
...
**Comment:** Matches criterion 4 closely: it leverages vision foundation models to improve collaborative LiDAR-based 3D object detection in V2X perception.
**Relevance:** 5
**Novelty:** 5

---

## 10. [LARAD: Layout-Aware Road Anomaly Detection via Spatial-Logic Reasoning](https://arxiv.org/abs/2607.12858) <a id="link10"></a>
**ArXiv ID:** 2607.12858
**Authors:** Shiyi Mu, Xujie Chen, Shugong Xu
...
**Comment:** Matches criterion 1 very closely: it introduces spatial-logic reasoning for anomaly detection, explicitly targeting contextual spatial understanding rather than appearance cues.
**Relevance:** 5
**Novelty:** 5

---

## 11. [DM-KG: A Novel Method for Boosting Spatial Cognition of Vision-Language Models in Street View Imagery](https://arxiv.org/abs/2607.12319) <a id="link11"></a>
**ArXiv ID:** 2607.12319
**Authors:** Xinyue Xu, Zheng Zhang, Kunyang Ma, Ge Zhu, Lianshuai Cao, Lei Wang, Zixuan Li, Yi Cheng
...
**Comment:** Matches criterion 1 closely: it explicitly aims to improve spatial cognition of VLMs for street-view imagery using structured geometric priors.
**Relevance:** 5
**Novelty:** 4

---

## 12. [RealSkin: Spatio-Spectral Partial Neural Adjoint Maps for Image-to-3D Attribute Transfer](https://arxiv.org/abs/2607.12495) <a id="link12"></a>
**ArXiv ID:** 2607.12495
**Authors:** Jing Li, Yawei Luo, Xiangze Meng, Ying Li, Tieru Wu, Rui Ma
...
**Comment:** Matches criterion 4 closely: it is a vision/3D foundation-model-adjacent method for image-to-3D attribute transfer using learned spectral correspondence.
**Relevance:** 4
**Novelty:** 5

---

## 13. [Gaussian Mixture Modeling for Event-Aware Visual Allocation in Long Video Understanding](https://arxiv.org/abs/2607.12557) <a id="link13"></a>
**ArXiv ID:** 2607.12557
**Authors:** Yifan Lu, Ziqi Zhang, Chunfeng Yuan, Jun Gao, Bing Li, Weiming Hu
...
**Comment:** Matches criterion 4: it is an application-oriented method for a vision-language foundation model on long video understanding, with a clever event-aware token allocation scheme.
**Relevance:** 4
**Novelty:** 4

---

## 14. [Point Tracking in Surgery--The 2025 Surgical Tattoos in Infrared Challenge (STIRC2025)](https://arxiv.org/abs/2607.12939) <a id="link14"></a>
**ArXiv ID:** 2607.12939
**Authors:** Adam Schmidt, Mert Asim Karaoglu, Zijian Wu, Jiaming Zhang, Yuxin Chen, Tim Salcudean, Ho-Gun Ha, Minkang Jang, Kyungmin Jung, Ihsan Ullah, Hyunki Lee, Suresh Guttikonda, Sarah Latus, Alexander Schlaefer, Xinkai Zhao, Yuichiro Hayashi, Masahiro Oda, Takayuki Kitasaka, Kensaku Mori, Peng Liu, Chenyang Li, Stefanie Speidel, Aoife Gardiner, Agostino Stilli, Danail Stoyanov, Francisco Vasconcelos, Anwesa Choudhuri, Meng Zheng, Zhongpai Gao, Benjamin Planche, Van Nguyen Nguyen, Terrence Chen, Ziyan Wu, Alexander Ladikos, Omid Mohareri
...
**Comment:** Matches criterion 3 only indirectly: it is an embodied/surgical point-tracking challenge and benchmark, with simulator- and evaluation-style relevance, but the focus is specialized.
**Relevance:** 4
**Novelty:** 3
