# Personalized Daily ArXiv Papers 06/11/2026
...
0. [InternVideo3: Agentify Foundation Models with Multimodal Contextual Reasoning](#link0)
...
1. [ARGUS: Stacked Multi-View Identity Mosaic Injection for Subject-Preserving Video Generation](#link1)
**Authors:** Zijie Meng, Jiwen Liu, Yufei Liu, Chengzhuo Tong, Xiaoqiang Liu, Yuanxing Zhang, Yulong Xu, Pengfei Wan

2. [MultiToP: Learning to Patch Visual Tokens to Mitigate Hallucinations in Video Large Multimodal Models](#link2)
**Authors:** Yuansheng Gao, Wenbin Xing, Jiahao Yuan, Kaiwen Zhou, Han Bao, Zonghui Wang, Wenzhi Chen

3. [i1: A Simple and Fully Open Recipe for Strong Text-to-Image Models](#link3)
**Authors:** Boya Zeng, Tianze Luo, Shu Pu, Jucheng Shen, Taiming Lu, Gabriel Sarch, Zhuang Liu

4. [HERO: Hindsight-Enhanced Reflection from Environment Observations for Agentic Self-Distillation](#link4)
**Authors:** Haoran Liu, Yuwei Zhang, Xiyao Li, Bohan Lyu, Jingbo Shang

5. [From Simulation to Real-World: An In-Field 6D Pose Dataset and Baseline for Robotic Strawberry Harvesting](#link5)
**Authors:** Woojung Son (Department of Agricultural and Biological Engineering, University of Florida), Won Suk Lee (Department of Agricultural and Biological Engineering, University of Florida), Zijing Huang (Department of Agricultural and Biological Engineering, University of Florida), Daeun Choi (Department of Agricultural and Biological Engineering, University of Florida), Catia Silva (Department of Electrical and Computer Engineering, University of Florida), Yu She (Edwardson School of Industrial Engineering, Purdue University), Yan Gu (School of Mechanical Engineering, Purdue University)

6. [From Prompts to Tokens: Internalizing Causal Supervision in Vision-Language Model for Multi-Image Causal Reasoning](#link6)
**Authors:** Haoping Yu, Yuanxi Li, Jing Ma

7. [TouchThinker: Scaling Tactile Commonsense Reasoning to the Open World with Large-scale Data and Action-aware Representation](#link7)
...
8. [SG2Loc: Sequential Visual Localization on 3D Scene Graphs](#link8)
**Authors:** Nicole Damblon, Olga Vysotska, Federico Tombari, Marc Pollefeys, Daniel Barath

9. [TRON: Tracing Rays to Orchestrate a Neural Renderer for 3D Gaussian Reconstructions](#link9)
**Authors:** Or Perel, Hassan Abu Alhaija, Zian Wang, Jacob Munkberg, Matan Atzmon, Sanja Fidler, Masha Shugrina

10. [Understanding Cross-Sensor Feature Variations for Generalizable 3D Perception](#link10)
**Authors:** Xin Qiu, Wenjie Liu, Fuyuan Ai, YuChen Tan, Zhiwei Xu, Chunyi Song

11. [A Scalable PyTorch Abstraction for Multi-GPU Gaussian Splatting](#link11)
**Authors:** Matthew Cong, Francis Williams, Jonathan Swartz, Mark Harris, Sanja Fidler, Ken Museth

12. [UniReason-Med: A Shared Grounded Reasoning Interface for 2D-to-3D Transfer in Medical VQA](#link12)
**Authors:** Mengzhuo Chen, Yan Shu, Chi Liu, Hongming Piao, Xidong Wang, Derek Li, Bryan Dai

13. [Automating Geometry-Intensive Compliance Checking in BIM: Graph-Based Semantic Reasoning Framework](#link13)
**Authors:** Zixuan Xiao, Pei Troh Koh, Jun Ma, Jack C. P. Cheng

---
## 0. [InternVideo3: Agentify Foundation Models with Multimodal Contextual Reasoning](https://arxiv.org/abs/2606.12195) <a id="link0"></a>
**ArXiv ID:** 2606.12195
**Authors:** Ziang Yan, Sheng Xia, Jiashuo Yu, Yue Wu, Tianxiang Jiang, Songze Li, Kanghui Tian, Yicheng Xu, Yinan He, Kai Chen, Limin Wang, Yu Qiao, Yi Wang
...
**Comment:** Matches criterion 2 closely, and also partially criterion 4: it introduces a multimodal foundation-model framework for long-horizon video understanding and agentic reasoning.
**Relevance:** 7
**Novelty:** 7

---

## 1. [ARGUS: Stacked Multi-View Identity Mosaic Injection for Subject-Preserving Video Generation](https://arxiv.org/abs/2606.11670) <a id="link1"></a>
**ArXiv ID:** 2606.11670
**Authors:** Zijie Meng, Jiwen Liu, Yufei Liu, Chengzhuo Tong, Xiaoqiang Liu, Yuanxing Zhang, Yulong Xu, Pengfei Wan
...
**Comment:** Matches criterion 4 well: a vision-language-guided subject-preserving video generation method, with a new benchmark and evaluation metrics.
**Relevance:** 6
**Novelty:** 6

---

## 2. [MultiToP: Learning to Patch Visual Tokens to Mitigate Hallucinations in Video Large Multimodal Models](https://arxiv.org/abs/2606.11792) <a id="link2"></a>
**ArXiv ID:** 2606.11792
**Authors:** Yuansheng Gao, Wenbin Xing, Jiahao Yuan, Kaiwen Zhou, Han Bao, Zonghui Wang, Wenzhi Chen
...
**Comment:** Matches criterion 2 closely: it proposes a new Video Large Multimodal Model method aimed at reducing hallucinations in VLM/VLLM outputs.
**Relevance:** 7
**Novelty:** 5

---

## 3. [i1: A Simple and Fully Open Recipe for Strong Text-to-Image Models](https://arxiv.org/abs/2606.11289) <a id="link3"></a>
**ArXiv ID:** 2606.11289
**Authors:** Boya Zeng, Tianze Luo, Shu Pu, Jucheng Shen, Taiming Lu, Gabriel Sarch, Zhuang Liu
...
**Comment:** Matches criterion 4 very closely: a fully open text-to-image diffusion model recipe with extensive ablations and training/inference design insights.
**Relevance:** 6
**Novelty:** 6

---

## 4. [HERO: Hindsight-Enhanced Reflection from Environment Observations for Agentic Self-Distillation](https://arxiv.org/abs/2606.11559) <a id="link4"></a>
**ArXiv ID:** 2606.11559
**Authors:** Haoran Liu, Yuwei Zhang, Xiyao Li, Bohan Lyu, Jingbo Shang
...
**Comment:** Matches criterion 3 somewhat: it is an agentic embodied-style method using environment observations for self-distillation, though it is more about training than a new benchmark or simulator.
**Relevance:** 5
**Novelty:** 6

---

## 5. [From Simulation to Real-World: An In-Field 6D Pose Dataset and Baseline for Robotic Strawberry Harvesting](https://arxiv.org/abs/2606.11381) <a id="link5"></a>
**ArXiv ID:** 2606.11381
**Authors:** Woojung Son (Department of Agricultural and Biological Engineering, University of Florida), Won Suk Lee (Department of Agricultural and Biological Engineering, University of Florida), Zijing Huang (Department of Agricultural and Biological Engineering, University of Florida), Daeun Choi (Department of Agricultural and Biological Engineering, University of Florida), Catia Silva (Department of Electrical and Computer Engineering, University of Florida), Yu She (Edwardson School of Industrial Engineering, Purdue University), Yan Gu (School of Mechanical Engineering, Purdue University)
...
**Comment:** Matches criterion 3 closely: it builds a new real-world 6D pose dataset for robotic strawberry harvesting and explicitly studies sim-to-real gap in a simulator-to-field setting.
**Relevance:** 6
**Novelty:** 5

---

## 6. [From Prompts to Tokens: Internalizing Causal Supervision in Vision-Language Model for Multi-Image Causal Reasoning](https://arxiv.org/abs/2606.11745) <a id="link6"></a>
**ArXiv ID:** 2606.11745
**Authors:** Haoping Yu, Yuanxi Li, Jing Ma
...
**Comment:** Matches criterion 2 very closely: it proposes a VLM for multi-image causal reasoning with internal causal tokens and decoder-side message passing.
**Relevance:** 5
**Novelty:** 6

---

## 7. [TouchThinker: Scaling Tactile Commonsense Reasoning to the Open World with Large-scale Data and Action-aware Representation](https://arxiv.org/abs/2606.11637) <a id="link7"></a>
**ArXiv ID:** 2606.11637
**Authors:** Kailin Lyu, Di Wu, Pengwei Zhang, Yuhang Zheng, Yingxin Lai, Long Xiao, Kangyi Wu, Pengna Li, Chen Gao, Lianyu Hu, Xiaobin Hu, Jie Hao, Ce Hao, Weihao Yuan, Shuicheng Yan
...
**Comment:** Matches criterion 3 closely: it proposes a new embodied tactile-language benchmark plus a method for open-world tactile commonsense reasoning.
**Relevance:** 6
**Novelty:** 5

---

## 8. [SG2Loc: Sequential Visual Localization on 3D Scene Graphs](https://arxiv.org/abs/2606.11880) <a id="link8"></a>
**ArXiv ID:** 2606.11880
**Authors:** Nicole Damblon, Olga Vysotska, Federico Tombari, Marc Pollefeys, Daniel Barath
...
**Comment:** Matches criterion 3 very closely: it is an embodied/robotics localization method built on 3D scene graphs for sequential visual localization.
**Relevance:** 6
**Novelty:** 5

---

## 9. [TRON: Tracing Rays to Orchestrate a Neural Renderer for 3D Gaussian Reconstructions](https://arxiv.org/abs/2606.11314) <a id="link9"></a>
**ArXiv ID:** 2606.11314
**Authors:** Or Perel, Hassan Abu Alhaija, Zian Wang, Jacob Munkberg, Matan Atzmon, Sanja Fidler, Masha Shugrina
...
**Comment:** Matches criterion 4 moderately well: it is about 3D Gaussian reconstruction and neural rendering, which is relevant to vision foundation model applications and 3D generation/editing workflows.
**Relevance:** 4
**Novelty:** 6

---

## 10. [Understanding Cross-Sensor Feature Variations for Generalizable 3D Perception](https://arxiv.org/abs/2606.11573) <a id="link10"></a>
**ArXiv ID:** 2606.11573
**Authors:** Xin Qiu, Wenjie Liu, Fuyuan Ai, YuChen Tan, Zhiwei Xu, Chunyi Song
...
**Comment:** Matches criterion 1 closely: the paper studies cross-sensor variation to improve generalizable 3D perception in BEV radar-camera fusion, which is about spatial understanding for embodied/driving agents.
**Relevance:** 5
**Novelty:** 5

---

## 11. [A Scalable PyTorch Abstraction for Multi-GPU Gaussian Splatting](https://arxiv.org/abs/2606.11390) <a id="link11"></a>
**ArXiv ID:** 2606.11390
**Authors:** Matthew Cong, Francis Williams, Jonathan Swartz, Mark Harris, Sanja Fidler, Ken Museth
...
**Comment:** Matches criterion 4 moderately: it is a systems-focused method for scaling Gaussian splatting, a vision foundation-model-adjacent 3D reconstruction technique.
**Relevance:** 4
**Novelty:** 5

---

## 12. [UniReason-Med: A Shared Grounded Reasoning Interface for 2D-to-3D Transfer in Medical VQA](https://arxiv.org/abs/2606.11740) <a id="link12"></a>
**ArXiv ID:** 2606.11740
**Authors:** Mengzhuo Chen, Yan Shu, Chi Liu, Hongming Piao, Xidong Wang, Derek Li, Bryan Dai
...
**Comment:** No close match to the listed criteria; it is medical VQA with grounded reasoning, but not specifically an embodied AI benchmark or a new vision foundation model method.
**Relevance:** 3
**Novelty:** 5

---

## 13. [Automating Geometry-Intensive Compliance Checking in BIM: Graph-Based Semantic Reasoning Framework](https://arxiv.org/abs/2606.12065) <a id="link13"></a>
**ArXiv ID:** 2606.12065
**Authors:** Zixuan Xiao, Pei Troh Koh, Jun Ma, Jack C. P. Cheng
...
**Comment:** Matches criterion 1 weakly: it uses graph-based spatial-geometric reasoning for BIM compliance, but it is more AEC automation than embodied spatial intelligence.
**Relevance:** 3
**Novelty:** 4
