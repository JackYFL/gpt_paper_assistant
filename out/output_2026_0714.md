# Personalized Daily ArXiv Papers 07/14/2026
...
0. [ABot-N1: Toward a General Visual Language Navigation Foundation Model](#link0)
...
1. [Evidence-Backed Video Question Answering](#link1)
**Authors:** Shijie Wang, Honglu Zhou, Ziyang Wang, Ran Xu, Caiming Xiong, Silvio Savarese, Chen Sun, Juan Carlos Niebles

2. [ABot-AgentOS: A General Robotic Agent OS with Lifelong Multi-modal Memory](#link2)
...
3. [MonkeyOCRv2: A Visual-Text Foundation Model for Document AI](#link3)
...
4. [Imperceptible and Reversible Adversarial Examples against Vision-Language Models for Privacy Protection](#link4)
**Authors:** Qi Lu, Ziqi Zhou, Yufei Song, Zijing Li, Lulu Xue, Minghui Li, Shengshan Hu, Leo Yu Zhang

5. [A Unified Framework for Comprehensive Cardiac CT Segmentation and Phenotyping: Human-in-the-Loop Data Annotation, Vision Foundation Model Development, Multicenter Evaluation and Clinical Validation](#link5)
...
6. [Incremental Online Scene Reconstruction by 3D Gaussian Triangulation](#link6)
**Authors:** Yanjin Zhu, Shaofan Liu, Jianke Zhu

7. [ReflectWorld-MM: An Entity-Oriented Multi-Media Memory System for Open-Ended Video Streams](#link7)
**Authors:** Xiaokang Ma, Yifan Sun, Zhihong Jin, Jie Gu, Yudong Luo, Shenyi Shao, Chu Tang, Jingmin Chen, Li Pu

8. [OmniX: Any-view and Any-time 4D Reconstruction via Feed-forward Trajectory Fields](#link8)
**Authors:** Yanqin Jiang, Tengfei Wang, Zhengwei Wang, Chenjie Cao, Junta Wu, Wenhan Luo, Weiming Hu, Jin Gao, Chunchao Guo

9. [Towards Real-World Wearable Motion Reconstruction](#link9)
**Authors:** Andrea Boscolo Camiletto, Rishabh Dabral, Eduardo Alvarado, Thabo Beeler, Marc Habermann, Christian Theobalt

10. [SETA: Scaling Environments for Terminal Agents](#link10)
...
11. [Lesioned Multimodal Language Models Reproduce Aphasic Picture-Naming Patterns](#link11)
...
12. [Imaging-101: Benchmarking LLM Coding Agents on Scientific Computational Imaging](#link12)
...
13. [ASUMOT: Motion-Consistency-Based Asynchronous UAV Detection and Tracking with Event Cameras](#link13)
**Authors:** Baofeng Jia, Xiaoyu Chen, Jingyuan Zhang, Zongze Wu, Haochen li, Jing Han, Lianfa Bai

14. [Improving Sample Diversity in Autoregressive Text-to-Image Generation via Cluster Truncation](#link14)
**Authors:** Trang Nguyen, Shuang Wu, Runyan Tan, Phillip Howard

15. [Latent-Identity Tuning in Text-to-Image Personalization Models](#link15)
**Authors:** Daniel Garibi, Ronen Kamenetsky, Hadar Averbuch-Elor, Daniel Cohen-Or, Or Patashnik

---
## 0. [ABot-N1: Toward a General Visual Language Navigation Foundation Model](https://arxiv.org/abs/2607.10383) <a id="link0"></a>
**ArXiv ID:** 2607.10383
**Authors:** Ruiyan Gong, Yingnan Guo, Junjun Hu, Jintao Kong, Xiaoxu Leng, Tianlun Li, Weize Li, Fei Liu, Zhicheng Liu, Jia Lu, Minghua Luo, Chenlin Ming, Yanfen Shen, Jiyue Tao, Zhengbo Wang, Mingyang Yin, Minqi Gu, Zihao Guan, Wei Guo, Guoqing Liu, Huachong Pang, Menglin Yang, Zeqian Ye, Xiaoxiao Geng, Zhining Gu, Honglin Han, Di Jing, Hongyu Pan, Mingchao Sun, Kuan Yang, Jianfang Zhang, Yanghong Chen, Ye He, Wei Mei, Jiahao Shi, Xiangpo Yang, Yanqing Zhu, Zedong Chu, Xiaolong Wu, Mu Xu
...
**Comment:** Matches criteria 1 and 3 closely: it is a new embodied visual-language navigation foundation model with new point-goal/POI-goal benchmarks.
**Relevance:** 10
**Novelty:** 8

---

## 1. [Evidence-Backed Video Question Answering](https://arxiv.org/abs/2607.11862) <a id="link1"></a>
**ArXiv ID:** 2607.11862
**Authors:** Shijie Wang, Honglu Zhou, Ziyang Wang, Ran Xu, Caiming Xiong, Silvio Savarese, Chen Sun, Juan Carlos Niebles
...
**Comment:** Strong match to criterion 2: it targets Video LLMs with a new evidence-backed grounding task and benchmark for spatio-temporal evidence.
**Relevance:** 8
**Novelty:** 8

---

## 2. [ABot-AgentOS: A General Robotic Agent OS with Lifelong Multi-modal Memory](https://arxiv.org/abs/2607.10350) <a id="link2"></a>
**ArXiv ID:** 2607.10350
**Authors:** Jiayi Tian, Shiao Liu, Yuting Xu, Jia Lu, Zihao Guan, Honglin Han, Di Yang, Minqi Gu, Yifei Qian, Tianlin Zhang, Yanqing Zhu, Zeqian Ye, Menglin Yang, Fei Wang, Xu Hu, Xiuxian Li, Wei Zhang, Shihui Su, Yiyan Ji, Jingbo Wang, Ziteng Feng, Jiaheng Liu, Zhaoxiang Zhang, Xiaolong Wu, Mingyang Yin, Zedong Chu, Mu Xu
...
**Comment:** Strong match to criterion 3: it proposes a new embodied AI agent OS and introduces a new benchmark/simulator-style evaluation setting for long-horizon robotics.
**Relevance:** 9
**Novelty:** 7

---

## 3. [MonkeyOCRv2: A Visual-Text Foundation Model for Document AI](https://arxiv.org/abs/2607.11562) <a id="link3"></a>
**ArXiv ID:** 2607.11562
**Authors:** Yuliang Liu, Zhang Li, Ziyang Zhang, Shuo Zhang, Qiang Liu, Jiajun Song, Zidun Guo, Xinhan Wang, Handong Zheng, Yang Liu, Dongliang Luo, Zhiyin Ma, Jiarui Zhang, Xiang Bai
...
**Comment:** Matches criterion 4 closely: it introduces a document-oriented visual-text foundation model and uses it as a strong MLLM vision encoder.
**Relevance:** 8
**Novelty:** 7

---

## 4. [Imperceptible and Reversible Adversarial Examples against Vision-Language Models for Privacy Protection](https://arxiv.org/abs/2607.10329) <a id="link4"></a>
**ArXiv ID:** 2607.10329
**Authors:** Qi Lu, Ziqi Zhou, Yufei Song, Zijing Li, Lulu Xue, Minghui Li, Shengshan Hu, Leo Yu Zhang
...
**Comment:** Matches criterion 2 closely: it proposes a new VLM-oriented privacy protection method with adversarial examples tailored to vision-language models.
**Relevance:** 8
**Novelty:** 7

---

## 5. [A Unified Framework for Comprehensive Cardiac CT Segmentation and Phenotyping: Human-in-the-Loop Data Annotation, Vision Foundation Model Development, Multicenter Evaluation and Clinical Validation](https://arxiv.org/abs/2607.11287) <a id="link5"></a>
**ArXiv ID:** 2607.11287
**Authors:** Pooya Mohammadi Kazaj, Leo Fridolin Weber, Wen Xie, Seyed Amir Ahmad Safavi-Naini, Anselm Stark, Giovanni Baj, Ali Mokhtari, Toshiya Yoshida, Christoph Ryffel, Taishi Okuno, Yoshihiro Akashi, Ronny R. Buechel, Thomas Pilgrim, Waldo Valenzuela, George C. M. Siontis, Xiaowei Xu, Moritz Hundertmark, Stephan Windecker, Christoph Grani, Isaac Shiri
...
**Comment:** Matches criterion 4 closely: it develops a vision foundation model and applies it to large-scale cardiac CT segmentation/phenotyping.
**Relevance:** 7
**Novelty:** 6

---

## 6. [Incremental Online Scene Reconstruction by 3D Gaussian Triangulation](https://arxiv.org/abs/2607.10690) <a id="link6"></a>
**ArXiv ID:** 2607.10690
**Authors:** Yanjin Zhu, Shaofan Liu, Jianke Zhu
...
**Comment:** Closest to criterion 4, because it uses 3D Gaussian Splatting / Gaussian representations for incremental scene reconstruction, which is a vision foundation-model-style representation with downstream application.
**Relevance:** 5
**Novelty:** 6

---

## 7. [ReflectWorld-MM: An Entity-Oriented Multi-Media Memory System for Open-Ended Video Streams](https://arxiv.org/abs/2607.09759) <a id="link7"></a>
**ArXiv ID:** 2607.09759
**Authors:** Xiaokang Ma, Yifan Sun, Zhihong Jin, Jie Gu, Yudong Luo, Shenyi Shao, Chu Tang, Jingmin Chen, Li Pu
...
**Comment:** Closest to criterion 2, since it is a multimodal long-term memory system for open-ended video streams built around an assistant-style MLLM pipeline.
**Relevance:** 5
**Novelty:** 6

---

## 8. [OmniX: Any-view and Any-time 4D Reconstruction via Feed-forward Trajectory Fields](https://arxiv.org/abs/2607.10840) <a id="link8"></a>
**ArXiv ID:** 2607.10840
**Authors:** Yanqin Jiang, Tengfei Wang, Zhengwei Wang, Chenjie Cao, Junta Wu, Wenhan Luo, Weiming Hu, Jin Gao, Chunchao Guo
...
**Comment:** No close match to criteria 1-4; it is a 4D reconstruction method with a new data engine, but not centered on embodied spatial intelligence or VLLMs/MLLMs.
**Relevance:** 3
**Novelty:** 7

---

## 9. [Towards Real-World Wearable Motion Reconstruction](https://arxiv.org/abs/2607.09780) <a id="link9"></a>
**ArXiv ID:** 2607.09780
**Authors:** Andrea Boscolo Camiletto, Rishabh Dabral, Eduardo Alvarado, Thabo Beeler, Marc Habermann, Christian Theobalt
...
**Comment:** No close match to the listed criteria; it studies wearable motion reconstruction, which is related to embodied sensing but not a benchmark/simulator-focused embodied AI method.
**Relevance:** 4
**Novelty:** 6

---

## 10. [SETA: Scaling Environments for Terminal Agents](https://arxiv.org/abs/2607.10891) <a id="link10"></a>
**ArXiv ID:** 2607.10891
**Authors:** Qijia Shen, Zhiqi Huang, Vamsidhar Kamanuru, Aznaur Aliev, Jay Rainton, Ahmed Awelkair, Zhichen Zeng, Jiajun Li, Shi Dong, Yueming Yuan, Boyuan Ma, Qizheng Zhang, Jiwei Fu, Yuzhen Mao, Wendong Fan, Ping Nie, Philip Torr, Bernard Ghanem, Changran Hu, Jonathan Lingjie Li, Urmish Thakker, Guohao Li
...
**Comment:** No close match to criteria 1-4; it builds terminal-agent training environments rather than embodied AI in the spatial/simulator sense or vision-language models.
**Relevance:** 3
**Novelty:** 6

---

## 11. [Lesioned Multimodal Language Models Reproduce Aphasic Picture-Naming Patterns](https://arxiv.org/abs/2607.11621) <a id="link11"></a>
**ArXiv ID:** 2607.11621
**Authors:** Yong Yang, Xiang Guan, Sophie Arheix-Parras, Saeed Ahmadi, Roger Newman-Norlund, Leonardo Bonilha, Christopher Rorden, Julius Fridriksson, Rutvik H. Desai, Srihari Nelakuditi
...
**Comment:** No close match to criteria 1-4; it is a multimodal language-model lesion study, but not a new VLLM/MLLM method or an embodied AI benchmark.
**Relevance:** 3
**Novelty:** 6

---

## 12. [Imaging-101: Benchmarking LLM Coding Agents on Scientific Computational Imaging](https://arxiv.org/abs/2607.10789) <a id="link12"></a>
**ArXiv ID:** 2607.10789
**Authors:** Siyi Chen, Jiahe Ying, Yixuan Jia, Yuxuan Gu, Enze Ye, Weimin Bai, Zhijun Zeng, Shaochi Ren, Binhong Gao, Yubing Li, Tianhan Zhang, He Sun
...
**Comment:** No close match to the listed criteria; it is a benchmark for coding agents in scientific computational imaging, which is adjacent but not embodied AI or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 13. [ASUMOT: Motion-Consistency-Based Asynchronous UAV Detection and Tracking with Event Cameras](https://arxiv.org/abs/2607.11303) <a id="link13"></a>
**ArXiv ID:** 2607.11303
**Authors:** Baofeng Jia, Xiaoyu Chen, Jingyuan Zhang, Zongze Wu, Haochen li, Jing Han, Lianfa Bai
...
**Comment:** No very close match to criteria 1-4; this is an event-camera UAV detection/tracking paper, which is adjacent to embodied perception but not really embodied AI or VLLM/MLLM work.
**Relevance:** 3
**Novelty:** 5

---

## 14. [Improving Sample Diversity in Autoregressive Text-to-Image Generation via Cluster Truncation](https://arxiv.org/abs/2607.10535) <a id="link14"></a>
**ArXiv ID:** 2607.10535
**Authors:** Trang Nguyen, Shuang Wu, Runyan Tan, Phillip Howard
...
**Comment:** No close match to the listed criteria; it is a decoding method for autoregressive text-to-image generation, mainly a generative modeling paper.
**Relevance:** 3
**Novelty:** 5

---

## 15. [Latent-Identity Tuning in Text-to-Image Personalization Models](https://arxiv.org/abs/2607.11885) <a id="link15"></a>
**ArXiv ID:** 2607.11885
**Authors:** Daniel Garibi, Ronen Kamenetsky, Hadar Averbuch-Elor, Daniel Cohen-Or, Or Patashnik
...
**Comment:** No close match to the listed criteria; it is a text-to-image personalization/editing method rather than a foundation-model or embodied-AI paper.
**Relevance:** 3
**Novelty:** 5
