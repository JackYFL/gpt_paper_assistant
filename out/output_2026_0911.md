# Personalized Daily ArXiv Papers 09/11/2026
...
0. [SenseNova-U1.5: Towards Native Unified Visual Intelligence](#link0)
...
1. [Valerant: An Automatic Navigable Game Map Generator via Action-Conditioned World Model Exploration](#link1)
**Authors:** Yiran Qiao, Feng Wang, Jing Ma

2. [Caption-once, Frames-on-Demand: Visual-Need Routing for Budget-Aware Agentic Long Video Understanding](#link2)
**Authors:** Weitong Cai, Hang Zhang, Yukai Huang, Yiqiao Xie, Shan Gao, Jiankang Deng, Songcen Xu, Jifei Song, Zhensong Zhang

3. [SAMV-DUSt3R: Instance-Centric 3D Scene Decoupling from Sparse Multi-Views](#link3)
**Authors:** Langxu Zhao, Zuan Gu, Yingdan Zhang, Pengfei Zhao, Tianhan Gao

4. [Tri-DehazeGS: Scene--Medium Decoupled Gaussian Splatting with Transmittance-Aware Optimization](#link4)
**Authors:** Kui Jiang, Yang Gu, Jiacheng Liu, Shiyu Liu, Youyu Chen, Hui Liu

5. [From Evaluation to Enhancement: Benchmarking and Improving Think-with-Video Reasoning for Video Generative Models](#link5)
**Authors:** Meng Luo, Yicheng Liu, Jiahao Wang, Yuanxing Zhang, Xin Tao, Pengfei Wan, Kun Gai, Hao Fei

6. [Vidu S2: Real-Time Interactive, Editable, and Spatial Video Generation](#link6)
...
7. [OmniKVQuant: KV Cache Quantization for Omni-LLMs](#link7)
**Authors:** Suho Yoo, Hyunjong Ok, Jongmin Choi, Jihoo Jung, Joon Son Chung

8. [CamPilot: A Multi-Agent Cinematic Assistant for Camera-Controlled Movie Generation](#link8)
**Authors:** Yang Wu, Stefano Petrangeli, Ishita Dasgupta, Yu Shen

9. [BridgeMatch: Conditional Transport Bridges in Matching Matrix Space for 3D Deformable Registration](#link9)
**Authors:** Qianliang Wu, Haobo Jiang, Guangwei Gao, Shuo Chen, Jin Xie, Jian Yang, Yaqing Ding

10. [HiPerViT: A Hierarchical Perceiver-Vision Transformer Architecture for Multi-Scale Texture Recognition](#link10)
**Authors:** Jo\~ao Pedro C. A. de S\'a, Odemir Martinez Bruno

11. [Learning Interaction between Image and Layout Priors for Joint Image-Layout Generation in Design Templates](#link11)
**Authors:** Shirong Yang, Bo Yang, Ying Cao

12. [3D Point Splatting for mmWave Radar Novel View Synthesis](#link12)
**Authors:** Adnan Armouti, Yixuan Gao, Rajalakshmi Nandakumar

13. [Guided Super-Resolution of Digital Elevation Models with Diffusion-Based Image Generators](#link13)
**Authors:** Armand Mihai Nicolicioiu, Dominik Narnhofer, Nando Metzger, Daniel Panangian, Ksenia Bittner, Konrad Schindler

14. [Uncertainty DMD: Restoring Diversity in Few-Step Autoregressive Video Distillation](#link14)
**Authors:** Zixuan Duan, Xunzhi Xiang, Yabo Chen, Xin Zhang, Changhan Liu, Haibin Huang, Chi Zhang, Qi Fan, Xuelong Li

15. [MHE-Former: Multi-Hypothesis Transformers via Entropy Maximization for 3D Mesh Recovery](#link15)
...
16. [Overpainting: Localized Context-aware Diffusion Image Editing](#link16)
**Authors:** Sam Sartor, Iliyan Georgiev, Michael Fischer, Valentin Deschaintre, Pieter Peers

---
## 0. [SenseNova-U1.5: Towards Native Unified Visual Intelligence](https://arxiv.org/abs/2609.11929) <a id="link0"></a>
**ArXiv ID:** 2609.11929
**Authors:** Haiwen Diao, Jiahao Wang, Chenjing Ding, Hanming Deng, Jiangnan Chen, Ruixi Zhang, Ruohui Wang, Wenwen Tong, Xiangyu Fan, Yubo Wang, Yue Zhu, Yuwei Niu, Zhengqi Bai, Zhiqian Lin, Zhitao Yang, Zhongang Cai, Bo Yang, Chen Feng, Chengguang Lv, Guangjia Liu, Guanlin Wang, Hanyu Zhang, Haojia Yu, Hongcan Xiao, Hongli Wang, Huan Wu, Huaping Zhong, Jian Fang, Jianan Fan, Jiaqi Li, Jiefan Lu, Jing Zuo, Jingcheng Ni, Junxiang Xu, Linjun Dai, Mutian Xu, Peishen Yan, Penghao Wu, Ruijie Mao, Ruisi Wang, Shihao Bai, Shuang Yang, Shuya Yang, Shuyan Zheng, Silei Wu, Siying Li, Tao Chu, Tianbo Zhong, Tongxi Zhou, Weichao Luo, Weichen Fan, Wenhao Jia, Wenjie Gao, Xiangli Kong, Yan Li, Yang Yong, Zimo Wen, Zixuan Qian, Wenxiu Sun, Ruihao Gong, Quan Wang, Lewei Lu, Lei Yang, Ziwei Liu, Dahua Lin
...
**Comment:** Matches criterion 2 and 4 closely: a new native unified multimodal model for visual understanding and generation, with strong visual foundation model flavor.
**Relevance:** 8
**Novelty:** 7

---

## 1. [Valerant: An Automatic Navigable Game Map Generator via Action-Conditioned World Model Exploration](https://arxiv.org/abs/2609.09418) <a id="link1"></a>
**ArXiv ID:** 2609.09418
**Authors:** Yiran Qiao, Feng Wang, Jing Ma
...
**Comment:** Matches criterion 3: an embodied-AI/game-world paper that builds a navigable 3D map from action-conditioned world-model rollouts, combining world modeling with SLAM-based reconstruction.
**Relevance:** 7
**Novelty:** 6

---

## 2. [Caption-once, Frames-on-Demand: Visual-Need Routing for Budget-Aware Agentic Long Video Understanding](https://arxiv.org/abs/2609.11899) <a id="link2"></a>
**ArXiv ID:** 2609.11899
**Authors:** Weitong Cai, Hang Zhang, Yukai Huang, Yiqiao Xie, Shan Gao, Jiankang Deng, Songcen Xu, Jifei Song, Zhensong Zhang
...
**Comment:** Matches criterion 2: introduces a new MLLM-style agentic framework for long video understanding with query-conditioned visual routing and budget-aware retrieval.
**Relevance:** 7
**Novelty:** 6

---

## 3. [SAMV-DUSt3R: Instance-Centric 3D Scene Decoupling from Sparse Multi-Views](https://arxiv.org/abs/2609.11279) <a id="link3"></a>
**ArXiv ID:** 2609.11279
**Authors:** Langxu Zhao, Zuan Gu, Yingdan Zhang, Pengfei Zhao, Tianhan Gao
...
**Comment:** Matches criterion 3 very closely: an embodied/3D scene understanding method for instance-centric scene decoupling from sparse multi-views, with a new mask-guided reconstruction pipeline.
**Relevance:** 7
**Novelty:** 6

---

## 4. [Tri-DehazeGS: Scene--Medium Decoupled Gaussian Splatting with Transmittance-Aware Optimization](https://arxiv.org/abs/2609.11223) <a id="link4"></a>
**ArXiv ID:** 2609.11223
**Authors:** Kui Jiang, Yang Gu, Jiacheng Liu, Shiyu Liu, Youyu Chen, Hui Liu
...
**Comment:** Matches criterion 4: it is a vision/3D reconstruction paper built on Gaussian Splatting, with a new scene--medium decoupling method and a transmittance-aware optimization trick.
**Relevance:** 6
**Novelty:** 6

---

## 5. [From Evaluation to Enhancement: Benchmarking and Improving Think-with-Video Reasoning for Video Generative Models](https://arxiv.org/abs/2609.11242) <a id="link5"></a>
**ArXiv ID:** 2609.11242
**Authors:** Meng Luo, Yicheng Liu, Jiahao Wang, Yuanxing Zhang, Xin Tao, Pengfei Wan, Kun Gai, Hao Fei
...
**Comment:** Matches criterion 3 closely: it introduces a benchmark for video world reasoning plus a method to improve it, focusing on reasoning beyond visual quality.
**Relevance:** 6
**Novelty:** 6

---

## 6. [Vidu S2: Real-Time Interactive, Editable, and Spatial Video Generation](https://arxiv.org/abs/2609.11638) <a id="link6"></a>
**ArXiv ID:** 2609.11638
**Authors:** Jintao Zhang, Kai Jiang, Jintao Chen, Xu Wang, Deyuan Liu, Jungang Li, Dechuang Chen, Ming Lin, Jingjiang Zhou, Haopeng Jin, Qi Jia, Xiaohang Wang, Yaole Wang, Zhanqiang Zhang, Ran Li, Zhengkun Huang, Shuyue Xiong, Yuji Wang, Zikun Dai, Hui He, Yang Luo, Mang Ning, Weiqi Feng, Chengyang Ye, Xinyue Lin, Min Zhao, Hongzhou Zhu, Hengkai Tan, Zeyuan Wang, Chendong Xiang, Kaiwen Zheng, Zhijie Deng, Fan Bao, Jianfei Chen, Jun Zhu
...
**Comment:** Matches criterion 2 and 3 closely: real-time editable and spatial video generation, with a strong emphasis on spatial video manipulation and interactive generation.
**Relevance:** 6
**Novelty:** 6

---

## 7. [OmniKVQuant: KV Cache Quantization for Omni-LLMs](https://arxiv.org/abs/2609.11582) <a id="link7"></a>
**ArXiv ID:** 2609.11582
**Authors:** Suho Yoo, Hyunjong Ok, Jongmin Choi, Jihoo Jung, Joon Son Chung
...
**Comment:** Matches criterion 2: proposes a new KV-cache quantization method for omni-modal large language models, with a concrete multimodal systems trick for audio-video-text inference.
**Relevance:** 6
**Novelty:** 5

---

## 8. [CamPilot: A Multi-Agent Cinematic Assistant for Camera-Controlled Movie Generation](https://arxiv.org/abs/2609.10943) <a id="link8"></a>
**ArXiv ID:** 2609.10943
**Authors:** Yang Wu, Stefano Petrangeli, Ishita Dasgupta, Yu Shen
...
**Comment:** Matches criterion 3 closely: it builds a new benchmark and method for camera-controlled movie generation, a novel angle around cinematic planning and viewpoint control.
**Relevance:** 5
**Novelty:** 6

---

## 9. [BridgeMatch: Conditional Transport Bridges in Matching Matrix Space for 3D Deformable Registration](https://arxiv.org/abs/2609.11472) <a id="link9"></a>
**ArXiv ID:** 2609.11472
**Authors:** Qianliang Wu, Haobo Jiang, Guangwei Gao, Shuo Chen, Jin Xie, Jian Yang, Yaqing Ding
...
**Comment:** Matches criterion 3 very closely: a new method for 3D deformable registration with generative transport bridges, relevant to embodied perception/manipulation-adjacent spatial understanding.
**Relevance:** 5
**Novelty:** 6

---

## 10. [HiPerViT: A Hierarchical Perceiver-Vision Transformer Architecture for Multi-Scale Texture Recognition](https://arxiv.org/abs/2609.10917) <a id="link10"></a>
**ArXiv ID:** 2609.10917
**Authors:** Jo\~ao Pedro C. A. de S\'a, Odemir Martinez Bruno
...
**Comment:** Matches criterion 4: a vision foundation model-style architecture for texture recognition, using explicit statistical tokenization and Perceiver-style fusion.
**Relevance:** 5
**Novelty:** 5

---

## 11. [Learning Interaction between Image and Layout Priors for Joint Image-Layout Generation in Design Templates](https://arxiv.org/abs/2609.11519) <a id="link11"></a>
**ArXiv ID:** 2609.11519
**Authors:** Shirong Yang, Bo Yang, Ying Cao
...
**Comment:** Matches criterion 4 closely: it leverages pretrained image and layout diffusion priors for joint generation, a generative multimodal application built on foundation-model priors.
**Relevance:** 5
**Novelty:** 5

---

## 12. [3D Point Splatting for mmWave Radar Novel View Synthesis](https://arxiv.org/abs/2609.11894) <a id="link12"></a>
**ArXiv ID:** 2609.11894
**Authors:** Adnan Armouti, Yixuan Gao, Rajalakshmi Nandakumar
...
**Comment:** Matches criterion 4: a novel rendering method for mmWave radar novel view synthesis, but it is more sensor-specific than a broad vision foundation model application.
**Relevance:** 4
**Novelty:** 5

---

## 13. [Guided Super-Resolution of Digital Elevation Models with Diffusion-Based Image Generators](https://arxiv.org/abs/2609.11886) <a id="link13"></a>
**ArXiv ID:** 2609.11886
**Authors:** Armand Mihai Nicolicioiu, Dominik Narnhofer, Nando Metzger, Daniel Panangian, Ksenia Bittner, Konrad Schindler
...
**Comment:** Matches criterion 4 closely: it applies diffusion-based image generators as strong priors for guided super-resolution of elevation models.
**Relevance:** 5
**Novelty:** 4

---

## 14. [Uncertainty DMD: Restoring Diversity in Few-Step Autoregressive Video Distillation](https://arxiv.org/abs/2609.11265) <a id="link14"></a>
**ArXiv ID:** 2609.11265
**Authors:** Zixuan Duan, Xunzhi Xiang, Yabo Chen, Xin Zhang, Changhan Liu, Haibin Huang, Chi Zhang, Qi Fan, Xuelong Li
...
**Comment:** No direct match to the listed criteria, though it is relevant to generative modeling in multimodal/video learning because it tackles diversity collapse in few-step video distillation.
**Relevance:** 3
**Novelty:** 5

---

## 15. [MHE-Former: Multi-Hypothesis Transformers via Entropy Maximization for 3D Mesh Recovery](https://arxiv.org/abs/2609.10743) <a id="link15"></a>
**ArXiv ID:** 2609.10743
**Authors:** Boshu Jia, Rongyu Chen, Linlin Yang, Zihao Liu, Yingjie Chen, Zhongqun Zhang, Zhulin Tao, Shaohui Lin, Xiaoyu Wu, Libiao Jin, Baochang Zhang, Angela Yao
...
**Comment:** Matches criterion 1 only indirectly through 3D human/body recovery and ambiguity handling; not an embodied-agent spatial intelligence paper.
**Relevance:** 3
**Novelty:** 5

---

## 16. [Overpainting: Localized Context-aware Diffusion Image Editing](https://arxiv.org/abs/2609.10811) <a id="link16"></a>
**ArXiv ID:** 2609.10811
**Authors:** Sam Sartor, Iliyan Georgiev, Michael Fischer, Valentin Deschaintre, Pieter Peers
...
**Comment:** Matches criterion 4 only loosely: it is a vision diffusion editing method, but not a vision foundation model application in the sense of broad foundational model usage.
**Relevance:** 3
**Novelty:** 4
