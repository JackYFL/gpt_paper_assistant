# Personalized Daily ArXiv Papers 05/19/2026
...
0. [ESI-Bench: Towards Embodied Spatial Intelligence that Closes the Perception-Action Loop](#link0)
**Authors:** Yining Hong, Jiageng Liu, Han Yin, Manling Li, Leonidas Guibas, Li Fei-Fei, Jiajun Wu, Yejin Choi

1. [Seeing Together:Multi-Robot Cooperative Egocentric Spatial Reasoning with Multimodal Large Language Models](#link1)
...
2. [CrossView Suite: Harnessing Cross-view Spatial Intelligence of MLLMs with Dataset, Model and Benchmark](#link2)
**Authors:** Wei Wang, Yuqian Yuan, Tianwei Lin, Wenqiao Zhang, Siliang Tang, Jun Xiao, Yueting Zhuang

3. [Omni-DuplexEval: Evaluating Real-time Duplex Omni-modal Interaction](#link3)
**Authors:** Chaoqun He, Mingyang Xiang, Yingjing Xu, Bokai Xu, Junbo Cui, Jie Zhou, Yuan Yao, Lijie Wen

4. [TaskGround: Structured Executable Task Inference for Full-Scene Household Reasoning](#link4)
...
5. [EPIC-Bench: A Perception-Centric Benchmark for Fine-Grained Embodied Visual Grounding in Vision-Language Models](#link5)
...
6. [Evaluating Cognitive Age Alignment in Interactive AI Agents](#link6)
**Authors:** Yifan Shen, Jiawen Zhang, Jian Xu, Junho Kim, Ismini Lourentzou, Xu Cao, Meihuan Huang

7. [TouchMap-OR: Multi-View 3D Mapping of Hand-Surface Contacts](#link7)
**Authors:** Sophokles Ktistakis, Rui Wang, Bastian Grande, Hugo Sax

8. [TTE-Flash: Accelerating Reasoning-based Multimodal Representations via Think-Then-Embed Tokens](#link8)
...
9. [Mamba-VGGT: Persistent Long-Sequence Video Geometry Grounded Transformer via External Sliding Window Mamba Memory](#link9)
**Authors:** Tianchen Deng, Zhenxiang Xiong, Nailin Wang, Fangjinhua Wang, Jiuming Liu, Jianfei Yang, Hesheng Wang

10. [Incantation: Natural Language as the Action Interface for Multi-Entity Video World Models](#link10)
...
11. [CAVE: A Structured Credit Assignment Approach for Fragmented Visual Evidence Reasoning](#link11)
**Authors:** Tengda Guo, Jie Leng, Hanlei Li, Yaoyuan Liang, Qingyue Zhang, Dian Yang, Mingyu Zhang, Yuhua Fu, Shao-Lun Huang

12. [EgoInteract: Synthetic Egocentric Videos Generation for Interaction Understanding and Anticipation](#link12)
...
13. [EgoExoMem: Cross-View Memory Reasoning over Synchronized Egocentric and Exocentric Videos](#link13)
...
14. [Sketch Then Paint: Hierarchical Reinforcement Learning for Diffusion Multi-Modal Large Language Models](#link14)
...
15. [Visualizing the Invisible: Generative Visual Grounding Empowers Universal EEG Understanding in MLLMs](#link15)
**Authors:** Junyu Pan, Yansen Wang, Enze Zhang, Baoliang Lu, Weilong Zheng, Dongsheng Li

16. [GraSP-VL: Length as a Semantic Granularity Interface for Vision-Language Representations](#link16)
**Authors:** Zesheng Li, Chengchang Pan, Honggang Qi

17. [Lance: Unified Multimodal Modeling by Multi-Task Synergy](#link17)
...
18. [How Many Visual Tokens Do Multimodal Language Models Need? Scaling Visual Token Pruning with F^3A](#link18)
...
19. [See What I Mean: Aligning Vision and Language Representations for Video Fine-grained Object Understanding](#link19)
**Authors:** Boyuan Sun, Bowen Yin, Yuanming Li, Xihan Wei, Qibin Hou

20. [StableVLA: Towards Robust Vision-Language-Action Models without Extra Data](#link20)
...
21. [Resolving Representation Ambiguity in Feedforward Novel View Synthesis Transformer via Semantic-Spatial Decoupling](#link21)
**Authors:** Yihang Wu, Yihang Sun, Shaofeng Zhang, Zuxuan Wu, Junchi Yan, Xiaosong Jia, Yu-gang Jiang

22. [Cracks in the Foundation: A Civil Infrastructure Dataset to Challenge Vision Foundation Models](#link22)
...
23. [Vision Transformer-Conditioned UNet for Domain-Adaptive Semantic Segmentation](#link23)
**Authors:** Joel Valdivia Ortega, Tingying Peng, Marion Jasnin

24. [Interactive Evaluation Requires a Design Science](#link24)
...
25. [Unleashing Vision Transformer Potential In Image Quality Assessment via Global-Local Adaptive Interaction](#link25)
**Authors:** Yu Li, Puchao Zhou, Yachun Mi, Yanfeng Wu, Xiaoming Wang, Shaohui Liu

26. [FastOCR: Dynamic Visual Fixation via KV Cache Pruning for Efficient Document Parsing](#link26)
**Authors:** Zihan Tang, Leqi Shen, Hui Chen, Ao Wang, Ben Wan, Yan Feng, Ke Zhang, Sicheng Zhao, Tongxuan Liu, Guiguang Ding

27. [Self-supervised Hierarchical Visual Reasoning with World Model](#link27)
**Authors:** Yuanfei Xu, Lin Liu, Wengang Zhou, Mingxiao Feng, Houqiang Li

28. [Spatial Blindness in Whole-Slide Multiple Instance Learning](#link28)
**Authors:** Xiangyu Li, Ran Su

29. [Beyond Point-Wise Matching: Structural Representation Alignment for Accelerating Diffusion Transformers](#link29)
**Authors:** Shaodong Xu, Zhendong Wang, Litong Gong, Zexian Li, Wengang Zhou, Tiezheng Ge, Houqiang Li

30. [Temporal Aware Pruning for Efficient Diffusion-based Video Generation](#link30)
**Authors:** Sheng Li, Yang Sui, Junhao Ran, Bo Yuan, Yue Dai, Xulong Tang

31. [GeoFlow: Enforcing Implicit Geometric Consistency in Video Generation](#link31)
**Authors:** Jan Ackermann, Shengqu Cai, Boyang Deng, Zhengfei Kuang, Songyou Peng, Gordon Wetzstein

32. [EgoIntrospect: An Egocentric Dataset and Benchmark for User-Centric Internal State Reasoning](#link32)
...
33. [EgoKit: Towards Unified Low-Cost Egocentric Data Collection with Heterogeneous Devices](#link33)
...
34. [AtlasVid: Efficient Ultra-High-Resolution Long Video Generation via Decoupled Global-Local Modeling](#link34)
**Authors:** Ziyang Mai, Yuyao Zhang, Yu-Wing Tai

35. [UCSF-PDGM-VQA: Visual Question Answering dataset for brain tumor MRI interpretation](#link35)
**Authors:** Shiv Ghosh (Catherine), Junayd Lateef (Catherine), Chih-Hua (Catherine), Liu, Yannan Yu, Andreas M. Rauschecker, Madhumita Sushil

36. [HL-OutPaint: Coarse-to-Fine Video Outpainting for High-Resolution Long-Range Videos](#link36)
**Authors:** Jeongeun Park, Janghyeok Han, Geonung Kim, Hyun-Seung Lee, Kyuha Choi, Youngseok Han, Sunghyun Cho

37. [Reasoning Before Diagnosis: Physician-Inspired Structured Thinking for ECG Classification](#link37)
**Authors:** Yang Wu, Xiaoyan Yuan, Hau-San Wong, Xiping Hu

38. [Spectral Progressive Diffusion for Efficient Image and Video Generation](#link38)
**Authors:** Howard Xiao, Brian Chao, Lior Yariv, Gordon Wetzstein

39. [Synthetic Aperture Radar Image Change Detection Based on Global Dynamic Context-Aware Network](#link39)
**Authors:** Baogui Huan, Chuanzheng Gong, Dezhong Chen, Feng Gao, Junyu Dong, Qian Du

40. [GCE-MIL: Faithful and Recoverable Evidence for Multiple Instance Learning in Whole-Slide Imaging](#link40)
**Authors:** Xiangyu Li, Ran Su

41. [ChronoSC: Task-Oriented Semantic Communication via Temporal-to-Color Encoding](#link41)
**Authors:** Phuc H. Nguyen, Trung T. Nguyen, Quy N. Duong, Van-Dinh Nguyen

42. [NGM: A Plug-and-Play Training-Free Memory Module for LLMs](#link42)
**Authors:** Yuwen Qu, Wenhui Dong, Chenyang Si, Caifeng Shan

43. [Axial-Relation Guided Fusion State Space Model for Optical-Elevation Sensing Image Segmentation](#link43)
**Authors:** Feng Gao, Zhilin Jin, Yanhai Gan, Junyu Dong, Qian Du

44. [Curriculum Group Policy Optimization: Adaptive Sampling for Unleashing the Potential of Text-to-Image Generation](#link44)
...
45. [HierEdit: Region-Aware Hierarchical Diffusion for Efficient High-Resolution Editing](#link45)
**Authors:** Yuyao Zhang, Alexander Huang-Menders, Yu-Wing Tai

46. [Edit-GRPO: A Locality-Preserving Policy Optimization Framework for Image Editing](#link46)
**Authors:** Shaodong Xu, Zexian Li, Zhendong Wang, Litong Gong, Tiezheng Ge, Wengang Zhou, Bo Zheng, Houqiang Li

47. [Degradation Frequency Curve: An Explicit Frequency-Quantified Representation for All-in-One Image Restoration](#link47)
**Authors:** Xinghua Huang, Zhixiong Yang, Chen Wu, Shengxi Li, Shuaifeng Zhi, Yue Zhang, Qibin Hou, Xin Deng, Jingyuan Xia

48. [Neural Visual Decoding via Cognitive guided Adaptive Blurring and Information Constrained Alignment](#link48)
**Authors:** Fan Yin, Chuhang Zheng, Peiliang Gong, Donghai Guan, Qi Zhu

49. [Learning Quantifiable Visual Explanations Without Ground-Truth](#link49)
**Authors:** Amritpal Singh, Andrey Barsky, Mohamed Ali Souibgui, Ernest Valveny, Dimosthenis Karatzas

50. [Prefix-Adaptive Block Diffusion for Efficient Document Recognition](#link50)
...
51. [AgentSteerTTS: A Multi-Agent Closed-Loop Framework for Composite-Instruction Text-to-Speech](#link51)
**Authors:** Bin Kang, Shaoguo Wen, Yang Fan, Shunlong Wu, Junjie Wang, Yulin Li, Junzhi Zhao, Junle Wang, Zhuotao Tian

52. [WebGameBench: Requirement-to-Application Evaluation for Coding Agents via Browser-Native Games](#link52)
...
53. [A Large-Scale Study on the Accuracy vs Cost Trade-offs of Training and Evaluation Settings in Fine-Grained Image Recognition](#link53)
...
---
## 0. [ESI-Bench: Towards Embodied Spatial Intelligence that Closes the Perception-Action Loop](https://arxiv.org/abs/2605.18746) <a id="link0"></a>
**ArXiv ID:** 2605.18746
**Authors:** Yining Hong, Jiageng Liu, Han Yin, Manling Li, Leonidas Guibas, Li Fei-Fei, Jiajun Wu, Yejin Choi
...
**Comment:** Matches criteria 1 (methodological improvements to spatial intelligence on embodied agents) and 3 (new embodied AI benchmark, ESI-BENCH, for active spatial reasoning in simulators). Provides surprising empirical findings about perception-action loop and metacognitive gaps in MLLMs.
**Relevance:** 10
**Novelty:** 9

---

## 1. [Seeing Together:Multi-Robot Cooperative Egocentric Spatial Reasoning with Multimodal Large Language Models](https://arxiv.org/abs/2605.18431) <a id="link1"></a>
**ArXiv ID:** 2605.18431
**Authors:** Kunyu Peng, Zhikun Zhou, Kailun Yang, Di Wen, Ruiping Liu, Yufan Chen, Junwei Zheng, Hao Shi, Yi Zhou, M. Saquib Sarfraz, Danda Pani Paudel, Luc Van Gool
...
**Comment:** Matches criteria 1 (new methodological improvements to spatial understanding on embodied agents), 2 (new MLLMs), and 3 (new benchmark for multi-robot cooperative spatial reasoning in simulators). Introduces CoopSR benchmark and SP-CoR MLLM framework for multi-robot egocentric spatial reasoning.
**Relevance:** 10
**Novelty:** 9

---

## 2. [CrossView Suite: Harnessing Cross-view Spatial Intelligence of MLLMs with Dataset, Model and Benchmark](https://arxiv.org/abs/2605.18621) <a id="link2"></a>
**ArXiv ID:** 2605.18621
**Authors:** Wei Wang, Yuqian Yuan, Tianwei Lin, Wenqiao Zhang, Siliang Tang, Jun Xiao, Yueting Zhuang
...
**Comment:** This paper directly matches criteria 1, 2, and 3: it introduces a new benchmark and dataset for cross-view spatial intelligence in MLLMs, proposes a new model (CrossViewer) for explicit cross-view alignment, and focuses on spatial reasoning and intelligence in multi-modal large language models. It also provides a systematic evaluation and a novel alignment mechanism, which is a novel angle.
**Relevance:** 10
**Novelty:** 8

---

## 3. [Omni-DuplexEval: Evaluating Real-time Duplex Omni-modal Interaction](https://arxiv.org/abs/2605.17360) <a id="link3"></a>
**ArXiv ID:** 2605.17360
**Authors:** Chaoqun He, Mingyang Xiang, Yingjing Xu, Bokai Xu, Junbo Cui, Jie Zhou, Yuan Yao, Lijie Wen
...
**Comment:** Matches criterion 2 (new MLLMs) and criterion 3 (embodied AI, new benchmarks): Proposes a new benchmark (Omni-DuplexEval) for real-time duplex multimodal interaction, with a novel evaluation framework for MLLMs in streaming settings.
**Relevance:** 10
**Novelty:** 8

---

## 4. [TaskGround: Structured Executable Task Inference for Full-Scene Household Reasoning](https://arxiv.org/abs/2605.18109) <a id="link4"></a>
**ArXiv ID:** 2605.18109
**Authors:** ZhiYuan Feng, Yu Deng, Ruichuan An, Zhenhua Liu, Qixiu Li, Keming Wu, Zhiying Du, Weijie Wang, Haoxiao Wang, Shuang Chen, Sicheng Xu, Yaobo Liang, Jiaolong Yang, Baining Guo
...
**Comment:** Matches criterion 3: Introduces TaskGround, a new method and benchmark (FullHome) for full-scene household reasoning in embodied AI, focusing on structured executable task inference.
**Relevance:** 10
**Novelty:** 8

---

## 5. [EPIC-Bench: A Perception-Centric Benchmark for Fine-Grained Embodied Visual Grounding in Vision-Language Models](https://arxiv.org/abs/2605.17070) <a id="link5"></a>
**ArXiv ID:** 2605.17070
**Authors:** Haozhe Shan, Xiancong Ren, Han Dong, Haoyuan Shi, Yingji Zhang, Jiayu Hu, Yi Zhang, Yong Dai, Bin Shen, Lizhen Qu, Zenglin Xu, Xiaozhu Ju
...
**Comment:** Strongly matches criterion 3 (embodied AI papers on new benchmarks/simulators) and criterion 4 (vision foundation models and applications). Introduces EPIC-Bench, a new benchmark for fine-grained embodied visual grounding in VLMs, and provides actionable insights for vision-driven embodied models.
**Relevance:** 10
**Novelty:** 8

---

## 6. [Evaluating Cognitive Age Alignment in Interactive AI Agents](https://arxiv.org/abs/2605.17894) <a id="link6"></a>
**ArXiv ID:** 2605.17894
**Authors:** Yifan Shen, Jiawen Zhang, Jian Xu, Junho Kim, Ismini Lourentzou, Xu Cao, Meihuan Huang
...
**Comment:** Matches criterion 3: introduces a new psychometrically grounded interactive benchmark (ChildAgentEval) for evaluating cognitive age alignment in MLLM-based agents, focusing on embodied AI and benchmarking from a novel angle (cognitive developmental stages).
**Relevance:** 9
**Novelty:** 8

---

## 7. [TouchMap-OR: Multi-View 3D Mapping of Hand-Surface Contacts](https://arxiv.org/abs/2605.17638) <a id="link7"></a>
**ArXiv ID:** 2605.17638
**Authors:** Sophokles Ktistakis, Rui Wang, Bastian Grande, Hugo Sax
...
**Comment:** Matches criterion 1 (spatial understanding on embodied agents): Proposes a multi-view 3D mapping system for hand-surface contact reconstruction in real-world operating rooms, focusing on spatial intelligence and embodied perception.
**Relevance:** 9
**Novelty:** 8

---

## 8. [TTE-Flash: Accelerating Reasoning-based Multimodal Representations via Think-Then-Embed Tokens](https://arxiv.org/abs/2605.16638) <a id="link8"></a>
**ArXiv ID:** 2605.16638
**Authors:** Jianpeng Cheng, Xian Wu, Jiangfan Zhang, Wentao Bao, Chaitanya Ahuja, Shlok Kumar Mishra, Hanchao Yu, Yang Gao, Fan Xia, Qi Guo, Shaodan Zhai, Xiangjun Fan, Jun Xiao
...
**Comment:** Matches criterion 2 (new MLLMs): Proposes a new reasoning-aware multimodal representation model (TTE-Flash-2B) with a novel token-based approach for efficient chain-of-thought reasoning in MLLMs.
**Relevance:** 9
**Novelty:** 8

---

## 9. [Mamba-VGGT: Persistent Long-Sequence Video Geometry Grounded Transformer via External Sliding Window Mamba Memory](https://arxiv.org/abs/2605.17478) <a id="link9"></a>
**ArXiv ID:** 2605.17478
**Authors:** Tianchen Deng, Zhenxiang Xiong, Nailin Wang, Fangjinhua Wang, Jiuming Liu, Jianfei Yang, Hesheng Wang
...
**Comment:** Matches criterion 1 and 3: Introduces a new method for persistent long-sequence video geometry grounding in embodied agents, with a novel memory module and spatial memory injector for scalable 3D world modeling.
**Relevance:** 9
**Novelty:** 8

---

## 10. [Incantation: Natural Language as the Action Interface for Multi-Entity Video World Models](https://arxiv.org/abs/2605.18601) <a id="link10"></a>
**ArXiv ID:** 2605.18601
**Authors:** Shangwen Zhu, Qianyu Peng, Zhao Pu, Zhilei Shu, Xiangrui Ke, Zhaohu Xing, Zizhao Tong, Zeqing Wang, Xinyu Cui, Huangji Wang, Jian Zhao, Yeying Jin, Fan Cheng, Ruili Feng
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 3 (embodied AI with new methods/benchmarks). Proposes Incantation, a novel interactive video world model using natural language as the action interface for multi-entity control, and demonstrates strong empirical results.
**Relevance:** 9
**Novelty:** 8

---

## 11. [CAVE: A Structured Credit Assignment Approach for Fragmented Visual Evidence Reasoning](https://arxiv.org/abs/2605.16416) <a id="link11"></a>
**ArXiv ID:** 2605.16416
**Authors:** Tengda Guo, Jie Leng, Hanlei Li, Yaoyuan Liang, Qingyue Zhang, Dian Yang, Mingyu Zhang, Yuhua Fu, Shao-Lun Huang
...
**Comment:** Strongly matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Also relevant to criterion 1 (methodological improvements to spatial/spatial intelligence) as it proposes a new structured credit assignment for fragmented visual reasoning in VLMs and introduces a new benchmark (TRACER-Bench).
**Relevance:** 9
**Novelty:** 8

---

## 12. [EgoInteract: Synthetic Egocentric Videos Generation for Interaction Understanding and Anticipation](https://arxiv.org/abs/2605.18214) <a id="link12"></a>
**ArXiv ID:** 2605.18214
**Authors:** Rosario Leonardi, Francesco Ragusa, Daniele Materia, Alessandro Passanisi, James Fort, Jakob Engel, Giovanni Maria Farinella
...
**Comment:** Matches criterion 3 (embodied AI, new simulator/benchmark for egocentric video generation and interaction understanding). Introduces EgoInteract, a controllable simulator and synthetic dataset for egocentric perception.
**Relevance:** 8
**Novelty:** 8

---

## 13. [EgoExoMem: Cross-View Memory Reasoning over Synchronized Egocentric and Exocentric Videos](https://arxiv.org/abs/2605.18734) <a id="link13"></a>
**ArXiv ID:** 2605.18734
**Authors:** Ruiping Liu, Junwei Zheng, Yufan Chen, Di Wen, Shaofang Quan, Chengzhi Wu, Jiaming Zhang, Kailun Yang, Kunyu Peng, Rainer Stiefelhagen
...
**Comment:** Matches criterion 3: introduces EgoExoMem, a new benchmark for cross-view memory reasoning in embodied AI, and proposes a novel frame selection method for synchronized egocentric and exocentric videos.
**Relevance:** 8
**Novelty:** 8

---

## 14. [Sketch Then Paint: Hierarchical Reinforcement Learning for Diffusion Multi-Modal Large Language Models](https://arxiv.org/abs/2605.16842) <a id="link14"></a>
**ArXiv ID:** 2605.16842
**Authors:** Siqi Luo, Jianghan Shen, Yi Xin, Huayu Zheng, Haoxing Chen, Yan Tai, Yue Li, Junjun He, Yihao Liu, Guangtao Zhai, Yuewen Cao, Xiaohong Liu
...
**Comment:** Matches criterion 2: proposes a new hierarchical reinforcement learning method for diffusion multi-modal large language models (dMLLMs), improving image generation quality and reward assignment.
**Relevance:** 8
**Novelty:** 8

---

## 15. [Visualizing the Invisible: Generative Visual Grounding Empowers Universal EEG Understanding in MLLMs](https://arxiv.org/abs/2605.18172) <a id="link15"></a>
**ArXiv ID:** 2605.18172
**Authors:** Junyu Pan, Yansen Wang, Enze Zhang, Baoliang Lu, Weilong Zheng, Dongsheng Li
...
**Comment:** Matches criterion 2: proposes a new generative visual grounding framework for MLLMs, using EEG-to-image generation to improve multi-modal understanding. Also relevant to criterion 4 as it leverages vision foundation models for brain signal interpretation.
**Relevance:** 8
**Novelty:** 8

---

## 16. [GraSP-VL: Length as a Semantic Granularity Interface for Vision-Language Representations](https://arxiv.org/abs/2605.17727) <a id="link16"></a>
**ArXiv ID:** 2605.17727
**Authors:** Zesheng Li, Chengchang Pan, Honggang Qi
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Proposes GraSP-VL, a new interface for controlling semantic granularity in frozen VLM embeddings, which is a clever statistical trick for multi-modal learning.
**Relevance:** 8
**Novelty:** 8

---

## 17. [Lance: Unified Multimodal Modeling by Multi-Task Synergy](https://arxiv.org/abs/2605.18678) <a id="link17"></a>
**ArXiv ID:** 2605.18678
**Authors:** Fengyi Fu, Mengqi Huang, Shaojin Wu, Yunsheng Jiang, Yufei Huo, Hao Li, Yinghang Song, Fei Ding, Jianzhu Guo, Qian He, Zheren Fu, Zhendong Mao, Yongdong Zhang
...
**Comment:** Strongly matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Introduces Lance, a unified multimodal model for understanding, generation, and editing of images and videos, with a novel dual-stream MoE architecture.
**Relevance:** 9
**Novelty:** 7

---

## 18. [How Many Visual Tokens Do Multimodal Language Models Need? Scaling Visual Token Pruning with F^3A](https://arxiv.org/abs/2605.16359) <a id="link18"></a>
**ArXiv ID:** 2605.16359
**Authors:** YiJie Huang, Yiqun Zhang, Zhuoyue Jia, Xiaocui Yang, Junzhao Huang, Zihan Wang, Shi Feng, Daling Wang, Yifei Zhang, Yongkang Liu
...
**Comment:** This paper addresses the efficiency of visual token usage in multimodal language models, proposing a new training-free pruning method (F^3A) for visual tokens. It is directly relevant to criterion 2 (new methods for VLLMs/MLLMs) and provides a clever statistical trick for token pruning, which is of interest for efficient vision-language modeling.
**Relevance:** 8
**Novelty:** 7

---

## 19. [See What I Mean: Aligning Vision and Language Representations for Video Fine-grained Object Understanding](https://arxiv.org/abs/2605.18018) <a id="link19"></a>
**ArXiv ID:** 2605.18018
**Authors:** Boyuan Sun, Bowen Yin, Yuanming Li, Xihan Wei, Qibin Hou
...
**Comment:** Matches criterion 2 (improves vision-language alignment in MLLMs for fine-grained object understanding). Proposes SWIM, a new training strategy and dataset for better text-visual alignment.
**Relevance:** 8
**Novelty:** 7

---

## 20. [StableVLA: Towards Robust Vision-Language-Action Models without Extra Data](https://arxiv.org/abs/2605.18287) <a id="link20"></a>
**ArXiv ID:** 2605.18287
**Authors:** Yiyang Fu, Chubin Zhang, Shukai Gong, Yufan Deng, Kaiwei Sun, Qiyang Min, Qibin Hou, Yansong Tang, Jianan Wang, Daquan Zhou
...
**Comment:** Matches criterion 3: proposes a new method (IB-Adapter) for improving robustness in Vision-Language-Action models for embodied AI, focusing on robustness to unseen disturbances without extra data.
**Relevance:** 8
**Novelty:** 7

---

## 21. [Resolving Representation Ambiguity in Feedforward Novel View Synthesis Transformer via Semantic-Spatial Decoupling](https://arxiv.org/abs/2605.18599) <a id="link21"></a>
**ArXiv ID:** 2605.18599
**Authors:** Yihang Wu, Yihang Sun, Shaofeng Zhang, Zuxuan Wu, Junchi Yan, Xiaosong Jia, Yu-gang Jiang
...
**Comment:** Matches criterion 1: proposes a new method for spatial understanding in novel view synthesis transformers by decoupling semantic and spatial tokens, improving spatial intelligence in vision models.
**Relevance:** 8
**Novelty:** 7

---

## 22. [Cracks in the Foundation: A Civil Infrastructure Dataset to Challenge Vision Foundation Models](https://arxiv.org/abs/2605.18413) <a id="link22"></a>
**ArXiv ID:** 2605.18413
**Authors:** Nicola Farronato, Niccolo Avogaro, Thomas Frick, Mattia Rigotti, Rizwan Ullah Khan, Michele Magno, Konrad Schindler, Cristiano Malossi, Florian Scheidegger
...
**Comment:** Matches criterion 4: introduces a large, detailed civil infrastructure dataset (CiF) to challenge vision foundation models and exposes their weaknesses in dense image understanding for real-world infrastructure. Also relevant to benchmarking (criterion 3).
**Relevance:** 8
**Novelty:** 7

---

## 23. [Vision Transformer-Conditioned UNet for Domain-Adaptive Semantic Segmentation](https://arxiv.org/abs/2605.16393) <a id="link23"></a>
**ArXiv ID:** 2605.16393
**Authors:** Joel Valdivia Ortega, Tingying Peng, Marion Jasnin
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Proposes a ViT-conditioned UNet for domain-adaptive semantic segmentation, combining ViT global priors with UNet local decoding for biomedical vision tasks.
**Relevance:** 8
**Novelty:** 7

---

## 24. [Interactive Evaluation Requires a Design Science](https://arxiv.org/abs/2605.17829) <a id="link24"></a>
**ArXiv ID:** 2605.17829
**Authors:** Keyang Xuan, Peiyang Song, Pan Lu, Pengrui Han, Wenkai Li, Zhenyu Zhang, Zexue He, Wenyue Hua, Manling Li, Jiaxuan You, Adrian Weller, Yizhong Wang, Jiaxin Pei
...
**Comment:** Matches criterion 3 (embodied AI, new benchmarks, novel evaluation): Position paper on interactive evaluation for agent systems, proposing a new taxonomy and design principles for interactive benchmarks, which is a novel angle in embodied AI evaluation.
**Relevance:** 8
**Novelty:** 7

---

## 25. [Unleashing Vision Transformer Potential In Image Quality Assessment via Global-Local Adaptive Interaction](https://arxiv.org/abs/2605.17748) <a id="link25"></a>
**ArXiv ID:** 2605.17748
**Authors:** Yu Li, Puchao Zhou, Yachun Mi, Yanfeng Wu, Xiaoming Wang, Shaohui Liu
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Introduces a new framework leveraging pre-trained Vision Transformers for image quality assessment, with a novel global-local interaction adapter.
**Relevance:** 8
**Novelty:** 7

---

## 26. [FastOCR: Dynamic Visual Fixation via KV Cache Pruning for Efficient Document Parsing](https://arxiv.org/abs/2605.17447) <a id="link26"></a>
**ArXiv ID:** 2605.17447
**Authors:** Zihan Tang, Leqi Shen, Hui Chen, Ao Wang, Ben Wan, Yan Feng, Ke Zhang, Sicheng Zhao, Tongxuan Liu, Guiguang Ding
...
**Comment:** Matches criterion 2 and 4: Proposes FastOCR, a dynamic visual fixation method for efficient document parsing in VLMs, with a novel KV cache pruning strategy.
**Relevance:** 8
**Novelty:** 7

---

## 27. [Self-supervised Hierarchical Visual Reasoning with World Model](https://arxiv.org/abs/2605.17537) <a id="link27"></a>
**ArXiv ID:** 2605.17537
**Authors:** Yuanfei Xu, Lin Liu, Wengang Zhou, Mingxiao Feng, Houqiang Li
...
**Comment:** Matches criterion 1 (methodological improvements to spatial/spatial intelligence on embodied agents) and criterion 3 (embodied AI with new methods). Proposes ResDreamer, a hierarchical world model for self-supervised visual reasoning in 3D open-world environments, with strong empirical results.
**Relevance:** 8
**Novelty:** 7

---

## 28. [Spatial Blindness in Whole-Slide Multiple Instance Learning](https://arxiv.org/abs/2605.17449) <a id="link28"></a>
**ArXiv ID:** 2605.17449
**Authors:** Xiangyu Li, Ran Su
...
**Comment:** Strongly matches criterion 1 (methodological improvements to spatial understanding on embodied agents) by identifying and addressing 'spatial blindness' in whole-slide MIL models, and proposes a new method (ResTopoMIL) to restore spatial sensitivity.
**Relevance:** 8
**Novelty:** 7

---

## 29. [Beyond Point-Wise Matching: Structural Representation Alignment for Accelerating Diffusion Transformers](https://arxiv.org/abs/2605.16949) <a id="link29"></a>
**ArXiv ID:** 2605.16949
**Authors:** Shaodong Xu, Zhendong Wang, Litong Gong, Zexian Li, Wengang Zhou, Tiezheng Ge, Houqiang Li
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a new structural alignment method (sREPA) for diffusion transformers, leveraging spatial structure from vision foundation models for generative modeling.
**Relevance:** 7
**Novelty:** 7

---

## 30. [Temporal Aware Pruning for Efficient Diffusion-based Video Generation](https://arxiv.org/abs/2605.17837) <a id="link30"></a>
**ArXiv ID:** 2605.17837
**Authors:** Sheng Li, Yang Sui, Junhao Ran, Bo Yuan, Yue Dai, Xulong Tang
...
**Comment:** Matches criterion 4: Proposes TAPE, a temporal-aware pruning method for efficient diffusion-based video generation, improving vision foundation model efficiency.
**Relevance:** 7
**Novelty:** 7

---

## 31. [GeoFlow: Enforcing Implicit Geometric Consistency in Video Generation](https://arxiv.org/abs/2605.18365) <a id="link31"></a>
**ArXiv ID:** 2605.18365
**Authors:** Jan Ackermann, Shengqu Cai, Boyang Deng, Zhengfei Kuang, Songyou Peng, Gordon Wetzstein
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and is relevant to generative modeling in multi-modal learning. Proposes a new geometric consistency reward for video generation, which is a novel angle for improving video diffusion models.
**Relevance:** 7
**Novelty:** 7

---

## 32. [EgoIntrospect: An Egocentric Dataset and Benchmark for User-Centric Internal State Reasoning](https://arxiv.org/abs/2605.17262) <a id="link32"></a>
**ArXiv ID:** 2605.17262
**Authors:** Zeyu Wang, Chang Liu, Eduardus Tjitrahardja, Yuntao Wang, Borislav Pavlov, Fangfei Gou, Jose Manuel Davila, Dai Shi, Ran Xu, Yue Pan, Jiayi Tan, Shuting Chang, Qi Wang, Jinzhao Li, Jiacheng Hua, Yifei Huang, Jingwei Sun, Yu Zhang, Liuxin Zhang, Guocai Yao, Jia Jia, Yin Li, Qianying Wang, Yuanchun Shi, Miao Liu
...
**Comment:** Partially matches criterion 3 (new egocentric benchmark for user internal state reasoning, with focus on MLLMs' ability to infer internal states). Novel angle on user-centric internal state reasoning in egocentric vision.
**Relevance:** 6
**Novelty:** 7

---

## 33. [EgoKit: Towards Unified Low-Cost Egocentric Data Collection with Heterogeneous Devices](https://arxiv.org/abs/2605.16797) <a id="link33"></a>
**ArXiv ID:** 2605.16797
**Authors:** Liuchuan Yu, Erdem Murat, Beichen Wang, Yan Zeng, Tingting Luo, Huizhen Zhou, Shanghao Li, Huining Feng, Zhigen Zhao, Ning Yang, Ke Jing, Yunhao Liu, Ruoya Sheng
...
**Comment:** Matches criterion 3: introduces EgoKit, a unified, low-cost toolkit for egocentric data collection across heterogeneous devices, facilitating embodied AI research and benchmarking.
**Relevance:** 7
**Novelty:** 6

---

## 34. [AtlasVid: Efficient Ultra-High-Resolution Long Video Generation via Decoupled Global-Local Modeling](https://arxiv.org/abs/2605.16649) <a id="link34"></a>
**ArXiv ID:** 2605.16649
**Authors:** Ziyang Mai, Yuyao Zhang, Yu-Wing Tai
...
**Comment:** Relevant to criterion 4: proposes a new framework for ultra-high-resolution long video generation using decoupled global-local modeling, which is an application of vision foundation models and generative modeling.
**Relevance:** 6
**Novelty:** 7

---

## 35. [UCSF-PDGM-VQA: Visual Question Answering dataset for brain tumor MRI interpretation](https://arxiv.org/abs/2605.17140) <a id="link35"></a>
**ArXiv ID:** 2605.17140
**Authors:** Shiv Ghosh (Catherine), Junayd Lateef (Catherine), Chih-Hua (Catherine), Liu, Yannan Yu, Andreas M. Rauschecker, Madhumita Sushil
...
**Comment:** Matches criterion 4: introduces a new VQA benchmark for brain tumor MRI interpretation and evaluates vision-language models, revealing modality collapse and the need for domain-specific VLMs.
**Relevance:** 7
**Novelty:** 6

---

## 36. [HL-OutPaint: Coarse-to-Fine Video Outpainting for High-Resolution Long-Range Videos](https://arxiv.org/abs/2605.17543) <a id="link36"></a>
**ArXiv ID:** 2605.17543
**Authors:** Jeongeun Park, Janghyeok Han, Geonung Kim, Hyun-Seung Lee, Kyuha Choi, Youngseok Han, Sunghyun Cho
...
**Comment:** Relevant to criterion 4 (vision foundation models and applications): Proposes a new video outpainting framework with global-local structure modeling, which is a novel application in generative modeling for vision.
**Relevance:** 6
**Novelty:** 7

---

## 37. [Reasoning Before Diagnosis: Physician-Inspired Structured Thinking for ECG Classification](https://arxiv.org/abs/2605.17308) <a id="link37"></a>
**ArXiv ID:** 2605.17308
**Authors:** Yang Wu, Xiaoyan Yuan, Hau-San Wong, Xiping Hu
...
**Comment:** Matches criterion 2: Proposes a physician-inspired multimodal large language model (MLLM) for ECG classification with structured reasoning, introducing a new optimization method.
**Relevance:** 6
**Novelty:** 7

---

## 38. [Spectral Progressive Diffusion for Efficient Image and Video Generation](https://arxiv.org/abs/2605.18736) <a id="link38"></a>
**ArXiv ID:** 2605.18736
**Authors:** Howard Xiao, Brian Chao, Lior Yariv, Gordon Wetzstein
...
**Comment:** Matches criterion 4: Proposes a novel spectral progressive diffusion framework for efficient image and video generation, improving foundation model efficiency.
**Relevance:** 6
**Novelty:** 7

---

## 39. [Synthetic Aperture Radar Image Change Detection Based on Global Dynamic Context-Aware Network](https://arxiv.org/abs/2605.16764) <a id="link39"></a>
**ArXiv ID:** 2605.16764
**Authors:** Baogui Huan, Chuanzheng Gong, Dezhong Chen, Feng Gao, Junyu Dong, Qian Du
...
**Comment:** Matches criterion 1: Proposes a novel global dynamic context-aware network for spatial understanding in SAR image change detection, with a new global dynamic convolution module and a two-stage Mixup strategy.
**Relevance:** 7
**Novelty:** 6

---

## 40. [GCE-MIL: Faithful and Recoverable Evidence for Multiple Instance Learning in Whole-Slide Imaging](https://arxiv.org/abs/2605.17456) <a id="link40"></a>
**ArXiv ID:** 2605.17456
**Authors:** Xiangyu Li, Ran Su
...
**Comment:** Matches criterion 1 (methodological improvements to spatial understanding) by proposing GCE-MIL, which directly optimizes evidence quality in MIL for whole-slide imaging, introducing explicit sufficiency, necessity, and recoverability criteria.
**Relevance:** 7
**Novelty:** 6

---

## 41. [ChronoSC: Task-Oriented Semantic Communication via Temporal-to-Color Encoding](https://arxiv.org/abs/2605.16388) <a id="link41"></a>
**ArXiv ID:** 2605.16388
**Authors:** Phuc H. Nguyen, Trung T. Nguyen, Quy N. Duong, Van-Dinh Nguyen
...
**Comment:** Partially matches criterion 2 (uses pre-trained vision-language models for semantic communication in video QA). Introduces a novel temporal-to-color encoding for efficient video transmission.
**Relevance:** 5
**Novelty:** 7

---

## 42. [NGM: A Plug-and-Play Training-Free Memory Module for LLMs](https://arxiv.org/abs/2605.16893) <a id="link42"></a>
**ArXiv ID:** 2605.16893
**Authors:** Yuwen Qu, Wenhui Dong, Chenyang Si, Caifeng Shan
...
**Comment:** Matches criterion 2 (shows new VLLMs/MLLMs) and partially criterion 4 (vision foundation models and applications), as it discusses a plug-and-play memory module that improves multimodal benchmarks and is evaluated on Qwen3-VL-2B.
**Relevance:** 6
**Novelty:** 6

---

## 43. [Axial-Relation Guided Fusion State Space Model for Optical-Elevation Sensing Image Segmentation](https://arxiv.org/abs/2605.16768) <a id="link43"></a>
**ArXiv ID:** 2605.16768
**Authors:** Feng Gao, Zhilin Jin, Yanhai Gan, Junyu Dong, Qian Du
...
**Comment:** This paper proposes a new state space model for multi-modal (optical-elevation) image segmentation, with a novel fusion module. While it is a methodological improvement in multi-modal vision, it does not focus on spatial intelligence in embodied agents, VLLMs/MLLMs, or new benchmarks. It is relevant to vision foundation models and their applications (criterion 4).
**Relevance:** 5
**Novelty:** 6

---

## 44. [Curriculum Group Policy Optimization: Adaptive Sampling for Unleashing the Potential of Text-to-Image Generation](https://arxiv.org/abs/2605.17807) <a id="link44"></a>
**ArXiv ID:** 2605.17807
**Authors:** Baoteng Li, Xianghao Zang, Xinran Wang, Xiangyu Na, Zhixiang He, Hao Sun, Chi Zhang, Zhongjiang He, Tianwei Cao, Kongming Liang, Zhanyu Ma
...
**Comment:** This paper proposes a new adaptive curriculum training framework for text-to-image generation, which is a methodological improvement in generative modeling. However, it does not directly address spatial understanding or embodied agents, nor does it introduce a new VLLM/MLLM or a new benchmark. It is most closely related to generative modeling in multi-modal learning (criterion 2, but only tangentially).
**Relevance:** 4
**Novelty:** 6

---

## 45. [HierEdit: Region-Aware Hierarchical Diffusion for Efficient High-Resolution Editing](https://arxiv.org/abs/2605.17294) <a id="link45"></a>
**ArXiv ID:** 2605.17294
**Authors:** Yuyao Zhang, Alexander Huang-Menders, Yu-Wing Tai
...
**Comment:** Does not directly match any specific criterion, but is relevant to vision foundation models and generative modeling (efficient high-res image editing with hierarchical diffusion).
**Relevance:** 4
**Novelty:** 6

---

## 46. [Edit-GRPO: A Locality-Preserving Policy Optimization Framework for Image Editing](https://arxiv.org/abs/2605.16951) <a id="link46"></a>
**ArXiv ID:** 2605.16951
**Authors:** Shaodong Xu, Zexian Li, Zhendong Wang, Litong Gong, Tiezheng Ge, Wengang Zhou, Bo Zheng, Houqiang Li
...
**Comment:** Does not directly match any specific criterion, but is relevant to computer vision and generative modeling (image editing with spatial locality preservation).
**Relevance:** 4
**Novelty:** 6

---

## 47. [Degradation Frequency Curve: An Explicit Frequency-Quantified Representation for All-in-One Image Restoration](https://arxiv.org/abs/2605.17506) <a id="link47"></a>
**ArXiv ID:** 2605.17506
**Authors:** Xinghua Huang, Zhixiong Yang, Chen Wu, Shengxi Li, Shuaifeng Zhi, Yue Zhang, Qibin Hou, Xin Deng, Jingyuan Xia
...
**Comment:** Does not directly match any specific criterion, but is relevant to vision foundation models and image restoration. Proposes a new spectral representation for image degradation.
**Relevance:** 4
**Novelty:** 6

---

## 48. [Neural Visual Decoding via Cognitive guided Adaptive Blurring and Information Constrained Alignment](https://arxiv.org/abs/2605.16418) <a id="link48"></a>
**ArXiv ID:** 2605.16418
**Authors:** Fan Yin, Chuhang Zheng, Peiliang Gong, Donghai Guan, Qi Zhu
...
**Comment:** Relevant to multi-modal learning and neural decoding, but does not directly match any specific criterion. Focuses on EEG-to-vision mapping.
**Relevance:** 4
**Novelty:** 6

---

## 49. [Learning Quantifiable Visual Explanations Without Ground-Truth](https://arxiv.org/abs/2605.18681) <a id="link49"></a>
**ArXiv ID:** 2605.18681
**Authors:** Amritpal Singh, Andrey Barsky, Mohamed Ali Souibgui, Ernest Valveny, Dimosthenis Karatzas
...
**Comment:** Does not match any specific criterion. Focuses on explainable AI and visual explanations, not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 50. [Prefix-Adaptive Block Diffusion for Efficient Document Recognition](https://arxiv.org/abs/2605.16861) <a id="link50"></a>
**ArXiv ID:** 2605.16861
**Authors:** Mingxu Chai, Ziyu Shen, Chenyu Liu, Kaidi Zhang, Jiazheng Zhang, Dingwei Zhu, Zhiheng Xi, Ruoyu Chen, Jun Long, Jihua Kang, Tao Gui, Qi Zhang
...
**Comment:** Does not match any specific criterion. Focuses on document recognition with block diffusion models, not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 51. [AgentSteerTTS: A Multi-Agent Closed-Loop Framework for Composite-Instruction Text-to-Speech](https://arxiv.org/abs/2605.17583) <a id="link51"></a>
**ArXiv ID:** 2605.17583
**Authors:** Bin Kang, Shaoguo Wen, Yang Fan, Shunlong Wu, Junjie Wang, Yulin Li, Junzhi Zhao, Junle Wang, Zhuotao Tian
...
**Comment:** Does not match any specific criterion. Focuses on TTS with multi-agent framework, not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 52. [WebGameBench: Requirement-to-Application Evaluation for Coding Agents via Browser-Native Games](https://arxiv.org/abs/2605.17637) <a id="link52"></a>
**ArXiv ID:** 2605.17637
**Authors:** Wenyu Zhang, Guoliang You, Tianlun, Haotian Zhao, Tianshu Zhu, Haoran Wang, Xiaoxuan Tang, Mingyang Dai, Jingnan Gu, Daxiang Dong, Jianmin Wu
...
**Comment:** Relevant to embodied AI evaluation, but focuses on coding agents and browser-native games, not spatial intelligence or vision-language models.
**Relevance:** 3
**Novelty:** 5

---

## 53. [A Large-Scale Study on the Accuracy vs Cost Trade-offs of Training and Evaluation Settings in Fine-Grained Image Recognition](https://arxiv.org/abs/2605.18700) <a id="link53"></a>
**ArXiv ID:** 2605.18700
**Authors:** Edwin Arkel Rios, Augusto Christian Surya, Oswin Gosal, Fernando Mikael, Mary Madeline Nicole, Kisoon Jang, Bo-Cheng Lai, Min-Chun Hu
...
**Comment:** Relevant to general computer vision and ML, but does not directly match any specific criterion. Focuses on accuracy vs cost trade-offs in fine-grained image recognition.
**Relevance:** 3
**Novelty:** 4
