...
0. [UAV-OVVIS: Unmanned Aerial Vehicles Also Need Open-Vocabulary Video Instance Segmentation](#link0)
**Authors:** Mingyu Dou, Shi Qiu, Ming Hu, Yifan Chen, Zhe Sun

1. [LEEVLA: Seeing What Matters in Latent Environment Evolution for Vision-Language-Action](#link1)
**Authors:** Qi Lyu, Baicheng Liu, Xudong Wang, Jiahua Dong, Lianqing Liu, Zhi Han

2. [GIRAF: Towards Generalizable Human Interactions with Articulated Objects](#link2)
**Authors:** Xiaohan Zhang, Sebastian Starke, Alexander Winkler, Federica Bogo, Samir Aroudj, Yuting Ye

3. [UniRef-UAV: A Multimodal Benchmark for Universal Referring in UAV Imagery](#link3)
**Authors:** Haibin Tian, Huichao Xie, Xuelin Qian, Ruitao Lu, Junwei Han, Dingwen Zhang

4. [LTM: Large-scale Terrain Model for Wildfire-prone Landscapes](#link4)
**Authors:** Xiao Fu, Yue Hu, Meida Chen, Peter Anthony Beerel, Barath Raghavan

5. [MentalHospital: A Virtual Environment for Evaluating Psychiatric Clinical Encounters](#link5)
**Authors:** Yuming Yang, Xiao Sun, Yuanwei Zou, Zhengxiao Wu, Yun Chen, Jiang Zhong, Haoyang Zeng, Jingwang Huang, Kaiwen Wei

6. [Dive Into the Implicit Biases of Low-rank Vision-language Alignment](#link6)
**Authors:** Mingjia Shi, Shuo Wang, Xiaobo Wang, Sifan Zhou, Kai Wang, Tianyu Fu, Chenxu Zhao, Anyang Su, Ping Jiang, Minghui Wu

7. [Track2Map: Online Deformable SLAM with Motion-Aware Pose Optimization in Robotic Surgery](#link7)
...
8. [LightCrafter: PBR-Conditioned Video Diffusion Refinement for Controllable and Consistent Relighting](#link8)
**Authors:** Zixin Guo, Yehonathan Litman, Yifeng He, John Miller, Chuhan Chen, Deva Ramanan

9. [Geometry and Gradient-based Partitioning for Panoramic Outdoor Reconstruction](#link9)
**Authors:** Weijian Chen, Weibo Yao, Yuhang Zhang, Xiaolin Tang, Guo Wang, Weijun Zhang, Xitong Gao, Yihao Chen, Hongde Qin, Lu Qi

10. [WaspMOT: A Benchmark for Long-Term Multi-Object Tracking of Trichogramma Wasps](#link10)
**Authors:** Tomasz Stanczyk, Yuan Gao, Hardik Agarwal, Seongroo Yoon, Tiantao Zhang, Vincent Calcagno, Francois Bremond

11. [Whareformer: Learning to Track What is Where in Long Egocentric Videos](#link11)
**Authors:** Jacob Chalk, Saptarshi Sinha, Dima Damen, Yannis Kalantidis, Diane Larlus

12. [Do Egocentric Video-Language Models Capture Both Hand- and Object-Centric Cues?](#link12)
**Authors:** Masatoshi Tateno, Alexandros Stergiou, Risa Shinoda, Yoichi Sato, Dima Damen

13. [A First-Principles Theory of Slow Thinking and Active Perception](#link13)
**Authors:** Hongkang Yang, Zhi-Qin John Xu, Feiyu Xiong, Weinan E

14. [OmniFood-Bench: Evaluating VLMs for Nutrient Reasoning and Personalized Health Advice](#link14)
**Authors:** Qian Jiang, Zhecheng Shi, Jingpu Yang, Zirui Song, Miao Fang

15. [HSA: Hierarchical Slot Attention for Multi-granularity Scene-Decomposition](#link15)
**Authors:** Neelu Madan, Rongzhen Zhao, Andreas Mogelmose, Juho Kannala, Joni Pajarinen, Graham W. Taylor, Thomas B. Moeslund

16. [SkelGen4D: Weakly-Supervised Skeleton-Based 4D Generation for Text-Driven Mesh Animation](#link16)
**Authors:** Hao Feng, Zhi Zuo, Jia-Hui Pan, Ka-Hei Hui, Zhengzhe Liu, Dian Zhang, Haoran Xie, Bin Sheng, Jingyu Hu

17. [Dual-Correlation Hypergraph Network for Unaligned RGBT Video Object Detection and A Large-scale Benchmark](#link17)
**Authors:** Qishun Wang, Yapeng Li, Bin Luo, Zhengzheng Tu, Chenglong Li

18. [Mixture of Enhanced-View Experts for Multi-Query Vehicle ReID and A Large-Scale Benchmark](#link18)
**Authors:** Aihua Zheng, Jie Zhen, Chenglong Li, Jiaxiang Wang, Jin Tang

---
## 0. [UAV-OVVIS: Unmanned Aerial Vehicles Also Need Open-Vocabulary Video Instance Segmentation](https://arxiv.org/abs/2607.08075) <a id="link0"></a>
**ArXiv ID:** 2607.08075
**Authors:** Mingyu Dou, Shi Qiu, Ming Hu, Yifan Chen, Zhe Sun
...
**Comment:** Matches criterion 3 very closely: it introduces a new embodied perception benchmark for UAV open-vocabulary video instance segmentation, plus a training-free method built around visual foundation models.
**Relevance:** 6
**Novelty:** 7

---

## 1. [LEEVLA: Seeing What Matters in Latent Environment Evolution for Vision-Language-Action](https://arxiv.org/abs/2607.08182) <a id="link1"></a>
**ArXiv ID:** 2607.08182
**Authors:** Qi Lyu, Baicheng Liu, Xudong Wang, Jiahua Dong, Lianqing Liu, Zhi Han
...
**Comment:** Matches criterion 3 and 2: a new Vision-Language-Action (VLA) method with explicit latent environment evolution modeling for embodied agents.
**Relevance:** 6
**Novelty:** 7

---

## 2. [GIRAF: Towards Generalizable Human Interactions with Articulated Objects](https://arxiv.org/abs/2607.07880) <a id="link2"></a>
**ArXiv ID:** 2607.07880
**Authors:** Xiaohan Zhang, Sebastian Starke, Alexander Winkler, Federica Bogo, Samir Aroudj, Yuting Ye
...
**Comment:** Matches criterion 3 very closely: embodied AI / human-object interaction with a new method for full-body interaction with articulated objects.
**Relevance:** 5
**Novelty:** 7

---

## 3. [UniRef-UAV: A Multimodal Benchmark for Universal Referring in UAV Imagery](https://arxiv.org/abs/2607.08267) <a id="link3"></a>
**ArXiv ID:** 2607.08267
**Authors:** Haibin Tian, Huichao Xie, Xuelin Qian, Ruitao Lu, Junwei Han, Dingwen Zhang
...
**Comment:** Matches criterion 3 very closely: it introduces a new multimodal UAV referring benchmark and a baseline for universal referring, which is a novel spatial grounding/evaluation setting.
**Relevance:** 6
**Novelty:** 6

---

## 4. [LTM: Large-scale Terrain Model for Wildfire-prone Landscapes](https://arxiv.org/abs/2607.08711) <a id="link4"></a>
**ArXiv ID:** 2607.08711
**Authors:** Xiao Fu, Yue Hu, Meida Chen, Peter Anthony Beerel, Barath Raghavan
...
**Comment:** Matches criterion 3 closely: it proposes a new simulator for large-terrain reconstruction in wildfire-prone landscapes and a multi-modal method using legacy DEM priors, which is a novel embodied/spatial angle.
**Relevance:** 5
**Novelty:** 7

---

## 5. [MentalHospital: A Virtual Environment for Evaluating Psychiatric Clinical Encounters](https://arxiv.org/abs/2607.08257) <a id="link5"></a>
**ArXiv ID:** 2607.08257
**Authors:** Yuming Yang, Xiao Sun, Yuanwei Zou, Zhengxiao Wu, Yun Chen, Jiang Zhong, Haoyang Zeng, Jingwang Huang, Kaiwen Wei
...
**Comment:** Matches criterion 3 very closely: it proposes a new benchmark/virtual environment for evaluating full psychiatric clinical encounters in an embodied, simulator-like setup.
**Relevance:** 5
**Novelty:** 7

---

## 6. [Dive Into the Implicit Biases of Low-rank Vision-language Alignment](https://arxiv.org/abs/2607.08194) <a id="link6"></a>
**ArXiv ID:** 2607.08194
**Authors:** Mingjia Shi, Shuo Wang, Xiaobo Wang, Sifan Zhou, Kai Wang, Tianyu Fu, Chenxu Zhao, Anyang Su, Ping Jiang, Minghui Wu
...
**Comment:** Matches criterion 4 and partly 2: it studies low-rank vision-language alignment and gives insightful empirical/theoretical results on alignment behavior.
**Relevance:** 5
**Novelty:** 7

---

## 7. [Track2Map: Online Deformable SLAM with Motion-Aware Pose Optimization in Robotic Surgery](https://arxiv.org/abs/2607.08408) <a id="link7"></a>
**ArXiv ID:** 2607.08408
**Authors:** Tianyi Song, Sierra Bonilla, Xinwei Ju, Evangelos Mazomenos, Danail Stoyanov, Adam Schmidt, Omid Mohareri, Sophia Bano, Francisco Vasconcelos
...
**Comment:** Matches criterion 3: an embodied/simulation-related method paper on online SLAM for deformable robotic surgery, with a novel motion-aware pose optimization angle.
**Relevance:** 5
**Novelty:** 7

---

## 8. [LightCrafter: PBR-Conditioned Video Diffusion Refinement for Controllable and Consistent Relighting](https://arxiv.org/abs/2607.08016) <a id="link8"></a>
**ArXiv ID:** 2607.08016
**Authors:** Zixin Guo, Yehonathan Litman, Yifeng He, John Miller, Chuhan Chen, Deva Ramanan
...
**Comment:** Matches criterion 4 closely: a vision foundation model–based application (post-training CogVideoX) for controllable video relighting, with a new benchmark contribution.
**Relevance:** 5
**Novelty:** 6

---

## 9. [Geometry and Gradient-based Partitioning for Panoramic Outdoor Reconstruction](https://arxiv.org/abs/2607.08769) <a id="link9"></a>
**ArXiv ID:** 2607.08769
**Authors:** Weijian Chen, Weibo Yao, Yuhang Zhang, Xiaolin Tang, Guo Wang, Weijun Zhang, Xitong Gao, Yihao Chen, Hongde Qin, Lu Qi
...
**Comment:** Matches criterion 3 closely: it introduces a new benchmark for panoramic outdoor reconstruction and a geometry/gradient partitioning method for scalable reconstruction.
**Relevance:** 5
**Novelty:** 6

---

## 10. [WaspMOT: A Benchmark for Long-Term Multi-Object Tracking of Trichogramma Wasps](https://arxiv.org/abs/2607.08729) <a id="link10"></a>
**ArXiv ID:** 2607.08729
**Authors:** Tomasz Stanczyk, Yuan Gao, Hardik Agarwal, Seongroo Yoon, Tiantao Zhang, Vincent Calcagno, Francois Bremond
...
**Comment:** Matches criterion 3 very closely: it builds a new benchmark for long-term multi-object tracking, emphasizing identity preservation over long horizons, which is a novel evaluation angle often ignored by prior work.
**Relevance:** 5
**Novelty:** 6

---

## 11. [Whareformer: Learning to Track What is Where in Long Egocentric Videos](https://arxiv.org/abs/2607.08537) <a id="link11"></a>
**ArXiv ID:** 2607.08537
**Authors:** Jacob Chalk, Saptarshi Sinha, Dima Damen, Yannis Kalantidis, Diane Larlus
...
**Comment:** Matches criterion 3: a new learning-based method for long egocentric video object tracking, a clear embodied perception problem with 'where/what' reasoning.
**Relevance:** 5
**Novelty:** 6

---

## 12. [Do Egocentric Video-Language Models Capture Both Hand- and Object-Centric Cues?](https://arxiv.org/abs/2607.08514) <a id="link12"></a>
**ArXiv ID:** 2607.08514
**Authors:** Masatoshi Tateno, Alexandros Stergiou, Risa Shinoda, Yoichi Sato, Dima Damen
...
**Comment:** Matches criterion 4 and partly 3: it studies egocentric video-language models and proposes cue-isolated evaluation plus hand/object-centric training for embodied understanding.
**Relevance:** 5
**Novelty:** 6

---

## 13. [A First-Principles Theory of Slow Thinking and Active Perception](https://arxiv.org/abs/2607.08196) <a id="link13"></a>
**ArXiv ID:** 2607.08196
**Authors:** Hongkang Yang, Zhi-Qin John Xu, Feiyu Xiong, Weinan E
...
**Comment:** Matches criterion 1 very loosely: it offers a theory of active perception/slow thinking, but it is primarily a theoretical paper rather than a concrete spatial-intelligence method.
**Relevance:** 3
**Novelty:** 8

---

## 14. [OmniFood-Bench: Evaluating VLMs for Nutrient Reasoning and Personalized Health Advice](https://arxiv.org/abs/2607.08423) <a id="link14"></a>
**ArXiv ID:** 2607.08423
**Authors:** Qian Jiang, Zhecheng Shi, Jingpu Yang, Zirui Song, Miao Fang
...
**Comment:** Matches criterion 2 and 4: a new VLM benchmark for nutrient reasoning and personalized health advice, with strong evaluation of model failures.
**Relevance:** 4
**Novelty:** 6

---

## 15. [HSA: Hierarchical Slot Attention for Multi-granularity Scene-Decomposition](https://arxiv.org/abs/2607.08249) <a id="link15"></a>
**ArXiv ID:** 2607.08249
**Authors:** Neelu Madan, Rongzhen Zhao, Andreas Mogelmose, Juho Kannala, Joni Pajarinen, Graham W. Taylor, Thomas B. Moeslund
...
**Comment:** Matches criterion 4 moderately well: vision representation learning for multi-granularity scene decomposition with slot attention, which is relevant to foundation-model-style visual understanding.
**Relevance:** 3
**Novelty:** 6

---

## 16. [SkelGen4D: Weakly-Supervised Skeleton-Based 4D Generation for Text-Driven Mesh Animation](https://arxiv.org/abs/2607.08246) <a id="link16"></a>
**ArXiv ID:** 2607.08246
**Authors:** Hao Feng, Zhi Zuo, Jia-Hui Pan, Ka-Hei Hui, Zhengzhe Liu, Dian Zhang, Haoran Xie, Bin Sheng, Jingyu Hu
...
**Comment:** Matches criterion 4 only loosely: it is a generative 4D content creation method, but it is not specifically about vision foundation models or embodied spatial intelligence.
**Relevance:** 3
**Novelty:** 6

---

## 17. [Dual-Correlation Hypergraph Network for Unaligned RGBT Video Object Detection and A Large-scale Benchmark](https://arxiv.org/abs/2607.08191) <a id="link17"></a>
**ArXiv ID:** 2607.08191
**Authors:** Qishun Wang, Yapeng Li, Bin Luo, Zhengzheng Tu, Chenglong Li
...
**Comment:** Matches criterion 3 only loosely: it adds a new benchmark and method for RGB-T video object detection, but this is not strongly embodied AI.
**Relevance:** 3
**Novelty:** 5

---

## 18. [Mixture of Enhanced-View Experts for Multi-Query Vehicle ReID and A Large-Scale Benchmark](https://arxiv.org/abs/2607.08085) <a id="link18"></a>
**ArXiv ID:** 2607.08085
**Authors:** Aihua Zheng, Jie Zhen, Chenglong Li, Jiaxiang Wang, Jin Tang
...
**Comment:** Matches criterion 3 only loosely: it introduces a new large-scale benchmark for multi-query vehicle ReID, which is vision-centric but not embodied AI.
**Relevance:** 3
**Novelty:** 5
