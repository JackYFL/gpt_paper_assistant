...
0. [TagaVLM: Topology-Aware Global Action Reasoning for Vision-Language Navigation](#link0)
**Authors:** Jiaxing Liu, Zexi Zhang, Xiaoyan Li, Boyue Wang, Yongli Hu, Baocai Yin

1. [CARE: Towards Clinical Accountability in Multi-Modal Medical Reasoning with an Evidence-Grounded Agentic Framework](#link1)
**Authors:** Yuexi Du, Jinglu Wang, Shujie Liu, Nicha C. Dvornek, Yan Lu

2. [Think-as-You-See: Streaming Chain-of-Thought Reasoning for Large Vision-Language Models](#link2)
**Authors:** Jialiang Zhang, Junlong Tong, Junyan Lin, Hao Wu, Yirong Sun, Yunpu Ma, Xiaoyu Shen

3. [Utonia: Toward One Encoder for All Point Clouds](#link3)
**Authors:** Yujia Zhang, Xiaoyang Wu, Yunhan Yang, Xianzhe Fan, Han Li, Yuechen Zhang, Zehao Huang, Naiyan Wang, Hengshuang Zhao

4. [Beyond Language Modeling: An Exploration of Multimodal Pretraining](#link4)
...
5. [EmCoop: A Framework and Benchmark for Embodied Cooperation Among LLM Agents](#link5)
**Authors:** Hanqing Yang, Shiyu Chen, Narjes Nourzad, Marie Siew, Jingdi Chen, Carlee Joe-Wong

6. [EIMC: Efficient Instance-aware Multi-modal Collaborative Perception](#link6)
**Authors:** Kang Yang, Peng Wang, Lantao Li, Tianci Bu, Chen Sun, Deying Li, Yongcai Wang

7. [The Dresden Dataset for 4D Reconstruction of Non-Rigid Abdominal Surgical Scenes](#link7)
**Authors:** Reuben Docea, Rayan Younis, Yonghao Long, Maxime Fleury, Jinjing Xu, Chenyang Li, Andr\'e Schulze, Ann Wierick, Johannes Bender, Micha Pfeiffer, Qi Dou, Martin Wagner, Stefanie Speidel

8. [LOGIGEN: Logic-Driven Generation of Verifiable Agentic Tasks](#link8)
...
9. [According to Me: Long-Term Personalized Referential Memory QA](#link9)
**Authors:** Jingbiao Mei, Jinghong Chen, Guangyu Yang, Xinyu Hou, Margaret Li, Bill Byrne

10. [CAPT: Confusion-Aware Prompt Tuning for Reducing Vision-Language Misalignment](#link10)
**Authors:** Maoyuan Shao, Yutong Gao, Xinyang Huang, Chuang Zhu, Lijuan Sun, Guoshun Nan

11. [Securing the Floor and Raising the Ceiling: A Merging-based Paradigm for Multi-modal Search Agents](#link11)
**Authors:** Zhixiang Wang, Jingxuan Xu, Dajun Chen, Yunfang Wu, Wei Jiang, Yong Li

12. [GloPath: An Entity-Centric Foundation Model for Glomerular Lesion Assessment and Clinicopathological Insights](#link12)
...
13. [How Well Do Multimodal Models Reason on ECG Signals?](#link13)
...
14. [Fair in Mind, Fair in Action? A Synchronous Benchmark for Understanding and Generation in UMLLMs](#link14)
**Authors:** Yiran Zhao, Lu Zhou, Xiaogang Xu, Zhe Liu, Jiafei Wu, Liming Fang

15. [Learning Structured Reasoning via Tractable Trajectory Control](#link15)
...
16. [Gated Differential Linear Attention: A Linear-Time Decoder for High-Fidelity Medical Segmentation](#link16)
**Authors:** Hongbo Zheng, Afshin Bozorgpour, Dorit Merhof, Minjia Zhang

17. [ProtRLSearch: A Multi-Round Multimodal Protein Search Agent with Large Language Models Trained via Reinforcement Learning](#link17)
**Authors:** Congying Liu, Taihao Li, Ming Huang, Xingyuan Wei, Peipei Liu, Yiqing Shen, Yanxu Mao, Tiehan Cui

18. [ATD: Improved Transformer with Adaptive Token Dictionary for Image Restoration](#link18)
**Authors:** Leheng Zhang, Wei Long, Yawei Li, Xingyu Zhou, Xiaorui Zhao, Shuhang Gu

19. [ModalPatch: A Plug-and-Play Module for Robust Multi-Modal 3D Object Detection under Modality Drop](#link19)
**Authors:** Shuangzhi Li, Lei Ma, Xingyu Li

20. [Beyond Prompt Degradation: Prototype-guided Dual-pool Prompting for Incremental Object Detection](#link20)
**Authors:** Yaoteng Zhang, Zhou Qing, Junyu Gao, Qi Wang

21. [Semantic XPath: Structured Agentic Memory Access for Conversational AI](#link21)
**Authors:** Yifan Simon Liu, Ruifan Wu, Liam Gallagher, Jiazhou Liang, Armin Toroghi, Scott Sanner

22. [BRIGHT: A Collaborative Generalist-Specialist Foundation Model for Breast Pathology](#link22)
...
24. [Kling-MotionControl Technical Report](#link24)
...
25. [Multimodal Mixture-of-Experts with Retrieval Augmentation for Protein Active Site Identification](#link25)
**Authors:** Jiayang Wu, Jiale Zhou, Xingyi Zhang, Xun Lin, Tianxu Lv, Leong Hou U, Rubo Wang, Yefeng Zheng

26. [Heterophily-Agnostic Hypergraph Neural Networks with Riemannian Local Exchanger](#link26)
**Authors:** Li Sun, Ming Zhang, Wenxin Jin, Zhongtian Sun, Zhenhao Huang, Hao Peng, Sen Su, Philip Yu

27. [Beyond Length Scaling: Synergizing Breadth and Depth for Generative Reward Models](#link27)
**Authors:** Qiyuan Zhang, Yufei Wang, Tianhe Wu, Can Xu, Qingfeng Sun, Kai Zheng, Xue Liu, Chen Ma

28. [CFG-Ctrl: Control-Based Classifier-Free Diffusion Guidance](#link28)
**Authors:** Hanyang Wang, Yiyang Liu, Jiawei Chi, Fangfu Liu, Ran Xue, Yueqi Duan

29. [DIG to Heal: Scaling General-purpose Agent Collaboration via Explainable Dynamic Decision Paths](#link29)
**Authors:** Hanqing Yang, Hyungwoo Lee, Yuhang Yao, Zhiwei Liu, Kay Liu, Jingdi Chen, Carlee Joe-Wong

30. [What Papers Don't Tell You: Recovering Tacit Knowledge for Automated Paper Reproduction](#link30)
...
31. [TenExp: Mixture-of-Experts-Based Tensor Decomposition Structure Search Framework](#link31)
**Authors:** Ting-Wei Zhou, Xi-Le Zhao, Sheng Liu, Wei-Hao Wu, Yu-Bang Zheng, Deyu Meng

32. [FT-Dojo: Towards Autonomous LLM Fine-Tuning with Language Agents](#link32)
**Authors:** Qizheng Li, Yifei Zhang, Xiao Yang, Xu Yang, Zhuo Wang, Weiqing Liu, Jiang Bian

33. [Words & Weights: Streamlining Multi-Turn Interactions via Co-Adaptation](#link33)
**Authors:** Chenxing Wei, Hong Wang, Ying He, Zhongxiang Dai, Bo Jiang, F. Richard Yu, Yao Shu

---
## 0. [TagaVLM: Topology-Aware Global Action Reasoning for Vision-Language Navigation](https://arxiv.org/abs/2603.02972) <a id="link0"></a>
**ArXiv ID:** 2603.02972
**Authors:** Jiaxing Liu, Zexi Zhang, Xiaoyan Li, Boyue Wang, Yongli Hu, Baocai Yin
...
**Comment:** Matches criterion 1 (methodological improvements to spatial understanding on embodied agents), criterion 2 (VLLMs), and criterion 3 (new method for embodied AI navigation). Proposes TagaVLM, a topology-aware VLM for vision-language navigation with explicit spatial reasoning, and demonstrates strong empirical results.
**Relevance:** 10
**Novelty:** 8

---

## 1. [CARE: Towards Clinical Accountability in Multi-Modal Medical Reasoning with an Evidence-Grounded Agentic Framework](https://arxiv.org/abs/2603.01607) <a id="link1"></a>
**ArXiv ID:** 2603.01607
**Authors:** Yuexi Du, Jinglu Wang, Shujie Liu, Nicha C. Dvornek, Yan Lu
...
**Comment:** Matches criterion 2 (new VLLM for medical reasoning with explicit evidence-grounded agentic framework) and criterion 3 (novel method for multi-modal medical reasoning with modular, agentic workflow emulating clinical practice).
**Relevance:** 10
**Novelty:** 8

---

## 2. [Think-as-You-See: Streaming Chain-of-Thought Reasoning for Large Vision-Language Models](https://arxiv.org/abs/2603.02872) <a id="link2"></a>
**ArXiv ID:** 2603.02872
**Authors:** Jialiang Zhang, Junlong Tong, Junyan Lin, Hao Wu, Yirong Sun, Yunpu Ma, Xiaoyu Shen
...
**Comment:** Matches criterion 2 (new VLLMs) and criterion 3 (novel method for streaming reasoning in LVLMs, addressing real-world video stream alignment, which is a previously underexplored angle). Also relevant to criterion 1 (spatial/temporal intelligence in embodied agents) due to focus on video understanding and reasoning.
**Relevance:** 10
**Novelty:** 8

---

## 3. [Utonia: Toward One Encoder for All Point Clouds](https://arxiv.org/abs/2603.03283) <a id="link3"></a>
**ArXiv ID:** 2603.03283
**Authors:** Yujia Zhang, Xiaoyang Wu, Yunhan Yang, Xianzhe Fan, Han Li, Yuechen Zhang, Zehao Huang, Naiyan Wang, Hengshuang Zhao
...
**Comment:** Matches criterion 1 and 4: Presents a universal point cloud encoder (Utonia) that benefits spatial understanding and embodied/multimodal reasoning, with applications in robotics and AR/VR. Also relevant to vision foundation models for 3D data.
**Relevance:** 10
**Novelty:** 8

---

## 4. [Beyond Language Modeling: An Exploration of Multimodal Pretraining](https://arxiv.org/abs/2603.03276) <a id="link4"></a>
**ArXiv ID:** 2603.03276
**Authors:** Shengbang Tong, David Fan, John Nguyen, Ellis Brown, Gaoyue Zhou, Shengyi Qian, Boyang Zheng, Th\'eophane Vallaeys, Junlin Han, Rob Fergus, Naila Murray, Marjan Ghazvininejad, Mike Lewis, Nicolas Ballas, Amir Bar, Michael Rabbat, Jakob Verbeek, Luke Zettlemoyer, Koustuv Sinha, Yann LeCun, Saining Xie
...
**Comment:** Matches criterion 2 and 4: Explores multimodal pretraining for foundation models, with empirical insights into unified vision-language models and scaling. Strongly relevant to VLLMs/MLLMs and vision foundation models.
**Relevance:** 10
**Novelty:** 8

---

## 5. [EmCoop: A Framework and Benchmark for Embodied Cooperation Among LLM Agents](https://arxiv.org/abs/2603.00349) <a id="link5"></a>
**ArXiv ID:** 2603.00349
**Authors:** Hanqing Yang, Shiyu Chen, Narjes Nourzad, Marie Siew, Jingdi Chen, Carlee Joe-Wong
...
**Comment:** Strongly matches criterion 3 (embodied AI benchmark for multi-agent cooperation, with new process-level metrics and analysis of cooperation dynamics). Introduces EmCoop, a new benchmark and framework for embodied multi-agent LLM systems.
**Relevance:** 10
**Novelty:** 8

---

## 6. [EIMC: Efficient Instance-aware Multi-modal Collaborative Perception](https://arxiv.org/abs/2603.02532) <a id="link6"></a>
**ArXiv ID:** 2603.02532
**Authors:** Kang Yang, Peng Wang, Lantao Li, Tianci Bu, Chen Sun, Deying Li, Yongcai Wang
...
**Comment:** Matches criterion 1 (methodological improvement to spatial intelligence in embodied agents via collaborative multi-modal perception for autonomous driving) and criterion 3 (novel method for collaborative perception with efficient communication and instance-aware fusion).
**Relevance:** 9
**Novelty:** 7

---

## 7. [The Dresden Dataset for 4D Reconstruction of Non-Rigid Abdominal Surgical Scenes](https://arxiv.org/abs/2603.02985) <a id="link7"></a>
**ArXiv ID:** 2603.02985
**Authors:** Reuben Docea, Rayan Younis, Yonghao Long, Maxime Fleury, Jinjing Xu, Chenyang Li, Andr\'e Schulze, Ann Wierick, Johannes Bender, Micha Pfeiffer, Qi Dou, Martin Wagner, Stefanie Speidel
...
**Comment:** Matches criterion 3 (new benchmark for embodied AI, specifically for 4D reconstruction and non-rigid SLAM in surgical scenes, with a comprehensive dataset and evaluation protocol).
**Relevance:** 9
**Novelty:** 7

---

## 8. [LOGIGEN: Logic-Driven Generation of Verifiable Agentic Tasks](https://arxiv.org/abs/2603.00540) <a id="link8"></a>
**ArXiv ID:** 2603.00540
**Authors:** Yucheng Zeng, Weipeng Lu, Linyun Liu, Shupeng Li, Zitian Qu, Chenghao Zhu, Shaofei Li, Zhengdong Tan, Mengyue Liu, Haotian Zhao, Zhe Zhou, Jianmin Wu
...
**Comment:** Matches criterion 3 (new method for embodied/agentic AI with logic-driven data synthesis and verification-based training). Introduces LOGIGEN, a framework for generating verifiable agentic tasks and a new training protocol for LLM agents.
**Relevance:** 8
**Novelty:** 7

---

## 9. [According to Me: Long-Term Personalized Referential Memory QA](https://arxiv.org/abs/2603.01990) <a id="link9"></a>
**ArXiv ID:** 2603.01990
**Authors:** Jingbiao Mei, Jinghong Chen, Guangyu Yang, Xinyu Hou, Margaret Li, Bill Byrne
...
**Comment:** Matches criterion 2 (new MLLMs/VLLMs) and criterion 3 (new benchmark for multi-modal, personalized referential memory QA). Introduces ATM-Bench, a new benchmark for multi-modal, multi-source personalized memory QA, and proposes a new schema-guided memory representation.
**Relevance:** 8
**Novelty:** 7

---

## 10. [CAPT: Confusion-Aware Prompt Tuning for Reducing Vision-Language Misalignment](https://arxiv.org/abs/2603.02557) <a id="link10"></a>
**ArXiv ID:** 2603.02557
**Authors:** Maoyuan Shao, Yutong Gao, Xinyang Huang, Chuang Zhu, Lijuan Sun, Guoshun Nan
...
**Comment:** Matches criterion 4: Proposes a confusion-aware prompt tuning method for vision-language models (like CLIP), improving fine-grained discriminability and reducing misalignment. Strong application to vision foundation models.
**Relevance:** 8
**Novelty:** 7

---

## 11. [Securing the Floor and Raising the Ceiling: A Merging-based Paradigm for Multi-modal Search Agents](https://arxiv.org/abs/2603.01416) <a id="link11"></a>
**ArXiv ID:** 2603.01416
**Authors:** Zhixiang Wang, Jingxuan Xu, Dajun Chen, Yunfang Wu, Wei Jiang, Yong Li
...
**Comment:** Matches criterion 2: Shows a new method for empowering VLMs (vision-language models) with multi-modal search agent capabilities via model merging. Also relevant to criterion 4 as it discusses VLMs and their applications.
**Relevance:** 8
**Novelty:** 7

---

## 12. [GloPath: An Entity-Centric Foundation Model for Glomerular Lesion Assessment and Clinicopathological Insights](https://arxiv.org/abs/2603.02926) <a id="link12"></a>
**ArXiv ID:** 2603.02926
**Authors:** Qiming He, Jing Li, Tian Guan, Yifei Ma, Zimo Zhao, Yanxia Wang, Hongjing Chen, Yingming Xu, Shuang Ge, Yexing Zhang, Yizhi Wang, Xinrui Chen, Lianghui Zhu, Yiqing Liu, Qingxia Hou, Shuyan Zhao, Xiaoqin Wang, Lili Ma, Peizhen Hu, Qiang Huang, Zihan Wang, Zhiyuan Shen, Junru Cheng, Siqi Zeng, Jiurun Chen, Zhen Song, Chao He, Zhe Wang, Yonghong He
...
**Comment:** Matches criterion 4: Vision foundation models and their application to medical pathology. GloPath is a foundation model for glomerular lesion assessment, showing strong empirical results and clinical insights.
**Relevance:** 8
**Novelty:** 7

---

## 13. [How Well Do Multimodal Models Reason on ECG Signals?](https://arxiv.org/abs/2603.00312) <a id="link13"></a>
**ArXiv ID:** 2603.00312
**Authors:** Maxwell A. Xu, Harish Haresumadram, Catherine W. Liu, Patrick Langer, Jathurshan Pradeepkumar, Wanting Mao, Sunita J. Ferns, Aradhana Verma, Jimeng Sun, Paul Schmiedmayer, Xin Liu, Daniel McDuff, Emily B. Fox, James M. Rehg
...
**Comment:** Matches criterion 2 (evaluation of reasoning in multimodal LLMs, specifically on ECG signals). Proposes a dual-verification framework for reasoning in VLLMs/MLLMs, with a focus on perception and deduction.
**Relevance:** 8
**Novelty:** 7

---

## 14. [Fair in Mind, Fair in Action? A Synchronous Benchmark for Understanding and Generation in UMLLMs](https://arxiv.org/abs/2603.00590) <a id="link14"></a>
**ArXiv ID:** 2603.00590
**Authors:** Yiran Zhao, Lu Zhou, Xiaogang Xu, Zhe Liu, Jiafei Wu, Liming Fang
...
**Comment:** Matches criterion 2 (new benchmark for unified multimodal LLMs, i.e., VLLMs/MLLMs) and is relevant to vision-language models, focusing on fairness evaluation. Introduces the IRIS benchmark for understanding and generation in UMLLMs.
**Relevance:** 8
**Novelty:** 7

---

## 15. [Learning Structured Reasoning via Tractable Trajectory Control](https://arxiv.org/abs/2603.01641) <a id="link15"></a>
**ArXiv ID:** 2603.01641
**Authors:** Po-Nien Kung, Zhen Yang, Jeffrey Luo, Cheng-Fu Yang, Haikang Deng, Zi-Yi Dou, Yinfei Yang, Nanyun Peng, Zhe Gan, Kai-Wei Chang
...
**Comment:** Matches criterion 2 (shows new methods for vision-language models) and criterion 1 (methodological improvements to structured reasoning, including vision-language models). The paper proposes a new framework (Ctrl-R) for structured reasoning in LLMs and VLLMs, with empirical results on mathematical reasoning tasks.
**Relevance:** 8
**Novelty:** 7

---

## 16. [Gated Differential Linear Attention: A Linear-Time Decoder for High-Fidelity Medical Segmentation](https://arxiv.org/abs/2603.02727) <a id="link16"></a>
**ArXiv ID:** 2603.02727
**Authors:** Hongbo Zheng, Afshin Bozorgpour, Dorit Merhof, Minjia Zhang
...
**Comment:** Matches criterion 4 (vision foundation models and efficient transformer-based segmentation for medical images, with a novel linear attention mechanism).
**Relevance:** 7
**Novelty:** 7

---

## 17. [ProtRLSearch: A Multi-Round Multimodal Protein Search Agent with Large Language Models Trained via Reinforcement Learning](https://arxiv.org/abs/2603.01464) <a id="link17"></a>
**ArXiv ID:** 2603.01464
**Authors:** Congying Liu, Taihao Li, Ming Huang, Xingyuan Wei, Peipei Liu, Yiqing Shen, Yanxu Mao, Tiehan Cui
...
**Comment:** Matches criterion 2: Introduces a multi-modal protein search agent using LLMs trained via RL, integrating protein sequence and text. Also builds a new benchmark (ProtMCQs), which is relevant to criterion 3 (embodied AI benchmarks, though in a bio domain).
**Relevance:** 7
**Novelty:** 7

---

## 18. [ATD: Improved Transformer with Adaptive Token Dictionary for Image Restoration](https://arxiv.org/abs/2603.02581) <a id="link18"></a>
**ArXiv ID:** 2603.02581
**Authors:** Leheng Zhang, Wei Long, Yawei Li, Xingyu Zhou, Xiaorui Zhao, Shuhang Gu
...
**Comment:** Matches criterion 4 (vision foundation models and applications), proposing a new transformer architecture for image restoration with an adaptive token dictionary and cross-attention mechanism.
**Relevance:** 7
**Novelty:** 7

---

## 19. [ModalPatch: A Plug-and-Play Module for Robust Multi-Modal 3D Object Detection under Modality Drop](https://arxiv.org/abs/2603.02481) <a id="link19"></a>
**ArXiv ID:** 2603.02481
**Authors:** Shuangzhi Li, Lei Ma, Xingyu Li
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and is relevant to multi-modal 3D object detection, with a novel plug-and-play module for robustness under modality drop. Uses uncertainty-guided cross-modality fusion.
**Relevance:** 7
**Novelty:** 7

---

## 20. [Beyond Prompt Degradation: Prototype-guided Dual-pool Prompting for Incremental Object Detection](https://arxiv.org/abs/2603.02286) <a id="link20"></a>
**ArXiv ID:** 2603.02286
**Authors:** Yaoteng Zhang, Zhou Qing, Junyu Gao, Qi Wang
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and is relevant to continual learning in object detection with prompt-based methods. Introduces a novel dual-pool prompt decoupling paradigm and prototypical pseudo-label generation.
**Relevance:** 7
**Novelty:** 7

---

## 21. [Semantic XPath: Structured Agentic Memory Access for Conversational AI](https://arxiv.org/abs/2603.01160) <a id="link21"></a>
**ArXiv ID:** 2603.01160
**Authors:** Yifan Simon Liu, Ruifan Wu, Liam Gallagher, Jiazhou Liang, Armin Toroghi, Scott Sanner
...
**Comment:** Matches criterion 3 (new method for structured agentic memory access in conversational AI). Proposes Semantic XPath, a tree-structured memory module for conversational agents, improving efficiency and performance over flat memory approaches.
**Relevance:** 7
**Novelty:** 6

---

## 22. [BRIGHT: A Collaborative Generalist-Specialist Foundation Model for Breast Pathology](https://arxiv.org/abs/2603.03030) <a id="link22"></a>
**ArXiv ID:** 2603.03030
**Authors:** Xiaojing Guo, Jiatai Lin, Yumian Jia, Jingqi Huang, Zeyan Xu, Weidong Li, Longfei Wang, Jingjing Chen, Qin Li, Weiwei Wang, Lifang Cui, Wen Yue, Zhiqiang Cheng, Xiaolong Wei, Jianzhong Yu, Xia Jin, Baizhou Li, Honghong Shen, Jing Li, Chunlan Li, Yanfen Cui, Yi Dai, Yiling Yang, Xiaolong Qian, Liu Yang, Yang Yang, Guangshen Gao, Yaqing Li, Lili Zhai, Chenying Liu, Tianhua Zhang, Zhenwei Shi, Cheng Lu, Xingchen Zhou, Jing Xu, Miaoqing Zhao, Fang Mei, Jiaojiao Zhou, Ning Mao, Fangfang Liu, Chu Han, Zaiyi Liu
...
**Comment:** Matches criterion 4 (vision foundation models and their application to pathology, with a collaborative generalist-specialist paradigm for breast pathology).
**Relevance:** 7
**Novelty:** 6
...
**Comment:** Matches criterion 4 (vision foundation models and their application to anomaly detection, with a novel synthesis pipeline and wavelet-domain attention module).
**Relevance:** 7
**Novelty:** 6

---

## 24. [Kling-MotionControl Technical Report](https://arxiv.org/abs/2603.03160) <a id="link24"></a>
**ArXiv ID:** 2603.03160
**Authors:** Kling Team, Jialu Chen, Yikang Ding, Zhixue Fang, Kun Gai, Kang He, Xu He, Jingyun Hua, Mingming Lao, Xiaohan Li, Hui Liu, Jiwen Liu, Xiaoqiang Liu, Fan Shi, Xiaoyu Shi, Peiqin Sun, Songlin Tang, Pengfei Wan, Tiancheng Wen, Zhiyong Wu, Haoxian Zhang, Runze Zhao, Yuanxing Zhang, Yan Zhou
...
**Comment:** Relevant to criterion 4 (vision foundation models and applications) and generative modeling for character animation, but does not directly address spatial intelligence or embodied AI benchmarks. Focuses on generative models for motion control and animation.
**Relevance:** 5
**Novelty:** 6

---

## 25. [Multimodal Mixture-of-Experts with Retrieval Augmentation for Protein Active Site Identification](https://arxiv.org/abs/2603.01511) <a id="link25"></a>
**ArXiv ID:** 2603.01511
**Authors:** Jiayang Wu, Jiale Zhou, Xingyi Zhang, Xun Lin, Tianxu Lv, Leong Hou U, Rubo Wang, Yefeng Zheng
...
**Comment:** Relevant to multi-modal learning and mixture-of-experts, but focused on protein active site identification. Does not directly match any criterion, but uses clever statistical tricks (Dempster-Shafer theory) for modality reliability.
**Relevance:** 4
**Novelty:** 6

---

## 26. [Heterophily-Agnostic Hypergraph Neural Networks with Riemannian Local Exchanger](https://arxiv.org/abs/2603.00599) <a id="link26"></a>
**ArXiv ID:** 2603.00599
**Authors:** Li Sun, Ming Zhang, Wenxin Jin, Zhongtian Sun, Zhenhao Huang, Hao Peng, Sen Su, Philip Yu
...
**Comment:** Relevant to general machine learning and graph neural networks, but does not directly match any of the four criteria (focuses on hypergraph neural networks, not specifically spatial intelligence, VLLMs, embodied AI, or vision foundation models).
**Relevance:** 3
**Novelty:** 6

---

## 27. [Beyond Length Scaling: Synergizing Breadth and Depth for Generative Reward Models](https://arxiv.org/abs/2603.01571) <a id="link27"></a>
**ArXiv ID:** 2603.01571
**Authors:** Qiyuan Zhang, Yufei Wang, Tianhe Wu, Can Xu, Qingfeng Sun, Kai Zheng, Xue Liu, Chen Ma
...
**Comment:** Relevant to generative modeling and reasoning, but does not directly match any of the four criteria (focuses on reward models and chain-of-thought reasoning, not specifically vision or multi-modal models).
**Relevance:** 3
**Novelty:** 6

---

## 28. [CFG-Ctrl: Control-Based Classifier-Free Diffusion Guidance](https://arxiv.org/abs/2603.03281) <a id="link28"></a>
**ArXiv ID:** 2603.03281
**Authors:** Hanyang Wang, Yiyang Liu, Jiawei Chi, Fangfu Liu, Ran Xue, Yueqi Duan
...
**Comment:** Related to generative modeling and diffusion models, but not directly about spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models. Focuses on classifier-free guidance improvements.
**Relevance:** 3
**Novelty:** 6

---

## 29. [DIG to Heal: Scaling General-purpose Agent Collaboration via Explainable Dynamic Decision Paths](https://arxiv.org/abs/2603.00309) <a id="link29"></a>
**ArXiv ID:** 2603.00309
**Authors:** Hanqing Yang, Hyungwoo Lee, Yuhang Yao, Zhiwei Liu, Kay Liu, Jingdi Chen, Carlee Joe-Wong
...
**Comment:** Related to agentic AI and multi-agent LLM collaboration, but not specifically about spatial intelligence, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models. Interesting for agent-based systems, but not a direct match.
**Relevance:** 3
**Novelty:** 6

---

## 30. [What Papers Don't Tell You: Recovering Tacit Knowledge for Automated Paper Reproduction](https://arxiv.org/abs/2603.01801) <a id="link30"></a>
**ArXiv ID:** 2603.01801
**Authors:** Lehui Li, Ruining Wang, Haochen Song, Yaoxin Mao, Tong Zhang, Yuyao Wang, Jiayi Fan, Yitong Zhang, Jieping Ye, Chengqi Zhang, Yongshun Gong
...
**Comment:** Does not directly match any of the four criteria. Focuses on automated paper reproduction and tacit knowledge extraction, which is interesting for ML reproducibility but not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 31. [TenExp: Mixture-of-Experts-Based Tensor Decomposition Structure Search Framework](https://arxiv.org/abs/2603.02720) <a id="link31"></a>
**ArXiv ID:** 2603.02720
**Authors:** Ting-Wei Zhou, Xi-Le Zhao, Sheng Liu, Wei-Hao Wu, Yu-Bang Zheng, Deyu Meng
...
**Comment:** Relevant to mixture-of-experts and tensor decomposition, but not directly to spatial intelligence, VLLMs, embodied AI, or vision foundation models. More of a general ML methods paper.
**Relevance:** 3
**Novelty:** 6

---

## 32. [FT-Dojo: Towards Autonomous LLM Fine-Tuning with Language Agents](https://arxiv.org/abs/2603.01712) <a id="link32"></a>
**ArXiv ID:** 2603.01712
**Authors:** Qizheng Li, Yifei Zhang, Xiao Yang, Xu Yang, Zhuo Wang, Weiqing Liu, Jiang Bian
...
**Comment:** Relevant to LLMs and autonomous fine-tuning, but not directly about spatial intelligence, VLLMs, embodied AI, or vision foundation models. Interesting for autonomous ML, but not a direct match.
**Relevance:** 3
**Novelty:** 6

---

## 33. [Words & Weights: Streamlining Multi-Turn Interactions via Co-Adaptation](https://arxiv.org/abs/2603.01375) <a id="link33"></a>
**ArXiv ID:** 2603.01375
**Authors:** Chenxing Wei, Hong Wang, Ying He, Zhongxiang Dai, Bo Jiang, F. Richard Yu, Yao Shu
...
**Comment:** Focuses on multi-turn LLM adaptation, not directly on spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models. Interesting for LLM optimization, but not a direct match.
**Relevance:** 3
**Novelty:** 5
