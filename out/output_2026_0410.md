...
0. [Small Vision-Language Models are Smart Compressors for Long Video Understanding](#link0)
...
1. [LAMP: Lift Image-Editing as General 3D Priors for Open-world Manipulation](#link1)
**Authors:** Jingjing Wang, Zhengdong Hong, Chong Bao, Yuke Zhu, Junhan Sun, Guofeng Zhang

2. [HY-Embodied-0.5: Embodied Foundation Models for Real-World Agents](#link2)
...
3. [BLaDA: Bridging Language to Functional Dexterous Actions within 3DGS Fields](#link3)
**Authors:** Fan Yang, Wenrui Chen, Guorun Yan, Ruize Liao, Wanjun Jia, Dongsheng Luo, Kailun Yang, Zhiyong Li, Yaonan Wang

4. [InstAP: Instance-Aware Vision-Language Pre-Train for Spatial-Temporal Understanding](#link4)
**Authors:** Ashutosh Kumar, Rajat Saini, Jingjing Pan, Mustafa Erdogan, Mingfang Zhang, Betty Le Dem, Norimasa Kobori, Quan Kong

5. [EVGeoQA: Benchmarking LLMs on Dynamic, Multi-Objective Geo-Spatial Exploration](#link5)
**Authors:** Jianfei Wu, Zhichun Wang, Zhensheng Wang, Zhiyu He

6. [Seeing but Not Thinking: Routing Distraction in Multimodal Mixture-of-Experts](#link6)
...
7. [MotionScape: A Large-Scale Real-World Highly Dynamic UAV Video Dataset for World Models](#link7)
**Authors:** Zile Guo, Zhan Chen, Enze Zhu, Kan Wei, Yongkang Zou, Xiaoxuan Liu, Lei Wang

8. [Bridging Time and Space: Decoupled Spatio-Temporal Alignment for Video Grounding](#link8)
**Authors:** Xuezhen Tu, Jingyu Wu, Fangyu Kang, Qingpeng Nong, Kaijin Zhang, Chaoyue Niu, Fan Wu

9. [MolmoWeb: Open Visual Web Agent and Open Data for the Open Web](#link9)
...
10. [Lighting-grounded Video Generation with Renderer-based Agent Reasoning](#link10)
**Authors:** Ziqi Cai, Taoyu Yang, Zheng Chang, Si Li, Han Jiang, Shuchen Weng, Boxin Shi

11. [LPM 1.0: Video-based Character Performance Model](#link11)
**Authors:** Ailing Zeng (R), Casper Yang (R), Chauncey Ge (R), Eddie Zhang (R), Garvey Xu (R), Gavin Lin (R), Gilbert Gu (R), Jeremy Pi (R), Leo Li (R), Mingyi Shi (R), Sheng Bi (R), Steven Tang (R), Thorn Hang (R), Tobey Guo (R), Vincent Li (R), Xin Tong (R), Yikang Li (R), Yuchen Sun (R), Yue (R), Zhao, Yuhan Lu, Yuwei Li, Zane Zhang, Zeshi Yang, Zi Ye

12. [Tarot-SAM3: Training-free SAM3 for Any Referring Expression Segmentation](#link12)
**Authors:** Weiming Zhang, Dingwen Xiao, Songyue Guo, Guangyu Xiang, Shiqi Wen, Minwei Zhao, Lei Chen, Lin Wang

13. [RemoteAgent: Bridging Vague Human Intents and Earth Observation with RL-based Agentic MLLMs](#link13)
...
14. [MedVR: Annotation-Free Medical Visual Reasoning via Agentic Reinforcement Learning](#link14)
**Authors:** Zheng Jiang, Heng Guo, Chengyu Fang, Changchen Xiao, Xinyang Hu, Lifeng Sun, Minfeng Xu

15. [FORGE:Fine-grained Multimodal Evaluation for Manufacturing Scenarios](#link15)
...
16. [Mitigating Entangled Steering in Large Vision-Language Models for Hallucination Reduction](#link16)
**Authors:** Yuanhong Zhang, Zhaoyang Wang, Xin Zhang, Weizhan Zhang, Joey Tianyi Zhou

17. [Beyond Surface Artifacts: Capturing Shared Latent Forgery Knowledge Across Modalities](#link17)
**Authors:** Jingtong Dou, Chuancheng Shi, Jian Wang, Fei Shen, Zhiyong Wang, Tat-Seng Chua

18. [HAWK: Head Importance-Aware Visual Token Pruning in Multimodal Models](#link18)
...
19. [Brain3D: EEG-to-3D Decoding of Visual Representations via Multimodal Reasoning](#link19)
**Authors:** Emanuele Balloni, Emanuele Frontoni, Chiara Matti, Marina Paolanti, Roberto Pierdicca, Emiliano Santarnecchi

20. [VSAS-BENCH: Real-Time Evaluation of Visual Streaming Assistant Models](#link20)
...
21. [PanoSAM2: Lightweight Distortion- and Memory-aware Adaptions of SAM2 for 360 Video Object Segmentation](#link21)
**Authors:** Dingwen Xiao, Weiming Zhang, Shiqi Wen, Lin Wang

22. [Latent Anomaly Knowledge Excavation: Unveiling Sparse Sensitive Neurons in Vision-Language Models](#link22)
**Authors:** Shaotian Li, Shangze Li, Chuancheng Shi, Wenhua Wu, Yanqiu Wu, Xiaohan Yu, Fei Shen, Tat-Seng Chua

23. [When Numbers Speak: Aligning Textual Numerals and Visual Instances in Text-to-Video Diffusion Models](#link23)
**Authors:** Zhengyang Sun, Yu Chen, Xin Zhou, Xiaofan Li, Xiwu Chen, Dingkang Liang, Xiang Bai

24. [ImVideoEdit: Image-learning Video Editing via 2D Spatial Difference Attention Blocks](#link24)
**Authors:** Jiayang Xu, Fan Zhuo, Majun Zhang, Changhao Pan, Zehan Wang, Siyu Chen, Xiaoda Yang, Tao Jin, Zhou Zhao

25. [SurfelSplat: Learning Efficient and Generalizable Gaussian Surfel Representations for Sparse-View Surface Reconstruction](#link25)
**Authors:** Chensheng Dai, Shengjun Zhang, Min Chen, Yueqi Duan

26. [OmniJigsaw: Enhancing Omni-Modal Reasoning via Modality-Orchestrated Reordering](#link26)
**Authors:** Yiduo Jia, Muzhi Zhu, Hao Zhong, Mingyu Liu, Yuling Xi, Hao Chen, Bin Qin, Yongjie Yang, Zhenbo Luo, Chunhua Shen

27. [EditCaption: Human-Aligned Instruction Synthesis for Image Editing via Supervised Fine-Tuning and Direct Preference Optimization](#link27)
**Authors:** Xiangyuan Wang, Honghao Cai, Yunhao Bai, Tianze Zhou, Haohua Chen, Yao Hu, Xu Tang, Yibo Chen, Wei Zhu

28. [ReconPhys: Reconstruct Appearance and Physical Attributes from Single Video](#link28)
...
29. [EEG2Vision: A Multimodal EEG-Based Framework for 2D Visual Reconstruction in Cognitive Neuroscience](#link29)
**Authors:** Emanuele Balloni, Emanuele Frontoni, Chiara Matti, Marina Paolanti, Roberto Pierdicca, Emiliano Santarnecchi

30. [Steering the Verifiability of Multimodal AI Hallucinations](#link30)
**Authors:** Jianhong Pang, Ruoxi Cheng, Ziyi Ye, Xingjun Ma, Zuxuan Wu, Xuanjing Huang, Yu-Gang Jiang

31. [CAMotion: A High-Quality Benchmark for Camouflaged Moving Object Detection in the Wild](#link31)
**Authors:** Siyuan Yao, Hao Sun, Ruiqi Yu, Xiwei Jiang, Wenqi Ren, Xiaochun Cao

32. [Beyond Mamba: Enhancing State-space Models with Deformable Dilated Convolutions for Multi-scale Traffic Object Detection](#link32)
**Authors:** Jun Li, Yingying Shi, Zhixuan Ruan, Nan Guo, Jianhua Xu

33. [DBMF: A Dual-Branch Multimodal Framework for Out-of-Distribution Detection](#link33)
**Authors:** Jiangbei Yue, Sharib Ali

34. [AgriChain Visually Grounded Expert Verified Reasoning for Interpretable Agricultural Vision Language Models](#link34)
**Authors:** Hazza Mahmood, Yongqiang Yu, Rao Anwer

35. [Self-Improving 4D Perception via Self-Distillation](#link35)
**Authors:** Nan Huang, Pengcheng Yu, Weijia Zeng, James M. Rehg, Angjoo Kanazawa, Haiwen Feng, Qianqian Wang

36. [How Much LLM Does a Self-Revising Agent Actually Need?](#link36)
**Authors:** Sungwoo Jung, Seonil Son

37. [ETCH-X: Robustify Expressive Body Fitting to Clothed Humans with Composable Datasets](#link37)
**Authors:** Xiaoben Li, Jingyi Wu, Zeyu Cai, Yu Siyuan, Boqian Li, Yuliang Xiu

38. [Reinforcement-Guided Synthetic Data Generation for Privacy-Sensitive Identity Recognition](#link38)
**Authors:** Xuemei Jia, Jiawei Du, Hui Wei, Jun Chen, Joey Tianyi Zhou, Zheng Wang

39. [Rethinking Generalization in Reasoning SFT: A Conditional Analysis on Optimization, Data, and Model Capability](#link39)
**Authors:** Qihan Ren, Peng Wang, Ruikun Cai, Shuai Shao, Dadi Guo, Yuejin Xie, Yafu Li, Quanshi Zhang, Xia Hu, Jing Shao, Dongrui Liu

40. [On Emotion-Sensitive Decision Making of Small Language Model Agents](#link40)
**Authors:** Jiaju Lin, Xingjian Du, Qingyun Wu, Ellen Wenting Zou, Jindong Wang

41. [MSGL-Transformer: A Multi-Scale Global-Local Transformer for Rodent Social Behavior Recognition](#link41)
**Authors:** Muhammad Imran Sharif, Doina Caragea

---
## 0. [Small Vision-Language Models are Smart Compressors for Long Video Understanding](https://arxiv.org/abs/2604.08120) <a id="link0"></a>
**ArXiv ID:** 2604.08120
**Authors:** Junjie Fei, Jun Chen, Zechun Liu, Yunyang Xiong, Chong Zhou, Wei Wen, Junlin Han, Mingchen Zhuge, Saksham Suri, Qi Qian, Shuming Liu, Lemeng Wu, Raghuraman Krishnamoorthi, Vikas Chandra, Mohamed Elhoseiny, Chenchen Zhu
...
**Comment:** Matches criteria 2 (new VLLMs/MLLMs) and 4 (vision foundation models and applications). Proposes a new method (Tempo) using Small Vision-Language Models as temporal compressors for long video understanding, with strong empirical results and a clever token allocation strategy.
**Relevance:** 10
**Novelty:** 8

---

## 1. [LAMP: Lift Image-Editing as General 3D Priors for Open-world Manipulation](https://arxiv.org/abs/2604.08475) <a id="link1"></a>
**ArXiv ID:** 2604.08475
**Authors:** Jingjing Wang, Zhengdong Hong, Chong Bao, Yuke Zhu, Junhan Sun, Guofeng Zhang
...
**Comment:** Matches criterion 1 (spatial understanding for embodied agents) and criterion 3 (novel method for open-world manipulation in embodied AI). Proposes lifting image-editing as 3D priors for manipulation, focusing on geometry-aware representations for robotic agents.
**Relevance:** 10
**Novelty:** 8

---

## 2. [HY-Embodied-0.5: Embodied Foundation Models for Real-World Agents](https://arxiv.org/abs/2604.07430) <a id="link2"></a>
**ArXiv ID:** 2604.07430
**Authors:** Tencent Robotics X, HY Vision Team, :, Xumin Yu, Zuyan Liu, Ziyi Wang, He Zhang, Yongming Rao, Fangfu Liu, Yani Zhang, Ruowen Zhao, Oran Wang, Yves Liang, Haitao Lin, Minghui Wang, Yubo Dong, Kevin Cheng, Bolin Ni, Rui Huang, Han Hu, Zhengyou Zhang, Linus, Shunyu Yao
...
**Comment:** Matches criterion 1 (methodological improvements for spatial and temporal understanding in embodied agents), criterion 2 (new vision-language foundation models for embodied agents), and criterion 3 (new methods and benchmarks for embodied AI).
**Relevance:** 10
**Novelty:** 8

---

## 3. [BLaDA: Bridging Language to Functional Dexterous Actions within 3DGS Fields](https://arxiv.org/abs/2604.08410) <a id="link3"></a>
**ArXiv ID:** 2604.08410
**Authors:** Fan Yang, Wenrui Chen, Guorun Yan, Ruize Liao, Wanjun Jia, Dongsheng Luo, Kailun Yang, Zhiyong Li, Yaonan Wang
...
**Comment:** Matches criteria 1 (spatial intelligence on embodied agents) and 3 (embodied AI, new method for language-to-action grounding in 3D scenes). BLaDA proposes a novel, interpretable zero-shot framework for grounding language to dexterous actions in 3D Gaussian Splatting fields, with new modules for spatial reasoning and manipulation.
**Relevance:** 10
**Novelty:** 8

---

## 4. [InstAP: Instance-Aware Vision-Language Pre-Train for Spatial-Temporal Understanding](https://arxiv.org/abs/2604.08337) <a id="link4"></a>
**ArXiv ID:** 2604.08337
**Authors:** Ashutosh Kumar, Rajat Saini, Jingjing Pan, Mustafa Erdogan, Mingfang Zhang, Betty Le Dem, Norimasa Kobori, Quan Kong
...
**Comment:** Matches criteria 1 (new methodological improvements to spatial understanding on embodied agents) and 2 (new VLLMs/MLLMs). InstAP introduces instance-aware pretraining for spatial-temporal understanding, with a new dataset and method for fine-grained alignment, showing strong empirical results.
**Relevance:** 10
**Novelty:** 8

---

## 5. [EVGeoQA: Benchmarking LLMs on Dynamic, Multi-Objective Geo-Spatial Exploration](https://arxiv.org/abs/2604.07070) <a id="link5"></a>
**ArXiv ID:** 2604.07070
**Authors:** Jianfei Wu, Zhichun Wang, Zhensheng Wang, Zhiyu He
...
**Comment:** Matches criteria 3 (embodied AI, new benchmark/simulator). Presents EVGeoQA, a new benchmark for dynamic, multi-objective geo-spatial exploration, and a novel evaluation framework (GeoRover) for LLMs in spatial intelligence tasks.
**Relevance:** 9
**Novelty:** 8

---

## 6. [Seeing but Not Thinking: Routing Distraction in Multimodal Mixture-of-Experts](https://arxiv.org/abs/2604.08541) <a id="link6"></a>
**ArXiv ID:** 2604.08541
**Authors:** Haolei Xu, Haiwen Hong, Hongxing Li, Rui Zhou, Yang Zhang, Longtao Huang, Hui Xue, Yongliang Shen, Weiming Lu, Yueting Zhuang
...
**Comment:** Matches criterion 2 (new insights into VLLMs/MLLMs, specifically multimodal mixture-of-experts and their reasoning failures, with a novel routing-guided intervention).
**Relevance:** 9
**Novelty:** 8

---

## 7. [MotionScape: A Large-Scale Real-World Highly Dynamic UAV Video Dataset for World Models](https://arxiv.org/abs/2604.07991) <a id="link7"></a>
**ArXiv ID:** 2604.07991
**Authors:** Zile Guo, Zhan Chen, Enze Zhu, Kan Wei, Yongkang Zou, Xiaoxuan Liu, Lei Wang
...
**Comment:** Matches criterion 3 (new benchmark for embodied AI/simulators). Introduces a large-scale real-world UAV video dataset for world models, with semantic and geometric alignment for embodied intelligence.
**Relevance:** 9
**Novelty:** 8

---

## 8. [Bridging Time and Space: Decoupled Spatio-Temporal Alignment for Video Grounding](https://arxiv.org/abs/2604.08014) <a id="link8"></a>
**ArXiv ID:** 2604.08014
**Authors:** Xuezhen Tu, Jingyu Wu, Fangyu Kang, Qingpeng Nong, Kaijin Zhang, Chaoyue Niu, Fan Wu
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 2 (MLLMs for spatio-temporal video grounding). The paper proposes a novel decoupled spatio-temporal alignment framework for video grounding using MLLMs, with new modules for semantic bridging and spatial localization.
**Relevance:** 9
**Novelty:** 8

---

## 9. [MolmoWeb: Open Visual Web Agent and Open Data for the Open Web](https://arxiv.org/abs/2604.08516) <a id="link9"></a>
**ArXiv ID:** 2604.08516
**Authors:** Tanmay Gupta, Piper Wolters, Zixian Ma, Peter Sushko, Rock Yuren Pang, Diego Llanes, Yue Yang, Taira Anderson, Boyuan Zheng, Zhongzheng Ren, Harsh Trivedi, Taylor Blanton, Caleb Ouellette, Winson Han, Ali Farhadi, Ranjay Krishna
...
**Comment:** Matches criterion 3 (introduces a new open benchmark and dataset for web-based embodied agents, with new open-source multimodal web agents). Also relevant to criterion 2 (open MLLMs for web agents).
**Relevance:** 9
**Novelty:** 8

---

## 10. [Lighting-grounded Video Generation with Renderer-based Agent Reasoning](https://arxiv.org/abs/2604.07966) <a id="link10"></a>
**ArXiv ID:** 2604.07966
**Authors:** Ziqi Cai, Taoyu Yang, Zheng Chang, Si Li, Han Jiang, Shuchen Weng, Boxin Shi
...
**Comment:** Matches criterion 4 (vision foundation models and applications, specifically controllable video generation with explicit 3D scene properties and a novel agent for scene control).
**Relevance:** 8
**Novelty:** 8

---

## 11. [LPM 1.0: Video-based Character Performance Model](https://arxiv.org/abs/2604.07823) <a id="link11"></a>
**ArXiv ID:** 2604.07823
**Authors:** Ailing Zeng (R), Casper Yang (R), Chauncey Ge (R), Eddie Zhang (R), Garvey Xu (R), Gavin Lin (R), Gilbert Gu (R), Jeremy Pi (R), Leo Li (R), Mingyi Shi (R), Sheng Bi (R), Steven Tang (R), Thorn Hang (R), Tobey Guo (R), Vincent Li (R), Xin Tong (R), Yikang Li (R), Yuchen Sun (R), Yue (R), Zhao, Yuhan Lu, Yuwei Li, Zane Zhang, Zeshi Yang, Zi Ye
...
**Comment:** Matches criterion 2 (MLLMs) and criterion 4 (vision foundation models and applications). Proposes a large-scale video-based character performance model with a new benchmark for interactive character performance.
**Relevance:** 8
**Novelty:** 8

---

## 12. [Tarot-SAM3: Training-free SAM3 for Any Referring Expression Segmentation](https://arxiv.org/abs/2604.07916) <a id="link12"></a>
**ArXiv ID:** 2604.07916
**Authors:** Weiming Zhang, Dingwen Xiao, Songyue Guo, Guangyu Xiang, Shiqi Wen, Minwei Zhao, Lei Chen, Lin Wang
...
**Comment:** Matches criteria 2 (VLLMs/MLLMs) and 4 (vision foundation models and applications). Tarot-SAM3 is a training-free framework for referring expression segmentation using SAM3 and MLLMs, with novel prompt and mask refinement strategies.
**Relevance:** 9
**Novelty:** 7

---

## 13. [RemoteAgent: Bridging Vague Human Intents and Earth Observation with RL-based Agentic MLLMs](https://arxiv.org/abs/2604.07765) <a id="link13"></a>
**ArXiv ID:** 2604.07765
**Authors:** Liang Yao, Shengxiang Xu, Fan Liu, Chuanyi Zhang, Bishun Yao, Rui Min, Yongjun Li, Chaoqian Ouyang, Shimin Di, Min-Ling Zhang
...
**Comment:** Matches criteria 2 (new MLLMs) and 3 (embodied AI, new agentic framework for vague intent understanding in Earth Observation). RemoteAgent introduces a reinforcement-tuned MLLM for bridging vague human intent and spatial analysis, with a new dataset and agentic orchestration.
**Relevance:** 9
**Novelty:** 7

---

## 14. [MedVR: Annotation-Free Medical Visual Reasoning via Agentic Reinforcement Learning](https://arxiv.org/abs/2604.08203) <a id="link14"></a>
**ArXiv ID:** 2604.08203
**Authors:** Zheng Jiang, Heng Guo, Chengyu Fang, Changchen Xiao, Xinyang Hu, Lifeng Sun, Minfeng Xu
...
**Comment:** Matches criteria 2 (new VLLMs/MLLMs) and 4 (vision foundation models and applications). Introduces MedVR, a reinforcement learning framework for annotation-free visual reasoning in medical VLMs, with new mechanisms for pseudo-supervision and uncertainty-guided exploration.
**Relevance:** 8
**Novelty:** 7

---

## 15. [FORGE:Fine-grained Multimodal Evaluation for Manufacturing Scenarios](https://arxiv.org/abs/2604.07413) <a id="link15"></a>
**ArXiv ID:** 2604.07413
**Authors:** Xiangru Jian, Hao Xu, Wei Pang, Xinjian Zhao, Chengyu Tao, Qixin Zhang, Xikun Zhang, Chao Zhang, Guanzhi Deng, Alex Xue, Juan Du, Tianshu Yu, Garth Tarr, Linqi Song, Qiuzhuang Sun, Dacheng Tao
...
**Comment:** Matches criterion 3 (new embodied AI benchmark for manufacturing, with multimodal evaluation and surprising empirical findings about bottlenecks in MLLMs).
**Relevance:** 8
**Novelty:** 7

---

## 16. [Mitigating Entangled Steering in Large Vision-Language Models for Hallucination Reduction](https://arxiv.org/abs/2604.07914) <a id="link16"></a>
**ArXiv ID:** 2604.07914
**Authors:** Yuanhong Zhang, Zhaoyang Wang, Xin Zhang, Weizhan Zhang, Joey Tianyi Zhou
...
**Comment:** Matches criterion 2 (VLLMs) and criterion 4 (vision foundation models and applications). Proposes a new framework for hallucination reduction in LVLMs with controlled latent intervention.
**Relevance:** 8
**Novelty:** 7

---

## 17. [Beyond Surface Artifacts: Capturing Shared Latent Forgery Knowledge Across Modalities](https://arxiv.org/abs/2604.07763) <a id="link17"></a>
**ArXiv ID:** 2604.07763
**Authors:** Jingtong Dou, Chuancheng Shi, Jian Wang, Fei Shen, Zhiyong Wang, Tat-Seng Chua
...
**Comment:** Matches criterion 2 (multi-modal large language models) and criterion 4 (vision foundation models and applications). Proposes a modality-agnostic forgery detection framework and introduces a new benchmark for multimodal forensics.
**Relevance:** 8
**Novelty:** 7

---

## 18. [HAWK: Head Importance-Aware Visual Token Pruning in Multimodal Models](https://arxiv.org/abs/2604.07812) <a id="link18"></a>
**ArXiv ID:** 2604.07812
**Authors:** Qihui Zhu, Tao Zhang, Yuchen Wang, Zijian Wen, Mengjie Zhang, Shuangwu Chen, Xiaobin Tan, Jian Yang, Yang Liu, Zhenhua Dong, Xianzhi Yu, Yinfei Pan
...
**Comment:** Matches criterion 2 (proposes a new method for visual token pruning in MLLMs, improving inference efficiency with a novel head-importance-aware approach).
**Relevance:** 8
**Novelty:** 7

---

## 19. [Brain3D: EEG-to-3D Decoding of Visual Representations via Multimodal Reasoning](https://arxiv.org/abs/2604.08068) <a id="link19"></a>
**ArXiv ID:** 2604.08068
**Authors:** Emanuele Balloni, Emanuele Frontoni, Chiara Matti, Marina Paolanti, Roberto Pierdicca, Emiliano Santarnecchi
...
**Comment:** Matches criterion 2 (uses a multimodal large language model in the pipeline for EEG-to-3D decoding) and criterion 4 (applies vision foundation models for 3D mesh generation). Also relevant to multi-modal generative modeling.
**Relevance:** 8
**Novelty:** 7

---

## 20. [VSAS-BENCH: Real-Time Evaluation of Visual Streaming Assistant Models](https://arxiv.org/abs/2604.07634) <a id="link20"></a>
**ArXiv ID:** 2604.07634
**Authors:** Pavan Kumar Anasosalu Vasu, Cem Koc, Fartash Faghri, Chun-Liang Li, Bo Feng, Zhengfeng Lai, Meng Cao, Oncel Tuzel, Hadi Pouransari
...
**Comment:** Matches criteria 3 (embodied AI, new benchmark/simulator). VSAS-BENCH introduces a new benchmark for real-time evaluation of visual streaming assistant models, with new metrics and protocols for streaming VLMs.
**Relevance:** 8
**Novelty:** 7

---

## 21. [PanoSAM2: Lightweight Distortion- and Memory-aware Adaptions of SAM2 for 360 Video Object Segmentation](https://arxiv.org/abs/2604.07901) <a id="link21"></a>
**ArXiv ID:** 2604.07901
**Authors:** Dingwen Xiao, Weiming Zhang, Shiqi Wen, Lin Wang
...
**Comment:** Matches criteria 4 (vision foundation models and applications). PanoSAM2 adapts SAM2 for 360 video object segmentation, introducing distortion- and memory-aware strategies for panoramic video.
**Relevance:** 8
**Novelty:** 7

---

## 22. [Latent Anomaly Knowledge Excavation: Unveiling Sparse Sensitive Neurons in Vision-Language Models](https://arxiv.org/abs/2604.07802) <a id="link22"></a>
**ArXiv ID:** 2604.07802
**Authors:** Shaotian Li, Shangze Li, Chuancheng Shi, Wenhua Wu, Yanqiu Wu, Xiaohan Yu, Fei Shen, Tat-Seng Chua
...
**Comment:** Matches criterion 2 (insightful analysis of VLMs for anomaly detection, proposing a training-free method to activate latent anomaly knowledge, with interpretability).
**Relevance:** 7
**Novelty:** 7

---

## 23. [When Numbers Speak: Aligning Textual Numerals and Visual Instances in Text-to-Video Diffusion Models](https://arxiv.org/abs/2604.08546) <a id="link23"></a>
**ArXiv ID:** 2604.08546
**Authors:** Zhengyang Sun, Yu Chen, Xin Zhou, Xiaofan Li, Xiwu Chen, Dingkang Liang, Xiang Bai
...
**Comment:** Matches criterion 4 (vision foundation models and applications, specifically improving numerical alignment in text-to-video diffusion models with a novel training-free framework).
**Relevance:** 7
**Novelty:** 7

---

## 24. [ImVideoEdit: Image-learning Video Editing via 2D Spatial Difference Attention Blocks](https://arxiv.org/abs/2604.07958) <a id="link24"></a>
**ArXiv ID:** 2604.07958
**Authors:** Jiayang Xu, Fan Zhuo, Majun Zhang, Changhao Pan, Zehan Wang, Siyu Chen, Xiaoda Yang, Tao Jin, Zhou Zhao
...
**Comment:** Matches criterion 4 (vision foundation models and applications, specifically efficient video editing using image-learned spatial attention blocks and text-guided semantic gating).
**Relevance:** 7
**Novelty:** 7

---

## 25. [SurfelSplat: Learning Efficient and Generalizable Gaussian Surfel Representations for Sparse-View Surface Reconstruction](https://arxiv.org/abs/2604.08370) <a id="link25"></a>
**ArXiv ID:** 2604.08370
**Authors:** Chensheng Dai, Shengjun Zhang, Min Chen, Yueqi Duan
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a new method for efficient and generalizable Gaussian surfel representations for 3D surface reconstruction from sparse views.
**Relevance:** 7
**Novelty:** 7

---

## 26. [OmniJigsaw: Enhancing Omni-Modal Reasoning via Modality-Orchestrated Reordering](https://arxiv.org/abs/2604.08209) <a id="link26"></a>
**ArXiv ID:** 2604.08209
**Authors:** Yiduo Jia, Muzhi Zhu, Hao Zhong, Mingyu Liu, Yuling Xi, Hao Chen, Bin Qin, Yongjie Yang, Zhenbo Luo, Chunhua Shen
...
**Comment:** Matches criterion 2 (multi-modal large language models) and criterion 4 (vision foundation models and applications). Proposes a self-supervised omni-modal learning framework for video-audio reasoning, with new proxy tasks and data filtering.
**Relevance:** 7
**Novelty:** 7

---

## 27. [EditCaption: Human-Aligned Instruction Synthesis for Image Editing via Supervised Fine-Tuning and Direct Preference Optimization](https://arxiv.org/abs/2604.08213) <a id="link27"></a>
**ArXiv ID:** 2604.08213
**Authors:** Xiangyuan Wang, Honghao Cai, Yunhao Bai, Tianze Zhou, Haohua Chen, Yao Hu, Xu Tang, Yibo Chen, Wei Zhu
...
**Comment:** Matches criterion 2 (improves VLLMs for instruction synthesis in image editing, with human alignment and preference optimization). Also relevant to vision-language model empirical evaluation.
**Relevance:** 8
**Novelty:** 6

---

## 28. [ReconPhys: Reconstruct Appearance and Physical Attributes from Single Video](https://arxiv.org/abs/2604.07882) <a id="link28"></a>
**ArXiv ID:** 2604.07882
**Authors:** Boyuan Wang, Xiaofeng Wang, Yongkang Li, Zheng Zhu, Yifan Chang, Angen Ye, Guosheng Zhao, Chaojun Ni, Guan Huang, Yijie Ren, Yueqi Duan, Xingang Wang
...
**Comment:** Matches criterion 4 (applies vision foundation models for 3D reconstruction and physical attribute estimation from video). Also relevant to generative modeling in vision.
**Relevance:** 6
**Novelty:** 7

---

## 29. [EEG2Vision: A Multimodal EEG-Based Framework for 2D Visual Reconstruction in Cognitive Neuroscience](https://arxiv.org/abs/2604.08063) <a id="link29"></a>
**ArXiv ID:** 2604.08063
**Authors:** Emanuele Balloni, Emanuele Frontoni, Chiara Matti, Marina Paolanti, Roberto Pierdicca, Emiliano Santarnecchi
...
**Comment:** Matches criterion 2 (uses a multimodal large language model for boosting EEG-to-image reconstruction) and criterion 4 (applies vision foundation models for generative reconstruction).
**Relevance:** 7
**Novelty:** 6

---

## 30. [Steering the Verifiability of Multimodal AI Hallucinations](https://arxiv.org/abs/2604.06714) <a id="link30"></a>
**ArXiv ID:** 2604.06714
**Authors:** Jianhong Pang, Ruoxi Cheng, Ziyi Ye, Xingjun Ma, Zuxuan Wu, Xuanjing Huang, Yu-Gang Jiang
...
**Comment:** Matches criterion 2 (studies hallucinations in MLLMs and proposes a method for controlling verifiability, with empirical insights).
**Relevance:** 7
**Novelty:** 6

---

## 31. [CAMotion: A High-Quality Benchmark for Camouflaged Moving Object Detection in the Wild](https://arxiv.org/abs/2604.08287) <a id="link31"></a>
**ArXiv ID:** 2604.08287
**Authors:** Siyuan Yao, Hao Sun, Ruiqi Yu, Xiwei Jiang, Wenqi Ren, Xiaochun Cao
...
**Comment:** Matches criterion 3 (introduces a new benchmark for camouflaged moving object detection, focusing on challenging real-world scenarios).
**Relevance:** 7
**Novelty:** 6

---

## 32. [Beyond Mamba: Enhancing State-space Models with Deformable Dilated Convolutions for Multi-scale Traffic Object Detection](https://arxiv.org/abs/2604.08038) <a id="link32"></a>
**ArXiv ID:** 2604.08038
**Authors:** Jun Li, Yingying Shi, Zhixuan Ruan, Nan Guo, Jianhua Xu
...
**Comment:** Partially matches criteria 1 (methodological improvements to spatial understanding on embodied agents) and 4 (vision foundation models and applications). Proposes a hybrid backbone for traffic object detection with new multi-scale convolutional modules and improved feature fusion, but is more focused on detection than embodied agents.
**Relevance:** 6
**Novelty:** 6

---

## 33. [DBMF: A Dual-Branch Multimodal Framework for Out-of-Distribution Detection](https://arxiv.org/abs/2604.08261) <a id="link33"></a>
**ArXiv ID:** 2604.08261
**Authors:** Jiangbei Yue, Sharib Ali
...
**Comment:** Matches criterion 2 (new multimodal framework for OOD detection, leveraging both text-image and vision branches, relevant to MLLMs).
**Relevance:** 6
**Novelty:** 6

---

## 34. [AgriChain Visually Grounded Expert Verified Reasoning for Interpretable Agricultural Vision Language Models](https://arxiv.org/abs/2604.07814) <a id="link34"></a>
**ArXiv ID:** 2604.07814
**Authors:** Hazza Mahmood, Yongqiang Yu, Rao Anwer
...
**Comment:** Matches criterion 2 (fine-tunes a VLM for interpretable reasoning in agriculture, with expert-verified chain-of-thought rationales). Also relevant to vision-language model applications.
**Relevance:** 6
**Novelty:** 5

---

## 35. [Self-Improving 4D Perception via Self-Distillation](https://arxiv.org/abs/2604.08532) <a id="link35"></a>
**ArXiv ID:** 2604.08532
**Authors:** Nan Huang, Pengcheng Yu, Weijia Zeng, James M. Rehg, Angjoo Kanazawa, Haiwen Feng, Qianqian Wang
...
**Comment:** Related to vision foundation models and self-improving 4D perception, but not a direct match to any specific criterion. Interesting for self-supervised learning in 4D perception.
**Relevance:** 4
**Novelty:** 7

---

## 36. [How Much LLM Does a Self-Revising Agent Actually Need?](https://arxiv.org/abs/2604.07236) <a id="link36"></a>
**ArXiv ID:** 2604.07236
**Authors:** Sungwoo Jung, Seonil Son
...
**Comment:** Somewhat related to embodied agents and agent design, but does not focus on spatial intelligence, VLLMs/MLLMs, or vision foundation models. More about agent architecture and LLM role analysis.
**Relevance:** 4
**Novelty:** 6

---

## 37. [ETCH-X: Robustify Expressive Body Fitting to Clothed Humans with Composable Datasets](https://arxiv.org/abs/2604.08548) <a id="link37"></a>
**ArXiv ID:** 2604.08548
**Authors:** Xiaoben Li, Jingyi Wu, Zeyu Cai, Yu Siyuan, Boqian Li, Yuliang Xiu
...
**Comment:** Related to vision foundation models and 3D human modeling, but not a direct match to any specific criterion. Focuses on robust body fitting with composable datasets.
**Relevance:** 4
**Novelty:** 6

---

## 38. [Reinforcement-Guided Synthetic Data Generation for Privacy-Sensitive Identity Recognition](https://arxiv.org/abs/2604.07884) <a id="link38"></a>
**ArXiv ID:** 2604.07884
**Authors:** Xuemei Jia, Jiawei Du, Hui Wei, Jun Chen, Joey Tianyi Zhou, Zheng Wang
...
**Comment:** Some relevance to generative modeling, but focused on privacy-sensitive identity recognition and synthetic data generation. Not a direct match to any criterion.
**Relevance:** 3
**Novelty:** 6

---

## 39. [Rethinking Generalization in Reasoning SFT: A Conditional Analysis on Optimization, Data, and Model Capability](https://arxiv.org/abs/2604.06628) <a id="link39"></a>
**ArXiv ID:** 2604.06628
**Authors:** Qihan Ren, Peng Wang, Ruikun Cai, Shuai Shao, Dadi Guo, Yuejin Xie, Yafu Li, Quanshi Zhang, Xia Hu, Jing Shao, Dongrui Liu
...
**Comment:** Does not match any specific criterion; focuses on generalization in reasoning SFT for LLMs, not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 40. [On Emotion-Sensitive Decision Making of Small Language Model Agents](https://arxiv.org/abs/2604.06562) <a id="link40"></a>
**ArXiv ID:** 2604.06562
**Authors:** Jiaju Lin, Xingjian Du, Qingyun Wu, Ellen Wenting Zou, Jindong Wang
...
**Comment:** Does not match any specific criterion; focuses on emotion-sensitive decision making in small language model agents, not spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 41. [MSGL-Transformer: A Multi-Scale Global-Local Transformer for Rodent Social Behavior Recognition](https://arxiv.org/abs/2604.07578) <a id="link41"></a>
**ArXiv ID:** 2604.07578
**Authors:** Muhammad Imran Sharif, Doina Caragea
...
**Comment:** Some relevance to spatial-temporal modeling, but focused on animal behavior recognition with transformers. Not a direct match to any criterion.
**Relevance:** 3
**Novelty:** 5
