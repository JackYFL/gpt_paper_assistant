# Personalized Daily ArXiv Papers 07/28/2026
...
0. [VIPER: Visual In-Context Physics Reasoning for Physically Plausible Video Generation](#link0)
**Authors:** Tianxiao Chen, Hanmo Chen, Huajin Chen, Bo Li, Qi Ye, Peng-Tao Jiang

1. [The Visual Bottleneck: Sparse-Frame Adaptation of MLLMs for Joint Spatial-Temporal Video Grounding](#link1)
**Authors:** Jiameng Zhang, Srikanth Madikeri

2. [SIREN: Towards End-to-End Extreme-Weather Early Warning with Experience-Grounded LLM Agents](#link2)
**Authors:** Hang Ni, Weijia Zhang, Fan Liu, Mengqian Lu, Hao Liu

3. [MicroZoom: Structure-Preserving Detail Synthesis at Extreme Scale](#link3)
**Authors:** Huy Huynh, Jingwei Ma, Brian Curless, Ira Kemelmacher-Shlizerman, Steven M. Seitz

4. [SARATR-X-v2: Scale-Aware Structural Pre-Training for SAR Foundation Models](#link4)
**Authors:** Weijie Li, Yafei Song, Yongxiang Liu, Bowen Peng, Jie Zhou, Jingyuan Xia, Wei Yang, Tianpeng Liu, Zhen Liu, Li Liu

5. [MarineEVT: Advancing Event-Centric Marine Video Understanding via Visual Tool Reasoning](#link5)
**Authors:** Tuan-An To, Yuk-Kwan Wong, Tuan-Anh Vu, Ziqiang Zheng, Sai-Kit Yeung

6. [E-Bench: Benchmarking Multi-Step Tool-Use Agents in Real-World Product Scenarios](#link6)
**Authors:** Weihuang Zheng, Tianyuan Zou, Eileen Ye, Alphet Liu, Youyong Kong, Ya-Qin Zhang, Duran Zheng, Maxm Pan

7. [Similarity Is Not Logic: Factored Inference for Dual-Encoder Vision-Language Models](#link7)
**Authors:** Sultan Alshehri, Zhantao Yang, Han Zhang, Marios Savvides

8. [Stress-testing large language model agents in a robotic chemistry laboratory](#link8)
...
9. [Controlling Embedding Spaces with Text-Conditioned Transformations](#link9)
**Authors:** Joseph Fioresi, Fabian Caba Heilbron, Pankaj Nathani, Mubarak Shah, Kushal Kafle

10. [VlogReward: Learning Multi-Dimensional Evaluation for Vlog Editing](#link10)
**Authors:** Yexiang Liu, Wen Zhong, Sijie Zhu, Xin Gu, Fan Chen, Junxian Duan, Jie Cao, Longyin Wen, Zhenfang Chen

11. [AgentOmnia: Scaling Agentic Models for Full-Scenario Applications](#link11)
...
12. [BeyondFusion: Self-Aligned Latent Diffusion for Calibration-Free Infrared Super-Resolution and Infrared-Visible Fusion](#link12)
**Authors:** Minchong Chen, Xiaoyun Yuan, Minyu Cao, Jianing Zhang, Jun Zhang, Shuyang Liu, Xiaokang Yang

13. [What Can I Edit? Open-Ended Strategy Discovery and the Emotion Editability Landscape](#link13)
**Authors:** Qing Li, Zeyu Dong, Yin Cui, Chuan Yan, Xiaojiang Peng

14. [Advancing All-Weather Building Damage Mapping to the Instance Level: Outcomes and Insights from the 2026 Bright Challenge](#link14)
...
15. [GNM Head: A Generative aNthropometric Model of the human head](#link15)
**Authors:** Stylianos Ploumpis, Jan Bednarik, Gaspard Zoss, Ruslan Guseinov, Luca Prasso, Prashanth Chandran, Oliver Boyne, Vasileios Choutas, Timo Bolkart, Daoye Wang, Menglei Chai, Di Qiu, Sebastian Winberg, Gilles Rainer, Lewis Bridgeman, Delio Vicini, J\'er\'emy Riviere, Yannick Boetzel, Alexander Koumis, Jay Busch, Cynthia Herrera, Jacob Still, Scott Ysebert, Peter Lincoln, Sergio Orts Escolano, Christoph Rhemann, Erroll Wood, Thabo Beeler, Stefanos Zafeiriou

16. [MM-ShiftKV: Decode-Aware Prefill-Stage KV Selection for Multimodal Large Language Models](#link16)
**Authors:** Jinsong Shu, Chenyang Wu, Zhongle Xie, Baokun Wang, Lidan Shou

17. [JarvisHub: An Open Harness for Canvas-Native Multimodal Creative Agents](#link17)
...
18. [Group Preference Collapse in Personalized Multimodal Large Language Models](#link18)
**Authors:** Fan Lyu, Wenqi Zhang, Joost van de Weijer

19. [CrossSpine: Multi-scale Cross-sequence Attention with Anatomical Priors for Automated Pfirrmann Grading](#link19)
...
20. [Reinforcement Learning for Heterogeneous Sensor Selection in Maritime Surveillance](#link20)
**Authors:** Andrei Starodubov, Yaqub Aris Prabowo, Andreas Hadjipieris, Roberto Galeazzi, Ioannis Kyriakides

21. [PRESTO: Prefix-Aligned Tree Drafting for Diffusion Speculative Decoding](#link21)
...
22. [Generative Artificial Intelligence (GenAI) to convert images of queuing networks into verifiable simulation models: an open-weight LLM workflow approach](#link22)
**Authors:** Thomas Monks, Alison Harper, Amy Heather, Navonil Mustafee

23. [ACM: Agentic Context Management for Long Horizon Tasks](#link23)
**Authors:** Xiaochuan Li, Ryan Ming, Meng Chu, Shuai Shao, Rong Jin, Chenyan Xiong

24. [Neuromorphic Object Detection: An In-Depth Study and Future Directions](#link24)
**Authors:** Jianing Li, Dianze Li, Arren Glover, Xiaopeng Fan, Guoqi Li, Chiara Bartolozzi, Ryad B. Benosman, Yonghong Tian

---
## 0. [VIPER: Visual In-Context Physics Reasoning for Physically Plausible Video Generation](https://arxiv.org/abs/2607.23472) <a id="link0"></a>
**ArXiv ID:** 2607.23472
**Authors:** Tianxiao Chen, Hanmo Chen, Huajin Chen, Bo Li, Qi Ye, Peng-Tao Jiang
...
**Comment:** Matches criterion 2 very closely: it introduces an MLLM-guided framework for physically plausible video generation, using visual in-context physics reasoning.
**Relevance:** 8
**Novelty:** 7

---

## 1. [The Visual Bottleneck: Sparse-Frame Adaptation of MLLMs for Joint Spatial-Temporal Video Grounding](https://arxiv.org/abs/2607.24570) <a id="link1"></a>
**ArXiv ID:** 2607.24570
**Authors:** Jiameng Zhang, Srikanth Madikeri
...
**Comment:** Matches criterion 2 very closely: this is an MLLM adaptation method for spatial-temporal video grounding, with strong empirical findings about sparse-frame deployment.
**Relevance:** 8
**Novelty:** 6

---

## 2. [SIREN: Towards End-to-End Extreme-Weather Early Warning with Experience-Grounded LLM Agents](https://arxiv.org/abs/2607.24588) <a id="link2"></a>
**ArXiv ID:** 2607.24588
**Authors:** Hang Ni, Weijia Zhang, Fan Liu, Mengqian Lu, Hao Liu
...
**Comment:** Matches criterion 3 very closely: it builds a new embodied/operational benchmark (SIREN-Bench) and a new agent framework for end-to-end extreme-weather early warning.
**Relevance:** 6
**Novelty:** 6

---

## 3. [MicroZoom: Structure-Preserving Detail Synthesis at Extreme Scale](https://arxiv.org/abs/2607.24729) <a id="link3"></a>
**ArXiv ID:** 2607.24729
**Authors:** Huy Huynh, Jingwei Ma, Brian Curless, Ira Kemelmacher-Shlizerman, Steven M. Seitz
...
**Comment:** Matches criterion 4 moderately well: it is a generative vision foundation-model-style application for extreme-scale image synthesis and structure-preserving detail generation.
**Relevance:** 5
**Novelty:** 7

---

## 4. [SARATR-X-v2: Scale-Aware Structural Pre-Training for SAR Foundation Models](https://arxiv.org/abs/2607.23238) <a id="link4"></a>
**ArXiv ID:** 2607.23238
**Authors:** Weijie Li, Yafei Song, Yongxiang Liu, Bowen Peng, Jie Zhou, Jingyuan Xia, Wei Yang, Tianpeng Liu, Zhen Liu, Li Liu
...
**Comment:** Matches criterion 4 well: this is a vision foundation model paper, specifically SAR foundation-model pre-training with a structural target design.
**Relevance:** 5
**Novelty:** 6

---

## 5. [MarineEVT: Advancing Event-Centric Marine Video Understanding via Visual Tool Reasoning](https://arxiv.org/abs/2607.24064) <a id="link5"></a>
**ArXiv ID:** 2607.24064
**Authors:** Tuan-An To, Yuk-Kwan Wong, Tuan-Anh Vu, Ziqiang Zheng, Sai-Kit Yeung
...
**Comment:** Matches criterion 2 very closely: it proposes a new VLM-style reasoning framework (EVT-R1) and a new video understanding benchmark focused on marine events.
**Relevance:** 5
**Novelty:** 6

---

## 6. [E-Bench: Benchmarking Multi-Step Tool-Use Agents in Real-World Product Scenarios](https://arxiv.org/abs/2607.23722) <a id="link6"></a>
**ArXiv ID:** 2607.23722
**Authors:** Weihuang Zheng, Tianyuan Zou, Eileen Ye, Alphet Liu, Youyong Kong, Ya-Qin Zhang, Duran Zheng, Maxm Pan
...
**Comment:** Matches criterion 3 closely: it introduces a new benchmark for multi-step tool-use agents in realistic product scenarios, with a novel synthetic environment/task construction angle.
**Relevance:** 5
**Novelty:** 6

---

## 7. [Similarity Is Not Logic: Factored Inference for Dual-Encoder Vision-Language Models](https://arxiv.org/abs/2607.23052) <a id="link7"></a>
**ArXiv ID:** 2607.23052
**Authors:** Sultan Alshehri, Zhantao Yang, Han Zhang, Marios Savvides
...
**Comment:** Matches criterion 2 very closely: it proposes a new inference method for dual-encoder vision-language models and includes a benchmark highlighting compositional failures.
**Relevance:** 5
**Novelty:** 6

---

## 8. [Stress-testing large language model agents in a robotic chemistry laboratory](https://arxiv.org/abs/2607.23045) <a id="link8"></a>
**ArXiv ID:** 2607.23045
**Authors:** Lulu Guo, Yingkai Sun, Xiaobo Li, Luyao Ge, Ziming Wang, Haitao Zheng, Jingyu Li, Huijuan Zhang, Bingxu Chen, Daobin Liu, Yuebo Liu, Jie Li, Xiaohui Li, Linjiang Chen, Yi Luo, Jun Jiang
...
**Comment:** Matches criterion 3 very closely: it is an embodied AI / robotic laboratory benchmark for measuring long-horizon planning, physical executability, and replanning in the real world.
**Relevance:** 5
**Novelty:** 6

---

## 9. [Controlling Embedding Spaces with Text-Conditioned Transformations](https://arxiv.org/abs/2607.22919) <a id="link9"></a>
**ArXiv ID:** 2607.22919
**Authors:** Joseph Fioresi, Fabian Caba Heilbron, Pankaj Nathani, Mubarak Shah, Kushal Kafle
...
**Comment:** Matches criterion 4 moderately well: this is a vision foundation-model/embedding-space method that controls CLIP-like representations with text-conditioned transformations.
**Relevance:** 5
**Novelty:** 6

---

## 10. [VlogReward: Learning Multi-Dimensional Evaluation for Vlog Editing](https://arxiv.org/abs/2607.22632) <a id="link10"></a>
**ArXiv ID:** 2607.22632
**Authors:** Yexiang Liu, Wen Zhong, Sijie Zhu, Xin Gu, Fan Chen, Junxian Duan, Jie Cao, Longyin Wen, Zhenfang Chen
...
**Comment:** Matches criterion 2 and partly criterion 4: it builds an MLLM benchmark for vlog editing and introduces a reward model for multimodal evaluation.
**Relevance:** 5
**Novelty:** 6

---

## 11. [AgentOmnia: Scaling Agentic Models for Full-Scenario Applications](https://arxiv.org/abs/2607.23124) <a id="link11"></a>
**ArXiv ID:** 2607.23124
**Authors:** Hao Jiang, Gangtao Xin, Yingdi Huang, Guojie Zhu, Jiangshan Zhang, Xinyuan Lin, Yunkun Xu, Chengyu Shen, Wenlong Fei, Jiawei Li, Yujie Fu, Sichen Kang, Tingyu Xie, Yedi Hu, Jingren Zhang, Hongcheng Gao, Jianshu Zeng, Chong Chen, Chang Guo, Chao Feng, Feng Wang, Fulin Lin, Jinchao Ma, Lang Mei, Li Huang, Liyan Liu, Qing He, Shuting Tao, Siyu Mo, Xiangnan Chen, Xiaohan Yu, Xiaoyang Li, Yanheng Hou, Yanyu Wu, Zhihan Yang, Wentao Zhang, Yang Gao, Zhao Cao
...
**Comment:** Matches criterion 3 very closely: it is an embodied/agentic system paper that builds a large benchmark and training pipeline for full-scenario applications, with environment synthesis and evaluation.
**Relevance:** 5
**Novelty:** 6

---

## 12. [BeyondFusion: Self-Aligned Latent Diffusion for Calibration-Free Infrared Super-Resolution and Infrared-Visible Fusion](https://arxiv.org/abs/2607.24110) <a id="link12"></a>
**ArXiv ID:** 2607.24110
**Authors:** Minchong Chen, Xiaoyun Yuan, Minyu Cao, Jianing Zhang, Jun Zhang, Shuyang Liu, Xiaokang Yang
...
**Comment:** Partial match to criterion 4: this is a generative vision model application for infrared-visible fusion and super-resolution, though it is not really about vision foundation models themselves.
**Relevance:** 4
**Novelty:** 6

---

## 13. [What Can I Edit? Open-Ended Strategy Discovery and the Emotion Editability Landscape](https://arxiv.org/abs/2607.23920) <a id="link13"></a>
**ArXiv ID:** 2607.23920
**Authors:** Qing Li, Zeyu Dong, Yin Cui, Chuan Yan, Xiaojiang Peng
...
**Comment:** Matches criterion 4 moderately well: this is a vision-language/agentic image-editing method built around affordance reasoning and user-controllable planning.
**Relevance:** 4
**Novelty:** 6

---

## 14. [Advancing All-Weather Building Damage Mapping to the Instance Level: Outcomes and Insights from the 2026 Bright Challenge](https://arxiv.org/abs/2607.22746) <a id="link14"></a>
**ArXiv ID:** 2607.22746
**Authors:** Hongruixuan Chen, He Huang, Haifeng Wang, Jian Song, Junjue Wang, Weihao Xuan, Hamish Mitchell, Jiepan Li, Wei He, Liangpei Zhang, Zijie Wang, Chen Zhong, Jiazhen Zhao, Lei Hu, Ting Hu, Hongyan Zhang, Gregory Angelides, Miriam Cha, Clifford Broni-Bediako, Junshi Xia, Taylor Perron, Naoto Yokoya
...
**Comment:** Matches criterion 3 closely: it is a new benchmark/challenge for all-weather building damage mapping at the instance level, with cross-event generalization insights and simulator-like remote-sensing evaluation.
**Relevance:** 5
**Novelty:** 5

---

## 15. [GNM Head: A Generative aNthropometric Model of the human head](https://arxiv.org/abs/2607.23687) <a id="link15"></a>
**ArXiv ID:** 2607.23687
**Authors:** Stylianos Ploumpis, Jan Bednarik, Gaspard Zoss, Ruslan Guseinov, Luca Prasso, Prashanth Chandran, Oliver Boyne, Vasileios Choutas, Timo Bolkart, Daoye Wang, Menglei Chai, Di Qiu, Sebastian Winberg, Gilles Rainer, Lewis Bridgeman, Delio Vicini, J\'er\'emy Riviere, Yannick Boetzel, Alexander Koumis, Jay Busch, Cynthia Herrera, Jacob Still, Scott Ysebert, Peter Lincoln, Sergio Orts Escolano, Christoph Rhemann, Erroll Wood, Thabo Beeler, Stefanos Zafeiriou
...
**Comment:** Matches criterion 4: this is a vision foundation model-related parametric human head model used for conditioning generative vision systems and spatial control.
**Relevance:** 5
**Novelty:** 5

---

## 16. [MM-ShiftKV: Decode-Aware Prefill-Stage KV Selection for Multimodal Large Language Models](https://arxiv.org/abs/2607.22586) <a id="link16"></a>
**ArXiv ID:** 2607.22586
**Authors:** Jinsong Shu, Chenyang Wu, Zhongle Xie, Baokun Wang, Lidan Shou
...
**Comment:** Matches criterion 2 closely: it proposes an MLLM inference efficiency method tailored to multimodal KV caching and visual-token selection.
**Relevance:** 5
**Novelty:** 5

---

## 17. [JarvisHub: An Open Harness for Canvas-Native Multimodal Creative Agents](https://arxiv.org/abs/2607.23588) <a id="link17"></a>
**ArXiv ID:** 2607.23588
**Authors:** Yunlong Lin, Zixu Lin, Zhaohu Xing, Biqiang Li, Chenxin Li, Haonan Wang, Haitao Wu, Hengyu Liu, Jianghai Chen, Kaituo Feng, Kaixin Li, Shawn Chen, Shijue Huang, Sixiang Chen, Tsung-Yi Ho, Wenxuan Huang, Xiangyan Liu, Xiaomeng Hu, Xuanhua He, Yan Sun, Yunqing Zhao, Zhiqin Yang, Zehan Wang, Zhengyang Tang, Tianyu Pang, Xiangyu Yue
...
**Comment:** Matches criterion 2 moderately well: it proposes an open harness for multimodal creative agents, enabling long-horizon agent behavior over canvas-based multimodal workflows.
**Relevance:** 4
**Novelty:** 5

---

## 18. [Group Preference Collapse in Personalized Multimodal Large Language Models](https://arxiv.org/abs/2607.22603) <a id="link18"></a>
**ArXiv ID:** 2607.22603
**Authors:** Fan Lyu, Wenqi Zhang, Joost van de Weijer
...
**Comment:** Matches criterion 2 moderately well: it is about personalized multimodal LLMs and analyzes a specific failure mode in MLLMs.
**Relevance:** 4
**Novelty:** 5

---

## 19. [CrossSpine: Multi-scale Cross-sequence Attention with Anatomical Priors for Automated Pfirrmann Grading](https://arxiv.org/abs/2607.22728) <a id="link19"></a>
**ArXiv ID:** 2607.22728
**Authors:** Hai Son Nguyen, Duong Ngoc Vu, Trong-Nghia Nguyen, Bien Tran Van, Van-Dem Pham, Trang Mai Xuan, Huan Vu, Thien Van Luong
...
**Comment:** Matches criterion 3: it proposes a new multimodal MRI fusion architecture and a curated medical grading dataset, but it is not embodied AI or a vision foundation model paper.
**Relevance:** 5
**Novelty:** 4

---

## 20. [Reinforcement Learning for Heterogeneous Sensor Selection in Maritime Surveillance](https://arxiv.org/abs/2607.22667) <a id="link20"></a>
**ArXiv ID:** 2607.22667
**Authors:** Andrei Starodubov, Yaqub Aris Prabowo, Andreas Hadjipieris, Roberto Galeazzi, Ioannis Kyriakides
...
**Comment:** Partial match to criterion 3 in the sense of an agentic decision-making method in a simulated environment, but it is not embodied AI in the usual benchmark/method sense.
**Relevance:** 3
**Novelty:** 5

---

## 21. [PRESTO: Prefix-Aligned Tree Drafting for Diffusion Speculative Decoding](https://arxiv.org/abs/2607.22634) <a id="link21"></a>
**ArXiv ID:** 2607.22634
**Authors:** Zheng Wang, Zhifan Ye, Qi Cheng, Yonggan Fu, Ziyan Wang, Feng Zhu, Haozhe Zhao, Jan Kautz, Pavlo Molchanov, Humphrey Shi, Minjia Zhang
...
**Comment:** Does not directly match the four criteria; it is mainly a decoding efficiency method for diffusion LLMs, though still relevant to generative modeling.
**Relevance:** 3
**Novelty:** 5

---

## 22. [Generative Artificial Intelligence (GenAI) to convert images of queuing networks into verifiable simulation models: an open-weight LLM workflow approach](https://arxiv.org/abs/2607.24259) <a id="link22"></a>
**ArXiv ID:** 2607.24259
**Authors:** Thomas Monks, Alison Harper, Amy Heather, Navonil Mustafee
...
**Comment:** Matches criterion 3 only partially: it uses an MLLM for sketch-to-simulation workflow generation, but the domain is queuing-network simulation rather than embodied AI or spatial intelligence.
**Relevance:** 4
**Novelty:** 4

---

## 23. [ACM: Agentic Context Management for Long Horizon Tasks](https://arxiv.org/abs/2607.23809) <a id="link23"></a>
**ArXiv ID:** 2607.23809
**Authors:** Xiaochuan Li, Ryan Ming, Meng Chu, Shuai Shao, Rong Jin, Chenyan Xiong
...
**Comment:** No very close match to criteria 1-4; this is an agentic long-horizon context management method, relevant to LLM agents but not specifically embodied AI, spatial intelligence, or VLLM/MLLM development.
**Relevance:** 3
**Novelty:** 5

---

## 24. [Neuromorphic Object Detection: An In-Depth Study and Future Directions](https://arxiv.org/abs/2607.23576) <a id="link24"></a>
**ArXiv ID:** 2607.23576
**Authors:** Jianing Li, Dianze Li, Arren Glover, Xiaopeng Fan, Guoqi Li, Chiara Bartolozzi, Ryad B. Benosman, Yonghong Tian
...
**Comment:** Matches criterion 3 only loosely: it is a neuromorphic object detection survey/benchmark, but not an embodied AI simulator benchmark or a new embodied method.
**Relevance:** 3
**Novelty:** 4
