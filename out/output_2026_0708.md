# Personalized Daily ArXiv Papers 07/08/2026
...
0. [Bridging Physical Reasoning and Task Generalization via Visual Action Outcome Reasoning Alignment](#link0)
**Authors:** Han-Jun Ko, Jr-Jen Chen, Haobo Yuan, Hsin-Ying Lee, Tiancheng Shen, Ming-Hsuan Yang, Yu-Chiang Frank Wang

1. [Vision as Unified Multimodal Generation](#link1)
...
2. [Ground3D-LMM: Fine-Grained 3D Point Grounding and Spatial Reasoning with LMM](#link2)
**Authors:** Amol Harsh, Zongyan Han, Jean Lahoud, Ye Liu, Rao Muhammad Anwer, Hisham Cholakkal, Salman Khan, Fahad Khan

3. [MoWorld: A Flash World Model](#link3)
...
4. [Benchmarking the Robustness of Autonomous Driving to Environmental Illusions: A Lane Perception Perspective](#link4)
**Authors:** Tianyuan Zhang, Xianglong Liu, Aishan Liu, Lu Wang, Yitong Zhang, Peng Yue, Mingchuan Zhang, Siyuan Liang, Dacheng Tao

5. [Propose and Attend: Training-free MLLM Grounding Confidence via Multi-Token Localized Attention](#link5)
**Authors:** Daniel Shalam, Emanuel Ben Baruch, Avi Ben Cohen, Tal Remez

6. [Analysis-by-Proxy: Localization Signals in VLMs Operating as Condition Encoders](#link6)
**Authors:** Yoav Baron, Sara Dorfman, Roni Paiss, Daniel Cohen-Or, Or Patashnik

7. [ArtisanCAD: An Industrial-Level CAD Agent with Expert-Grounded Knowledge Distillation](#link7)
...
8. [Synthetic-to-Real Translation for Class-Agnostic Motion Prediction](#link8)
...
9. [PVCap: Towards Accurate 3D Dense Captioning via PseudoCap and VoxelCapNet](#link9)
...
10. [Multi-Teacher Contrastive Distillation for Edge-Efficient Pathology Foundation Models](#link10)
**Authors:** Tim Lenz, Maurice Heide, Marco Gustav, Nic G. Reitsam, Jakob Nikolas Kather

11. [PolicyShiftGuard: Benchmarking and Improving Policy-Adaptive Image Guardrails](#link11)
**Authors:** Mingyang Song, Luxin Xu, Haoyu Sun, Minzhou Pan, Yu Cheng, Bo Li

---
## 0. [Bridging Physical Reasoning and Task Generalization via Visual Action Outcome Reasoning Alignment](https://arxiv.org/abs/2607.06522) <a id="link0"></a>
**ArXiv ID:** 2607.06522
**Authors:** Han-Jun Ko, Jr-Jen Chen, Haobo Yuan, Hsin-Ying Lee, Tiancheng Shen, Ming-Hsuan Yang, Yu-Chiang Frank Wang
...
**Comment:** Matches criterion 1 very closely: it proposes a new method for physical reasoning in embodied settings, specifically aligning reasoning with visual action outcomes to improve task generalization.
**Relevance:** 8
**Novelty:** 7

---

## 1. [Vision as Unified Multimodal Generation](https://arxiv.org/abs/2607.06560) <a id="link1"></a>
**ArXiv ID:** 2607.06560
**Authors:** Xiaoyang Han, Jianhua Li, Kewang Deng, Zukai Chen, Xuanke Shi, Sihan Wang, Boxuan Li, Linyan Wang, Siyi Xie, Xin You, Jinsheng Quan, Zhongang Cai, Haiwen Diao, Ziwei Liu, Lei Yang, Dahua Lin, Quan Wang
...
**Comment:** Matches criterion 4 very closely: it is about a unified multimodal generation formulation for broad computer vision tasks, i.e., a vision foundation model-style approach and applications across many vision problems.
**Relevance:** 8
**Novelty:** 7

---

## 2. [Ground3D-LMM: Fine-Grained 3D Point Grounding and Spatial Reasoning with LMM](https://arxiv.org/abs/2607.05493) <a id="link2"></a>
**ArXiv ID:** 2607.05493
**Authors:** Amol Harsh, Zongyan Han, Jean Lahoud, Ye Liu, Rao Muhammad Anwer, Hisham Cholakkal, Salman Khan, Fahad Khan
...
**Comment:** Matches criterion 1 and 3 closely: a 3D LMM for fine-grained point grounding and metric spatial reasoning, with a new 3D grounded measurement dataset.
**Relevance:** 8
**Novelty:** 7

---

## 3. [MoWorld: A Flash World Model](https://arxiv.org/abs/2607.06216) <a id="link3"></a>
**ArXiv ID:** 2607.06216
**Authors:** Team Moxin, Deyi Ji, Tianrun Chen, Xin Zhang, Jiale Yang, Qi Zhu, An Zhao, Zihao Xie, Han Wang, Xuanyi Liu, Yixiang Zhou, Pei Liu, Yi Tan, Cheng Chen, Dayi Zhu, Mingyu Wei, Hanjie Xu, Jun Liao, Siqi Li, Lingyu Lu, Hongye Fang, Hongming Tan, Youjiang Zhu, Taiyu Zhang, Zejian Li, Chaotao Ding, Lanyun Zhu, Yunhe Pan, Lingyun Sun
...
**Comment:** Matches criterion 4 closely: a new world model built for efficient real-time deployment, with 3D-native data and practical inference optimizations.
**Relevance:** 8
**Novelty:** 7

---

## 4. [Benchmarking the Robustness of Autonomous Driving to Environmental Illusions: A Lane Perception Perspective](https://arxiv.org/abs/2607.05783) <a id="link4"></a>
**ArXiv ID:** 2607.05783
**Authors:** Tianyuan Zhang, Xianglong Liu, Aishan Liu, Lu Wang, Yitong Zhang, Peng Yue, Mingchuan Zhang, Siyuan Liang, Dacheng Tao
...
**Comment:** Matches criterion 3 very closely: it builds a new simulator-based benchmark for embodied/autonomous driving robustness, focusing on overlooked environmental illusions and also proposes a defense method.
**Relevance:** 7
**Novelty:** 6

---

## 5. [Propose and Attend: Training-free MLLM Grounding Confidence via Multi-Token Localized Attention](https://arxiv.org/abs/2607.05978) <a id="link5"></a>
**ArXiv ID:** 2607.05978
**Authors:** Daniel Shalam, Emanuel Ben Baruch, Avi Ben Cohen, Tal Remez
...
**Comment:** Matches criterion 2 closely: a new training-free grounding-confidence method for MLLMs with multi-token localized attention.
**Relevance:** 7
**Novelty:** 6

---

## 6. [Analysis-by-Proxy: Localization Signals in VLMs Operating as Condition Encoders](https://arxiv.org/abs/2607.06445) <a id="link6"></a>
**ArXiv ID:** 2607.06445
**Authors:** Yoav Baron, Sara Dorfman, Roni Paiss, Daniel Cohen-Or, Or Patashnik
...
**Comment:** Matches criterion 1 closely: it studies localization signals and spatial understanding inside VLMs, especially when used as condition encoders for image editing.
**Relevance:** 6
**Novelty:** 7

---

## 7. [ArtisanCAD: An Industrial-Level CAD Agent with Expert-Grounded Knowledge Distillation](https://arxiv.org/abs/2607.05750) <a id="link7"></a>
**ArXiv ID:** 2607.05750
**Authors:** Yunhan Xu, Qifeng Wu, Xunjin Li, Yuanwei Bin, Qingsong Yao, Jianghang Gu, Guan Wang, Weihao Lv, Huiyu Yang, Wenfa Luo, Jiao Xiang, Yuntian Chen, Shiyi Chen
...
**Comment:** Matches criterion 3 moderately well: an industrial CAD agent for procedural 3D design, which is a novel embodied/interactive design workflow with expert knowledge distillation.
**Relevance:** 6
**Novelty:** 6

---

## 8. [Synthetic-to-Real Translation for Class-Agnostic Motion Prediction](https://arxiv.org/abs/2607.06319) <a id="link8"></a>
**ArXiv ID:** 2607.06319
**Authors:** Yizheng Wu, Hongwei Fan, Kewei Wang, Ruibo Li, Xingyi Li, Xiao Song, Zhe Wang, Chenjing Ding, Dongliang Wang, Zhiguo Cao, Guosheng Lin
...
**Comment:** Matches criterion 3: it introduces a simulator/synthetic-data pipeline and a new method for motion prediction via synthetic-to-real transfer, with a new synthetic 4D LiDAR dataset.
**Relevance:** 6
**Novelty:** 5

---

## 9. [PVCap: Towards Accurate 3D Dense Captioning via PseudoCap and VoxelCapNet](https://arxiv.org/abs/2607.06097) <a id="link9"></a>
**ArXiv ID:** 2607.06097
**Authors:** Xiaopei Wu, Chenshu Hou, Liang Peng, Dan Xu, Binbin Lin, Xiaoshui Huang, Yuenan Hou, Yu Li, Wenxiao Wang, Haifeng Liu, Deng Cai, Wanli Ouyang
...
**Comment:** Matches criterion 3: a 3D embodied perception task paper that builds a new method for 3D dense captioning with spatial-layout-aware augmentation and a stronger voxel-based captioning baseline.
**Relevance:** 6
**Novelty:** 5

---

## 10. [Multi-Teacher Contrastive Distillation for Edge-Efficient Pathology Foundation Models](https://arxiv.org/abs/2607.05533) <a id="link10"></a>
**ArXiv ID:** 2607.05533
**Authors:** Tim Lenz, Maurice Heide, Marco Gustav, Nic G. Reitsam, Jakob Nikolas Kather
...
**Comment:** Matches criterion 4 loosely: a foundation-model distillation method for pathology, which is vision-foundation-model related but not about spatial understanding or embodied AI.
**Relevance:** 4
**Novelty:** 6

---

## 11. [PolicyShiftGuard: Benchmarking and Improving Policy-Adaptive Image Guardrails](https://arxiv.org/abs/2607.05910) <a id="link11"></a>
**ArXiv ID:** 2607.05910
**Authors:** Mingyang Song, Luxin Xu, Haoyu Sun, Minzhou Pan, Yu Cheng, Bo Li
...
**Comment:** Matches criterion 1 only loosely: policy-adaptive image guardrails involve VLM behavior, but this is safety/benchmarking rather than spatial understanding or embodied AI.
**Relevance:** 3
**Novelty:** 5
