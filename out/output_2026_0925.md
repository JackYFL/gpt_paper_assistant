# Personalized Daily ArXiv Papers 09/25/2026
...
0. [HelloWorld: Towards Practical Applications of Generative Driving World Models](#link0)
...
1. [PUBG Ally: A Conversational Embodied Agent as an AI Teammate](#link1)
...
2. [Training Object Permanence in World Models](#link2)
...
3. [Qwen-Planner-Agent: A Closed-Loop AI-for-AI Framework for Real-World Mobile Planner Agents](#link3)
...
4. [ExplorationBench: Measuring AI Systems' Exploration in Verifiable Alien Worlds](#link4)
...
5. [FounRef: Robust, Structure-Preserving, and Fast Metric Refinement of Frozen Monocular Foundation Priors with Sparse Anchors](#link5)
**Authors:** Dan Halperin, Mirko M\"ahlisch

6. [MEVL-STP: Multi-Encoder and Vision Language Model for Arbitrarily Shaped Scene Text Spotting](#link6)
**Authors:** Aman Anand, Partha Pratim Roy, Shivakumara Palaiahnakote

7. [PAWS: Policy-driven Agentic World Simulation](#link7)
**Authors:** Tiviatis Sim, Jia Hui Woon, Xinming Gao, Chen Gao, Fengbin Zhu, Zheng Huanhuan, Chua Tat Seng, Kenji Kawaguchi

8. [DeltaWAM: Delta World Action Models for Bimanual Manipulation](#link8)
**Authors:** Han Yan, Zishang Xiang, Haokai Jiang, Zeyu Zhang, Qilin Wang, Weiyu Guo, Yandong Guo, Boxin Shi, Hao Tang

9. [Forecast-Dojo: Replayable Environments for Benchmarking and Training LLM Forecasting Agents](#link9)
...
10. [Less is More: Encoder-only Audio-Visual Segmentation](#link10)
**Authors:** Ilpo Viertola, Vladimir Iashin, Sophie T\"otterstr\"om, Esa Rahtu

11. [Mind What Matters for Reasoning: Aligning Cross-Modal Attention via Selective Probability Mass Concentration](#link11)
**Authors:** Jiaqi Deng, Zonghan Wu, Zhan Heng, Xiaoshui Huang, Huan Huo, Guandong Xu

12. [Direction-Scale Decomposition in Action Representation: Rethinking What to Tokenize for Vision-Language-Action Models](#link12)
**Authors:** Yufei Duan, Hang Yin, Alberta Longhini, Chao Tang, Danica Kragic

13. [M$^2$PFN: End-to-End Disentangled Alignment for Generalizable Multimodal In-Context Learning in Alzheimer's Disease](#link13)
**Authors:** Lujia Zhong, Shuo Huang, Jianwei Zhang, Xinyu Nie, Yonggang Shi

14. [Towards Practical Compression of 3D Gaussian Splatting](#link14)
**Authors:** Pengpeng Yu, Yueru Chen, Fei Song, Tai Qin, Qi Zhang, Jing Wang, Yulan Guo

15. [Hyperbolic Multimodal Continual Learning: A Closest-Admissible Solution](#link15)
**Authors:** Jiahong Liu, Ming Shen, Xiaohao Liu, Rex Ying, Menglin Yang, Tat-Seng Chua, Irwin King

16. [GRASP: Generating, Revising, and Assessing for Strategic Planning with Agentic AI](#link16)
**Authors:** Arunabh Srivastava (Amir), Mohammad A. (Amir), Khojastepour, Srimat Chakradhar, Sennur Ulukus

---
## 0. [HelloWorld: Towards Practical Applications of Generative Driving World Models](https://arxiv.org/abs/2609.28931) <a id="link0"></a>
**ArXiv ID:** 2609.28931
**Authors:** Fan Lu, Hanshi Wang, Zijing Wang, Quan Feng, Zhi Wang, Shijie Chen, Xianming Zeng, Yujian Zhang, Jiazhe Wang, Xin Zha, Kai Wang, Zhijie Zhao, Lin Zhu, Tianyi Yang, Yucheng Xu, Tao Ji, Haodong Zhang, Zhipeng Zhang, Peixi Peng, Guang Chen, Xingliang Liu, Lei Yang, Jianyun Xu
...
**Comment:** Matches criterion 3 closely: it presents a generative driving world model for controllable simulation, multi-sensor synthesis, and interactive driving data generation.
**Relevance:** 8
**Novelty:** 8

---

## 1. [PUBG Ally: A Conversational Embodied Agent as an AI Teammate](https://arxiv.org/abs/2609.29837) <a id="link1"></a>
**ArXiv ID:** 2609.29837
**Authors:** Beomsoo Kim, Byeongju Kim, Dohyun Kim, Dongwon Kim, Eunchong Kim, Hongmin Kim, Hyeojung Im, Hyeonbin Hwang, Hyeonghwan Kim, Hyoseok Seol, Insub Im, Irene Chen, Jaeseung Jeon, Jimin Hong, Kiyoon Yoo, Minkyoung Park, Seohyeon Jung, Seungjun Chung, Sue Hyun Park, Sungwoo Kim, Youngin Cho, Yujeong Son, Kangwook Lee, Hyunseung Kim
...
**Comment:** Matches criterion 3 very closely: it is an embodied AI system for a real game environment, with a new conversational teammate agent, real gameplay data, and live deployment.
**Relevance:** 9
**Novelty:** 7

---

## 2. [Training Object Permanence in World Models](https://arxiv.org/abs/2609.28654) <a id="link2"></a>
**ArXiv ID:** 2609.28654
**Authors:** Haotian Zhang, Fengyuan Yu, Dezhi Luo, Haoran Sun, Zehong Zhao, Qingying Gao, Yihan Li, Siyuan An, Huayi Qin, Yilan Zhang, Zhengze Jiang, Pinyuan Feng, Renrui Zhang, Ziyu Guo, Letian Wang, Mengyue Yang, Kangfu Mei, Maijunxian Wang, Ran Ji, Vikash Kumar, Freda Shi, Chandra Sripada, Vincent C. Muller, Philip Torr, Alan Yuille, Nikolaus Kriegeskorte, Felix Juefei-Xu, Lvmin Zhang, Jieneng Chen, Yilun Du, Hokin Deng
...
**Comment:** Matches criterion 4 closely: it uses video/world models and a cognitive-science-inspired training corpus to improve object permanence, a core visual reasoning capability.
**Relevance:** 7
**Novelty:** 8

---

## 3. [Qwen-Planner-Agent: A Closed-Loop AI-for-AI Framework for Real-World Mobile Planner Agents](https://arxiv.org/abs/2609.29892) <a id="link3"></a>
**ArXiv ID:** 2609.29892
**Authors:** Tingyu Qu, Weigao Sun, Yuecheng Liu, Yucheng Zhao, Yi Zhu, Yifeng Ding, Qiyi Wang, Sihan Cao, Pengkun Jiao, Hanlei Xie, Xiongwei Wu, Qichao Wang, Haodong Zhang, Jiajun Liu, Yuhao Wang, Yuqing Xie, Junpeng Zhao, Long Chen, Ming Ma, Sihan Yang, Ziwang Zhao, Yanhao Jia, Liangquan Gong, Feida Zhu, Yiran Zhong, Steven Hoi
...
**Comment:** Matches criterion 3 closely: it presents a new embodied/mobile planner-agent framework with closed-loop data generation, training, and deployment, centered on real-world agent interaction.
**Relevance:** 8
**Novelty:** 7

---

## 4. [ExplorationBench: Measuring AI Systems' Exploration in Verifiable Alien Worlds](https://arxiv.org/abs/2609.30199) <a id="link4"></a>
**ArXiv ID:** 2609.30199
**Authors:** Ming Zhang, Zhenghao Xiang, Peizhong Gao, Yujiong Shen, Yuhui Wang, Zhonghan Yue, Shihan Dou, Zhangyue Yin, Junjie Ye, Shichun Liu, Weihuang Zheng, Jiahao Chen, Jiayi Chen, Hongzhang Liu, Jiaqi Shao, Tao Gui, Qi Zhang, Xuanjing Huang, Suncong Zheng, Maxm Pan
...
**Comment:** Matches criterion 3 very closely: it introduces a new benchmark for exploration in verifiable simulated worlds, aimed at evaluating embodied-style exploration and discovery rather than standard recall.
**Relevance:** 7
**Novelty:** 7

---

## 5. [FounRef: Robust, Structure-Preserving, and Fast Metric Refinement of Frozen Monocular Foundation Priors with Sparse Anchors](https://arxiv.org/abs/2609.29224) <a id="link5"></a>
**ArXiv ID:** 2609.29224
**Authors:** Dan Halperin, Mirko M\"ahlisch
...
**Comment:** Matches criterion 4 closely: it refines a frozen monocular foundation prior using sparse metric anchors, which is a vision foundation model application for dense metric depth.
**Relevance:** 7
**Novelty:** 6

---

## 6. [MEVL-STP: Multi-Encoder and Vision Language Model for Arbitrarily Shaped Scene Text Spotting](https://arxiv.org/abs/2609.28857) <a id="link6"></a>
**ArXiv ID:** 2609.28857
**Authors:** Aman Anand, Partha Pratim Roy, Shivakumara Palaiahnakote
...
**Comment:** Matches criterion 2 very closely: it explicitly combines multiple frozen vision encoders with a vision-language model (Qwen3-VL) for scene text spotting.
**Relevance:** 8
**Novelty:** 5

---

## 7. [PAWS: Policy-driven Agentic World Simulation](https://arxiv.org/abs/2609.28547) <a id="link7"></a>
**ArXiv ID:** 2609.28547
**Authors:** Tiviatis Sim, Jia Hui Woon, Xinming Gao, Chen Gao, Fengbin Zhu, Zheng Huanhuan, Chua Tat Seng, Kenji Kawaguchi
...
**Comment:** Matches criterion 3 closely: it builds a new agentic world simulation dataset for policy-driven financial multi-agent simulation, with aligned historical evidence and replay-style evaluation.
**Relevance:** 6
**Novelty:** 6

---

## 8. [DeltaWAM: Delta World Action Models for Bimanual Manipulation](https://arxiv.org/abs/2609.28811) <a id="link8"></a>
**ArXiv ID:** 2609.28811
**Authors:** Han Yan, Zishang Xiang, Haokai Jiang, Zeyu Zhang, Qilin Wang, Weiyu Guo, Yandong Guo, Boxin Shi, Hao Tang
...
**Comment:** Matches criterion 1 closely: it proposes a new embodied control method for bimanual manipulation using world-action models and delta prediction.
**Relevance:** 5
**Novelty:** 7

---

## 9. [Forecast-Dojo: Replayable Environments for Benchmarking and Training LLM Forecasting Agents](https://arxiv.org/abs/2609.28876) <a id="link9"></a>
**ArXiv ID:** 2609.28876
**Authors:** Liqin Ye, Haorui Wang, Fardin Ahmed, Rongzhi Zhang, Yuan He, Ziyuan Lin, Yanbin Yin, Jing Peng, Michael Galarnyk, Sudheer Chava, Chao Zhang
...
**Comment:** Matches criterion 3 closely: it builds a replayable benchmark/environment for training and evaluating LLM forecasting agents, with a simulator-like setup and a new evaluation protocol.
**Relevance:** 5
**Novelty:** 7

---

## 10. [Less is More: Encoder-only Audio-Visual Segmentation](https://arxiv.org/abs/2609.29121) <a id="link10"></a>
**ArXiv ID:** 2609.29121
**Authors:** Ilpo Viertola, Vladimir Iashin, Sophie T\"otterstr\"om, Esa Rahtu
...
**Comment:** Matches criterion 4 closely: it is a vision foundation model application in audio-visual semantic segmentation, and it emphasizes a simpler encoder-only design with strong empirical results.
**Relevance:** 6
**Novelty:** 5

---

## 11. [Mind What Matters for Reasoning: Aligning Cross-Modal Attention via Selective Probability Mass Concentration](https://arxiv.org/abs/2609.29940) <a id="link11"></a>
**ArXiv ID:** 2609.29940
**Authors:** Jiaqi Deng, Zonghan Wu, Zhan Heng, Xiaoshui Huang, Huan Huo, Guandong Xu
...
**Comment:** Matches criterion 2 closely: it studies and improves multimodal large language models via selective cross-modal attention grounding, i.e. a direct MLLM method.
**Relevance:** 5
**Novelty:** 6

---

## 12. [Direction-Scale Decomposition in Action Representation: Rethinking What to Tokenize for Vision-Language-Action Models](https://arxiv.org/abs/2609.28865) <a id="link12"></a>
**ArXiv ID:** 2609.28865
**Authors:** Yufei Duan, Hang Yin, Alberta Longhini, Chao Tang, Danica Kragic
...
**Comment:** Matches criterion 1 closely: it proposes a new action representation/tokenization strategy for vision-language-action models aimed at better spatial/motion understanding in embodied manipulation.
**Relevance:** 5
**Novelty:** 6

---

## 13. [M$^2$PFN: End-to-End Disentangled Alignment for Generalizable Multimodal In-Context Learning in Alzheimer's Disease](https://arxiv.org/abs/2609.28836) <a id="link13"></a>
**ArXiv ID:** 2609.28836
**Authors:** Lujia Zhong, Shuo Huang, Jianwei Zhang, Xinyu Nie, Yonggang Shi
...
**Comment:** Matches criterion 4 closely: it adapts a tabular foundation model to multimodal medical prediction with end-to-end multimodal alignment and in-context learning.
**Relevance:** 5
**Novelty:** 6

---

## 14. [Towards Practical Compression of 3D Gaussian Splatting](https://arxiv.org/abs/2609.30245) <a id="link14"></a>
**ArXiv ID:** 2609.30245
**Authors:** Pengpeng Yu, Yueru Chen, Fei Song, Tai Qin, Qi Zhang, Jing Wang, Yulan Guo
...
**Comment:** Matches criterion 4 very closely: it is about 3D Gaussian Splatting compression, which is tightly connected to vision foundation-model applications in novel-view synthesis / 3D vision.
**Relevance:** 5
**Novelty:** 6

---

## 15. [Hyperbolic Multimodal Continual Learning: A Closest-Admissible Solution](https://arxiv.org/abs/2609.29329) <a id="link15"></a>
**ArXiv ID:** 2609.29329
**Authors:** Jiahong Liu, Ming Shen, Xiaohao Liu, Rex Ying, Menglin Yang, Tat-Seng Chua, Irwin King
...
**Comment:** Matches criterion 4 closely: it is about hyperbolic multimodal continual learning, relevant to multimodal representation learning and foundation-model-style transfer.
**Relevance:** 4
**Novelty:** 6

---

## 16. [GRASP: Generating, Revising, and Assessing for Strategic Planning with Agentic AI](https://arxiv.org/abs/2609.30147) <a id="link16"></a>
**ArXiv ID:** 2609.30147
**Authors:** Arunabh Srivastava (Amir), Mohammad A. (Amir), Khojastepour, Srimat Chakradhar, Sennur Ulukus
...
**Comment:** Does not match any criterion very closely; it is an agentic planning framework for LLMs, which is adjacent to the friend's interests but not specific to vision/embodied AI or multimodal foundation models.
**Relevance:** 3
**Novelty:** 5
