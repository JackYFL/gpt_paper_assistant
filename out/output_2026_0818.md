# Personalized Daily ArXiv Papers 08/18/2026
...
0. [VibeWorlding: Can Multimodal Agents Construct 3D Open Worlds End-to-End?](#link0)
**Authors:** Yansong Ning, Jingwen Ye, Zhongkai Wu, Yang Sun, Yiqin Zhu, Xingyi Li, Weidong Zhang, Hao Liu

1. [Emergent 3D Instance Segmentation from Self-Supervised Point Transformers](#link1)
**Authors:** Ted Lentsch, Santiago Montiel-Mar\'in, Holger Caesar, Julian F. P. Kooij

2. [MOSS-VL Technical Report](#link2)
...
3. [Beyond Similarity Matching: Structured Reasoning for Open-Vocabulary Referring Segmentation in 3DGS](#link3)
**Authors:** Yizhao Wang, Xinfa Wang, Jingbo Wang, Jingbo Wang, Guantao Zhang, Yafeng Han, Guohong Gao, Yuhe Xia

4. [HarnessEval-W: Agentifying the Evaluation of Visual Worlds](#link4)
...
5. [SplatGuide: Geometric Priors from 3D Gaussians for Pose-Free Novel View Synthesis](#link5)
**Authors:** Yejun Zhang, Zihan Wang, Xu Ji, Yihao Wang, Yuxin Hou, Junyuan Fang, Juho-Matti Kilpel\"ainen, Arno Solin, Hamed Rezazadegan Tavakoli, Esa Rahtu, Juho Kannala

6. [PersonaDrive: Controllable Trajectory Prediction with Multi-Dimensional Driving Personas](#link6)
**Authors:** Chan Lee, Kimin Yun, Yuseok Bae, Seong Tae Kim, Jung Uk Kim

7. [MetaReason: Precise Interleaved Multimodal Reasoning via Editing Meta Information for Solving Geometry Problems](#link7)
**Authors:** Penghao Yin, Haomin Wang, Qihong Tang, Xiaoye Qu, Hongjie Zhang, Xiao-Ping Zhang

8. [CoM$^3$eT: A foundation model for medical image analysis through federated, multidimensional context integration](#link8)
**Authors:** J. Raphael Sch\"afer, Kai Geissler, Till Nicke, Chiara Tappermann, Karoline Heber, Eike Petersen, Habib Mergan, Lars Ole Schwen, Nick Weiss, Annika Gerken, Jan Hendrik Moltz, Tom Bisson, Isil Dogan O, Tim-Rasmus Kiehl, Norman Zerbe, Sefer Elezkurtaj, Robin S. Mayer, Nadine Flinner, Peter Wild, Isabel Dahm, Felix Peisen, Heinrich von Busch, Robert Grimm, Sebastian Arndt, Lisa Siegler, Matthias Stefan May, Antje Prasse, Natalia Artysh, Fabian Kiessling, Johannes Lotz

9. [Remote-Sensing City Layout Extraction with MLLM](#link9)
**Authors:** Zigan Zhou, Kai Li, Yupeng Deng

10. [An Empirical Study of Training Pixel-Space Text-to-Image Diffusion Models](#link10)
...
11. [PixelControl: Fine-Grained Condition Fidelity in Text-to-Image Diffusion](#link11)
**Authors:** Xin Lin, Haodong Li, Zhifei Zhang, Yutong Yang, Haitian Zheng, Juanxi Tian, Zhe Lin, Truong Nguyen

12. [TRACE-Bench: Decomposing and Diagnosing Multi-Reference Image Generation](#link12)
**Authors:** Haoran Wang, Chaofan Ma, Ran Yi, Lizhuang Ma

13. [GenRouter: Unified Workflow Routing for Agentic Image Generation](#link13)
**Authors:** Harold Haodong Chen, Zhiyu Hou, Wen-Jie Shu, Weilin Ruan, Yingjie Xu, Litao Guo, Ying-Cong Chen

14. [Unlocking the Potential of Image Editing via Concept Scaling and Dense Supervision](#link14)
**Authors:** Long Cui, Xiaoqian Liu, Qi Qin, Yi Xin, Tao Lin, Jianguo Li, Linfeng Zhang

15. [MegaParts: Scaling Part-Aware 3D Object Generation to 300 Parts via Token-Efficient Autoregressive Modeling](#link15)
...
16. [Beyond Accuracy: Assessing Calibration of Geospatial Foundation Models and Their Sensitivity to Distribution Shifts](#link16)
**Authors:** Nils Lehmann, Jakob Gawlikowski, Burak Ekim, Isaac Corley, Xiao Xiang Zhu

17. [Trajectory-Level Automatic Curriculum Learning for Legged Locomotion on Unstructured Terrain](#link17)
**Authors:** Rocky Liu, Tengyu Liu, Baoxiong Jia, Fangwei Zhong, Xinyi Tong, Hongzhao Xie, Siyuan Huang

18. [Scalable Black-Box Model Attribution for Images](#link18)
**Authors:** Asaf Livne, Amir Jevnisek, Shai Avidan

19. [ES3D: Embedding Semantics into 3D Space for Component-Aware Editing](#link19)
**Authors:** Xuancheng Jin, Rengan Xie, Jiayuan Lu, Wenting Zheng, Rui Wang, Yuchi Huo, Lincheng Li, Yingfeng Chen

20. [ConceptFormer: Learning Adaptive Latent Concepts for Query-Document Alignment in Visual Document Retrieval](#link20)
...
21. [CM-MAE: A Physics-Guided Cross-Modal Self-Supervised Learning Framework for Vision-Wireless Applications](#link21)
**Authors:** Yubo Zhang, Yiyao Liu

22. [CLARA: Clip-Level Multimodal Alignment with VLM-Derived Rationales for Hateful Video Detection](#link22)
**Authors:** Yuchen Zhang, Shuang Dai, Zeyu Fu, Yunfei Long, Ravi Shekhar, Haralambos Mouratidis

23. [BASeg: Boundary-Aware Remote Sensing Segmentation with Structural Penalties](#link23)
**Authors:** Yuexi Song, Kailai Sun, Zhuoyu Wang, Mingyi He, Paul Pu Liang, Shenhao Wang, Jinhua Zhao

24. [Depth-Dominant Skeleton Detection for Natural Scenes](#link24)
**Authors:** Chengkun Rao, Yixuan Deng, Min Li, Yangjun Ou, Ye Li, Ziwei Luo, Zhaojing Wang, Junwei Tang, Bangchao Wang, Xiaoyun Yan

25. [Hierarchical Adaptive Feature Refinement Network for VHR Remote Sensing Image Segmentation](#link25)
**Authors:** Shuaishuai Cao, Meng Tang, Shuwei Peng, Xuan Liu, Min Huang, Jie Chen, Jiacheng Niu, Yong Chen, Edore Akpokodje, Hui Lin

---
## 0. [VibeWorlding: Can Multimodal Agents Construct 3D Open Worlds End-to-End?](https://arxiv.org/abs/2608.15265) <a id="link0"></a>
**ArXiv ID:** 2608.15265
**Authors:** Yansong Ning, Jingwen Ye, Zhongkai Wu, Yang Sun, Yiqin Zhu, Xingyi Li, Weidong Zhang, Hao Liu
...
**Comment:** Matches criterion 3 very closely: an embodied/multimodal agent benchmark and RL training framework for constructing interactive 3D open worlds.
**Relevance:** 9
**Novelty:** 7

---

## 1. [Emergent 3D Instance Segmentation from Self-Supervised Point Transformers](https://arxiv.org/abs/2608.15796) <a id="link1"></a>
**ArXiv ID:** 2608.15796
**Authors:** Ted Lentsch, Santiago Montiel-Mar\'in, Holger Caesar, Julian F. P. Kooij
...
**Comment:** Strong match to criterion 1: it studies emergent spatial/3D instance structure in self-supervised point transformers and turns that into a prior-free 3D segmentation method.
**Relevance:** 8
**Novelty:** 7

---

## 2. [MOSS-VL Technical Report](https://arxiv.org/abs/2608.15045) <a id="link2"></a>
**ArXiv ID:** 2608.15045
**Authors:** Pengyu Wang, Chenkun Tan, Shaojun Zhou, Qirui Zhou, Yanxin Chen, Xingyang He, Huazheng Zeng, Jijun Cheng, Chenghao Wang, Xiaomeng Qian, Pengfei Wang, Zhan Huang, Shanqing Gao, Wei Huang, Longjun Cao, Wu Ran, Jie Liu, Changtai Zhu, Hongkai Wang, Yixian Tian, Chenghao Liu, Zhen Ye, Xinghao Wang, Botian Jiang, Guoguo Feng, Zhaoye Fei, Ruixiao Li, Mingshu Chen, Yang Gao, Qinyuan Cheng, Shimin Li, Xipeng Qiu
...
**Comment:** Matches criterion 2 closely: a new open vision-language model family for real-time streaming interaction and proactive perception-while-speaking.
**Relevance:** 8
**Novelty:** 6

---

## 3. [Beyond Similarity Matching: Structured Reasoning for Open-Vocabulary Referring Segmentation in 3DGS](https://arxiv.org/abs/2608.16103) <a id="link3"></a>
**ArXiv ID:** 2608.16103
**Authors:** Yizhao Wang, Xinfa Wang, Jingbo Wang, Jingbo Wang, Guantao Zhang, Yafeng Han, Guohong Gao, Yuhe Xia
...
**Comment:** Matches criterion 1 and 4: language-guided open-vocabulary referring segmentation in 3DGS with explicit spatial/part-relation reasoning.
**Relevance:** 6
**Novelty:** 7

---

## 4. [HarnessEval-W: Agentifying the Evaluation of Visual Worlds](https://arxiv.org/abs/2608.16859) <a id="link4"></a>
**ArXiv ID:** 2608.16859
**Authors:** Weiliang Chen, Haowen Sun, Jun Gao, Jiawei Chi, Hanyang Wang, Qiyu Dai, Yihao Li, Hao Li, Jingnan Gao, Yi-Hsin Hung, Xingzhuo Guo, Shangchen Miao, Zhiyuan Shi, Xiang Li, Fengrui Tian, Weihua Du, Ziqi Huang, Shenyuan Gao, Siqiao Huang, Mingyu Liu, Yifei Li, Shizun Wang, Xi Wang, Tianqi Zhang, Xue Luo, Xiyin Ren, Jinshan Ren, Xiaoyang Shen, Xiaobo Hu, Zhiyang Dou, Mingyu Ding, Yichao Yan, Xinchao Wang, Yizhou Wang, Shilong Liu, Wenzhao Zheng, Yueqi Duan, Yuan Gong, Ziwei Liu, Ming-Yu Liu, Jialong Wu, Jiangran Lyu, Fangfu Liu
...
**Comment:** Matches criterion 3 closely: it is a benchmark/evaluation paper for world models, with a new agentified evaluation pipeline for visual worlds.
**Relevance:** 5
**Novelty:** 7

---

## 5. [SplatGuide: Geometric Priors from 3D Gaussians for Pose-Free Novel View Synthesis](https://arxiv.org/abs/2608.16863) <a id="link5"></a>
**ArXiv ID:** 2608.16863
**Authors:** Yejun Zhang, Zihan Wang, Xu Ji, Yihao Wang, Yuxin Hou, Junyuan Fang, Juho-Matti Kilpel\"ainen, Arno Solin, Hamed Rezazadegan Tavakoli, Esa Rahtu, Juho Kannala
...
**Comment:** Matches criterion 4: pose-free novel view synthesis using 3D Gaussian priors and multi-view diffusion, which is directly in vision foundation model / 3D reconstruction applications.
**Relevance:** 6
**Novelty:** 6

---

## 6. [PersonaDrive: Controllable Trajectory Prediction with Multi-Dimensional Driving Personas](https://arxiv.org/abs/2608.15230) <a id="link6"></a>
**ArXiv ID:** 2608.15230
**Authors:** Chan Lee, Kimin Yun, Yuseok Bae, Seong Tae Kim, Jung Uk Kim
...
**Comment:** Matches criterion 1 closely: proposes controllable trajectory prediction with multi-dimensional driving personas for embodied driving behavior.
**Relevance:** 6
**Novelty:** 5

---

## 7. [MetaReason: Precise Interleaved Multimodal Reasoning via Editing Meta Information for Solving Geometry Problems](https://arxiv.org/abs/2608.15006) <a id="link7"></a>
**ArXiv ID:** 2608.15006
**Authors:** Penghao Yin, Haomin Wang, Qihong Tang, Xiaoye Qu, Hongjie Zhang, Xiao-Ping Zhang
...
**Comment:** Matches criterion 2 closely: introduces a new multimodal VLM-style reasoning framework with interleaved visual/text reasoning and a new benchmark.
**Relevance:** 6
**Novelty:** 5

---

## 8. [CoM$^3$eT: A foundation model for medical image analysis through federated, multidimensional context integration](https://arxiv.org/abs/2608.16268) <a id="link8"></a>
**ArXiv ID:** 2608.16268
**Authors:** J. Raphael Sch\"afer, Kai Geissler, Till Nicke, Chiara Tappermann, Karoline Heber, Eike Petersen, Habib Mergan, Lars Ole Schwen, Nick Weiss, Annika Gerken, Jan Hendrik Moltz, Tom Bisson, Isil Dogan O, Tim-Rasmus Kiehl, Norman Zerbe, Sefer Elezkurtaj, Robin S. Mayer, Nadine Flinner, Peter Wild, Isabel Dahm, Felix Peisen, Heinrich von Busch, Robert Grimm, Sebastian Arndt, Lisa Siegler, Matthias Stefan May, Antje Prasse, Natalia Artysh, Fabian Kiessling, Johannes Lotz
...
**Comment:** Matches criterion 4 closely: a medical vision foundation model with federated training and cross-domain image analysis applications.
**Relevance:** 5
**Novelty:** 6

---

## 9. [Remote-Sensing City Layout Extraction with MLLM](https://arxiv.org/abs/2608.16484) <a id="link9"></a>
**ArXiv ID:** 2608.16484
**Authors:** Zigan Zhou, Kai Li, Yupeng Deng
...
**Comment:** Matches criterion 2 closely: it uses an MLLM for remote-sensing layout extraction and code generation, i.e. a new multimodal large language model application with structured visual reasoning.
**Relevance:** 5
**Novelty:** 6

---

## 10. [An Empirical Study of Training Pixel-Space Text-to-Image Diffusion Models](https://arxiv.org/abs/2608.16887) <a id="link10"></a>
**ArXiv ID:** 2608.16887
**Authors:** Dengyang Jiang, Ruoyi Du, Zhennan Chen, Dongyang Liu, Zanyi Wang, Mingzhe Zheng, Xiangpeng Yang, Huanqia Cai, Aiming Hao, Yuming Jiang, Peng Gao, Harry Yang, Steven Hoi
...
**Comment:** No direct criterion match; it is a generative modeling paper, but focused on pixel-space text-to-image diffusion training rather than a new multimodal model or embodied AI.
**Relevance:** 4
**Novelty:** 7

---

## 11. [PixelControl: Fine-Grained Condition Fidelity in Text-to-Image Diffusion](https://arxiv.org/abs/2608.15705) <a id="link11"></a>
**ArXiv ID:** 2608.15705
**Authors:** Xin Lin, Haodong Li, Zhifei Zhang, Yutong Yang, Haitian Zheng, Juanxi Tian, Zhe Lin, Truong Nguyen
...
**Comment:** Matches criterion 4: a controllable text-to-image diffusion method focused on fine-grained spatial condition fidelity and boundary preservation.
**Relevance:** 5
**Novelty:** 6

---

## 12. [TRACE-Bench: Decomposing and Diagnosing Multi-Reference Image Generation](https://arxiv.org/abs/2608.16765) <a id="link12"></a>
**ArXiv ID:** 2608.16765
**Authors:** Haoran Wang, Chaofan Ma, Ran Yi, Lizhuang Ma
...
**Comment:** Matches criterion 2 and 4: a benchmark for multi-reference image generation with a compositional diagnostic formulation, useful for evaluating multimodal generative models.
**Relevance:** 5
**Novelty:** 6

---

## 13. [GenRouter: Unified Workflow Routing for Agentic Image Generation](https://arxiv.org/abs/2608.16721) <a id="link13"></a>
**ArXiv ID:** 2608.16721
**Authors:** Harold Haodong Chen, Zhiyu Hou, Wen-Jie Shu, Weilin Ruan, Yingjie Xu, Litao Guo, Ying-Cong Chen
...
**Comment:** Matches criterion 4: this is a vision-generation routing system built on agentic image-generation workflows, with a new framework for adaptive workflow selection.
**Relevance:** 5
**Novelty:** 6

---

## 14. [Unlocking the Potential of Image Editing via Concept Scaling and Dense Supervision](https://arxiv.org/abs/2608.16812) <a id="link14"></a>
**ArXiv ID:** 2608.16812
**Authors:** Long Cui, Xiaoqian Liu, Qi Qin, Yi Xin, Tao Lin, Jianguo Li, Linfeng Zhang
...
**Comment:** Matches criterion 4 partially: image editing with concept scaling and dense supervision, relevant to vision foundation model applications and generative modeling.
**Relevance:** 4
**Novelty:** 6

---

## 15. [MegaParts: Scaling Part-Aware 3D Object Generation to 300 Parts via Token-Efficient Autoregressive Modeling](https://arxiv.org/abs/2608.14783) <a id="link15"></a>
**ArXiv ID:** 2608.14783
**Authors:** Manwen Liao, Xinyu Lian, Jian Mao, Kaixu Chen, Li Luo, Jinghao Yan, Wanshui Gan, Qiao Yu, Weitian Zhang, Chunhua Shen, Guang Chen, Bo Dai, Xudong Xu, Zhaoyang Lyu
...
**Comment:** Matches criterion 4 partially: vision/3D generative modeling with scalable token-efficient autoregressive generation, though not a foundation model paper per se.
**Relevance:** 4
**Novelty:** 6

---

## 16. [Beyond Accuracy: Assessing Calibration of Geospatial Foundation Models and Their Sensitivity to Distribution Shifts](https://arxiv.org/abs/2608.16614) <a id="link16"></a>
**ArXiv ID:** 2608.16614
**Authors:** Nils Lehmann, Jakob Gawlikowski, Burak Ekim, Isaac Corley, Xiao Xiang Zhu
...
**Comment:** Matches criterion 4: a careful evaluation of geospatial foundation models, emphasizing calibration and distribution shift rather than just accuracy.
**Relevance:** 5
**Novelty:** 5

---

## 17. [Trajectory-Level Automatic Curriculum Learning for Legged Locomotion on Unstructured Terrain](https://arxiv.org/abs/2608.16164) <a id="link17"></a>
**ArXiv ID:** 2608.16164
**Authors:** Rocky Liu, Tengyu Liu, Baoxiong Jia, Fangwei Zhong, Xinyi Tong, Hongzhao Xie, Siyuan Huang
...
**Comment:** Matches criterion 3: this is an embodied locomotion method with a novel trajectory-level automatic curriculum for unstructured terrain.
**Relevance:** 5
**Novelty:** 5

---

## 18. [Scalable Black-Box Model Attribution for Images](https://arxiv.org/abs/2608.15652) <a id="link18"></a>
**ArXiv ID:** 2608.15652
**Authors:** Asaf Livne, Amir Jevnisek, Shai Avidan
...
**Comment:** No very close match to the listed criteria; it is more about black-box image model attribution than embodied AI, VLLMs/MLLMs, or vision foundation model applications.
**Relevance:** 3
**Novelty:** 6

---

## 19. [ES3D: Embedding Semantics into 3D Space for Component-Aware Editing](https://arxiv.org/abs/2608.15749) <a id="link19"></a>
**ArXiv ID:** 2608.15749
**Authors:** Xuancheng Jin, Rengan Xie, Jiayuan Lu, Wenting Zheng, Rui Wang, Yuchi Huo, Lincheng Li, Yingfeng Chen
...
**Comment:** Matches criterion 4 partially: uses multimodal semantics for component-aware 3D editing, relevant to vision foundation model applications.
**Relevance:** 4
**Novelty:** 5

---

## 20. [ConceptFormer: Learning Adaptive Latent Concepts for Query-Document Alignment in Visual Document Retrieval](https://arxiv.org/abs/2608.15698) <a id="link20"></a>
**ArXiv ID:** 2608.15698
**Authors:** Peng Chunyi, Xu Zhipeng, Yan Yukun, Liu Zhenghao, Yu Shi, Mei Sen, Sun Yubo, Zhang Yongheng, Zhou Jie, Gu Yu, Yu Ge, Sun Maosong
...
**Comment:** Matches criterion 4 closely: vision foundation model methods applied to visual document retrieval, with latent concept alignment.
**Relevance:** 4
**Novelty:** 5

---

## 21. [CM-MAE: A Physics-Guided Cross-Modal Self-Supervised Learning Framework for Vision-Wireless Applications](https://arxiv.org/abs/2608.15972) <a id="link21"></a>
**ArXiv ID:** 2608.15972
**Authors:** Yubo Zhang, Yiyao Liu
...
**Comment:** Matches criterion 4: a new self-supervised cross-modal pretraining method for vision-wireless representation learning, with a notable statistical trick via soft contrastive alignment.
**Relevance:** 4
**Novelty:** 5

---

## 22. [CLARA: Clip-Level Multimodal Alignment with VLM-Derived Rationales for Hateful Video Detection](https://arxiv.org/abs/2608.15905) <a id="link22"></a>
**ArXiv ID:** 2608.15905
**Authors:** Yuchen Zhang, Shuang Dai, Zeyu Fu, Yunfei Long, Ravi Shekhar, Haralambos Mouratidis
...
**Comment:** Matches criterion 2 only loosely through VLM-derived rationales, but the main task is hateful video detection rather than a new VLLM/MLLM.
**Relevance:** 3
**Novelty:** 5

---

## 23. [BASeg: Boundary-Aware Remote Sensing Segmentation with Structural Penalties](https://arxiv.org/abs/2608.15683) <a id="link23"></a>
**ArXiv ID:** 2608.15683
**Authors:** Yuexi Song, Kailai Sun, Zhuoyu Wang, Mingyi He, Paul Pu Liang, Shenhao Wang, Jinhua Zhao
...
**Comment:** No very close criterion match; it is remote-sensing segmentation with a new loss and benchmark, adjacent to vision applications but not embodied AI or VLMs.
**Relevance:** 3
**Novelty:** 5

---

## 24. [Depth-Dominant Skeleton Detection for Natural Scenes](https://arxiv.org/abs/2608.16367) <a id="link24"></a>
**ArXiv ID:** 2608.16367
**Authors:** Chengkun Rao, Yixuan Deng, Min Li, Yangjun Ou, Ye Li, Ziwei Luo, Zhaojing Wang, Junwei Tang, Bangchao Wang, Xiaoyun Yan
...
**Comment:** No direct criterion match, though it is a spatial perception method; the depth-dominant idea is about skeleton detection in natural scenes rather than embodied spatial intelligence.
**Relevance:** 3
**Novelty:** 5

---

## 25. [Hierarchical Adaptive Feature Refinement Network for VHR Remote Sensing Image Segmentation](https://arxiv.org/abs/2608.15647) <a id="link25"></a>
**ArXiv ID:** 2608.15647
**Authors:** Shuaishuai Cao, Meng Tang, Shuwei Peng, Xuan Liu, Min Huang, Jie Chen, Jiacheng Niu, Yong Chen, Edore Akpokodje, Hui Lin
...
**Comment:** No very close criterion match; it is a remote-sensing segmentation method with pretrained hierarchical encoders, which is adjacent to criterion 4 but not really about vision foundation models themselves.
**Relevance:** 3
**Novelty:** 4
