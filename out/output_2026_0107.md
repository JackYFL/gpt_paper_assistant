...
0. [Unified Thinker: A General Reasoning Modular Core for Image Generation](#link0)
...
1. [UniCorn: Towards Self-Improving Unified Multimodal Models through Self-Generated Supervision](#link1)
...
2. [AbductiveMLLM: Boosting Visual Abductive Reasoning Within MLLMs](#link2)
**Authors:** Boyu Chang, Qi Wang, Xi Guo, Zhixiong Nan, Yazhou Yao, Tianfei Zhou

3. [MMP-A*: Multimodal Perception Enhanced Incremental Heuristic Search on Path Planning](#link3)
**Authors:** Minh Hieu Ha, Khanh Ly Ta, Hung Phan, Tung Doan, Tung Dao, Dao Tran, Huynh Thi Thanh Binh

4. [Watch Wider and Think Deeper: Collaborative Cross-modal Chain-of-Thought for Complex Visual Reasoning](#link4)
...
6. [Unveiling and Bridging the Functional Perception Gap in MLLMs: Atomic Visual Alignment and Hierarchical Evaluation via PET-Bench](#link6)
...
7. [Text-Guided Layer Fusion Mitigates Hallucination in Multimodal LLMs](#link7)
**Authors:** Chenchen Lin, Sanbao Su, Rachel Luo, Yuxiao Chen, Yan Wang, Marco Pavone, Fei Miao

8. [PatchAlign3D: Local Feature Alignment for Dense 3D Shape understanding](#link8)
**Authors:** Souhail Hadgi, Bingchen Gong, Ramana Sundararaman, Emery Pierson, Lei Li, Peter Wonka, Maks Ovsjanikov

9. [TA-Prompting: Enhancing Video Large Language Models for Dense Video Captioning via Temporal Anchors](#link9)
**Authors:** Wei-Yuan Cheng, Kai-Po Chang, Chi-Pin Huang, Fu-En Yang, Yu-Chiang Frank Wang

10. [A unified multimodal understanding and generation model for cross-disciplinary scientific research](#link10)
**Authors:** Xiaomeng Yang, Zhiyu Tan, Xiaohui Zhong, Mengping Yang, Qiusheng Huang, Lei Chen, Libo Wu, Hao Li

11. [Zoom-IQA: Image Quality Assessment with Reliable Region-Aware Reasoning](#link11)
**Authors:** Guoqiang Liang, Jianyi Wang, Zhonghua Wu, Shangchen Zhou

12. [PrismVAU: Prompt-Refined Inference System for Multimodal Video Anomaly Understanding](#link12)
**Authors:** I\~naki Erregue, Kamal Nasrollahi, Sergio Escalera

13. [HOLO: Homography-Guided Pose Estimator Network for Fine-Grained Visual Localization on SD Maps](#link13)
**Authors:** Xuchang Zhong, Xu Cao, Jinke Feng, Hao Fang

14. [OpenSocInt: A Multi-modal Training Environment for Human-Aware Social Navigation](#link14)
**Authors:** Victor Sanchez, Chris Reinke, Ahamed Mohamed, Xavier Alameda-Pineda

15. [SA-ResGS: Self-Augmented Residual 3D Gaussian Splatting for Next Best View Selection](#link15)
**Authors:** Kim Jun-Seong, Tae-Hyun Oh, Eduardo P\'erez-Pellitero, Youngkyoon Jang

16. [Robust Mesh Saliency GT Acquisition in VR via View Cone Sampling and Geometric Smoothing](#link16)
**Authors:** Guoquan Zheng, Jie Hao, Huiyu Duan, Yongming Han, Liang Yuan, Dong Zhang, Guangtao Zhai

17. [Yuan3.0 Flash: An Open Multimodal Large Language Model for Enterprise Applications](#link17)
...
18. [LAMS-Edit: Latent and Attention Mixing with Schedulers for Improved Content Preservation in Diffusion-Based Image and Style Editing](#link18)
**Authors:** Wingwa Fu, Takayuki Okatani

19. [Evaluating the Diagnostic Classification Ability of Multimodal Large Language Models: Insights from the Osteoarthritis Initiative](#link19)
**Authors:** Li Wang, Xi Chen, XiangWen Deng, HuaHui Yi, ZeKun Jiang, Kang Li, Jian Li

20. [Shallow- and Deep-fake Image Manipulation Localization Using Vision Mamba and Guided Graph Neural Network](#link20)
**Authors:** Junbin Zhang, Hamid Reza Tohidypour, Yixiao Wang, Panos Nasiopoulos

21. [Understanding Multi-Agent Reasoning with Large Language Models for Cartoon VQA](#link21)
**Authors:** Tong Wu, Thanet Markchom

22. [VTONQA: A Multi-Dimensional Quality Assessment Dataset for Virtual Try-on](#link22)
**Authors:** Xinyi Wei, Sijing Wu, Zitong Xu, Yunhao Li, Huiyu Duan, Xiongkuo Min, Guangtao Zhai

23. [InfiniDepth: Arbitrary-Resolution and Fine-Grained Depth Estimation with Neural Implicit Fields](#link23)
**Authors:** Hao Yu, Haotong Lin, Jiawei Wang, Jiaxin Li, Yida Wang, Xueyang Zhang, Yue Wang, Xiaowei Zhou, Ruizhen Hu, Sida Peng

24. [Towards Agnostic and Holistic Universal Image Segmentation with Bit Diffusion](#link24)
**Authors:** Jakob L{\o}nborg Christensen, Morten Rieger Hannemose, Anders Bjorholm Dahl, Vedrana Andersen Dahl

25. [Towards Efficient 3D Object Detection for Vehicle-Infrastructure Collaboration via Risk-Intent Selection](#link25)
**Authors:** Li Wang, Boqi Li, Hang Chen, Xingjian Wu, Yichen Wang, Jiewen Tan, Xinyu Zhang, Huaping Liu

26. [D$^3$R-DETR: DETR with Dual-Domain Density Refinement for Tiny Object Detection in Aerial Images](#link26)
**Authors:** Zixiao Wen, Zhen Yang, Xianjie Bao, Lei Zhang, Xiantai Xiang, Wenshuai Li, Yuhan Liu

27. [Jenius Agent: Towards Experience-Driven Accuracy Optimization in Real-World Scenarios](#link27)
**Authors:** Defei Xia, Bingfeng Pi, Shenbin Zhang, Song Hua, Yunfei Wei, Lei Zuo

28. [Beyond Gemini-3-Pro: Revisiting LLM Routing and Aggregation at Scale](#link28)
**Authors:** Shengji Tang, Weihao Lin, Jingqi Ye, Hao Li, Bo Zhang, Shuyue Hu, Tao Chen, Wangli Ouyang, Lei Bai, Peng Ye

29. [EverMemOS: A Self-Organizing Memory Operating System for Structured Long-Horizon Reasoning](#link29)
...
30. [CaveAgent: Transforming LLMs into Stateful Runtime Operators](#link30)
...
31. [Topology-aware Pathological Consistency Matching for Weakly-Paired IHC Virtual Staining](#link31)
**Authors:** Mingzhou Jiang, Jiaying Zhou, Nan Zeng, Mickael Li, Qijie Tang, Chao He, Huazhu Fu, Honghui He

32. [Fine-Grained Generalization via Structuralizing Concept and Feature Space into Commonality, Specificity and Confounding](#link32)
**Authors:** Zhen Wang, Jiaojiao Zhao, Qilong Wang, Yongfeng Dong, Wenlong Yu

33. [DCG ReID: Disentangling Collaboration and Guidance Fusion Representations for Multi-modal Vehicle Re-Identification](#link33)
**Authors:** Aihua Zheng, Ya Gao, Shihao Li, Chenglong Li, Jin Tang

34. [Streaming Hallucination Detection in Long Chain-of-Thought Reasoning](#link34)
**Authors:** Haolang Lu, Minghui Pan, Ripeng Li, Guoshun Nan, Jialin Zhuang, Zijie Zhao, Zhongxiang Sun, Kun Wang, Yang Liu

35. [Digital Twin AI: Opportunities and Challenges from Large Language Models to World Models](#link35)
...
36. [ULS+: Data-driven Model Adaptation Enhances Lesion Segmentation](#link36)
**Authors:** Rianne Weber, Niels Rocholl, Max de Grauw, Mathias Prokop, Ewoud Smit, Alessa Hering

37. [Motion Blur Robust Wheat Pest Damage Detection with Dynamic Fuzzy Feature Fusion](#link37)
**Authors:** Han Zhang, Yanwei Wang, Fang Li, Hongjun Wang

38. [Foreground-Aware Dataset Distillation via Dynamic Patch Selection](#link38)
**Authors:** Longzhen Li, Guang Li, Ren Togo, Keisuke Maeda, Takahiro Ogawa, Miki Haseyama

---
## 0. [Unified Thinker: A General Reasoning Modular Core for Image Generation](https://arxiv.org/abs/2601.03127) <a id="link0"></a>
**ArXiv ID:** 2601.03127
**Authors:** Sashuai Zhou, Qiang Zhou, Jijin Hu, Hanqing Yang, Yue Cao, Junpeng Ma, Yinchao Ma, Jun Song, Tiezheng Ge, Cheng Yu, Bo Zheng, Zhou Zhao
...
**Comment:** Directly matches criterion 4 (vision foundation models and applications) and is highly relevant to generative modeling in multi-modal learning. Proposes Unified Thinker, a modular reasoning core for image generation, decoupling reasoning from generation and using RL for grounding. This is a novel approach to improving reasoning in generative vision models.
**Relevance:** 10
**Novelty:** 8

---

## 1. [UniCorn: Towards Self-Improving Unified Multimodal Models through Self-Generated Supervision](https://arxiv.org/abs/2601.03193) <a id="link1"></a>
**ArXiv ID:** 2601.03193
**Authors:** Ruiyan Han, Zhen Fang, XinYu Sun, Yuchen Ma, Ziheng Wang, Yu Zeng, Zehui Chen, Lin Chen, Wenxuan Huang, Wei-Jie Xu, Yi Cao, Feng Zhao
...
**Comment:** Matches criterion 2 (new MLLMs/VLLMs) and criterion 4 (vision foundation models and applications). UniCorn introduces a self-improvement framework for unified multimodal models, focusing on self-generated supervision and cycle-consistency benchmarks for image generation and comprehension.
**Relevance:** 9
**Novelty:** 8

---

## 2. [AbductiveMLLM: Boosting Visual Abductive Reasoning Within MLLMs](https://arxiv.org/abs/2601.02771) <a id="link2"></a>
**ArXiv ID:** 2601.02771
**Authors:** Boyu Chang, Qi Wang, Xi Guo, Zhixiong Nan, Yazhou Yao, Tianfei Zhou
...
**Comment:** Directly matches criterion 2 (new MLLMs) and criterion 4 (vision foundation models and applications). Proposes AbductiveMLLM, a new architecture for visual abductive reasoning, combining LLMs and diffusion models for improved multi-modal inference.
**Relevance:** 9
**Novelty:** 8

---

## 3. [MMP-A*: Multimodal Perception Enhanced Incremental Heuristic Search on Path Planning](https://arxiv.org/abs/2601.01910) <a id="link3"></a>
**ArXiv ID:** 2601.01910
**Authors:** Minh Hieu Ha, Khanh Ly Ta, Hung Phan, Tung Doan, Tung Dao, Dao Tran, Huynh Thi Thanh Binh
...
**Comment:** Matches criterion 1 (spatial intelligence on embodied agents) and criterion 3 (embodied AI, new methods for spatial reasoning). Proposes MMP-A*, a multimodal path planning framework integrating VLMs for spatial grounding, with a novel adaptive decay mechanism.
**Relevance:** 9
**Novelty:** 8

---

## 4. [Watch Wider and Think Deeper: Collaborative Cross-modal Chain-of-Thought for Complex Visual Reasoning](https://arxiv.org/abs/2601.02422) <a id="link4"></a>
**ArXiv ID:** 2601.02422
**Authors:** Wenting Lu, Didi Zhu, Tao Shen, Donglin Zhu, Ayong Ye, Chao Wu
...
**Comment:** Matches criterion 2 (new MLLM/VLLM) and criterion 4 (vision foundation models and applications). Proposes a new cross-modal chain-of-thought framework (CoCoT) for complex visual reasoning, with a new dataset and significant empirical improvements.
**Relevance:** 9
**Novelty:** 8
...
**Comment:** This paper presents EarthVL, a progressive Earth vision-language understanding and generation framework, including a new multi-modal dataset and a semantic-guided network for geospatial VQA and segmentation. It matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications), as it builds a new VLM for remote sensing and provides a new benchmark.
**Relevance:** 9
**Novelty:** 8

---

## 6. [Unveiling and Bridging the Functional Perception Gap in MLLMs: Atomic Visual Alignment and Hierarchical Evaluation via PET-Bench](https://arxiv.org/abs/2601.02737) <a id="link6"></a>
**ArXiv ID:** 2601.02737
**Authors:** Zanting Ye, Xiaolong Niu, Xuanbin Wu, Xu Han, Shengyuan Liu, Jing Hao, Zhihao Peng, Hao Sun, Jieqin Lv, Fanghu Wang, Yanchao Huang, Hubing Wu, Yixuan Yuan, Habib Zaidi, Arman Rahmim, Yefeng Zheng, Lijun Lu
...
**Comment:** Matches criterion 3 (embodied AI/new benchmarks or methods, novel angles). Introduces PET-Bench, a new large-scale functional imaging benchmark for MLLMs, and identifies a novel hallucination trap in chain-of-thought prompting, proposing a new fine-tuning strategy.
**Relevance:** 8
**Novelty:** 8

---

## 7. [Text-Guided Layer Fusion Mitigates Hallucination in Multimodal LLMs](https://arxiv.org/abs/2601.03100) <a id="link7"></a>
**ArXiv ID:** 2601.03100
**Authors:** Chenchen Lin, Sanbao Su, Rachel Luo, Yuxiao Chen, Yan Wang, Marco Pavone, Fei Miao
...
**Comment:** Matches criterion 2 (new MLLMs/VLLMs) and criterion 4 (vision foundation models and applications). Proposes TGIF, a novel text-guided, query-conditioned fusion of vision encoder layers to reduce hallucination in MLLMs, with strong empirical results.
**Relevance:** 9
**Novelty:** 7

---

## 8. [PatchAlign3D: Local Feature Alignment for Dense 3D Shape understanding](https://arxiv.org/abs/2601.02457) <a id="link8"></a>
**ArXiv ID:** 2601.02457
**Authors:** Souhail Hadgi, Bingchen Gong, Ramana Sundararaman, Emery Pierson, Lei Li, Peter Wonka, Maks Ovsjanikov
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes PatchAlign3D, a 3D encoder for language-aligned patch-level features, leveraging vision-language foundation models for dense 3D shape understanding.
**Relevance:** 8
**Novelty:** 8

---

## 9. [TA-Prompting: Enhancing Video Large Language Models for Dense Video Captioning via Temporal Anchors](https://arxiv.org/abs/2601.02908) <a id="link9"></a>
**ArXiv ID:** 2601.02908
**Authors:** Wei-Yuan Cheng, Kai-Po Chang, Chi-Pin Huang, Fu-En Yang, Yu-Chiang Frank Wang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Proposes TA-Prompting, a new method for enhancing VideoLLMs for dense video captioning and temporal understanding.
**Relevance:** 8
**Novelty:** 7

---

## 10. [A unified multimodal understanding and generation model for cross-disciplinary scientific research](https://arxiv.org/abs/2601.01363) <a id="link10"></a>
**ArXiv ID:** 2601.01363
**Authors:** Xiaomeng Yang, Zhiyu Tan, Xiaohui Zhong, Mengping Yang, Qiusheng Huang, Lei Chen, Libo Wu, Hao Li
...
**Comment:** Matches criterion 2 (new MLLMs/VLLMs) and criterion 4 (vision foundation models and applications). Presents FuXi-Uni, a unified multimodal model for scientific understanding and generation across domains, with strong results in Earth science and biomedicine.
**Relevance:** 8
**Novelty:** 7

---

## 11. [Zoom-IQA: Image Quality Assessment with Reliable Region-Aware Reasoning](https://arxiv.org/abs/2601.02918) <a id="link11"></a>
**ArXiv ID:** 2601.02918
**Authors:** Guoqiang Liang, Jianyi Wang, Zhonghua Wu, Shangchen Zhou
...
**Comment:** Matches criterion 2 (Shows new VLLMs or MLLMs) and criterion 4 (Vision foundation models and applications). Proposes Zoom-IQA, a VLM-based model for image quality assessment with region-aware reasoning and explainability, using a novel training pipeline and reinforcement learning.
**Relevance:** 8
**Novelty:** 7

---

## 12. [PrismVAU: Prompt-Refined Inference System for Multimodal Video Anomaly Understanding](https://arxiv.org/abs/2601.02927) <a id="link12"></a>
**ArXiv ID:** 2601.02927
**Authors:** I\~naki Erregue, Kamal Nasrollahi, Sergio Escalera
...
**Comment:** Matches criterion 2 (new MLLM/VLLM) and criterion 4 (vision foundation models and applications). Introduces PrismVAU, a lightweight system for video anomaly understanding using an off-the-shelf MLLM, with prompt optimization and competitive results.
**Relevance:** 8
**Novelty:** 7

---

## 13. [HOLO: Homography-Guided Pose Estimator Network for Fine-Grained Visual Localization on SD Maps](https://arxiv.org/abs/2601.02730) <a id="link13"></a>
**ArXiv ID:** 2601.02730
**Authors:** Xuchang Zhong, Xu Cao, Jinke Feng, Hao Fang
...
**Comment:** Matches criterion 1 (methodological improvements to spatial understanding on embodied agents) and criterion 4 (vision foundation models and applications). Proposes a homography-guided pose estimator for fine-grained visual localization, unifying BEV semantic reasoning with homography learning.
**Relevance:** 8
**Novelty:** 7

---

## 14. [OpenSocInt: A Multi-modal Training Environment for Human-Aware Social Navigation](https://arxiv.org/abs/2601.01939) <a id="link14"></a>
**ArXiv ID:** 2601.01939
**Authors:** Victor Sanchez, Chris Reinke, Ahamed Mohamed, Xavier Alameda-Pineda
...
**Comment:** This paper introduces OpenSocInt, an open-source simulator for multi-modal social interactions and training social agents. It matches criterion 3 (embodied AI papers on new benchmarks/simulators), as it provides a new environment for embodied AI research in social navigation.
**Relevance:** 8
**Novelty:** 7

---

## 15. [SA-ResGS: Self-Augmented Residual 3D Gaussian Splatting for Next Best View Selection](https://arxiv.org/abs/2601.03024) <a id="link15"></a>
**ArXiv ID:** 2601.03024
**Authors:** Kim Jun-Seong, Tae-Hyun Oh, Eduardo P\'erez-Pellitero, Youngkyoon Jang
...
**Comment:** This paper introduces SA-ResGS, a new framework for next-best-view selection in active scene reconstruction, with a focus on uncertainty quantification and residual learning for 3D Gaussian Splatting. It is highly relevant to embodied AI (criterion 3), as it proposes a novel method for active view selection and scene reconstruction, addressing issues in simulators and planning.
**Relevance:** 8
**Novelty:** 7

---

## 16. [Robust Mesh Saliency GT Acquisition in VR via View Cone Sampling and Geometric Smoothing](https://arxiv.org/abs/2601.02721) <a id="link16"></a>
**ArXiv ID:** 2601.02721
**Authors:** Guoquan Zheng, Jie Hao, Huiyu Duan, Yongming Han, Liang Yuan, Dong Zhang, Guangtao Zhai
...
**Comment:** Presents a new method for 3D mesh saliency ground truth acquisition in VR, using view cone sampling and geometric smoothing. This is relevant to criterion 3 (Embodied AI, new methods for simulators/benchmarks, novel angles), as it addresses a gap in 3D mesh saliency for VR.
**Relevance:** 7
**Novelty:** 7

---

## 17. [Yuan3.0 Flash: An Open Multimodal Large Language Model for Enterprise Applications](https://arxiv.org/abs/2601.01718) <a id="link17"></a>
**ArXiv ID:** 2601.01718
**Authors:** YuanLab. ai, :, Shawn Wu, Sean Wang, Louie Li, Darcy Chen, Allen Wang, Jiangang Luo, Xudong Zhao, Joseph Shen, Gawain Ma, Jasper Jia, Marcus Mao, Claire Wang, Hunter He, Carol Wang, Zera Zhang, Jason Wang, Chonly Shen, Leo Zhang, Logan Chen, Qasim Meng, James Gong, Danied Zhao, Penn Zheng, Owen Zhu, Tong Yu
...
**Comment:** Matches criterion 2 (new MLLMs/VLLMs). Introduces Yuan3.0 Flash, an open-source MoE MLLM for enterprise applications, with a novel RL training algorithm for overthinking mitigation.
**Relevance:** 7
**Novelty:** 6

---

## 18. [LAMS-Edit: Latent and Attention Mixing with Schedulers for Improved Content Preservation in Diffusion-Based Image and Style Editing](https://arxiv.org/abs/2601.02987) <a id="link18"></a>
**ArXiv ID:** 2601.02987
**Authors:** Wingwa Fu, Takayuki Okatani
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes LAMS-Edit, a new method for improved content preservation in diffusion-based image and style editing, relevant to generative modeling.
**Relevance:** 7
**Novelty:** 6

---

## 19. [Evaluating the Diagnostic Classification Ability of Multimodal Large Language Models: Insights from the Osteoarthritis Initiative](https://arxiv.org/abs/2601.02443) <a id="link19"></a>
**ArXiv ID:** 2601.02443
**Authors:** Li Wang, Xi Chen, XiangWen Deng, HuaHui Yi, ZeKun Jiang, Kang Li, Jian Li
...
**Comment:** Matches criterion 2 (new MLLMs/VLLMs) and criterion 4 (vision foundation models and applications). Provides empirical insights into the diagnostic classification ability of MLLMs in medical imaging, with surprising results about the limitations of MLLMs for classification.
**Relevance:** 7
**Novelty:** 6

---

## 20. [Shallow- and Deep-fake Image Manipulation Localization Using Vision Mamba and Guided Graph Neural Network](https://arxiv.org/abs/2601.02566) <a id="link20"></a>
**ArXiv ID:** 2601.02566
**Authors:** Junbin Zhang, Hamid Reza Tohidypour, Yixiao Wang, Panos Nasiopoulos
...
**Comment:** Presents a method for image manipulation localization using Vision Mamba and a guided GNN. This is relevant to criterion 4 (vision foundation models and applications), as it leverages a vision foundation model for a practical vision task.
**Relevance:** 7
**Novelty:** 6

---

## 21. [Understanding Multi-Agent Reasoning with Large Language Models for Cartoon VQA](https://arxiv.org/abs/2601.03073) <a id="link21"></a>
**ArXiv ID:** 2601.03073
**Authors:** Tong Wu, Thanet Markchom
...
**Comment:** Proposes a multi-agent LLM framework for cartoon VQA, which is a multi-modal reasoning task. This matches criterion 2 (new MLLMs) and is relevant to vision-language reasoning, with a novel multi-agent approach.
**Relevance:** 7
**Novelty:** 6

---

## 22. [VTONQA: A Multi-Dimensional Quality Assessment Dataset for Virtual Try-on](https://arxiv.org/abs/2601.02945) <a id="link22"></a>
**ArXiv ID:** 2601.02945
**Authors:** Xinyi Wei, Sijing Wu, Zitong Xu, Yunhao Li, Huiyu Duan, Xiongkuo Min, Guangtao Zhai
...
**Comment:** This paper introduces a new benchmark dataset for virtual try-on image quality assessment. It matches criterion 3 (Embodied AI papers on building new benchmarks or methods, especially with novel angles), as it provides a new multi-dimensional dataset for a vision task.
**Relevance:** 6
**Novelty:** 6

---

## 23. [InfiniDepth: Arbitrary-Resolution and Fine-Grained Depth Estimation with Neural Implicit Fields](https://arxiv.org/abs/2601.03252) <a id="link23"></a>
**ArXiv ID:** 2601.03252
**Authors:** Hao Yu, Haotong Lin, Jiawei Wang, Jiaxin Li, Yida Wang, Xueyang Zhang, Yue Wang, Xiaowei Zhou, Ruizhen Hu, Sida Peng
...
**Comment:** Somewhat matches criterion 4 (vision foundation models and applications). Introduces InfiniDepth, a neural implicit field approach for arbitrary-resolution depth estimation, with a new 4K synthetic benchmark. Not directly about foundation models, but relevant to vision and generative modeling.
**Relevance:** 5
**Novelty:** 7

---

## 24. [Towards Agnostic and Holistic Universal Image Segmentation with Bit Diffusion](https://arxiv.org/abs/2601.02881) <a id="link24"></a>
**ArXiv ID:** 2601.02881
**Authors:** Jakob L{\o}nborg Christensen, Morten Rieger Hannemose, Anders Bjorholm Dahl, Vedrana Andersen Dahl
...
**Comment:** Somewhat matches criterion 4 (vision foundation models and applications) as it introduces a diffusion-based framework for universal image segmentation, with unique capabilities like ambiguity modeling. However, it is not directly about foundation models but about a new generative segmentation approach.
**Relevance:** 5
**Novelty:** 7

---

## 25. [Towards Efficient 3D Object Detection for Vehicle-Infrastructure Collaboration via Risk-Intent Selection](https://arxiv.org/abs/2601.03001) <a id="link25"></a>
**ArXiv ID:** 2601.03001
**Authors:** Li Wang, Boqi Li, Hang Chen, Xingjian Wu, Yichen Wang, Jiewen Tan, Xinyu Zhang, Huaping Liu
...
**Comment:** This paper proposes a new method for efficient 3D object detection in vehicle-infrastructure collaboration, using risk-intent selection and semantic-selective fusion. It is relevant to spatial understanding and intelligence (criterion 1), as it introduces a new way to prioritize spatial regions for communication and detection in autonomous driving.
**Relevance:** 5
**Novelty:** 6

---

## 26. [D$^3$R-DETR: DETR with Dual-Domain Density Refinement for Tiny Object Detection in Aerial Images](https://arxiv.org/abs/2601.02747) <a id="link26"></a>
**ArXiv ID:** 2601.02747
**Authors:** Zixiao Wen, Zhen Yang, Xianjie Bao, Lei Zhang, Xiantai Xiang, Wenshuai Li, Yuhan Liu
...
**Comment:** This paper proposes a DETR-based detector with dual-domain density refinement for tiny object detection in aerial images. It fuses spatial and frequency domain information, which is a methodological improvement in spatial understanding (criterion 1), especially for remote sensing and tiny object detection.
**Relevance:** 5
**Novelty:** 6

---

## 27. [Jenius Agent: Towards Experience-Driven Accuracy Optimization in Real-World Scenarios](https://arxiv.org/abs/2601.01857) <a id="link27"></a>
**ArXiv ID:** 2601.01857
**Authors:** Defei Xia, Bingfeng Pi, Shenbin Zhang, Song Hua, Yunfei Wei, Lei Zuo
...
**Comment:** Describes an LLM-based agent framework for real-world task optimization, focusing on prompt generation, tool orchestration, and memory. While interesting for agent systems, it does not directly address spatial intelligence, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models.
**Relevance:** 4
**Novelty:** 5

---

## 28. [Beyond Gemini-3-Pro: Revisiting LLM Routing and Aggregation at Scale](https://arxiv.org/abs/2601.01330) <a id="link28"></a>
**ArXiv ID:** 2601.01330
**Authors:** Shengji Tang, Weihao Lin, Jingqi Ye, Hao Li, Bo Zhang, Shuyue Hu, Tao Chen, Wangli Ouyang, Lei Bai, Peng Ye
...
**Comment:** Focuses on LLM routing and aggregation, not on spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models. It is more about language model collaboration.
**Relevance:** 3
**Novelty:** 6

---

## 29. [EverMemOS: A Self-Organizing Memory Operating System for Structured Long-Horizon Reasoning](https://arxiv.org/abs/2601.02163) <a id="link29"></a>
**ArXiv ID:** 2601.02163
**Authors:** Chuanrui Hu, Xingze Gao, Zuyi Zhou, Dannong Xu, Yi Bai, Xintong Li, Hui Zhang, Tong Li, Chong Zhang, Lidong Bing, Yafeng Deng
...
**Comment:** Does not directly match any criterion. Focuses on memory systems for LLMs, not spatial intelligence, VLLMs, or vision applications.
**Relevance:** 3
**Novelty:** 6

---

## 30. [CaveAgent: Transforming LLMs into Stateful Runtime Operators](https://arxiv.org/abs/2601.01569) <a id="link30"></a>
**ArXiv ID:** 2601.01569
**Authors:** Maohao Ran, Zhenglin Wan, Cooper Lin, Yanting Zhang, Hongyu Xin, Hongwei Fan, Yibo Xu, Beier Luo, Yaxin Zhou, Wangbo Zhao, Lijie Yang, Lang Feng, Fuchao Yang, Jingxuan Wu, Yiqiao Huang, Chendong Ma, Dailing Jiang, Jianbo Deng, Sihui Han, Bo An, Yike Guo, Jun Song
...
**Comment:** Does not directly match any criterion. Focuses on LLMs as runtime operators for agentic systems, not specifically spatial intelligence, VLLMs, or vision applications.
**Relevance:** 3
**Novelty:** 6

---

## 31. [Topology-aware Pathological Consistency Matching for Weakly-Paired IHC Virtual Staining](https://arxiv.org/abs/2601.02806) <a id="link31"></a>
**ArXiv ID:** 2601.02806
**Authors:** Mingzhou Jiang, Jiaying Zhou, Nan Zeng, Mickael Li, Qijie Tang, Chao He, Huazhu Fu, Honghui He
...
**Comment:** This paper proposes a topology-aware framework for virtual staining in pathology, using graph contrastive learning and topological perturbations. While it is a novel application in medical imaging, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 32. [Fine-Grained Generalization via Structuralizing Concept and Feature Space into Commonality, Specificity and Confounding](https://arxiv.org/abs/2601.03056) <a id="link32"></a>
**ArXiv ID:** 2601.03056
**Authors:** Zhen Wang, Jiaojiao Zhao, Qilong Wang, Yongfeng Dong, Wenlong Yu
...
**Comment:** This paper proposes a new method for fine-grained domain generalization by disentangling concept and feature spaces into common, specific, and confounding components. While it is a methodological improvement in representation learning, it does not directly address spatial understanding, embodied agents, VLLMs/MLLMs, or vision foundation models. It is most relevant to general computer vision and machine learning.
**Relevance:** 3
**Novelty:** 6

---

## 33. [DCG ReID: Disentangling Collaboration and Guidance Fusion Representations for Multi-modal Vehicle Re-Identification](https://arxiv.org/abs/2601.02924) <a id="link33"></a>
**ArXiv ID:** 2601.02924
**Authors:** Aihua Zheng, Ya Gao, Shihao Li, Chenglong Li, Jin Tang
...
**Comment:** Does not match any specific criterion. Focuses on multi-modal vehicle re-identification, not on spatial intelligence, MLLMs, embodied AI benchmarks, or vision foundation models in a general sense.
**Relevance:** 3
**Novelty:** 5

---

## 34. [Streaming Hallucination Detection in Long Chain-of-Thought Reasoning](https://arxiv.org/abs/2601.02170) <a id="link34"></a>
**ArXiv ID:** 2601.02170
**Authors:** Haolang Lu, Minghui Pan, Ripeng Li, Guoshun Nan, Jialin Zhuang, Zijie Zhao, Zhongxiang Sun, Kun Wang, Yang Liu
...
**Comment:** This paper focuses on hallucination detection in long chain-of-thought reasoning for LLMs, not directly related to spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models. It is more about language model reasoning.
**Relevance:** 3
**Novelty:** 5

---

## 35. [Digital Twin AI: Opportunities and Challenges from Large Language Models to World Models](https://arxiv.org/abs/2601.01321) <a id="link35"></a>
**ArXiv ID:** 2601.01321
**Authors:** Rong Zhou, Dongping Chen, Zihan Jia, Yao Su, Yixin Liu, Yiwen Lu, Dongwei Shi, Yue Huang, Tianyang Xu, Yi Pan, Xinliang Li, Yohannes Abate, Qingyu Chen, Zhengzhong Tu, Yu Yang, Yu Zhang, Qingsong Wen, Gengchen Mai, Sunyang Fu, Jiachen Li, Xuyu Wang, Ziran Wang, Jing Huang, Tianming Liu, Yong Chen, Lichao Sun, Lifang He
...
**Comment:** Somewhat matches criterion 4 (vision foundation models and applications) as it discusses the integration of foundation models and generative AI in digital twins, but is a broad survey rather than a new method or empirical result.
**Relevance:** 4
**Novelty:** 4

---

## 36. [ULS+: Data-driven Model Adaptation Enhances Lesion Segmentation](https://arxiv.org/abs/2601.02988) <a id="link36"></a>
**ArXiv ID:** 2601.02988
**Authors:** Rianne Weber, Niels Rocholl, Max de Grauw, Mathias Prokop, Ewoud Smit, Alessa Hering
...
**Comment:** This paper presents ULS+, an improved universal lesion segmentation model for CT scans, with data-driven adaptation and better performance. While it is a methodological improvement in medical imaging, it does not directly address spatial intelligence, embodied agents, VLLMs/MLLMs, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 37. [Motion Blur Robust Wheat Pest Damage Detection with Dynamic Fuzzy Feature Fusion](https://arxiv.org/abs/2601.03046) <a id="link37"></a>
**ArXiv ID:** 2601.03046
**Authors:** Han Zhang, Yanwei Wang, Fang Li, Hongjun Wang
...
**Comment:** This paper proposes a dynamic fuzzy feature fusion method for motion blur robust object detection in wheat pest images. While it is a methodological improvement in vision, it does not directly address spatial intelligence, embodied agents, VLLMs/MLLMs, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 38. [Foreground-Aware Dataset Distillation via Dynamic Patch Selection](https://arxiv.org/abs/2601.02727) <a id="link38"></a>
**ArXiv ID:** 2601.02727
**Authors:** Longzhen Li, Guang Li, Ren Togo, Keisuke Maeda, Takahiro Ogawa, Miki Haseyama
...
**Comment:** This paper introduces a new dataset distillation method using dynamic patch selection with a focus on foreground objects. While it is a methodological improvement in dataset distillation and uses vision models, it does not directly address spatial intelligence, embodied agents, VLLMs/MLLMs, or vision foundation models.
**Relevance:** 3
**Novelty:** 5
