...
0. [VANTAGE-Bench: Evaluating the Infrastructure AI Gap in Vision-Language Models](#link0)
...
1. [LayerRoute: Action-Conditioned Mixture-of-Layers Routing for Vision-Language-Action Policies](#link1)
...
2. [SceneHI: High-Resolution 3D-Consistent Scene Texturing with Controllable Illumination](#link2)
...
3. [TRACE: Trajectory-robust Admission with Evidence Ordering for Efficient GUI Agents](#link3)
**Authors:** Yuhao Wang, Mu Qiao, Xindong Zhang, Yunzhi Zhuge, Lei Zhang, Huchuan Lu

4. [Spot-the-shift: Evaluating Grounded Image Difference Captioning of Long-term Changes](#link4)
**Authors:** Benedetta Liberatori, Nermin Samet, Paolo Rota, Matthieu Cord, Elisa Ricci, Andrei Bursuc, Monika Wysocza\'nska

5. [Infra-Bench CLS: A Global, Open-Source Benchmark for Critical Infrastructure Classification with Earth Observation Foundation Models](#link5)
**Authors:** Justin Guthrie, Edward Oughton, Konrad Wessels, Matthew Rice, Isaac Corley

6. [Interpreting Object-Dependent Concept Brittleness in Text-to-Image Diffusion Models](#link6)
**Authors:** Yifan Yuan, Xiangyu Liu, Hongming Shan, Yu Han, Yu Jiang, Hao Tan, Junping Zhang, Linlin Shen

7. [Bridging the Semantic-Utility Gap in Multimodal RAG via Generator-in-the-Loop Alignment](#link7)
**Authors:** Zhan-Lun Chang, Dong-Jun Han, Seyyedali Hosseinalipour, Mung Chiang, Christopher G. Brinton

8. [Procedural Graphs: Self-Evolving Execution Structures for LLM Agents](#link8)
**Authors:** Yuxing Lu, Yicheng Chen, Shanchan Wu, Sercan \"{O}. Ar{\i}k

9. [EvolveScaler: Synthesizing Information-Evolution Contexts via Executable State Machines and Natural-Language Rendering](#link9)
**Authors:** Ziliang Zhao, Zenan Xu, Shuting Wang, Zhao Wang, Bowen Cao, Minda Hu, Lincheng Li, Pluto Zhou, Zhicheng Dou

10. [LeCor: Learning to Be Corrected by Meta-Learned Test-Time Training for Interactive 3D Lung-Tumour Segmentation](#link10)
**Authors:** Yi Luo, Yike Guo, Wenxuan Li, Zongwei Zhou, Rui Zhang, Kai Ding

11. [IAE-VTG: Interaction-Aligned Action-Entity Video Temporal Grounding](#link11)
**Authors:** Shiwen Zhao, Qi Zhang, Sezer Karaoglu, Theo Gevers, Martin R. Oswald

12. [AgenticGen: Reward-Guided Agentic Video Generation for Advertising](#link12)
...
13. [MVFA: A Multi-View Text-Guided Multimodal Fusion LLM Adapter for Sentiment Analysis and Emotion Recognition](#link13)
...
14. [When and What to Teach: Budget-Aware Online Adaptation for Web Agents](#link14)
**Authors:** Jianwei Zhang, Sihan Cao, Pengcheng Zheng, Ya Wen, Pei Ke, Kuien Liu, Shen Gao, Wei Dong, Yang Yang, Chaoning Zhang

15. [World Models Under Asynchronous Sensor Observations](#link15)
**Authors:** Akash Anand, Abhay Anand, Yash Vishe

16. [EmoMed: An Emotionally-Aware Agent for Multimodal Medical Support with Real-Time Information Retrieval](#link16)
**Authors:** Ivan Nasonov, Nikita Glazkov, Ivan Makovetskiy, Mikhail Mozikov, Daniil Sukhorukov, Andrey Savchenko, Ilya Makarov

---
## 0. [VANTAGE-Bench: Evaluating the Infrastructure AI Gap in Vision-Language Models](https://arxiv.org/abs/2609.09396) <a id="link0"></a>
**ArXiv ID:** 2609.09396
**Authors:** Zaid Pervaiz Bhat, Nimra Nayyar, Arihant Jain, Lap Fung Chan, John Suchanek, Yu Wang, Varun Praveen, Tomasz Kornuta, Vidya Nariyambut Murali
...
**Comment:** Matches criterion 3 very closely: it builds a new embodied/physical-AI benchmark for fixed-camera infrastructure video with spatial, temporal, and grounding evaluations, covering a novel angle that prior work overlooked.
**Relevance:** 8
**Novelty:** 7

---

## 1. [LayerRoute: Action-Conditioned Mixture-of-Layers Routing for Vision-Language-Action Policies](https://arxiv.org/abs/2609.06079) <a id="link1"></a>
**ArXiv ID:** 2609.06079
**Authors:** Zheng Lu, Haoran Liao, Wanqi Zhong, Yunhe Ni, Lijie Wang, Xingjie Fan, Zhisheng Chen, Yantang Qu, Meijia Chen, Tianyu Xin, Zirui Song, Yiming Li
...
**Comment:** Matches criterion 1 and criterion 3 closely: it proposes a new method for vision-language-action policies in embodied robot control.
**Relevance:** 8
**Novelty:** 7

---

## 2. [SceneHI: High-Resolution 3D-Consistent Scene Texturing with Controllable Illumination](https://arxiv.org/abs/2609.10363) <a id="link2"></a>
**ArXiv ID:** 2609.10363
**Authors:** Athanasios Tragakis, Marco Aversa, Daniela Ivanova, Chaitanya Kaul, Roderick Murray-Smith, Daniele Faccio, Paul Henderson
...
**Comment:** Matches criterion 4 very closely: vision foundation model priors from 2D diffusion models are lifted to a new 3D texture synthesis application with controllable illumination.
**Relevance:** 6
**Novelty:** 7

---

## 3. [TRACE: Trajectory-robust Admission with Evidence Ordering for Efficient GUI Agents](https://arxiv.org/abs/2609.10297) <a id="link3"></a>
**ArXiv ID:** 2609.10297
**Authors:** Yuhao Wang, Mu Qiao, Xindong Zhang, Yunzhi Zhuge, Lei Zhang, Huchuan Lu
...
**Comment:** Matches criterion 3 very closely: it is a new method for GUI agents focused on spatial coverage, token pruning, and trajectory-robust visual evidence management in an embodied/interactive setting.
**Relevance:** 7
**Novelty:** 6

---

## 4. [Spot-the-shift: Evaluating Grounded Image Difference Captioning of Long-term Changes](https://arxiv.org/abs/2609.10356) <a id="link4"></a>
**ArXiv ID:** 2609.10356
**Authors:** Benedetta Liberatori, Nermin Samet, Paolo Rota, Matthieu Cord, Elisa Ricci, Andrei Bursuc, Monika Wysocza\'nska
...
**Comment:** Matches criterion 1 and criterion 2 closely: it evaluates multi-image spatial understanding in MLLMs on grounded long-term change captioning.
**Relevance:** 7
**Novelty:** 6

---

## 5. [Infra-Bench CLS: A Global, Open-Source Benchmark for Critical Infrastructure Classification with Earth Observation Foundation Models](https://arxiv.org/abs/2609.09482) <a id="link5"></a>
**ArXiv ID:** 2609.09482
**Authors:** Justin Guthrie, Edward Oughton, Konrad Wessels, Matthew Rice, Isaac Corley
...
**Comment:** Matches criterion 4 very closely: this is a benchmark and evaluation paper for earth observation foundation models.
**Relevance:** 7
**Novelty:** 5

---

## 6. [Interpreting Object-Dependent Concept Brittleness in Text-to-Image Diffusion Models](https://arxiv.org/abs/2609.09909) <a id="link6"></a>
**ArXiv ID:** 2609.09909
**Authors:** Yifan Yuan, Xiangyu Liu, Hongming Shan, Yu Han, Yu Jiang, Hao Tan, Junping Zhang, Linlin Shen
...
**Comment:** Matches criterion 4: it studies and corrects failures in text-to-image diffusion models, which is relevant to vision foundation models and their applications.
**Relevance:** 6
**Novelty:** 6

---

## 7. [Bridging the Semantic-Utility Gap in Multimodal RAG via Generator-in-the-Loop Alignment](https://arxiv.org/abs/2609.08188) <a id="link7"></a>
**ArXiv ID:** 2609.08188
**Authors:** Zhan-Lun Chang, Dong-Jun Han, Seyyedali Hosseinalipour, Mung Chiang, Christopher G. Brinton
...
**Comment:** Matches criterion 2 closely: it introduces a VLM-based multimodal RAG alignment method using generator-in-the-loop feedback for image-query retrieval and reranking.
**Relevance:** 6
**Novelty:** 5

---

## 8. [Procedural Graphs: Self-Evolving Execution Structures for LLM Agents](https://arxiv.org/abs/2609.09153) <a id="link8"></a>
**ArXiv ID:** 2609.09153
**Authors:** Yuxing Lu, Yicheng Chen, Shanchan Wu, Sercan \"{O}. Ar{\i}k
...
**Comment:** Matches criterion 3 moderately well: it proposes a new method for self-evolving agent execution structures over long-horizon tool use, which is adjacent to embodied/interactive agent methodology.
**Relevance:** 5
**Novelty:** 6

---

## 9. [EvolveScaler: Synthesizing Information-Evolution Contexts via Executable State Machines and Natural-Language Rendering](https://arxiv.org/abs/2609.08435) <a id="link9"></a>
**ArXiv ID:** 2609.08435
**Authors:** Ziliang Zhao, Zenan Xu, Shuting Wang, Zhao Wang, Bowen Cao, Minda Hu, Lincheng Li, Pluto Zhou, Zhicheng Dou
...
**Comment:** Matches criterion 3 moderately well: it builds a new benchmark/synthesis framework for long-context information evolution with executable simulators and evaluation instances, though it is not embodied AI in the classic sense.
**Relevance:** 5
**Novelty:** 6

---

## 10. [LeCor: Learning to Be Corrected by Meta-Learned Test-Time Training for Interactive 3D Lung-Tumour Segmentation](https://arxiv.org/abs/2609.09477) <a id="link10"></a>
**ArXiv ID:** 2609.09477
**Authors:** Yi Luo, Yike Guo, Wenxuan Li, Zongwei Zhou, Rui Zhang, Kai Ding
...
**Comment:** Matches criterion 4 loosely: it uses SAM 3, a promptable vision foundation model, for interactive medical segmentation with test-time correction.
**Relevance:** 5
**Novelty:** 6

---

## 11. [IAE-VTG: Interaction-Aligned Action-Entity Video Temporal Grounding](https://arxiv.org/abs/2609.09736) <a id="link11"></a>
**ArXiv ID:** 2609.09736
**Authors:** Shiwen Zhao, Qi Zhang, Sezer Karaoglu, Theo Gevers, Martin R. Oswald
...
**Comment:** Matches criterion 3 loosely: it is a new method for video temporal grounding, but not specifically embodied AI or spatial intelligence.
**Relevance:** 5
**Novelty:** 6

---

## 12. [AgenticGen: Reward-Guided Agentic Video Generation for Advertising](https://arxiv.org/abs/2609.09187) <a id="link12"></a>
**ArXiv ID:** 2609.09187
**Authors:** Xingyuan Bu, Chengru Song, Hao Zhou, Tao Zhou, Dong Li, Wei Li, Shilong Li, Hao Shi, Yongxin Guo, Donghao Zhou, Qiangpeng Yang, Shilei Wen
...
**Comment:** Matches criterion 4 moderately: it applies recent video foundation models in a reward-guided generation system for a real downstream application, though it is more an application paper than a new foundation model.
**Relevance:** 5
**Novelty:** 5

---

## 13. [MVFA: A Multi-View Text-Guided Multimodal Fusion LLM Adapter for Sentiment Analysis and Emotion Recognition](https://arxiv.org/abs/2609.06188) <a id="link13"></a>
**ArXiv ID:** 2609.06188
**Authors:** Pengfei Shao, Jisheng Dang, Jiawen Fang, Ning Liu, Wencan Zhang, Bimei Wang, Jingwen Zhao, Jianhuang Lai, Qi Tian, Tat-Seng Chua
...
**Comment:** Matches criterion 2 moderately well: it is a multimodal LLM adapter for audio-visual-text fusion, but the task is sentiment/emotion recognition rather than a new general VLLM/MLLM architecture.
**Relevance:** 5
**Novelty:** 4

---

## 14. [When and What to Teach: Budget-Aware Online Adaptation for Web Agents](https://arxiv.org/abs/2609.05513) <a id="link14"></a>
**ArXiv ID:** 2609.05513
**Authors:** Jianwei Zhang, Sihan Cao, Pengcheng Zheng, Ya Wen, Pei Ke, Kuien Liu, Shen Gao, Wei Dong, Yang Yang, Chaoning Zhang
...
**Comment:** Matches criterion 3 loosely: it introduces a new online adaptation method for web agents, which is agentic but not clearly embodied AI in the simulator/robotics sense.
**Relevance:** 4
**Novelty:** 5

---

## 15. [World Models Under Asynchronous Sensor Observations](https://arxiv.org/abs/2609.07299) <a id="link15"></a>
**ArXiv ID:** 2609.07299
**Authors:** Akash Anand, Abhay Anand, Yash Vishe
...
**Comment:** No very close match to criteria 1-4; it is about world models under asynchronous sensor observations, which is adjacent to embodied AI but not clearly a benchmark or vision-language method.
**Relevance:** 3
**Novelty:** 5

---

## 16. [EmoMed: An Emotionally-Aware Agent for Multimodal Medical Support with Real-Time Information Retrieval](https://arxiv.org/abs/2609.07194) <a id="link16"></a>
**ArXiv ID:** 2609.07194
**Authors:** Ivan Nasonov, Nikita Glazkov, Ivan Makovetskiy, Mikhail Mozikov, Daniil Sukhorukov, Andrey Savchenko, Ilya Makarov
...
**Comment:** No close match to criteria 1-4; it is a multimodal medical support agent, but the abstract does not indicate a new VLLM/MLLM or a vision/embodied benchmark contribution.
**Relevance:** 3
**Novelty:** 3
