# Personalized Daily ArXiv Papers 05/29/2026
...
0. [Planning with the Views via Scene Self-Exploration](#link0)
...
1. [Grounded 3D-Aware Spatial Vision-Language Modeling](#link1)
...
2. [VLA-Trace: Diagnosing Vision-Language-Action Models through Representation and Behavior Tracing](#link2)
...
3. [minWM: A Full-Stack Open-Source Framework for Real-Time Interactive Video World Models](#link3)
...
4. [AgentCVR: Active Multi-Agent Cross-Video Reasoning via Script-Simulated Reinforcement Learning](#link4)
**Authors:** Yilun Qiu, Jiahe Wang, Cilin Yan, Jiayin Cai, Xiaolong Jiang, Yao Hu, Chun Yuan

5. [VideoFDB: Evaluating Full-Duplex Vision-Speech Capabilities in Conversational Agents](#link5)
...
6. [Towards Consistent Video Geometry Estimation](#link6)
...
7. [Train the Agent, Not the Expert: Learning to Harness Heterogeneous Experts for Multi-Turn Visual Reasoning](#link7)
**Authors:** Yaowu Fan, Tao Han, Dazhao Du, Andy J. Ma, Jia Wan

8. [AnyMo: Scaling Any-Modality Conditional Motion Generation with Masked Modeling](#link8)
**Authors:** Yiheng Li, Zhuo Li, Ruibing Hou, Yingjie Chen, Hong Chang, Hao Liu, Shiguang Shan

9. [AgentSchool: An LLM-Powered Multi-Agent Simulation for Education](#link9)
...
22. [Geometry-Guided Modeling of Foundation Features Enables Generalizable Object Shape Deformation Learning](#link22)
**Authors:** Yiyao Ma, Kai Chen, Zhongxiang Zhou, Zhuheng Song, Dongsheng Xie, Zelong Tan, Rong Xiong, Qi Dou

23. [DeepTool: Scaling Interleaved Deliberation in Tool-Integrated Reasoning via Process-Supervised Reinforcement Learning](#link23)
**Authors:** Yang He, Xiao Ding, Bibo Cai, Yufei Zhang, Kai Xiong, Zhouhao Sun, Bing Qin, Ting Liu

24. [Mind-Omni: A Unified Multi-Task Framework for Brain-Vision-Language Modeling via Discrete Diffusion](#link24)
**Authors:** Yizhuo Lu, Changde Du, Qingyu Shi, Hang Chen, Jie Peng, Liuyun Jiang, Shuangchen Zhao, Huiguang He

25. [OmniMatBench: A Human-Calibrated Multimodal Reasoning Benchmark Across 19 Materials Science Subfields](#link25)
...
26. [DocRetriever: A Plug-and-Play Framework for Multimodal Document Retrieval with Comprehensive Benchmark](#link26)
...
27. [ReasonLight: A Multimodal Foundation Model-Enhanced Reinforcement Learning Framework for Zero-Shot Traffic Signal Control](#link27)
**Authors:** Aoyu Pang, Maonan Wang, Yuejiao Xie, Chung Shue Chen, Zhiwei Yang, Man-On Pun

28. [BenchTrace: A Benchmark for Testing Reflection Ability and Controlled Evolution in LLM Agents](#link28)
**Authors:** Jiahao Huang, Fei Cheng, Junfeng Jiang, Zefan Yu, Akiko Aizawa

29. [AnomalyAgent: Training-Free Agentic Models for Zero-/Few-Shot Anomaly Detection](#link29)
**Authors:** Yi Zhang, Jiawen Zhu, Lele Fu, Guansong Pang

30. [IP-Adapter Is All You Need: Towards Fine-Tuning-Free Diffusion-Based Talking Face Generation](#link30)
**Authors:** Hao Wu, Xiangyang Luo, Hao Wang, Jiawei Zhang, Yi Zhang, Jinwei Wang

31. [VideoMLA: Low-Rank Latent KV Cache for Minute-Scale Autoregressive Video Diffusion](#link31)
**Authors:** Hidir Yesiltepe, Jiazhen Hu, Tuna Han Salih Meral, Adil Kaan Akan, Kaan Oktay, Hoda Eldardiry, Pinar Yanardag

32. [Fewer Steps, Better Performance: Efficient Cross-Modal Clip Trimming for Video Moment Retrieval Using Language](#link32)
**Authors:** Xiang Fang, Daizong Liu, Wanlong Fang, Pan Zhou, Zichuan Xu, Wenzheng Xu, Junyang Chen, Renfu Li

33. [Large Depth Completion Model from Sparse Observations](#link33)
...
34. [PTCG-Bench: Can LLM Agents Master Pok\'emon Trading Card Game?](#link34)
**Authors:** Dongdong Hua, Yifei Sun, Renhong Huang, Feng Gao, Chunping Wang, Yang Yang

35. [SkillsInjector: Dynamic Skill Context Construction for LLM Agents](#link35)
**Authors:** Yanchao Li, Wanhao Liu, Ben Gao, Jiaqing Xie, Zhehong Ai, Na Zou, Yuqiang Li, Tianfan Fu

36. [Not All Inputs Are Valid: Towards Open-Set Video Moment Retrieval Using Language](#link36)
...
37. [Battery-Sim-Agent: Leveraging LLM-Agent for Inverse Battery Parameter Estimation](#link37)
**Authors:** Jiawei Chen, Xiaofan Gui, Shikai Fang, Shengyu Tao, Shun Zheng, Weiqing Liu, Jiang Bian

38. [Robust and Generalizable Safety Steering for Text-to-Image Diffusion Transformers](#link38)
**Authors:** Zihao Xue, Yan Wang, Zhen Bi, Long Ma, Zhonglong Zheng, Zeyu Yang, Bingyu Zhu, Longtao Huang, Jie Xiao, Jungang Lou

39. [The Chain Holds, the Answer Folds: Trace-Answer Dissociation in Reasoning Models Under Adversarial Pressure](#link39)
**Authors:** Yubo Li, Ramayya Krishnan, Rema Padman

40. [ParaTool: Shifting Tool Representations from Context to Parameters](#link40)
**Authors:** Zekai Yu, Qi Meng, Qizhi Chu, Yu Hao, Chuan Shi, Cheng Yang

41. [Harmonizing Real-Time Constraints and Long-Horizon Reasoning: An Asynchronous Agentic Framework for Dynamic Scheduling](#link41)
**Authors:** Shijie Cao, Yuan Yuan, Jing Liu

42. [Make LLM Learn to Synthesize from Streaming Experiences through Feedback](#link42)
**Authors:** Zhenlin Hu, Yan Wang, Zhen Bi, Zihao Xue, Bingyu Zhu, Longtao Huang, Xiongtao Zhang, Zeyu Yang, Zhixuan Chu, Jungang Lou

43. [Citation-Closure Retrieval and Per-Rule Attribution for Real-World Regulatory Compliance Question Answering](#link43)
**Authors:** Yeong-Joon Ju, Seong-Whan Lee

44. [Domain-Specific Data Synthesis for LLMs via Minimal Sufficient Representation Learning](#link44)
**Authors:** Tong Ye, Hang Yu, Tengfei Ma, Xuhong Zhang, Jianguo Li, Peng Di, Peiyu Liu, Jianwei Yin, Wenhai Wang

45. [Enhancing Multi-Agent Communication through Attention Steering with Context Relevance](#link45)
**Authors:** Hongxiang Zhang, Yuan Tian, Tianyi Zhang

46. [Toward AI Systems That Understand Self and Others: A Multi-Phase Inference Framework for Human Cognitive Diversity and World-Model Alignment](#link46)
**Authors:** Toru Takahashi

47. [Non-Forgetting Knowledge Allocation with Bi-level Competition for Class-Incremental Learning](#link47)
**Authors:** Xiang Tan, Run He, Yawen Cui, Mengchen Zhao, Yan Wu, Tianyi Chen, Huiping Zhuang, Xiaonan Luo, Guanbin Li

48. [FedSmoothLoRA: Toward Smoother and Faster Convergence in Federated Low-Rank Adaptation](#link48)
**Authors:** Zehao Wang, Guanglei Yang, Yihan Zeng, Hang Xu, Hongzhi Zhang, Wangmeng Zuo, Chun-Mei Feng

49. [When Should Models Change Their Minds? Contextual Belief Management in Large Language Models](#link49)
**Authors:** Haoming Xu, Weihong Xu, Zongrui Li, Mengru Wang, Yunzhi Yao, Chiyu Wu, Jin Shang, Yu Gong, Shumin Deng

50. [Behavior-Aware Auxiliary Corrections for Off-Policy Temporal-Difference Prediction](#link50)
**Authors:** Xingguo Chen, Zhiang He, Yuchen Shen, Shangdong Yang, Chao Li, Guang Yang, Wenhao Wang

51. [VikingMem: A Memory Base Management System for Stateful LLM-based Applications](#link51)
**Authors:** Jiajie Fu, Junwen Chen, Mengzhao Wang, Aoxiang He, Maojia Sheng, Xiangyu Ke, Yifan Zhu, Yunjun Gao

52. [Behavior-Induced Mirror-Prox Temporal-Difference Learning for Faster Off-Policy Prediction](#link52)
**Authors:** Xingguo Chen, Yuchen Shen, Shangdong Yang, Chao Li, Guang Yang, Wenhao Wang

53. [Tailoring the Curriculum: Student-Centered Reasoning Distillation via Dynamic Data-Model Compatibility](#link53)
**Authors:** Jiahao Huang, Fei Cheng, Junfeng Jiang, Akiko Aizawa

54. [Efficient, Validation-Free Intrinsic Quality Estimation for Large-Scale Face Recognition Datasets](#link54)
**Authors:** Zhichao Chen, Yongle Zhao, Kaicheng Yang, Meng Yang, Yin Xie, Ziyong Feng

55. [Lightweight Complementary-Cue Fusion for Robust Video Face Forgery Detection](#link55)
**Authors:** Sunghwan Baek, Tariq Anwaar, Karanveer Singh, Rita Singh

56. [Robust Cross-Domain Generalization Using Unlabeled Target Data with Source-Domain Supervision](#link56)
**Authors:** Yuyue Zhou (Kai Yue), Shrimanti Ghosh (Kai Yue), Michael (Kai Yue), Xie, Justin JY Kim, Jessica Knight, Steel McDonald, Vincent Man, Jacob L. Jaremko, Abhilash Hareendranathan

---
## 0. [Planning with the Views via Scene Self-Exploration](https://arxiv.org/abs/2605.29563) <a id="link0"></a>
**ArXiv ID:** 2605.29563
**Authors:** Kangrui Wang, Linjie Li, Zhengyuan Yang, Shiqi Chen, Zihan Wang, Li Fei-Fei, Jiajun Wu, Leonidas Guibas, Lijuan Wang, Manling Li
...
**Comment:** Directly matches criterion 1 (spatial understanding and intelligence on embodied agents) and criterion 3 (new methods for spatial planning in VLMs with a new 3D environment benchmark). Presents a novel self-exploration framework for view planning.
**Relevance:** 10
**Novelty:** 9

---

## 1. [Grounded 3D-Aware Spatial Vision-Language Modeling](https://arxiv.org/abs/2605.30307) <a id="link1"></a>
**ArXiv ID:** 2605.30307
**Authors:** An-Chieh Cheng, Yang Fu, Yatai Ji, Ligeng Zhu, Guanqi Zhan, Zhuoyang Zhang, Zhaojing Yang, Song Han, Yao Lu, Pavlo Molchanov, Vidya Nariyambut Murali, Jan Kautz, Xiaolong Wang, Hongxu Yin, Sifei Liu
...
**Comment:** Strongly matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 2 (shows a new VLLM, GR3D, with explicit/implicit 2D and monocular 3D grounding). Also relevant to criterion 4 (vision foundation models and applications). The paper introduces a new spatial VLM with multiple grounding mechanisms and demonstrates improved spatial reasoning, which is a novel approach.
**Relevance:** 10
**Novelty:** 8

---

## 2. [VLA-Trace: Diagnosing Vision-Language-Action Models through Representation and Behavior Tracing](https://arxiv.org/abs/2605.30117) <a id="link2"></a>
**ArXiv ID:** 2605.30117
**Authors:** Haoyuan Shi, Xiancong Ren, Yingji Zhang, Qinfan Zhang, Jiayu Hu, Haozhe Shan, Han Dong, Jinpeng Lu, Yinda Chen, Yi Zhang, Yong Dai, Xiaozhu Ju
...
**Comment:** Directly matches criterion 1 (methodological improvements to spatial understanding on embodied agents) and criterion 3 (novel diagnostic methods for embodied VLA models). Provides new analysis tools for understanding VLA models' spatial reasoning and control.
**Relevance:** 10
**Novelty:** 8

---

## 3. [minWM: A Full-Stack Open-Source Framework for Real-Time Interactive Video World Models](https://arxiv.org/abs/2605.30263) <a id="link3"></a>
**ArXiv ID:** 2605.30263
**Authors:** Min Zhao, Hongzhou Zhu, Bokai Yan, Zihan Zhou, Yimin Chen, Wenqiang Sun, Kaiwen Zheng, Guande He, Xiao Yang, Chongxuan Li, Fan Bao, Jun Zhu
...
**Comment:** Matches criterion 3 (embodied AI, new benchmark/simulator) and criterion 4 (vision foundation models): Introduces minWM, an open-source framework for real-time interactive video world models, converting video foundation models into controllable, causal, low-latency world models for simulation and embodied AI.
**Relevance:** 10
**Novelty:** 8

---

## 4. [AgentCVR: Active Multi-Agent Cross-Video Reasoning via Script-Simulated Reinforcement Learning](https://arxiv.org/abs/2605.29643) <a id="link4"></a>
**ArXiv ID:** 2605.29643
**Authors:** Yilun Qiu, Jiahe Wang, Cilin Yan, Jiayin Cai, Xiaolong Jiang, Yao Hu, Chun Yuan
...
**Comment:** Matches criterion 2 (multi-modal large language models for cross-video reasoning) and criterion 3 (novel multi-agent framework and RL training for cross-video reasoning, with a new simulator for efficient training).
**Relevance:** 9
**Novelty:** 8

---

## 5. [VideoFDB: Evaluating Full-Duplex Vision-Speech Capabilities in Conversational Agents](https://arxiv.org/abs/2605.30256) <a id="link5"></a>
**ArXiv ID:** 2605.30256
**Authors:** Amrita Mazumdar, Seonwook Park, Rajarshi Roy, Nikhil Srihari, Shengze Wang, Yuhao Zhou, Julia Wang, Koki Nagano, Shalini De Mello
...
**Comment:** Matches criterion 3 (new benchmark for embodied/multimodal agents, specifically for full-duplex vision-speech conversational agents). VideoFDB is a new benchmark for AV2AV interaction, focusing on nonverbal conversational dynamics, which is a novel angle.
**Relevance:** 9
**Novelty:** 8

---

## 6. [Towards Consistent Video Geometry Estimation](https://arxiv.org/abs/2605.30060) <a id="link6"></a>
**ArXiv ID:** 2605.30060
**Authors:** Zhu Yu, Jingnan Gao, Runmin Zhang, Lingteng Qiu, Zhengyi Zhao, Rui Peng, Yichao Yan, Kejie Qiu, Siyu Zhu, Si-Yuan Cao, Hui-Liang Shen
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 4 (vision foundation models and applications). ViGeo is a foundation model for temporally consistent video geometry estimation, with a novel dynamic chunking attention and a completion-based data refinement framework. Strong focus on spatial understanding from video.
**Relevance:** 9
**Novelty:** 8

---

## 7. [Train the Agent, Not the Expert: Learning to Harness Heterogeneous Experts for Multi-Turn Visual Reasoning](https://arxiv.org/abs/2605.29894) <a id="link7"></a>
**ArXiv ID:** 2605.29894
**Authors:** Yaowu Fan, Tao Han, Dazhao Du, Andy J. Ma, Jia Wan
...
**Comment:** Strongly matches criterion 1 (methodological improvements to spatial intelligence on embodied agents) and criterion 3 (new method for multi-turn visual reasoning using heterogeneous experts, with dynamic visual memory archiving for efficient RL training). Also relevant to criterion 2 (multi-modal reasoning).
**Relevance:** 9
**Novelty:** 8

---

## 8. [AnyMo: Scaling Any-Modality Conditional Motion Generation with Masked Modeling](https://arxiv.org/abs/2605.29488) <a id="link8"></a>
**ArXiv ID:** 2605.29488
**Authors:** Yiheng Li, Zhuo Li, Ruibing Hou, Yingjie Chen, Hong Chang, Hao Liu, Shiguang Shan
...
**Comment:** Matches criterion 4 (vision foundation models and applications: AnyMo is a scalable, unified multimodal motion generation framework with a large new dataset). Also relevant to generative modeling in multi-modal learning.
**Relevance:** 8
**Novelty:** 8

---

## 9. [AgentSchool: An LLM-Powered Multi-Agent Simulation for Education](https://arxiv.org/abs/2605.30144) <a id="link9"></a>
**ArXiv ID:** 2605.30144
**Authors:** Yulei Ye, Wenhao Li, Zhong Wen, Yunshu Huang, Yichen Hu, Zifan Wei, Yige Wang, Xinyu Xie, Haoxuan Yang, Yanjun Huang, Ruijia Li, Hong Qian, Yu Song, Bo Jiang, Bingdong Li, Lijun Li, Bo Zhang, Pinlong Cai, Xingcheng Xu, Shuangye Chen, Xia Hu, Liang He, Aimin Zhou, Jingjing Qu, Jing Shao, Xiangfeng Wang
...
**Comment:** Matches criterion 3 (new multi-agent simulator/benchmark for educational settings, with novel modeling of cognitive/social trajectories and multi-agent coordination). AgentSchool introduces new simulation angles for embodied AI.
**Relevance:** 8
**Novelty:** 8

---

## 10. [ESAM++: Efficient Online 3D Perception on the Edge](https://arxiv.org/abs/2605.29505) <a id="link10"></a>
**ArXiv ID:** 2605.29505
**Authors:** Qin Liu, Lavisha Aggarwal, Saptarashmi Bandyopadhyay, Vikas Bahirwani, Marc Niethammer, Ehsan Adeli, Andrea Colaco
...
**Comment:** Directly matches criterion 1 (methodological improvements to spatial understanding on embodied agents) and criterion 3 (new methods for efficient 3D perception in embodied AI). Focuses on online 3D scene perception for robotics and AR/VR.
**Relevance:** 9
**Novelty:** 7

---

## 11. [MINDGAMES: A Live Arena for Evaluating Social and Strategic Reasoning in Multi-Agent LLMs](https://arxiv.org/abs/2605.29512) <a id="link11"></a>
**ArXiv ID:** 2605.29512
**Authors:** Kevin Wang, Anna Th\"oni, Benjamin Kempinski, Bobby Cheng, Jianzhu Yao, Benjamin Finch, Leon Guertler, Viraj Nadkarni, Yihan Jiang, Aliaksei Korshuk, Alexander Buyantuev, Ilya Makarov, Siyuan Wu, Yu-Chi Cheng, Yan-Ru Ju, Ti-Rong Wu, I-Hsuan Chu, Yu-Yu Yang, I-Chen Wu, Yitian Huang, Qinlu Cao, Yiheng Sun, Yuhong Dai, Hongkun Yao, Jingxuan Fu, Jiwei Zhang, Hao Liao, Mossimo Ebeling, Govind Arun, Sadhvik Bathini, Mihir S Arya, Avinash Anish, Aditya Ranjan, Kirtana Sunil Phatnani, Paval KS, Vrushali Mehta, Aravind S, Nikhil Arora, Tanya Upadhyay, Amol Bandagale, Yuan Lu, ChunEn Hsiao, YuTing Lin, Arvin Chung, Jerry John Thomas, Mathieu Lauri\`ere, Leshem Choshen, Yoram Bachrach, Pramod Viswanath, Maria Polukarov, Cheston Tan, Tal Kachman, Atlas Wang
...
**Comment:** Matches criterion 3 (embodied AI/new benchmarks): Introduces Mindgames, a new live arena and benchmark for evaluating social and strategic reasoning in multi-agent LLMs, with a large dataset and novel evaluation.
**Relevance:** 8
**Novelty:** 8

---

## 12. [LoMo: Local Modality Substitution for Deeper Vision-Language Fusion](https://arxiv.org/abs/2605.30265) <a id="link12"></a>
**ArXiv ID:** 2605.30265
**Authors:** Feng Han, Zhixiong Zhang, Zheming Liang, Yibin Wang, Jiaqi Wang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and 4 (vision foundation models and applications). Proposes LoMo, a new data curation paradigm for deeper vision-language fusion, with strong empirical results on VLMs.
**Relevance:** 9
**Novelty:** 7

---

## 13. [GenClaw: Code-Driven Agentic Image Generation](https://arxiv.org/abs/2605.30248) <a id="link13"></a>
**ArXiv ID:** 2605.30248
**Authors:** Junyan Ye, Jun He, Zilong Huang, Dongzhi Jiang, Xuan Yang, Rui Chen, Weijia Li
...
**Comment:** Matches criterion 2 (multi-modal agentic image generation) and criterion 4 (vision foundation models and applications). Proposes a code-driven, staged image generation paradigm integrating reasoning, sketching, and generative models for controllable visual synthesis.
**Relevance:** 8
**Novelty:** 8

---

## 14. [xModel-KD: Cross-modal Knowledge Distillation for 3D Scene Perception using LiDAR](https://arxiv.org/abs/2605.30111) <a id="link14"></a>
**ArXiv ID:** 2605.30111
**Authors:** Thenukan Pathmanathan, Kanchan Keisham, Thangarajah Akilan
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding on embodied agents) and criterion 3 (novel cross-modal knowledge distillation for 3D scene perception, focusing on annotation efficiency and leveraging multi-modal fusion). The method proposes a new cross-modal fusion encoder and contrastive objective for 3D point cloud segmentation, which is a novel angle for scalable 3D scene understanding.
**Relevance:** 8
**Novelty:** 7

---

## 15. [SAAS: Self-Aware Reinforcement Learning for Over-Search Mitigation in Agentic Search](https://arxiv.org/abs/2605.29796) <a id="link15"></a>
**ArXiv ID:** 2605.29796
**Authors:** Yunbo Tang, Chengyi Yang, Shiyu Liu, Zhishang Xiang, Zerui Chen, Qinggang Zhang, Jinsong Su
...
**Comment:** Matches criterion 1 (methodological improvement for agentic search via self-aware RL to mitigate over-search) and criterion 3 (novel RL framework for search boundary modeling in LLM agents).
**Relevance:** 8
**Novelty:** 7

---

## 16. [GRASP: Gated Regression-Aware Skill Proposer for Self-Improving LLM Agents](https://arxiv.org/abs/2605.29668) <a id="link16"></a>
**ArXiv ID:** 2605.29668
**Authors:** Johannes Moll, Jean-Philippe Corbeil, Jiazhen Pan, Martin Hadamitzky, Daniel Rueckert, Lisa Adams, Keno Bressem
...
**Comment:** Matches criterion 1 (methodological improvement for self-improving LLM agents via regression-aware skill proposal) and criterion 3 (novel method for agent skill improvement with regression gating, a new angle).
**Relevance:** 8
**Novelty:** 7

---

## 17. [Redundant or Necessary? A Benchmark for Detecting Redundant Steps in Agent Trajectories](https://arxiv.org/abs/2605.29893) <a id="link17"></a>
**ArXiv ID:** 2605.29893
**Authors:** Minyang Hu, Bo Yang, Zhinuo Zhou, Jiachen Liang, Guo Jiahao, Yiyang Yin, Xiongwei Han
...
**Comment:** Matches criterion 3 (new benchmark for agent trajectory analysis, focusing on redundant step detection, a previously overlooked aspect of agent efficiency). RedundancyBench is a new dataset and task.
**Relevance:** 8
**Novelty:** 7

---

## 18. [Meta-Cognitive Memory Policy Optimization for Long-Horizon LLM Agents](https://arxiv.org/abs/2605.30159) <a id="link18"></a>
**ArXiv ID:** 2605.30159
**Authors:** Ziyan Liu, Zhezheng Hao, Yeqiu Chen, Hong Wang, Jingren Hou, Ruiyi Ding, Yongkang Yang, Wence Ji, Wei Xia, Feng Liu
...
**Comment:** Matches criterion 1 (methodological improvements to memory and belief modeling in long-horizon LLM agents for spatial/temporal reasoning) and criterion 3 (novel method for memory optimization in embodied/agentic settings). Introduces Belief Entropy and MMPO for fine-grained memory policy optimization, which is a new angle.
**Relevance:** 8
**Novelty:** 7

---

## 19. [EarlyTom: Early Token Compression Completes Fast Video Understanding](https://arxiv.org/abs/2605.30010) <a id="link19"></a>
**ArXiv ID:** 2605.30010
**Authors:** Hesong Wang, Xin Jin, Lu Lu, Chenhaowen Li, Jian Chen, Qiang Liu, Huan Wang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and 4 (vision foundation models and applications): Proposes EarlyTom, a new token compression framework for Video-LLMs, improving efficiency and practicality.
**Relevance:** 8
**Novelty:** 7

---

## 20. [FakeVLM-R1: Internalizing Physical Laws via CoT for Synthetic Image Detection](https://arxiv.org/abs/2605.30062) <a id="link20"></a>
**ArXiv ID:** 2605.30062
**Authors:** Leqi Zhu, Junyan Ye, Kaiqing Lin, Zhiyuan Yan, Conghui He, Weijia Li
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs): Proposes FakeVLM-R1, a new LMM for synthetic image detection with a novel reasoning mechanism. Also relevant to criterion 4 (vision foundation models and applications).
**Relevance:** 8
**Novelty:** 7

---

## 21. [Reinforcement Learning with Robust Rubric Rewards](https://arxiv.org/abs/2605.30244) <a id="link21"></a>
**ArXiv ID:** 2605.30244
**Authors:** Ya-Qi Yu, Hao Wang, Fangyu Hong, Xiangyang Qu, Gaojie Wu, Qiaoyu Luo, Nuo Xu, Huixin Wang, Wuheng Xu, Yongxin Liao, Zihao Chen, Haonan Li, Ziming Li, Dezhi Peng, Minghui Liao, Jihao Wu, Haoyu Ren, Dandan Tu
...
**Comment:** Matches criterion 2 (VLLMs/MLLMs) and is relevant to vision-language RL. Proposes a new RL framework for vision-language tasks with rubric-based rewards, evaluated on a strong VLLM (Qwen3-VL-30B-A3B) across 15 benchmarks. Novel reward design for multi-criteria supervision in VLMs.
**Relevance:** 8
**Novelty:** 7

---

## 22. [Geometry-Guided Modeling of Foundation Features Enables Generalizable Object Shape Deformation Learning](https://arxiv.org/abs/2605.29661) <a id="link22"></a>
**ArXiv ID:** 2605.29661
**Authors:** Yiyao Ma, Kai Chen, Zhongxiang Zhou, Zhuheng Song, Dongsheng Xie, Zelong Tan, Rong Xiong, Qi Dou
...
**Comment:** Strongly matches criterion 4 (vision foundation models and applications). Proposes a geometry-guided feature modeling mechanism for generalizable 3D object shape deformation, with applications to robotic manipulation.
**Relevance:** 8
**Novelty:** 7

---

## 23. [DeepTool: Scaling Interleaved Deliberation in Tool-Integrated Reasoning via Process-Supervised Reinforcement Learning](https://arxiv.org/abs/2605.29568) <a id="link23"></a>
**ArXiv ID:** 2605.29568
**Authors:** Yang He, Xiao Ding, Bibo Cai, Yufei Zhang, Kai Xiong, Zhouhao Sun, Bing Qin, Ting Liu
...
**Comment:** Matches criterion 1 (methodological improvements to spatial intelligence on embodied agents) and criterion 3 (new methods for tool-integrated reasoning in agents). Introduces a process-supervised RL framework for tool-integrated reasoning with interleaved thinking/action/observation, and demonstrates significant empirical improvements.
**Relevance:** 8
**Novelty:** 7

---

## 24. [Mind-Omni: A Unified Multi-Task Framework for Brain-Vision-Language Modeling via Discrete Diffusion](https://arxiv.org/abs/2605.29591) <a id="link24"></a>
**ArXiv ID:** 2605.29591
**Authors:** Yizhuo Lu, Changde Du, Qingyu Shi, Hang Chen, Jie Peng, Liuyun Jiang, Shuangchen Zhao, Huiguang He
...
**Comment:** Related to criterion 2 (multi-modal large language models) and criterion 4 (foundation models for neural activity), but focuses on brain-vision-language modeling rather than spatial intelligence or embodied agents.
**Relevance:** 6
**Novelty:** 8

---

## 25. [OmniMatBench: A Human-Calibrated Multimodal Reasoning Benchmark Across 19 Materials Science Subfields](https://arxiv.org/abs/2605.29833) <a id="link25"></a>
**ArXiv ID:** 2605.29833
**Authors:** Wanhao Liu, Jiaqing Xie, Qian Tan, Weida Wang, Jue Wang, Ran Sun, Zhuo Yang, Wanli Ouyang, Lei Bai, Tianfan Fu, Lu Chen, Xin Chen, Yuqiang Li
...
**Comment:** Matches criterion 3 (new benchmark for MLLMs) and criterion 2 (evaluation of MLLMs) by introducing a new multimodal reasoning benchmark for materials science and evaluating multiple MLLMs.
**Relevance:** 7
**Novelty:** 7

---

## 26. [DocRetriever: A Plug-and-Play Framework for Multimodal Document Retrieval with Comprehensive Benchmark](https://arxiv.org/abs/2605.30027) <a id="link26"></a>
**ArXiv ID:** 2605.30027
**Authors:** Ruofan Hu, Menghui Zhu, Jieming Zhu, Bo Chen, Shengyang Xu, Minjie Hong, Xiaoda Yang, Sashuai Zhou, Li Tang, Tao Jin, Zhou Zhao
...
**Comment:** Matches criterion 2 (new MLLMs/VLLMs) and criterion 4 (vision foundation models and applications) by proposing a new multimodal document retrieval framework and benchmark.
**Relevance:** 7
**Novelty:** 7

---

## 27. [ReasonLight: A Multimodal Foundation Model-Enhanced Reinforcement Learning Framework for Zero-Shot Traffic Signal Control](https://arxiv.org/abs/2605.29425) <a id="link27"></a>
**ArXiv ID:** 2605.29425
**Authors:** Aoyu Pang, Maonan Wang, Yuejiao Xie, Chung Shue Chen, Zhiwei Yang, Man-On Pun
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Proposes ReasonLight, a multimodal foundation model-enhanced RL framework for zero-shot traffic signal control, integrating vision and RL.
**Relevance:** 7
**Novelty:** 7

---

## 28. [BenchTrace: A Benchmark for Testing Reflection Ability and Controlled Evolution in LLM Agents](https://arxiv.org/abs/2605.29225) <a id="link28"></a>
**ArXiv ID:** 2605.29225
**Authors:** Jiahao Huang, Fei Cheng, Junfeng Jiang, Zefan Yu, Akiko Aizawa
...
**Comment:** Matches criterion 3 (new benchmarks for embodied/agentic AI). Introduces BenchTrace, a benchmark for evaluating self-evolution and reflection in LLM agents, with new metrics and analysis of failure avoidance. Focuses on agentic behavior and evaluation, which is a novel angle.
**Relevance:** 7
**Novelty:** 7

---

## 29. [AnomalyAgent: Training-Free Agentic Models for Zero-/Few-Shot Anomaly Detection](https://arxiv.org/abs/2605.30140) <a id="link29"></a>
**ArXiv ID:** 2605.30140
**Authors:** Yi Zhang, Jiawen Zhu, Lele Fu, Guansong Pang
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs): Proposes AnomalyAgent, a training-free agentic framework leveraging MLLMs for zero-/few-shot anomaly detection, with agentic reasoning and memory modules.
**Relevance:** 7
**Novelty:** 7

---

## 30. [IP-Adapter Is All You Need: Towards Fine-Tuning-Free Diffusion-Based Talking Face Generation](https://arxiv.org/abs/2605.30230) <a id="link30"></a>
**ArXiv ID:** 2605.30230
**Authors:** Hao Wu, Xiangyang Luo, Hao Wang, Jiawei Zhang, Yi Zhang, Jinwei Wang
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Proposes a fine-tuning-free diffusion-based talking face generation method leveraging Stable Diffusion and IP-Adapter, with novel parameter-free modules for identity and temporal consistency.
**Relevance:** 7
**Novelty:** 7

---

## 31. [VideoMLA: Low-Rank Latent KV Cache for Minute-Scale Autoregressive Video Diffusion](https://arxiv.org/abs/2605.30351) <a id="link31"></a>
**ArXiv ID:** 2605.30351
**Authors:** Hidir Yesiltepe, Jiazhen Hu, Tuna Han Salih Meral, Adil Kaan Akan, Kaan Oktay, Hoda Eldardiry, Pinar Yanardag
...
**Comment:** Related to criterion 4 (vision foundation models and applications) and generative modeling in multi-modal learning, with a focus on efficient video diffusion models. Not directly about spatial intelligence or embodied agents.
**Relevance:** 6
**Novelty:** 7

---

## 32. [Fewer Steps, Better Performance: Efficient Cross-Modal Clip Trimming for Video Moment Retrieval Using Language](https://arxiv.org/abs/2605.29793) <a id="link32"></a>
**ArXiv ID:** 2605.29793
**Authors:** Xiang Fang, Daizong Liu, Wanlong Fang, Pan Zhou, Zichuan Xu, Wenzheng Xu, Junyang Chen, Renfu Li
...
**Comment:** Matches criterion 2 (multi-modal large language models for video moment retrieval) and is relevant to criterion 4 (vision foundation models and applications). Proposes a new efficient cross-modal clip trimming method for video-language retrieval.
**Relevance:** 7
**Novelty:** 6

---

## 33. [Large Depth Completion Model from Sparse Observations](https://arxiv.org/abs/2605.30115) <a id="link33"></a>
**ArXiv ID:** 2605.30115
**Authors:** Zhu Yu, Zhengyi Zhao, Runmin Zhang, Lingteng Qiu, Kejie Qiu, Yisheng He, Siyu Zhu, Zilong Dong, Si-Yuan Cao, Hui-Liang Shen
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Presents a large depth completion model leveraging monocular foundation models and a novel training objective for metric depth estimation from sparse observations.
**Relevance:** 7
**Novelty:** 6

---

## 34. [PTCG-Bench: Can LLM Agents Master Pok\'emon Trading Card Game?](https://arxiv.org/abs/2605.29653) <a id="link34"></a>
**ArXiv ID:** 2605.29653
**Authors:** Dongdong Hua, Yifei Sun, Renhong Huang, Feng Gao, Chunping Wang, Yang Yang
...
**Comment:** Matches criterion 3 (new embodied AI benchmark in a complex interactive environment). Focuses on LLM agents in the Pokémon Trading Card Game, which is less spatial but relevant for embodied agent benchmarks.
**Relevance:** 6
**Novelty:** 6

---

## 35. [SkillsInjector: Dynamic Skill Context Construction for LLM Agents](https://arxiv.org/abs/2605.29794) <a id="link35"></a>
**ArXiv ID:** 2605.29794
**Authors:** Yanchao Li, Wanhao Liu, Ben Gao, Jiaqing Xie, Zhehong Ai, Na Zou, Yuqiang Li, Tianfan Fu
...
**Comment:** Matches criterion 3 (embodied AI/new methods) to some extent: proposes a new method for dynamic skill context construction in LLM agents, evaluated on ALFWorld (an embodied AI benchmark).
**Relevance:** 6
**Novelty:** 6

---

## 36. [Not All Inputs Are Valid: Towards Open-Set Video Moment Retrieval Using Language](https://arxiv.org/abs/2605.29812) <a id="link36"></a>
**ArXiv ID:** 2605.29812
**Authors:** Xiang Fang, Wanlong Fang, Daizong Liu, Xiaoye Qu, Jianfeng Dong, Pan Zhou, Renfu Li, Zichuan Xu, Lixing Chen, Panpan Zheng, Yu Cheng
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs): Proposes a novel model (OpenVMR) for open-set video moment retrieval using language, with normalizing flow and positive-unlabeled learning. Also involves cross-modal interaction between video and language.
**Relevance:** 6
**Novelty:** 6

---

## 37. [Battery-Sim-Agent: Leveraging LLM-Agent for Inverse Battery Parameter Estimation](https://arxiv.org/abs/2605.29560) <a id="link37"></a>
**ArXiv ID:** 2605.29560
**Authors:** Jiawei Chen, Xiaofan Gui, Shikai Fang, Shengyu Tao, Shun Zheng, Weiqing Liu, Jiang Bian
...
**Comment:** Somewhat matches criterion 3 (LLM agent in closed-loop with a simulator for scientific discovery, but focused on battery parameter estimation, not spatial/embodied AI). Interesting agent-simulator loop, but more application-specific.
**Relevance:** 5
**Novelty:** 6

---

## 38. [Robust and Generalizable Safety Steering for Text-to-Image Diffusion Transformers](https://arxiv.org/abs/2605.30049) <a id="link38"></a>
**ArXiv ID:** 2605.30049
**Authors:** Zihao Xue, Yan Wang, Zhen Bi, Long Ma, Zhonglong Zheng, Zeyu Yang, Bingyu Zhu, Longtao Huang, Jie Xiao, Jungang Lou
...
**Comment:** Related to vision foundation models (criterion 4) and generative modeling in multi-modal learning, but focuses on safety steering for text-to-image diffusion transformers rather than new spatial intelligence or embodied agents.
**Relevance:** 5
**Novelty:** 6

---

## 39. [The Chain Holds, the Answer Folds: Trace-Answer Dissociation in Reasoning Models Under Adversarial Pressure](https://arxiv.org/abs/2605.29087) <a id="link39"></a>
**ArXiv ID:** 2605.29087
**Authors:** Yubo Li, Ramayya Krishnan, Rema Padman
...
**Comment:** Somewhat related to criterion 2 (reasoning in LLMs), but not about vision or multi-modal models. Focuses on reasoning trace/answer dissociation under adversarial pressure.
**Relevance:** 4
**Novelty:** 6

---

## 40. [ParaTool: Shifting Tool Representations from Context to Parameters](https://arxiv.org/abs/2605.29561) <a id="link40"></a>
**ArXiv ID:** 2605.29561
**Authors:** Zekai Yu, Qi Meng, Qizhi Chu, Yu Hao, Chuan Shi, Cheng Yang
...
**Comment:** Related to criterion 2 (new methods for LLM tool use), but not specifically about vision or multi-modal models. Focuses on parameterizing tool representations for LLMs.
**Relevance:** 4
**Novelty:** 6

---

## 41. [Harmonizing Real-Time Constraints and Long-Horizon Reasoning: An Asynchronous Agentic Framework for Dynamic Scheduling](https://arxiv.org/abs/2605.29262) <a id="link41"></a>
**ArXiv ID:** 2605.29262
**Authors:** Shijie Cao, Yuan Yuan, Jing Liu
...
**Comment:** Related to criterion 3 (embodied AI, new methods/benchmarks), but the focus is on scheduling in industrial control with LLMs, not vision or embodied agents in the usual sense. Interesting agentic framework, but not a direct match.
**Relevance:** 4
**Novelty:** 6

---

## 42. [Make LLM Learn to Synthesize from Streaming Experiences through Feedback](https://arxiv.org/abs/2605.29940) <a id="link42"></a>
**ArXiv ID:** 2605.29940
**Authors:** Zhenlin Hu, Yan Wang, Zhen Bi, Zihao Xue, Bingyu Zhu, Longtao Huang, Xiongtao Zhang, Zeyu Yang, Zhixuan Chu, Jungang Lou
...
**Comment:** Somewhat related to criterion 2 (new VLLMs/MLLMs), but focuses on LLMs for synthetic data generation and learning from streaming tasks. Not directly about vision or multi-modal models.
**Relevance:** 4
**Novelty:** 6

---

## 43. [Citation-Closure Retrieval and Per-Rule Attribution for Real-World Regulatory Compliance Question Answering](https://arxiv.org/abs/2605.29742) <a id="link43"></a>
**ArXiv ID:** 2605.29742
**Authors:** Yeong-Joon Ju, Seong-Whan Lee
...
**Comment:** Somewhat related to criterion 3 (new benchmark for regulatory compliance QA, with a focus on structured procedural lookups and evidence attribution). However, the focus is more on retrieval and legal QA than embodied AI or spatial intelligence.
**Relevance:** 4
**Novelty:** 6

---

## 44. [Domain-Specific Data Synthesis for LLMs via Minimal Sufficient Representation Learning](https://arxiv.org/abs/2605.30039) <a id="link44"></a>
**ArXiv ID:** 2605.30039
**Authors:** Tong Ye, Hang Yu, Tengfei Ma, Xuhong Zhang, Jianguo Li, Peng Di, Peiyu Liu, Jianwei Yin, Wenhai Wang
...
**Comment:** Related to data synthesis for LLMs, but not directly matching any of the four criteria (not spatial, embodied, or vision-focused).
**Relevance:** 3
**Novelty:** 6

---

## 45. [Enhancing Multi-Agent Communication through Attention Steering with Context Relevance](https://arxiv.org/abs/2605.30136) <a id="link45"></a>
**ArXiv ID:** 2605.30136
**Authors:** Hongxiang Zhang, Yuan Tian, Tianyi Zhang
...
**Comment:** Somewhat related to criterion 1 (attention steering in multi-agent systems, which could be relevant for spatial intelligence in collaborative agents), but not directly focused on spatial or embodied AI.
**Relevance:** 4
**Novelty:** 5

---

## 46. [Toward AI Systems That Understand Self and Others: A Multi-Phase Inference Framework for Human Cognitive Diversity and World-Model Alignment](https://arxiv.org/abs/2605.29930) <a id="link46"></a>
**ArXiv ID:** 2605.29930
**Authors:** Toru Takahashi
...
**Comment:** Does not directly match any criterion; focuses on cognitive diversity and world-model alignment, more theoretical and philosophical than methodological or benchmark-driven.
**Relevance:** 3
**Novelty:** 5

---

## 47. [Non-Forgetting Knowledge Allocation with Bi-level Competition for Class-Incremental Learning](https://arxiv.org/abs/2605.29592) <a id="link47"></a>
**ArXiv ID:** 2605.29592
**Authors:** Xiang Tan, Run He, Yawen Cui, Mengchen Zhao, Yan Wu, Tianyi Chen, Huiping Zhuang, Xiaonan Luo, Guanbin Li
...
**Comment:** Does not match any specific criterion. Focuses on class-incremental learning and adapter allocation, not spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 48. [FedSmoothLoRA: Toward Smoother and Faster Convergence in Federated Low-Rank Adaptation](https://arxiv.org/abs/2605.29460) <a id="link48"></a>
**ArXiv ID:** 2605.29460
**Authors:** Zehao Wang, Guanglei Yang, Yihan Zeng, Hang Xu, Hongzhi Zhang, Wangmeng Zuo, Chun-Mei Feng
...
**Comment:** Does not match any specific criterion. Focuses on federated learning and LoRA adaptation, not spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 49. [When Should Models Change Their Minds? Contextual Belief Management in Large Language Models](https://arxiv.org/abs/2605.30219) <a id="link49"></a>
**ArXiv ID:** 2605.30219
**Authors:** Haoming Xu, Weihong Xu, Zongrui Li, Mengru Wang, Yunzhi Yao, Chiyu Wu, Jin Shang, Yu Gong, Shumin Deng
...
**Comment:** Does not match any specific criterion. Focuses on belief management in LLMs, not vision or multi-modal.
**Relevance:** 3
**Novelty:** 5

---

## 50. [Behavior-Aware Auxiliary Corrections for Off-Policy Temporal-Difference Prediction](https://arxiv.org/abs/2605.28855) <a id="link50"></a>
**ArXiv ID:** 2605.28855
**Authors:** Xingguo Chen, Zhiang He, Yuchen Shen, Shangdong Yang, Chao Li, Guang Yang, Wenhao Wang
...
**Comment:** Relevant to RL and off-policy TD learning, but not directly about spatial intelligence, VLLMs/MLLMs, or vision foundation models. No direct match to criteria.
**Relevance:** 3
**Novelty:** 5

---

## 51. [VikingMem: A Memory Base Management System for Stateful LLM-based Applications](https://arxiv.org/abs/2605.29640) <a id="link51"></a>
**ArXiv ID:** 2605.29640
**Authors:** Jiajie Fu, Junwen Chen, Mengzhao Wang, Aoxiang He, Maojia Sheng, Xiangyu Ke, Yifan Zhu, Yunjun Gao
...
**Comment:** Somewhat related to criterion 2 (LLM memory management), but not about vision or multi-modal models. Focuses on stateful LLM applications.
**Relevance:** 3
**Novelty:** 5

---

## 52. [Behavior-Induced Mirror-Prox Temporal-Difference Learning for Faster Off-Policy Prediction](https://arxiv.org/abs/2605.28849) <a id="link52"></a>
**ArXiv ID:** 2605.28849
**Authors:** Xingguo Chen, Yuchen Shen, Shangdong Yang, Chao Li, Guang Yang, Wenhao Wang
...
**Comment:** Relevant to RL and off-policy prediction, but not directly about spatial intelligence, VLLMs/MLLMs, or vision foundation models. No direct match to criteria.
**Relevance:** 3
**Novelty:** 5

---

## 53. [Tailoring the Curriculum: Student-Centered Reasoning Distillation via Dynamic Data-Model Compatibility](https://arxiv.org/abs/2605.29229) <a id="link53"></a>
**ArXiv ID:** 2605.29229
**Authors:** Jiahao Huang, Fei Cheng, Junfeng Jiang, Akiko Aizawa
...
**Comment:** Related to general reasoning distillation in LLMs, but does not directly match any of the four criteria (not spatial, embodied, or vision-focused).
**Relevance:** 3
**Novelty:** 5

---

## 54. [Efficient, Validation-Free Intrinsic Quality Estimation for Large-Scale Face Recognition Datasets](https://arxiv.org/abs/2605.29720) <a id="link54"></a>
**ArXiv ID:** 2605.29720
**Authors:** Zhichao Chen, Yongle Zhao, Kaicheng Yang, Meng Yang, Yin Xie, Ziyong Feng
...
**Comment:** Does not match any specific criterion. Focuses on face recognition dataset quality estimation, not spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 4

---

## 55. [Lightweight Complementary-Cue Fusion for Robust Video Face Forgery Detection](https://arxiv.org/abs/2605.29092) <a id="link55"></a>
**ArXiv ID:** 2605.29092
**Authors:** Sunghwan Baek, Tariq Anwaar, Karanveer Singh, Rita Singh
...
**Comment:** Does not directly match any specific criterion. Focuses on lightweight fusion for video face forgery detection, which is vision-related but not about spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 4

---

## 56. [Robust Cross-Domain Generalization Using Unlabeled Target Data with Source-Domain Supervision](https://arxiv.org/abs/2605.29122) <a id="link56"></a>
**ArXiv ID:** 2605.29122
**Authors:** Yuyue Zhou (Kai Yue), Shrimanti Ghosh (Kai Yue), Michael (Kai Yue), Xie, Justin JY Kim, Jessica Knight, Steel McDonald, Vincent Man, Jacob L. Jaremko, Abhilash Hareendranathan
...
**Comment:** Does not directly match any specific criterion. Focuses on cross-domain generalization in medical imaging using self-supervised learning and model ensembling. Related to computer vision and ML, but not to spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 4
