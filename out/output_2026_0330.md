...
0. [OVI-MAP:Open-Vocabulary Instance-Semantic Mapping](#link0)
**Authors:** Zilong Deng, Federico Tombari, Marc Pollefeys, Johanna Wald, Daniel Barath

1. [ViGoR-Bench: How Far Are Visual Generative Models From Zero-Shot Visual Reasoners?](#link1)
...
3. [Beyond Where to Look: Trajectory-Guided Reinforcement Learning for Multimodal RLVR](#link3)
**Authors:** Jinda Lu, Junkang Wu, Jinghan Li, Kexin Huang, Shuo Yang, Mingzhu Chen, Jiancan Wu, Kuien Liu, Xiang Wang

4. [ArtHOI: Taming Foundation Models for Monocular 4D Reconstruction of Hand-Articulated-Object Interactions](#link4)
**Authors:** Zikai Wang, Zhilu Zhang, Yiqing Wang, Hui Li, Wangmeng Zuo

5. [CREval: An Automated Interpretable Evaluation for Creative Image Manipulation under Complex Instructions](#link5)
**Authors:** Chonghuinan Wang, Zihan Chen, Yuxiang Wei, Tianyi Jiang, Xiaohe Wu, Fan Li, Wangmeng Zuo, Hongxun Yao

6. [GUIDE: A Benchmark for Understanding and Assisting Users in Open-Ended GUI Tasks](#link6)
**Authors:** Saelyne Yang, Jaesang Yu, Yi-Hao Peng, Kevin Qinghong Lin, Jae Won Cho, Yale Song, Juho Kim

7. [Generation Is Compression: Zero-Shot Video Coding via Stochastic Rectified Flow](#link7)
**Authors:** Ziyue Zeng, Xun Su, Haoyuan Liu, Bingyu Lu, Yui Tatsumi, Hiroshi Watanabe

8. [TaxaAdapter: Vision Taxonomy Models are Key to Fine-grained Image Generation over the Tree of Life](#link8)
...
9. [Rethinking Token Pruning for Historical Screenshots in GUI Visual Agents: Semantic, Spatial, and Temporal Perspectives](#link9)
**Authors:** Daiqiang Li, Zihao Pan, Zeyu Zhang, Ronghao Chen, Huacan Wang, Honggang Chen, Haiyun Jiang

10. [GeoGuide: Hierarchical Geometric Guidance for Open-Vocabulary 3D Semantic Segmentation](#link10)
...
11. [DiReCT: Disentangled Regularization of Contrastive Trajectories for Physics-Refined Video Generation](#link11)
**Authors:** Abolfazl Meyarian, Amin Karimi Monsefi, Rajiv Ramnath, Ser-Nam Lim

12. [ARTA: Adaptive Mixed-Resolution Token Allocation for Efficient Dense Feature Extraction](#link12)
**Authors:** David Hagerman, Roman Naeem, Erik Brorsson, Fredrik Kahl, Lennart Svensson

13. [Real-Time Branch-to-Tool Distance Estimation for Autonomous UAV Pruning: Benchmarking Five DEFOM-Stereo Variants from Simulation to Jetson Deployment](#link13)
**Authors:** Yida Lin, Bing Xue, Mengjie Zhang, Sam Schofield, Richard Green

14. [JRM: Joint Reconstruction Model for Multiple Objects without Alignment](#link14)
...
15. [SparseCam4D: Spatio-Temporally Consistent 4D Reconstruction from Sparse Cameras](#link15)
**Authors:** Weihong Pan, Xiaoyu Zhang, Zhuang Zhang, Zhichao Ye, Nan Wang, Haomin Liu, Guofeng Zhang

16. [Diffusion MRI Transformer with a Diffusion Space Rotary Positional Embedding (D-RoPE)](#link16)
...
17. [GLASS: Geometry-aware Local Alignment and Structure Synchronization Network for 2D-3D Registration](#link17)
**Authors:** Zhixin Cheng, Jiacheng Deng, Xinjun Li, Bohao Liao, Li Liu, Xiaotian Yin, Baoqun Yin, Tianzhu Zhang

18. [HAD: Heterogeneity-Aware Distillation for Lifelong Heterogeneous Learning](#link18)
**Authors:** Xuerui Zhang, Xuehao Wang, Zhan Zhuang, Linglan Zhao, Ziyue Li, Xinmin Zhang, Zhihuan Song, Yu Zhang

19. [Pioneering Perceptual Video Fluency Assessment: A Novel Task with Benchmark Dataset and Baseline](#link19)
**Authors:** Qizhi Xie, Kun Yuan, Yunpeng Qu, Ming Sun, Chao Zhou, Jihong Zhu

20. [MuDD: A Multimodal Deception Detection Dataset and GSR-Guided Progressive Distillation for Non-Contact Deception Detection](#link20)
**Authors:** Peiyuan Jiang, Yao Liu, Yanglei Gan, Jiaye Yang, Lu Liu, Daibing Yao, Qiao Liu

21. [Face2Parts: Exploring Coarse-to-Fine Inter-Regional Facial Dependencies for Generalized Deepfake Detection](#link21)
**Authors:** Kutub Uddin, Nusrat Tasnim, Byung Tae Oh

22. [Only Whats Necessary: Pareto Optimal Data Minimization for Privacy Preserving Video Anomaly Detection](#link22)
**Authors:** Nazia Aslam, Abhisek Ray, Thomas B. Moeslund, Kamal Nasrollahi

---
## 0. [OVI-MAP:Open-Vocabulary Instance-Semantic Mapping](https://arxiv.org/abs/2603.26541) <a id="link0"></a>
**ArXiv ID:** 2603.26541
**Authors:** Zilong Deng, Federico Tombari, Marc Pollefeys, Johanna Wald, Daniel Barath
...
**Comment:** Directly matches criterion 1 and 3: OVI-MAP proposes a new open-vocabulary 3D instance-semantic mapping system for embodied agents, using vision-language models for semantic inference and real-time mapping. It also leverages VLMs (criterion 2) for semantic labeling. Strong match for embodied AI, spatial intelligence, and VLLM application.
**Relevance:** 10
**Novelty:** 8

---

## 1. [ViGoR-Bench: How Far Are Visual Generative Models From Zero-Shot Visual Reasoners?](https://arxiv.org/abs/2603.25823) <a id="link1"></a>
**ArXiv ID:** 2603.25823
**Authors:** Haonan Han, Jiancheng Huang, Xiaopeng Sun, Junyan He, Rui Yang, Jie Hu, Xiaojiang Peng, Lin Ma, Xiaoming Wei, Xiu Li
...
**Comment:** Matches criterion 4: introduces ViGoR-Bench, a new benchmark for evaluating reasoning abilities of visual generative models (vision foundation models) in zero-shot visual reasoning tasks, with a focus on spatial, causal, and physical reasoning.
**Relevance:** 9
**Novelty:** 8
...
**Comment:** Matches criterion 3 (embodied AI, new methods for GUI agents, plug-and-play annotation pipeline, and new benchmark for GUI agent domain bias). The use of real-time web video retrieval and automated annotation for GUI agents is a novel angle.
**Relevance:** 8
**Novelty:** 8

---

## 3. [Beyond Where to Look: Trajectory-Guided Reinforcement Learning for Multimodal RLVR](https://arxiv.org/abs/2603.26126) <a id="link3"></a>
**ArXiv ID:** 2603.26126
**Authors:** Jinda Lu, Junkang Wu, Jinghan Li, Kexin Huang, Shuo Yang, Mingzhu Chen, Jiancan Wu, Kuien Liu, Xiang Wang
...
**Comment:** Directly matches criterion 2 (new methods for MLLMs) and is also relevant to criterion 1 (spatial intelligence in embodied agents) as it focuses on improving reasoning in multimodal RLVR by integrating visual evidence into reasoning chains. The trajectory-guided RL approach and token-level reweighting are new methods for bridging perception and reasoning.
**Relevance:** 9
**Novelty:** 7

---

## 4. [ArtHOI: Taming Foundation Models for Monocular 4D Reconstruction of Hand-Articulated-Object Interactions](https://arxiv.org/abs/2603.25791) <a id="link4"></a>
**ArXiv ID:** 2603.25791
**Authors:** Zikai Wang, Zhilu Zhang, Yiqing Wang, Hui Li, Wangmeng Zuo
...
**Comment:** Matches criterion 4 and partially criterion 2: leverages foundation models and MLLMs for monocular 4D reconstruction of hand-articulated-object interactions, introducing new methods and datasets. Strong application of vision foundation models and MLLMs.
**Relevance:** 8
**Novelty:** 8

---

## 5. [CREval: An Automated Interpretable Evaluation for Creative Image Manipulation under Complex Instructions](https://arxiv.org/abs/2603.26174) <a id="link5"></a>
**ArXiv ID:** 2603.26174
**Authors:** Chonghuinan Wang, Zihan Chen, Yuxiang Wei, Tianyi Jiang, Xiaohe Wu, Fan Li, Wangmeng Zuo, Hongxun Yao
...
**Comment:** Matches criterion 2 and 4: introduces CREval, an automated evaluation pipeline and benchmark for creative image manipulation under complex instructions, systematically evaluating state-of-the-art multimodal large language models (MLLMs) and vision foundation models for image editing.
**Relevance:** 9
**Novelty:** 7

---

## 6. [GUIDE: A Benchmark for Understanding and Assisting Users in Open-Ended GUI Tasks](https://arxiv.org/abs/2603.25864) <a id="link6"></a>
**ArXiv ID:** 2603.25864
**Authors:** Saelyne Yang, Jaesang Yu, Yi-Hao Peng, Kevin Qinghong Lin, Jae Won Cho, Yale Song, Juho Kim
...
**Comment:** Matches criterion 3: introduces a new benchmark (GUIDE) for understanding and assisting users in open-ended GUI tasks, focusing on user intent and behavior in GUI agents. Also relevant to spatial understanding in embodied agents (criterion 1) as it involves perception and reasoning about user actions in spatially complex interfaces.
**Relevance:** 8
**Novelty:** 8

---

## 7. [Generation Is Compression: Zero-Shot Video Coding via Stochastic Rectified Flow](https://arxiv.org/abs/2603.26571) <a id="link7"></a>
**ArXiv ID:** 2603.26571
**Authors:** Ziyue Zeng, Xun Su, Haoyuan Liu, Bingyu Lu, Yui Tatsumi, Hiroshi Watanabe
...
**Comment:** This paper proposes a generative video codec that uses a pretrained video foundation model as the codec itself, supporting multiple conditioning strategies (image, text, first/last frame). This is a novel application of vision foundation models (criterion 4) and generative modeling.
**Relevance:** 8
**Novelty:** 8

---

## 8. [TaxaAdapter: Vision Taxonomy Models are Key to Fine-grained Image Generation over the Tree of Life](https://arxiv.org/abs/2603.26128) <a id="link8"></a>
**ArXiv ID:** 2603.26128
**Authors:** Mridul Khurana, Amin Karimi Monsefi, Justin Lee, Medha Sawhney, David Carlyn, Julia Chae, Jianyang Gu, Rajiv Ramnath, Sara Beery, Wei-Lun Chao, Anuj Karpatne, Cheng Zhang
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and also relates to criterion 2 (VLLMs/MLLMs) via the use of BioCLIP and a new multimodal LLM-based metric. The method is a novel way to inject vision taxonomy model embeddings into diffusion models for fine-grained image generation, and introduces a new evaluation metric.
**Relevance:** 8
**Novelty:** 7

---

## 9. [Rethinking Token Pruning for Historical Screenshots in GUI Visual Agents: Semantic, Spatial, and Temporal Perspectives](https://arxiv.org/abs/2603.26041) <a id="link9"></a>
**ArXiv ID:** 2603.26041
**Authors:** Daiqiang Li, Zihao Pan, Zeyu Zhang, Ronghao Chen, Huacan Wang, Honggang Chen, Haiyun Jiang
...
**Comment:** Matches criterion 1 and 3: provides empirical insights into token pruning for GUI visual agents (MLLMs), focusing on semantic, spatial, and temporal perspectives, and offers new practical strategies for efficient spatial reasoning in embodied agents.
**Relevance:** 8
**Novelty:** 7

---

## 10. [GeoGuide: Hierarchical Geometric Guidance for Open-Vocabulary 3D Semantic Segmentation](https://arxiv.org/abs/2603.26260) <a id="link10"></a>
**ArXiv ID:** 2603.26260
**Authors:** Xujing Tao, Chuxin Wang, Yubo Ai, Zhixin Cheng, Zhuoyuan Li, Liangsheng Liu, Yujia Chen, Xinjun Li, Qiao Li, Wenfei Yang, Tianzhu Zhang
...
**Comment:** GeoGuide proposes a new framework for open-vocabulary 3D semantic segmentation, integrating hierarchical geometric-semantic consistency and uncertainty-based distillation. This is relevant to spatial understanding (criterion 1) and vision foundation models (criterion 4), especially for 3D scene understanding.
**Relevance:** 8
**Novelty:** 7

---

## 11. [DiReCT: Disentangled Regularization of Contrastive Trajectories for Physics-Refined Video Generation](https://arxiv.org/abs/2603.25931) <a id="link11"></a>
**ArXiv ID:** 2603.25931
**Authors:** Abolfazl Meyarian, Amin Karimi Monsefi, Rajiv Ramnath, Ser-Nam Lim
...
**Comment:** This paper proposes a new method for video generation that disentangles semantic and physical dynamics using contrastive learning, with a focus on improving physical plausibility in generative video models. It introduces a clever statistical trick for contrastive regularization. Closest to criterion 4 (vision foundation models and applications), and also relevant for generative modeling in multi-modal learning.
**Relevance:** 7
**Novelty:** 8

---

## 12. [ARTA: Adaptive Mixed-Resolution Token Allocation for Efficient Dense Feature Extraction](https://arxiv.org/abs/2603.26258) <a id="link12"></a>
**ArXiv ID:** 2603.26258
**Authors:** David Hagerman, Roman Naeem, Erik Brorsson, Fredrik Kahl, Lennart Svensson
...
**Comment:** ARTA introduces a mixed-resolution vision transformer for efficient dense feature extraction, with adaptive token allocation focusing on semantic boundaries. This is a methodological improvement in spatial understanding (criterion 1), especially relevant for spatial intelligence in vision models.
**Relevance:** 7
**Novelty:** 7

---

## 13. [Real-Time Branch-to-Tool Distance Estimation for Autonomous UAV Pruning: Benchmarking Five DEFOM-Stereo Variants from Simulation to Jetson Deployment](https://arxiv.org/abs/2603.26250) <a id="link13"></a>
**ArXiv ID:** 2603.26250
**Authors:** Yida Lin, Bing Xue, Mengjie Zhang, Sam Schofield, Richard Green
...
**Comment:** Matches criterion 3 (embodied AI, new benchmark/methods for spatial understanding in UAVs, sim-to-real transfer, and real-time deployment). The benchmarking of DEFOM-Stereo variants for UAV pruning is a practical contribution, with a focus on real-world deployment and sim-to-real transfer.
**Relevance:** 7
**Novelty:** 6

---

## 14. [JRM: Joint Reconstruction Model for Multiple Objects without Alignment](https://arxiv.org/abs/2603.25985) <a id="link14"></a>
**ArXiv ID:** 2603.25985
**Authors:** Qirui Wu, Yawar Siddiqui, Duncan Frost, Samir Aroudj, Armen Avetisyan, Richard Newcombe, Angel X. Chang, Jakob Engel, Henry Howard-Jenkins
...
**Comment:** Partially matches criterion 4: introduces a joint reconstruction model for multiple objects without alignment, using a generative model for 3D reconstruction. Relevant to vision foundation models and generative modeling in vision.
**Relevance:** 6
**Novelty:** 7

---

## 15. [SparseCam4D: Spatio-Temporally Consistent 4D Reconstruction from Sparse Cameras](https://arxiv.org/abs/2603.26481) <a id="link15"></a>
**ArXiv ID:** 2603.26481
**Authors:** Weihong Pan, Xiaoyu Zhang, Zhuang Zhang, Zhichao Ye, Nan Wang, Haomin Liu, Guofeng Zhang
...
**Comment:** Partially matches criterion 4: proposes a new method for 4D reconstruction from sparse cameras, leveraging generative observations and spatio-temporal consistency. Relevant to vision foundation models and their applications.
**Relevance:** 6
**Novelty:** 7

---

## 16. [Diffusion MRI Transformer with a Diffusion Space Rotary Positional Embedding (D-RoPE)](https://arxiv.org/abs/2603.25977) <a id="link16"></a>
**ArXiv ID:** 2603.25977
**Authors:** Gustavo Chau Loo Kung, Mohammad Abbasi, Camila Blank, Juze Zhang, Alan Q. Wang, Sophie Ostmeier, Akshay Chaudhari, Kilian Pohl, Ehsan Adeli
...
**Comment:** This paper introduces a new transformer architecture for diffusion MRI that jointly models spatial, diffusion-weighting, and directional dependencies, with a novel diffusion space rotary positional embedding. This is a methodological improvement in spatial understanding, but focused on medical imaging rather than embodied agents. Closest to criterion 1.
**Relevance:** 5
**Novelty:** 7

---

## 17. [GLASS: Geometry-aware Local Alignment and Structure Synchronization Network for 2D-3D Registration](https://arxiv.org/abs/2603.26262) <a id="link17"></a>
**ArXiv ID:** 2603.26262
**Authors:** Zhixin Cheng, Jiacheng Deng, Xinjun Li, Bohao Liao, Li Liu, Xiaotian Yin, Baoqun Yin, Tianzhu Zhang
...
**Comment:** Partially matches criterion 1: proposes new modules for geometry-aware local alignment and structure synchronization in 2D-3D registration, which is relevant to spatial understanding. However, not directly about embodied agents or multi-modal models.
**Relevance:** 5
**Novelty:** 6

---

## 18. [HAD: Heterogeneity-Aware Distillation for Lifelong Heterogeneous Learning](https://arxiv.org/abs/2603.26192) <a id="link18"></a>
**ArXiv ID:** 2603.26192
**Authors:** Xuerui Zhang, Xuehao Wang, Zhan Zhuang, Linglan Zhao, Ziyue Li, Xinmin Zhang, Zhihuan Song, Yu Zhang
...
**Comment:** This paper introduces a heterogeneity-aware distillation method for lifelong heterogeneous learning, focusing on dense prediction tasks. While it is a methodological advance in continual learning, it does not directly match the specific criteria.
**Relevance:** 4
**Novelty:** 6

---

## 19. [Pioneering Perceptual Video Fluency Assessment: A Novel Task with Benchmark Dataset and Baseline](https://arxiv.org/abs/2603.26055) <a id="link19"></a>
**ArXiv ID:** 2603.26055
**Authors:** Qizhi Xie, Kun Yuan, Yunpeng Qu, Ming Sun, Chao Zhou, Jihong Zhu
...
**Comment:** Does not directly match any specific criterion. Focuses on perceptual video fluency assessment and introduces a new dataset and baseline, but not directly about spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 20. [MuDD: A Multimodal Deception Detection Dataset and GSR-Guided Progressive Distillation for Non-Contact Deception Detection](https://arxiv.org/abs/2603.26064) <a id="link20"></a>
**ArXiv ID:** 2603.26064
**Authors:** Peiyuan Jiang, Yao Liu, Yanglei Gan, Jiaye Yang, Lu Liu, Daibing Yao, Qiao Liu
...
**Comment:** MuDD introduces a new multimodal deception detection dataset and a GSR-guided progressive distillation method for non-contact deception detection. While it is a multi-modal learning paper, it does not match the specific criteria.
**Relevance:** 3
**Novelty:** 6

---

## 21. [Face2Parts: Exploring Coarse-to-Fine Inter-Regional Facial Dependencies for Generalized Deepfake Detection](https://arxiv.org/abs/2603.26036) <a id="link21"></a>
**ArXiv ID:** 2603.26036
**Authors:** Kutub Uddin, Nusrat Tasnim, Byung Tae Oh
...
**Comment:** This paper presents a new method for deepfake detection using hierarchical feature representation and inter-regional dependencies. While it is a vision paper, it does not match any of the specific criteria.
**Relevance:** 3
**Novelty:** 5

---

## 22. [Only Whats Necessary: Pareto Optimal Data Minimization for Privacy Preserving Video Anomaly Detection](https://arxiv.org/abs/2603.26354) <a id="link22"></a>
**ArXiv ID:** 2603.26354
**Authors:** Nazia Aslam, Abhisek Ray, Thomas B. Moeslund, Kamal Nasrollahi
...
**Comment:** This paper is about privacy-preserving video anomaly detection, focusing on data minimization and privacy-utility tradeoffs. While it uses computer vision, it does not match any of the specific criteria.
**Relevance:** 3
**Novelty:** 5
