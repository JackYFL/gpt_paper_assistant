...
0. [Point Cloud as a Foreign Language for Multi-modal Large Language Model](#link0)
**Authors:** Sneha Paul, Zachary Patterson, Nizar Bouguila

1. [InternVL-U: Democratizing Unified Multimodal Models for Understanding, Reasoning, Generation and Editing](#link1)
...
2. [MM-Zero: Self-Evolving Multi-Model Vision Language Models From Zero Data](#link2)
...
3. [Open-World Motion Forecasting](#link3)
**Authors:** Nicolas Schischka, Nikhil Gosala, B Ravi Kiran, Senthil Yogamani, Abhinav Valada

4. [Beyond Scaling: Assessing Strategic Reasoning and Rapid Decision-Making Capability of LLMs in Zero-sum Environments](#link4)
**Authors:** Yang Li, Xing Chen, Yutao Liu, Gege Qi, Yanxian BI, Zizhe Wang, Yunjian Zhang, Yao Zhu

5. [Probing the Reliability of Driving VLMs: From Inconsistent Responses to Grounded Temporal Reasoning](#link5)
**Authors:** Chun-Peng Chang, Chen-Yu Wang, Holger Caesar, Alain Pagani

6. [VisionCreator-R1: A Reflection-Enhanced Native Visual-Generation Agentic Model](#link6)
**Authors:** Jinxiang Lai, Wenzhe Zhao, Zexin Lu, Hualei Zhang, Qinyu Yang, Rongwei Quan, Zhimin Li, Shuai Shao, Song Guo, Qinglin Lu

7. [Towards Visual Query Segmentation in the Wild](#link7)
**Authors:** Bing Fan, Minghao Li, Hanzhi Zhang, Shaohua Dong, Naga Prudhvi Mareedu, Weishi Shi, Yunhe Feng, Yan Huang, Heng Fan

8. [DiffWind: Physics-Informed Differentiable Modeling of Wind-Driven Object Dynamics](#link8)
...
9. [EventVGGT: Exploring Cross-Modal Distillation for Consistent Event-based Depth Estimation](#link9)
...
10. [AutoAgent: Evolving Cognition and Elastic Memory Orchestration for Adaptive Agents](#link10)
**Authors:** Xiaoxing Wang, Ning Liao, Shikun Wei, Chen Tang, Feiyu Xiong

11. [SVG-EAR: Parameter-Free Linear Compensation for Sparse Video Generation via Error-aware Routing](#link11)
...
12. [CogBlender: Towards Continuous Cognitive Intervention in Text-to-Image Generation](#link12)
**Authors:** Shengqi Dang, Jiaying Lei, Yi He, Ziqing Qian, Nan Cao

13. [AgentOS: From Application Silos to a Natural Language-Driven Data Ecosystem](#link13)
**Authors:** Rui Liu, Tao Zhe, Dongjie Wang, Zijun Yao, Kunpeng Liu, Yanjie Fu, Huan Liu, Jian Pei

14. [Think Before You Lie: How Reasoning Improves Honesty](#link14)
...
15. [Social-R1: Towards Human-like Social Reasoning in LLMs](#link15)
**Authors:** Jincenzi Wu, Yuxuan Lei, Jianxun Lian, Yitian Huang, Lexin Zhou, Haotian Li, Xing Xie, Helen Meng

16. [TriFusion-SR: Joint Tri-Modal Medical Image Fusion and SR](#link16)
**Authors:** Fayaz Ali Dharejo, Sharif S. M. A., Aiman Khalil, Nachiket Chaudhary, Rizwan Ali Naqvi, Radu Timofte

17. [Improving 3D Foot Motion Reconstruction in Markerless Monocular Human Motion Capture](#link17)
**Authors:** Tom Wehrbein, Bodo Rosenhahn

18. [Adaptive Clinical-Aware Latent Diffusion for Multimodal Brain Image Generation and Missing Modality Imputation](#link18)
**Authors:** Rong Zhou, Houliang Zhou, Yao Su, Brian Y. Chen, Yu Zhang, Lifang He, Alzheimer's Disease Neuroimaging Initiative

19. [Progressive Representation Learning for Multimodal Sentiment Analysis with Incomplete Modalities](#link19)
**Authors:** Jindi Bao, Jianjun Qian, Mengkai Yan, Jian Yang

20. [CIGPose: Causal Intervention Graph Neural Network for Whole-Body Pose Estimation](#link20)
**Authors:** Bohao Li, Zhicheng Cao, Huixian Li, Yangming Guo

21. [ConfCtrl: Enabling Precise Camera Control in Video Diffusion via Confidence-Aware Interpolation](#link21)
**Authors:** Liudi Yang, George Eskandar, Fengyi Shen, Mohammad Altillawi, Yang Bai, Chi Zhang, Ziyuan Liu, Abhinav Valada

22. [BrainSTR: Spatio-Temporal Contrastive Learning for Interpretable Dynamic Brain Network Modeling](#link22)
**Authors:** Guiliang Guo, Guangqi Wen, Lingwen Liu, Ruoxian Song, Peng Cao, Jinzhu Yang, Fei Wang, Xiaoli Liu, Osmar R. Zaiane

23. [ProGS: Towards Progressive Coding for 3D Gaussian Splatting](#link23)
**Authors:** Zhiye Tang, Lingzhuo Liu, Shengjie Jiao, Qiudan Zhang, Junhui Hou, You Yang, Xu Wang

24. [GSStream: 3D Gaussian Splatting based Volumetric Scene Streaming System](#link24)
**Authors:** Zhiye Tang, Qiudan Zhang, Lei Zhang, Junhui Hou, You Yang, Xu Wang

25. [RiO-DETR: DETR for Real-time Oriented Object Detection](#link25)
...
26. [A comprehensive study of time-of-flight non-line-of-sight imaging](#link26)
**Authors:** Julio Marco, Adrian Jarabo, Ji Hyun Nam, Alberto Tosi, Diego Gutierrez, Andreas Velten

27. [From Days to Minutes: An Autonomous AI Agent Achieves Reliable Clinical Triage in Remote Patient Monitoring](#link27)
...
---
## 0. [Point Cloud as a Foreign Language for Multi-modal Large Language Model](https://arxiv.org/abs/2603.09173) <a id="link0"></a>
**ArXiv ID:** 2603.09173
**Authors:** Sneha Paul, Zachary Patterson, Nizar Bouguila
...
**Comment:** Matches criterion 2 (MLLMs): Proposes SAGE, an end-to-end multi-modal large language model that directly processes raw point clouds as a 'foreign language', introducing a new 3D tokenizer and preference optimization for 3D question answering. This is a novel MLLM for 3D data, directly relevant to multi-modal LLMs and spatial understanding.
**Relevance:** 10
**Novelty:** 8

---

## 1. [InternVL-U: Democratizing Unified Multimodal Models for Understanding, Reasoning, Generation and Editing](https://arxiv.org/abs/2603.09877) <a id="link1"></a>
**ArXiv ID:** 2603.09877
**Authors:** Changyao Tian, Danni Yang, Guanzhou Chen, Erfei Cui, Zhaokai Wang, Yuchen Duan, Penghao Yin, Sitao Chen, Ganlin Yang, Mingxin Liu, Zirun Zhu, Ziqian Fan, Leyao Gu, Haomin Wang, Qi Wei, Jinhui Yin, Xue Yang, Zhihang Zhong, Qi Qin, Yi Xin, Bin Fu, Yihao Liu, Jiaye Ge, Qipeng Guo, Gen Luo, Hongsheng Li, Yu Qiao, Kai Chen, Hongjie Zhang
...
**Comment:** Matches criterion 2 (Shows new VLLMs or MLLMs) and criterion 4 (vision foundation models and applications): Introduces InternVL-U, a unified multimodal model (UMM) for understanding, reasoning, generation, and editing, with a novel architecture and data synthesis pipeline. Strong focus on vision-language modeling and generative capabilities.
**Relevance:** 10
**Novelty:** 8

---

## 2. [MM-Zero: Self-Evolving Multi-Model Vision Language Models From Zero Data](https://arxiv.org/abs/2603.09206) <a id="link2"></a>
**ArXiv ID:** 2603.09206
**Authors:** Zongxia Li, Hongyang Du, Chengsong Huang, Xiyang Wu, Lantao Yu, Yicheng He, Jing Xie, Xiaomin Wu, Zhichao Liu, Jiarui Zhang, Fuxiao Liu
...
**Comment:** Matches criterion 2 (Shows new VLLMs or MLLMs): Introduces MM-Zero, a new RL-based framework for zero-data self-evolution in vision-language models (VLMs), with a multi-role agentic setup and novel training mechanisms. Also relevant to criterion 4 (vision foundation models and applications).
**Relevance:** 10
**Novelty:** 8

---

## 3. [Open-World Motion Forecasting](https://arxiv.org/abs/2603.09420) <a id="link3"></a>
**ArXiv ID:** 2603.09420
**Authors:** Nicolas Schischka, Nikhil Gosala, B Ravi Kiran, Senthil Yogamani, Abhinav Valada
...
**Comment:** Matches criterion 3 (embodied AI benchmarks/methods): Introduces open-world motion forecasting, a new setting for motion forecasting in autonomous driving where object classes are incrementally introduced. Proposes a class-incremental motion forecasting framework with pseudo-labeling and vision-language model filtering. Strong match for embodied AI with a novel benchmark and method.
**Relevance:** 9
**Novelty:** 8

---

## 4. [Beyond Scaling: Assessing Strategic Reasoning and Rapid Decision-Making Capability of LLMs in Zero-sum Environments](https://arxiv.org/abs/2603.09337) <a id="link4"></a>
**ArXiv ID:** 2603.09337
**Authors:** Yang Li, Xing Chen, Yutao Liu, Gege Qi, Yanxian BI, Zizhe Wang, Yunjian Zhang, Yao Zhu
...
**Comment:** Matches criterion 3 (embodied AI benchmarks/methods): Introduces the STAR benchmark for evaluating LLMs in zero-sum, interactive, adversarial environments, focusing on strategic reasoning and rapid decision-making. The benchmark is modular and supports both turn-based and real-time settings, providing new insights into reasoning vs. execution trade-offs. Strong match for embodied AI benchmarking with a novel angle.
**Relevance:** 9
**Novelty:** 8

---

## 5. [Probing the Reliability of Driving VLMs: From Inconsistent Responses to Grounded Temporal Reasoning](https://arxiv.org/abs/2603.09512) <a id="link5"></a>
**ArXiv ID:** 2603.09512
**Authors:** Chun-Peng Chang, Chen-Yu Wang, Holger Caesar, Alain Pagani
...
**Comment:** Matches criterion 2 (VLLMs) and criterion 3 (embodied AI benchmarks/methods): This paper probes the reliability of Vision-Language Models (VLMs) in driving assistant scenarios, focusing on temporal reasoning and consistency, and introduces a new benchmark (FutureVQA) for future scene reasoning. It also proposes a self-supervised tuning method for temporal reasoning. Strong match for VLLM evaluation and embodied AI benchmarking.
**Relevance:** 10
**Novelty:** 7

---

## 6. [VisionCreator-R1: A Reflection-Enhanced Native Visual-Generation Agentic Model](https://arxiv.org/abs/2603.08812) <a id="link6"></a>
**ArXiv ID:** 2603.08812
**Authors:** Jinxiang Lai, Wenzhe Zhao, Zexin Lu, Hualei Zhang, Qinyu Yang, Rongwei Quan, Zhimin Li, Shuai Shao, Song Guo, Qinglin Lu
...
**Comment:** Matches criterion 2 (Shows new VLLMs or MLLMs) and criterion 4 (vision foundation models and applications): Proposes VisionCreator-R1, a native visual generation agent with explicit reflection and a novel training methodology, outperforming Gemini2.5Pro on visual generation tasks. Focuses on agentic visual generation and reflection mechanisms.
**Relevance:** 9
**Novelty:** 8

---

## 7. [Towards Visual Query Segmentation in the Wild](https://arxiv.org/abs/2603.08898) <a id="link7"></a>
**ArXiv ID:** 2603.08898
**Authors:** Bing Fan, Minghao Li, Hanzhi Zhang, Shaohua Dong, Naga Prudhvi Mareedu, Weishi Shi, Yunhe Feng, Yan Huang, Heng Fan
...
**Comment:** This paper introduces visual query segmentation (VQS), a new paradigm for visual query localization, and presents VQS-4K, a large-scale benchmark for this task. It also proposes VQ-SAM, a method extending SAM for VQS. This matches criterion 3 (new benchmark for vision task, novel angle: pixel-level segmentation for all object occurrences in video) and criterion 4 (application of vision foundation models, i.e., SAM).
**Relevance:** 9
**Novelty:** 8

---

## 8. [DiffWind: Physics-Informed Differentiable Modeling of Wind-Driven Object Dynamics](https://arxiv.org/abs/2603.09668) <a id="link8"></a>
**ArXiv ID:** 2603.09668
**Authors:** Yuanhang Lei, Boming Zhao, Zesong Yang, Xingxuan Li, Tao Cheng, Haocheng Peng, Ru Zhang, Yang Yang, Siyuan Huang, Yujun Shen, Ruizhen Hu, Hujun Bao, Zhaopeng Cui
...
**Comment:** DiffWind presents a physics-informed differentiable framework for modeling wind-driven object dynamics from video, unifying wind-object interaction modeling, video-based reconstruction, and forward simulation. It introduces a new dataset and supports forward simulation under novel wind conditions. This is a strong match for criterion 1 (spatial understanding and intelligence in embodied agents) and criterion 3 (new benchmark and method for dynamic scene modeling).
**Relevance:** 9
**Novelty:** 8

---

## 9. [EventVGGT: Exploring Cross-Modal Distillation for Consistent Event-based Depth Estimation](https://arxiv.org/abs/2603.09385) <a id="link9"></a>
**ArXiv ID:** 2603.09385
**Authors:** Yinrui Ren, Jinjing Zhu, Kanghao Chen, Zhuoxiao Li, Jing Ou, Zidong Cao, Tongyan Hua, Peilun Shi, Yingchun Fu, Wufan Zhao, Hui Xiong
...
**Comment:** Matches criterion 4 (vision foundation models and applications): Proposes EventVGGT, which distills spatio-temporal and geometric priors from a Visual Geometry Grounded Transformer (a vision foundation model) into event-based depth estimation, with a novel tri-level distillation strategy. Strong application of vision foundation models to a new modality (event cameras).
**Relevance:** 9
**Novelty:** 7

---

## 10. [AutoAgent: Evolving Cognition and Elastic Memory Orchestration for Adaptive Agents](https://arxiv.org/abs/2603.09716) <a id="link10"></a>
**ArXiv ID:** 2603.09716
**Authors:** Xiaoxing Wang, Ning Liao, Shikun Wei, Chen Tang, Feiyu Xiong
...
**Comment:** AutoAgent introduces a self-evolving multi-agent framework with evolving cognition and elastic memory orchestration for adaptive agents. It is evaluated on embodied task environments and proposes new methods for agent cognition and memory. This matches criterion 3 (embodied AI, new methods for adaptive agents, novel angle: elastic memory orchestration and evolving cognition).
**Relevance:** 8
**Novelty:** 7

---

## 11. [SVG-EAR: Parameter-Free Linear Compensation for Sparse Video Generation via Error-aware Routing](https://arxiv.org/abs/2603.08982) <a id="link11"></a>
**ArXiv ID:** 2603.08982
**Authors:** Xuanyi Zhou, Qiuyang Mang, Shuo Yang, Haocheng Xi, Jintao Zhang, Huanzhi Mao, Joseph E. Gonzalez, Kurt Keutzer, Ion Stoica, Alvin Cheung
...
**Comment:** This paper introduces SVG-EAR, a parameter-free linear compensation method for sparse video generation using diffusion transformers. It proposes a clever statistical trick (error-aware routing and centroid compensation) for efficient video generation. This is relevant to generative modeling in vision (criterion 4), and the method is novel in its approach to sparsification and compensation.
**Relevance:** 7
**Novelty:** 8

---

## 12. [CogBlender: Towards Continuous Cognitive Intervention in Text-to-Image Generation](https://arxiv.org/abs/2603.09286) <a id="link12"></a>
**ArXiv ID:** 2603.09286
**Authors:** Shengqi Dang, Jiaying Lei, Yi He, Ziqing Qian, Nan Cao
...
**Comment:** CogBlender enables continuous and multi-dimensional intervention of cognitive properties in text-to-image generation, introducing a new paradigm for cognition-driven creative design. While it is a novel generative modeling approach, it does not directly address spatial intelligence, embodied agents, or VLLMs/MLLMs. Closest to criterion 4 (vision foundation models and applications), but not a direct match.
**Relevance:** 5
**Novelty:** 7

---

## 13. [AgentOS: From Application Silos to a Natural Language-Driven Data Ecosystem](https://arxiv.org/abs/2603.08938) <a id="link13"></a>
**ArXiv ID:** 2603.08938
**Authors:** Rui Liu, Tao Zhe, Dongjie Wang, Zijun Yao, Kunpeng Liu, Yanjie Fu, Huan Liu, Jian Pei
...
**Comment:** This paper proposes AgentOS, a new paradigm for agent-based operating systems with natural language interfaces. While it discusses agentic systems and intent mining, it does not focus on spatial intelligence, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models.
**Relevance:** 3
**Novelty:** 7

---

## 14. [Think Before You Lie: How Reasoning Improves Honesty](https://arxiv.org/abs/2603.09957) <a id="link14"></a>
**ArXiv ID:** 2603.09957
**Authors:** Ann Yuan, Asma Ghandeharioun, Carter Blum, Alicia Machado, Jessica Hoffmann, Daphne Ippolito, Martin Wattenberg, Lucas Dixon, Katja Filippova
...
**Comment:** This paper investigates honesty and reasoning in LLMs, with interesting empirical findings about representational geometry and moral reasoning. However, it does not address spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 7

---

## 15. [Social-R1: Towards Human-like Social Reasoning in LLMs](https://arxiv.org/abs/2603.09249) <a id="link15"></a>
**ArXiv ID:** 2603.09249
**Authors:** Jincenzi Wu, Yuxuan Lei, Jianxun Lian, Yitian Huang, Lexin Zhou, Haotian Li, Xing Xie, Helen Meng
...
**Comment:** This paper introduces Social-R1, a reinforcement learning framework for social reasoning in LLMs, with a new adversarial benchmark. While it is a novel approach to social intelligence in LLMs, it does not focus on spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 7

---

## 16. [TriFusion-SR: Joint Tri-Modal Medical Image Fusion and SR](https://arxiv.org/abs/2603.09702) <a id="link16"></a>
**ArXiv ID:** 2603.09702
**Authors:** Fayaz Ali Dharejo, Sharif S. M. A., Aiman Khalil, Nachiket Chaudhary, Rizwan Ali Naqvi, Radu Timofte
...
**Comment:** TriFusion-SR proposes a wavelet-guided conditional diffusion framework for joint tri-modal medical image fusion and super-resolution. It introduces frequency-aware crossmodal interaction and adaptive spatial-frequency fusion. While it is a multi-modal generative model, it is not a VLLM/MLLM or vision foundation model, nor does it focus on spatial intelligence or embodied agents. Closest to criterion 2, but not a direct match.
**Relevance:** 4
**Novelty:** 6

---

## 17. [Improving 3D Foot Motion Reconstruction in Markerless Monocular Human Motion Capture](https://arxiv.org/abs/2603.09681) <a id="link17"></a>
**ArXiv ID:** 2603.09681
**Authors:** Tom Wehrbein, Bodo Rosenhahn
...
**Comment:** This paper proposes FootMR, a method for refining 3D foot motion in markerless monocular human motion capture, introducing a new dataset and improving fine-grained motion estimation. While it is relevant to computer vision and motion capture, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, or vision foundation models. Closest to criterion 1, but not a direct match.
**Relevance:** 4
**Novelty:** 6

---

## 18. [Adaptive Clinical-Aware Latent Diffusion for Multimodal Brain Image Generation and Missing Modality Imputation](https://arxiv.org/abs/2603.09931) <a id="link18"></a>
**ArXiv ID:** 2603.09931
**Authors:** Rong Zhou, Houliang Zhou, Yao Su, Brian Y. Chen, Yu Zhang, Lifang He, Alzheimer's Disease Neuroimaging Initiative
...
**Comment:** This paper presents ACADiff, a framework for multimodal brain image generation and missing modality imputation using adaptive clinical-aware latent diffusion. It leverages GPT-4o-encoded prompts for semantic clinical guidance. While it is a multi-modal generative model, it is not a VLLM/MLLM or vision foundation model, nor does it focus on spatial intelligence or embodied agents. Closest to criterion 2, but not a direct match.
**Relevance:** 4
**Novelty:** 6

---

## 19. [Progressive Representation Learning for Multimodal Sentiment Analysis with Incomplete Modalities](https://arxiv.org/abs/2603.09111) <a id="link19"></a>
**ArXiv ID:** 2603.09111
**Authors:** Jindi Bao, Jianjun Qian, Mengkai Yan, Jian Yang
...
**Comment:** This paper proposes a new framework for multimodal sentiment analysis with incomplete modalities, introducing an adaptive modality reliability estimator and progressive interaction module. It is relevant to multi-modal learning but does not focus on spatial intelligence, embodied agents, VLLMs/MLLMs, or vision foundation models. Closest to criterion 2, but not a direct match.
**Relevance:** 4
**Novelty:** 6

---

## 20. [CIGPose: Causal Intervention Graph Neural Network for Whole-Body Pose Estimation](https://arxiv.org/abs/2603.09418) <a id="link20"></a>
**ArXiv ID:** 2603.09418
**Authors:** Bohao Li, Zhicheng Cao, Huixian Li, Yangming Guo
...
**Comment:** This paper introduces CIGPose, a causal intervention graph neural network for whole-body pose estimation, using causal reasoning to improve anatomical plausibility. While it is a strong vision/statistics paper, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models. It is most relevant to pose estimation and causal modeling.
**Relevance:** 3
**Novelty:** 6

---

## 21. [ConfCtrl: Enabling Precise Camera Control in Video Diffusion via Confidence-Aware Interpolation](https://arxiv.org/abs/2603.09819) <a id="link21"></a>
**ArXiv ID:** 2603.09819
**Authors:** Liudi Yang, George Eskandar, Fengyi Shen, Mohammad Altillawi, Yang Bai, Chi Zhang, Ziyuan Liu, Abhinav Valada
...
**Comment:** This paper proposes a confidence-aware video interpolation framework (ConfCtrl) for novel view synthesis using diffusion models. While it is a strong vision and generative modeling paper, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models. It is most relevant to generative modeling and 3D vision.
**Relevance:** 3
**Novelty:** 6

---

## 22. [BrainSTR: Spatio-Temporal Contrastive Learning for Interpretable Dynamic Brain Network Modeling](https://arxiv.org/abs/2603.09825) <a id="link22"></a>
**ArXiv ID:** 2603.09825
**Authors:** Guiliang Guo, Guangqi Wen, Lingwen Liu, Ruoxian Song, Peng Cao, Jinzhu Yang, Fei Wang, Xiaoli Liu, Osmar R. Zaiane
...
**Comment:** This paper proposes BrainSTR, a spatio-temporal contrastive learning framework for dynamic brain network modeling. While it involves spatio-temporal modeling and interpretability, it is focused on neuroimaging and not on spatial intelligence for embodied agents, VLLMs/MLLMs, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 23. [ProGS: Towards Progressive Coding for 3D Gaussian Splatting](https://arxiv.org/abs/2603.09703) <a id="link23"></a>
**ArXiv ID:** 2603.09703
**Authors:** Zhiye Tang, Lingzhuo Liu, Shengjie Jiao, Qiudan Zhang, Junhui Hou, You Yang, Xu Wang
...
**Comment:** This paper proposes a new method for progressive coding of 3D Gaussian Splatting data, which is relevant to 3D scene representation and streaming. While it involves spatial data, it does not focus on spatial intelligence for embodied agents, VLLMs/MLLMs, or vision foundation models. It is more about compression and streaming.
**Relevance:** 3
**Novelty:** 6

---

## 24. [GSStream: 3D Gaussian Splatting based Volumetric Scene Streaming System](https://arxiv.org/abs/2603.09718) <a id="link24"></a>
**ArXiv ID:** 2603.09718
**Authors:** Zhiye Tang, Qiudan Zhang, Lei Zhang, Junhui Hou, You Yang, Xu Wang
...
**Comment:** This paper presents GSStream, a streaming system for 3D Gaussian Splatting data, with collaborative viewport prediction and DRL-based bitrate adaptation. While it is relevant to 3D scene representation and streaming, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models. It is more about systems and compression.
**Relevance:** 3
**Novelty:** 5

---

## 25. [RiO-DETR: DETR for Real-time Oriented Object Detection](https://arxiv.org/abs/2603.09411) <a id="link25"></a>
**ArXiv ID:** 2603.09411
**Authors:** Zhangchi Hu, Yifan Zhao, Yansong Peng, Wenzhang Sun, Xiangchen Yin, Jie Chen, Peixi Wu, Hebei Li, Xinghao Wang, Dongsheng Jiang, Xiaoyan Sun
...
**Comment:** This paper proposes a new real-time oriented object detection transformer (DETR variant) with several novel architectural improvements for oriented bounding box detection. While it is a strong computer vision paper, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models. It is most relevant to general object detection.
**Relevance:** 3
**Novelty:** 5

---

## 26. [A comprehensive study of time-of-flight non-line-of-sight imaging](https://arxiv.org/abs/2603.09548) <a id="link26"></a>
**ArXiv ID:** 2603.09548
**Authors:** Julio Marco, Adrian Jarabo, Ji Hyun Nam, Alberto Tosi, Diego Gutierrez, Andreas Velten
...
**Comment:** This is a comprehensive study of time-of-flight non-line-of-sight imaging methods. While it is relevant to computer vision and spatial understanding, it does not introduce new methods for spatial intelligence in embodied agents, VLLMs/MLLMs, or vision foundation models. It is a survey/comparison paper.
**Relevance:** 3
**Novelty:** 4

---

## 27. [From Days to Minutes: An Autonomous AI Agent Achieves Reliable Clinical Triage in Remote Patient Monitoring](https://arxiv.org/abs/2603.09052) <a id="link27"></a>
**ArXiv ID:** 2603.09052
**Authors:** Seunghwan Kim (AnsibleHealth Inc., San Francisco, USA), Tiffany H. Kung (AnsibleHealth Inc., San Francisco, USA, Stanford School of Medicine, Stanford, USA), Heena Verma (AnsibleHealth Inc., San Francisco, USA), Dilan Edirisinghe (AnsibleHealth Inc., San Francisco, USA), Kaveh Sedehi (AnsibleHealth Inc., San Francisco, USA), Johanna Alvarez (AnsibleHealth Inc., San Francisco, USA), Diane Shilling (AnsibleHealth Inc., San Francisco, USA), Audra Lisa Doyle (AnsibleHealth Inc., San Francisco, USA), Ajit Chary (AnsibleHealth Inc., San Francisco, USA), William Borden (AnsibleHealth Inc., San Francisco, USA, George Washington University, Washington, D.C., USA), Ming Jack Po (AnsibleHealth Inc., San Francisco, USA)
...
**Comment:** This paper is about an autonomous AI agent for clinical triage in remote patient monitoring. While it involves multi-step reasoning and agentic behavior, it does not focus on spatial intelligence, embodied agents, VLLMs/MLLMs, new benchmarks for embodied AI, or vision foundation models. It is more of an application in healthcare AI.
**Relevance:** 3
**Novelty:** 4
