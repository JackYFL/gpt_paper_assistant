# Personalized Daily ArXiv Papers 04/13/2026
...
0. [HiL-Bench (Human-in-Loop Benchmark): Do Agents Know When to Ask for Help?](#link0)
...
1. [Mind the Gap Between Spatial Reasoning and Acting! Step-by-Step Evaluation of Agents With Spatial-Gym](#link1)
**Authors:** Lars Benedikt Kaesberg, Tianyu Yang, Niklas Bauer, Terry Ruas, Jan Philip Wahle, Bela Gipp

2. [Learning Vision-Language-Action World Models for Autonomous Driving](#link2)
**Authors:** Guoqing Wang, Pin Tang, Xiangxuan Ren, Guodongfang Zhao, Bailan Feng, Chao Ma

3. [VisionFoundry: Teaching VLMs Visual Perception with Synthetic Images](#link3)
**Authors:** Guanyu Zhou, Yida Yin, Wenhao Chai, Shengbang Tong, Xingyu Fu, Zhuang Liu

4. [RIRF: Reasoning Image Restoration Framework](#link4)
**Authors:** Wending Yan, Rongkai Zhang, Kaihua Tang, Yu Cheng, Qiankun Liu

5. [VL-Calibration: Decoupled Confidence Calibration for Large Vision-Language Models Reasoning](#link5)
**Authors:** Wenyi Xiao, Xinchi Xu, Leilei Gan

6. [ActFER: Agentic Facial Expression Recognition via Active Tool-Augmented Visual Reasoning](#link6)
...
7. [Arbitration Failure, Not Perceptual Blindness: How Vision-Language Models Resolve Visual-Linguistic Conflicts](#link7)
**Authors:** Farhad Nooralahzadeh, Omid Rohanian, Yi Zhang, Jonathan F\"urst, Kurt Stockinger

8. [Matrix-Game 3.0: Real-Time and Streaming Interactive World Model with Long-Horizon Memory](#link8)
...
9. [ELT: Elastic Looped Transformers for Visual Generation](#link9)
**Authors:** Sahil Goyal, Swayam Agrawal, Gautham Govind Anil, Prateek Jain, Sujoy Paul, Aditya Kusupati

10. [SEA-Eval: A Benchmark for Evaluating Self-Evolving Agents Beyond Episodic Assessment](#link10)
...
11. [MV3DIS: Multi-View Mask Matching via 3D Guides for Zero-Shot 3D Instance Segmentation](#link11)
**Authors:** Yibo Zhao, Yigong Zhang, Jin Xie

12. [Realizing Immersive Volumetric Video: A Multimodal Framework for 6-DoF VR Engagement](#link12)
...
13. [Robust 4D Visual Geometry Transformer with Uncertainty-Aware Priors](#link13)
**Authors:** Ying Zang, Yidong Han, Chaotao Ding, Yuanqi Hu, Deyi Ji, Qi Zhu, Xuanfu Li, Jin Ma, Lingyun Sun, Tianrun Chen, Lanyun Zhu

14. [DRBENCHER: Can Your Agent Identify the Entity, Retrieve Its Properties and Do the Math?](#link14)
**Authors:** Young-Suk Lee, Ramon Fernandez Astudillo, Radu Florian

15. [SenBen: Sensitive Scene Graphs for Explainable Content Moderation](#link15)
**Authors:** Fatih Cagatay Akyon, Alptekin Temizel

16. [StreamMeCo: Long-Term Agent Memory Compression for Efficient Streaming Video Understanding](#link16)
**Authors:** Junxi Wang, Te Sun, Jiayi Zhu, Junxian Li, Haowen Xu, Zichen Wen, Xuming Hu, Zhiyu Li, Linfeng Zhang

17. [Long-SCOPE: Fully Sparse Long-Range Cooperative 3D Perception](#link17)
...
18. [Seeing is Believing: Robust Vision-Guided Cross-Modal Prompt Learning under Label Noise](#link18)
**Authors:** Zibin Geng, Xuefeng Jiang, Jia Li, Zheng Li, Tian Wen, Lvhua Wu, Sheng Sun, Yuwei Wang, Min Liu

19. [Visually-Guided Policy Optimization for Multimodal Reasoning](#link19)
**Authors:** Zengbin Wang, Feng Xiong, Liang Lin, Xuecai Hu, Yong Wang, Yanlin Wang, Man Zhang, Xiangxiang Chu

20. [Overhang Tower: Resource-Rational Adaptation in Sequential Physical Planning](#link20)
**Authors:** Ruihong Shen, Shiqian Li, Yixin Zhu

21. [SAGE: A Service Agent Graph-guided Evaluation Benchmark](#link21)
**Authors:** Ling Shi, Yuqin Dai, Ziyin Wang, Ning Gao, Wei Zhang, Chaozheng Wang, Yujie Wang, Wei He, Jinpeng Wang, Deiyi Xiong

22. [FIRE-CIR: Fine-grained Reasoning for Composed Fashion Image Retrieval](#link22)
**Authors:** Fran\c{c}ois Gard\`eres, Camille-Sovanneary Gauthier, Jean Ponce, Shizhe Chen

23. [MASS: Mesh-inellipse Aligned Deformable Surfel Splatting for Hand Reconstruction and Rendering from Egocentric Monocular Video](#link23)
**Authors:** Haoyu Zhu, Yi Zhang, Lei Yao, Lap-pui Chau, Yi Wang

24. [NTIRE 2026 The 3rd Restore Any Image Model (RAIM) Challenge: Multi-Exposure Image Fusion in Dynamic Scenes (Track 2)](#link24)
...
25. [OpenKedge: Governing Agentic Mutation with Execution-Bound Safety and Evidence Chains](#link25)
**Authors:** Jun He, Deying Yu

26. [InsEdit: Towards Instruction-based Visual Editing via Data-Efficient Video Diffusion Models Adaptation](#link26)
**Authors:** Zhefan Rao, Bin Zou, Haoxuan Che, Xuanhua He, Chong Hou Choi, Yanheng Li, Rui Liu, Qifeng Chen

27. [Process Reward Agents for Steering Knowledge-Intensive Reasoning](#link27)
**Authors:** Jiwoong Sohn, Tomasz Sternal, Kenneth Styppa, Torsten Hoefler, Michael Moor

28. [Neural Distribution Prior for LiDAR Out-of-Distribution Detection](#link28)
**Authors:** Zizhao Li, Zhengkang Xiang, Jiayang Ao, Feng Liu, Joseph West, Kourosh Khoshelham

29. [What Matters in Virtual Try-Off? Dual-UNet Diffusion Model For Garment Reconstruction](#link29)
**Authors:** Loc-Phat Truong, Meysam Madadi, Sergio Escalera

30. [EpiAgent: An Agent-Centric System for Ancient Inscription Restoration](#link30)
**Authors:** Shipeng Zhu, Ang Chen, Na Nie, Pengfei Fang, Min-Ling Zhang, Hui Xue

31. [Beyond Segmentation: Structurally Informed Facade Parsing from Imperfect Images](#link31)
**Authors:** Maciej Janicki, Aleksander Plocharski, Przemyslaw Musialski

32. [Domain-generalizable Face Anti-Spoofing with Patch-based Multi-tasking and Artifact Pattern Conversion](#link32)
**Authors:** Seungjin Jung, Yonghyun Jeong, Minha Kim, Jimin Min, Youngjoon Yoo, Jongwon Choi

33. [E3-TIR: Enhanced Experience Exploitation for Tool-Integrated Reasoning](#link33)
**Authors:** Weiyang Guo, Zesheng Shi, Liye Zhao, Jiayuan Ma, Zeen Zhu, Junxian He, Min Zhang, Jing Li

34. [CAD 100K: A Comprehensive Multi-Task Dataset for Car Related Visual Anomaly Detection](#link34)
...
35. [BIAS: A Biologically Inspired Algorithm for Video Saliency Detection](#link35)
**Authors:** Zhao-ji Zhang, Ya-tang Li

---
## 0. [HiL-Bench (Human-in-Loop Benchmark): Do Agents Know When to Ask for Help?](https://arxiv.org/abs/2604.09408) <a id="link0"></a>
**ArXiv ID:** 2604.09408
**Authors:** Mohamed Elfeki, Tu Trinh, Kelvin Luu, Guangze Luo, Nathan Hunt, Ernesto Montoya, Nandan Marwaha, Yannis He, Charles Wang, Fernando Crabedo, Alessa Castilo, Bing Liu
...
**Comment:** This paper introduces HiL-Bench, a new human-in-the-loop benchmark for evaluating agents' ability to know when to ask for help. It directly matches criterion 3 (embodied AI benchmarks with a novel angle: selective escalation/judgment), and introduces a new metric (Ask-F1) and analysis of help-seeking behavior.
**Relevance:** 10
**Novelty:** 9

---

## 1. [Mind the Gap Between Spatial Reasoning and Acting! Step-by-Step Evaluation of Agents With Spatial-Gym](https://arxiv.org/abs/2604.09338) <a id="link1"></a>
**ArXiv ID:** 2604.09338
**Authors:** Lars Benedikt Kaesberg, Tianyu Yang, Niklas Bauer, Terry Ruas, Jan Philip Wahle, Bela Gipp
...
**Comment:** Matches criterion 1 and 3: Introduces Spatial-Gym, a new benchmark and environment for evaluating spatial reasoning in agents, with detailed empirical analysis of model limitations and step-by-step reasoning. This is a novel simulator/benchmark for embodied AI and spatial intelligence.
**Relevance:** 10
**Novelty:** 8

---

## 2. [Learning Vision-Language-Action World Models for Autonomous Driving](https://arxiv.org/abs/2604.09059) <a id="link2"></a>
**ArXiv ID:** 2604.09059
**Authors:** Guoqing Wang, Pin Tang, Xiangxuan Ren, Guodongfang Zhao, Bailan Feng, Chao Ma
...
**Comment:** VLA-World is a new vision-language-action world model for autonomous driving, unifying predictive imagination and reflective reasoning. This matches criterion 1 (spatial intelligence in embodied agents), criterion 2 (multi-modal models), and criterion 4 (vision foundation models and applications).
**Relevance:** 10
**Novelty:** 8

---

## 3. [VisionFoundry: Teaching VLMs Visual Perception with Synthetic Images](https://arxiv.org/abs/2604.09531) <a id="link3"></a>
**ArXiv ID:** 2604.09531
**Authors:** Guanyu Zhou, Yida Yin, Wenhao Chai, Shengbang Tong, Xingyu Fu, Zhuang Liu
...
**Comment:** Matches criteria 1 (spatial understanding on VLMs/embodied agents), 2 (new VLM training with synthetic data), and 4 (vision foundation models and applications). The paper introduces a synthetic data pipeline to improve VLMs' spatial and perceptual abilities, showing significant empirical gains on spatial benchmarks.
**Relevance:** 10
**Novelty:** 8

---

## 4. [RIRF: Reasoning Image Restoration Framework](https://arxiv.org/abs/2604.09511) <a id="link4"></a>
**ArXiv ID:** 2604.09511
**Authors:** Wending Yan, Rongkai Zhang, Kaihua Tang, Yu Cheng, Qiankun Liu
...
**Comment:** Matches criterion 2 and 4: Proposes a new framework (R&R) that tightly couples structured chain-of-thought reasoning (using a VLLM, Qwen3-VL) with image restoration, integrating semantic reasoning and low-level vision. This is a novel application of VLLMs to vision restoration tasks.
**Relevance:** 9
**Novelty:** 8

---

## 5. [VL-Calibration: Decoupled Confidence Calibration for Large Vision-Language Models Reasoning](https://arxiv.org/abs/2604.09529) <a id="link5"></a>
**ArXiv ID:** 2604.09529
**Authors:** Wenyi Xiao, Xinchi Xu, Leilei Gan
...
**Comment:** VL-Calibration introduces a decoupled confidence calibration method for LVLMs, using RL to separate visual and reasoning confidence. This directly matches criterion 2 (new VLLM methods) and is highly relevant for vision-language model reliability.
**Relevance:** 9
**Novelty:** 8

---

## 6. [ActFER: Agentic Facial Expression Recognition via Active Tool-Augmented Visual Reasoning](https://arxiv.org/abs/2604.08990) <a id="link6"></a>
**ArXiv ID:** 2604.08990
**Authors:** Shifeng Liu, Zhengye Zhang, Sirui Zhao, Xinglong Mao, Zhehan Kan, Zhixiang Wei, Shiwei Wu, Chaoyou Fu, Tong Xu, Enhong Chen
...
**Comment:** ActFER proposes an agentic, tool-augmented MLLM for facial expression recognition, introducing active visual reasoning and a new RL algorithm. Closely matches criterion 1 (methodological improvements to spatial/spatial intelligence on embodied agents) and criterion 2 (new MLLM methods).
**Relevance:** 9
**Novelty:** 8

---

## 7. [Arbitration Failure, Not Perceptual Blindness: How Vision-Language Models Resolve Visual-Linguistic Conflicts](https://arxiv.org/abs/2604.09364) <a id="link7"></a>
**ArXiv ID:** 2604.09364
**Authors:** Farhad Nooralahzadeh, Omid Rohanian, Yi Zhang, Jonathan F\"urst, Kurt Stockinger
...
**Comment:** Directly investigates the internal mechanisms of VLMs, showing surprising empirical results about visual grounding and arbitration, and proposes interventions to improve visual faithfulness. Matches criterion 2 (VLLMs) and 4 (vision foundation models and applications), with insightful empirical findings.
**Relevance:** 9
**Novelty:** 8

---

## 8. [Matrix-Game 3.0: Real-Time and Streaming Interactive World Model with Long-Horizon Memory](https://arxiv.org/abs/2604.08995) <a id="link8"></a>
**ArXiv ID:** 2604.08995
**Authors:** Zile Wang, Zexiang Liu, Jaixing Li, Kaichen Huang, Baixin Xu, Fei Kang, Mengyin An, Peiyu Wang, Biao Jiang, Yichen Wei, Yidan Xietian, Jiangbo Pei, Liang Hu, Boyi Jiang, Hua Xue, Zidong Wang, Haofeng Sun, Wei Li, Wanli Ouyang, Xianglong He, Yang Liu, Yangguang Li, Yahui Zhou
...
**Comment:** Matrix-Game 3.0 presents a real-time, memory-augmented interactive world model for long-horizon video generation, with improvements in data, model, and inference. This is highly relevant to vision foundation models and generative modeling (criterion 4), and also touches on embodied AI simulators (criterion 3) via world modeling.
**Relevance:** 9
**Novelty:** 8

---

## 9. [ELT: Elastic Looped Transformers for Visual Generation](https://arxiv.org/abs/2604.09168) <a id="link9"></a>
**ArXiv ID:** 2604.09168
**Authors:** Sahil Goyal, Swayam Agrawal, Gautham Govind Anil, Prateek Jain, Sujoy Paul, Aditya Kusupati
...
**Comment:** This paper introduces Elastic Looped Transformers (ELT), a new parameter-efficient recurrent transformer architecture for visual generative modeling. It is highly relevant to vision foundation models and generative modeling (criterion 4), and introduces a clever intra-loop self-distillation trick.
**Relevance:** 9
**Novelty:** 8

---

## 10. [SEA-Eval: A Benchmark for Evaluating Self-Evolving Agents Beyond Episodic Assessment](https://arxiv.org/abs/2604.08988) <a id="link10"></a>
**ArXiv ID:** 2604.08988
**Authors:** Sihang Jiang, Lipeng Ma, Zhonghua Hong, Keyi Wang, Zhiyu Lu, Shisong Chen, Jinghao Zhang, Tianjun Pan, Weijia Zhou, Jiaqing Liang, Yanghua Xiao
...
**Comment:** SEA-Eval is a new benchmark for evaluating self-evolving agents, focusing on long-term evolution and intra-task reliability. This directly matches criterion 3 (new benchmarks for embodied AI with a novel focus on evolution and cross-task learning).
**Relevance:** 8
**Novelty:** 8

---

## 11. [MV3DIS: Multi-View Mask Matching via 3D Guides for Zero-Shot 3D Instance Segmentation](https://arxiv.org/abs/2604.08916) <a id="link11"></a>
**ArXiv ID:** 2604.08916
**Authors:** Yibo Zhao, Yigong Zhang, Jin Xie
...
**Comment:** Proposes a new method for zero-shot 3D instance segmentation using multi-view 2D masks and 3D priors, addressing spatial understanding and spatial intelligence in embodied agents. Matches criterion 1 (spatial understanding on embodied agents) and 3 (new methods for embodied AI).
**Relevance:** 9
**Novelty:** 7

---

## 12. [Realizing Immersive Volumetric Video: A Multimodal Framework for 6-DoF VR Engagement](https://arxiv.org/abs/2604.09473) <a id="link12"></a>
**ArXiv ID:** 2604.09473
**Authors:** Zhengxian Yang, Shengqi Wang, Shi Pan, Hongshuai Li, Haoxiang Wang, Lin Li, Guanjun Li, Zhengqi Wen, Borong Lin, Jianhua Tao, Tao Yu
...
**Comment:** Introduces a new multi-modal dataset and framework for immersive volumetric video with 6-DoF VR, including a new benchmark and simulator-related pipeline. Closely matches criterion 3 (embodied AI, new benchmarks/simulators) and 4 (vision foundation models and applications).
**Relevance:** 8
**Novelty:** 8

---

## 13. [Robust 4D Visual Geometry Transformer with Uncertainty-Aware Priors](https://arxiv.org/abs/2604.09366) <a id="link13"></a>
**ArXiv ID:** 2604.09366
**Authors:** Ying Zang, Yidong Han, Chaotao Ding, Yuanqi Hu, Deyi Ji, Qi Zhu, Xuanfu Li, Jin Ma, Lingyun Sun, Tianrun Chen, Lanyun Zhu
...
**Comment:** This paper proposes a robust 4D visual geometry transformer with uncertainty-aware priors for dynamic scene reconstruction. It is relevant to spatial understanding and vision foundation models (criteria 1 and 4), with novel mechanisms for disentangling dynamic/static components and uncertainty modeling.
**Relevance:** 8
**Novelty:** 8

---

## 14. [DRBENCHER: Can Your Agent Identify the Entity, Retrieve Its Properties and Do the Math?](https://arxiv.org/abs/2604.09251) <a id="link14"></a>
**ArXiv ID:** 2604.09251
**Authors:** Young-Suk Lee, Ramon Fernandez Astudillo, Radu Florian
...
**Comment:** This paper introduces DRBENCHER, a new synthetic benchmark for evaluating agents' ability to interleave web browsing and computation. It is relevant to embodied AI benchmarks (criterion 3), especially for agents that combine retrieval and reasoning in complex, multi-hop tasks.
**Relevance:** 8
**Novelty:** 8

---

## 15. [SenBen: Sensitive Scene Graphs for Explainable Content Moderation](https://arxiv.org/abs/2604.08819) <a id="link15"></a>
**ArXiv ID:** 2604.08819
**Authors:** Fatih Cagatay Akyon, Alptekin Temizel
...
**Comment:** Matches criterion 4: Introduces a new large-scale scene graph benchmark (SenBen) for sensitive content, and distills a VLM into a compact model with novel loss functions and evaluation. The work is directly related to vision foundation models and their applications in explainable content moderation.
**Relevance:** 8
**Novelty:** 7

---

## 16. [StreamMeCo: Long-Term Agent Memory Compression for Efficient Streaming Video Understanding](https://arxiv.org/abs/2604.09000) <a id="link16"></a>
**ArXiv ID:** 2604.09000
**Authors:** Junxi Wang, Te Sun, Jiayi Zhu, Junxian Li, Haowen Xu, Zichen Wen, Xuming Hu, Zhiyu Li, Linfeng Zhang
...
**Comment:** Matches criterion 1 and 3: Proposes a new memory compression framework for vision agents in streaming video understanding, with empirical results on embodied agent benchmarks. The method addresses efficient spatial memory and agent reasoning, and is evaluated on embodied AI benchmarks.
**Relevance:** 8
**Novelty:** 7

---

## 17. [Long-SCOPE: Fully Sparse Long-Range Cooperative 3D Perception](https://arxiv.org/abs/2604.09206) <a id="link17"></a>
**ArXiv ID:** 2604.09206
**Authors:** Jiahao Wang, Zikun Xu, Yuner Zhang, Zhongwei Jiang, Chenyang Lu, Shuocheng Yang, Yuxuan Wang, Jiaru Zhong, Chuang Zhang, Shaobing Xu, Jianqiang Wang
...
**Comment:** Long-SCOPE proposes a fully sparse framework for long-range cooperative 3D perception, introducing geometry-guided query generation and context-aware association. This matches criterion 1 (methodological improvements to spatial understanding in embodied agents).
**Relevance:** 8
**Novelty:** 7

---

## 18. [Seeing is Believing: Robust Vision-Guided Cross-Modal Prompt Learning under Label Noise](https://arxiv.org/abs/2604.09532) <a id="link18"></a>
**ArXiv ID:** 2604.09532
**Authors:** Zibin Geng, Xuefeng Jiang, Jia Li, Zheng Li, Tian Wen, Lvhua Wu, Sheng Sun, Yuwei Wang, Min Liu
...
**Comment:** Presents a robust vision-guided prompt learning framework for VLMs under label noise, using cross-modal attention and conditional modulation. Matches criterion 2 (VLLMs/MLLMs) and 4 (vision foundation models and applications), with a clever statistical approach to robustness.
**Relevance:** 8
**Novelty:** 7

---

## 19. [Visually-Guided Policy Optimization for Multimodal Reasoning](https://arxiv.org/abs/2604.09349) <a id="link19"></a>
**ArXiv ID:** 2604.09349
**Authors:** Zengbin Wang, Feng Xiong, Liang Lin, Xuecai Hu, Yong Wang, Yanlin Wang, Man Zhang, Xiangxiang Chu
...
**Comment:** Proposes a new policy optimization framework to improve visual grounding in VLMs for multi-modal reasoning, addressing visual forgetting and attention. Matches criterion 2 (VLLMs/MLLMs) and 4 (vision foundation models and applications), with a novel statistical trick for reinforcement learning.
**Relevance:** 8
**Novelty:** 7

---

## 20. [Overhang Tower: Resource-Rational Adaptation in Sequential Physical Planning](https://arxiv.org/abs/2604.09072) <a id="link20"></a>
**ArXiv ID:** 2604.09072
**Authors:** Ruihong Shen, Shiqian Li, Yixin Zhu
...
**Comment:** Matches criterion 1: The paper investigates human strategies for sequential physical planning and spatial reasoning under resource constraints, providing insights into spatial intelligence and adaptation mechanisms. The Overhang Tower task is a novel experimental setup for studying these phenomena.
**Relevance:** 7
**Novelty:** 7

---

## 21. [SAGE: A Service Agent Graph-guided Evaluation Benchmark](https://arxiv.org/abs/2604.09285) <a id="link21"></a>
**ArXiv ID:** 2604.09285
**Authors:** Ling Shi, Yuqin Dai, Ziyin Wang, Ning Gao, Wei Zhang, Chaozheng Wang, Yujie Wang, Wei He, Jinpeng Wang, Deiyi Xiong
...
**Comment:** This paper introduces SAGE, a new multi-agent benchmark for evaluating LLMs in customer service, with a focus on dynamic dialogue graphs and adversarial intent. Closely matches criterion 3 (new benchmarks for embodied/agentic AI with novel evaluation angles).
**Relevance:** 7
**Novelty:** 7

---

## 22. [FIRE-CIR: Fine-grained Reasoning for Composed Fashion Image Retrieval](https://arxiv.org/abs/2604.09114) <a id="link22"></a>
**ArXiv ID:** 2604.09114
**Authors:** Fran\c{c}ois Gard\`eres, Camille-Sovanneary Gauthier, Jean Ponce, Shizhe Chen
...
**Comment:** Presents a new method for compositional reasoning in vision-language models for fine-grained image retrieval, with a focus on interpretable, attribute-level reasoning. Closely matches criterion 2 (VLLMs/MLLMs) and 4 (vision foundation models and applications).
**Relevance:** 7
**Novelty:** 7

---

## 23. [MASS: Mesh-inellipse Aligned Deformable Surfel Splatting for Hand Reconstruction and Rendering from Egocentric Monocular Video](https://arxiv.org/abs/2604.08943) <a id="link23"></a>
**ArXiv ID:** 2604.08943
**Authors:** Haoyu Zhu, Yi Zhang, Lei Yao, Lap-pui Chau, Yi Wang
...
**Comment:** This paper introduces a new method for high-fidelity 3D hand reconstruction from egocentric monocular video, using a mesh-inellipse aligned deformable surfel splatting approach. It is a methodological improvement in spatial understanding and 3D vision (criterion 1), especially for embodied perception tasks.
**Relevance:** 7
**Novelty:** 7

---

## 24. [NTIRE 2026 The 3rd Restore Any Image Model (RAIM) Challenge: Multi-Exposure Image Fusion in Dynamic Scenes (Track 2)](https://arxiv.org/abs/2604.09030) <a id="link24"></a>
**ArXiv ID:** 2604.09030
**Authors:** Lishen Qu, Yao Liu, Jie Liang, Hui Zeng, Wen Dai, Guanyi Qin, Ya-nan Guan, Shihao Zhou, Jufeng Yang, Lei Zhang, Radu Timofte, Xiyuan Yuan, Wanjie Sun, Shihang Li, Bo Zhang, Bin Chen, Jiannan Lin, Yuxu Chen, Qinquan Gao, Tong Tong, Song Gao, Jiacong Tang, Tao Hu, Xiaowen Ma, Qingsen Yan, Sunhan Xu, Juan Wang, Xinyu Sun, Lei Qi, He Xu, Jiachen Tu, Guoyi Xu, Yaoxin Jiang, Jiajia Liu, Yaokun Shi
...
**Comment:** NTIRE 2026 RAIM Challenge presents a new benchmark for multi-exposure image fusion in dynamic scenes. This matches criterion 4 (vision foundation models and applications) and criterion 3 (new benchmarks in vision).
**Relevance:** 7
**Novelty:** 6

---

## 25. [OpenKedge: Governing Agentic Mutation with Execution-Bound Safety and Evidence Chains](https://arxiv.org/abs/2604.08601) <a id="link25"></a>
**ArXiv ID:** 2604.08601
**Authors:** Jun He, Deying Yu
...
**Comment:** OpenKedge introduces a protocol for safe, auditable agentic mutation in multi-agent systems, focusing on intent governance and execution safety. This is relevant to criterion 3 (new methods for embodied/agentic AI with a novel safety and auditability angle).
**Relevance:** 6
**Novelty:** 7

---

## 26. [InsEdit: Towards Instruction-based Visual Editing via Data-Efficient Video Diffusion Models Adaptation](https://arxiv.org/abs/2604.08646) <a id="link26"></a>
**ArXiv ID:** 2604.08646
**Authors:** Zhefan Rao, Bin Zou, Haoxuan Che, Xuanhua He, Chong Hou Choi, Yanheng Li, Rui Liu, Qifeng Chen
...
**Comment:** Instruction-based visual editing via video diffusion models is relevant to generative modeling in multi-modal learning (criterion 4), but not directly about spatial intelligence or VLLMs. The data-efficient adaptation and support for both video and image editing is a notable technical contribution.
**Relevance:** 5
**Novelty:** 7

---

## 27. [Process Reward Agents for Steering Knowledge-Intensive Reasoning](https://arxiv.org/abs/2604.09482) <a id="link27"></a>
**ArXiv ID:** 2604.09482
**Authors:** Jiwoong Sohn, Tomasz Sternal, Kenneth Styppa, Torsten Hoefler, Michael Moor
...
**Comment:** Process Reward Agents (PRA) is a new method for online, step-wise reward in knowledge-intensive reasoning, decoupling reward from frozen policy models. While not directly vision-related, it is a novel method for reasoning in LLMs, tangentially related to criterion 2.
**Relevance:** 4
**Novelty:** 7

---

## 28. [Neural Distribution Prior for LiDAR Out-of-Distribution Detection](https://arxiv.org/abs/2604.09232) <a id="link28"></a>
**ArXiv ID:** 2604.09232
**Authors:** Zizhao Li, Zhengkang Xiang, Jiayang Ao, Feng Liu, Joseph West, Kourosh Khoshelham
...
**Comment:** This paper proposes a new method for LiDAR out-of-distribution detection, which is relevant to spatial understanding in embodied agents (criterion 1), but it is not focused on embodied agents or spatial intelligence per se, rather on OOD detection in LiDAR perception. It introduces a neural distribution prior and a Perlin noise-based OOD synthesis strategy, which is a methodological improvement in open-world perception.
**Relevance:** 5
**Novelty:** 6

---

## 29. [What Matters in Virtual Try-Off? Dual-UNet Diffusion Model For Garment Reconstruction](https://arxiv.org/abs/2604.08716) <a id="link29"></a>
**ArXiv ID:** 2604.08716
**Authors:** Loc-Phat Truong, Meysam Madadi, Sergio Escalera
...
**Comment:** Somewhat related to criterion 4: The paper proposes a new diffusion-based architecture for garment reconstruction (Virtual Try-Off), which is a vision foundation model application in generative modeling. However, it is more focused on fashion and image synthesis than general-purpose vision foundation models.
**Relevance:** 4
**Novelty:** 6

---

## 30. [EpiAgent: An Agent-Centric System for Ancient Inscription Restoration](https://arxiv.org/abs/2604.09367) <a id="link30"></a>
**ArXiv ID:** 2604.09367
**Authors:** Shipeng Zhu, Ang Chen, Na Nie, Pengfei Fang, Min-Ling Zhang, Hui Xue
...
**Comment:** EpiAgent is an agent-centric system for ancient inscription restoration, using a hierarchical planning paradigm with LLM-based orchestration of multimodal tools. It is relevant to multi-modal learning and agent-based systems, but does not directly match the criteria for VLLMs/MLLMs or embodied AI benchmarks.
**Relevance:** 4
**Novelty:** 6

---

## 31. [Beyond Segmentation: Structurally Informed Facade Parsing from Imperfect Images](https://arxiv.org/abs/2604.09260) <a id="link31"></a>
**ArXiv ID:** 2604.09260
**Authors:** Maciej Janicki, Aleksander Plocharski, Przemyslaw Musialski
...
**Comment:** Presents a new loss for structural regularity in facade parsing, which is a vision task but not directly about spatial intelligence in embodied agents, VLLMs, or vision foundation models. Some relevance to spatial understanding in a narrow context.
**Relevance:** 4
**Novelty:** 5

---

## 32. [Domain-generalizable Face Anti-Spoofing with Patch-based Multi-tasking and Artifact Pattern Conversion](https://arxiv.org/abs/2604.09018) <a id="link32"></a>
**ArXiv ID:** 2604.09018
**Authors:** Seungjin Jung, Yonghyun Jeong, Minha Kim, Jimin Min, Youngjoon Yoo, Jongwon Choi
...
**Comment:** PCGAN is a generative adversarial network for face anti-spoofing with patch-based multi-tasking. While it uses generative modeling and vision, it does not directly match any specific criterion.
**Relevance:** 3
**Novelty:** 5

---

## 33. [E3-TIR: Enhanced Experience Exploitation for Tool-Integrated Reasoning](https://arxiv.org/abs/2604.09455) <a id="link33"></a>
**ArXiv ID:** 2604.09455
**Authors:** Weiyang Guo, Zesheng Shi, Liye Zhao, Jiayuan Ma, Zeen Zhu, Junxian He, Min Zhang, Jing Li
...
**Comment:** Related to multi-modal tool-use reasoning in LLMs, but does not focus on spatial intelligence, VLLMs, or vision foundation models. Closest to general multi-modal agent training.
**Relevance:** 3
**Novelty:** 5

---

## 34. [CAD 100K: A Comprehensive Multi-Task Dataset for Car Related Visual Anomaly Detection](https://arxiv.org/abs/2604.09023) <a id="link34"></a>
**ArXiv ID:** 2604.09023
**Authors:** Jiahua Pang, Ying Li, Dongpu Cao, Jingcai Luo, Yanuo Zheng, Bao Yunfan, Yujie Lei, Rui Yuan, Yuxi Tian, Guojin Yuan, Hongchang Chen, Zhi Zheng, Yongchun Liu
...
**Comment:** CAD 100K introduces a large-scale multi-task dataset for car-related visual anomaly detection. It is a new benchmark, but not for embodied AI or simulators, and does not match the specific criteria.
**Relevance:** 3
**Novelty:** 5

---

## 35. [BIAS: A Biologically Inspired Algorithm for Video Saliency Detection](https://arxiv.org/abs/2604.08858) <a id="link35"></a>
**ArXiv ID:** 2604.08858
**Authors:** Zhao-ji Zhang, Ya-tang Li
...
**Comment:** BIAS is a biologically inspired algorithm for video saliency detection. While it is a methodological improvement in video understanding, it does not directly match any of the four criteria, but is generally relevant to computer vision.
**Relevance:** 3
**Novelty:** 5
