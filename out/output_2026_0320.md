...
0. [Rethinking MLLM Itself as a Segmenter with a Single Segmentation Token](#link0)
**Authors:** Anqi Zhang, Xiaokang Ji, Guangyu Gao, Jianbo Jiao, Chi Harold Liu, Yunchao Wei

1. [MultihopSpatial: Multi-hop Compositional Spatial Reasoning Benchmark for Vision-Language Model](#link1)
**Authors:** Youngwan Lee, Soojin Jang, Yoorhim Cho, Seunghwan Lee, Yong-Ju Lee, Sung Ju Hwang

2. [TerraScope: Pixel-Grounded Visual Reasoning for Earth Observation](#link2)
**Authors:** Yan Shu, Bin Ren, Zhitong Xiong, Xiao Xiang Zhu, Beg\"um Demir, Nicu Sebe, Paolo Rota

3. [GenVideoLens: Where LVLMs Fall Short in AI-Generated Video Detection?](#link3)
**Authors:** Yueying Zou, Pei Pei Li, Zekun Li, Xinyu Guo, Xing Cui, Huaibo Huang, Ran He

4. [NymeriaPlus: Enriching Nymeria Dataset with Additional Annotations and Data](#link4)
...
5. [Multi-Modal Building Change Detection for Large-Scale Small Changes: Benchmark and Baseline](#link5)
**Authors:** Ye Wang, Wei Lu, Zhihui You, Keyan Chen, Tongfei Liu, Kaiyu Li, Hongruixuan Chen, Qingling Shu, Sibao Chen

6. [Inst4DGS: Instance-Decomposed 4D Gaussian Splatting with Multi-Video Label Permutation Learning](#link6)
**Authors:** Yonghan Lee, Dinesh Manocha

7. [Ontology-Guided Diffusion for Zero-Shot Visual Sim2Real Transfer](#link7)
**Authors:** Mohamed Youssef, Mayar Elfares, Anna-Maria Meer, Matteo Bortoletto, Andreas Bulling

8. [VLM-AutoDrive: Post-Training Vision-Language Models for Safety-Critical Autonomous Driving Events](#link8)
...
9. [Reconstruction Matters: Learning Geometry-Aligned BEV Representation through 3D Gaussian Splatting](#link9)
**Authors:** Yiren Lu, Xin Ye, Burhaneddin Yaman, Jingru Luo, Zhexiao Xiong, Liu Ren, Yu Yin

10. [Learning Consistent Temporal Grounding between Related Tasks in Sports Coaching](#link10)
**Authors:** Arushi Rai, Adriana Kovashka

11. [OpenT2M: No-frill Motion Generation with Open-source,Large-scale, High-quality Data](#link11)
**Authors:** Bin Cao, Sipeng Zheng, Hao Luo, Boyuan Li, Jing Liu, Zongqing Lu

12. [SEM: Sparse Embedding Modulation for Post-Hoc Debiasing of Vision-Language Models](#link12)
**Authors:** Quentin Guimard, Federico Bartsch, Simone Caldarella, Rahaf Aljundi, Elisa Ricci, Massimiliano Mancini

13. [Em-Garde: A Propose-Match Framework for Proactive Streaming Video Understanding](#link13)
**Authors:** Yikai Zheng, Xin Ding, Yifan Yang, Shiqi Jiang, Hao Wu, Qianxi Zhang, Weijun Wang, Ting Cao, Yunxin Liu

14. [Pixel-Accurate Epipolar Guided Matching](#link14)
**Authors:** Oleksii Nasypanyi, Francois Rameau

15. [SAMA: Factorized Semantic Anchoring and Motion Alignment for Instruction-Guided Video Editing](#link15)
...
16. [ProRL Agent: Rollout-as-a-Service for RL Training of Multi-Turn LLM Agents](#link16)
...
17. [Generalized Hand-Object Pose Estimation with Occlusion Awareness](#link17)
**Authors:** Hui Yang, Wei Sun, Jian Liu, Jian Xiao Tao Xie, Hossein Rahmani, Ajmal Saeed mian, Nicu Sebe, Gim Hee Lee

18. [MemMA: Coordinating the Memory Cycle through Multi-Agent Reasoning and In-Situ Self-Evolution](#link18)
**Authors:** Minhua Lin, Zhiwei Zhang, Hanqing Lu, Hui Liu, Xianfeng Tang, Qi He, Xiang Zhang, Suhang Wang

19. [DA-Mamba: Learning Domain-Aware State Space Model for Global-Local Alignment in Domain Adaptive Object Detection](#link19)
**Authors:** Haochen Li, Rui Zhang, Hantao Yao, Xin Zhang, Yifan Hao, Shaohui Peng, Yongwei Zhao, Ling Li

20. [Interplay: Training Independent Simulators for Reference-Free Conversational Recommendation](#link20)
**Authors:** Jerome Ramos, Feng Xia, Xi Wang, Shubham Chatterjee, Xiao Fu, Hossein A. Rahmani, Aldo Lipani

21. [EffectErase: Joint Video Object Removal and Insertion for High-Quality Effect Erasing](#link21)
**Authors:** Yang Fu, Yike Zheng, Ziyun Dai, Henghui Ding

22. [Reasoning over mathematical objects: on-policy reward modeling and test time aggregation](#link22)
...
23. [Q-Drift: Quantization-Aware Drift Correction for Diffusion Model Sampling](#link23)
**Authors:** Sooyoung Ryu, Mathieu Salzmann, Saqib Javed

---
## 0. [Rethinking MLLM Itself as a Segmenter with a Single Segmentation Token](https://arxiv.org/abs/2603.19026) <a id="link0"></a>
**ArXiv ID:** 2603.19026
**Authors:** Anqi Zhang, Xiaokang Ji, Guangyu Gao, Jianbo Jiao, Chi Harold Liu, Yunchao Wei
...
**Comment:** Strongly matches criterion 2 (new MLLM segmentation method) and criterion 4 (vision foundation models and applications). Proposes a decoder-free segmentation approach using a single segmentation token in MLLMs, which is a novel angle.
**Relevance:** 10
**Novelty:** 8

---

## 1. [MultihopSpatial: Multi-hop Compositional Spatial Reasoning Benchmark for Vision-Language Model](https://arxiv.org/abs/2603.18892) <a id="link1"></a>
**ArXiv ID:** 2603.18892
**Authors:** Youngwan Lee, Soojin Jang, Yoorhim Cho, Seunghwan Lee, Yong-Ju Lee, Sung Ju Hwang
...
**Comment:** Strongly matches criterion 1 and 3: introduces MultihopSpatial, a new benchmark for multi-hop compositional spatial reasoning in VLMs, with new metrics and training corpus, and provides insights into spatial intelligence and embodied AI evaluation.
**Relevance:** 10
**Novelty:** 8

---

## 2. [TerraScope: Pixel-Grounded Visual Reasoning for Earth Observation](https://arxiv.org/abs/2603.19039) <a id="link2"></a>
**ArXiv ID:** 2603.19039
**Authors:** Yan Shu, Bin Ren, Zhitong Xiong, Xiao Xiang Zhu, Beg\"um Demir, Nicu Sebe, Paolo Rota
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Introduces TerraScope, a unified VLM for pixel-grounded geospatial reasoning, with a new dataset and benchmark.
**Relevance:** 9
**Novelty:** 8

---

## 3. [GenVideoLens: Where LVLMs Fall Short in AI-Generated Video Detection?](https://arxiv.org/abs/2603.18625) <a id="link3"></a>
**ArXiv ID:** 2603.18625
**Authors:** Yueying Zou, Pei Pei Li, Zekun Li, Xinyu Guo, Xing Cui, Huaibo Huang, Ran He
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 3 (benchmark for LVLMs on AI-generated video detection with fine-grained analysis). Provides a new benchmark (GenVideoLens) and diagnostic insights into LVLMs' weaknesses in video authenticity detection.
**Relevance:** 9
**Novelty:** 8

---

## 4. [NymeriaPlus: Enriching Nymeria Dataset with Additional Annotations and Data](https://arxiv.org/abs/2603.18496) <a id="link4"></a>
**ArXiv ID:** 2603.18496
**Authors:** Daniel DeTone, Federica Bogo, Eric-Tuan Le, Duncan Frost, Julian Straub, Yawar Siddiqui, Yuting Ye, Jakob Engel, Richard Newcombe, Lingni Ma
...
**Comment:** Matches criterion 3 (new embodied AI benchmark/dataset with novel modalities and annotations for egocentric, multimodal learning). NymeriaPlus is a significant upgrade to an existing dataset, supporting new research directions.
**Relevance:** 9
**Novelty:** 7

---

## 5. [Multi-Modal Building Change Detection for Large-Scale Small Changes: Benchmark and Baseline](https://arxiv.org/abs/2603.19077) <a id="link5"></a>
**ArXiv ID:** 2603.19077
**Authors:** Ye Wang, Wei Lu, Zhihui You, Keyan Chen, Tongfei Liu, Kaiyu Li, Hongruixuan Chen, Qingling Shu, Sibao Chen
...
**Comment:** Matches criterion 3 and 4: introduces a new large-scale multi-modal benchmark (LSMD) for building change detection and proposes a novel network (MSCNet) for cross-modal feature fusion, relevant to vision foundation models and embodied AI benchmarks.
**Relevance:** 9
**Novelty:** 7

---

## 6. [Inst4DGS: Instance-Decomposed 4D Gaussian Splatting with Multi-Video Label Permutation Learning](https://arxiv.org/abs/2603.18402) <a id="link6"></a>
**ArXiv ID:** 2603.18402
**Authors:** Yonghan Lee, Dinesh Manocha
...
**Comment:** Matches criterion 1 (spatial understanding and intelligence) and criterion 3 (novel method for instance-decomposed 4D Gaussian Splatting with label permutation learning). Presents a new approach for instance decomposition and tracking in dynamic scenes.
**Relevance:** 8
**Novelty:** 8

---

## 7. [Ontology-Guided Diffusion for Zero-Shot Visual Sim2Real Transfer](https://arxiv.org/abs/2603.18719) <a id="link7"></a>
**ArXiv ID:** 2603.18719
**Authors:** Mohamed Youssef, Mayar Elfares, Anna-Maria Meer, Matteo Bortoletto, Andreas Bulling
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and criterion 3 (sim2real transfer with a novel neuro-symbolic diffusion approach). Introduces ontology-guided diffusion for zero-shot sim2real transfer, using structured knowledge and graph neural networks.
**Relevance:** 8
**Novelty:** 8

---

## 8. [VLM-AutoDrive: Post-Training Vision-Language Models for Safety-Critical Autonomous Driving Events](https://arxiv.org/abs/2603.18178) <a id="link8"></a>
**ArXiv ID:** 2603.18178
**Authors:** Mohammad Qazim Bhat, Yufan Huang, Niket Agarwal, Hao Wang, Michael Woods, John Kenyon, Tsung-Yi Lin, Xiaodong Yang, Ming-Yu Liu, Kevin Xie
...
**Comment:** Matches criterion 2 (adapting VLMs for domain-specific, temporally localized tasks) and criterion 4 (application of vision foundation models). Proposes a modular post-training framework for VLMs in safety-critical autonomous driving, with interpretable reasoning.
**Relevance:** 8
**Novelty:** 7

---

## 9. [Reconstruction Matters: Learning Geometry-Aligned BEV Representation through 3D Gaussian Splatting](https://arxiv.org/abs/2603.19193) <a id="link9"></a>
**ArXiv ID:** 2603.19193
**Authors:** Yiren Lu, Xin Ye, Burhaneddin Yaman, Jingru Luo, Zhexiao Xiong, Liu Ren, Yu Yin
...
**Comment:** Matches criterion 1 (methodological improvement to spatial understanding in BEV perception) and criterion 4 (vision foundation models and applications). Introduces explicit 3D Gaussian Splatting for geometry-aligned BEV representations, a novel approach for spatial reasoning.
**Relevance:** 8
**Novelty:** 7

---

## 10. [Learning Consistent Temporal Grounding between Related Tasks in Sports Coaching](https://arxiv.org/abs/2603.18453) <a id="link10"></a>
**ArXiv ID:** 2603.18453
**Authors:** Arushi Rai, Adriana Kovashka
...
**Comment:** Matches criterion 1 (methodological improvement to spatial/temporal grounding in embodied agents) and criterion 2 (improving video-LLMs for temporal grounding). Uses a novel self-consistency objective for better temporal attention in sports coaching tasks.
**Relevance:** 8
**Novelty:** 7

---

## 11. [OpenT2M: No-frill Motion Generation with Open-source,Large-scale, High-quality Data](https://arxiv.org/abs/2603.18623) <a id="link11"></a>
**ArXiv ID:** 2603.18623
**Authors:** Bin Cao, Sipeng Zheng, Hao Luo, Boyuan Li, Jing Liu, Zongqing Lu
...
**Comment:** Matches criterion 3: introduces OpenT2M, a large-scale open-source text-to-motion dataset and a new motion model, addressing benchmarking and generalization in motion generation for embodied agents.
**Relevance:** 8
**Novelty:** 7

---

## 12. [SEM: Sparse Embedding Modulation for Post-Hoc Debiasing of Vision-Language Models](https://arxiv.org/abs/2603.19028) <a id="link12"></a>
**ArXiv ID:** 2603.19028
**Authors:** Quentin Guimard, Federico Bartsch, Simone Caldarella, Rahaf Aljundi, Elisa Ricci, Massimiliano Mancini
...
**Comment:** Matches criterion 4: proposes SEM, a new post-hoc debiasing method for vision-language models (CLIP), using sparse latent representations for improved fairness and semantic fidelity.
**Relevance:** 8
**Novelty:** 7

---

## 13. [Em-Garde: A Propose-Match Framework for Proactive Streaming Video Understanding](https://arxiv.org/abs/2603.19054) <a id="link13"></a>
**ArXiv ID:** 2603.19054
**Authors:** Yikai Zheng, Xin Ding, Yifan Yang, Shiqi Jiang, Hao Wu, Qianxi Zhang, Weijun Wang, Ting Cao, Yunxin Liu
...
**Comment:** Matches criterion 1 (methodological improvement for spatial understanding in streaming video) and criterion 2 (proposes a new VideoLLM framework). Introduces a novel propose-match framework for proactive streaming video understanding, improving efficiency and accuracy.
**Relevance:** 8
**Novelty:** 7

---

## 14. [Pixel-Accurate Epipolar Guided Matching](https://arxiv.org/abs/2603.18401) <a id="link14"></a>
**ArXiv ID:** 2603.18401
**Authors:** Oleksii Nasypanyi, Francois Rameau
...
**Comment:** Matches criterion 1 (methodological improvement for spatial understanding) with a novel, efficient, and exact epipolar-guided matching method for keypoint correspondence.
**Relevance:** 7
**Novelty:** 7

---

## 15. [SAMA: Factorized Semantic Anchoring and Motion Alignment for Instruction-Guided Video Editing](https://arxiv.org/abs/2603.19228) <a id="link15"></a>
**ArXiv ID:** 2603.19228
**Authors:** Xinyao Zhang, Wenkai Dong, Yuxin Song, Bo Fang, Qi Zhang, Jing Wang, Fan Chen, Hui Zhang, Haocheng Feng, Yu Lu, Hang Zhou, Chun Yuan, Jingdong Wang
...
**Comment:** Matches criterion 4 (vision foundation models and applications) and is relevant to generative modeling in multi-modal learning. Proposes a factorized approach for instruction-guided video editing with strong zero-shot ability.
**Relevance:** 7
**Novelty:** 7

---

## 16. [ProRL Agent: Rollout-as-a-Service for RL Training of Multi-Turn LLM Agents](https://arxiv.org/abs/2603.18815) <a id="link16"></a>
**ArXiv ID:** 2603.18815
**Authors:** Hao Zhang, Mingjie Liu, Shaokun Zhang, Songyang Han, Jian Hu, Zhenghui Jin, Yuchi Zhang, Shizhe Diao, Ximing Lu, Binfeng Xu, Zhiding Yu, Jan Kautz, Yi Dong
...
**Comment:** Matches criterion 3: introduces a new scalable infrastructure (ProRL Agent) for RL training of multi-turn LLM agents, with standardized sandbox environments and open-source integration, which is relevant to embodied AI benchmarks and methods.
**Relevance:** 7
**Novelty:** 6

---

## 17. [Generalized Hand-Object Pose Estimation with Occlusion Awareness](https://arxiv.org/abs/2603.19013) <a id="link17"></a>
**ArXiv ID:** 2603.19013
**Authors:** Hui Yang, Wei Sun, Jian Liu, Jian Xiao Tao Xie, Hossein Rahmani, Ajmal Saeed mian, Nicu Sebe, Gim Hee Lee
...
**Comment:** Related to spatial understanding (criterion 1) and multi-modal learning, but focuses on hand-object pose estimation with occlusion awareness. Uses hierarchical semantic prompts and multi-modal masked modeling.
**Relevance:** 6
**Novelty:** 6

---

## 18. [MemMA: Coordinating the Memory Cycle through Multi-Agent Reasoning and In-Situ Self-Evolution](https://arxiv.org/abs/2603.18718) <a id="link18"></a>
**ArXiv ID:** 2603.18718
**Authors:** Minhua Lin, Zhiwei Zhang, Hanqing Lu, Hui Liu, Xianfeng Tang, Qi He, Xiang Zhang, Suhang Wang
...
**Comment:** Somewhat related to criterion 3: introduces MemMA, a multi-agent framework for memory-augmented LLM agents, focusing on memory cycle coordination and self-evolution, which is a novel method for agent reasoning but not directly about spatial or embodied AI.
**Relevance:** 5
**Novelty:** 6

---

## 19. [DA-Mamba: Learning Domain-Aware State Space Model for Global-Local Alignment in Domain Adaptive Object Detection](https://arxiv.org/abs/2603.18757) <a id="link19"></a>
**ArXiv ID:** 2603.18757
**Authors:** Haochen Li, Rui Zhang, Hantao Yao, Xin Zhang, Yifan Hao, Shaohui Peng, Yongwei Zhao, Ling Li
...
**Comment:** Somewhat related to criterion 1 (spatial intelligence in embodied agents) via domain adaptation in object detection, but not a direct match. Focuses on global-local alignment using state space models.
**Relevance:** 5
**Novelty:** 6

---

## 20. [Interplay: Training Independent Simulators for Reference-Free Conversational Recommendation](https://arxiv.org/abs/2603.18573) <a id="link20"></a>
**ArXiv ID:** 2603.18573
**Authors:** Jerome Ramos, Feng Xia, Xi Wang, Shubham Chatterjee, Xiao Fu, Hossein A. Rahmani, Aldo Lipani
...
**Comment:** Somewhat related to criterion 3: proposes a new simulation framework for training conversational recommender systems using independent LLMs, which is a novel method for generating training data, but not directly about embodied AI or spatial intelligence.
**Relevance:** 4
**Novelty:** 6

---

## 21. [EffectErase: Joint Video Object Removal and Insertion for High-Quality Effect Erasing](https://arxiv.org/abs/2603.19224) <a id="link21"></a>
**ArXiv ID:** 2603.19224
**Authors:** Yang Fu, Yike Zheng, Ziyun Dai, Henghui Ding
...
**Comment:** Related to vision foundation models and generative modeling, but does not directly match any specific criterion. Focuses on video object removal/insertion and introduces a new dataset and reciprocal learning scheme.
**Relevance:** 4
**Novelty:** 6

---

## 22. [Reasoning over mathematical objects: on-policy reward modeling and test time aggregation](https://arxiv.org/abs/2603.18886) <a id="link22"></a>
**ArXiv ID:** 2603.18886
**Authors:** Pranjal Aggarwal, Marjan Ghazvininejad, Seungone Kim, Ilia Kulikov, Jack Lanchantin, Xian Li, Tianjian Li, Bo Liu, Graham Neubig, Anaelia Ovalle, Swarnadeep Saha, Sainbayar Sukhbaatar, Sean Welleck, Jason Weston, Chenxi Whitehouse, Adina Williams, Jing Xu, Ping Yu, Weizhe Yuan, Jingyu Zhang, Wenting Zhao
...
**Comment:** Related to multi-modal reasoning and LLMs, but focuses on mathematical object derivation and reward modeling, not directly on spatial or embodied AI or VLLMs/MLLMs.
**Relevance:** 3
**Novelty:** 5

---

## 23. [Q-Drift: Quantization-Aware Drift Correction for Diffusion Model Sampling](https://arxiv.org/abs/2603.18095) <a id="link23"></a>
**ArXiv ID:** 2603.18095
**Authors:** Sooyoung Ryu, Mathieu Salzmann, Saqib Javed
...
**Comment:** Relevant to generative modeling in multi-modal learning, but does not directly match any specific criterion. Focuses on quantization-aware correction for diffusion models.
**Relevance:** 3
**Novelty:** 5
