...
0. [EnvHarness: Awakening Static Worlds for Agent Learning](#link0)
...
1. [Scaffolding Minds: Optimizing Latent Visual Target Representations for Multimodal Reasoning](#link1)
**Authors:** Haoqiang Kang, Yinpeng Chen, Luyang Liu, Jesper Sparre Andersen, Abhijit Ogale, Baochen Sun, Lichan Hong, Ed H. Chi

2. [CVSD-Reg: Cross-Modal Visual Semantic Prior Distillation for Robust LiDAR Registration](#link2)
**Authors:** Eunsoo Im, Junghun Suh, Gyeonggwan Lee, Seunghwan Hong

3. [VGI-BENCH: Probing Visual Intelligence in Video Generation Models](#link3)
...
4. [SafeBranch: Branch-Pair Safety Alignment for Embodied Agents](#link4)
**Authors:** Hyunse Lee, Jiwoo Jeong, Haneul Lee, Kyochul Jang, Youngjae Yu, Woojin Lee

5. [CAViAR: A Causal Video Dataset for Fine-Grained Accident Reasoning in Real-World Scenarios](#link5)
**Authors:** Sparsh Garg, Yi-Wen Chen, Vijay Kumar B G, Abhishek Aich

6. [DARS: Dual-Level Credit Assignment RL with Structured Reasoning for Instruction-Based Image Editing](#link6)
**Authors:** Haoxiang Cao, Jiajiong Cao, Xuanpu Zhang, Changqian Yu, Chaoqun Wang

7. [Scale-Separated Conditioning for Style-Encoder-Free Diffusion Stylization](#link7)
**Authors:** Jingtao Zhang, Haorui Gao, Youqing Liang, Zeming Liu

8. [Swift-Image: Exploring the Performance Frontier of Compact Unified Image Generation Models](#link8)
...
9. [DPC-Net: Dual-Prior Collaborative Network for All-in-One Image Restoration](#link9)
**Authors:** Zhaokun He, Kangbiao Shi, Axi Niu, Jian Jin, Peng Wu, Wei Dong, Qingsen Yan

10. [ArmorOCR: Grounded Adversarial Visual Perception via Observation-Transferred Self-Distillation](#link10)
...
11. [DIFFCZSL: Compositional Zero-Shot Learning Regularized by Diffusion Representations](#link11)
**Authors:** Hangyu Tian, Zhenqi He, Yanghao Wang, Long Chen

12. [Towards Surgical World-Action Modeling: A Preliminary Joint Visual-Trajectory Forecasting for Surgical Motion Planning](#link12)
**Authors:** Weiliang Huang, Huanrong Liu, Bob Zhang, Qi Dou, Zhen Chen, Yun Gu, Guy Rosman, Qingbiao Li

13. [Ultra-High-Definition Restoration Transformers with Correlation Matching Transformation](#link13)
**Authors:** Cong Wang, Liyan Wang, Jinshan Pan, Wei Wang, Wenqi Ren, Jun Liu, Xiaochun Cao

14. [Inter-X++: A Comprehensive Benchmark for Multimodal Human-Human Interaction Analysis](#link14)
**Authors:** Liang Xu, Chengqun Yang, Zili Lin, Xintao Lv, Yichao Yan, Xin Jin, Zhibo Chen, Xiaokang Yang, Wenjun Zeng

15. [Unwarping the Lens: A Physics-Grounded Approach to Video Glasses Removal](#link15)
**Authors:** Radim Spetlik, David Futschik, Radek Danecek, Feitong Tan, Ziqian Bai, Rohit Pandey, Yinda Zhang

16. [TextRefine: Improving Textual Fidelity, Spatial Placement, and Glyph Rendering for Text Editing in Product Posters](#link16)
...
17. [Break It Down, Pass It On: Cross-Task Skill Transfer in LLM Agents](#link17)
**Authors:** Yiyang Feng, Biddut Sarker Bijoy, Niranjan Balasubramanian, Jiawei Zhou

18. [RIPE++: Reinforced Keypoint Learning from Positive Pairs Only](#link18)
**Authors:** Johannes K\"unzel, Peter Eisert, Anna Hilsmann

19. [Unified and Efficient Point-Line Local Features](#link19)
**Authors:** Fran\c{c}ois Costa, Raphael Kreft, Eckhard Goedeke, Felix M\"oller, Hardik Shah, Ramanathan Rajaraman, Shaohui Liu, R\'emi Pautrat, Marc Pollefeys

20. [PL-NBA: A Possession-level Universal Basketball Video Dataset Supporting Multiple Visual Understanding Tasks](#link20)
**Authors:** Yunhao Zhao, Haoying Sun, Jiarui Li, Zhuming Wang, Ya Jing, Xiangbo Shu, Lifang Wu, Changwen Chen

21. [HandMvNet: Real-Time 3D Hand Pose Estimation Using Multi-View Cross-Attention Fusion](#link21)
**Authors:** Muhammad Asad Ali, Nadia Robertini, Didier Stricker

---
## 0. [EnvHarness: Awakening Static Worlds for Agent Learning](https://arxiv.org/abs/2608.19880) <a id="link0"></a>
**ArXiv ID:** 2608.19880
**Authors:** Chengsong Huang, Zifeng Wang, Rujun Han, Jun Yan, Yanfei Chen, Zoey CuiZhu, Ke Jiang, Peng Xia, Han Yu, Yufan Zhuang, Yifei Ming, Jiaqi Pan, Bhavana Dalvi Mishra, Jiaxin Huang, Burak Gokturk, Tomas Pfister, Chen-Yu Lee
...
**Comment:** Matches criterion 3 closely: it proposes a new environment-harness framework for agent learning, targeting weaknesses in static environments and automated environment reshaping.
**Relevance:** 8
**Novelty:** 7

---

## 1. [Scaffolding Minds: Optimizing Latent Visual Target Representations for Multimodal Reasoning](https://arxiv.org/abs/2608.19669) <a id="link1"></a>
**ArXiv ID:** 2608.19669
**Authors:** Haoqiang Kang, Yinpeng Chen, Luyang Liu, Jesper Sparre Andersen, Abhijit Ogale, Baochen Sun, Lichan Hong, Ed H. Chi
...
**Comment:** Matches criterion 1 closely: it improves multimodal reasoning for spatial planning, with explicit gains on FrozenLake spatial planning.
**Relevance:** 7
**Novelty:** 6

---

## 2. [CVSD-Reg: Cross-Modal Visual Semantic Prior Distillation for Robust LiDAR Registration](https://arxiv.org/abs/2608.19536) <a id="link2"></a>
**ArXiv ID:** 2608.19536
**Authors:** Eunsoo Im, Junghun Suh, Gyeonggwan Lee, Seunghwan Hong
...
**Comment:** Matches criterion 4 closely: it distills a vision foundation model (DINOv2) into LiDAR registration for robust cross-sensor geometry.
**Relevance:** 7
**Novelty:** 6

---

## 3. [VGI-BENCH: Probing Visual Intelligence in Video Generation Models](https://arxiv.org/abs/2608.19583) <a id="link3"></a>
**ArXiv ID:** 2608.19583
**Authors:** Xuan He, Cong Wei, Yuhao Cheng, Linrui Ma, Yuxuan Zhang, Zuojun Li, Yuhao Wen, Zeyi Liu, Yuren Hao, Songcheng Cai, Keming Wu, Penghui Du, Kai Zou, Rui Yang, Chenkai Sun, Ke Yang, Ping Nie, Kelsey R Allen, Chenglong Wang, Michel Galley, Jianfeng Gao, ChengXiang Zhai
...
**Comment:** Matches criterion 4 very closely: it is a benchmark for probing visual intelligence in video generation models, with analysis of failure modes and reasoning capabilities.
**Relevance:** 7
**Novelty:** 6

---

## 4. [SafeBranch: Branch-Pair Safety Alignment for Embodied Agents](https://arxiv.org/abs/2608.19729) <a id="link4"></a>
**ArXiv ID:** 2608.19729
**Authors:** Hyunse Lee, Jiwoo Jeong, Haneul Lee, Kyochul Jang, Youngjae Yu, Woojin Lee
...
**Comment:** Matches criterion 1 very closely: safety alignment for embodied agents, focusing on safer action selection in interactive environments.
**Relevance:** 5
**Novelty:** 7

---

## 5. [CAViAR: A Causal Video Dataset for Fine-Grained Accident Reasoning in Real-World Scenarios](https://arxiv.org/abs/2608.19380) <a id="link5"></a>
**ArXiv ID:** 2608.19380
**Authors:** Sparsh Garg, Yi-Wen Chen, Vijay Kumar B G, Abhishek Aich
...
**Comment:** Matches criterion 3 closely: a new embodied/safety benchmark for fine-grained accident reasoning from driving videos, with a novel angle on responsibility and causal reasoning that prior work often ignored.
**Relevance:** 5
**Novelty:** 6

---

## 6. [DARS: Dual-Level Credit Assignment RL with Structured Reasoning for Instruction-Based Image Editing](https://arxiv.org/abs/2608.20161) <a id="link6"></a>
**ArXiv ID:** 2608.20161
**Authors:** Haoxiang Cao, Jiajiong Cao, Xuanpu Zhang, Changqian Yu, Chaoqun Wang
...
**Comment:** Matches criterion 2 closely: it explicitly studies a VLM-based planner-renderer pipeline for instruction-based image editing and proposes RL for that multimodal system.
**Relevance:** 5
**Novelty:** 6

---

## 7. [Scale-Separated Conditioning for Style-Encoder-Free Diffusion Stylization](https://arxiv.org/abs/2608.19719) <a id="link7"></a>
**ArXiv ID:** 2608.19719
**Authors:** Jingtao Zhang, Haorui Gao, Youqing Liang, Zeming Liu
...
**Comment:** Matches criterion 4 closely: a diffusion-stylization method built around a style-encoder-free conditioning design, which is a vision foundation model application.
**Relevance:** 5
**Novelty:** 6

---

## 8. [Swift-Image: Exploring the Performance Frontier of Compact Unified Image Generation Models](https://arxiv.org/abs/2608.20334) <a id="link8"></a>
**ArXiv ID:** 2608.20334
**Authors:** Taihang Hu, Zhao Wang, Zuan Gao, Tao Liu, Hao Yan, Zhengze Xu, Yuhang Yu, Yongchao Du, Xingjian Wang, Jun Zheng, Qinye Zhou, Zhengrui Chen, Chao Lin, Yefeng Shen, Zhengtao Wu, Ge Wu, Xiaoli Xu, Denghui Yang, Huayu Zhang, Mingzhou Zhang, Mengting Chen
...
**Comment:** Matches criterion 4 very closely: a compact unified image generation model with text-to-image and image-editing capabilities, i.e. a vision foundation model application.
**Relevance:** 5
**Novelty:** 6

---

## 9. [DPC-Net: Dual-Prior Collaborative Network for All-in-One Image Restoration](https://arxiv.org/abs/2608.20141) <a id="link9"></a>
**ArXiv ID:** 2608.20141
**Authors:** Zhaokun He, Kangbiao Shi, Axi Niu, Jian Jin, Peng Wu, Wei Dong, Qingsen Yan
...
**Comment:** Matches criterion 4 closely: it uses a vision-language model as supervision inside an image restoration method, which is a vision foundation model application.
**Relevance:** 6
**Novelty:** 5

---

## 10. [ArmorOCR: Grounded Adversarial Visual Perception via Observation-Transferred Self-Distillation](https://arxiv.org/abs/2608.20122) <a id="link10"></a>
**ArXiv ID:** 2608.20122
**Authors:** Linhan Cao, Siyuan Li, Jun Lan, Liangbo He, Guannan Li, Xiaolei Huang, Jun Jia, Shuheng Zhou, Huijia Zhu, Weiqiang Wang, Wei Sun
...
**Comment:** Matches criterion 2 very closely: a new multimodal model/training framework for grounded adversarial OCR perception, with a new benchmark for region-aware evaluation.
**Relevance:** 5
**Novelty:** 6

---

## 11. [DIFFCZSL: Compositional Zero-Shot Learning Regularized by Diffusion Representations](https://arxiv.org/abs/2608.19871) <a id="link11"></a>
**ArXiv ID:** 2608.19871
**Authors:** Hangyu Tian, Zhenqi He, Yanghao Wang, Long Chen
...
**Comment:** Matches criterion 4: uses diffusion representations to improve compositional zero-shot learning, which is directly vision-foundation-model adjacent.
**Relevance:** 5
**Novelty:** 6

---

## 12. [Towards Surgical World-Action Modeling: A Preliminary Joint Visual-Trajectory Forecasting for Surgical Motion Planning](https://arxiv.org/abs/2608.20284) <a id="link12"></a>
**ArXiv ID:** 2608.20284
**Authors:** Weiliang Huang, Huanrong Liu, Bob Zhang, Qi Dou, Zhen Chen, Yun Gu, Guy Rosman, Qingbiao Li
...
**Comment:** Matches criterion 3: an embodied/surgical world-action modeling paper focused on joint visual and trajectory forecasting for motion planning.
**Relevance:** 5
**Novelty:** 6

---

## 13. [Ultra-High-Definition Restoration Transformers with Correlation Matching Transformation](https://arxiv.org/abs/2608.20263) <a id="link13"></a>
**ArXiv ID:** 2608.20263
**Authors:** Cong Wang, Liyan Wang, Jinshan Pan, Wei Wang, Wenqi Ren, Jun Liu, Xiaochun Cao
...
**Comment:** Matches criterion 4 closely: a Transformer-based ultra-high-definition image restoration framework, fitting vision foundation model applications.
**Relevance:** 5
**Novelty:** 5

---

## 14. [Inter-X++: A Comprehensive Benchmark for Multimodal Human-Human Interaction Analysis](https://arxiv.org/abs/2608.20312) <a id="link14"></a>
**ArXiv ID:** 2608.20312
**Authors:** Liang Xu, Chengqun Yang, Zili Lin, Xintao Lv, Yichao Yan, Xin Jin, Zhibo Chen, Xiaokang Yang, Wenjun Zeng
...
**Comment:** Matches criterion 4 and partly criterion 2: a new benchmark plus unified model for multimodal human-human interaction analysis with generative and perceptive tasks.
**Relevance:** 4
**Novelty:** 6

---

## 15. [Unwarping the Lens: A Physics-Grounded Approach to Video Glasses Removal](https://arxiv.org/abs/2608.20212) <a id="link15"></a>
**ArXiv ID:** 2608.20212
**Authors:** Radim Spetlik, David Futschik, Radek Danecek, Feitong Tan, Ziqian Bai, Rohit Pandey, Yinda Zhang
...
**Comment:** Matches criterion 4: a physics-grounded video restoration/editing method that leverages a vision foundation model (DINOv2) and generative priors.
**Relevance:** 4
**Novelty:** 6

---

## 16. [TextRefine: Improving Textual Fidelity, Spatial Placement, and Glyph Rendering for Text Editing in Product Posters](https://arxiv.org/abs/2608.19637) <a id="link16"></a>
**ArXiv ID:** 2608.19637
**Authors:** Honglie Wang, Jia Sun, Zijun Li, Junlong Wu, Pengcheng Wei, Jiyuan Wang, Yongrui Heng, Boheng Zhang, Huaiqing Wang, Dewen Fan, Qianqian Gan, Fan Yang, Tingting Gao, Yan-Ming Zhang
...
**Comment:** Matches criterion 4 very closely: a vision-based image editing method with a new dataset and post-training framework for text fidelity and spatial placement in product posters.
**Relevance:** 5
**Novelty:** 5

---

## 17. [Break It Down, Pass It On: Cross-Task Skill Transfer in LLM Agents](https://arxiv.org/abs/2608.20274) <a id="link17"></a>
**ArXiv ID:** 2608.20274
**Authors:** Yiyang Feng, Biddut Sarker Bijoy, Niranjan Balasubramanian, Jiawei Zhou
...
**Comment:** No very close match to criteria 1-4; it is mainly an analysis of cross-task skill transfer in LLM agents, which is adjacent to embodied/agentic learning but not an embodied AI benchmark or a new VLLM/MLLM method.
**Relevance:** 3
**Novelty:** 6

---

## 18. [RIPE++: Reinforced Keypoint Learning from Positive Pairs Only](https://arxiv.org/abs/2608.19693) <a id="link18"></a>
**ArXiv ID:** 2608.19693
**Authors:** Johannes K\"unzel, Peter Eisert, Anna Hilsmann
...
**Comment:** Matches criterion 4 loosely: a new learning method for sparse keypoints and matching, relevant to vision foundation-style geometric representations.
**Relevance:** 4
**Novelty:** 5

---

## 19. [Unified and Efficient Point-Line Local Features](https://arxiv.org/abs/2608.19894) <a id="link19"></a>
**ArXiv ID:** 2608.19894
**Authors:** Fran\c{c}ois Costa, Raphael Kreft, Eckhard Goedeke, Felix M\"oller, Hardik Shah, Ramanathan Rajaraman, Shaohui Liu, R\'emi Pautrat, Marc Pollefeys
...
**Comment:** Matches criterion 4: a vision feature extractor for point-line local features, useful for downstream geometric vision and foundation-style feature extraction.
**Relevance:** 4
**Novelty:** 5

---

## 20. [PL-NBA: A Possession-level Universal Basketball Video Dataset Supporting Multiple Visual Understanding Tasks](https://arxiv.org/abs/2608.19646) <a id="link20"></a>
**ArXiv ID:** 2608.19646
**Authors:** Yunhao Zhao, Haoying Sun, Jiarui Li, Zhuming Wang, Ya Jing, Xiangbo Shu, Lifang Wu, Changwen Chen
...
**Comment:** Matches criterion 3 loosely: it introduces a new benchmark/dataset for basketball video understanding, though it is not simulator-related embodied AI.
**Relevance:** 4
**Novelty:** 4

---

## 21. [HandMvNet: Real-Time 3D Hand Pose Estimation Using Multi-View Cross-Attention Fusion](https://arxiv.org/abs/2608.20093) <a id="link21"></a>
**ArXiv ID:** 2608.20093
**Authors:** Muhammad Asad Ali, Nadia Robertini, Didier Stricker
...
**Comment:** Matches criterion 3 partially: an embodied/3D perception method for real-time hand pose estimation from multi-view inputs, but it is not a benchmark or novel embodied-agent angle.
**Relevance:** 3
**Novelty:** 4
