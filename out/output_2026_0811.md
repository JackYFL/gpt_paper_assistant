# Personalized Daily ArXiv Papers 08/11/2026
...
0. [VLZip: Unified Visual and Textual Compression for Interleaved Long-Context Modeling](#link0)
**Authors:** Yuqi Zhang, Cheng Chen, Yuyu Guo, Wenjie Yang, Lingchen Meng, Peng Di, Hang Yu, Zuxuan Wu, Yu-Gang Jiang

1. [CAP: A Scalable Benchmark for Evaluating Cross-Site Browser Agents with Complex Actions and Perception](#link1)
...
2. [Towards Expert-level Medical AI for Real-time Video Consultations](#link2)
**Authors:** Mahvish Nagda, Jihyeon Lee, Matthew Thompson, Chunjong Park, Tim Strother, Valentin Li\'evin, Roma Ruparel, Akshay Goel, Teya Bergamaschi, Suhana Bedi, Meet Shah, Pavel Dubov, Liviu Panait, Toshiyuki Fukuzawa, Sam Schmidgall, Craig Schiff, Joseph Xu, Aliya Rysbek, Yana Lunts, Jan Freyberg, Rebecca Hemengway, Sunny Virmani, David Racz, Carey Radebaugh, Jo\"elle Barral, Kavi Goel, Dale R. Webster, Katherine Chou, Avinatan Hassidim, Yossi Matias, James Manyika, Gregory Wayne, Tao Tu, Yun Liu, Ethan Goh, Christina Chen, Ryutaro Tanno, Po-Hsuan Cameron Chen, Mike Schaekermann, Anil Palepu

3. [Multi-Submap Implicit Neural SLAM with Local-to-Global Loop Closure for Large-Scale Scene Reconstruction](#link3)
**Authors:** Tianchen Deng, Chongdi Wang, Nailin Wang, Lei Zhao, Ziqi Ma, Tianjun Zhang, Zhe Liu, Danwei Wang, Hesheng Wang

4. [Agentic AI-powered flexible fiber-bundle endoscopy for high-resolution NIR-II fluorescence imaging in vivo](#link4)
...
5. [SignLlama: Enhancing Gloss-free Sign Language Translation by Prioritizing Visual Features for LLMs](#link5)
**Authors:** Shiwei Gan, Xiao Liu, Yafeng Yin, Zhiwei Jiang, Bowen Guo, Lie Xie, Sanglu Lu, Hongkai Wen

6. [VideoVIBE: A Video-Grounded Diagnostic Benchmark for One-Shot Interactive Website Generation](#link6)
**Authors:** Jiajun Xu, Yanghao Zhou, Jingyun Liao, Yu Bai, Jinxing Zhou, Chengliang Liu, Changsen Yuan, Bo Wang, Qian Liu

7. [Wiener Representation Filtering for VLM Hallucination Suppression](#link7)
**Authors:** Ameen Ali, Tamim Zoabi, Lidor Brami, Lior Wolf

8. [LAVE: Latent Visual Evidence-Enhanced Planning for Video Tool-use Agents](#link8)
**Authors:** Zijian Wang, Junnan Zhu, Rongzhen Li, Xiao Liu, Guohui Xiang, Quan Lu, Lijia Liu, Yining Wang, Jiang Zhong, Kaiwen Wei

9. [DSLE: A Learning Environment for Dark Souls Boss Encounters](#link9)
**Authors:** Derin Gezgin, Jim O'Connor, Tanner Goodwin, Gary B. Parker

10. [SC-Diff: Semantically Calibrated Diffusion for Visible-to-Infrared Image Translation](#link10)
**Authors:** Junyin Zhang, Siyu Huang, Jianxiong Ye, Haowei Gong, Ruicheng Zhang, Deyu Meng, Chenqiang Gao

11. [A Structural Dynamics Graph World Model: Unified Modeling, Constrained Rollout, and Interpretable Calibration](#link11)
**Authors:** Wei Wang, Yaosen Chen, Han Yang, Yuegen Liu, Mingli Luo, Xinxin Jiao, Xuming Wen, Ming Liu

12. [Improving Generalization Robustness of Multimodal RLVR](#link12)
...
13. [DocPure: Prompt-Free Unified Document Restoration via Degradation-Aware Structure-Guided Wavelet Modulation](#link13)
**Authors:** Lingming Su (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China), Wanglong Lu (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China, AI Analytics Team, Nasdaq, St. John's, Canada), Tao Wang (vivo Mobile Communication Co., Ltd, Shanghai, China), Kaihao Zhang (College of Engineering and Computer Science, The Australian National University, Canberra, Australia), Nan Zhang (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China), Liyan An (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China), Hanli Zhao (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China)

14. [Emotion in an active inference model of human driving](#link14)
**Authors:** Julian F. Schumann, Johan Engstr\"om, Ran Wei, Jens Kober, Martijn Wisse, Arkady Zgonnikov

---
## 0. [VLZip: Unified Visual and Textual Compression for Interleaved Long-Context Modeling](https://arxiv.org/abs/2608.08630) <a id="link0"></a>
**ArXiv ID:** 2608.08630
**Authors:** Yuqi Zhang, Cheng Chen, Yuyu Guo, Wenjie Yang, Lingchen Meng, Peng Di, Hang Yu, Zuxuan Wu, Yu-Gang Jiang
...
**Comment:** Matches criterion 2 strongly: it proposes a new multimodal long-context model for interleaved image-text sequences and also adds a benchmark for long multimodal reasoning.
**Relevance:** 8
**Novelty:** 7

---

## 1. [CAP: A Scalable Benchmark for Evaluating Cross-Site Browser Agents with Complex Actions and Perception](https://arxiv.org/abs/2608.08392) <a id="link1"></a>
**ArXiv ID:** 2608.08392
**Authors:** Zejun Xu, Taiyi Chen, Jin Li, Yongtong Gu, Qi Cheng, Aixuan Lv, Shuai Zhu, Pengfei Zhu, Kaichen Yang, Boyu Sun, Yixian Yang, Mulong Xie, Xin Liu, Dagang Li, Xiaoteng Ma, Hongru Wang
...
**Comment:** Matches criterion 3 very closely: it introduces a new benchmark for browser agents with complex perception-heavy cross-site actions, a simulator-like evaluation setting that exposes overlooked web interaction difficulty.
**Relevance:** 8
**Novelty:** 6

---

## 2. [Towards Expert-level Medical AI for Real-time Video Consultations](https://arxiv.org/abs/2608.09861) <a id="link2"></a>
**ArXiv ID:** 2608.09861
**Authors:** Mahvish Nagda, Jihyeon Lee, Matthew Thompson, Chunjong Park, Tim Strother, Valentin Li\'evin, Roma Ruparel, Akshay Goel, Teya Bergamaschi, Suhana Bedi, Meet Shah, Pavel Dubov, Liviu Panait, Toshiyuki Fukuzawa, Sam Schmidgall, Craig Schiff, Joseph Xu, Aliya Rysbek, Yana Lunts, Jan Freyberg, Rebecca Hemengway, Sunny Virmani, David Racz, Carey Radebaugh, Jo\"elle Barral, Kavi Goel, Dale R. Webster, Katherine Chou, Avinatan Hassidim, Yossi Matias, James Manyika, Gregory Wayne, Tao Tu, Yun Liu, Ethan Goh, Christina Chen, Ryutaro Tanno, Po-Hsuan Cameron Chen, Mike Schaekermann, Anil Palepu
...
**Comment:** Matches criterion 2 very closely: it presents a new multimodal large language model system for real-time video consultations with audio-visual perception.
**Relevance:** 9
**Novelty:** 5

---

## 3. [Multi-Submap Implicit Neural SLAM with Local-to-Global Loop Closure for Large-Scale Scene Reconstruction](https://arxiv.org/abs/2608.09146) <a id="link3"></a>
**ArXiv ID:** 2608.09146
**Authors:** Tianchen Deng, Chongdi Wang, Nailin Wang, Lei Zhao, Ziqi Ma, Tianjun Zhang, Zhe Liu, Danwei Wang, Hesheng Wang
...
**Comment:** Matches criterion 3 very closely: it is an embodied/robotic SLAM method with a new large-scale neural mapping and loop-closure framework, plus a benchmarked real-world reconstruction setting. It also touches criterion 4 through the use of a foundation model for global descriptor extraction.
**Relevance:** 7
**Novelty:** 6

---

## 4. [Agentic AI-powered flexible fiber-bundle endoscopy for high-resolution NIR-II fluorescence imaging in vivo](https://arxiv.org/abs/2608.08402) <a id="link4"></a>
**ArXiv ID:** 2608.08402
**Authors:** Yanzhao Shi, Yuanhua Liu, Sixin Xu, Wayne Jason Li, Yuyuan Chen, Danyang Xu, Zhisheng Wu, Hanze Yu, Ian Yu-Hong Wong, Simon Ying-Kit Law, Hongjie Dai, Liangqiong Qu, Feifei Wang
...
**Comment:** Matches criterion 4 closely: it combines a vision-language model with an AI-guided restoration pipeline for a biomedical imaging platform, showing a practical application of foundation models.
**Relevance:** 7
**Novelty:** 6

---

## 5. [SignLlama: Enhancing Gloss-free Sign Language Translation by Prioritizing Visual Features for LLMs](https://arxiv.org/abs/2608.09006) <a id="link5"></a>
**ArXiv ID:** 2608.09006
**Authors:** Shiwei Gan, Xiao Liu, Yafeng Yin, Zhiwei Jiang, Bowen Guo, Lie Xie, Sanglu Lu, Hongkai Wen
...
**Comment:** Matches criterion 2 closely: this is an LLM-based sign language translation method that explicitly adapts the model to prioritize visual inputs.
**Relevance:** 8
**Novelty:** 5

---

## 6. [VideoVIBE: A Video-Grounded Diagnostic Benchmark for One-Shot Interactive Website Generation](https://arxiv.org/abs/2608.09573) <a id="link6"></a>
**ArXiv ID:** 2608.09573
**Authors:** Jiajun Xu, Yanghao Zhou, Jingyun Liao, Yu Bai, Jinxing Zhou, Chengliang Liu, Changsen Yuan, Bo Wang, Qian Liu
...
**Comment:** Strong match to criterion 2: it introduces a video-grounded benchmark and evaluation system for one-shot interactive website generation, directly involving Video MLLMs.
**Relevance:** 6
**Novelty:** 7

---

## 7. [Wiener Representation Filtering for VLM Hallucination Suppression](https://arxiv.org/abs/2608.08167) <a id="link7"></a>
**ArXiv ID:** 2608.08167
**Authors:** Ameen Ali, Tamim Zoabi, Lidor Brami, Lior Wolf
...
**Comment:** Matches criterion 2 moderately well: it studies hallucination suppression in vision-language models with a clever post-hoc statistical filtering trick, though it is not a new model architecture or benchmark.
**Relevance:** 6
**Novelty:** 6

---

## 8. [LAVE: Latent Visual Evidence-Enhanced Planning for Video Tool-use Agents](https://arxiv.org/abs/2608.07585) <a id="link8"></a>
**ArXiv ID:** 2608.07585
**Authors:** Zijian Wang, Junnan Zhu, Rongzhen Li, Xiao Liu, Guohui Xiang, Quan Lu, Lijia Liu, Yining Wang, Jiang Zhong, Kaiwen Wei
...
**Comment:** Closest to criterion 2 and somewhat 3: it is a new video tool-use agent method built around latent visual evidence, which is relevant to MLLM-style video agents.
**Relevance:** 5
**Novelty:** 7

---

## 9. [DSLE: A Learning Environment for Dark Souls Boss Encounters](https://arxiv.org/abs/2608.09902) <a id="link9"></a>
**ArXiv ID:** 2608.09902
**Authors:** Derin Gezgin, Jim O'Connor, Tanner Goodwin, Gary B. Parker
...
**Comment:** Matches criterion 3: this is a new embodied-AI benchmark/environment built around Dark Souls boss encounters, with careful evaluation of several agents in a simulator-style setting.
**Relevance:** 6
**Novelty:** 5

---

## 10. [SC-Diff: Semantically Calibrated Diffusion for Visible-to-Infrared Image Translation](https://arxiv.org/abs/2608.08555) <a id="link10"></a>
**ArXiv ID:** 2608.08555
**Authors:** Junyin Zhang, Siyu Huang, Jianxiong Ye, Haowei Gong, Ruicheng Zhang, Deyu Meng, Chenqiang Gao
...
**Comment:** Strong match to criterion 4: it uses a pretrained SAM3 vision foundation model and adapts it for visible-to-infrared image translation with semantic calibration.
**Relevance:** 5
**Novelty:** 6

---

## 11. [A Structural Dynamics Graph World Model: Unified Modeling, Constrained Rollout, and Interpretable Calibration](https://arxiv.org/abs/2608.08689) <a id="link11"></a>
**ArXiv ID:** 2608.08689
**Authors:** Wei Wang, Yaosen Chen, Han Yang, Yuegen Liu, Mingli Luo, Xinxin Jiao, Xuming Wen, Ming Liu
...
**Comment:** Partial fit to criterion 1 in a broad sense: it proposes a structural dynamics graph world model with spatiotemporal state evolution, but it is not specifically embodied AI.
**Relevance:** 4
**Novelty:** 7

---

## 12. [Improving Generalization Robustness of Multimodal RLVR](https://arxiv.org/abs/2608.08802) <a id="link12"></a>
**ArXiv ID:** 2608.08802
**Authors:** Pengfei Zhou, Zhiwei Tang, Xiaopeng Peng, Chenrui Zhou, Lama Moukheiber, Yixing Ma, Bin Xu, Jiajun Song, Zhenglin Wan, Wangbo Zhao, Jiasheng Tang, Bohan Zhuang, Fan Wang, Yang You
...
**Comment:** Somewhat related to criterion 2: it is a multimodal RLVR post-training method for MLLMs, but it is not a new MLLM architecture or benchmark.
**Relevance:** 4
**Novelty:** 6

---

## 13. [DocPure: Prompt-Free Unified Document Restoration via Degradation-Aware Structure-Guided Wavelet Modulation](https://arxiv.org/abs/2608.09536) <a id="link13"></a>
**ArXiv ID:** 2608.09536
**Authors:** Lingming Su (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China), Wanglong Lu (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China, AI Analytics Team, Nasdaq, St. John's, Canada), Tao Wang (vivo Mobile Communication Co., Ltd, Shanghai, China), Kaihao Zhang (College of Engineering and Computer Science, The Australian National University, Canberra, Australia), Nan Zhang (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China), Liyan An (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China), Hanli Zhao (College of Computer Science and Artificial Intelligence, Wenzhou University, Wenzhou, China)
...
**Comment:** Matches criterion 4 moderately well: it is a document restoration method, but the connection to vision foundation models is indirect and the main contribution is a restoration architecture rather than a foundation-model application.
**Relevance:** 4
**Novelty:** 5

---

## 14. [Emotion in an active inference model of human driving](https://arxiv.org/abs/2608.07480) <a id="link14"></a>
**ArXiv ID:** 2608.07480
**Authors:** Julian F. Schumann, Johan Engstr\"om, Ran Wei, Jens Kober, Martijn Wisse, Arkady Zgonnikov
...
**Comment:** Matches criterion 3 only loosely: embodied driving with active inference, but it is mainly an affect/emotion modeling paper rather than a new embodied benchmark or spatial intelligence method.
**Relevance:** 3
**Novelty:** 4
