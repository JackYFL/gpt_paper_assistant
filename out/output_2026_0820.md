...
0. [USR-Drive: Unified Driving Scene Representation via Joint Denoising of 3D Gaussians and Boxes](#link0)
...
1. [StateTrace: An Object-Centric Framework for Hidden-State Spatiotemporal Reasoning in Long Videos](#link1)
**Authors:** Yu Han, Wenhao Li, Yichao Cao, Hongyan Xu, Shuo Yang, Shan You, Xiu Su

2. [GrabVG: Graph-Attentive Binding for Visual Grounding in UAV Imagery](#link2)
**Authors:** Chaowei Wang, Yan Di, Jingjun Sun, Baozhe Liu, Jiaxu Tian, Yuheng Li, Guangqian Guo, Shan Gao

3. [From Inference to Adaptation: A Unified Optimal Transport View of Vision Language Model](#link3)
...
4. [ReX-Shot: Single-Image Rephotography via Geometry- and Camera-Grounded Generation](#link4)
**Authors:** Ruiqi Zhang, Hao Zhu, Wenhao Zhang, Qi Zhang, Junqi Shi, Ming Lu, Xun Cao, Zhan Ma

5. [Breaking the weakest link to evade vision language models](#link5)
**Authors:** Ilan Zini, Boussad Addad, Katarzyna Kapusta

6. [Frozen DINO Localizes Image Edits Without a Localizer](#link6)
**Authors:** Zane Kumar, Vishal Jain, Bernhard Kainz

7. [TTSD-FAR: Test-Time Self-Distillation with Fisher-Anchored Restoration for Missing-Modality Emotion Recognition in LVLMs](#link7)
**Authors:** Muhammad Haseeb Aslam, Alessandro Koerich, Marco Pedersoli, Ali Etemad, Eric Granger

8. [Composed Historical Image Retrieval by Modeling Temporal Representations](#link8)
**Authors:** Adri\`a Molina Rodr\'iguez, Oriol Ramos Terrades, Josep Llad\'os Canet

9. [FM-Bench: A Benchmark for Long-Horizon Management with Competing Agents](#link9)
**Authors:** Tianyou Wang, Chongyang Gao, Kezhen Chen, Chen Dong, Yinghao He, Donghan Li, Wangcheng Xu, Hongjiu Zhang, Chi Li

10. [DocClaw: A Unified Agentic System for Intelligent Document Processing](#link10)
**Authors:** Siqi Xiang, Zhipeng Xu, Yufei Liu, Junhao Ji, Qing Liu, Zulong Chen, Zhibo Yang, Chunyan Miao, Shijian Lu

11. [SkillGate: Training In-Policy Skill Selection in Long-Horizon Agents](#link11)
**Authors:** Qingyao Li, Wenxiang Jiao, Shuai Shao, Kangning Zhang, Yuan Lu, Yi Guo, Weiwen Liu, Weinan Zhang, Yong Yu

12. [CoMVS-GS: Collaborative Multi-View Stereo and 3D Gaussian Splatting for Surface Reconstruction](#link12)
**Authors:** Shihan Chen, Junjing Zhang, Qingsong Yan, Haibing Liu, Haofan Ren, Fei Deng

13. [JSL-DC: A Word-Level Japanese Sign Language Dataset with Linguist-Derived Descriptions for Distinguishing Confusable Signs](#link13)
...
14. [Teeth2Point: A Two-Stage Dental CBCT ROI-to-Point Segmentation Framework](#link14)
**Authors:** Qi Ma, Shipra Jain, Niko Benjamin Huber, Ender Konukoglu

15. [XRF-to-Optical Field-of-View Localization with Vision Language Models](#link15)
...
---
## 0. [USR-Drive: Unified Driving Scene Representation via Joint Denoising of 3D Gaussians and Boxes](https://arxiv.org/abs/2608.19036) <a id="link0"></a>
**ArXiv ID:** 2608.19036
**Authors:** Li-Heng Chen, Haokai Pang, Chengye Su, Jiarun Liu, Qifeng Chen, Ziqian Ni, Jianxin Huang, Shi-Sheng Huang, Hongbo Fu, Sheng Yang
...
**Comment:** Matches criterion 1 very closely: it proposes a unified spatial representation for autonomous driving, jointly denoising 3D Gaussians and 3D boxes for scene understanding.
**Relevance:** 8
**Novelty:** 7

---

## 1. [StateTrace: An Object-Centric Framework for Hidden-State Spatiotemporal Reasoning in Long Videos](https://arxiv.org/abs/2608.18532) <a id="link1"></a>
**ArXiv ID:** 2608.18532
**Authors:** Yu Han, Wenhao Li, Yichao Cao, Hongyan Xu, Shuo Yang, Shan You, Xiu Su
...
**Comment:** Matches criterion 1 closely: it proposes a new method for hidden-state spatiotemporal reasoning in long videos, an object-centric reasoning framework for VideoLLMs.
**Relevance:** 7
**Novelty:** 7

---

## 2. [GrabVG: Graph-Attentive Binding for Visual Grounding in UAV Imagery](https://arxiv.org/abs/2608.18996) <a id="link2"></a>
**ArXiv ID:** 2608.18996
**Authors:** Chaowei Wang, Yan Di, Jingjun Sun, Baozhe Liu, Jiaxu Tian, Yuheng Li, Guangqian Guo, Shan Gao
...
**Comment:** Matches criterion 1 closely: it targets spatial understanding / visual grounding in UAV imagery with explicit graph-based spatial reasoning.
**Relevance:** 7
**Novelty:** 6

---

## 3. [From Inference to Adaptation: A Unified Optimal Transport View of Vision Language Model](https://arxiv.org/abs/2608.18339) <a id="link3"></a>
**ArXiv ID:** 2608.18339
**Authors:** Qi Yu, Zhichen Zeng, Katherine Tieu, Xiyuan Yang, Ruizhong Qiu, Yuchen Yan, Lihui Liu, Yanjun Zhao, Lingjie Chen, Jingrui He, Hanghang Tong
...
**Comment:** Matches criterion 2, and also fits criterion 4 somewhat closely: it proposes a new VLM test-time adaptation method with an explicit OT-based inference/adaptation formulation.
**Relevance:** 5
**Novelty:** 7

---

## 4. [ReX-Shot: Single-Image Rephotography via Geometry- and Camera-Grounded Generation](https://arxiv.org/abs/2608.18593) <a id="link4"></a>
**ArXiv ID:** 2608.18593
**Authors:** Ruiqi Zhang, Hao Zhu, Wenhao Zhang, Qi Zhang, Junqi Shi, Ming Lu, Xun Cao, Zhan Ma
...
**Comment:** Matches criterion 4 very closely: it uses foundation-model features and a generative 3D-aware backbone for camera- and geometry-grounded image synthesis.
**Relevance:** 6
**Novelty:** 6

---

## 5. [Breaking the weakest link to evade vision language models](https://arxiv.org/abs/2608.18938) <a id="link5"></a>
**ArXiv ID:** 2608.18938
**Authors:** Ilan Zini, Boussad Addad, Katarzyna Kapusta
...
**Comment:** Matches criterion 2 very closely: it studies adversarial vulnerability of vision-language models and attacks modern open-source VLMs.
**Relevance:** 7
**Novelty:** 5

---

## 6. [Frozen DINO Localizes Image Edits Without a Localizer](https://arxiv.org/abs/2608.18968) <a id="link6"></a>
**ArXiv ID:** 2608.18968
**Authors:** Zane Kumar, Vishal Jain, Bernhard Kainz
...
**Comment:** Matches criterion 4 very closely: it shows a surprising application of a frozen vision foundation model (DINO) for edit localization without a dedicated localizer.
**Relevance:** 6
**Novelty:** 6

---

## 7. [TTSD-FAR: Test-Time Self-Distillation with Fisher-Anchored Restoration for Missing-Modality Emotion Recognition in LVLMs](https://arxiv.org/abs/2608.18386) <a id="link7"></a>
**ArXiv ID:** 2608.18386
**Authors:** Muhammad Haseeb Aslam, Alessandro Koerich, Marco Pedersoli, Ali Etemad, Eric Granger
...
**Comment:** Matches criterion 2 closely: it studies a multimodal large video-language model setting and proposes a test-time adaptation/restoration method for missing modalities.
**Relevance:** 5
**Novelty:** 6

---

## 8. [Composed Historical Image Retrieval by Modeling Temporal Representations](https://arxiv.org/abs/2608.18694) <a id="link8"></a>
**ArXiv ID:** 2608.18694
**Authors:** Adri\`a Molina Rodr\'iguez, Oriol Ramos Terrades, Josep Llad\'os Canet
...
**Comment:** Matches criterion 4 moderately well: it learns temporally decomposable representations for composed image retrieval, a vision foundation-model-style representation learning application.
**Relevance:** 5
**Novelty:** 6

---

## 9. [FM-Bench: A Benchmark for Long-Horizon Management with Competing Agents](https://arxiv.org/abs/2608.18423) <a id="link9"></a>
**ArXiv ID:** 2608.18423
**Authors:** Tianyou Wang, Chongyang Gao, Kezhen Chen, Chen Dong, Yinghao He, Donghan Li, Wangcheng Xu, Hongjiu Zhang, Chi Li
...
**Comment:** No very close match to criteria 1-4; it is a long-horizon agent benchmark, but the setting is football management rather than embodied AI or spatial intelligence.
**Relevance:** 3
**Novelty:** 6

---

## 10. [DocClaw: A Unified Agentic System for Intelligent Document Processing](https://arxiv.org/abs/2608.18685) <a id="link10"></a>
**ArXiv ID:** 2608.18685
**Authors:** Siqi Xiang, Zhipeng Xu, Yufei Liu, Junhao Ji, Qing Liu, Zulong Chen, Zhibo Yang, Chunyan Miao, Shijian Lu
...
**Comment:** Matches criterion 3 closely: it is a new benchmark-like agentic system for intelligent document processing with a shared state/action loop, though the focus is documents rather than embodied AI.
**Relevance:** 4
**Novelty:** 5

---

## 11. [SkillGate: Training In-Policy Skill Selection in Long-Horizon Agents](https://arxiv.org/abs/2608.18852) <a id="link11"></a>
**ArXiv ID:** 2608.18852
**Authors:** Qingyao Li, Wenxiang Jiao, Shuai Shao, Kangning Zhang, Yuan Lu, Yi Guo, Weiwen Liu, Weinan Zhang, Yong Yu
...
**Comment:** No close match to criteria 1-4; it is an agentic skill-selection training method, but not specifically embodied spatial intelligence or benchmark building.
**Relevance:** 3
**Novelty:** 6

---

## 12. [CoMVS-GS: Collaborative Multi-View Stereo and 3D Gaussian Splatting for Surface Reconstruction](https://arxiv.org/abs/2608.18413) <a id="link12"></a>
**ArXiv ID:** 2608.18413
**Authors:** Shihan Chen, Junjing Zhang, Qingsong Yan, Haibing Liu, Haofan Ren, Fei Deng
...
**Comment:** No close match to criteria 1-4; this is a multi-view stereo plus 3D Gaussian splatting reconstruction method, relevant to 3D vision but not the target embodied/VLM themes.
**Relevance:** 3
**Novelty:** 5

---

## 13. [JSL-DC: A Word-Level Japanese Sign Language Dataset with Linguist-Derived Descriptions for Distinguishing Confusable Signs](https://arxiv.org/abs/2608.18412) <a id="link13"></a>
**ArXiv ID:** 2608.18412
**Authors:** Ken Takaki, Asuka Ando, Misa Suzuki, Uiko Yano, Masaya Tsujimoto, Bill Neubauer, Ananay Vikram Gupta, Rose Shao, Matthias Hoppe, Sahir Shahryar, Celeste Mason, Kai Kunze, Yohei Oseki, Yoshihiro Kawahara, Thad Starner
...
**Comment:** No close match to criteria 1-4; this is a sign-language dataset and recognition paper, relevant to multimodal learning but not to the specific requested themes.
**Relevance:** 3
**Novelty:** 5

---

## 14. [Teeth2Point: A Two-Stage Dental CBCT ROI-to-Point Segmentation Framework](https://arxiv.org/abs/2608.18667) <a id="link14"></a>
**ArXiv ID:** 2608.18667
**Authors:** Qi Ma, Shipra Jain, Niko Benjamin Huber, Ender Konukoglu
...
**Comment:** Matches criterion 4 moderately well: it uses DINO-style self-supervised pretraining as part of a point-token transformer for medical CBCT segmentation.
**Relevance:** 4
**Novelty:** 4

---

## 15. [XRF-to-Optical Field-of-View Localization with Vision Language Models](https://arxiv.org/abs/2608.18309) <a id="link15"></a>
**ArXiv ID:** 2608.18309
**Authors:** Xiangyu Yin, Tatjana Paunesku, Letonia Copeland-Hardin, Martina Ralle, Zichao Wendy Di, Si Chen, Gayle E. Woloschak, Barry Lai, Mathew J. Cherukara, Stefan Vogt
...
**Comment:** Matches criterion 4 weakly: it applies training-free VLMs to cross-modal field-of-view localization, but it is more an application study than a new foundation model or method.
**Relevance:** 3
**Novelty:** 4
