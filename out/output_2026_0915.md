# Personalized Daily ArXiv Papers 09/15/2026
...
0. [PhysBrain 1.5: From Vision-Language Models to Physical Foundation Models](#link0)
...
1. [DiVA: Enabling Interactive Digital Life Simulation via Video Models](#link1)
...
2. [VisInteract: Towards Dynamic Interactive Text-to-Visualization under Imperfect Queries](#link2)
**Authors:** Wenxin Xu, Jinwei Lu, Hwanhee Kim, Chen Jason Zhang, Xiao-Yong Wei, Haoyang Li, Yuanfeng Song

3. [Concept-Grounded Reasoning with Prompt-Driven Localization for Interpretable Structured Report Generation](#link3)
**Authors:** Xinyue Xu, Hongbin Lin, Juangui Xu, Hualiang Wang, Lehan Wang, Lijie Hu, Weiyang Liu, Adrian Weller, Xiaomeng Li

4. [ConeGaussian: Anti-Aliased Gaussian Ray-Tracing for Generic Central Cameras](#link4)
**Authors:** Deheng Zhang, Letian Shi, Runyi Yang, Zhendong Li, Lei Sun, Kanzhi Wu, Ajad Chhatkuli, Danda Pani Paudel, Luc Van Gool

5. [Selective Tool Use for Agentic Change Visual Question Answering in Remote Sensing](#link5)
**Authors:** Yakoub Bazi, Mohamad M. Al Rahhal, Mohamed A. Mekhtiche, Mansour Zuair

6. [Hyper-LLaVA: Hyperbolic Uncertainty-aware Modality-Balanced Routing for Multimodal Continual Instruction Tuning](#link6)
**Authors:** Kunlun Xu, Yanqin Zhang, Wenwen Qiang, Jiahuan Zhou

7. [Realtime-Venus: A full-duplex interaction system with asynchronous delegation](#link7)
...
8. [DNF-SR: Dual-Input and Negative-Aware Feature Fine-Tuning for Real-World Image Super-Resolution](#link8)
**Authors:** Shuhao Han, Wenjie Liao, Hayden Vance, Hang Dong, Rui Zhang, Chun-Le Guo, Chongyi Li

9. [Beyond Natural Images: Rethinking AI-Generated Image Detection in Documents](#link9)
**Authors:** Zhangjie Fu, Jiazhen Yan, Yuanwen Chen, Xinquan Yu, Yanzhe Li, Hui Jiang, Lei Gao, Chenfu Bao

10. [LIMODENet: Attention-Free Compact Encoders for Information-Preserving Onboard Satellite Image Restoration](#link10)
**Authors:** Thanh-Dung Le, Vu Nguyen Ha, Ti Ti Nguyen, Symeon Chatzinotas

11. [TryOnReward: Learning Foveated Consistency for Reinforcement Fine-Tuning of Virtual Try-On](#link11)
**Authors:** Xueheng Li, Yong Liu, Xiaolong Fu, Wen Xue, Chengjun Xie, Yipeng Sun, Yan Li, Simiu Gu

12. [Beyond Accuracy: Robustness, Cost, and Governance Trade-offs for Vision-Language Models in Templated Document Extraction](#link12)
**Authors:** Kushal Patel, Pushkal Shrivastava, Mackenzie Lees, Qirui Lu, Bhargobjyoti Saikia, Liying Li, Junlin Jiang

13. [From Density to Biopsy Decisions and Malignancy Prediction: A Benchmark Study of Multimodal Large Language Models Against Radiologists in Digital and Contrast-Enhanced Mammography](#link13)
...
14. [CWM: Controllable White-Box Meta-Prompting for Adaptive Retrieval-Augmented Generation and Reasoning Ability](#link14)
**Authors:** Keuntae Kim, Eunhye Jeong, Yong Suk Choi

15. [Robust Multi-Model Fitting through Learning Neighbor Regions](#link15)
**Authors:** Chang Nie, Guangming Wang, Zhe Liu, Hesheng Wang

16. [MoVT: Video-Augmented Motion Tokenizer for Text-to-Motion Generation](#link16)
**Authors:** Beibei Jing, Tianle Guo, Youjia Zhang, Zikai Song, Yawei Luo, Junqing Yu, Tao Guan, Wei Yang

17. [PACE: Progressive Angular-to-Norm Contrastive Embedding](#link17)
**Authors:** Yanping Li, Wei Zhou, Yawen Liu, Yibo Wang, Ke Zhu, Guangda Huzhang, Qing-Guo Chen, Zhao Xu, Jun Zhang, Wei Wei

---
## 0. [PhysBrain 1.5: From Vision-Language Models to Physical Foundation Models](https://arxiv.org/abs/2609.14973) <a id="link0"></a>
**ArXiv ID:** 2609.14973
**Authors:** DeepCybo Team, Yu Bin, Haipeng Cao, Zheng Chang, Kai Chen, Youning Chen, Kailin Deng, Yichao Du, Xiaotong Fu, Haoyang Ge, Yunlong Guo, Chenliu Hao, Jiyan He, Xuguo He, Yakun Hou, Kai Hu, Cong Huang, Tuopusen Huang, Yu Huang, Hong Li, Peize Li, Shijie Lian, Xiaopeng Lin, Yun Lin, Haibao Liu, Haochen Liu, Qiuzhi Liu, Shengcai Liu, Zhiqiang Liu, Tao Luo, Peng Ren, Shuo Ren, Chaoyi Ruan, Zhaolong Shen, Yukun Shi, Qiyuan Su, Yuxuan Tian, Yining Wang, Changti Wu, Hao Wu, Xueyin Xu, Ruoqi Yang, Zhaoyang Yang, Hang Yuan, Zhaoyang Zeng, Hanwen Zhang, Ruimeng Zhang, Yao Zhang, Yibo Zhang, Yuxiang Zhang, Zhirui Zhang, Ziyi Zhang, Zubin Zheng, Zishen Zhuang
...
**Comment:** Matches criterion 1 and 4 very closely: it is a physical foundation model built from a vision-language model, aimed at understanding physical environments, generating actions, and predicting future states for embodied settings.
**Relevance:** 8
**Novelty:** 8

---

## 1. [DiVA: Enabling Interactive Digital Life Simulation via Video Models](https://arxiv.org/abs/2609.13830) <a id="link1"></a>
**ArXiv ID:** 2609.13830
**Authors:** Cheng Chen, Hao Ouyang, Qiuyu Wang, Ka Leong Cheng, Wen Wang, Yihao Meng, Hanlin Wang, Yixuan Li, Jiacheng Wei, Zhenshan Tan, Yanhong Zeng, Yujun Shen, Guosheng Lin, Fayao Liu
...
**Comment:** Matches criterion 3 very closely: it is an embodied/digital-life simulation system built around an MLLM router and interactive video generation, with explicit focus on long-term simulation, spatial grounding, and stable transitions.
**Relevance:** 8
**Novelty:** 7

---

## 2. [VisInteract: Towards Dynamic Interactive Text-to-Visualization under Imperfect Queries](https://arxiv.org/abs/2609.15182) <a id="link2"></a>
**ArXiv ID:** 2609.15182
**Authors:** Wenxin Xu, Jinwei Lu, Hwanhee Kim, Chen Jason Zhang, Xiao-Yong Wei, Haoyang Li, Yuanfeng Song
...
**Comment:** Matches criterion 3 very closely: it builds a new embodied-like benchmark and method for dynamic interactive Text-to-Visualization, with a novel simulator-style user agent and MCTS-based interaction loop that previous work largely ignored.
**Relevance:** 6
**Novelty:** 7

---

## 3. [Concept-Grounded Reasoning with Prompt-Driven Localization for Interpretable Structured Report Generation](https://arxiv.org/abs/2609.15334) <a id="link3"></a>
**ArXiv ID:** 2609.15334
**Authors:** Xinyue Xu, Hongbin Lin, Juangui Xu, Hualiang Wang, Lehan Wang, Lijie Hu, Weiyang Liu, Adrian Weller, Xiaomeng Li
...
**Comment:** Matches criterion 2 and also criterion 1 in a medical-imaging setting: it uses an MLLM with prompt-driven localization and concept-grounded reasoning for spatially grounded report generation.
**Relevance:** 7
**Novelty:** 6

---

## 4. [ConeGaussian: Anti-Aliased Gaussian Ray-Tracing for Generic Central Cameras](https://arxiv.org/abs/2609.13397) <a id="link4"></a>
**ArXiv ID:** 2609.13397
**Authors:** Deheng Zhang, Letian Shi, Runyi Yang, Zhendong Li, Lei Sun, Kanzhi Wu, Ajad Chhatkuli, Danda Pani Paudel, Luc Van Gool
...
**Comment:** Matches criterion 4 closely: this is a vision/rendering method for generic central cameras, improving camera-model-agnostic Gaussian ray tracing with anti-aliasing for distorted and fisheye imagery.
**Relevance:** 6
**Novelty:** 6

---

## 5. [Selective Tool Use for Agentic Change Visual Question Answering in Remote Sensing](https://arxiv.org/abs/2609.14523) <a id="link5"></a>
**ArXiv ID:** 2609.14523
**Authors:** Yakoub Bazi, Mohamad M. Al Rahhal, Mohamed A. Mekhtiche, Mansour Zuair
...
**Comment:** Matches criterion 2 and 3 moderately well: it introduces a tool-augmented VLM pipeline for change VQA in remote sensing, with selective tool use and a new tool-augmented benchmark extension.
**Relevance:** 5
**Novelty:** 6

---

## 6. [Hyper-LLaVA: Hyperbolic Uncertainty-aware Modality-Balanced Routing for Multimodal Continual Instruction Tuning](https://arxiv.org/abs/2609.13742) <a id="link6"></a>
**ArXiv ID:** 2609.13742
**Authors:** Kunlun Xu, Yanqin Zhang, Wenwen Qiang, Jiahuan Zhou
...
**Comment:** Matches criterion 2 closely: Hyper-LLaVA is a multimodal continual instruction-tuning method for an MLLM, with a new routing strategy.
**Relevance:** 5
**Novelty:** 6

---

## 7. [Realtime-Venus: A full-duplex interaction system with asynchronous delegation](https://arxiv.org/abs/2609.13814) <a id="link7"></a>
**ArXiv ID:** 2609.13814
**Authors:** Ruixiang Zhao, Hualei Wang, Renhe Sun, Enzhi Zhou, Jincenzi Wu, Xujie Song, Kexin Shi, Zihang Liu, Pengcheng Zhu, Jiayi Zhou, Baoyue Zhang, Changhao Zhang, Zitong Wang, Jinhong Wang, Tong Niu, Jingjing Liu, Junan Lin, Haolin He, Hengshuo Chu, Yuhui Chen, Jian Liu, Yuge Huang, Junliang Xing, Yuntao Wang, Weiqiang Wang, Chun Yu, Yuanchun Shi
...
**Comment:** Matches criterion 2 reasonably well: it presents an audio-visual interaction model with online video understanding and proactive dialogue, i.e. a VLLM/MLLM-style system.
**Relevance:** 5
**Novelty:** 6

---

## 8. [DNF-SR: Dual-Input and Negative-Aware Feature Fine-Tuning for Real-World Image Super-Resolution](https://arxiv.org/abs/2609.15120) <a id="link8"></a>
**ArXiv ID:** 2609.15120
**Authors:** Shuhao Han, Wenjie Liao, Hayden Vance, Hang Dong, Rui Zhang, Chun-Le Guo, Chongyi Li
...
**Comment:** Matches criterion 4 moderately well: it is a diffusion-model-based image super-resolution method, using generative priors and feature fine-tuning for real-world restoration.
**Relevance:** 5
**Novelty:** 6

---

## 9. [Beyond Natural Images: Rethinking AI-Generated Image Detection in Documents](https://arxiv.org/abs/2609.14352) <a id="link9"></a>
**ArXiv ID:** 2609.14352
**Authors:** Zhangjie Fu, Jiazhen Yan, Yuanwen Chen, Xinquan Yu, Yanzhe Li, Hui Jiang, Lei Gao, Chenfu Bao
...
**Comment:** Matches criterion 4 moderately well: it is a vision foundation model application for AI-generated image detection in document images, with a new benchmark and document-specific analysis.
**Relevance:** 6
**Novelty:** 5

---

## 10. [LIMODENet: Attention-Free Compact Encoders for Information-Preserving Onboard Satellite Image Restoration](https://arxiv.org/abs/2609.14690) <a id="link10"></a>
**ArXiv ID:** 2609.14690
**Authors:** Thanh-Dung Le, Vu Nguyen Ha, Ti Ti Nguyen, Symeon Chatzinotas
...
**Comment:** Matches criterion 4 moderately well: it is a vision restoration backbone for onboard satellite imaging, centered on compact attention-free encoders and deployment-constrained visual foundation-style design choices.
**Relevance:** 5
**Novelty:** 5

---

## 11. [TryOnReward: Learning Foveated Consistency for Reinforcement Fine-Tuning of Virtual Try-On](https://arxiv.org/abs/2609.13259) <a id="link11"></a>
**ArXiv ID:** 2609.13259
**Authors:** Xueheng Li, Yong Liu, Xiaolong Fu, Wen Xue, Chengjun Xie, Yipeng Sun, Yan Li, Simiu Gu
...
**Comment:** No close match to the listed criteria; it is a reward model and benchmark for virtual try-on, which is a multimodal application but not specifically spatial intelligence, embodied AI, or foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 12. [Beyond Accuracy: Robustness, Cost, and Governance Trade-offs for Vision-Language Models in Templated Document Extraction](https://arxiv.org/abs/2609.15706) <a id="link12"></a>
**ArXiv ID:** 2609.15706
**Authors:** Kushal Patel, Pushkal Shrivastava, Mackenzie Lees, Qirui Lu, Bhargobjyoti Saikia, Liying Li, Junlin Jiang
...
**Comment:** Matches criterion 2 only indirectly: it studies vision-language models for document extraction and gives a measurement-grounded evaluation framework, but it is not really about a new VLLM/MLLM or embodiment/spatial understanding.
**Relevance:** 4
**Novelty:** 5

---

## 13. [From Density to Biopsy Decisions and Malignancy Prediction: A Benchmark Study of Multimodal Large Language Models Against Radiologists in Digital and Contrast-Enhanced Mammography](https://arxiv.org/abs/2609.14676) <a id="link13"></a>
**ArXiv ID:** 2609.14676
**Authors:** Ali Abbasian Ardakani, Afshin Mohammadi, Taha Yusuf Kuzan, Beyza Nur Kuzan, Alisa Mohebbi, Masume Behruzi, Hamid Khorshidi, Ashkan Ghorbani, Elham Asadiara, Zeinab Khorshidi Lotfi, Ansar Rahman, Nedim Christoph Beste, U. Rajendra Acharya, Sepideh Hatamikia
...
**Comment:** Matches criterion 2 very closely: it benchmarks multiple MLLMs on mammography tasks and compares them against radiologists.
**Relevance:** 5
**Novelty:** 4

---

## 14. [CWM: Controllable White-Box Meta-Prompting for Adaptive Retrieval-Augmented Generation and Reasoning Ability](https://arxiv.org/abs/2609.15234) <a id="link14"></a>
**ArXiv ID:** 2609.15234
**Authors:** Keuntae Kim, Eunhye Jeong, Yong Suk Choi
...
**Comment:** No close match to criteria 1-4; this is an LLM method for adaptive RAG and reasoning, but not a visual or multimodal model.
**Relevance:** 3
**Novelty:** 6

---

## 15. [Robust Multi-Model Fitting through Learning Neighbor Regions](https://arxiv.org/abs/2609.15348) <a id="link15"></a>
**ArXiv ID:** 2609.15348
**Authors:** Chang Nie, Guangming Wang, Zhe Liu, Hesheng Wang
...
**Comment:** No very close match to the criteria; it is a computer vision optimization method for multi-model fitting, which is related to vision/geometry but not specifically spatial intelligence, VLLMs, embodied AI, or foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 16. [MoVT: Video-Augmented Motion Tokenizer for Text-to-Motion Generation](https://arxiv.org/abs/2609.14965) <a id="link16"></a>
**ArXiv ID:** 2609.14965
**Authors:** Beibei Jing, Tianle Guo, Youjia Zhang, Zikai Song, Yawei Luo, Junqing Yu, Tao Guan, Wei Yang
...
**Comment:** No close match to criteria 1-4; it is a generative text-to-motion method using video augmentation, but not an embodied AI benchmark or VLLM/MLLM paper.
**Relevance:** 3
**Novelty:** 5

---

## 17. [PACE: Progressive Angular-to-Norm Contrastive Embedding](https://arxiv.org/abs/2609.15152) <a id="link17"></a>
**ArXiv ID:** 2609.15152
**Authors:** Yanping Li, Wei Zhou, Yawen Liu, Yibo Wang, Ke Zhu, Guangda Huzhang, Qing-Guo Chen, Zhao Xu, Jun Zhang, Wei Wei
...
**Comment:** No close match to the listed criteria; it is a multimodal embedding method, but not a VLLM/MLLM, embodied AI, or vision foundation model application in the intended sense.
**Relevance:** 3
**Novelty:** 5
