...
0. [BabyVision: Visual Reasoning Beyond Language](#link0)
...
2. [Smooth Operator: Smooth Verifiable Reward Activates Spatial Reasoning Ability of Vision-Language Model](#link2)
...
3. [LLMTrack: Semantic Multi-Object Tracking with Multi-modal Large Language Models](#link3)
**Authors:** Pan Liao, Feng Yang, Di Wu, Jinwen Yu, Yuhua Zhu, Wenhui Zhao

4. [SceneNAT: Masked Generative Modeling for Language-Guided Indoor Scene Synthesis](#link4)
**Authors:** Jeongjun Choi, Yeonsoo Park, H. Jin Kim

5. [PulseMind: A Multi-Modal Medical Model for Real-World Clinical Diagnosis](#link5)
...
6. [ShowUI-Aloha: Human-Taught GUI Agent](#link6)
**Authors:** Yichun Zhang, Xiangwu Guo, Yauhong Goh, Jessica Hu, Zhiheng Chen, Xin Wang, Difei Gao, Mike Zheng Shou

7. [OSCAR: Open-Set CAD Retrieval from a Language Prompt and a Single Image](#link7)
**Authors:** Tessa Pulli, Jean-Baptiste Weibel, Peter H\"onig, Matthias Hirschmanner, Markus Vincze, Andreas Holzinger

8. [GeoMotionGPT: Geometry-Aligned Motion Understanding with Large Language Models](#link8)
**Authors:** Zhankai Ye, Bofan Li, Yukai Jin, Shuoqiu Li, Wei Wang, Yanfu Zhang, Shangqian Gao, Xin Liu

9. [ViewMorpher3D: A 3D-aware Diffusion Framework for Multi-Camera Novel View Synthesis in Autonomous Driving](#link9)
**Authors:** Farhad G. Zanjani, Hong Cai, Amirhossein Habibian

10. [Measuring Social Bias in Vision-Language Models with Face-Only Counterfactuals from Real Photos](#link10)
**Authors:** Haodong Chen, Qiang Huang, Jiaqi Zhao, Qiuping Jiang, Xiaojun Chang, Jun Yu

11. [APEX: Learning Adaptive Priorities for Multi-Objective Alignment in Vision-Language Generation](#link11)
...
12. [A Visual Semantic Adaptive Watermark grounded by Prefix-Tuning for Large Vision-Language Model](#link12)
...
13. [PanoSAMic: Panoramic Image Segmentation from SAM Feature Encoding and Dual View Fusion](#link13)
**Authors:** Mahdi Chamseddine, Didier Stricker, Jason Rambach

14. [GenCtrl -- A Formal Controllability Toolkit for Generative Models](#link14)
**Authors:** Emily Cheng, Carmen Amo Alonso, Federico Danieli, Arno Blaas, Luca Zappella, Pau Rodriguez, Xavier Suau

15. [Focal Guidance: Unlocking Controllability from Semantic-Weak Layers in Video Diffusion Models](#link15)
**Authors:** Yuanyang Yin, Yufan Deng, Shenghai Yuan, Kaipeng Zhang, Xiao Yang, Feng Zhao

16. [FocalOrder: Focal Preference Optimization for Reading Order Detection](#link16)
...
17. [SIRR-LMM: Single-image Reflection Removal via Large Multimodal Model](#link17)
**Authors:** Yu Guo, Zhiqiang Lao, Xiyun Song, Yubin Zhou, Heather Yu

18. [Conformity and Social Impact on AI Agents](#link18)
**Authors:** Alessandro Bellina, Giordano De Marzo, David Garcia

19. [Towards Egocentric 3D Hand Pose Estimation in Unseen Domains](#link19)
**Authors:** Wiktor Mucha, Michael Wray, Martin Kampel

20. [PARL: Position-Aware Relation Learning Network for Document Layout Analysis](#link20)
**Authors:** Fuyuan Liu, Dianyu Yu, He Ren, Nayu Liu, Xiaomian Kang, Delai Qiu, Fa Zhang, Genpeng Zhen, Shengping Liu, Jiaen Liang, Wei Huang, Yining Wang, Junnan Zhu

21. [Sissi: Zero-shot Style-guided Image Synthesis via Semantic-style Integration](#link21)
**Authors:** Yingying Deng, Xiangyu He, Fan Tang, Weiming Dong, Xucheng Yin

22. [From Sketch to Fresco: Efficient Diffusion Transformer with Progressive Resolution](#link22)
**Authors:** Shikang Zheng, Guantao Chen, Lixuan He, Jiacheng Liu, Yuqi Lin, Chang Zou, Linfeng Zhang

23. [RenderFlow: Single-Step Neural Rendering via Flow Matching](#link23)
**Authors:** Shenghao Zhang, Runtao Liu, Christopher Schroers, Yang Zhang

24. [Toward Generalizable Deblurring: Leveraging Massive Blur Priors with Linear Attention for Real-World Scenarios](#link24)
**Authors:** Yuanting Gao, Shuo Cao, Xiaohui Li, Yuandong Pu, Yihao Liu, Kai Zhang

25. [Synthetic FMCW Radar Range Azimuth Maps Augmentation with Generative Diffusion Model](#link25)
**Authors:** Zhaoze Wang, Changxu Zhang, Tai Fei, Christopher Grimm, Yi Jin, Claas Tebruegge, Ernst Warsitz, Markus Gardill

26. [Learning Domain Agnostic Latent Embeddings of 3D Faces for Zero-shot Animal Expression Transfer](#link26)
**Authors:** Yue Wang, Lawrence Amadi, Xiang Gao, Yazheng Chen, Yuanpeng Liu, Ning Lu, Xianfeng Gu

27. [Anatomy Aware Cascade Network: Bridging Epistemic Uncertainty and Geometric Manifold for 3D Tooth Segmentation](#link27)
**Authors:** Bing Yu, Liu Shi, Haitao Wang, Deran Qi, Xiang Cai, Wei Zhong, Qiegen Liu

28. [DynaDebate: Breaking Homogeneity in Multi-Agent Debate with Dynamic Path Generation](#link28)
**Authors:** Zhenghao Li, Zhi Zheng, Wei Chen, Jielun Zhao, Yong Chen, Tong Xu, Enhong Chen

29. [StackPlanner: A Centralized Hierarchical Multi-Agent System with Task-Experience Memory Management](#link29)
...
30. [Explainable AI: Learning from the Learners](#link30)
**Authors:** Ricardo Vinuesa, Steven L. Brunton, Gianmarco Mengaldo

31. [The Persona Paradox: Medical Personas as Behavioral Priors in Clinical Language Models](#link31)
**Authors:** Tassallah Abdullahi, Shrestha Ghosh, Hamish S Fraser, Daniel Le\'on Tramontini, Adeel Abbasi, Ghada Bourjeily, Carsten Eickhoff, Ritambhara Singh

32. [Enhancing Low-resolution Image Representation Through Normalizing Flows](#link32)
**Authors:** Chenglong Bao, Tongyao Pang, Zuowei Shen, Dihan Zheng, Yihang Zou

33. [Boosting Overlapping Organoid Instance Segmentation Using Pseudo-Label Unmixing and Synthesis-Assisted Learning](#link33)
...
34. [PALUM: Part-based Attention Learning for Unified Motion Retargeting](#link34)
**Authors:** Siqi Liu, Maoyu Wang, Bo Dai, Cewu Lu

35. [ART: Adaptive Reasoning Trees for Explainable Claim Verification](#link35)
**Authors:** Sahil Wadhwa, Himanshu Kumar, Guanqun Yang, Abbaas Alif Mohamed Nishar, Pranab Mohanty, Swapnil Shinde, Yue Wu

36. [FMAC: a Fair Fiducial Marker Accuracy Comparison Software](#link36)
**Authors:** Guillaume J. Laurent, Patrick Sandoz

---
## 0. [BabyVision: Visual Reasoning Beyond Language](https://arxiv.org/abs/2601.06521) <a id="link0"></a>
**ArXiv ID:** 2601.06521
**Authors:** Liang Chen, Weichu Xie, Yiyan Liang, Hongfeng He, Hans Zhao, Zhibo Yang, Zhiqi Huang, Haoning Wu, Haoyu Lu, Y. charles, Yiping Bao, Yuantao Fan, Guopeng Li, Haiyang Shen, Xuanzhong Chen, Wendong Xu, Shuzheng Si, Zefan Cai, Wenhao Chai, Ziqi Huang, Fangfu Liu, Tianyu Liu, Baobao Chang, Xiaobo Hu, Kaiyuan Chen, Yixin Ren, Yang Liu, Yuan Gong, Kuan Li
...
## 2. [Smooth Operator: Smooth Verifiable Reward Activates Spatial Reasoning Ability of Vision-Language Model](https://arxiv.org/abs/2601.07695) <a id="link2"></a>
**ArXiv ID:** 2601.07695
**Authors:** Siwen Jiao, Tianxiong Lv, Kangan Qian, Chenxu Zhao, Xiuyuan Zhu, Tianlun Li, Xiaolong Cheng, Jinyu Li, Zhihao Liao, Yang Cai
...
## 3. [LLMTrack: Semantic Multi-Object Tracking with Multi-modal Large Language Models](https://arxiv.org/abs/2601.06550) <a id="link3"></a>
**ArXiv ID:** 2601.06550
**Authors:** Pan Liao, Feng Yang, Di Wu, Jinwen Yu, Yuhua Zhu, Wenhui Zhao
...
## 4. [SceneNAT: Masked Generative Modeling for Language-Guided Indoor Scene Synthesis](https://arxiv.org/abs/2601.07218) <a id="link4"></a>
**ArXiv ID:** 2601.07218
**Authors:** Jeongjun Choi, Yeonsoo Park, H. Jin Kim
...
## 5. [PulseMind: A Multi-Modal Medical Model for Real-World Clinical Diagnosis](https://arxiv.org/abs/2601.07344) <a id="link5"></a>
**ArXiv ID:** 2601.07344
**Authors:** Jiao Xu, Junwei Liu, Jiangwei Lao, Qi Zhu, Yunpeng Zhao, Congyun Jin, Shinan Liu, Zhihong Lu, Lihe Zhang, Xin Chen, Jian Wang, Ping Wang
...
## 6. [ShowUI-Aloha: Human-Taught GUI Agent](https://arxiv.org/abs/2601.07181) <a id="link6"></a>
**ArXiv ID:** 2601.07181
**Authors:** Yichun Zhang, Xiangwu Guo, Yauhong Goh, Jessica Hu, Zhiheng Chen, Xin Wang, Difei Gao, Mike Zheng Shou
...
## 7. [OSCAR: Open-Set CAD Retrieval from a Language Prompt and a Single Image](https://arxiv.org/abs/2601.07333) <a id="link7"></a>
**ArXiv ID:** 2601.07333
**Authors:** Tessa Pulli, Jean-Baptiste Weibel, Peter H\"onig, Matthias Hirschmanner, Markus Vincze, Andreas Holzinger
...
## 8. [GeoMotionGPT: Geometry-Aligned Motion Understanding with Large Language Models](https://arxiv.org/abs/2601.07632) <a id="link8"></a>
**ArXiv ID:** 2601.07632
**Authors:** Zhankai Ye, Bofan Li, Yukai Jin, Shuoqiu Li, Wei Wang, Yanfu Zhang, Shangqian Gao, Xin Liu
...
## 9. [ViewMorpher3D: A 3D-aware Diffusion Framework for Multi-Camera Novel View Synthesis in Autonomous Driving](https://arxiv.org/abs/2601.07540) <a id="link9"></a>
**ArXiv ID:** 2601.07540
**Authors:** Farhad G. Zanjani, Hong Cai, Amirhossein Habibian
...
## 10. [Measuring Social Bias in Vision-Language Models with Face-Only Counterfactuals from Real Photos](https://arxiv.org/abs/2601.06931) <a id="link10"></a>
**ArXiv ID:** 2601.06931
**Authors:** Haodong Chen, Qiang Huang, Jiaqi Zhao, Qiuping Jiang, Xiaojun Chang, Jun Yu
...
## 11. [APEX: Learning Adaptive Priorities for Multi-Objective Alignment in Vision-Language Generation](https://arxiv.org/abs/2601.06574) <a id="link11"></a>
**ArXiv ID:** 2601.06574
**Authors:** Dongliang Chen, Xinlin Zhuang, Junjie Xu, Luojian Xie, Zehui Wang, Jiaxi Zhuang, Haolin Yang, Liang Dou, Xiao He, Xingjiao Wu, Ying Qian
...
## 12. [A Visual Semantic Adaptive Watermark grounded by Prefix-Tuning for Large Vision-Language Model](https://arxiv.org/abs/2601.07291) <a id="link12"></a>
**ArXiv ID:** 2601.07291
**Authors:** Qi Zheng, Shuliang Liu, Yu Huang, Sihang Jia, Jungang Li, Lyuhao Chen, Junhao Chen, Hanqian Li, Aiwei Liu, Yibo Yan, Xuming Hu
...
## 13. [PanoSAMic: Panoramic Image Segmentation from SAM Feature Encoding and Dual View Fusion](https://arxiv.org/abs/2601.07447) <a id="link13"></a>
**ArXiv ID:** 2601.07447
**Authors:** Mahdi Chamseddine, Didier Stricker, Jason Rambach
...
## 14. [GenCtrl -- A Formal Controllability Toolkit for Generative Models](https://arxiv.org/abs/2601.05637) <a id="link14"></a>
**ArXiv ID:** 2601.05637
**Authors:** Emily Cheng, Carmen Amo Alonso, Federico Danieli, Arno Blaas, Luca Zappella, Pau Rodriguez, Xavier Suau
...
## 15. [Focal Guidance: Unlocking Controllability from Semantic-Weak Layers in Video Diffusion Models](https://arxiv.org/abs/2601.07287) <a id="link15"></a>
**ArXiv ID:** 2601.07287
**Authors:** Yuanyang Yin, Yufan Deng, Shenghai Yuan, Kaipeng Zhang, Xiao Yang, Feng Zhao
...
## 16. [FocalOrder: Focal Preference Optimization for Reading Order Detection](https://arxiv.org/abs/2601.07483) <a id="link16"></a>
**ArXiv ID:** 2601.07483
**Authors:** Fuyuan Liu, Dianyu Yu, He Ren, Nayu Liu, Xiaomian Kang, Delai Qiu, Fa Zhang, Genpeng Zhen, Shengping Liu, Jiaen Liang, Wei Huang, Yining Wang, Junnan Zhu
...
## 17. [SIRR-LMM: Single-image Reflection Removal via Large Multimodal Model](https://arxiv.org/abs/2601.07209) <a id="link17"></a>
**ArXiv ID:** 2601.07209
**Authors:** Yu Guo, Zhiqiang Lao, Xiyun Song, Yubin Zhou, Heather Yu
...
## 18. [Conformity and Social Impact on AI Agents](https://arxiv.org/abs/2601.05384) <a id="link18"></a>
**ArXiv ID:** 2601.05384
**Authors:** Alessandro Bellina, Giordano De Marzo, David Garcia
...
## 19. [Towards Egocentric 3D Hand Pose Estimation in Unseen Domains](https://arxiv.org/abs/2601.06537) <a id="link19"></a>
**ArXiv ID:** 2601.06537
**Authors:** Wiktor Mucha, Michael Wray, Martin Kampel
...
## 20. [PARL: Position-Aware Relation Learning Network for Document Layout Analysis](https://arxiv.org/abs/2601.07620) <a id="link20"></a>
**ArXiv ID:** 2601.07620
**Authors:** Fuyuan Liu, Dianyu Yu, He Ren, Nayu Liu, Xiaomian Kang, Delai Qiu, Fa Zhang, Genpeng Zhen, Shengping Liu, Jiaen Liang, Wei Huang, Yining Wang, Junnan Zhu
...
## 21. [Sissi: Zero-shot Style-guided Image Synthesis via Semantic-style Integration](https://arxiv.org/abs/2601.06605) <a id="link21"></a>
**ArXiv ID:** 2601.06605
**Authors:** Yingying Deng, Xiangyu He, Fan Tang, Weiming Dong, Xucheng Yin
...
## 22. [From Sketch to Fresco: Efficient Diffusion Transformer with Progressive Resolution](https://arxiv.org/abs/2601.07462) <a id="link22"></a>
**ArXiv ID:** 2601.07462
**Authors:** Shikang Zheng, Guantao Chen, Lixuan He, Jiacheng Liu, Yuqi Lin, Chang Zou, Linfeng Zhang
...
## 23. [RenderFlow: Single-Step Neural Rendering via Flow Matching](https://arxiv.org/abs/2601.06928) <a id="link23"></a>
**ArXiv ID:** 2601.06928
**Authors:** Shenghao Zhang, Runtao Liu, Christopher Schroers, Yang Zhang
...
## 24. [Toward Generalizable Deblurring: Leveraging Massive Blur Priors with Linear Attention for Real-World Scenarios](https://arxiv.org/abs/2601.06525) <a id="link24"></a>
**ArXiv ID:** 2601.06525
**Authors:** Yuanting Gao, Shuo Cao, Xiaohui Li, Yuandong Pu, Yihao Liu, Kai Zhang
...
## 25. [Synthetic FMCW Radar Range Azimuth Maps Augmentation with Generative Diffusion Model](https://arxiv.org/abs/2601.06228) <a id="link25"></a>
**ArXiv ID:** 2601.06228
**Authors:** Zhaoze Wang, Changxu Zhang, Tai Fei, Christopher Grimm, Yi Jin, Claas Tebruegge, Ernst Warsitz, Markus Gardill
...
## 26. [Learning Domain Agnostic Latent Embeddings of 3D Faces for Zero-shot Animal Expression Transfer](https://arxiv.org/abs/2601.06484) <a id="link26"></a>
**ArXiv ID:** 2601.06484
**Authors:** Yue Wang, Lawrence Amadi, Xiang Gao, Yazheng Chen, Yuanpeng Liu, Ning Lu, Xianfeng Gu
...
## 27. [Anatomy Aware Cascade Network: Bridging Epistemic Uncertainty and Geometric Manifold for 3D Tooth Segmentation](https://arxiv.org/abs/2601.07499) <a id="link27"></a>
**ArXiv ID:** 2601.07499
**Authors:** Bing Yu, Liu Shi, Haitao Wang, Deran Qi, Xiang Cai, Wei Zhong, Qiegen Liu
...
## 28. [DynaDebate: Breaking Homogeneity in Multi-Agent Debate with Dynamic Path Generation](https://arxiv.org/abs/2601.05746) <a id="link28"></a>
**ArXiv ID:** 2601.05746
**Authors:** Zhenghao Li, Zhi Zheng, Wei Chen, Jielun Zhao, Yong Chen, Tong Xu, Enhong Chen
...
## 29. [StackPlanner: A Centralized Hierarchical Multi-Agent System with Task-Experience Memory Management](https://arxiv.org/abs/2601.05890) <a id="link29"></a>
**ArXiv ID:** 2601.05890
**Authors:** Ruizhe Zhang, Xinke Jiang, Zhibang Yang, Zhixin Zhang, Jiaran Gao, Yuzhen Xiao, Hongbin Lai, Xu Chu, Junfeng Zhao, Yasha Wang
...
## 30. [Explainable AI: Learning from the Learners](https://arxiv.org/abs/2601.05525) <a id="link30"></a>
**ArXiv ID:** 2601.05525
**Authors:** Ricardo Vinuesa, Steven L. Brunton, Gianmarco Mengaldo
...
## 31. [The Persona Paradox: Medical Personas as Behavioral Priors in Clinical Language Models](https://arxiv.org/abs/2601.05376) <a id="link31"></a>
**ArXiv ID:** 2601.05376
**Authors:** Tassallah Abdullahi, Shrestha Ghosh, Hamish S Fraser, Daniel Le\'on Tramontini, Adeel Abbasi, Ghada Bourjeily, Carsten Eickhoff, Ritambhara Singh
...
## 32. [Enhancing Low-resolution Image Representation Through Normalizing Flows](https://arxiv.org/abs/2601.06834) <a id="link32"></a>
**ArXiv ID:** 2601.06834
**Authors:** Chenglong Bao, Tongyao Pang, Zuowei Shen, Dihan Zheng, Yihang Zou
...
## 33. [Boosting Overlapping Organoid Instance Segmentation Using Pseudo-Label Unmixing and Synthesis-Assisted Learning](https://arxiv.org/abs/2601.06642) <a id="link33"></a>
**ArXiv ID:** 2601.06642
**Authors:** Gui Huang, Kangyuan Zheng, Xuan Cai, Jiaqi Wang, Jianjia Zhang, Kaida Ning, Wenbo Wei, Yujuan Zhu, Jiong Zhang, Mengting Liu
...
## 34. [PALUM: Part-based Attention Learning for Unified Motion Retargeting](https://arxiv.org/abs/2601.07272) <a id="link34"></a>
**ArXiv ID:** 2601.07272
**Authors:** Siqi Liu, Maoyu Wang, Bo Dai, Cewu Lu
...
## 35. [ART: Adaptive Reasoning Trees for Explainable Claim Verification](https://arxiv.org/abs/2601.05455) <a id="link35"></a>
**ArXiv ID:** 2601.05455
**Authors:** Sahil Wadhwa, Himanshu Kumar, Guanqun Yang, Abbaas Alif Mohamed Nishar, Pranab Mohanty, Swapnil Shinde, Yue Wu
...
## 36. [FMAC: a Fair Fiducial Marker Accuracy Comparison Software](https://arxiv.org/abs/2601.07723) <a id="link36"></a>
**ArXiv ID:** 2601.07723
**Authors:** Guillaume J. Laurent, Patrick Sandoz
