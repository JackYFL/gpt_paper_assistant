# Personalized Daily ArXiv Papers 08/15/2026
...
0. [Spatial Memory Agent: Experience-Grounded Procedure Memory for Spatial Intelligence](#link0)
**Authors:** Haokai Zhang, Yuhang Ding, Yunshu Zhou, Xinze Du, Shengtao Zhang, Zhiyue Zhao, Yuling Xi, Hao Chen

1. [DiG-bench: Discovery in Games](#link1)
**Authors:** Ruairidh M. Battleday, Kai Sandbrink, Jimi Cullen-Drohan, Zihan Yan, Timothy Muller, Clare Maguire, Ales Kubicek, Fraser Greenlee-Scott, Sukrit Sumant, Tri Dao, J\"urgen Schmidhuber, Michal Valko, Joshua Tenenbaum, Thomas L. Griffiths, Zeb Kurth-Nelson, James C. R. Whittington

2. [LongEarth-R1: Benchmarking and Aligning Vision-Language Models for Long-Horizon Earth Observation Reasoning](#link2)
**Authors:** Yupan Ding, Jing Xiao, Zhenyuan Zhang, Chaofeng Chen, Liang Liao, Gui-Song Xia, Mi Wang

3. [From Local Mismatch to Global Impact: Optimizing Cache Reuse Policy for Efficient Diffusion](#link3)
**Authors:** Xichen Ye, Yifan Wu, Zhikang Xie, Xiangyu Yue, Cheng Jin, Weizhong Zhang

4. [Auditable agentic AI for evidence-grounded thyroid ultrasound diagnosis and reporting](#link4)
...
5. [SteerBench-Work: A Benchmark for Agent Steering at Action Boundaries](#link5)
**Authors:** Oguz Serdar, Cuneyt Mertayak

6. [MindMemOS: A Portable and Self-Evolving Memory Operating Layer for AI Agents](#link6)
...
7. [Beyond Retrieval: Query-Conditioned Reuse of Long-Horizon Agent Trajectories](#link7)
**Authors:** Yifei Li, Heng Wang, Lingling Zhang, Muye Huang, Xinyu Zhang, Jiashuai Liu, Hang Yan, Rongman Xu

8. [The Role of Natural Language Understanding in Multimodal Video-Based Dengue Diagnosis](#link8)
...
---
## 0. [Spatial Memory Agent: Experience-Grounded Procedure Memory for Spatial Intelligence](https://arxiv.org/abs/2608.12743) <a id="link0"></a>
**ArXiv ID:** 2608.12743
**Authors:** Haokai Zhang, Yuhang Ding, Yunshu Zhou, Xinze Du, Shengtao Zhang, Zhiyue Zhao, Yuling Xi, Hao Chen
...
**Comment:** Strong match to criterion 1: it proposes a new method for spatial intelligence in embodied/VLM agents via experience-grounded memory and verifier-guided reflection.
**Relevance:** 9
**Novelty:** 7

---

## 1. [DiG-bench: Discovery in Games](https://arxiv.org/abs/2608.12593) <a id="link1"></a>
**ArXiv ID:** 2608.12593
**Authors:** Ruairidh M. Battleday, Kai Sandbrink, Jimi Cullen-Drohan, Zihan Yan, Timothy Muller, Clare Maguire, Ales Kubicek, Fraser Greenlee-Scott, Sukrit Sumant, Tri Dao, J\"urgen Schmidhuber, Michal Valko, Joshua Tenenbaum, Thomas L. Griffiths, Zeb Kurth-Nelson, James C. R. Whittington
...
**Comment:** Strong match to criterion 3: it builds a new interaction-based benchmark for discovery in games, a novel evaluation setting for agentic/embodied-style experimentation.
**Relevance:** 6
**Novelty:** 7

---

## 2. [LongEarth-R1: Benchmarking and Aligning Vision-Language Models for Long-Horizon Earth Observation Reasoning](https://arxiv.org/abs/2608.13344) <a id="link2"></a>
**ArXiv ID:** 2608.13344
**Authors:** Yupan Ding, Jing Xiao, Zhenyuan Zhang, Chaofeng Chen, Liang Liao, Gui-Song Xia, Mi Wang
...
**Comment:** Criterion 2 is a strong match, and criterion 3 is also relevant: this builds a new benchmark for long-horizon Earth-observation reasoning and aligns/finetunes a VLM with structured spatial-temporal reasoning.
**Relevance:** 6
**Novelty:** 6

---

## 3. [From Local Mismatch to Global Impact: Optimizing Cache Reuse Policy for Efficient Diffusion](https://arxiv.org/abs/2608.13043) <a id="link3"></a>
**ArXiv ID:** 2608.13043
**Authors:** Xichen Ye, Yifan Wu, Zhikang Xie, Xiangyu Yue, Cheng Jin, Weizhong Zhang
...
**Comment:** No direct match to the criteria, but it is relevant to generative modeling in vision: it improves diffusion inference efficiency with a statistically grounded cache policy.
**Relevance:** 4
**Novelty:** 7

---

## 4. [Auditable agentic AI for evidence-grounded thyroid ultrasound diagnosis and reporting](https://arxiv.org/abs/2608.12590) <a id="link4"></a>
**ArXiv ID:** 2608.12590
**Authors:** Haifan Gong, Shiyu Chen, Bodong Wang, Yuqi Wang, Shijie Wang, Guoliang You, Xinyu Xiong, Haowei Wang, Mingzhi Mao, Dexing Kong, Qinghua Liu, Wei Lou, Fei Chen, Guanbin Li
...
**Comment:** Partial match to criterion 3: it is an embodied/agentic AI system for medical ultrasound with auditable evidence-grounded reporting, but it is not simulator-based embodied AI.
**Relevance:** 5
**Novelty:** 5

---

## 5. [SteerBench-Work: A Benchmark for Agent Steering at Action Boundaries](https://arxiv.org/abs/2608.12654) <a id="link5"></a>
**ArXiv ID:** 2608.12654
**Authors:** Oguz Serdar, Cuneyt Mertayak
...
**Comment:** Partial match to criterion 3: it introduces a new benchmark for action-boundary steering in long-running agents, but it is not embodied/simulator-based.
**Relevance:** 4
**Novelty:** 5

---

## 6. [MindMemOS: A Portable and Self-Evolving Memory Operating Layer for AI Agents](https://arxiv.org/abs/2608.12428) <a id="link6"></a>
**ArXiv ID:** 2608.12428
**Authors:** Kaichao Liang, Yuqi Cui, Hao Kong, Xinyuan Huang, Guohaotian Hou, Qingcan Kang, Liang Chen, Yiyang Yin, Ke Ye, Jiaquan Guo, Da Chen, Lingan Zeng, Yixing Peng, Rong Yao, Shixiong Kai, Mingxuan Yuan
...
**Comment:** No direct match to the criteria, though it is adjacent to long-term agent memory and self-evolving skills; it is not specifically spatial or vision-language grounded.
**Relevance:** 3
**Novelty:** 6

---

## 7. [Beyond Retrieval: Query-Conditioned Reuse of Long-Horizon Agent Trajectories](https://arxiv.org/abs/2608.12847) <a id="link7"></a>
**ArXiv ID:** 2608.12847
**Authors:** Yifei Li, Heng Wang, Lingling Zhang, Muye Huang, Xinyu Zhang, Jiashuai Liu, Hang Yan, Rongman Xu
...
**Comment:** No criterion match very closely; it is a long-horizon agent-memory / web-agent trajectory reuse paper, which is only loosely related to embodied-agent methods rather than matching criteria 1, 2, or 3 directly.
**Relevance:** 3
**Novelty:** 4

---

## 8. [The Role of Natural Language Understanding in Multimodal Video-Based Dengue Diagnosis](https://arxiv.org/abs/2608.12677) <a id="link8"></a>
**ArXiv ID:** 2608.12677
**Authors:** Danial Sharifrazi, Saadat Behzadi, Julakha Jahan Jui, Mojtaba Mohammadi, Nouman Javed, Roohallah Alizadehsani, Prasad N. Paradkar, Asim Bhatti
...
**Comment:** Criterion 2 is a mild match: it uses a CLIP-based vision-language framework, but the application is a narrow biomedical video classification task rather than a new VLLM/MLLM or embodied/spatial method.
**Relevance:** 3
**Novelty:** 3
