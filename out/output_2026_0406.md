# Personalized Daily ArXiv Papers 04/06/2026
...
0. [VLMs Need Words: Vision Language Models Ignore Visual Detail In Favor of Semantic Anchors](#link0)
**Authors:** Haz Sameen Shahgir, Xiaofu Chen, Yu Fu, Erfan Shayegani, Nael Abu-Ghazaleh, Yova Kementchedjhieva, Yue Dong

1. [Agentic-MME: What Agentic Capability Really Brings to Multimodal Intelligence?](#link1)
...
2. [MI-Pruner: Crossmodal Mutual Information-guided Token Pruner for Efficient MLLMs](#link2)
**Authors:** Jiameng Li, Aleksei Tiulpin, Matthew B. Blaschko

3. [DeCo-DETR: Decoupled Cognition DETR for efficient Open-Vocabulary Object Detection](#link3)
...
4. [Contrastive Language-Colored Pointmap Pretraining for Unified 3D Scene Understanding](#link4)
**Authors:** Ye Mao, Weixun Luo, Ranran Huang, Junpeng Jing, Krystian Mikolajczyk

5. [NavCrafter: Exploring 3D Scenes from a Single Image](#link5)
**Authors:** Hongbo Duan, Peiyu Zhuang, Yi Liu, Zhengyang Zhang, Yuxin Zhang, Pengting Luo, Fangming Liu, Xueqian Wang

6. [Do Audio-Visual Large Language Models Really See and Hear?](#link6)
**Authors:** Ramaneswaran Selvakumar, Kaousheik Jayakumar, S Sakshi, Sreyan Ghosh, Ruohan Gao, Dinesh Manocha

7. [VOSR: A Vision-Only Generative Model for Image Super-Resolution](#link7)
**Authors:** Rongyuan Wu, Lingchen Sun, Zhengqiang Zhang, Xiangtao Kong, Jixin Zhao, Shihao Wang, Lei Zhang

8. [Rapidly deploying on-device eye tracking by distilling visual foundation models](#link8)
**Authors:** Cheng Jiang, Jogendra Kundu, David Colmenares, Fengting Yang, Joseph Robinson, Yatong An, Ali Behrooz

9. [Collaborative Multi-Mode Pruning for Vision-Language Models](#link9)
**Authors:** Zimeng Wu, Yunhong Wang, Donghao Wang, Jiaxin Chen

10. [Smart Transfer: Leveraging Vision Foundation Model for Rapid Building Damage Mapping with Post-Earthquake VHR Imagery](#link10)
**Authors:** Hao Li, Liwei Zou, Wenping Yin, Gulsen Taskin, Naoto Yokoya, Danfeng Hong, Wufan Zhao

11. [BEVPredFormer: Spatio-temporal Attention for BEV Instance Prediction in Autonomous Driving](#link11)
**Authors:** Miguel Antunes-Garc\'ia, Santiago Montiel-Mar\'in, Fabio S\'anchez-Garc\'ia, Rodrigo Guti\'errez-Moreno, Rafael Barea, Luis M. Bergasa

12. [Unlocking Positive Transfer in Incrementally Learning Surgical Instruments: A Self-reflection Hierarchical Prompt Framework](#link12)
**Authors:** Yu Zhu, Kang Li, Zheng Li, Pheng-Ann Heng

13. [CANDLE: Illumination-Invariant Semantic Priors for Color Ambient Lighting Normalization](#link13)
**Authors:** Rong-Lin Jian, Ting-Yao Chen, Yu-Fan Lin, Chia-Ming Lee, Fu-En Yang, Yu-Chiang Frank Wang, Chih-Chung Hsu

14. [Modality-Specific Hierarchical Enhancement for RGB-D Camouflaged Object Detection](#link14)
**Authors:** Yuzhen Niu, Yangqing Wang, Ri Cheng, Fusheng Li, Rongshen Wang, Zhichen Yang

15. [Gram-MMD: A Texture-Aware Metric for Image Realism Assessment](#link15)
**Authors:** Jo\'e Napolitano, Pascal Nguyen

16. [Beyond Fixed Inference: Quantitative Flow Matching for Adaptive Image Denoising](#link16)
**Authors:** Jigang Duan, Genwei Ma, Xu Jiang, Wenfeng Xu, Ping Yang, Xing Zhao

17. [TrackerSplat: Exploiting Point Tracking for Fast and Robust Dynamic 3D Gaussians Reconstruction](#link17)
**Authors:** Daheng Yin, Isaac Ding, Yili Jin, Jianxin Shi, Jiangchuan Liu

18. [ProtoFlow: Mitigating Forgetting in Class-Incremental Remote Sensing Segmentation via Low-Curvature Prototype Flow](#link18)
...
19. [InfoSeeker: A Scalable Hierarchical Parallel Agent Framework for Web Information Seeking](#link19)
**Authors:** Ka Yiu Lee, Yuxuan Huang, Zhiyuan He, Huichi Zhou, Weilin Luo, Kun Shao, Meng Fang, Jun Wang

20. [InverseDraping: Recovering Sewing Patterns from 3D Garment Surfaces via BoxMesh Bridging](#link20)
**Authors:** Leyang Jin, Zirong Jin, Zisheng Ye, Haokai Pang, Xiaoguang Han, Yujian Zheng, Hao Li

21. [Adaptive Local Frequency Filtering for Fourier-Encoded Implicit Neural Representations](#link21)
**Authors:** Ligen Shi, Jun Qiu, Yuhang Zheng, Chang Liu

22. [Factorized Multi-Resolution HashGrid for Efficient Neural Radiance Fields: Execution on Edge-Devices](#link22)
**Authors:** Kim Jun-Seong, Mingyu Kim, GeonU Kim, Tae-Hyun Oh, Jin-Hwa Kim

23. [HairOrbit: Multi-view Aware 3D Hair Modeling from Single Portraits](#link23)
**Authors:** Leyang Jin, Yujian Zheng, Bingkui Tong, Yuda Qiu, Zhenyu Xie, Hao Li

24. [The Eleventh NTIRE 2026 Efficient Super-Resolution Challenge Report](#link24)
...
---
## 0. [VLMs Need Words: Vision Language Models Ignore Visual Detail In Favor of Semantic Anchors](https://arxiv.org/abs/2604.02486) <a id="link0"></a>
**ArXiv ID:** 2604.02486
**Authors:** Haz Sameen Shahgir, Xiaofu Chen, Yu Fu, Erfan Shayegani, Nael Abu-Ghazaleh, Yova Kementchedjhieva, Yue Dong
...
**Comment:** Matches criterion 2: Provides new empirical insights into VLMs' limitations in visual detail reasoning, and proposes methods to improve their performance on vision-focused tasks. Surprising empirical results about VLMs' reliance on language.
**Relevance:** 10
**Novelty:** 8

---

## 1. [Agentic-MME: What Agentic Capability Really Brings to Multimodal Intelligence?](https://arxiv.org/abs/2604.03016) <a id="link1"></a>
**ArXiv ID:** 2604.03016
**Authors:** Qianshan Wei, Yishan Yang, Siyi Wang, Jinglin Chen, Binyu Wang, Jiaming Wang, Shuang Chen, Zechen Li, Yang Shi, Yuqi Tang, Weining Wang, Yi Yu, Chaoyou Fu, Qi Li, Yi-Fan Zhang
...
**Comment:** Matches criteria 2 and 3: This paper introduces Agentic-MME, a new process-verified benchmark for evaluating agentic capabilities in Multimodal Large Language Models (MLLMs), with a focus on real-world multimodal agentic problem solving and process-level verification. It is directly relevant to new MLLMs and embodied AI benchmarks, and provides surprising empirical results.
**Relevance:** 10
**Novelty:** 8

---

## 2. [MI-Pruner: Crossmodal Mutual Information-guided Token Pruner for Efficient MLLMs](https://arxiv.org/abs/2604.03072) <a id="link2"></a>
**ArXiv ID:** 2604.03072
**Authors:** Jiameng Li, Aleksei Tiulpin, Matthew B. Blaschko
...
**Comment:** MI-Pruner introduces a mutual information-guided token pruning method for efficient MLLMs, directly matching criterion 2 (new MLLMs) and involving a clever statistical trick.
**Relevance:** 9
**Novelty:** 8

---

## 3. [DeCo-DETR: Decoupled Cognition DETR for efficient Open-Vocabulary Object Detection](https://arxiv.org/abs/2604.02753) <a id="link3"></a>
**ArXiv ID:** 2604.02753
**Authors:** Siheng Wang, Yanshu Li, Bohan Hu, Zhengdao Li, Haibo Zhan, Linshan Li, Weiming Liu, Ruizhi Qian, Guangxin Wu, Hao Zhang, Jifeng Shen, Piotr Koniusz, Zhengtao Yao, Junhao Dong, Qiang Sun
...
**Comment:** Matches criterion 2 and 4: Proposes a new vision-centric open-vocabulary object detection framework that leverages pre-trained LVLMs and CLIP for semantic representation, decoupling semantic cognition from detection. Relevant for VLLMs and vision foundation models.
**Relevance:** 9
**Novelty:** 7

---

## 4. [Contrastive Language-Colored Pointmap Pretraining for Unified 3D Scene Understanding](https://arxiv.org/abs/2604.02546) <a id="link4"></a>
**ArXiv ID:** 2604.02546
**Authors:** Ye Mao, Weixun Luo, Ranran Huang, Junpeng Jing, Krystian Mikolajczyk
...
**Comment:** Matches criterion 1 and 3: Proposes a new transformer-based encoder for unified 3D scene understanding using multi-view colored pointmaps, with novel cross-view geometric and semantic alignment. Also relevant to embodied AI and spatial intelligence.
**Relevance:** 9
**Novelty:** 7

---

## 5. [NavCrafter: Exploring 3D Scenes from a Single Image](https://arxiv.org/abs/2604.02828) <a id="link5"></a>
**ArXiv ID:** 2604.02828
**Authors:** Hongbo Duan, Peiyu Zhuang, Yi Liu, Zhengyang Zhang, Yuxin Zhang, Pengting Luo, Fangming Liu, Xueqian Wang
...
**Comment:** NavCrafter introduces a novel framework for exploring 3D scenes from a single image, with a focus on controllable novel-view synthesis and 3D reconstruction. This is a methodological improvement in spatial understanding and intelligence (criterion 1), and also relevant to vision foundation models (criterion 4) due to the use of video diffusion models.
**Relevance:** 8
**Novelty:** 8

---

## 6. [Do Audio-Visual Large Language Models Really See and Hear?](https://arxiv.org/abs/2604.02605) <a id="link6"></a>
**ArXiv ID:** 2604.02605
**Authors:** Ramaneswaran Selvakumar, Kaousheik Jayakumar, S Sakshi, Sreyan Ghosh, Ruohan Gao, Dinesh Manocha
...
**Comment:** Matches criterion 2: This paper investigates Audio-Visual Large Language Models (AVLLMs), providing mechanistic interpretability and empirical insights into modality bias and fusion in multi-modal LLMs. It offers surprising empirical results about how audio and vision are integrated, which aligns with your friend's interest in VLLMs/MLLMs and insightful results.
**Relevance:** 9
**Novelty:** 7

---

## 7. [VOSR: A Vision-Only Generative Model for Image Super-Resolution](https://arxiv.org/abs/2604.03225) <a id="link7"></a>
**ArXiv ID:** 2604.03225
**Authors:** Rongyuan Wu, Lingchen Sun, Zhengqiang Zhang, Xiangtao Kong, Jixin Zhao, Shihao Wang, Lei Zhang
...
**Comment:** Matches criterion 4: Proposes a vision-only generative model for super-resolution, challenging the dominance of multimodal (T2I) models and showing that high-quality SR can be achieved without multimodal pretraining. Novel application and empirical result for vision foundation models.
**Relevance:** 8
**Novelty:** 7

---

## 8. [Rapidly deploying on-device eye tracking by distilling visual foundation models](https://arxiv.org/abs/2604.02509) <a id="link8"></a>
**ArXiv ID:** 2604.02509
**Authors:** Cheng Jiang, Jogendra Kundu, David Colmenares, Fengting Yang, Joseph Robinson, Yatong An, Ali Behrooz
...
**Comment:** This paper distills visual foundation models for rapid on-device eye tracking, matching criterion 4 (vision foundation models and applications). The method also combines synthetic and real data in a clever way.
**Relevance:** 8
**Novelty:** 7

---

## 9. [Collaborative Multi-Mode Pruning for Vision-Language Models](https://arxiv.org/abs/2604.02956) <a id="link9"></a>
**ArXiv ID:** 2604.02956
**Authors:** Zimeng Wu, Yunhong Wang, Donghao Wang, Jiaxin Chen
...
**Comment:** This paper introduces a novel multi-mode pruning framework for vision-language models, directly matching criterion 2 (new VLLMs/MLLMs) and also involves clever statistical tricks for model compression.
**Relevance:** 8
**Novelty:** 7

---

## 10. [Smart Transfer: Leveraging Vision Foundation Model for Rapid Building Damage Mapping with Post-Earthquake VHR Imagery](https://arxiv.org/abs/2604.02627) <a id="link10"></a>
**ArXiv ID:** 2604.02627
**Authors:** Hao Li, Liwei Zou, Wenping Yin, Gulsen Taskin, Naoto Yokoya, Danfeng Hong, Wufan Zhao
...
**Comment:** This paper leverages vision foundation models for rapid building damage mapping, directly matching criterion 4 (vision foundation models and applications). The use of novel transfer strategies is also notable.
**Relevance:** 8
**Novelty:** 7

---

## 11. [BEVPredFormer: Spatio-temporal Attention for BEV Instance Prediction in Autonomous Driving](https://arxiv.org/abs/2604.02930) <a id="link11"></a>
**ArXiv ID:** 2604.02930
**Authors:** Miguel Antunes-Garc\'ia, Santiago Montiel-Mar\'in, Fabio S\'anchez-Garc\'ia, Rodrigo Guti\'errez-Moreno, Rafael Barea, Luis M. Bergasa
...
**Comment:** BEVPredFormer proposes a new spatio-temporal attention architecture for BEV instance prediction in autonomous driving, which is a methodological improvement in spatial intelligence for embodied agents (criterion 1).
**Relevance:** 7
**Novelty:** 7

---

## 12. [Unlocking Positive Transfer in Incrementally Learning Surgical Instruments: A Self-reflection Hierarchical Prompt Framework](https://arxiv.org/abs/2604.02877) <a id="link12"></a>
**ArXiv ID:** 2604.02877
**Authors:** Yu Zhu, Kang Li, Zheng Li, Pheng-Ann Heng
...
**Comment:** Matches criterion 1: This paper proposes a new hierarchical prompt framework for incremental learning in surgical video scene parsing, focusing on positive knowledge transfer and avoiding catastrophic forgetting. It leverages foundation models and prompt engineering, which is a methodological improvement relevant to spatial understanding in embodied agents.
**Relevance:** 7
**Novelty:** 7

---

## 13. [CANDLE: Illumination-Invariant Semantic Priors for Color Ambient Lighting Normalization](https://arxiv.org/abs/2604.02785) <a id="link13"></a>
**ArXiv ID:** 2604.02785
**Authors:** Rong-Lin Jian, Ting-Yao Chen, Yu-Fan Lin, Chia-Ming Lee, Fu-En Yang, Yu-Chiang Frank Wang, Chih-Chung Hsu
...
**Comment:** Matches criterion 4: Uses DINOv3 (a vision foundation model) as semantic prior for color normalization, showing a novel application of vision foundation models to illumination-invariant color correction.
**Relevance:** 7
**Novelty:** 6

---

## 14. [Modality-Specific Hierarchical Enhancement for RGB-D Camouflaged Object Detection](https://arxiv.org/abs/2604.02935) <a id="link14"></a>
**ArXiv ID:** 2604.02935
**Authors:** Yuzhen Niu, Yangqing Wang, Ri Cheng, Fusheng Li, Rongshen Wang, Zhichen Yang
...
**Comment:** This paper proposes a new method for RGB-D camouflaged object detection using modality-specific hierarchical enhancement, which is a methodological improvement in spatial understanding for embodied agents (criterion 1).
**Relevance:** 6
**Novelty:** 6

---

## 15. [Gram-MMD: A Texture-Aware Metric for Image Realism Assessment](https://arxiv.org/abs/2604.03064) <a id="link15"></a>
**ArXiv ID:** 2604.03064
**Authors:** Jo\'e Napolitano, Pascal Nguyen
...
**Comment:** Proposes a new metric for image realism assessment in generative modeling. While interesting for generative modeling, it does not directly match any specific criterion.
**Relevance:** 4
**Novelty:** 6

---

## 16. [Beyond Fixed Inference: Quantitative Flow Matching for Adaptive Image Denoising](https://arxiv.org/abs/2604.02392) <a id="link16"></a>
**ArXiv ID:** 2604.02392
**Authors:** Jigang Duan, Genwei Ma, Xu Jiang, Wenfeng Xu, Ping Yang, Xing Zhao
...
**Comment:** Presents a quantitative flow matching framework for adaptive image denoising using generative models. While relevant to generative modeling, it does not directly match any specific criterion.
**Relevance:** 4
**Novelty:** 6

---

## 17. [TrackerSplat: Exploiting Point Tracking for Fast and Robust Dynamic 3D Gaussians Reconstruction](https://arxiv.org/abs/2604.02586) <a id="link17"></a>
**ArXiv ID:** 2604.02586
**Authors:** Daheng Yin, Isaac Ding, Yili Jin, Jianxin Shi, Jiangchuan Liu
...
**Comment:** This paper introduces TrackerSplat, a method for robust dynamic 3D Gaussian reconstruction using point tracking. While it is relevant to dynamic scene understanding and 3D reconstruction, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models.
**Relevance:** 4
**Novelty:** 6

---

## 18. [ProtoFlow: Mitigating Forgetting in Class-Incremental Remote Sensing Segmentation via Low-Curvature Prototype Flow](https://arxiv.org/abs/2604.03212) <a id="link18"></a>
**ArXiv ID:** 2604.03212
**Authors:** Jiekai Wu, Rong Fu, Chuangqi Li, Zijian Zhang, Guangxin Wu, Hao Zhang, Shiyin Lin, Jianyuan Ni, Yang Li, Dongxu Zhang, Amir H. Gandomi, Simon Fong, Pengbin Feng
...
**Comment:** This paper introduces ProtoFlow, a prototype dynamics framework for continual remote sensing segmentation. It models class prototypes as trajectories to mitigate forgetting. While it is a continual learning paper in vision, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models.
**Relevance:** 4
**Novelty:** 6

---

## 19. [InfoSeeker: A Scalable Hierarchical Parallel Agent Framework for Web Information Seeking](https://arxiv.org/abs/2604.02971) <a id="link19"></a>
**ArXiv ID:** 2604.02971
**Authors:** Ka Yiu Lee, Yuxuan Huang, Zhiyuan He, Huichi Zhou, Weilin Luo, Kun Shao, Meng Fang, Jun Wang
...
**Comment:** This paper presents a hierarchical agent framework for web information seeking, focusing on scalable information synthesis and parallel agentic reasoning. While it is about agentic systems and LLMs, it does not focus on spatial intelligence, VLLMs/MLLMs, embodied AI, or vision foundation models. It is more about web search and agentic LLMs.
**Relevance:** 4
**Novelty:** 6

---

## 20. [InverseDraping: Recovering Sewing Patterns from 3D Garment Surfaces via BoxMesh Bridging](https://arxiv.org/abs/2604.02764) <a id="link20"></a>
**ArXiv ID:** 2604.02764
**Authors:** Leyang Jin, Zirong Jin, Zisheng Ye, Haokai Pang, Xiaoguang Han, Yujian Zheng, Hao Li
...
**Comment:** This paper presents a two-stage framework for recovering sewing patterns from 3D garment surfaces. While it is a strong 3D vision and geometry paper, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 21. [Adaptive Local Frequency Filtering for Fourier-Encoded Implicit Neural Representations](https://arxiv.org/abs/2604.02846) <a id="link21"></a>
**ArXiv ID:** 2604.02846
**Authors:** Ligen Shi, Jun Qiu, Yuhang Zheng, Chang Liu
...
**Comment:** This paper proposes adaptive local frequency filtering for Fourier-encoded implicit neural representations, improving spatially varying signal modeling. While it is a methodological improvement in neural representations, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 22. [Factorized Multi-Resolution HashGrid for Efficient Neural Radiance Fields: Execution on Edge-Devices](https://arxiv.org/abs/2604.02836) <a id="link22"></a>
**ArXiv ID:** 2604.02836
**Authors:** Kim Jun-Seong, Mingyu Kim, GeonU Kim, Tae-Hyun Oh, Jin-Hwa Kim
...
**Comment:** This paper introduces a new parameter encoding for neural radiance fields (NeRFs) for efficient on-device execution. While it is a strong vision/3D representation paper, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models. It is more about efficient 3D representation.
**Relevance:** 3
**Novelty:** 6

---

## 23. [HairOrbit: Multi-view Aware 3D Hair Modeling from Single Portraits](https://arxiv.org/abs/2604.02867) <a id="link23"></a>
**ArXiv ID:** 2604.02867
**Authors:** Leyang Jin, Yujian Zheng, Bingkui Tong, Yuda Qiu, Zhenyu Xie, Hao Li
...
**Comment:** This paper presents a novel framework for 3D hair modeling from single images by leveraging multi-view priors and neural orientation extraction. While it is a strong computer vision paper, it does not directly address spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models. It is more about 3D reconstruction.
**Relevance:** 3
**Novelty:** 6

---

## 24. [The Eleventh NTIRE 2026 Efficient Super-Resolution Challenge Report](https://arxiv.org/abs/2604.03198) <a id="link24"></a>
**ArXiv ID:** 2604.03198
**Authors:** Bin Ren, Hang Guo, Yan Shu, Jiaqi Ma, Ziteng Cui, Shuhong Liu, Guofeng Mei, Lei Sun, Zongwei Wu, Fahad Shahbaz Khan, Salman Khan, Radu Timofte, Yawei Li, Hongyuan Yu, Pufan Xu, Chen Wu, Long Peng, Jiaojiao Yi, Siyang Yi, Yuning Cui, Jingyuan Xia, Xing Mou, Keji He, Jinlin Wu, Zongang Gao, Sen Yang, Rui Zheng, Fengguo Li, Yecheng Lei, Wenkai Min, Jie Liu, Keye Cao, Shubham Sharma, Manish Prasad, Haobo Li, Matin Fazel, Abdelhak Bentaleb, Rui Chen, Shurui Shi, Zitao Dai, Qingliang Liu, Yang Cheng, Jing Hu, Xuan Zhang, Rui Ding, Tingyi Zhang, Hui Deng, Mengyang Wang, Fulin Liu, Jing Wei, Qian Wang, Hongying Liu, Mingyang Li, Guanglu Dong, Zheng Yang, Chao Ren, Hongbo Fang, Lingxuan Li, Lin Si, Pan Gao, Moncef Gabbouj, Watchara Ruangsang, Supavadee Aramvith
...
**Comment:** Challenge report on efficient super-resolution. While relevant to computer vision, it does not match any specific criterion.
**Relevance:** 3
**Novelty:** 3
