# Personalized Daily ArXiv Papers 08/13/2026
...
0. [HUGIN: Enhancing Vision-Language Planning for Autonomous Logistics Sorting](#link0)
**Authors:** Xikai Sun, Cangtian Zhou, Kebin Liu, Ke Ma, Xu Wang, Zaishu Chen, Haotian Wang, Li Liu, Yunhao Liu

1. [GeoBridge: Decoupled Semantic Conditioning for Generative Image Geolocalization](#link1)
**Authors:** Zhiyang Dou, Xumeng Han, Fengde Peng, Zipeng Wang, Moxuan Zhao, Zhipei Huang, Zhenjun Han

2. [Apodex Discovery: Reality Benchmarks and Environments for Evaluating and Building Discoverative Artificial Intelligence](#link2)
...
3. [DreamFly: Causal Memory and Receding-Horizon Diffusion Planning for Aerial Vision-Language Navigation](#link3)
**Authors:** Yan Deng, Fei Xu

4. [VOLA: Improving Open-World Driving by VLM-Based Semantic Attribute Prediction](#link4)
**Authors:** Yuchen Zhang, Yuan Gao, Sebastian Schmidt, Johannes Betz

5. [LookBack: Where and How to Score LVLM Responses via Visual Reference Usage](#link5)
**Authors:** Beomsik Cho, Jinhyeong Kim, Dongseok Lee, Jaehyung Kim

6. [Do You See What You Draw? A Semantic Closed-Loop Framework for Holistic Evaluation of Unified Multimodal Models](#link6)
**Authors:** Hao Zhang, Jiaxin Qi, Zhijiang Tang, Jianqiang Huang

7. [Diagram-MMU: A Multi-Modal Benchmark for Scientific Diagrams](#link7)
**Authors:** Weihao Bo, Shan Zhang, Yanpeng Sun, Jie Liu, Yongke Yao, Jinhao Du, Wei He, Kai Zou, Zechao Li, Jingdong Wang

8. [STAR: A Spatial-Topology Aware Routing Framework for Generalizable 3D Scene Understanding](#link8)
**Authors:** Mingwei Xing, Xinliang Wang, Yifeng Shi

9. [Map-Det3D: Metric Feed-Forward 3D Reconstruction Prior for Multi-view 3D Object Detection from Streaming Inputs](#link9)
**Authors:** Yung-Hsu Yang, Luigi Piccinelli, Samuel Rota Bul\`o, Sunghwan Hong, Denis Rozumny, Johannes Sch\"onberger, Zuria Bauer, Hermann Blum, Peter Kontschieder, Marc Pollefeys

10. [Motion-as-Prompt: Enhancing Motion Reasoning in Multimodal Large Language Models via Motion-Guided Cross-Frame Visual Prompting](#link10)
**Authors:** Xikai Sun, Kebin Liu, Haotian Wang, Li Liu, Xu Wang, Yunhao Liu

11. [Repurposing RGB-based Foundation Model for Depth Estimation on Thermal Images Using Hierarchical Supervision](#link11)
**Authors:** Jie Hong, Tingtian Li, Xuesong Li, Xiao Li

12. [Zero-OVCD: Bridging Training-Free Foundation Models and Pseudo-Label Learning for Open-Vocabulary Change Detection](#link12)
**Authors:** Daifeng Peng, Yuanke Peng, Haiyan Guan

13. [How Can Driving World Models Do Counterfactual Prediction?](#link13)
**Authors:** Jiaru Zhang, Can Cui, Yi Xu, Xin Ye, Ruqi Zhang, Ziran Wang

14. [Warping Earth Observations for better ice labeling in the Marginal Marginal Ice Zone](#link14)
**Authors:** Tom Kelly, Martin S. J. Rogers

15. [GeoFlow: Efficient Driving Video Generation via Geometry-Aligned Priors](#link15)
**Authors:** Jiazheng Liu, Hang Li, Jiawei Zhang, Jiahe Li, Xiaohan Yu, Shengyin Fan, Jin Zheng, Xiao Bai

16. [Better Slots, Better Worlds: Representation Quality & Robustness in Object-Centric World Models](#link16)
**Authors:** Shukrullo Nazirjonov, Sai Prasanna, Anna Manasyan, Georg Martius

17. [Benchmarking LLM Judges for Mobile Agent Evaluation](#link17)
**Authors:** Ziqiang Wan, Li Gu, Zhixiang Chi, Zhi Liu, Seyed Mehdi Ayyoubzadeh, Yuanhao Yu, Yang Wang

18. [EGM-Det: Entropy-Guided Multimodal Adaptive Fusion for UAV RGB-IR Object Detection](#link18)
**Authors:** Cunzheng Fan, Dawei Yan, Guanlin Wang, Xingshuo Yang, Yupeng Jia, Jing Yang, Haokui Zhang

19. [Generative Video Compression Based on Hierarchical Referencing](#link19)
**Authors:** Daowen Li, Ding Ding, Zifu Zhang, Kai Li, Ying Chen

20. [TangPoetryBench: A Multi-Dimensional Benchmark and Rubric-Conditioned Evaluator for Poetry-to-Image Generation](#link20)
**Authors:** Haoqi Hu, Tongji Luo, Li Zhang, Boning Zhou

---
## 0. [HUGIN: Enhancing Vision-Language Planning for Autonomous Logistics Sorting](https://arxiv.org/abs/2608.11692) <a id="link0"></a>
**ArXiv ID:** 2608.11692
**Authors:** Xikai Sun, Cangtian Zhou, Kebin Liu, Ke Ma, Xu Wang, Zaishu Chen, Haotian Wang, Li Liu, Yunhao Liu
...
**Comment:** Matches criterion 3 very closely: embodied AI paper building a new simulator-related benchmark (SortingBench) and proposing a new VLM planning method for spatially disjoint multi-scene understanding.
**Relevance:** 9
**Novelty:** 6

---

## 1. [GeoBridge: Decoupled Semantic Conditioning for Generative Image Geolocalization](https://arxiv.org/abs/2608.11838) <a id="link1"></a>
**ArXiv ID:** 2608.11838
**Authors:** Zhiyang Dou, Xumeng Han, Fengde Peng, Zipeng Wang, Moxuan Zhao, Zhipei Huang, Zhenjun Han
...
**Comment:** Matches criterion 2 closely: a new MLLM-based generative geolocalization pipeline with a frozen semantic MLLM and geometry-aware decoding.
**Relevance:** 7
**Novelty:** 7

---

## 2. [Apodex Discovery: Reality Benchmarks and Environments for Evaluating and Building Discoverative Artificial Intelligence](https://arxiv.org/abs/2608.11341) <a id="link2"></a>
**ArXiv ID:** 2608.11341
**Authors:** Brian Wang, Bin Feng, Xiaoman Pan, Chenyang An, Felix Liu, Tangqi Fang, Gongbo Sun, Lingfeng Shen, Ning Wang, Handuo Zhang, Feng Chen, Fuchao Yang, Xiang Wang, Jiacheng Lin, Siting Li, Zixuan Liu, Chi Han, Zhenhailong Wang, Kunlun Zhu, Lawrence Zhao, Yueqi Guo, Kailong Wen, Feng Xing, Yiling Guo, Lidong Bing, David Tan, Bo An, Heng Ji, Sheng Wang
...
**Comment:** Matches criterion 3 closely: it builds new benchmarks/environments for discoverative AI with explicit simulation, verification, and tool use.
**Relevance:** 7
**Novelty:** 7

---

## 3. [DreamFly: Causal Memory and Receding-Horizon Diffusion Planning for Aerial Vision-Language Navigation](https://arxiv.org/abs/2608.12308) <a id="link3"></a>
**ArXiv ID:** 2608.12308
**Authors:** Yan Deng, Fei Xu
...
**Comment:** Matches criterion 3 very closely: it is an embodied AI navigation method for aerial vision-language navigation with new memory, planning, and stop prediction components.
**Relevance:** 8
**Novelty:** 6

---

## 4. [VOLA: Improving Open-World Driving by VLM-Based Semantic Attribute Prediction](https://arxiv.org/abs/2608.11777) <a id="link4"></a>
**ArXiv ID:** 2608.11777
**Authors:** Yuchen Zhang, Yuan Gao, Sebastian Schmidt, Johannes Betz
...
**Comment:** Matches criterion 1 very closely: it proposes a new spatially dense, action-relevant representation for open-world driving using VLM image-token features, aimed at embodied driving intelligence.
**Relevance:** 8
**Novelty:** 6

---

## 5. [LookBack: Where and How to Score LVLM Responses via Visual Reference Usage](https://arxiv.org/abs/2608.11847) <a id="link5"></a>
**ArXiv ID:** 2608.11847
**Authors:** Beomsik Cho, Jinhyeong Kim, Dongseok Lee, Jaehyung Kim
...
**Comment:** Matches criterion 2 closely: a new training-free LVLM response scoring method that specifically measures visual reference usage in the model’s outputs.
**Relevance:** 7
**Novelty:** 6

---

## 6. [Do You See What You Draw? A Semantic Closed-Loop Framework for Holistic Evaluation of Unified Multimodal Models](https://arxiv.org/abs/2608.11907) <a id="link6"></a>
**ArXiv ID:** 2608.11907
**Authors:** Hao Zhang, Jiaxin Qi, Zhijiang Tang, Jianqiang Huang
...
**Comment:** Matches criterion 2 closely: it introduces a new evaluation framework for unified multimodal models that combines understanding and generation in a closed loop.
**Relevance:** 6
**Novelty:** 6

---

## 7. [Diagram-MMU: A Multi-Modal Benchmark for Scientific Diagrams](https://arxiv.org/abs/2608.12262) <a id="link7"></a>
**ArXiv ID:** 2608.12262
**Authors:** Weihao Bo, Shan Zhang, Yanpeng Sun, Jie Liu, Yongke Yao, Jinhao Du, Wei He, Kai Zou, Zechao Li, Jingdong Wang
...
**Comment:** Matches criterion 2 closely: it is a new multi-modal benchmark for evaluating MLLMs on scientific diagram parsing, editing, and diagram QA.
**Relevance:** 7
**Novelty:** 5

---

## 8. [STAR: A Spatial-Topology Aware Routing Framework for Generalizable 3D Scene Understanding](https://arxiv.org/abs/2608.11699) <a id="link8"></a>
**ArXiv ID:** 2608.11699
**Authors:** Mingwei Xing, Xinliang Wang, Yifeng Shi
...
**Comment:** Matches criterion 1 closely: it introduces a spatial-topology aware framework for generalizable 3D scene understanding, explicitly targeting cross-domain spatial reasoning in 3D.
**Relevance:** 6
**Novelty:** 6

---

## 9. [Map-Det3D: Metric Feed-Forward 3D Reconstruction Prior for Multi-view 3D Object Detection from Streaming Inputs](https://arxiv.org/abs/2608.12179) <a id="link9"></a>
**ArXiv ID:** 2608.12179
**Authors:** Yung-Hsu Yang, Luigi Piccinelli, Samuel Rota Bul\`o, Sunghwan Hong, Denis Rozumny, Johannes Sch\"onberger, Zuria Bauer, Hermann Blum, Peter Kontschieder, Marc Pollefeys
...
**Comment:** Matches criterion 1 closely: it proposes a new method for metric 3D reconstruction priors to improve online multi-view 3D object detection for embodied agents, with a clear spatial understanding angle.
**Relevance:** 6
**Novelty:** 6

---

## 10. [Motion-as-Prompt: Enhancing Motion Reasoning in Multimodal Large Language Models via Motion-Guided Cross-Frame Visual Prompting](https://arxiv.org/abs/2608.11655) <a id="link10"></a>
**ArXiv ID:** 2608.11655
**Authors:** Xikai Sun, Kebin Liu, Haotian Wang, Li Liu, Xu Wang, Yunhao Liu
...
**Comment:** Matches criterion 2 and criterion 1: a new MLLM prompting method that improves motion reasoning in video understanding, especially for movement and interaction reasoning.
**Relevance:** 6
**Novelty:** 5

---

## 11. [Repurposing RGB-based Foundation Model for Depth Estimation on Thermal Images Using Hierarchical Supervision](https://arxiv.org/abs/2608.11564) <a id="link11"></a>
**ArXiv ID:** 2608.11564
**Authors:** Jie Hong, Tingtian Li, Xuesong Li, Xiao Li
...
**Comment:** Matches criterion 4 closely: it repurposes an RGB foundation model for thermal depth estimation using hierarchical supervision.
**Relevance:** 6
**Novelty:** 5

---

## 12. [Zero-OVCD: Bridging Training-Free Foundation Models and Pseudo-Label Learning for Open-Vocabulary Change Detection](https://arxiv.org/abs/2608.11663) <a id="link12"></a>
**ArXiv ID:** 2608.11663
**Authors:** Daifeng Peng, Yuanke Peng, Haiyan Guan
...
**Comment:** Matches criterion 4 closely: it uses foundation-model-based pseudo-labeling for open-vocabulary change detection, a clear vision foundation model application.
**Relevance:** 6
**Novelty:** 5

---

## 13. [How Can Driving World Models Do Counterfactual Prediction?](https://arxiv.org/abs/2608.11601) <a id="link13"></a>
**ArXiv ID:** 2608.11601
**Authors:** Jiaru Zhang, Can Cui, Yi Xu, Xin Ye, Ruqi Zhang, Ziran Wang
...
**Comment:** Matches criterion 3 somewhat: it builds a controlled benchmark for counterfactual prediction in driving world models and exposes a failure mode in current approaches.
**Relevance:** 5
**Novelty:** 6

---

## 14. [Warping Earth Observations for better ice labeling in the Marginal Marginal Ice Zone](https://arxiv.org/abs/2608.11883) <a id="link14"></a>
**ArXiv ID:** 2608.11883
**Authors:** Tom Kelly, Martin S. J. Rogers
...
**Comment:** Matches criterion 4 closely: it develops a multimodal satellite image alignment method and a sparse expert-labeled benchmark for dense segmentation under modality misalignment.
**Relevance:** 5
**Novelty:** 6

---

## 15. [GeoFlow: Efficient Driving Video Generation via Geometry-Aligned Priors](https://arxiv.org/abs/2608.12203) <a id="link15"></a>
**ArXiv ID:** 2608.12203
**Authors:** Jiazheng Liu, Hang Li, Jiawei Zhang, Jiahe Li, Xiaohan Yu, Shengyin Fan, Jin Zheng, Xiao Bai
...
**Comment:** Matches criterion 4 moderately: vision foundation/generative modeling applied to driving video generation with geometry-aligned priors, though it is more a domain-specific generative method than a foundation model advance.
**Relevance:** 4
**Novelty:** 6

---

## 16. [Better Slots, Better Worlds: Representation Quality & Robustness in Object-Centric World Models](https://arxiv.org/abs/2608.12078) <a id="link16"></a>
**ArXiv ID:** 2608.12078
**Authors:** Shukrullo Nazirjonov, Sai Prasanna, Anna Manasyan, Georg Martius
...
**Comment:** Matches criterion 3 somewhat and criterion 4 indirectly: it studies object-centric world models for visual planning, robustness, and the role of pretrained features in scene understanding.
**Relevance:** 5
**Novelty:** 5

---

## 17. [Benchmarking LLM Judges for Mobile Agent Evaluation](https://arxiv.org/abs/2608.11434) <a id="link17"></a>
**ArXiv ID:** 2608.11434
**Authors:** Ziqiang Wan, Li Gu, Zhixiang Chi, Zhi Liu, Seyed Mehdi Ayyoubzadeh, Yuanhao Yu, Yang Wang
...
**Comment:** Matches criterion 3 loosely: benchmark for evaluating LLM-as-judge methods on mobile agent trajectories, relevant to embodied agent evaluation rather than new agent methods.
**Relevance:** 4
**Novelty:** 5

---

## 18. [EGM-Det: Entropy-Guided Multimodal Adaptive Fusion for UAV RGB-IR Object Detection](https://arxiv.org/abs/2608.11685) <a id="link18"></a>
**ArXiv ID:** 2608.11685
**Authors:** Cunzheng Fan, Dawei Yan, Guanlin Wang, Xingshuo Yang, Yupeng Jia, Jing Yang, Haokui Zhang
...
**Comment:** Matches criterion 1 moderately: methodological improvement for spatially varying multimodal fusion in UAV RGB-IR perception, which is spatial understanding for embodied/robotic sensing but not a direct embodied-agent paper.
**Relevance:** 4
**Novelty:** 5

---

## 19. [Generative Video Compression Based on Hierarchical Referencing](https://arxiv.org/abs/2608.11618) <a id="link19"></a>
**ArXiv ID:** 2608.11618
**Authors:** Daowen Li, Ding Ding, Zifu Zhang, Kai Li, Ying Chen
...
**Comment:** Matches criterion 4 loosely: diffusion-based generative video compression is a vision/generative-model application, though not a core foundation-model paper.
**Relevance:** 4
**Novelty:** 5

---

## 20. [TangPoetryBench: A Multi-Dimensional Benchmark and Rubric-Conditioned Evaluator for Poetry-to-Image Generation](https://arxiv.org/abs/2608.11452) <a id="link20"></a>
**ArXiv ID:** 2608.11452
**Authors:** Haoqi Hu, Tongji Luo, Li Zhang, Boning Zhou
...
**Comment:** Matches criterion 4 loosely: vision foundation model application in text-to-image generation and evaluation, but centered on a literary benchmark rather than a foundation-model method.
**Relevance:** 3
**Novelty:** 5
