...
0. [SAMRI-3D: Adapting SAM2 for 3D MRI Segmentation with Global Volume Tokens](#link0)
**Authors:** Zhao Wang, Wei Dai, Hongfu Sun, Craig Engstrom, Shekhar S. Chandra

1. [HarmoHOI: Harmonizing Appearance and 3D Motion for Multi-view Hand-Object Interaction Synthesis](#link1)
**Authors:** Lingwei Dang, Juntong Li, Zonghan Li, Hongwen Zhang, Liang An, Wei Min, Yebin Liu, Qingyao Wu

2. [SciForma: Structure-Faithful Generation of Scientific Diagrams](#link2)
**Authors:** Yuxuan Luo, Peng Zhang, Xinjie Zhang, Xun Guo, Zhouhui Lian, Yan Lu

3. [RegionFM: Interpretable Region-Based Brain MRI Classification Using Foundation Model Embeddings](#link3)
**Authors:** Wei Zhang

4. [Understanding From Human Perspective: A Multi-agent System for Interactive Egocentric Medical Image Segmentation](#link4)
**Authors:** Rongjun Ge, Dongyang Wang, Heng Zhu, Zhirui Li, Yang Chen, Yuting He

5. [DepthART: Scaling Foundation Monocular Depth to Tiny Models](#link5)
...
6. [HOMIE: Human-object Centric Video Personalization via Multimodal Intelligent Enchancement](#link6)
...
7. [Pailitao-MMSearch: Building Native E-Commerce Multimodal Search Foundation](#link7)
...
8. [Consistent Feature Transport for Image Relighting](#link8)
**Authors:** Bohan Zhang, Huanwei Liang, Yuhan He, Hongteng Xu, Quxiao Chao, Luoqi Liu, Dixin Luo, Ting Liu

9. [Simple Domain Generalization for Strong Pixel-Level Image Tampering Detection in Modern VLMs](#link9)
...
10. [STAR: Skeletal Token Alignment and Rearrangement for Interaction Recognition](#link10)
**Authors:** Yuhang Wen, Mengyuan Liu, Zixuan Tang, Junsong Yuan, Sirui Li, Beichen Ding

11. [TopoGS: Planar Reconstruction via Topology-aware 3D Gaussian Splatting](#link11)
**Authors:** Shanshan Pan, Jiale Chen, Yilin Liu, Hui Huang

12. [From Modalities to Propositions: A Language-Centric Framework for Multimodal Intelligence](#link12)
...
13. [STBridge: Shared-Target Alignment for Bridging Understanding and Generation in UMMs](#link13)
**Authors:** Ye Wang, Hongjun Wang, Hao Fang, Tongyuan Bai, Zuwei Long, Peixian Chen, Wei Liu, Weibo Gu, Xing Sun, Rui Ma

14. [Dynamic Defense Profiling Enables Cognitive Jailbreak of Text-to-Image Models](#link14)
**Authors:** Dongdong Yang, Deyue Zhang, Zhao Liu, Zonghao Ying, Wenzhuo Xu, Jiankai Jin, Xiangzheng Zhang, Quanchen Zou

15. [MixDiffusion: Mixing Diffusion-based Uni-condition Text-to-Image Generation Models for Multi-condition Image Synthesis](#link15)
**Authors:** Pengcheng Wan, Liang Han, Lin Xu, Bowen Xiao, Liqiang Nie

16. [Diversity-Oriented Fine-Tuning for Uncertainty-Based Hallucination Detection](#link16)
**Authors:** Qiuyuan Li, Hongliang Dai, Piji Li

17. [SpEmoC: A Balanced Speaker-Segment Multimodal Emotion Benchmark](#link17)
**Authors:** Sania Bano, Shahzad Ahmad, Santosh Kumar Vipparthi, Sukalpa Chanda, Subrahmanyam Murala

18. [Localization-Infused Vision-Language Semantic Fusion for Text-Guided Medical Image Segmentation](#link18)
**Authors:** Songyue Han, Mingye Zou, Shuchang Ye, Lei Bi, Mingyuan Meng

19. [Is Progressive Disclosure All You Need for Long-Context Agents?](#link19)
**Authors:** Yifeng He, Yinzhe Zhao, Jicheng Wang, Hao Chen

---
## 0. [SAMRI-3D: Adapting SAM2 for 3D MRI Segmentation with Global Volume Tokens](https://arxiv.org/abs/2607.18014) <a id="link0"></a>
**ArXiv ID:** 2607.18014
**Authors:** Zhao Wang, Wei Dai, Hongfu Sun, Craig Engstrom, Shekhar S. Chandra
...
**Comment:** Matches criterion 4 very closely: it adapts a vision foundation model (SAM2) to 3D MRI segmentation and introduces a new benchmark plus a zero-cost token-based method.
**Relevance:** 8
**Novelty:** 7

---

## 1. [HarmoHOI: Harmonizing Appearance and 3D Motion for Multi-view Hand-Object Interaction Synthesis](https://arxiv.org/abs/2607.17097) <a id="link1"></a>
**ArXiv ID:** 2607.17097
**Authors:** Lingwei Dang, Juntong Li, Zonghan Li, Hongwen Zhang, Liang An, Wei Min, Yebin Liu, Qingyao Wu
...
**Comment:** Matches criterion 3 very closely: it is an embodied-AI-adjacent HOI synthesis method with a strong simulator/generation angle and multi-view 3D motion consistency, emphasizing a novel geometry-aware direction.
**Relevance:** 7
**Novelty:** 7

---

## 2. [SciForma: Structure-Faithful Generation of Scientific Diagrams](https://arxiv.org/abs/2607.18091) <a id="link2"></a>
**ArXiv ID:** 2607.18091
**Authors:** Yuxuan Luo, Peng Zhang, Xinjie Zhang, Xun Guo, Zhouhui Lian, Yan Lu
...
**Comment:** Matches criterion 2 and criterion 4 very closely: it introduces a new generative model and benchmark for structure-faithful scientific diagram generation.
**Relevance:** 6
**Novelty:** 7

---

## 3. [RegionFM: Interpretable Region-Based Brain MRI Classification Using Foundation Model Embeddings](https://arxiv.org/abs/2607.16325) <a id="link3"></a>
**ArXiv ID:** 2607.16325
**Authors:** Wei Zhang
...
**Comment:** Matches criterion 4 very closely: it applies foundation-model embeddings to a medical vision task with an anatomically interpretable design.
**Relevance:** 6
**Novelty:** 5

---

## 4. [Understanding From Human Perspective: A Multi-agent System for Interactive Egocentric Medical Image Segmentation](https://arxiv.org/abs/2607.17341) <a id="link4"></a>
**ArXiv ID:** 2607.17341
**Authors:** Rongjun Ge, Dongyang Wang, Heng Zhu, Zhirui Li, Yang Chen, Yuting He
...
**Comment:** Matches criterion 3 very closely: an embodied/interactive segmentation method for egocentric video with a multi-agent workflow.
**Relevance:** 6
**Novelty:** 5

---

## 5. [DepthART: Scaling Foundation Monocular Depth to Tiny Models](https://arxiv.org/abs/2607.17099) <a id="link5"></a>
**ArXiv ID:** 2607.17099
**Authors:** Feng Xue, Wu Chen, Mingshuai Zhao, Guofeng Zhong, Anlong Ming, Haozhe Wang, Dianqiao Lei, Zhaowen Lin, Haiyang Zhang, Nicu Sebe
...
**Comment:** Matches criterion 4 well: it advances a geometric vision foundation-model line for monocular depth estimation by scaling it to tiny on-device models.
**Relevance:** 5
**Novelty:** 6

---

## 6. [HOMIE: Human-object Centric Video Personalization via Multimodal Intelligent Enchancement](https://arxiv.org/abs/2607.18217) <a id="link6"></a>
**ArXiv ID:** 2607.18217
**Authors:** Yiyang Cai, Nan Chen, Rongchang Xie, Junwen Pan, Chunyang Jiang, Cheng Chen, Wen Zhou, Zhenbang Sun, Wei Xue, Wenhan Luo, Yike Guo
...
**Comment:** Matches criterion 2 very closely: it proposes a new MLLM-integrated framework for human-object centric video personalization.
**Relevance:** 5
**Novelty:** 6

---

## 7. [Pailitao-MMSearch: Building Native E-Commerce Multimodal Search Foundation](https://arxiv.org/abs/2607.17499) <a id="link7"></a>
**ArXiv ID:** 2607.17499
**Authors:** Xiaohan Ye, Xu Chen, Zihan Gong, Jian Ding, Lianyu Du, Baicheng Chen, Yunmeng Shu, Jingqian Zhao, Zhixiang Zhao, Shuaiqi Jia, Chong Ma, Shuwen Xiao, Xiangheng Kong, Yuan Gao, Jun Song, Jinsong Lan, Xiaoyong Zhu, Bo Zheng
...
**Comment:** Matches criterion 2 closely: this is a new native multimodal foundation model for e-commerce multimodal search.
**Relevance:** 5
**Novelty:** 6

---

## 8. [Consistent Feature Transport for Image Relighting](https://arxiv.org/abs/2607.17833) <a id="link8"></a>
**ArXiv ID:** 2607.17833
**Authors:** Bohan Zhang, Huanwei Liang, Yuhan He, Hongteng Xu, Quxiao Chao, Luoqi Liu, Dixin Luo, Ting Liu
...
**Comment:** Matches criterion 4 moderately well: it is a vision foundation-model-adjacent generative editing method for image relighting, with a new transport formulation.
**Relevance:** 4
**Novelty:** 6

---

## 9. [Simple Domain Generalization for Strong Pixel-Level Image Tampering Detection in Modern VLMs](https://arxiv.org/abs/2607.18230) <a id="link9"></a>
**ArXiv ID:** 2607.18230
**Authors:** Yi Tang, Xinyi Shang, Jiacheng Cui, Sondos Mahmoud Bsharat, Jiacheng Liu, Xiaohan Zhao, Tran Dinh Tien, Ahmed Elhagry, Salwa K. Al Khatib, Tianjun Yao, Yonina C. Eldar, Jing-Hao Xue, Hao Li, Salman Khan, Zhiqiang Shen
...
**Comment:** Matches criterion 4: it is about robust pixel-level tampering detection on modern VLM-generated images, an application built around vision-language foundation models.
**Relevance:** 5
**Novelty:** 5

---

## 10. [STAR: Skeletal Token Alignment and Rearrangement for Interaction Recognition](https://arxiv.org/abs/2607.17342) <a id="link10"></a>
**ArXiv ID:** 2607.17342
**Authors:** Yuhang Wen, Mengyuan Liu, Zixuan Tang, Junsong Yuan, Sirui Li, Beichen Ding
...
**Comment:** Matches criterion 3: this is an embodied/3D interaction recognition method using skeletal + RGB cues for human-robot and human-human interactions.
**Relevance:** 5
**Novelty:** 5

---

## 11. [TopoGS: Planar Reconstruction via Topology-aware 3D Gaussian Splatting](https://arxiv.org/abs/2607.16838) <a id="link11"></a>
**ArXiv ID:** 2607.16838
**Authors:** Shanshan Pan, Jiale Chen, Yilin Liu, Hui Huang
...
**Comment:** Only a partial match to criterion 4: it is a 3D reconstruction method, but it does not center on vision foundation models or embodied agents.
**Relevance:** 3
**Novelty:** 6

---

## 12. [From Modalities to Propositions: A Language-Centric Framework for Multimodal Intelligence](https://arxiv.org/abs/2607.16560) <a id="link12"></a>
**ArXiv ID:** 2607.16560
**Authors:** Nadine Chang, Maying Shen, Shizhe Diao, Jialiang Wang, Jingde Chen, Thomas Breuel, Pavlo Molchanov, Rafid Mahmood, Jose M. Alvarez
...
**Comment:** No very close match to the listed criteria; it is a multimodal intelligence framework, but not clearly a new VLLM/MLLM or embodied-AI benchmark/method in the sense of criteria 2 or 3.
**Relevance:** 3
**Novelty:** 6

---

## 13. [STBridge: Shared-Target Alignment for Bridging Understanding and Generation in UMMs](https://arxiv.org/abs/2607.17140) <a id="link13"></a>
**ArXiv ID:** 2607.17140
**Authors:** Ye Wang, Hongjun Wang, Hao Fang, Tongyuan Bai, Zuwei Long, Peixian Chen, Wei Liu, Weibo Gu, Xing Sun, Rui Ma
...
**Comment:** Matches criterion 2 and criterion 4 somewhat: it studies unified multimodal models and their understanding-generation alignment for image editing.
**Relevance:** 4
**Novelty:** 5

---

## 14. [Dynamic Defense Profiling Enables Cognitive Jailbreak of Text-to-Image Models](https://arxiv.org/abs/2607.17779) <a id="link14"></a>
**ArXiv ID:** 2607.17779
**Authors:** Dongdong Yang, Deyue Zhang, Zhao Liu, Zonghao Ying, Wenzhuo Xu, Jiankai Jin, Xiangzheng Zhang, Quanchen Zou
...
**Comment:** Matches criterion 4 only indirectly: it studies attacks on text-to-image models, which are vision generative models, but the paper is primarily about jailbreaks and safety rather than foundation-model applications.
**Relevance:** 3
**Novelty:** 6

---

## 15. [MixDiffusion: Mixing Diffusion-based Uni-condition Text-to-Image Generation Models for Multi-condition Image Synthesis](https://arxiv.org/abs/2607.17634) <a id="link15"></a>
**ArXiv ID:** 2607.17634
**Authors:** Pengcheng Wan, Liang Han, Lin Xu, Bowen Xiao, Liqiang Nie
...
**Comment:** Matches criterion 4 loosely: it is a diffusion-based multi-condition image synthesis method, but it is not specifically a vision foundation model paper.
**Relevance:** 3
**Novelty:** 5

---

## 16. [Diversity-Oriented Fine-Tuning for Uncertainty-Based Hallucination Detection](https://arxiv.org/abs/2607.16643) <a id="link16"></a>
**ArXiv ID:** 2607.16643
**Authors:** Qiuyuan Li, Hongliang Dai, Piji Li
...
**Comment:** No close match to the listed criteria; it is about hallucination detection fine-tuning for multimodal/LLM outputs, which is adjacent to criterion 2 but not a new VLLM/MLLM method itself.
**Relevance:** 3
**Novelty:** 4

---

## 17. [SpEmoC: A Balanced Speaker-Segment Multimodal Emotion Benchmark](https://arxiv.org/abs/2607.18109) <a id="link17"></a>
**ArXiv ID:** 2607.18109
**Authors:** Sania Bano, Shahzad Ahmad, Santosh Kumar Vipparthi, Sukalpa Chanda, Subrahmanyam Murala
...
**Comment:** No very close match to the listed criteria; it is a multimodal emotion benchmark, which is adjacent to multimodal learning but not specifically criterion 2, 3, or 4.
**Relevance:** 3
**Novelty:** 4

---

## 18. [Localization-Infused Vision-Language Semantic Fusion for Text-Guided Medical Image Segmentation](https://arxiv.org/abs/2607.16327) <a id="link18"></a>
**ArXiv ID:** 2607.16327
**Authors:** Songyue Han, Mingye Zou, Shuchang Ye, Lei Bi, Mingyuan Meng
...
**Comment:** Matches criterion 4 loosely: this is a vision-language method for text-guided medical image segmentation, an application of multimodal models rather than a foundation model paper.
**Relevance:** 3
**Novelty:** 4

---

## 19. [Is Progressive Disclosure All You Need for Long-Context Agents?](https://arxiv.org/abs/2607.17598) <a id="link19"></a>
**ArXiv ID:** 2607.17598
**Authors:** Yifeng He, Yinzhe Zhao, Jicheng Wang, Hao Chen
...
**Comment:** Matches criterion 3 only loosely: it studies agentic long-context document navigation and progressive disclosure, but it is not an embodied AI benchmark/method paper.
**Relevance:** 3
**Novelty:** 4
