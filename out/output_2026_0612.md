...
<main class="daily-arxiv">
  <section class="hero">
    <div>
      <p class="eyebrow">Daily ArXiv / June 12, 2026</p>
    ...
    <details class="paper-row" id="link0">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>SpatialClaw: Rethinking Action Interface for Agentic Spatial Reasoning</strong>
          <small>Seokju Cho, Ryo Hachiuma, Abhishek Badki, Hang Su, Byung-Kwan Lee, Chan Hee Song, Sifei Liu, Subhashree Radhakrishnan, Seungryong Kim, Yu-Chiang Frank Wang, Min-Hung Chen</small>
...
<span class="category-tag">cs.AI</span>
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 1 / arXiv:2606.13673</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.13673">Open arXiv</a>
        </div>
        ...
        <p class="comment"><strong>Why selected:</strong> Matches criterion 1 very closely: it proposes a new action interface for agentic spatial reasoning, specifically targeting open-ended 3D/4D spatial understanding.</p>
    ...
    <details class="paper-row" id="link1">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>HYDRA-X: Native Unified Multimodal Models with Holistic Visual Tokenizers</strong>
          <small>Guozhen Zhang, Xuerui Qiu, Yutao Cui, Tianhui Song, Changlin Li, Junzhe Li, Tao Huang, Xiao Zhang, Yang Li, Jianbing Wu, Miles Yang, Zhao Zhong, Liefeng Bo, Limin Wang</small>
...
<span class="category-tag">cs.AI</span>
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 2 / arXiv:2606.13289</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.13289">Open arXiv</a>
        </div>
    ...
    <details class="paper-row" id="link3">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>Language-Guided Abstraction for Visual Reasoning</strong>
          <small>Xu-Jing Ye, Yuan-Gen Wang, Ruping Wang</small>

    <div class="topic-tags" aria-label="fine-grained topic tags">
      <span class="topic-tag">Visual Reasoning</span>
<span class="topic-tag">Language-Guided Learning</span>
<span class="topic-tag">ARC</span>
    </div>
    ...
    <div class="category-tags" aria-label="arXiv categories">
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 4 / arXiv:2606.12847</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.12847">Open arXiv</a>
        </div>
        ...
        <p class="comment"><strong>Why selected:</strong> Matches criterion 1: it proposes a new method for visual reasoning that injects language-guided abstraction into an ARC-style setting.</p>
    ...
    <details class="paper-row" id="link5">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>HairPort: In-context 3D-aware Hair Import and Transfer for Images</strong>
          <small>Alireza Heidari, Amirhossein Alimohammadi, Wallace Michel Pinto Lira, Adi Bar-Lev, Ali Mahdavi-Amiri</small>
...
<span class="category-tag">cs.GR</span>
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 6 / arXiv:2606.12562</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.12562">Open arXiv</a>
        </div>
        ...
        <p class="comment"><strong>Why selected:</strong> Matches criterion 4: vision foundation models are used for 3D-aware hairstyle import/transfer, with a new bald-conversion dataset and a generative pipeline.</p>
    ...
    <details class="paper-row" id="link9">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>Visual Place Recognition in Forests with Depth-Aware Distillation</strong>
...
<span class="topic-tag">Depth Distillation</span>
    </div>
...
<span class="category-tag">cs.RO</span>
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 10 / arXiv:2606.13206</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.13206">Open arXiv</a>
        </div>
    ...
    <details class="paper-row" id="link6">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>GRIP: Feedback-Guided Prompt Retrieval for Large Multimodal Models</strong>
          <small>Garvita Allabadi, Matteo Sodano, Roberto Estev\~ao, Yuxiong Wang, Vikram Adve, Emre Kiciman, Ranveer Chandra</small>
...
<span class="topic-tag">Retrieval</span>
    ...
    <div class="category-tags" aria-label="arXiv categories">
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 7 / arXiv:2606.12744</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.12744">Open arXiv</a>
        </div>
        ...
        <p class="comment"><strong>Why selected:</strong> Matches criterion 2: it is about large multimodal models and a new retrieval method for multimodal in-context learning.</p>
    ...
    <details class="paper-row" id="link10">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>Dual-State Slot Attention: Decoupling Appearance and Identity for Video Object-Centric Learning</strong>
          <small>Sieu Tran, Duc Nguyen, Hao Vo, Khoa Vo, Ngan Le</small>
...
<span class="topic-tag">Self-Supervised Learning</span>
    ...
    <div class="category-tags" aria-label="arXiv categories">
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 11 / arXiv:2606.12601</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.12601">Open arXiv</a>
        </div>
    ...
    <details class="paper-row" id="link11">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>DIMOS: Disentangling Instance-level Moving Object Segmentation</strong>
          <small>Hongxiang Huang, Hongwei Ren, Xiaopeng Lin, Yulong Huang, Zeke Xie, Bojun Cheng</small>

    <div class="topic-tags" aria-label="fine-grained topic tags">
      <span class="topic-tag">Event Cameras</span>
<span class="topic-tag">Moving Object Segmentation</span>
...
<span class="category-tag">cs.AI</span>
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 12 / arXiv:2606.12826</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.12826">Open arXiv</a>
        </div>
    ...
    <details class="topic-section" open>
      <summary class="topic-heading">Grounded Learning</summary>
      <div class="queue">
    ...
    <details class="paper-row" id="link12">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>Objects Before Words: Object-First Inductive Biases for Grounding Language in Child-View Video</strong>
          <small>Sathira Silva, Abrham Kahsay Gebreselasie, Muhammad Umer Sheikh, Kartik Kuckreja, Daniel Harari, Muhammad Haris Khan</small>

    <div class="topic-tags" aria-label="fine-grained topic tags">
      <span class="topic-tag">Grounded Learning</span>
<span class="topic-tag">Object-Centric Vision</span>
<span class="topic-tag">Contrastive Learning</span>
    ...
    <div class="category-tags" aria-label="arXiv categories">
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 13 / arXiv:2606.12985</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.12985">Open arXiv</a>
        </div>
    ...
    <details class="topic-section" open>
      <summary class="topic-heading">Surveillance Vision</summary>
      <div class="queue">
    ...
    <details class="paper-row" id="link13">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>Revisiting Vehicle Color Recognition in Long-Tailed Surveillance Scenarios</strong>
          <small>Vin\&#x27;icius Orr\&#x27;u, Bruno H. Foggiatto, Gabriel E. Lima, David Menotti, Rayson Laroca</small>

    <div class="topic-tags" aria-label="fine-grained topic tags">
      <span class="topic-tag">Surveillance Vision</span>
<span class="topic-tag">Long-Tailed Recognition</span>
<span class="topic-tag">Synthetic Data</span>
    ...
    <div class="category-tags" aria-label="arXiv categories">
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 14 / arXiv:2606.13625</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.13625">Open arXiv</a>
        </div>
        ...
        <p class="comment"><strong>Why selected:</strong> Matches criterion 4 only weakly: it applies vision models and generative augmentation to a surveillance recognition problem, but it is a narrow application rather than a foundation-model contribution.</p>
    ...
    <details class="paper-row" id="link2">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>Reasoning for Mobile User Experience with Multimodal LLMs: Task, Benchmark, and Approach</strong>
          <small>Ruichao Mao, Zhou Fang, Teng Guo, Hao Yang, Yaping Li, Shaohua Peng, Maji Huang, Xiaoyu Lin, Shuoyang Liu, Xuepeng Li, Yuyu Zhang, Hai Rao</small>

    <div class="topic-tags" aria-label="fine-grained topic tags">
      <span class="topic-tag">Multimodal LLMs</span>
<span class="topic-tag">Benchmark &amp; Evaluation</span>
<span class="topic-tag">UI Reasoning</span>
    </div>
    ...
    <div class="category-tags" aria-label="arXiv categories">
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 3 / arXiv:2606.13192</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.13192">Open arXiv</a>
        </div>
    ...
    <details class="paper-row" id="link4">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>TerraBench: Can Agents Reason Over Heterogeneous Earth-System Data?</strong>
          <small>Dat Tien Nguyen, Thao Nguyen, Fadillah Adamsyah Maani, Huy M. Le, Muhammad Umer Sheikh, Numan Saeed, Muhammad Haris Khan, Salman Khan</small>

    <div class="topic-tags" aria-label="fine-grained topic tags">
      <span class="topic-tag">Benchmark &amp; Evaluation</span>
<span class="topic-tag">Agentic Reasoning</span>
<span class="topic-tag">Earth-System AI</span>
    </div>
    ...
    <div class="category-tags" aria-label="arXiv categories">
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 5 / arXiv:2606.13148</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.13148">Open arXiv</a>
        </div>
    ...
    <details class="topic-section" open>
      <summary class="topic-heading">Knowledge Graphs</summary>
      <div class="queue">
    ...
    <details class="paper-row" id="link7">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>Agents-K1: Towards Agent-native Knowledge Orchestration</strong>
          <small>Zongsheng Cao, Bihao Zhan, Jinxin Shi, Jiong Wang, Fangchen Yu, Zhijie Zhong, Zijie Guo, Tianshuo Peng, Zhuo Liu, Yi Xie, Xiang Zhuang, Yue Fan, Runmin Ma, Shiyang Feng, Xiangchao Yan, Anran Liu, Peng Ye, Wenlong Zhang, Shufei Zhang, Chunfeng Song, Fenghua Ling, Jie Zhou, Liang He, Bo Zhang, Lei Bai</small>

    <div class="topic-tags" aria-label="fine-grained topic tags">
      <span class="topic-tag">Knowledge Graphs</span>
<span class="topic-tag">Scientific Agents</span>
<span class="topic-tag">Multimodal Information Extraction</span>
    </div>
    ...
    <div class="category-tags" aria-label="arXiv categories">
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 8 / arXiv:2606.13669</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.13669">Open arXiv</a>
        </div>
    ...
    <details class="topic-section" open>
      <summary class="topic-heading">Fact Verification</summary>
      <div class="queue">
    ...
    <details class="paper-row" id="link8">
      <summary class="paper-row-summary">
        ...
        <span class="paper-row-copy">
          <strong>From Verdict to Process: Agentic Reinforcement Learning for Multi-Stage Fact Verification</strong>
          <small>Rongxin Yang, Shenghong He, Siyuan Zhu, Chao Yu</small>

    <div class="topic-tags" aria-label="fine-grained topic tags">
      <span class="topic-tag">Fact Verification</span>
<span class="topic-tag">Agentic RL</span>
<span class="topic-tag">Multi-Stage Reasoning</span>
    </div>
    ...
    <div class="category-tags" aria-label="arXiv categories">
      ...
      <div class="paper-row-detail">
        <div class="paper-row-meta">
          <span>Paper 9 / arXiv:2606.13262</span>
          <a class="paper-action" href="https://arxiv.org/abs/2606.13262">Open arXiv</a>
        </div>
        ...
        <p class="comment"><strong>Why selected:</strong> Matches criterion 3: it introduces a new agentic reinforcement learning method for multi-stage fact verification, focusing on process-level optimization rather than a standard verifier.</p>
