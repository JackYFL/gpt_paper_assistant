...
0. [SpatialClaw: Rethinking Action Interface for Agentic Spatial Reasoning](#link0)
...
1. [HYDRA-X: Native Unified Multimodal Models with Holistic Visual Tokenizers](#link1)
...
2. [Reasoning for Mobile User Experience with Multimodal LLMs: Task, Benchmark, and Approach](#link2)
...
3. [Language-Guided Abstraction for Visual Reasoning](#link3)
**Authors:** Xu-Jing Ye, Yuan-Gen Wang, Ruping Wang

4. [TerraBench: Can Agents Reason Over Heterogeneous Earth-System Data?](#link4)
...
5. [HairPort: In-context 3D-aware Hair Import and Transfer for Images](#link5)
**Authors:** Alireza Heidari, Amirhossein Alimohammadi, Wallace Michel Pinto Lira, Adi Bar-Lev, Ali Mahdavi-Amiri

6. [GRIP: Feedback-Guided Prompt Retrieval for Large Multimodal Models](#link6)
**Authors:** Garvita Allabadi, Matteo Sodano, Roberto Estev\~ao, Yuxiong Wang, Vikram Adve, Emre Kiciman, Ranveer Chandra

7. [Agents-K1: Towards Agent-native Knowledge Orchestration](#link7)
...
8. [From Verdict to Process: Agentic Reinforcement Learning for Multi-Stage Fact Verification](#link8)
**Authors:** Rongxin Yang, Shenghong He, Siyuan Zhu, Chao Yu

9. [Visual Place Recognition in Forests with Depth-Aware Distillation](#link9)
**Authors:** Walter Nedov, Saimunur Rahman, Kavindie Katuwandeniya, David Hall, Kaushik Roy, Peyman Moghadam

10. [Dual-State Slot Attention: Decoupling Appearance and Identity for Video Object-Centric Learning](#link10)
**Authors:** Sieu Tran, Duc Nguyen, Hao Vo, Khoa Vo, Ngan Le

11. [DIMOS: Disentangling Instance-level Moving Object Segmentation](#link11)
**Authors:** Hongxiang Huang, Hongwei Ren, Xiaopeng Lin, Yulong Huang, Zeke Xie, Bojun Cheng

12. [Objects Before Words: Object-First Inductive Biases for Grounding Language in Child-View Video](#link12)
**Authors:** Sathira Silva, Abrham Kahsay Gebreselasie, Muhammad Umer Sheikh, Kartik Kuckreja, Daniel Harari, Muhammad Haris Khan

13. [Revisiting Vehicle Color Recognition in Long-Tailed Surveillance Scenarios](#link13)
**Authors:** Vin\'icius Orr\'u, Bruno H. Foggiatto, Gabriel E. Lima, David Menotti, Rayson Laroca

---
## 0. [SpatialClaw: Rethinking Action Interface for Agentic Spatial Reasoning](https://arxiv.org/abs/2606.13673) <a id="link0"></a>
**ArXiv ID:** 2606.13673
**Authors:** Seokju Cho, Ryo Hachiuma, Abhishek Badki, Hang Su, Byung-Kwan Lee, Chan Hee Song, Sifei Liu, Subhashree Radhakrishnan, Seungryong Kim, Yu-Chiang Frank Wang, Min-Hung Chen
...
**Comment:** Matches criterion 1 very closely: it proposes a new action interface for agentic spatial reasoning, specifically targeting open-ended 3D/4D spatial understanding.
**Relevance:** 6
**Novelty:** 7

---

## 1. [HYDRA-X: Native Unified Multimodal Models with Holistic Visual Tokenizers](https://arxiv.org/abs/2606.13289) <a id="link1"></a>
**ArXiv ID:** 2606.13289
**Authors:** Guozhen Zhang, Xuerui Qiu, Yutao Cui, Tianhui Song, Changlin Li, Junzhe Li, Tao Huang, Xiao Zhang, Yang Li, Jianbing Wu, Miles Yang, Zhao Zhong, Liefeng Bo, Limin Wang
...
**Comment:** Matches criterion 2 and criterion 4: it introduces a unified multimodal model with holistic visual tokenizers for image/video understanding and generation.
**Relevance:** 6
**Novelty:** 7

---

## 2. [Reasoning for Mobile User Experience with Multimodal LLMs: Task, Benchmark, and Approach](https://arxiv.org/abs/2606.13192) <a id="link2"></a>
**ArXiv ID:** 2606.13192
**Authors:** Ruichao Mao, Zhou Fang, Teng Guo, Hao Yang, Yaping Li, Shaohua Peng, Maji Huang, Xiaoyu Lin, Shuoyang Liu, Xuepeng Li, Yuyu Zhang, Hai Rao
...
**Comment:** Matches criterion 2 and criterion 3: it introduces a new MLLM-based system plus a benchmark for UI/UX reasoning from screenshots.
**Relevance:** 6
**Novelty:** 6

---

## 3. [Language-Guided Abstraction for Visual Reasoning](https://arxiv.org/abs/2606.12847) <a id="link3"></a>
**ArXiv ID:** 2606.12847
**Authors:** Xu-Jing Ye, Yuan-Gen Wang, Ruping Wang
...
**Comment:** Matches criterion 1: it proposes a new method for visual reasoning that injects language-guided abstraction into an ARC-style setting.
**Relevance:** 6
**Novelty:** 5

---

## 4. [TerraBench: Can Agents Reason Over Heterogeneous Earth-System Data?](https://arxiv.org/abs/2606.13148) <a id="link4"></a>
**ArXiv ID:** 2606.13148
**Authors:** Dat Tien Nguyen, Thao Nguyen, Fadillah Adamsyah Maani, Huy M. Le, Muhammad Umer Sheikh, Numan Saeed, Muhammad Haris Khan, Salman Khan
...
**Comment:** Matches criterion 3 very closely: this is a new embodied/agentic benchmark for simulator-grounded Earth-system reasoning with tool use and execution traces.
**Relevance:** 5
**Novelty:** 6

---

## 5. [HairPort: In-context 3D-aware Hair Import and Transfer for Images](https://arxiv.org/abs/2606.12562) <a id="link5"></a>
**ArXiv ID:** 2606.12562
**Authors:** Alireza Heidari, Amirhossein Alimohammadi, Wallace Michel Pinto Lira, Adi Bar-Lev, Ali Mahdavi-Amiri
...
**Comment:** Matches criterion 4: vision foundation models are used for 3D-aware hairstyle import/transfer, with a new bald-conversion dataset and a generative pipeline.
**Relevance:** 5
**Novelty:** 6

---

## 6. [GRIP: Feedback-Guided Prompt Retrieval for Large Multimodal Models](https://arxiv.org/abs/2606.12744) <a id="link6"></a>
**ArXiv ID:** 2606.12744
**Authors:** Garvita Allabadi, Matteo Sodano, Roberto Estev\~ao, Yuxiong Wang, Vikram Adve, Emre Kiciman, Ranveer Chandra
...
**Comment:** Matches criterion 2: it is about large multimodal models and a new retrieval method for multimodal in-context learning.
**Relevance:** 5
**Novelty:** 5

---

## 7. [Agents-K1: Towards Agent-native Knowledge Orchestration](https://arxiv.org/abs/2606.13669) <a id="link7"></a>
**ArXiv ID:** 2606.13669
**Authors:** Zongsheng Cao, Bihao Zhan, Jinxin Shi, Jiong Wang, Fangchen Yu, Zhijie Zhong, Zijie Guo, Tianshuo Peng, Zhuo Liu, Yi Xie, Xiang Zhuang, Yue Fan, Runmin Ma, Shiyang Feng, Xiangchao Yan, Anran Liu, Peng Ye, Wenlong Zhang, Shufei Zhang, Chunfeng Song, Fenghua Ling, Jie Zhou, Liang He, Bo Zhang, Lei Bai
...
**Comment:** Matches criterion 3: it builds a new agent-native scientific knowledge graph pipeline and multimodal parser, which is a novel benchmark/infrastructure-style contribution.
**Relevance:** 4
**Novelty:** 6

---

## 8. [From Verdict to Process: Agentic Reinforcement Learning for Multi-Stage Fact Verification](https://arxiv.org/abs/2606.13262) <a id="link8"></a>
**ArXiv ID:** 2606.13262
**Authors:** Rongxin Yang, Shenghong He, Siyuan Zhu, Chao Yu
...
**Comment:** Matches criterion 3: it introduces a new agentic reinforcement learning method for multi-stage fact verification, focusing on process-level optimization rather than a standard verifier.
**Relevance:** 4
**Novelty:** 5

---

## 9. [Visual Place Recognition in Forests with Depth-Aware Distillation](https://arxiv.org/abs/2606.13206) <a id="link9"></a>
**ArXiv ID:** 2606.13206
**Authors:** Walter Nedov, Saimunur Rahman, Kavindie Katuwandeniya, David Hall, Kaushik Roy, Peyman Moghadam
...
**Comment:** Matches criterion 4: it applies a vision foundation model (DINOv2) to visual place recognition with depth-aware distillation.
**Relevance:** 5
**Novelty:** 4

---

## 10. [Dual-State Slot Attention: Decoupling Appearance and Identity for Video Object-Centric Learning](https://arxiv.org/abs/2606.12601) <a id="link10"></a>
**ArXiv ID:** 2606.12601
**Authors:** Sieu Tran, Duc Nguyen, Hao Vo, Khoa Vo, Ngan Le
...
**Comment:** No close match to the four criteria; it is a video object-centric learning method, which is adjacent to vision but not specifically one of the requested categories.
**Relevance:** 3
**Novelty:** 5

---

## 11. [DIMOS: Disentangling Instance-level Moving Object Segmentation](https://arxiv.org/abs/2606.12826) <a id="link11"></a>
**ArXiv ID:** 2606.12826
**Authors:** Hongxiang Huang, Hongwei Ren, Xiaopeng Lin, Yulong Huang, Zeke Xie, Bojun Cheng
...
**Comment:** Matches criterion 1 only indirectly: it is a multimodal motion-segmentation method with event cameras, but not embodied spatial intelligence or VLLMs.
**Relevance:** 3
**Novelty:** 5

---

## 12. [Objects Before Words: Object-First Inductive Biases for Grounding Language in Child-View Video](https://arxiv.org/abs/2606.12985) <a id="link12"></a>
**ArXiv ID:** 2606.12985
**Authors:** Sathira Silva, Abrham Kahsay Gebreselasie, Muhammad Umer Sheikh, Kartik Kuckreja, Daniel Harari, Muhammad Haris Khan
...
**Comment:** Matches criterion 4 loosely: it uses object-centric visual representations for grounded language learning from child-view video, but it is not a VLLM/MLLM or embodied benchmark.
**Relevance:** 3
**Novelty:** 5

---

## 13. [Revisiting Vehicle Color Recognition in Long-Tailed Surveillance Scenarios](https://arxiv.org/abs/2606.13625) <a id="link13"></a>
**ArXiv ID:** 2606.13625
**Authors:** Vin\'icius Orr\'u, Bruno H. Foggiatto, Gabriel E. Lima, David Menotti, Rayson Laroca
...
**Comment:** Matches criterion 4 only weakly: it applies vision models and generative augmentation to a surveillance recognition problem, but it is a narrow application rather than a foundation-model contribution.
**Relevance:** 3
**Novelty:** 4
