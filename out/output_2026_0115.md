...
1. [Affostruction: 3D Affordance Grounding with Generative Reconstruction](#link1)
**Authors:** Chunghyun Park, Seunghyeon Lee, Minsu Cho

2. [SkinFlow: Efficient Information Transmission for Open Dermatological Diagnosis via Dynamic Visual Encoding and Staged RL](#link2)
...
3. [SCE-SLAM: Scale-Consistent Monocular SLAM via Scene Coordinate Embeddings](#link3)
**Authors:** Yuchen Wu, Jiahe Li, Xiaohan Yu, Lina Yu, Jin Zheng, Xiao Bai

4. [CogRail: Benchmarking VLMs in Cognitive Intrusion Perception for Intelligent Railway Transportation Systems](#link4)
...
5. [Efficient Camera-Controlled Video Generation of Static Scenes via Sparse Diffusion and 3D Rendering](#link5)
**Authors:** Jieying Chen, Jeffrey Hu, Joan Lasenby, Ayush Tewari

6. [Vision Foundation Models for Domain Generalisable Cross-View Localisation in Planetary Ground-Aerial Robotic Teams](#link6)
**Authors:** Lachlan Holden, Feras Dayoub, Alberto Candela, David Harvey, Tat-Jun Chin

7. [AtomMem : Learnable Dynamic Agentic Memory with Atomic Memory Operation](#link7)
**Authors:** Yupeng Huo, Yaxi Lu, Zhong Zhang, Haotian Chen, Yankai Lin

8. [ToolACE-MCP: Generalizing History-Aware Routing from MCP Tools to the Agent Web](#link8)
**Authors:** Zhiyuan Yao, Zishan Xu, Yifu Guo, Zhiguang Han, Cheng Yang, Shuo Zhang, Weinan Zhang, Xingshan Zeng, Weiwen Liu

9. [LiteEmbed: Adapting CLIP to Rare Classes](#link9)
**Authors:** Aishwarya Agarwal, Srikrishna Karanam, Vineet Gandhi

10. [SSVP: Synergistic Semantic-Visual Prompting for Industrial Zero-Shot Anomaly Detection](#link10)
**Authors:** Chenhao Fu, Han Fang, Xiuzheng Zheng, Wenbo Wei, Yonghua Li, Hao Sun, Xuelong Li

11. [Image2Garment: Simulation-ready Garment Generation from a Single Image](#link11)
...
12. [BrainSegNet: A Novel Framework for Whole-Brain MRI Parcellation Enhanced by Large Models](#link12)
**Authors:** Yucheng Li, Xiaofan Wang, Junyi Wang, Yijie Li, Xi Zhu, Mubai Du, Dian Sheng, Wei Zhang, Fan Zhang

13. [CLIDD: Cross-Layer Independent Deformable Description for Efficient and Discriminative Local Feature Representation](#link13)
**Authors:** Haodi Yao, Fenghua He, Ning Hao, Yao Su

14. [DeTracker: Motion-decoupled Vehicle Detection and Tracking in Unstabilized Satellite Videos](#link14)
**Authors:** Jiajun Chen, Jing Xiao, Shaohan Cao, Yuming Zhu, Liang Liao, Jun Pan, Mi Wang

15. [SAM3-DMS: Decoupled Memory Selection for Multi-target Video Segmentation of SAM3](#link15)
**Authors:** Ruiqi Shen, Chang Liu, Henghui Ding

16. [Sketch-Based Facade Renovation With Generative AI: A Streamlined Framework for Bypassing As-Built Modelling in Industrial Adaptive Reuse](#link16)
**Authors:** Warissara Booranamaitree, Xusheng Du, Yushu Cai, Zhengyang Wang, Ye Zhang, Haoran Xie

17. [Exploring Reliable Spatiotemporal Dependencies for Efficient Visual Tracking](#link17)
**Authors:** Junze Shi, Yang Yu, Jian Shi, Haibo Luo

18. [MEMEWEAVER: Inter-Meme Graph Reasoning for Sexism and Misogyny Detection](#link18)
**Authors:** Paolo Italiani, David Gimeno-Gomez, Luca Ragazzi, Gianluca Moro, Paolo Rosso

19. [Integrating Diverse Assignment Strategies into DETRs](#link19)
**Authors:** Yiwei Zhang, Jin Gao, Hanshi Wang, Fudong Ge, Guan Luo, Weiming Hu, Zhipeng Zhang

20. [Beyond Linearization: Attributed Table Graphs for Table Reasoning](#link20)
**Authors:** Yuxiang Wang, Junhao Gan, Shengxiang Gao, Shenghao Ye, Zhengyi Yang, Jianzhong Qi

21. [Deconstructing Pre-training: Knowledge Attribution Analysis in MoE and Dense Models](#link21)
**Authors:** Bo Wang, Junzhuo Li, Hong Chen, Yuanlin Chu, Yuxuan Fan, Xuming Hu

22. [Improving LLM Reasoning with Homophily-aware Structural and Semantic Text-Attributed Graph Compression](#link22)
**Authors:** Zijun Di, Bin Lu, Huquan Kang, Luoyi Fu, Jiaxin Ding, Xiaoying Gan, Lei Zhou, Xinbing Wang, Chenghu Zhou

23. [Reading or Reasoning? Format Decoupled Reinforcement Learning for Document OCR](#link23)
...
24. [Point Tracking as a Temporal Cue for Robust Myocardial Segmentation in Echocardiography Videos](#link24)
...
25. [MemoBrain: Executive Memory as an Agentic Brain for Reasoning](#link25)
**Authors:** Hongjin Qian, Zhao Cao, Zheng Liu

26. [Magnifying change: Rapid burn scar mapping with multi-resolution, multi-source satellite imagery](#link26)
**Authors:** Maria Sdraka, Dimitrios Michail, Ioannis Papoutsis

27. [Trustworthy Longitudinal Brain MRI Completion: A Deformation-Based Approach with KAN-Enhanced Diffusion Model](#link27)
**Authors:** Tianli Tao, Ziyang Wang, Delong Yang, Han Zhang, Le Zhang

28. [Towards Robust Cross-Dataset Object Detection Generalization under Domain Specificity](#link28)
**Authors:** Ritabrata Chakraborty, Hrishit Mitra, Shivakumara Palaiahnakote, Umapada Pal

29. [Bipartite Mode Matching for Vision Training Set Search from a Hierarchical Data Server](#link29)
**Authors:** Yue Yao, Ruining Yang, Tom Gedeon

30. [WaterCopilot: An AI-Driven Virtual Assistant for Water Management](#link30)
**Authors:** Keerththanan Vickneswaran, Mariangel Garcia Andarcia, Hugo Retief, Chris Dickens, Paulo Silva

31. [Instance camera focus prediction for crystal agglomeration classification](#link31)
**Authors:** Xiaoyu Ji, Chenhao Zhang, Tyler James Downard, Zoltan Nagy, Ali Shakouri, Fengqing Zhu

32. [Changes in Visual Attention Patterns for Detection Tasks due to Dependencies on Signal and Background Spatial Frequencies](#link32)
**Authors:** Amar Kavuri, Howard C. Gifford, Mini Das

33. [Radiomics-Integrated Deep Learning with Hierarchical Loss for Osteosarcoma Histology Classification](#link33)
...
**Comment:** Matches criterion 2 (new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications). Introduces STEP3-VL-10B, a compact, open-source vision-language foundation model with strong performance and novel training strategies.
**Relevance:** 10
**Novelty:** 8

---

## 1. [Affostruction: 3D Affordance Grounding with Generative Reconstruction](https://arxiv.org/abs/2601.09211) <a id="link1"></a>
**ArXiv ID:** 2601.09211
**Authors:** Chunghyun Park, Seunghyeon Lee, Minsu Cho
...
**Comment:** Matches criterion 1 (new methodological improvements to spatial understanding and spatial intelligence on embodied agents) and criterion 3 (novel method for affordance grounding with generative 3D reconstruction and active view selection, which is a new angle).
**Relevance:** 10
**Novelty:** 8

---

## 2. [SkinFlow: Efficient Information Transmission for Open Dermatological Diagnosis via Dynamic Visual Encoding and Staged RL](https://arxiv.org/abs/2601.09136) <a id="link2"></a>
**ArXiv ID:** 2601.09136
**Authors:** Lijun Liu, Linwei Chen, Zhishou Zhang, Meng Tian, Hengfu Cui, Ruiyang Li, Zhaocheng Liu, Qiang Ju, Qianxi Li, Hong-Yu Zhou
...
**Comment:** Matches criterion 2 (new VLLMs) and criterion 4 (vision foundation models and applications). Proposes SkinFlow, a new vision-language model for dermatological diagnosis, with a novel dynamic vision encoder and staged RL, outperforming larger models.
**Relevance:** 9
**Novelty:** 8

---

## 3. [SCE-SLAM: Scale-Consistent Monocular SLAM via Scene Coordinate Embeddings](https://arxiv.org/abs/2601.09665) <a id="link3"></a>
**ArXiv ID:** 2601.09665
**Authors:** Yuchen Wu, Jiahe Li, Xiaohan Yu, Lina Yu, Jin Zheng, Xiao Bai
...
**Comment:** Matches criterion 1 (methodological improvements to spatial understanding for embodied agents) and criterion 3 (novel SLAM method with scale-consistent embeddings). Proposes a new monocular SLAM system with learned scene coordinate embeddings for improved scale consistency.
**Relevance:** 9
**Novelty:** 8

---

## 4. [CogRail: Benchmarking VLMs in Cognitive Intrusion Perception for Intelligent Railway Transportation Systems](https://arxiv.org/abs/2601.09613) <a id="link4"></a>
**ArXiv ID:** 2601.09613
**Authors:** Yonglin Tian, Qiyao Zhang, Wei Xu, Yutong Wang, Yihao Wu, Xinyi Li, Xingyuan Dai, Hui Zhang, Zhiyong Cui, Baoqing Guo, Zujun Yu, Yisheng Lv
...
**Comment:** Matches criterion 3 (embodied AI, new benchmark, simulator-related, novel angle) and criterion 4 (vision foundation models and applications). Introduces CogRail, a new benchmark for spatio-temporal reasoning in railway safety, and evaluates/adapts VLMs for cognitive intrusion perception. Highlights limitations of current VLMs and proposes a joint fine-tuning framework.
**Relevance:** 9
**Novelty:** 8

---

## 5. [Efficient Camera-Controlled Video Generation of Static Scenes via Sparse Diffusion and 3D Rendering](https://arxiv.org/abs/2601.09697) <a id="link5"></a>
**ArXiv ID:** 2601.09697
**Authors:** Jieying Chen, Jeffrey Hu, Joan Lasenby, Ayush Tewari
...
**Comment:** Matches criterion 4 (efficient video generation using diffusion models and 3D rendering, relevant to vision foundation models and generative modeling in multi-modal learning).
**Relevance:** 8
**Novelty:** 8

---

## 6. [Vision Foundation Models for Domain Generalisable Cross-View Localisation in Planetary Ground-Aerial Robotic Teams](https://arxiv.org/abs/2601.09107) <a id="link6"></a>
**ArXiv ID:** 2601.09107
**Authors:** Lachlan Holden, Feras Dayoub, Alberto Candela, David Harvey, Tat-Jun Chin
...
**Comment:** Matches criterion 4 (vision foundation models for cross-view localisation in planetary robotics, with application to embodied agents and domain generalization). Also partially matches criterion 3 (new dataset and method for embodied AI localisation).
**Relevance:** 9
**Novelty:** 7

---

## 7. [AtomMem : Learnable Dynamic Agentic Memory with Atomic Memory Operation](https://arxiv.org/abs/2601.08323) <a id="link7"></a>
**ArXiv ID:** 2601.08323
**Authors:** Yupeng Huo, Yaxi Lu, Zhong Zhang, Haotian Chen, Yankai Lin
...
**Comment:** Matches criterion 1 (new methodological improvements to agent memory for spatial/temporal intelligence) and criterion 3 (novel learning-based memory management for agents). The paper introduces a learnable, dynamic memory system for agents, outperforming static workflows.
**Relevance:** 8
**Novelty:** 7

---

## 8. [ToolACE-MCP: Generalizing History-Aware Routing from MCP Tools to the Agent Web](https://arxiv.org/abs/2601.08276) <a id="link8"></a>
**ArXiv ID:** 2601.08276
**Authors:** Zhiyuan Yao, Zishan Xu, Yifu Guo, Zhiguang Han, Cheng Yang, Shuo Zhang, Weinan Zhang, Xingshan Zeng, Weiwen Liu
...
**Comment:** Matches criterion 1 (methodological improvements to spatial understanding on embodied agents) and criterion 3 (new methods for agent routing in large-scale, open ecosystems). The paper proposes a history-aware routing pipeline for agent navigation in large-scale tool ecosystems, with empirical results on real-world benchmarks.
**Relevance:** 8
**Novelty:** 7

---

## 9. [LiteEmbed: Adapting CLIP to Rare Classes](https://arxiv.org/abs/2601.09661) <a id="link9"></a>
**ArXiv ID:** 2601.09661
**Authors:** Aishwarya Agarwal, Srikrishna Karanam, Vineet Gandhi
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes LiteEmbed, a method for few-shot personalization of CLIP to rare classes, with plug-and-play embeddings for various tasks.
**Relevance:** 8
**Novelty:** 7

---

## 10. [SSVP: Synergistic Semantic-Visual Prompting for Industrial Zero-Shot Anomaly Detection](https://arxiv.org/abs/2601.09147) <a id="link10"></a>
**ArXiv ID:** 2601.09147
**Authors:** Chenhao Fu, Han Fang, Xiuzheng Zheng, Wenbo Wei, Yonghua Li, Hao Sun, Xuelong Li
...
**Comment:** Matches criterion 2 (new VLLMs) and criterion 4 (vision foundation models and applications). Proposes a new method (SSVP) that fuses DINOv3 and CLIP for zero-shot anomaly detection, with novel prompt generation and calibration mechanisms. Strong empirical results on industrial benchmarks.
**Relevance:** 8
**Novelty:** 7

---

## 11. [Image2Garment: Simulation-ready Garment Generation from a Single Image](https://arxiv.org/abs/2601.09658) <a id="link11"></a>
**ArXiv ID:** 2601.09658
**Authors:** Selim Emir Can, Jan Ackermann, Kiyohiro Nakayama, Ruofan Liu, Tong Wu, Yang Zheng, Hugo Bertiche, Menglei Chai, Thabo Beeler, Gordon Wetzstein
...
**Comment:** This paper proposes a method for generating simulation-ready garments from a single image by fine-tuning a vision-language model to infer material and fabric attributes, then mapping these to physical parameters. This matches criterion 2 (shows new VLLMs/MLLMs) and criterion 4 (vision foundation models and applications), as it leverages VLMs for a novel application in computer vision and simulation.
**Relevance:** 8
**Novelty:** 7

---

## 12. [BrainSegNet: A Novel Framework for Whole-Brain MRI Parcellation Enhanced by Large Models](https://arxiv.org/abs/2601.09263) <a id="link12"></a>
**ArXiv ID:** 2601.09263
**Authors:** Yucheng Li, Xiaofan Wang, Junyi Wang, Yijie Li, Xi Zhu, Mubai Du, Dian Sheng, Wei Zhang, Fan Zhang
...
**Comment:** Matches criterion 4 (application of vision foundation models, specifically adapting SAM, to medical imaging for brain parcellation).
**Relevance:** 8
**Novelty:** 7

---

## 13. [CLIDD: Cross-Layer Independent Deformable Description for Efficient and Discriminative Local Feature Representation](https://arxiv.org/abs/2601.09230) <a id="link13"></a>
**ArXiv ID:** 2601.09230
**Authors:** Haodi Yao, Fenghua He, Ning Hao, Yao Su
...
**Comment:** Matches criterion 1 (new method for efficient and discriminative local feature representation for spatial intelligence tasks such as robot navigation and AR).
**Relevance:** 8
**Novelty:** 7

---

## 14. [DeTracker: Motion-decoupled Vehicle Detection and Tracking in Unstabilized Satellite Videos](https://arxiv.org/abs/2601.09240) <a id="link14"></a>
**ArXiv ID:** 2601.09240
**Authors:** Jiajun Chen, Jing Xiao, Shaohan Cao, Yuming Zhu, Liang Liao, Jun Pan, Mi Wang
...
**Comment:** This paper introduces DeTracker, a new detection-and-tracking framework for unstabilized satellite videos, with a novel motion decoupling module and a new benchmark dataset (SDM-Car-SU). This matches criterion 3 (embodied AI papers on building new benchmarks or methods, especially with novel angles), as it introduces a new benchmark and method for a challenging tracking scenario.
**Relevance:** 7
**Novelty:** 7

---

## 15. [SAM3-DMS: Decoupled Memory Selection for Multi-target Video Segmentation of SAM3](https://arxiv.org/abs/2601.09699) <a id="link15"></a>
**ArXiv ID:** 2601.09699
**Authors:** Ruiqi Shen, Chang Liu, Henghui Ding
...
**Comment:** Matches criterion 4 (vision foundation models and applications). Proposes a new memory selection strategy for SAM3, a vision foundation model for video segmentation, improving multi-object tracking and segmentation.
**Relevance:** 7
**Novelty:** 6

---

## 16. [Sketch-Based Facade Renovation With Generative AI: A Streamlined Framework for Bypassing As-Built Modelling in Industrial Adaptive Reuse](https://arxiv.org/abs/2601.08531) <a id="link16"></a>
**ArXiv ID:** 2601.08531
**Authors:** Warissara Booranamaitree, Xusheng Du, Yushu Cai, Zhengyang Wang, Ye Zhang, Haoran Xie
...
**Comment:** This paper presents a generative AI and vision-language model-based framework for sketch-based facade renovation, bypassing as-built modeling. It uses VLMs and generative models for a novel application, matching criterion 2 (VLLMs/MLLMs) and criterion 4 (vision foundation models and applications).
**Relevance:** 7
**Novelty:** 6

---

## 17. [Exploring Reliable Spatiotemporal Dependencies for Efficient Visual Tracking](https://arxiv.org/abs/2601.09078) <a id="link17"></a>
**ArXiv ID:** 2601.09078
**Authors:** Junze Shi, Yang Yu, Jian Shi, Haibo Luo
...
**Comment:** Somewhat related to criterion 1 (spatiotemporal dependencies for visual tracking, which is a spatial intelligence task), but not directly about embodied agents or spatial understanding in the context of embodied AI.
**Relevance:** 5
**Novelty:** 6

---

## 18. [MEMEWEAVER: Inter-Meme Graph Reasoning for Sexism and Misogyny Detection](https://arxiv.org/abs/2601.08684) <a id="link18"></a>
**ArXiv ID:** 2601.08684
**Authors:** Paolo Italiani, David Gimeno-Gomez, Luca Ragazzi, Gianluca Moro, Paolo Rosso
...
**Comment:** Somewhat related to criterion 2 (multimodal models), as it presents a multimodal framework for meme analysis, but the focus is on social graph reasoning for hate detection, not on general-purpose VLLMs or MLLMs.
**Relevance:** 4
**Novelty:** 6

---

## 19. [Integrating Diverse Assignment Strategies into DETRs](https://arxiv.org/abs/2601.09247) <a id="link19"></a>
**ArXiv ID:** 2601.09247
**Authors:** Yiwei Zhang, Jin Gao, Hanshi Wang, Fudong Ge, Guan Luo, Weiming Hu, Zhipeng Zhang
...
**Comment:** This paper introduces LoRA-DETR, a framework for integrating diverse assignment strategies into DETR-style object detectors, with a surprising empirical insight about supervision diversity. While it is a clever statistical trick for object detection, it does not directly address spatial intelligence for embodied agents, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 4
**Novelty:** 6

---

## 20. [Beyond Linearization: Attributed Table Graphs for Table Reasoning](https://arxiv.org/abs/2601.08444) <a id="link20"></a>
**ArXiv ID:** 2601.08444
**Authors:** Yuxiang Wang, Junhao Gan, Shengxiang Gao, Shenghao Ye, Zhengyi Yang, Jianzhong Qi
...
**Comment:** Does not directly match any specific criterion. Proposes a graph-based approach for table reasoning, not vision or spatial intelligence.
**Relevance:** 3
**Novelty:** 6

---

## 21. [Deconstructing Pre-training: Knowledge Attribution Analysis in MoE and Dense Models](https://arxiv.org/abs/2601.08383) <a id="link21"></a>
**ArXiv ID:** 2601.08383
**Authors:** Bo Wang, Junzhuo Li, Hong Chen, Yuanlin Chu, Yuxuan Fan, Xuming Hu
...
**Comment:** Does not match any specific criterion. Focuses on knowledge attribution in MoE and dense models, not spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 22. [Improving LLM Reasoning with Homophily-aware Structural and Semantic Text-Attributed Graph Compression](https://arxiv.org/abs/2601.08187) <a id="link22"></a>
**ArXiv ID:** 2601.08187
**Authors:** Zijun Di, Bin Lu, Huquan Kang, Luoyi Fu, Jiaxin Ding, Xiaoying Gan, Lei Zhou, Xinbing Wang, Chenghu Zhou
...
**Comment:** Does not match any specific criterion. Focuses on LLMs and graph compression, not spatial intelligence, VLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 6

---

## 23. [Reading or Reasoning? Format Decoupled Reinforcement Learning for Document OCR](https://arxiv.org/abs/2601.08834) <a id="link23"></a>
**ArXiv ID:** 2601.08834
**Authors:** Yufeng Zhong, Lei Chen, Zhixiong Zeng, Xuanle Zhao, Deyang Jiang, Liming Zheng, Jing Huang, Haibo Qiu, Peng Shi, Siqi Yang, Lin Ma
...
**Comment:** Does not directly match any specific criterion. Focuses on OCR and reinforcement learning for document reading, not spatial intelligence, VLLMs, or embodied AI.
**Relevance:** 3
**Novelty:** 5

---

## 24. [Point Tracking as a Temporal Cue for Robust Myocardial Segmentation in Echocardiography Videos](https://arxiv.org/abs/2601.09207) <a id="link24"></a>
**ArXiv ID:** 2601.09207
**Authors:** Bahar Khodabakhshian, Nima Hashemi, Armin Saadat, Zahra Gholami, In-Chang Hwang, Samira Sojoudi, Christina Luong, Purang Abolmaesumi, Teresa Tsang
...
**Comment:** Does not directly match any specific criterion. Focuses on medical video segmentation using point tracking, not spatial intelligence for embodied agents or vision-language models.
**Relevance:** 3
**Novelty:** 5

---

## 25. [MemoBrain: Executive Memory as an Agentic Brain for Reasoning](https://arxiv.org/abs/2601.08079) <a id="link25"></a>
**ArXiv ID:** 2601.08079
**Authors:** Hongjin Qian, Zhao Cao, Zheng Liu
...
**Comment:** Does not directly match any specific criterion. Focuses on memory for reasoning in tool-augmented agents, not spatial intelligence or vision/multimodal models.
**Relevance:** 3
**Novelty:** 5

---

## 26. [Magnifying change: Rapid burn scar mapping with multi-resolution, multi-source satellite imagery](https://arxiv.org/abs/2601.09262) <a id="link26"></a>
**ArXiv ID:** 2601.09262
**Authors:** Maria Sdraka, Dimitrios Michail, Ioannis Papoutsis
...
**Comment:** This paper proposes a deep learning model for rapid burn scar mapping using multi-resolution, multi-source satellite imagery. While it is a novel application in remote sensing, it does not address spatial intelligence for embodied agents, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 27. [Trustworthy Longitudinal Brain MRI Completion: A Deformation-Based Approach with KAN-Enhanced Diffusion Model](https://arxiv.org/abs/2601.09572) <a id="link27"></a>
**ArXiv ID:** 2601.09572
**Authors:** Tianli Tao, Ziyang Wang, Delong Yang, Han Zhang, Le Zhang
...
**Comment:** This paper introduces a KAN-enhanced diffusion model for trustworthy longitudinal brain MRI completion. While it uses generative modeling, it is focused on medical imaging and does not address spatial intelligence for embodied agents, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 5

---

## 28. [Towards Robust Cross-Dataset Object Detection Generalization under Domain Specificity](https://arxiv.org/abs/2601.09497) <a id="link28"></a>
**ArXiv ID:** 2601.09497
**Authors:** Ritabrata Chakraborty, Hrishit Mitra, Shivakumara Palaiahnakote, Umapada Pal
...
**Comment:** This paper studies cross-dataset object detection generalization and introduces a principled characterization of domain specificity. It does not introduce new VLLMs/MLLMs, embodied AI, or vision foundation models, but does provide empirical insights into domain adaptation for object detection.
**Relevance:** 3
**Novelty:** 5

---

## 29. [Bipartite Mode Matching for Vision Training Set Search from a Hierarchical Data Server](https://arxiv.org/abs/2601.09531) <a id="link29"></a>
**ArXiv ID:** 2601.09531
**Authors:** Yue Yao, Ruining Yang, Tom Gedeon
...
**Comment:** Related to data-centric unsupervised domain adaptation for vision tasks, but does not match any specific criterion (not about spatial intelligence, VLLMs, embodied AI, or vision foundation models).
**Relevance:** 3
**Novelty:** 5

---

## 30. [WaterCopilot: An AI-Driven Virtual Assistant for Water Management](https://arxiv.org/abs/2601.08559) <a id="link30"></a>
**ArXiv ID:** 2601.08559
**Authors:** Keerththanan Vickneswaran, Mariangel Garcia Andarcia, Hugo Retief, Chris Dickens, Paulo Silva
...
**Comment:** Related to AI assistants and retrieval-augmented generation, but does not match any specific criterion. Focus is on water management applications, not on embodied agents, VLLMs, or vision foundation models.
**Relevance:** 3
**Novelty:** 4

---

## 31. [Instance camera focus prediction for crystal agglomeration classification](https://arxiv.org/abs/2601.09004) <a id="link31"></a>
**ArXiv ID:** 2601.09004
**Authors:** Xiaoyu Ji, Chenhao Zhang, Tyler James Downard, Zoltan Nagy, Ali Shakouri, Fengqing Zhu
...
**Comment:** Related to computer vision and machine learning, but does not match any specific criterion. Focuses on focus prediction and segmentation for crystal agglomeration, not on embodied agents, VLLMs, or vision foundation models.
**Relevance:** 3
**Novelty:** 4

---

## 32. [Changes in Visual Attention Patterns for Detection Tasks due to Dependencies on Signal and Background Spatial Frequencies](https://arxiv.org/abs/2601.09008) <a id="link32"></a>
**ArXiv ID:** 2601.09008
**Authors:** Amar Kavuri, Howard C. Gifford, Mini Das
...
**Comment:** This paper investigates visual attention patterns in detection tasks, focusing on human observer studies in medical imaging. While it provides empirical insights into visual attention, it does not address the specific criteria of spatial intelligence in embodied agents, VLLMs/MLLMs, embodied AI, or vision foundation models.
**Relevance:** 3
**Novelty:** 4

---

## 33. [Radiomics-Integrated Deep Learning with Hierarchical Loss for Osteosarcoma Histology Classification](https://arxiv.org/abs/2601.09416) <a id="link33"></a>
**ArXiv ID:** 2601.09416
**Authors:** Yaxi Chen, Zi Ye, Shaheer U. Saeed, Oliver Yu, Simin Ni, Jie Huang, Yipeng Hu
...
**Comment:** This paper proposes a multimodal deep learning approach for histology classification, integrating radiomic features and a hierarchical loss. While it uses multimodal input (image + radiomics), it does not focus on spatial intelligence for embodied agents, VLLMs/MLLMs, embodied AI benchmarks, or vision foundation models. It is more of a medical imaging application.
**Relevance:** 3
**Novelty:** 4
